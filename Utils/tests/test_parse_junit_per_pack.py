...
def test_parse_xml(tmp_path):
    ...
    (xml_path := Path(tmp_path, "foo.xml")).write_text(
        ...
        '<testsuites><testsuite name="pytest" errors="0" failures="0" skipped="0" tests="3" time="2.158" timestamp="2024-02-20T15:25:31.306846" hostname="0d480f757bd2">'
        '<testcase classname="Packs.ipinfo.Integrations.ipinfo_v2.ipinfo_v2_test" name="test_ipinfo_ip_command" time="0.010"/>'
        '<testcase classname="Packs.ipinfo.Integrations.ipinfo_v2.ipinfo_v2_test" name="test_ipinfo_nultiple_ips_command" time="0.008"/>'
        '<testcase classname="Packs.ipinfo.Integrations.ipinfo_v2.ipinfo_v2_test" name="test_check_columns_exists" time="0.005"/></testsuite>'
        '<testsuite name="pytest" errors="0" failures="0" skipped="0" tests="3" time="1.767" timestamp="2024-02-20T15:25:25.799231" hostname="d190b19a16e8">'
...
@pytest.mark.parametrize("value", ("", " ", "foo", "Packs.", "Tests.pack1",'Utils.pack1','Packs.Pack', 'Packs..'))
