...
# For this script to work you will need to use a trigger token (see here for more about that: https://code-stage.pan.run/help/ci/triggers/README#trigger-token)
