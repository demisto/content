...
def test_main_success(mocker):
    ...
    """
    alert_ids = ["1", "2", "3"]
    mock_closure_results = [[{"Contents": f"Alert {alert_id} closed successfully."}] for alert_id in alert_ids]
    ...
    for alert_id in alert_ids:
        mock_execute_command.assert_any_call("closeInvestigation", {"id": alert_id, "close_reason": "Resolved - Auto Resolve"})
