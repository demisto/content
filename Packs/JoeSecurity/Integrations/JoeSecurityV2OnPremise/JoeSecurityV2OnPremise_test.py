...
@pytest.fixture()
def client():
    from JoeSecurityV2OnPremise import Client
...
def test_paginate_success(args, excepted):
    ...
    """
    from JoeSecurityV2OnPremise import paginate
...
def test_is_online_command(mocker, client, result, excepted):
    ...
    """
    from JoeSecurityV2OnPremise import is_online_command
...
def test_info_analysis_command(mocker, client):
    ...
    """
    from JoeSecurityV2OnPremise import analysis_info_command
...
def test_list_analysis_command(mocker, client):
    ...
    """
    from JoeSecurityV2OnPremise import list_analysis_command
...
def test_download_report_command(mocker, client, web_id, file_type):
    ...
    """
    from JoeSecurityV2OnPremise import download_report_command
...
def test_download_sample_command(mocker, client):
    ...
    """
    from JoeSecurityV2OnPremise import download_sample_command
...
def test_search_command(mocker, client):
    ...
    """
    from JoeSecurityV2OnPremise import search_command
...
def test_file_command(mocker, client):
    ...
    """
    from JoeSecurityV2OnPremise import file_command
...
def test_url_command(mocker, client):
    ...
    Then:
        - Ensure the corresponding indicator were created with the right DBscore and duplicates were removed.
    """
    from JoeSecurityV2OnPremise import url_command
...
def test_list_lia_countries_command(mocker, client):
    ...
    Then:
        - Ensure the corresponding readable output is returned.
    """
    from JoeSecurityV2OnPremise import list_lia_countries_command
...
def test_list_lang_locales_command(mocker, client):
    ...
    Then:
        - Ensure the corresponding readable output is returned.
    """
    from JoeSecurityV2OnPremise import list_lang_locales_command
...
def test_get_account_quota_command(mocker, client):
    ...
    """
    from JoeSecurityV2OnPremise import get_account_quota_command
...
def test_submit_sample_command_file(mocker, client):
    ...
    Then:
        - Ensure the corresponding readable output is returned.
    """
    from JoeSecurityV2OnPremise import submit_sample_command
...
def test_submit_sample_command_url(mocker, client):
    ...
    Then:
        - Ensure the corresponding readable output is returned.
    """
    from JoeSecurityV2OnPremise import submit_url_command
    from CommonServerPython import ScheduledCommand
...
def test_update_metrics():
    ...
    """
    from JoeSecurityV2OnPremise import update_metrics
