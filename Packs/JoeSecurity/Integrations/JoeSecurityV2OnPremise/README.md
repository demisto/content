Access the full set of possibilities the Joe Sandbox On-Premise provides via RESTful Web API v2.
This integration was integrated and tested with version 3.18.0 of [jbxapi](https://github.com/joesecurity/jbxapi).

If you are using Joe Sandbox Cloud, please use the "Joe Security v2" Integration.

## Configure Joe Security v2 on Cortex XSOAR

1. Navigate to **Settings** > **Integrations** > **Servers & Services**.
2. Search for Joe Security v2 On-Premise.
