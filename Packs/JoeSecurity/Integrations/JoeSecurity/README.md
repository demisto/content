...
<hr>
<p>Downloads a resource associated to a report. This can be the full report, dropped binaries, and so on.
Click <a href="https://jbxcloud.joesecurity.org/userguide?sphinxurl=usage/webapi.html#v2-analysis-download"> here </a> to see the full report types list.
</p>
<h5>Base Command</h5>
