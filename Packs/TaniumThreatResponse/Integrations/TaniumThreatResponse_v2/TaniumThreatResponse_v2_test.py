...
from Packs.TaniumThreatResponse.Integrations.TaniumThreatResponse_v2 import TaniumThreatResponse_v2
...
def mock_client():
    client = TaniumThreatResponse_v2.Client(base_url=BASE_URL, password="TEST", username="TEST")
    return client
...
def test_convert_to_int(test_input, expected_output):
    res = TaniumThreatResponse_v2.convert_to_int(test_input)
...
def test_get_intel_doc(requests_mock):
    ...
    human_readable, outputs, raw_response = TaniumThreatResponse_v2.get_intel_doc(MOCK_CLIENT, {"intel-doc-id": "423"})
...
def test_get_intel_docs(requests_mock):
    ...
    human_readable, outputs, raw_response = TaniumThreatResponse_v2.get_intel_docs(MOCK_CLIENT, {"name": "test2"})
...
def test_get_intel_docs_labels_list(requests_mock):
    ...
    human_readable, outputs, raw_response = TaniumThreatResponse_v2.get_intel_docs_labels_list(MOCK_CLIENT, {
...
def test_add_intel_docs_label(requests_mock):
    ...
    human_readable, outputs, raw_response = TaniumThreatResponse_v2.add_intel_docs_label(MOCK_CLIENT,
                                                                                         {"intel-doc-id": intel_doc_id,
                                                                                          "label-id": label_id})
...
def test_remove_intel_docs_label(requests_mock):
    ...
    human_readable, outputs, raw_response = TaniumThreatResponse_v2.remove_intel_docs_label(MOCK_CLIENT, {
        "intel-doc-id": intel_doc_id,
        "label-id": label_id})
...
def test_create_intel_doc(requests_mock):
    pass


def test_update_intel_doc(requests_mock):
    pass
