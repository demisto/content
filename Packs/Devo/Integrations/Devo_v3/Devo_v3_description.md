...
permissions for the time being if you want the fetch incidents to work correctly with the default alert table `siem.logtrust.alert.info`. 
Otherwise only grant access to particular tables.
