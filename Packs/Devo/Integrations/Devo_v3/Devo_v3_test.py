...
from Devo_v3 import fetch_incidents, run_query_command, get_alerts_command,\
...
@patch('Devo_v3.READER_ENDPOINT', MOCK_READER_ENDPOINT, create=True)
@patch('Devo_v3.READER_OAUTH_TOKEN', MOCK_READER_OAUTH_TOKEN, create=True)
@patch('Devo_v3.WRITER_RELAY', MOCK_WRITER_RELAY, create=True)
@patch('Devo_v3.WRITE_CREDENTIALS', MOCK_WRITER_CREDENTIALS, create=True)
@patch('Devo_v3.FETCH_INCIDENTS_FILTER', MOCK_FETCH_INCIDENTS_FILTER, create=True)
@patch('Devo_v3.FETCH_INCIDENTS_DEDUPE', MOCK_FETCH_INCIDENTS_DEDUPE, create=True)
@patch('Devo_v3.ds.Reader.query')
@patch('Devo_v3.Sender')
...
@patch('Devo_v3.READER_OAUTH_TOKEN', MOCK_READER_OAUTH_TOKEN, create=True)
@patch('Devo_v3.FETCH_INCIDENTS_FILTER', MOCK_FETCH_INCIDENTS_FILTER, create=True)
@patch('Devo_v3.demisto.getLastRun')
@patch('Devo_v3.ds.Reader.query')
...
@patch('Devo_v3.READER_ENDPOINT', MOCK_READER_ENDPOINT, create=True)
@patch('Devo_v3.READER_OAUTH_TOKEN', MOCK_READER_OAUTH_TOKEN, create=True)
@patch('Devo_v3.concurrent.futures.wait')
@patch('Devo_v3.concurrent.futures.ThreadPoolExecutor.submit')
@patch('Devo_v3.demisto.args')
@patch('Devo_v3.ds.Reader.query')
@patch('Devo_v3.ds.Reader')
@patch('Devo_v3.get_types')
...
@patch('Devo_v3.WRITER_RELAY', MOCK_WRITER_RELAY, create=True)
@patch('Devo_v3.WRITER_CREDENTIALS', MOCK_WRITER_CREDENTIALS, create=True)
@patch('Devo_v3.demisto.args')
@patch('Devo_v3.Sender')
