...
def test_lookup_func(mocker):
    ...
    folder_lookup = [
        {
            "Type": 1,
            "Contents": {"name": "folders/111111111111", "displayName": "folder-name", "parent": "organizations/111111111111"},
        }
    ]
    ...
    result = lookup(**args)
    assert result == ("organizations/111111111111", {"id": "folders/folder-name", "level": "1", "number": "folders/111111111111"})
...
def test_GCPProjectHierarchy_command_empty_folder(mocker):
    ...
    def executeCommand(name, args):
        if name == "gcp-iam-projects-get":  # noqa: RET503
            ...
            return [{"Type": 1, "Contents": {"name": "", "displayName": "", "parent": ""}}]
...
def test_GCPProjectHierarchy_command_no_folder_name(mocker):
    ...
    def executeCommand(name, args):
        if name == "gcp-iam-projects-get":  # noqa: RET503
            ...
            return [{"Type": 1, "Contents": {"name": None, "displayName": "folder-name", "parent": "organizations/111111111111"}}]
    ...
    expected_result = CommandResults(outputs_prefix="GCPHierarchy", outputs_key_field="level", outputs=expected_hierachy)
...
def test_GCPProjectHierarchy_command_no_folder_parent(mocker):
    ...
    def executeCommand(name, args):
        if name == "gcp-iam-projects-get":  # noqa: RET503
            ...
            return [{"Type": 1, "Contents": {"name": "folders/111111111111", "displayName": "folder-name", "parent": None}}]
    ...
    def executeCommand(name, args):
        if name == "gcp-iam-projects-get":  # noqa: RET503
            ...
            return [
                {
                    "Type": 1,
                    "Contents": {"name": "folders/111111111111", "displayName": None, "parent": "organizations/111111111111"},
                }
            ]
