...
def aws_session(service="dynamodb", region=None, roleArn=None, roleSessionName=None, roleSessionDuration=None, rolePolicy=None):
    client = None
    kwargs = {}
...
def create_backup_command(args):
    ...
    kwargs = {"TableName": args.get("table_name", None), "BackupName": args.get("backup_name", None)}
    kwargs = remove_empty_elements(kwargs)
    if args.get("raw_json") is not None and not kwargs:
        del kwargs
        kwargs = safe_load_json(args.get("raw_json", "{ }"))
    ...
    response = json.dumps(response, default=datetime_to_string)
    response = json.loads(response)
    outputs = {"AWS-DynamoDB.BackupDetails(val.BackupName && val.BackupName === obj.BackupName)": response.get("BackupDetails")}
    del response["ResponseMetadata"]
...
def create_global_table_command(args):
    ...
    response = json.loads(response)
    outputs = {
        "AWS-DynamoDB.GlobalTableDescription(val.GlobalTableArn && val.GlobalTableArn === obj.GlobalTableArn)": response.get(
...
def create_table_command(args):
    ...
    response = json.dumps(response, default=datetime_to_string)
    response = json.loads(response)
    outputs = {"AWS-DynamoDB.TableDescription(val.TableArn && val.TableArn === obj.TableArn)": response.get("TableDescription")}
    del response["ResponseMetadata"]
...
def delete_backup_command(args):
    ...
    kwargs = {"BackupArn": args.get("backup_arn", None)}
    kwargs = remove_empty_elements(kwargs)
    if args.get("raw_json") is not None and not kwargs:
        del kwargs
        kwargs = safe_load_json(args.get("raw_json", "{ }"))
...
def delete_table_command(args):
    ...
    kwargs = {"TableName": args.get("table_name", None)}
    kwargs = remove_empty_elements(kwargs)
    if args.get("raw_json") is not None and not kwargs:
        del kwargs
        kwargs = safe_load_json(args.get("raw_json", "{ }"))
...
def describe_continuous_backups_command(args):
    ...
    response = json.dumps(response, default=datetime_to_string)
    response = json.loads(response)
    outputs = {"AWS-DynamoDB.ContinuousBackupsDescription": response["ContinuousBackupsDescription"]}
    del response["ResponseMetadata"]
...
def describe_global_table_command(args):
    ...
    kwargs = {"GlobalTableName": args.get("global_table_name", None)}
    kwargs = remove_empty_elements(kwargs)
    if args.get("raw_json") is not None and not kwargs:
        del kwargs
        kwargs = safe_load_json(args.get("raw_json", "{ }"))
...
def describe_global_table_settings_command(args):
    ...
    response = json.dumps(response, default=datetime_to_string)
    response = json.loads(response)
    outputs = {"AWS-DynamoDB(val.GlobalTableName && val.GlobalTableName === obj.GlobalTableName)": response}
    del response["ResponseMetadata"]
...
def describe_table_command(args):
    ...
    response = json.dumps(response, default=datetime_to_string)
    response = json.loads(response)
    outputs = {"AWS-DynamoDB.Table(val.TableArn && val.TableArn === obj.TableArn)": response.get("Table")}
    del response["ResponseMetadata"]
...
def describe_time_to_live_command(args):
    ...
    response = json.dumps(response, default=datetime_to_string)
    response = json.loads(response)
    outputs = {"AWS-DynamoDB.TimeToLiveDescription": response["TimeToLiveDescription"]}
    del response["ResponseMetadata"]
...
def list_backups_command(args):
    ...
    response = json.dumps(response, default=datetime_to_string)
    response = json.loads(response)
    outputs = {"AWS-DynamoDB.BackupSummaries(val.BackupArn && val.BackupArn === obj.BackupArn)": response.get("BackupSummaries")}
    del response["ResponseMetadata"]
...
def list_tags_of_resource_command(args):
    ...
    kwargs = {"ResourceArn": args.get("resource_arn", None), "NextToken": args.get("next_token", None)}
    kwargs = remove_empty_elements(kwargs)
    if args.get("raw_json") is not None and not kwargs:
        del kwargs
        kwargs = safe_load_json(args.get("raw_json", "{ }"))
...
def update_continuous_backups_command(args):
    ...
    kwargs = {
        ...
        "PointInTimeRecoverySpecification": {
            ...
            if args.get("point_in_time_recovery_specification_point_in_time_recovery_enabled", "") == "true"
            else None,
        },
    }
    kwargs = remove_empty_elements(kwargs)
...
def update_global_table_settings_command(args):
    ...
    kwargs = {
        ...
        "GlobalTableProvisionedWriteCapacityAutoScalingSettingsUpdate": {
            ...
            if args.get("global_table_provisioned_write_capacity_auto_scaling_settings_update_auto_scaling_disabled", "")
            == "true"
            else None,
            "AutoScalingRoleArn": args.get(
                "global_table_provisioned_write_capacity_auto_scaling_settings_update_auto_scaling_role_arn", None
            ),
            "ScalingPolicyUpdate": {
                "PolicyName": args.get("scaling_policy_update_policy_name", None),
                "TargetTrackingScalingPolicyConfiguration": {
                    "DisableScaleIn": True
                    if args.get("target_tracking_scaling_policy_configuration_disable_scale_in", "") == "true"
                    else None,
                },
            },
        },
        ...
        "ProvisionedWriteCapacityAutoScalingSettingsUpdate": {
            ...
            "AutoScalingDisabled": True
            if args.get("provisioned_write_capacity_auto_scaling_settings_update_auto_scaling_disabled", "") == "true"
            else None,
...
def update_time_to_live_command(args):
    ...
    response = json.dumps(response, default=datetime_to_string)
    response = json.loads(response)
    outputs = {"AWS-DynamoDB.TimeToLiveSpecification": response["TimeToLiveSpecification"]}
    del response["ResponseMetadata"]
...
def main():  # pragma: no cover
    ...
    try:
        ...
        return_error("Error has occurred in the AWS dynamodb Integration: {code} {message}".format(code=type(e), message=e))
