...
def main() -> None:
    ...
    try:
        ...
        if command == 'test-module':
            ...
            return_results(generic_ansible('azurecompute', 'azure_rm_autoscale', args, int_params, host_type))
        elif command == 'azure-rm-autoscale-info':
            return_results(generic_ansible('azurecompute', 'azure_rm_autoscale_info', args, int_params, host_type))
        elif command == 'azure-rm-availabilityset':
            return_results(generic_ansible('azurecompute', 'azure_rm_availabilityset', args, int_params, host_type))
        elif command == 'azure-rm-availabilityset-info':
            return_results(generic_ansible('azurecompute', 'azure_rm_availabilityset_info', args, int_params, host_type))
        elif command == 'azure-rm-deployment':
            return_results(generic_ansible('azurecompute', 'azure_rm_deployment', args, int_params, host_type))
        elif command == 'azure-rm-deployment-info':
            return_results(generic_ansible('azurecompute', 'azure_rm_deployment_info', args, int_params, host_type))
        elif command == 'azure-rm-functionapp':
            return_results(generic_ansible('azurecompute', 'azure_rm_functionapp', args, int_params, host_type))
        elif command == 'azure-rm-functionapp-info':
            return_results(generic_ansible('azurecompute', 'azure_rm_functionapp_info', args, int_params, host_type))
        elif command == 'azure-rm-gallery':
            return_results(generic_ansible('azurecompute', 'azure_rm_gallery', args, int_params, host_type))
        elif command == 'azure-rm-gallery-info':
            return_results(generic_ansible('azurecompute', 'azure_rm_gallery_info', args, int_params, host_type))
        elif command == 'azure-rm-galleryimage':
            return_results(generic_ansible('azurecompute', 'azure_rm_galleryimage', args, int_params, host_type))
        elif command == 'azure-rm-galleryimage-info':
            return_results(generic_ansible('azurecompute', 'azure_rm_galleryimage_info', args, int_params, host_type))
        elif command == 'azure-rm-galleryimageversion':
            return_results(generic_ansible('azurecompute', 'azure_rm_galleryimageversion', args, int_params, host_type))
        elif command == 'azure-rm-galleryimageversion-info':
            return_results(generic_ansible('azurecompute', 'azure_rm_galleryimageversion_info', args, int_params, host_type))
        elif command == 'azure-rm-image':
            return_results(generic_ansible('azurecompute', 'azure_rm_image', args, int_params, host_type))
        elif command == 'azure-rm-image-info':
            return_results(generic_ansible('azurecompute', 'azure_rm_image_info', args, int_params, host_type))
        elif command == 'azure-rm-loadbalancer':
            return_results(generic_ansible('azurecompute', 'azure_rm_loadbalancer', args, int_params, host_type))
        elif command == 'azure-rm-loadbalancer-info':
            return_results(generic_ansible('azurecompute', 'azure_rm_loadbalancer_info', args, int_params, host_type))
            ...
            return_results(generic_ansible('azurecompute', 'azure_rm_resourcegroup', args, int_params, host_type))
        elif command == 'azure-rm-resourcegroup-info':
            return_results(generic_ansible('azurecompute', 'azure_rm_resourcegroup_info', args, int_params, host_type))
        elif command == 'azure-rm-snapshot':
            return_results(generic_ansible('azurecompute', 'azure_rm_snapshot', args, int_params, host_type))
        elif command == 'azure-rm-virtualmachine':
            return_results(generic_ansible('azurecompute', 'azure_rm_virtualmachine', args, int_params, host_type))
        elif command == 'azure-rm-virtualmachine-info':
            return_results(generic_ansible('azurecompute', 'azure_rm_virtualmachine_info', args, int_params, host_type))
        elif command == 'azure-rm-virtualmachineextension':
            return_results(generic_ansible('azurecompute', 'azure_rm_virtualmachineextension', args, int_params, host_type))
        elif command == 'azure-rm-virtualmachineextension-info':
            return_results(generic_ansible('azurecompute', 'azure_rm_virtualmachineextension_info', args, int_params, host_type))
        elif command == 'azure-rm-virtualmachineimage-info':
            return_results(generic_ansible('azurecompute', 'azure_rm_virtualmachineimage_info', args, int_params, host_type))
        elif command == 'azure-rm-virtualmachinescaleset':
            return_results(generic_ansible('azurecompute', 'azure_rm_virtualmachinescaleset', args, int_params, host_type))
            ...
            return_results(generic_ansible('azurecompute', 'azure_rm_webapp_info', args, int_params, host_type))
        elif command == 'azure-rm-webappslot':
            return_results(generic_ansible('azurecompute', 'azure_rm_webappslot', args, int_params, host_type))
