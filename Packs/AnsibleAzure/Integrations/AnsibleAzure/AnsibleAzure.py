...
def main() -> None:
    ...
    try:
        ...
        if command == 'test-module':
            ...
            return_results(generic_ansible('Azure', 'azure_rm_galleryimageversion_info',
            ...
            return_results(generic_ansible('Azure', 'azure_rm_virtualmachineextension',
                                           args, int_params, host_type, creds_mapping))
        elif command == 'azure-rm-virtualmachineextension-info':
            return_results(generic_ansible('Azure', 'azure_rm_virtualmachineextension_info',
                                           args, int_params, host_type, creds_mapping))
        elif command == 'azure-rm-virtualmachineimage-info':
            return_results(generic_ansible('Azure', 'azure_rm_virtualmachineimage_info',
                                           args, int_params, host_type, creds_mapping))
        elif command == 'azure-rm-virtualmachinescaleset':
            return_results(generic_ansible('Azure', 'azure_rm_virtualmachinescaleset',
                                           args, int_params, host_type, creds_mapping))
        elif command == 'azure-rm-virtualmachinescaleset-info':
            return_results(generic_ansible('Azure', 'azure_rm_virtualmachinescaleset_info',
                                           args, int_params, host_type, creds_mapping))
            ...
            return_results(generic_ansible('Azure', 'azure_rm_virtualnetworkpeering_info',
                                           args, int_params, host_type, creds_mapping))
            ...
            return_results(generic_ansible('Azure', 'azure_rm_trafficmanagerendpoint',
                                           args, int_params, host_type, creds_mapping))
            ...
            return_results(generic_ansible('Azure', 'azure_rm_trafficmanagerprofile_info',
                                           args, int_params, host_type, creds_mapping))
