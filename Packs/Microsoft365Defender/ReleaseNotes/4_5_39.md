...
Updated the field type to **single select**. Possible values are:  
...
- Added the following configuration parameters:  
  - **Comment Entry Tag To Microsoft 365 Defender**: Specify a tag for mirroring Cortex XSOAR entries as comments to Microsoft 365 Defender.  
  ...
  - **Close Mirrored XSOAR Incident**: Allows mirroring closure from Microsoft 365 Defender to Cortex XSOAR.  
  - **Close Mirrored Microsoft 365 Defender Incident**: Allows mirroring closure from Cortex XSOAR to Microsoft 365 Defender.
