...
function CreateUpdateRuleCommand {
    ...
    $name = $kwargs.name
    $safe_links_policy = $kwargs.safe_links_policy
    $comments = $kwargs.comments,
    $enabled = $kwargs.enabled -as [bool]
    $except_if_recipient_domain_is = $kwargs.except_if_recipient_domain_is
    $except_if_sent_to = $kwargs.except_if_sent_to
    $except_if_sent_to_member_of = $kwargs.except_if_sent_to_member_of
    $priority = $kwargs.enable_for_internal_senders -as [Int32]
    $recipient_domain_is = $kwargs.recipient_domain_is
    $sent_to = $kwargs.sent_to
    $sent_to_member_of = $kwargs.sent_to_member_of
