            ...
            "value": [
                {
                    ...
                    "from": {"emailAddress": {"address": "john.doe@company.com", "name": "John Doe"}},
                    "hasAttachments": True,
                    "id": "qwe",
                    "importance": "normal",
                    ...
                    "replyTo": [],
                    "sender": {"emailAddress": {"address": "john.doe@company.com", "name": "John Doe"}},
                    "sentDateTime": "2021-08-20T10:18:40Z",
                    "subject": "Test",
                    "toRecipients": [{"emailAddress": {"address": "mailbox@company.com", "name": "My mailbox"}}],
...
def test_get_email_as_eml(mocker):
    ...
    RAW_RESPONSE = {
        ...
        "sender": {"emailAddress": {"name": "Jon Doe", "address": "you@company.com"}},
        "from": {"emailAddress": {"name": "Jon Doe", "address": "you@company.com"}},
        "toRecipients": [{"emailAddress": {"name": "My", "address": "my@company.com"}}],
        "ccRecipients": [],
        "bccRecipients": [],
        "replyTo": [],
        "flag": {"flagStatus": "notFlagged"},
...
def test_test_module_command_with_managed_identities(mocker, requests_mock, client_id):
    ...
    import MicrosoftGraphListener
    from MicrosoftGraphListener import MANAGED_IDENTITIES_TOKEN_URL, Resources, main
...
class TestCommandsWithLargeAttachments:
    ...
    def test_send_mail_command(self, mocker, client, args):
        ...
        with requests_mock.Mocker() as request_mocker:
            ...
            send_mail_mocker = request_mocker.post(f"https://graph.microsoft.com/v1.0/users/{client._mailbox_to_fetch}/SendMail")
    ...
    @pytest.mark.parametrize(
        "command_args, expected_http_params",
        [
            (
                {"exclude_ids": [], "last_fetch": "2022-12-31T09:38:15Z", "folder_id": "XYZ", "overwrite_rate_limit_retry": True},
                {
                    "method": "GET",
                    "url_suffix": "/users/dummy@mailbox.com/mailFolders/XYZ/messages",
                    "params": {
...
@pytest.mark.parametrize(
    ...
    [
        ("slabiky, ale liší se podle významu", False),
        ("English", True),
        ("ގެ ފުރަތަމަ ދެ އަކުރު ކަ", False),
...
def test_generate_login_url(mocker):
    ...
    import demistomock as demisto
    import MicrosoftGraphListener
    from MicrosoftGraphListener import Scopes, main
