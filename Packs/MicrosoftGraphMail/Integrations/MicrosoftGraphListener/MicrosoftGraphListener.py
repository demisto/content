...
class MsGraphListenerClient(MsGraphClient):
    """
    ...
    def get_emails(self, exclude_ids, last_fetch, folder_id, overwrite_rate_limit_retry=False,
                   fetch_mail_body_as_text: bool = True, mark_emails_as_read: bool = False) -> list:

        results = self.get_emails_from_api(limit=len(exclude_ids) + self._emails_fetch_limit,
                                           received_date_time_filter=last_fetch,
                                           folder_id=folder_id,
                                           overwrite_rate_limit_retry=overwrite_rate_limit_retry,
                                           body_as_text=fetch_mail_body_as_text)
