...
register_module_line('MicrosoftGraphMail', 'start', __line__())
...
# contributing to the integration itself
...
register_module_line('MicrosoftGraphMail', 'end', __line__())
