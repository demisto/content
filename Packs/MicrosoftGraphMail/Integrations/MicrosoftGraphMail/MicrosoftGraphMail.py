...
class MsGraphClient:
    ...
    @staticmethod
    def build_message_to_reply(to_recipients, cc_recipients, bcc_recipients, subject, email_body, body_type, attach_ids,
        ...
        return {
            'message': {
                ...
                'bccRecipients': MsGraphClient._build_recipient_input(bcc_recipients),
                'subject': subject,
                'body': MsGraphClient._build_body_input(body=email_body, body_type=body_type),
...
def reply_email_command(client: MsGraphClient, args):
    ...
    reply = client.build_message_to_reply(email_to, email_cc, email_bcc, email_subject, message_body, body_type,
                                          attach_ids, attach_names, attach_cids)
