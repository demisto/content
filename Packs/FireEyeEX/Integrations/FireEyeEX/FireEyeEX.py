...
def list_allowedlist(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    if not raw_response:
        ...
        md_ = tableToMarkdown(
            name=f"{INTEGRATION_NAME} Allowed lists. showing {limit} of {len(raw_response)}:", t=allowed_list, removeNull=True
        )
...
def create_allowedlist(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    return CommandResults(readable_output=f"Allowedlist entry {entry_value} of type {type_} was created.")
...
def update_allowedlist(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    return CommandResults(readable_output=f"Allowedlist entry {entry_value} of type {type_} was updated.")
...
def delete_allowedlist(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    return CommandResults(readable_output=f"Allowedlist entry {entry_value} of type {type_} was deleted.")
...
def list_blockedlist(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    if not raw_response:
        ...
        md_ = tableToMarkdown(
            name=f"{INTEGRATION_NAME} Blocked lists. showing {limit} of {len(raw_response)}:", t=blocked_list, removeNull=True
        )
...
def create_blockedlist(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    return CommandResults(readable_output=f"Blockedlist entry {entry_value} of type {type_} was created.")
...
def update_blockedlist(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    return CommandResults(readable_output=f"Blockedlist entry {entry_value} of type {type_} was updated.")
...
def delete_blockedlist(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    return CommandResults(readable_output=f"Blockedlist entry {entry_value} of type {type_} was deleted.")
