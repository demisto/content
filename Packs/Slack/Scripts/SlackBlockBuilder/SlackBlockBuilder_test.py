...
BLOCKS_URL = (
    "https://app.slack.com/block-kit-builder/T0DAYMVCM#%7B%22blocks%22:%5B%7B%22type%22:%22section%22,"
...
COMMAND_ARGS = {"channel": "random", "task": "4", "replyEntriesTag": "slackResponse", "persistent": "yes"}
...
def test_block_builder_command_url_return_fail(mocker):
    ...
    def executeCommand(command: str, args: dict[str, Any]) -> list[dict[str, Any]]:
        if command == "getList":
            ...
            return [{"Type": 4, "HumanReadable": None, "Contents": "Could not find any destination to send to."}]
        return []
...
def test_image_id_bug_XSUP_31982(mocker):
    ...
    provided_url = (
        "https://app.slack.com/block-kit-builder/TAT0NDT9A#%7B%22blocks%22:%5B%7B%22type%22:%22section%22,"
        "%22text%22:%7B%22type%22:%22mrkdwn%22,"
