...
- ***Please note:*** in order for a mirrored channel to receive messages within the first five seconds of creation,
  add the `channel_created` scope to your bot event subscriptions.
- Updated Docker image to `devdemisto/slackv3:1.0.0.26959`.