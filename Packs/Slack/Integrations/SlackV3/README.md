...
**Note:** Command slack-send-file isn't available for newly created apps (from May 8, 2024) and will throw an error in case of use, due to changes from the Slack API side.
