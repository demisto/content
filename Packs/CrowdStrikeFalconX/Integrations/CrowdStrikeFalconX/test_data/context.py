...
CHECK_QUOTA_STATUS_CONTEXT = {"csfalconx.resource(val.id && val.id == obj.id)": {"total": 100, "used": 47, "in_progress": 2}}

FIND_SANDBOX_REPORTS_CONTEXT = {
    "csfalconx.resource(val.id && val.id == obj.id)": {"resources": ["resources1", "resources2", "resources3", "resources4"]}
}
...
FIND_SANDBOX_REPORTS_NOT_FOUND_HASH_CONTEXT = {
    "csfalconx.resource(val.id && val.id == obj.id)": {"resources": [], "FindReport": [{"sha256": "hash1", "reportIds": []}]}
}
...
GET_FULL_REPORT_CONTEXT_EXTENDED = {
    ...
    "http_requests": [
        {"header": "header", "host": "host", "host_ip": "111.27.12.67", "host_port": 80, "method": "GET", "url": "url"},
        {"header": "header", "host": "host", "host_ip": "111.27.12.67", "host_port": 80, "method": "GET", "url": "url"},
        {"header": "header", "host": "ocsp.pki.goog", "host_ip": "172.217.7.163", "host_port": 80, "method": "GET", "url": "url"},
        {"header": "header", "host": "ocsp.pki.goog", "host_ip": "172.217.7.163", "host_port": 80, "method": "GET", "url": "url"},
        {"header": "header", "host": "ocsp.pki.goog", "host_ip": "172.217.7.163", "host_port": 80, "method": "GET", "url": "url"},
        {"header": "header", "host": "ocsp.pki.goog", "host_ip": "172.217.7.163", "host_port": 80, "method": "GET", "url": "url"},
        {"header": "header", "host": "ocsp.pki.goog", "host_ip": "172.217.7.163", "host_port": 80, "method": "GET", "url": "url"},
