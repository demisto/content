...
GET_FULL_REPORT_CONTEXT_EXTENDED = {'created_timestamp': '2020-03-16T17:04:48Z',
                                    ...
                                    'sandbox': {'architecture': 'WINDOWS',
                                                ...
                                                'contacted_hosts': [{'address': '0.0.0.0',
...
GET_FULL_REPORT_CONTEXT = {'environment_description': 'Windows 10 64 bit',
                           'environment_id': 160, 'sha256': 'sha256',
                           'submission_type': 'page_url',
                           'submit_url': 'hxxps://www.google.com', 'threat_score': 13,
                           ...
                           'contacted_hosts': [{'address': '0.0.0.0',
                                               ...
                                               {'address': '0.0.0.0',
                                                'associated_runtime': [{'name': 'name.exe', 'pid': 6428}],
                                                'country': 'United States', 'port': 443, 'protocol': 'TCP'}],
                           'dns_requests': [{'address': '3.3.3.3', 'country': 'United States',
                                             'domain': 'example.com',
                                             'registrar_creation_timestamp': '1996-01-16T00:00:00+00:00',
                                             'registrar_name': 'registrar_name',
                                             'registrar_organization': 'registrar_organization'},
                                            {'address': '1.1.1.1', 'country': 'United States',
                                             'domain': 'domain'},
                                            {'address': '0.0.0.0', 'country': 'United States',
                                             'domain': 'dummy2.com',
                                             'registrar_creation_timestamp': '2008-02-11T00:00:00+00:00',
                                             'registrar_name': 'registrar_name',
                                             'registrar_organization': 'Google Inc.'},
                                            {'address': '2.2.2.2', 'country': 'United States',
                                             'domain': 'example2.com',
                                             'registrar_creation_timestamp': '2008-02-11T00:00:00+00:00',
                                             'registrar_name': 'registrar_name',
                                             'registrar_organization': 'registrar_organization'}], 'http_requests': [
        {'header': 'header', 'host': 'host', 'host_ip': '0.0.0.0', 'host_port': 80, 'method': 'GET', 'url': 'url'},
        {'header': 'header', 'host': 'host', 'host_ip': '0.0.0.0', 'host_port': 80, 'method': 'GET', 'url': 'url'},
        {'header': 'header', 'host': 'example.dummy', 'host_ip': '1.1.1.1', 'host_port': 80, 'method': 'GET',
         'url': 'url'},
        {'header': 'header', 'host': 'example.dummy', 'host_ip': '1.1.1.1', 'host_port': 80, 'method': 'GET',
         'url': 'url'},
        {'header': 'header', 'host': 'example.dummy', 'host_ip': '1.1.1.1', 'host_port': 80, 'method': 'GET',
        ...
        {'header': 'header', 'host': 'example.dummy', 'host_ip': '1.1.1.1', 'host_port': 80, 'method': 'GET',
         'url': 'url'},
        {'header': 'header', 'host': 'example.dummy', 'host_ip': '1.1.1.1', 'host_port': 80, 'method': 'GET',
         'url': 'url'}], 'incidents': [{'details': ['Contacts 4 domains and 4 hosts'], 'name': 'Network Behavior'}],
                           'processes': [{'command_line': 'command_line', 'icon_artifact_id': 'icon_artifact_id',
                                          'name': 'rundll32.exe', 'normalized_path': 'normalized_path.exe', 'pid': 6648,
                           ...
                           'screenshots_artifact_ids': ['screenshots_artifact_ids1', 'screenshots_artifact_ids2',
                                                        'screenshots_artifact_ids3', 'screenshots_artifact_ids4'],
                           'created_timestamp': '2020-03-16T17:04:48Z', 'id': 'id',
                           'ioc_report_broad_csv_artifact_id': 'ioc_report_broad_csv_artifact_id',
                           'ioc_report_broad_json_artifact_id': 'ioc_report_broad_json_artifact_id',
                           'ioc_report_broad_maec_artifact_id': 'ioc_report_broad_maec_artifact_id',
                           ...
                           'ioc_report_strict_maec_artifact_id': 'ioc_report_strict_maec_artifact_id',
                           'ioc_report_strict_stix_artifact_id': 'ioc_report_strict_stix_artifact_id',
                           'verdict': 'no specific threat', 'sandbox': {'architecture': 'WINDOWS', 'classification': [
        '91.6% (.URL) Windows URL shortcut', '8.3% (.INI) Generic INI configuration'], 'contacted_hosts': [
        {'address': '0.0.0.0',
         'associated_runtime': [{'name': 'name.exe', 'pid': 6428}, {'name': 'name.exe', 'pid': 9372}],
         'country': 'United States', 'port': 443, 'protocol': 'TCP'}, {'address': '0.0.0.0',
                                                                       'associated_runtime': [
                                                                           {'name': 'name.exe', 'pid': 6428},
                                                                           {'name': 'name.exe', 'pid': 9372}],
                                                                       'country': 'United States', 'port': 80,
                                                                       'protocol': 'TCP'},
        {'address': '0.0.0.0', 'associated_runtime': [{'name': 'name.exe', 'pid': 6428}],
         'country': 'United States', 'port': 443, 'protocol': 'TCP'},
        {'address': '0.0.0.0', 'associated_runtime': [{'name': 'name.exe', 'pid': 6428}],
         'country': 'United States', 'port': 443, 'protocol': 'TCP'},
        {'address': '0.0.0.0', 'associated_runtime': [{'name': 'name.exe', 'pid': 6428}],
        ...
        {'address': '0.0.0.0', 'associated_runtime': [{'name': 'name.exe', 'pid': 6428}],
         'country': 'United States', 'port': 443, 'protocol': 'TCP'},
        {'address': '0.0.0.0', 'associated_runtime': [{'name': 'name.exe', 'pid': 6428}],
         'country': 'United States', 'port': 443, 'protocol': 'TCP'}], 'dns_requests': [
        {'address': '3.3.3.3', 'country': 'United States', 'domain': 'example.com',
         'registrar_creation_timestamp': '1996-01-16T00:00:00+00:00', 'registrar_name': 'registrar_name',
         'registrar_organization': 'registrar_organization'},
        {'address': '1.1.1.1', 'country': 'United States', 'domain': 'domain'},
        {'address': '0.0.0.0', 'country': 'United States', 'domain': 'dummy2.com',
         'registrar_creation_timestamp': '2008-02-11T00:00:00+00:00', 'registrar_name': 'registrar_name',
         'registrar_organization': 'Google Inc.'},
        {'address': '2.2.2.2', 'country': 'United States', 'domain': 'example2.com',
         'registrar_creation_timestamp': '2008-02-11T00:00:00+00:00', 'registrar_name': 'registrar_name',
         'registrar_organization': 'registrar_organization'}], 'http_requests': [
        {'header': 'header', 'host': 'host', 'host_ip': '0.0.0.0', 'host_port': 80, 'method': 'GET', 'url': 'url'},
        {'header': 'header', 'host': 'host', 'host_ip': '0.0.0.0', 'host_port': 80, 'method': 'GET', 'url': 'url'},
