...
- New: Detonate one or more files using the CrowdStrike Falcon Intelligence Sandbox integration. This playbook returns relevant reports to the War Room and file reputations to the context data. (Available from Cortex XSOAR 6.10.0).
...
Email files: MIME RFC 822 .eml, Outlook .msg. (Available from Cortex XSOAR 6.10.0).
