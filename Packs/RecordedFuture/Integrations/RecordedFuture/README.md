...
### recordedfuture-alert-writestatus
***
...
#### Command Example
```!recordedfuture-alert-writestatus alert_id="asdy3l" status="no-action"```
...
#### Command Example
```!recordedfuture-alert-setnote alert_id="asdy3l" note="This is a note we would like to show you"```
