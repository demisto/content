...
| Collective Insights Settings                    | The Recorded Future Intelligence Cloud aggregates data related to indicators, incidents and detections from correlations, driving collective insights to better identify threats. Unattributable data is collected for analytical purposes to identify trends and insights with the Intelligence Cloud. Go to the Recorded Future support site to learn more about [Collective Insights](https://support.recordedfuture.com/hc/en-us/articles/11633413141779).                                                                                                            |
