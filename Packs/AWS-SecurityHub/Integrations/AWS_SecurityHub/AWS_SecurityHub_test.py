...
FILTER_FIELDS_TEST_CASES = [
    ...
    ("name=name,value=value,comparison=comparison", {"name": [{"Value": "value", "Comparison": "COMPARISON"}]}),
    (
        "name=name1,value=value1,comparison=comparison1;name=name2,value=value2,comparison=comparison2",
        {
            "name1": [{"Value": "value1", "Comparison": "COMPARISON1"}],
            "name2": [{"Value": "value2", "Comparison": "COMPARISON2"}],
        },
    ),
    (
...
RESOURCE_IDS_TEST_CASES = [("a,b,c", ["a", "b", "c"]), ("a, b, c", ["a", "b", "c"]), ("", [])]
...
FINDINGS = [
    {
        ...
        "Id": "Id",
        "Severity": {"Product": 0, "Label": "LOW", "Normalized": 0, "Original": "LOW"},
...
class MockClient:
    ...
    def batch_update_findings(self, **kwargs):
        if kwargs["FindingIdentifiers"] == []:
            raise Exception(
                "<class 'botocore.errorfactory.InvalidInputException'> "
...
def test_fetch_incidents_with_filters(mocker):
    ...
    expected_filters = {
        "CreatedAt": [{"Start": "2018-10-24T14:13:20+00:00", "End": "2021-03-14T13:34:14.758295+00:00"}],
        "SeverityLabel": [
            {"Comparison": "EQUALS", "Value": "MEDIUM"},
            {"Comparison": "EQUALS", "Value": "HIGH"},
            {"Comparison": "EQUALS", "Value": "CRITICAL"},
        ],
        "Type": [{"Comparison": "PREFIX", "Value": "Software and Configuration Checks"}],
...
severity_list = [("LOW", 1), ("MEDIUM", 2), ("HIGH", 3), ("CRITICAL", 4), ("INFORMATIONAL", 0)]
...
def test_get_remote_data_command():
    ...
    client = MockClient()
    args = {"id": "Id", "lastUpdate": "2023-02-01T13:30:21.172707565Z"}
...
severity_update = (
    ...
    "ID",
    {"FindingIdentifiers": [{"Id": "ID", "ProductArn": "ProductArn"}], "Severity": {"Label": "LOW"}},
)
...
confidence_update = (
    ...
    "ID",
    {"FindingIdentifiers": [{"Id": "ID", "ProductArn": "ProductArn"}], "Confidence": 1},
)
...
criticality_update = (
    ...
    "ID",
    {"FindingIdentifiers": [{"Id": "ID", "ProductArn": "ProductArn"}], "Criticality": 10},
)
...
comment_update = (
    ...
    "ID",
    {"FindingIdentifiers": [{"Id": "ID", "ProductArn": "ProductArn"}], "Note": {"Text": "test", "UpdatedBy": "admin"}},
)
...
verification_state_update = (
    ...
    "ID",
    {"FindingIdentifiers": [{"Id": "ID", "ProductArn": "ProductArn"}], "VerificationState": "TRUE_POSITIVE"},
)
...
workflow_status_update = (
    ...
    "ID",
    {"FindingIdentifiers": [{"Id": "ID", "ProductArn": "ProductArn"}], "Workflow": {"Status": "NOTIFIED"}},
)
...
test_update_remote_system_command_params = [
    severity_update,
    confidence_update,
    criticality_update,
    comment_update,
