...
- Fixed an issue where commands that still used deprecated Incydr APIs could still be called. Removed the following deprecated command: ***code42-securitydata-search***. Use ***code42-file-events-search*** instead.
