...
- Changed `code42-alert-resolve` to `code42-alert-update`, which can set the alert state to OPEN, CLOSED_TP, or CLOSED_FP
...
- Updated the Docker image to: *demisto/py42:1.0.0.113103*.
