...
@pytest.mark.parametrize("input, expected", [("CVE-2021-44228", True), ("CVEM-2021-44228", False)])
def test_valid_cve_format(input, expected):
    assert valid_cve_format(input) == expected


@pytest.mark.parametrize(
    "response, expected", [(util_load_json("test_data/CVE-2019-0708.json"), (util_load_json("test_data/parsed_Cve.json")))]
)
...
@pytest.mark.parametrize(
    ...
    [
        (
            util_load_json("test_data/CVE-2019-0708.json"),
            ["Windows vista", "Windows 7", "Windows server 2008", "Windows server 2003", "Windows xp", "Microsoft", "CWE-416"],
        )
    ],
)
...
@pytest.mark.parametrize(
    "input, expected", [([{"value": "CVE-2019-0708"}, {"value": "CVE-2019-0708"}], [{"value": "CVE-2019-0708"}])]
)
...
@pytest.mark.parametrize(
    "input, expected", [(util_load_json("test_data/CVE-2019-0708.json"), util_load_json("test_data/indicator.json"))]
)
...
@pytest.mark.parametrize(
    "response, expected, args, mock_url",
    [
        (
            util_load_json("test_data/reports_response.json"),
            CommandResults(
                outputs=[
                    {"id": "KLMHU9EB4N8C", "created_at": "2023-08-02T09:52:47Z", "details": ["microsoft"]},
                    {"id": "NZSBGGBLW4TH", "created_at": "2023-08-02T07:11:31Z", "details": ["microsoft"]},
                ],
        ...
        (
            ...
            CommandResults(
                outputs=util_load_json("test_data/single_report_response.json"), outputs_prefix="OpenCVE.Reports.KLMHU9EB4N8C"
            ),
...
@pytest.mark.parametrize(
    "response, args, expected, mock_url",
    [
        (
            util_load_json("test_data/vendors_specific_vendor.json"),
            {"vendor_name": "paloaltonetworks"},
            CommandResults(
                outputs=util_load_json("test_data/vendors_specific_vendor.json"), outputs_prefix="OpenCVE.paloaltonetworks"
            ),
        ...
        (
            ...
            CommandResults(outputs=util_load_json("test_data/vendors.json"), outputs_prefix="OpenCVE.Vendors"),
...
@pytest.mark.parametrize(
    "response, expected, mock_url",
    [
        (
            util_load_json("test_data/my_vendors.json"),
            CommandResults(outputs=util_load_json("test_data/my_vendors.json"), outputs_prefix="OpenCVE.myVendors"),
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            CommandResults(outputs=util_load_json("test_data/my_products.json"), outputs_prefix="OpenCVE.myProducts"),
...
@pytest.mark.parametrize(
    "input, expected",
    [("HIGH", "High (H)"), ("REQUIRED", "Required (R)"), ("TEMPORARY_FIX", "Temporary Fix (T)"), ("Unknown_key", "Unknown_key")],
)
...
def test_cve_latest_command(expected, requests_mock):
    requests_mock.get("https://www.opencve.io/api/reports", json=util_load_json("test_data/reports_response.json"))
    requests_mock.get(
        "https://www.opencve.io/api/reports/KLMHU9EB4N8C/alerts", json=util_load_json("test_data/KLMHU9EB4N8C_alerts.json")
    )
    requests_mock.get(
        "https://www.opencve.io/api/reports/NZSBGGBLW4TH/alerts", json=util_load_json("test_data/NZSBGGBLW4TH_alerts.json")
    )
    requests_mock.get("https://www.opencve.io/api/cve/CVE-2021-28478", json=util_load_json("test_data/CVE-2021-28478.json"))
    requests_mock.get("https://www.opencve.io/api/cve/CVE-2021-26418", json=util_load_json("test_data/CVE-2021-26418.json"))
...
@pytest.mark.parametrize(
    "args, mock_url, mock_json",
    [
        (
            {"report_id": "KLMHU9EB4N8C", "alert_id": "475fde88-00dc-4024-9499-8197e334dfe7"},
            "https://www.opencve.io/api/reports/KLMHU9EB4N8C/alerts/475fde88-00dc-4024-9499-8197e334dfe7",
            util_load_json("test_data/alert_475fde88-00dc-4024-9499-8197e334dfe7.json"),
        ),
        (
            {"report_id": "KLMHU9EB4N8C"},
...
@pytest.mark.parametrize(
    "args, mock_url, mock_json, expected",
    [
        (
            {"cve": "CVE-2021-26418"},
            "https://www.opencve.io/api/cve/CVE-2021-26418",
...
def test_get_product_cves_command(mocker):
    args = {"vendor_name": "vendor_name", "product_name": "product_name"}
    mocker.patch.object(
        CLIENT,
        "get_cves_by_product_request",
        return_value=[{"id": "CVE", "summary": "summary", "created_at": "created_at", "updated_at": "updated_at"}],
    )
    mocker.patch.object(
        CLIENT,
        "get_cve_request",
