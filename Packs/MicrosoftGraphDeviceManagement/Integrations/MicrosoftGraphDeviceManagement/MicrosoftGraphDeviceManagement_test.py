...
from MicrosoftGraphDeviceManagement import MsGraphClient, build_device_object, find_managed_devices_command, try_parse_integer
...
def test_test_module_command_with_managed_identities(mocker, requests_mock, client_id):
    ...
    from MicrosoftGraphDeviceManagement import MANAGED_IDENTITIES_TOKEN_URL, Resources, main
...
def test_get_managed_device_physical_memory_command(mocker):
    ...
    mocker.patch(
        "MicrosoftGraphDeviceManagement.build_device_object",
        return_value={"ID": "1111111-1111-1111-1111-11111111", "Name": "Test", "PhysicalMemoryInBytes": 1},
    )
    outputs = mocker.patch("MicrosoftGraphDeviceManagement.return_outputs")
...
def test_list_managed_devices__results_with_limit(mocker):
    ...
    client.ms_client = mocker.Mock()
    client.ms_client.http_request.return_value = {"@odata.nextLink": "next_link", "value": ["device1", "device2", "device3"]}
