...
with open(os.path.dirname(__file__) + '/test_data/raw_device.json') as json_file:
    data: dict = json.load(json_file)
    raw_device = data.get('value')

with open(os.path.dirname(__file__) + '/test_data/device_hr.json') as json_file:
    device_hr: dict = json.load(json_file)

with open(os.path.dirname(__file__) + '/test_data/device.json') as json_file:
