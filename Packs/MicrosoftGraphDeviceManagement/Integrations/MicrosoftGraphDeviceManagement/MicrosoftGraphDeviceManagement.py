...
def clean_windows_device_command(client: MsGraphClient, args: dict) -> None:
    keep_user_data: bool = argToBoolean(args.get('keep_user_data'))
    device_id: str = str(args.get('device_id'))
...
def windows_device_defender_scan_command(client: MsGraphClient, args: dict) -> None:
    quick_scan: bool = argToBoolean(args.get('quick_scan'))
    device_id: str = str(args.get('device_id'))
...
def wipe_device_command(client: MsGraphClient, args: dict) -> None:
    keep_enrollment_data: bool = argToBoolean(args.get('keep_enrollment_data'))
    keep_user_data: bool = argToBoolean(args.get('keep_user_data'))
...
def update_windows_device_account_command(client: MsGraphClient, args: dict) -> None:
    ...
    password_rotation_enabled: bool = argToBoolean(args.get('password_rotation_enabled'))
    calendar_sync_enabled: bool = argToBoolean(args.get('calendar_sync_enabled'))
