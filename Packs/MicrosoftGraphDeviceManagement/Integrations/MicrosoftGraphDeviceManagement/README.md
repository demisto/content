...
| page_size | Number of results to return per page. Maximum page size is 1000.<br/>Note: Page size is only relevant when the next_link parameter is not specified. Default is 50. | Optional | 
