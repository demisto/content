...
To allow us access to Microsoft Endpoint Manager, an admin has to approve our app using an admin consent flow by clicking this [link](https://oproxy.demisto.ninja/ms-graph-device-management).
After authorizing the Cortex XSOAR app, you will get an ID, Token, and Key which should be inserted in the relevant integration instance settings fields.
