...
| searchThisWeek | Whether to limit the search to the current week. Disabling this may increase search scope, execution time, and risk of timeout for large mailboxes. Must be "true" or "false". |
