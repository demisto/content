...
| --- | --- | --- |
| ioc_type | The type of the indicator. Possible values are: "sha256", "md5", "domain", "ipv4", and "ipv6". | Required | 
| value | The string representation of the indicator. Can also get comma separated values in order to upload multiple IOCs of the same type but with different values (all other args will be the same for all the newly created IOCs) | Required | 
