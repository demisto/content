...
| BlockMaliciousIOCGlobally | Whether adding to block list is global.<br/>If False, provide an input for the BlockHostGroup input with the group name. | True | Optional |
