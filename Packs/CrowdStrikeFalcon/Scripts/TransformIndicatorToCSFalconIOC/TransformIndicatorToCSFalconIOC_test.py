...
XSOAR_INDICATOR_DOMAIN = [
    {"expiration": "2022-02-10T17:02:59.193836+02:00", "indicator_type": "Domain", "score": 1, "value": "test.com"}
]
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            {"query": "type:File", "action": "no_action", "platforms": "mac", "applied_globally": True},
            XSOAR_INDICATOR_FILE,
            CS_IOC_FILE,
        ),
        (
        ...
        (
            {"query": "type:Domain", "action": "no_action", "platforms": "mac", "applied_globally": True},
            XSOAR_INDICATOR_DOMAIN,
            CS_INDICATOR_DOMAIN,
        ),
        (
            {
                "query": "value:2000:db1:3333:4444:5555:6666:7777:8888",
                "action": "no_action",
                "platforms": "mac",
                "applied_globally": True,
            },
...
def test_get_indicators_by_query_no_indicators(mocker):
    ...
    mocker.patch.object(
        demisto,
        "args",
        return_value={"query": "value=1.2.3.4", "action": "no_action", "platforms": "mac", "applied_globally": True},
    )
