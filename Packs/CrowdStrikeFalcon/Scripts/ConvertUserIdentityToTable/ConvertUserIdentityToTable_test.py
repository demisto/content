from ConvertUserIdentityToTable import *
from pytest_mock import MockerFixture

CONTEXT_RESULTS = '{"key_1": "val_1", "key_2": "val_2", "key_3": "val_3", "key_4": "val_4"}'
...
def test_convert_to_table(mocker: MockerFixture):
    ...
    """
    tableToMarkdown_mocker = mocker.patch("ConvertUserIdentityToTable.tableToMarkdown", side_effect=tableToMarkdown)
