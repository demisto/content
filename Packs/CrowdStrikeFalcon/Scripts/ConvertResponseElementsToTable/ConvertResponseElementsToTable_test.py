...
from ConvertResponseElementsToTable import *
CONTEXT_RESULTS = (
...
def test_convert_to_table(mocker: MockerFixture):
    ...
    """
    tableToMarkdown_mocker = mocker.patch('ConvertResponseElementsToTable.tableToMarkdown', side_effect=tableToMarkdown)
