...
from ConvertResourceAttributesToTable import *
CONTEXT_RESULTS = (
...
def test_convert_to_table(mocker: MockerFixture):
    ...
    """
    tableToMarkdown_mocker = mocker.patch('ConvertResourceAttributesToTable.tableToMarkdown', side_effect=tableToMarkdown)
