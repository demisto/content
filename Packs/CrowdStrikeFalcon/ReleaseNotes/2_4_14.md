...
- Added classifying for the new **CrowdStrike Falcon NGSIEM Case**, **CrowdStrike Falcon NGSIEM Incident**, and **CrowdStrike Falcon NGSIEM Automated Lead** incident types.

#### Incident Fields

##### CrowdStrike Falcon System Product Name

- Added the **CrowdStrike Falcon NGSIEM Case**, **CrowdStrike Falcon NGSIEM Incident**, and **CrowdStrike Falcon NGSIEM Automated Lead** incident types as an associated types.
...
- Added support for **NGSIEM incidents fetch query** parameter.
- Added support for **NGSIEM automated leads fetch query** parameter.
- Added support for **NGSIEM cases fetch query** parameter.
