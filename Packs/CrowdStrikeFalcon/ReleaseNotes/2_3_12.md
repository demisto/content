...
- **Breaking Change**: The legacy-specific status options (in_progress, true_positive, false_positive) have been removed from the ***cs-falcon-resolve-detection*** command, and the following legacy-specific context outputs have been removed from the ***cs-falcon-search-detection*** command:
