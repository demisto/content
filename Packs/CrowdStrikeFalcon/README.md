...
- Mirrors <~XSOAR>incidents</~XSOAR><~XSIAM>events</~XSIAM> between Cortex <~XSOAR>XSOAR incidents</~XSOAR><~XSIAM>XSIAM events</~XSIAM> and CrowdStrike Falcon incidents or detections
