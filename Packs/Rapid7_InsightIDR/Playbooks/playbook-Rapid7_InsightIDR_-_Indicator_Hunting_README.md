...
| InsightIDRdstIP | The name of the fields, in Rapid7 InsightIDR, in which to find the destination IPs. |  | Optional |
| InsightIDRsrcIP | The name of the fields, in Rapid7 InsightIDR, in which to find the source IPs. |  | Optional |
...
| InsightIDRApp | The name of the fields, in Rapid7 InsightIDR, in which to find the application names. |  | Optional |
...
| InsightIDRsrcPort | The name of the fields, in Rapid7 InsightIDR, in which to find the source ports. |  | Optional |
| InsightIDRdstPort | The name of the fields, in Rapid7 InsightIDR, in which to find the destination ports. |  | Optional |
...
| InsightIDRsrcGeolocation | The name of the fields, in Rapid7 InsightIDR, in which to find the source geolocations. |  | Optional |
| InsightIDRSdstGeolocation | The name of the fields, in Rapid7 InsightIDR, in which to find the destination geolocations. |  | Optional |
...
| InsightIDRUserAgent | The name of the fields, in Rapid7 InsightIDR, in which to find the user agents. |  | Optional |
...
| InsightIDRFileType | The name of the fields, in Rapid7 InsightIDR, in which to find the file types. |  | Optional |
...
| InsightIDRFileName | The name of the fields, in Rapid7 InsightIDR, in which to find the file names. |  | Optional |
...
| InsightIDRURLDomain | The name of the fields, in Rapid7 InsightIDR, in which to find the URLs or domains. |  | Optional |
...
| InsightIDRURI | The name of the fields, in Rapid7 InsightIDR, in which to find the URIs. |  | Optional |
...
| InsightIDRSender | The name of the fields, in Rapid7 InsightIDR, in which to find the sender's email addresses. |  | Optional |
...
| InsightIDRHttpMethods | The name of the fields, in Rapid7 InsightIDR, in which to find the HTTP request methods. |  | Optional |
...
| InsightIDRMD5 | The name of the fields, in Rapid7 InsightIDR, in which to find the MD5 hashes. |  | Optional |
...
| InsightIDRSHA256 | The name of the fields, in Rapid7 InsightIDR, in which to find the SHA256 hashes. |  | Optional |
...
| InsightIDRSHA1 | The name of the fields, in Rapid7 InsightIDR, in which to find the SHA1 hashes. |  | Optional |
...
| InsightIDRRegistryValue | The name of the fields, in Rapid7 InsightIDR, in which to find the registry values. |  | Optional |
