...
<h3 id="h_newcommand">17. Set public access prevention for a bucket</h3> <hr> <p>Sets the public access prevention policy for a bucket to either "enforced" or "inherited".</p> <h5>Base Command</h5> <p><code>gcs-block-public-access-bucket</code></p> <h5>Input</h5> <table style="width: 748px;" border="2" cellpadding="6"> <thead> <tr> <th style="width: 184px;"><strong>Argument Name</strong></th> <th style="width: 421px;"><strong>Description</strong></th> <th style="width: 103px;"><strong>Required</strong></th> </tr> </thead> <tbody> <tr> <td style="width: 184px;">bucket_name</td> <td style="width: 421px;">The name of the bucket for which to set public access prevention.</td> <td style="width: 103px;">Required</td> </tr> <tr> <td style="width: 184px;">public_access_prevention</td> <td style="width: 421px;">The public access prevention policy to set. Must be either "enforced" or "inherited".</td> <td style="width: 103px;">Required</td> </tr> </tbody> </table> <p> </p> <h5>Context Output</h5> <table style="width: 748px;" border="2" cellpadding="6"> <thead> <tr> <th style="width: 280px;"><strong>Path</strong></th> <th style="width: 67px;"><strong>Type</strong></th> <th style="width: 361px;"><strong>Description</strong></th> </tr> </thead> <tbody> <tr> <td style="width: 280px;">GCS.Bucket.PublicAccessPrevention</td> <td style="width: 67px;">String</td> <td style="width: 361px;">Public access prevention policy of the bucket.</td> </tr> <tr> <td style="width: 280px;">GCS.Bucket.Name</td> <td style="width: 67px;">String</td> <td style="width: 361px;">The name of the bucket.</td> </tr> </tbody> </table> <p> </p> <h5>Command Example</h5> <pre>gcs-block-public-access-bucket bucket_name=my-bucket public_access_prevention=enforced</pre> <h5>Human Readable Output</h5> <h3>Public Access Prevention set for bucket: my-bucket</h3> <p>The public access prevention policy for the bucket "my-bucket" has been set to "enforced".</p>
