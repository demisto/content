 ...
 * [Cortex XSOAR Application](https://xsoar.pan.dev/docs/reference/articles/microsoft-integrations---authentication#cortex-xsoar-application) (Cortex XSOAR - MS Graph Calendar)
...
After authorizing the Cortex XSOAR app, you will get an ID, Token, and Key which need to be added to the relevant integration instance settings fields.
