# Configure an API account in Google Calendar
...
Provide the https://www.googleapis.com/auth/calendar scope to execute the ***google-calendar-acl-list*** and ***google-calendar-acl-add*** commands.
