# Configure an API account on Google Calendar
...
Provide https://www.googleapis.com/auth/calendar scope to execute google-calendar-acl-list and google-calendar-add command.
