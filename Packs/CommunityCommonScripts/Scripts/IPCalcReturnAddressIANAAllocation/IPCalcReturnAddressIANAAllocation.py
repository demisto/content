...
def return_address_info_command(args: Dict[str, Any]) -> CommandResults:
    ...
    info_object = {"address": ip_address, "allocation": address_info}

    readable_output = tableToMarkdown(t=info_object, name="Iana Allocation")

    return CommandResults(
        outputs_prefix="IPCalc.IP.Allocation", outputs_key_field="", readable_output=readable_output, outputs=info_object
    )
