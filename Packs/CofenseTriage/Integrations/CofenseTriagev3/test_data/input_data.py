...
create_threat_indicators_cmd_arg = [
    ...
    ({"threat_level": "1", "threat_type": "a", "threat_value": ""}, MESSAGES["REQUIRED_ARGUMENT"].format("threat_value")),
]
...
check_fetch_incident_configuration_args = [
    ...
    (
        {"filter[location]": "Inbox", "filter[categorization_tags]": "test"},
        {},
        MESSAGES["INVALID_LOCATION_FOR_CATEGORIZATION_TAGS"],
    ),
    ({"filter[location]": "Processed", "filter[tags]": "test"}, {}, MESSAGES["INVALID_LOCATION_FOR_TAGS"]),
    ({"filter[location]": "Inbox"}, {"category_id": 2}, MESSAGES["INVALID_LOCATION_FOR_CATEGORY_ID"]),
]
