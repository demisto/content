...
def main() -> None:
    ...
    creds_mapping = {"password": "api_token"}
    ...
    try:
        if command == "test-module":
            ...
            return_results(generic_ansible("HCloud", "hcloud_datacenter_info", args, int_params, host_type, creds_mapping))
        elif command == "hcloud-floating-ip-info":
            return_results(generic_ansible("HCloud", "hcloud_floating_ip_info", args, int_params, host_type, creds_mapping))
            ...
            return_results(generic_ansible("HCloud", "hcloud_location_info", args, int_params, host_type, creds_mapping))
            ...
            return_results(generic_ansible("HCloud", "hcloud_server_network", args, int_params, host_type, creds_mapping))
        elif command == "hcloud-server-type-info":
            return_results(generic_ansible("HCloud", "hcloud_server_type_info", args, int_params, host_type, creds_mapping))
