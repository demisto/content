...
- Updated the status_id argument in the **get-issue-list** command to status now it will handle both an ID and a predefined status.
- Updated the **redmine-issue-create** to not have a status_id argument since the API uses a default status.