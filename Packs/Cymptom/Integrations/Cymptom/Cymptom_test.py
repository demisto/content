...
MOCK_GET_MITIGATIONS_API_RESPONSE = {
    "totalVectors": 399,
...
MOCK_GET_MITIGATION_BY_ID_API_RESPONSE = {
    "id": 3824,
    "name": "Brute Force",
    "references": [
    ...
    "subtechniques": [
        {
            ...
            "details": {
                ...
                "metadata": {
                    ...
                    "malwares": ["China Chopper", "Pony", "SpeakUp", "Emotet", "Xbash"],
                    "tools": [],
            ...
            "evidence": ["<sources>'s and <targets>'s passwords were cracked using dictionaries of common passwords"],
            "vectorCount": 33,
            "procedures": [{"vectorCount": 33, "severity": {"name": "medium", "percentage": 8.27, "value": 33}}],
            "recommendations": [
                {
                    "id": 1187,
        ...
        },
        {
            ...
            "evidence": ["<sources> and <targets>'s password hashes were found identical"],
            "vectorCount": 155,
            "procedures": [{"vectorCount": 11, "severity": {"name": "low", "percentage": 2.76, "value": 11}}],
            "recommendations": [
                {
                    "id": 1190,
                    "name": "Account Use Policies",
        ...
        },
        {
            ...
            "evidence": ["<sources> and <targets>'s password hashes were found identical"],
            "vectorCount": 155,
            "procedures": [{"vectorCount": 5, "severity": {"name": "low", "percentage": 1.25, "value": 5}}],
            "recommendations": [
                {
                    "id": 1190,
                    "name": "Account Use Policies",
        ...
        },
        {
            ...
            "evidence": ["<sources> and <targets>'s password hashes were found identical"],
            "vectorCount": 155,
            "procedures": [{"vectorCount": 139, "severity": {"name": "critical", "percentage": 34.84, "value": 139}}],
            "recommendations": [
                {
                    "id": 1190,
                    "name": "Account Use Policies",
...
MOCK_GET_MITIGATIONS_SUBTECHNIQUE_PROCEDURE_BY_ID_API_RESPONSE = [
    {
        "id": 4635,
        "vectorCount": 33,
        "sources": [{"name": "tal", "id": 3997, "labels": ["WindowsObject", "User", "Domain"]}],
        "targets": [{"name": "amber", "id": 11379, "labels": ["WindowsObject", "User", "Domain"]}],
        "cause": {"name": "Aa123456", "id": 5766, "labels": ["Password", "Cracked"]},
        "severity": {"name": "medium", "percentage": 8.27, "value": 33},
        "state": "open",
        "ticket": None,
    }
]
...
MOCK_GET_MITIGATIONS_RESPONSE = [
    {
        ...
        "Name": "Brute Force",
        "Severity Type": "High",
        "Attack Vectors Use Percentage": 11.78,
        "Attack Vectors Count": 188,
        "Procedures": [
            {"name": "Password Guessing-5766", "state": "open"},
            {"name": "Password Spraying-5766", "state": "open"},
            {"name": "Password Spraying-5772", "state": "open"},
        ...
        "Techniques": ["User Account Management", "Multi-factor Authentication", "Account Use Policies", "Password Policies"],
        "Sub Techniques": [
            {
                "id": 356,
                "name": "Password Guessing",
...
def create_mitigations_requests_mocks(requests_mock):
    ...
    requests_mock.get(
        MOCK_BASE_URL + "mitigations/subtechnique-procedures/356",
