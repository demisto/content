...
class Client:
    ...
    def aggregate_allow_list_request(
        self,
        msa_aggregatequeryrequest_date_ranges,
        msa_aggregatequeryrequest_field,
        msa_aggregatequeryrequest_filter,
        msa_aggregatequeryrequest_interval,
        msa_aggregatequeryrequest_min_doc_count,
        msa_aggregatequeryrequest_missing,
        msa_aggregatequeryrequest_name,
        msa_aggregatequeryrequest_q,
        msa_aggregatequeryrequest_ranges,
        msa_aggregatequeryrequest_size,
        msa_aggregatequeryrequest_sort,
        msa_aggregatequeryrequest_sub_aggregates,
        msa_aggregatequeryrequest_time_zone,
        msa_aggregatequeryrequest_type,
    ):
        data = assign_params(
            date_ranges=msa_aggregatequeryrequest_date_ranges,
            field=msa_aggregatequeryrequest_field,
            filter=msa_aggregatequeryrequest_filter,
            interval=msa_aggregatequeryrequest_interval,
            min_doc_count=msa_aggregatequeryrequest_min_doc_count,
            missing=msa_aggregatequeryrequest_missing,
            name=msa_aggregatequeryrequest_name,
            q=msa_aggregatequeryrequest_q,
            ranges=msa_aggregatequeryrequest_ranges,
            size=msa_aggregatequeryrequest_size,
            sort=msa_aggregatequeryrequest_sort,
            sub_aggregates=msa_aggregatequeryrequest_sub_aggregates,
            time_zone=msa_aggregatequeryrequest_time_zone,
            type=msa_aggregatequeryrequest_type,
        )
    ...
    def aggregate_block_list_request(
        self,
        msa_aggregatequeryrequest_date_ranges,
        msa_aggregatequeryrequest_field,
        msa_aggregatequeryrequest_filter,
    ...
    def aggregate_detections_request(
        self,
        msa_aggregatequeryrequest_date_ranges,
        msa_aggregatequeryrequest_field,
        msa_aggregatequeryrequest_filter,
    ...
    def aggregate_device_count_collection_request(
        self,
        msa_aggregatequeryrequest_date_ranges,
        msa_aggregatequeryrequest_field,
        msa_aggregatequeryrequest_filter,
    ...
    def aggregate_notificationsv1_request(
        self,
        msa_aggregatequeryrequest_date_ranges,
        msa_aggregatequeryrequest_field,
        msa_aggregatequeryrequest_filter,
    ...
    def aggregate_remediations_request(
        self,
        msa_aggregatequeryrequest_date_ranges,
        msa_aggregatequeryrequest_field,
        msa_aggregatequeryrequest_filter,
    ...
    def aggregateevents_request(
        self,
        fwmgr_msa_aggregatequeryrequest_date_ranges,
        fwmgr_msa_aggregatequeryrequest_field,
        fwmgr_msa_aggregatequeryrequest_filter,
        fwmgr_msa_aggregatequeryrequest_interval,
        fwmgr_msa_aggregatequeryrequest_min_doc_count,
        fwmgr_msa_aggregatequeryrequest_missing,
        fwmgr_msa_aggregatequeryrequest_name,
        fwmgr_msa_aggregatequeryrequest_q,
        fwmgr_msa_aggregatequeryrequest_ranges,
        fwmgr_msa_aggregatequeryrequest_size,
        fwmgr_msa_aggregatequeryrequest_sort,
        fwmgr_msa_aggregatequeryrequest_sub_aggregates,
        fwmgr_msa_aggregatequeryrequest_time_zone,
        fwmgr_msa_aggregatequeryrequest_type,
    ):
        data = assign_params(
            date_ranges=fwmgr_msa_aggregatequeryrequest_date_ranges,
            field=fwmgr_msa_aggregatequeryrequest_field,
            filter=fwmgr_msa_aggregatequeryrequest_filter,
            interval=fwmgr_msa_aggregatequeryrequest_interval,
            min_doc_count=fwmgr_msa_aggregatequeryrequest_min_doc_count,
            missing=fwmgr_msa_aggregatequeryrequest_missing,
            name=fwmgr_msa_aggregatequeryrequest_name,
            q=fwmgr_msa_aggregatequeryrequest_q,
            ranges=fwmgr_msa_aggregatequeryrequest_ranges,
            size=fwmgr_msa_aggregatequeryrequest_size,
            sort=fwmgr_msa_aggregatequeryrequest_sort,
            sub_aggregates=fwmgr_msa_aggregatequeryrequest_sub_aggregates,
            time_zone=fwmgr_msa_aggregatequeryrequest_time_zone,
            type=fwmgr_msa_aggregatequeryrequest_type,
        )
    ...
    def aggregaterulegroups_request(
        self,
        fwmgr_msa_aggregatequeryrequest_date_ranges,
        fwmgr_msa_aggregatequeryrequest_field,
        fwmgr_msa_aggregatequeryrequest_filter,
    ...
    def apipreemptproxypostgraphql_request(
        self,
    ):
        headers = self.cs_client._headers
    ...
    def batch_active_responder_cmd_request(
        self,
        timeout,
        timeout_duration,
        domain_batchexecutecommandrequest_base_command,
        domain_batchexecutecommandrequest_batch_id,
        domain_batchexecutecommandrequest_command_string,
        domain_batchexecutecommandrequest_optional_hosts,
        domain_batchexecutecommandrequest_persist_all,
    ):
        params = assign_params(timeout=timeout, timeout_duration=timeout_duration)
        data = assign_params(
            base_command=domain_batchexecutecommandrequest_base_command,
            batch_id=domain_batchexecutecommandrequest_batch_id,
            command_string=domain_batchexecutecommandrequest_command_string,
            optional_hosts=domain_batchexecutecommandrequest_optional_hosts,
    ...
    def batch_get_cmd_request(
        self,
        timeout,
        timeout_duration,
        domain_batchgetcommandrequest_batch_id,
        domain_batchgetcommandrequest_file_path,
        domain_batchgetcommandrequest_optional_hosts,
    ):
        params = assign_params(timeout=timeout, timeout_duration=timeout_duration)
        data = assign_params(
            batch_id=domain_batchgetcommandrequest_batch_id,
            file_path=domain_batchgetcommandrequest_file_path,
            optional_hosts=domain_batchgetcommandrequest_optional_hosts,
        )
    ...
    def batch_init_sessions_request(
        self,
        timeout,
        timeout_duration,
        domain_batchinitsessionrequest_existing_batch_id,
        domain_batchinitsessionrequest_host_ids,
        domain_batchinitsessionrequest_queue_offline,
    ):
        params = assign_params(timeout=timeout, timeout_duration=timeout_duration)
        data = assign_params(
            existing_batch_id=domain_batchinitsessionrequest_existing_batch_id,
            host_ids=domain_batchinitsessionrequest_host_ids,
    ...
    def batch_refresh_sessions_request(
        self,
        timeout,
        timeout_duration,
        domain_batchrefreshsessionrequest_batch_id,
        domain_batchrefreshsessionrequest_hosts_to_remove,
    ):
        params = assign_params(timeout=timeout, timeout_duration=timeout_duration)
        data = assign_params(
            batch_id=domain_batchrefreshsessionrequest_batch_id, hosts_to_remove=domain_batchrefreshsessionrequest_hosts_to_remove
        )
    ...
    def create_firewall_policies_request(self, requests_createfirewallpoliciesv1_resources, clone_id):
        ...
        response = self.cs_client.http_request(
            "post", "policy/entities/firewall/v1", params=params, json_data=data, headers=headers
        )
    ...
    def create_rulesv1_request(
        self,
        sadomain_createrulerequestv1_filter,
        sadomain_createrulerequestv1_name,
        sadomain_createrulerequestv1_permissions,
        sadomain_createrulerequestv1_priority,
        sadomain_createrulerequestv1_topic,
    ):
        data = assign_params(
            filter=sadomain_createrulerequestv1_filter,
            name=sadomain_createrulerequestv1_name,
            permissions=sadomain_createrulerequestv1_permissions,
            priority=sadomain_createrulerequestv1_priority,
            topic=sadomain_createrulerequestv1_topic,
        )
    ...
    def create_user_request(
        self,
        domain_usercreaterequest_firstname,
        domain_usercreaterequest_lastname,
        domain_usercreaterequest_password,
        domain_usercreaterequest_uid,
    ):
        data = assign_params(
            firstName=domain_usercreaterequest_firstname,
            lastName=domain_usercreaterequest_lastname,
            password=domain_usercreaterequest_password,
            uid=domain_usercreaterequest_uid,
        )
    ...
    def createioc_request(
        self,
        api_iocviewrecord_batch_id,
        api_iocviewrecord_created_by,
        api_iocviewrecord_created_timestamp,
        api_iocviewrecord_description,
        api_iocviewrecord_expiration_days,
        api_iocviewrecord_expiration_timestamp,
        api_iocviewrecord_modified_by,
        api_iocviewrecord_modified_timestamp,
        api_iocviewrecord_policy,
        api_iocviewrecord_share_level,
        api_iocviewrecord_source,
        api_iocviewrecord_type,
        api_iocviewrecord_value,
    ):
        data = assign_params(
            batch_id=api_iocviewrecord_batch_id,
            created_by=api_iocviewrecord_created_by,
            created_timestamp=api_iocviewrecord_created_timestamp,
            description=api_iocviewrecord_description,
            expiration_days=api_iocviewrecord_expiration_days,
            expiration_timestamp=api_iocviewrecord_expiration_timestamp,
            modified_by=api_iocviewrecord_modified_by,
            modified_timestamp=api_iocviewrecord_modified_timestamp,
            policy=api_iocviewrecord_policy,
            share_level=api_iocviewrecord_share_level,
            source=api_iocviewrecord_source,
            type=api_iocviewrecord_type,
            value=api_iocviewrecord_value,
        )
    ...
    def createml_exclusionsv1_request(
        self,
        requests_mlexclusioncreatereqv1_comment,
        requests_mlexclusioncreatereqv1_excluded_from,
        requests_mlexclusioncreatereqv1_groups,
        requests_mlexclusioncreatereqv1_value,
    ):
        data = assign_params(
            comment=requests_mlexclusioncreatereqv1_comment,
            excluded_from=requests_mlexclusioncreatereqv1_excluded_from,
            groups=requests_mlexclusioncreatereqv1_groups,
            value=requests_mlexclusioncreatereqv1_value,
        )
    ...
    def createrule_request(
        self,
        api_rulecreatev1_comment,
        api_rulecreatev1_description,
        api_rulecreatev1_disposition_id,
        api_rulecreatev1_field_values,
        api_rulecreatev1_name,
        api_rulecreatev1_pattern_severity,
        api_rulecreatev1_rulegroup_id,
        api_rulecreatev1_ruletype_id,
    ):
        data = assign_params(
            comment=api_rulecreatev1_comment,
            description=api_rulecreatev1_description,
            disposition_id=api_rulecreatev1_disposition_id,
            field_values=api_rulecreatev1_field_values,
            name=api_rulecreatev1_name,
            pattern_severity=api_rulecreatev1_pattern_severity,
            rulegroup_id=api_rulecreatev1_rulegroup_id,
            ruletype_id=api_rulecreatev1_ruletype_id,
        )
    ...
    def createrulegroup_request(
        self,
        clone_id,
        li_ary,
        comment,
        fwmgr_api_rulegroupcreaterequestv1_description,
        fwmgr_api_rulegroupcreaterequestv1_enabled,
        fwmgr_api_rulegroupcreaterequestv1_name,
        fwmgr_api_rulegroupcreaterequestv1_rules,
    ):
        params = assign_params(clone_id=clone_id, li_ary=li_ary, comment=comment)
        data = assign_params(
            description=fwmgr_api_rulegroupcreaterequestv1_description,
            enabled=fwmgr_api_rulegroupcreaterequestv1_enabled,
            name=fwmgr_api_rulegroupcreaterequestv1_name,
            rules=fwmgr_api_rulegroupcreaterequestv1_rules,
        )

        headers = self.cs_client._headers

        response = self.cs_client.http_request(
            "post", "fwmgr/entities/rule-groups/v1", params=params, json_data=data, headers=headers
        )

        return response

    def createrulegroup_mixin0_request(
        self,
        api_rulegroupcreaterequestv1_comment,
        api_rulegroupcreaterequestv1_description,
        api_rulegroupcreaterequestv1_name,
        api_rulegroupcreaterequestv1_platform,
    ):
        data = assign_params(
            comment=api_rulegroupcreaterequestv1_comment,
            description=api_rulegroupcreaterequestv1_description,
            name=api_rulegroupcreaterequestv1_name,
            platform=api_rulegroupcreaterequestv1_platform,
        )
    ...
    def createsv_exclusionsv1_request(
        self,
        requests_svexclusioncreatereqv1_comment,
        requests_svexclusioncreatereqv1_groups,
        requests_svexclusioncreatereqv1_value,
    ):
        data = assign_params(
            comment=requests_svexclusioncreatereqv1_comment,
            groups=requests_svexclusioncreatereqv1_groups,
            value=requests_svexclusioncreatereqv1_value,
        )
    ...
    def download_sensor_installer_by_id_request(self, id_):
        ...
        response = self.cs_client.http_request(
            "get", "sensors/entities/download-installer/v1", params=params, headers=headers, resp_type="response"
        )
    ...
    def get_aggregate_detects_request(
        self,
        msa_aggregatequeryrequest_date_ranges,
        msa_aggregatequeryrequest_field,
        msa_aggregatequeryrequest_filter,
    ...
    def get_device_login_history_request(self, ids):
        ...
        headers = self.cs_client._headers
        response = self.cs_client.http_request(
            "post", "devices/combined/devices/login-history/v1", json_data=data, headers=headers
        )
    ...
    def get_device_network_history_request(self, ids):
        ...
        headers = self.cs_client._headers
        response = self.cs_client.http_request(
            "post", "devices/combined/devices/network-address-history/v1", json_data=data, headers=headers
        )
    ...
    def get_scans_aggregates_request(
        self,
        msa_aggregatequeryrequest_date_ranges,
        msa_aggregatequeryrequest_field,
        msa_aggregatequeryrequest_filter,
    ...
    def getioa_users_request(self, policy_id, cloud_provider, account_id, azure_tenant_id):
        params = assign_params(
            policy_id=policy_id, cloud_provider=cloud_provider, account_id=account_id, azure_tenant_id=azure_tenant_id
        )
    ...
    def grant_user_role_ids_request(self, user_uuid, domain_roleids_roleids):
        ...
        response = self.cs_client.http_request(
            "post", "user-roles/entities/user-roles/v1", params=params, json_data=data, headers=headers
        )
    ...
    def indicatorcreatev1_request(
        self, retrodetects, ignore_warnings, api_indicatorcreatereqsv1_comment, api_indicatorcreatereqsv1_indicators
    ):
        ...
        response = self.cs_client.http_request(
            "post", "iocs/entities/indicators/v1", params=params, json_data=data, headers=headers
        )
    ...
    def indicatorupdatev1_request(
        self,
        retrodetects,
        ignore_warnings,
        api_indicatorupdatereqsv1_bulk_update,
        api_indicatorupdatereqsv1_comment,
        api_indicatorupdatereqsv1_indicators,
    ):
        params = assign_params(retrodetects=retrodetects, ignore_warnings=ignore_warnings)
        data = assign_params(
            bulk_update=api_indicatorupdatereqsv1_bulk_update,
            comment=api_indicatorupdatereqsv1_comment,
            indicators=api_indicatorupdatereqsv1_indicators,
        )

        headers = self.cs_client._headers

        response = self.cs_client.http_request(
            "patch", "iocs/entities/indicators/v1", params=params, json_data=data, headers=headers
        )
    ...
    def perform_actionv2_request(self, action_name, msa_entityactionrequestv2_action__meters, msa_entityactionrequestv2_ids):
        ...
        response = self.cs_client.http_request(
            "post", "devices/entities/devices-actions/v2", params=params, json_data=data, headers=headers
        )

        return response

    def perform_device_control_policies_action_request(
        self, action_name, msa_entityactionrequestv2_action__meters, msa_entityactionrequestv2_ids
    ):
        params = assign_params(action_name=action_name)
        data = assign_params(action__meters=msa_entityactionrequestv2_action__meters, ids=msa_entityactionrequestv2_ids)
        ...
        response = self.cs_client.http_request(
            "post", "policy/entities/device-control-actions/v1", params=params, json_data=data, headers=headers
        )

        return response

    def perform_firewall_policies_action_request(
        self, action_name, msa_entityactionrequestv2_action__meters, msa_entityactionrequestv2_ids
    ):
        params = assign_params(action_name=action_name)
        data = assign_params(action__meters=msa_entityactionrequestv2_action__meters, ids=msa_entityactionrequestv2_ids)
        ...
        response = self.cs_client.http_request(
            "post", "policy/entities/firewall-actions/v1", params=params, json_data=data, headers=headers
        )
    ...
    def perform_group_action_request(self, action_name, msa_entityactionrequestv2_action__meters, msa_entityactionrequestv2_ids):
        ...
        response = self.cs_client.http_request(
            "post", "devices/entities/host-group-actions/v1", params=params, json_data=data, headers=headers
        )
    ...
    def perform_prevention_policies_action_request(
        self, action_name, msa_entityactionrequestv2_action__meters, msa_entityactionrequestv2_ids
    ):
        params = assign_params(action_name=action_name)
        data = assign_params(action__meters=msa_entityactionrequestv2_action__meters, ids=msa_entityactionrequestv2_ids)
        ...
        response = self.cs_client.http_request(
            "post", "policy/entities/prevention-actions/v1", params=params, json_data=data, headers=headers
        )

        return response

    def perform_sensor_update_policies_action_request(
        self, action_name, msa_entityactionrequestv2_action__meters, msa_entityactionrequestv2_ids
    ):
        params = assign_params(action_name=action_name)
        data = assign_params(action__meters=msa_entityactionrequestv2_action__meters, ids=msa_entityactionrequestv2_ids)
        ...
        response = self.cs_client.http_request(
            "post", "policy/entities/sensor-update-actions/v1", params=params, json_data=data, headers=headers
        )

        return response

    def performrt_response_policies_action_request(
        self, action_name, msa_entityactionrequestv2_action__meters, msa_entityactionrequestv2_ids
    ):
        params = assign_params(action_name=action_name)
        data = assign_params(action__meters=msa_entityactionrequestv2_action__meters, ids=msa_entityactionrequestv2_ids)
        ...
        response = self.cs_client.http_request(
            "post", "policy/entities/response-actions/v1", params=params, json_data=data, headers=headers
        )
    ...
    def post_mal_query_exact_searchv1_request(
        self, malquery_externalexactsearchparametersv1_options, malquery_externalexactsearchparametersv1_patterns
    ):
        data = assign_params(
            options=malquery_externalexactsearchparametersv1_options, patterns=malquery_externalexactsearchparametersv1_patterns
        )
    ...
    def post_mal_query_fuzzy_searchv1_request(
        self, malquery_fuzzysearchparametersv1_options, malquery_fuzzysearchparametersv1_patterns
    ):
    ...
    def post_mal_query_huntv1_request(
        self, malquery_externalhuntparametersv1_options, malquery_externalhuntparametersv1_yara_rule
    ):
        data = assign_params(
            options=malquery_externalhuntparametersv1_options, yara_rule=malquery_externalhuntparametersv1_yara_rule
        )
    ...
    def provisionaws_accounts_request(self, mode, models_createawsaccountsv1_resources):
        ...
        response = self.cs_client.http_request(
            "post", "cloud-connect-aws/entities/accounts/v1", params=params, json_data=data, headers=headers
        )
    ...
    def query_intel_rule_ids_request(
        self, offset, limit, sort, name, type_, description, tags, min_created_date, max_created_date, q
    ):
        params = assign_params(
            offset=offset,
            limit=limit,
    ...
    def query_roles_request(self, user_group_id, cid_group_id, role_id, sort, offset, limit):
        params = assign_params(
            user_group_id=user_group_id, cid_group_id=cid_group_id, role_id=role_id, sort=sort, offset=offset, limit=limit
        )
    ...
    def queryio_cs_request(
        self,
        types,
        values,
        from_expiration_timestamp,
        to_expiration_timestamp,
        policies,
        sources,
        share_levels,
        created_by,
        ...
        params = assign_params(
            types=types,
            values=values,
            from_expiration_timestamp=from_expiration_timestamp,
            to_expiration_timestamp=to_expiration_timestamp,
            policies=policies,
            sources=sources,
    ...
    def reveal_uninstall_token_request(
        self, requests_revealuninstalltokenv1_audit_message, requests_revealuninstalltokenv1_device_id
    ):
        data = assign_params(
            audit_message=requests_revealuninstalltokenv1_audit_message, device_id=requests_revealuninstalltokenv1_device_id
        )
    ...
    def rtr_aggregate_sessions_request(
        self,
        msa_aggregatequeryrequest_date_ranges,
        msa_aggregatequeryrequest_field,
        msa_aggregatequeryrequest_filter,
    ...
    def rtr_execute_active_responder_command_request(
        self,
        domain_commandexecuterequest_base_command,
        domain_commandexecuterequest_command_string,
        domain_commandexecuterequest_device_id,
        domain_commandexecuterequest_id,
        domain_commandexecuterequest_persist,
        domain_commandexecuterequest_session_id,
    ):
        data = assign_params(
            base_command=domain_commandexecuterequest_base_command,
            command_string=domain_commandexecuterequest_command_string,
            device_id=domain_commandexecuterequest_device_id,
            id=domain_commandexecuterequest_id,
            persist=domain_commandexecuterequest_persist,
            session_id=domain_commandexecuterequest_session_id,
        )
    ...
    def rtr_execute_admin_command_request(
        self,
        domain_commandexecuterequest_base_command,
        domain_commandexecuterequest_command_string,
        domain_commandexecuterequest_device_id,
    ...
    def rtr_execute_command_request(
        self,
        domain_commandexecuterequest_base_command,
        domain_commandexecuterequest_command_string,
        domain_commandexecuterequest_device_id,
    ...
    def rtr_init_session_request(self, domain_initrequest_device_id, domain_initrequest_origin, domain_initrequest_queue_offline):
        data = assign_params(
            device_id=domain_initrequest_device_id,
            origin=domain_initrequest_origin,
    ...
    def rtr_pulse_session_request(
        self, domain_initrequest_device_id, domain_initrequest_origin, domain_initrequest_queue_offline
    ):
        data = assign_params(
            device_id=domain_initrequest_device_id,
            origin=domain_initrequest_origin,
    ...
    def rtr_update_scripts_request(
        self, id_, file, description, name, comments_for_audit_log, permission_type, content, platform
    ):
        data = assign_params(
            id=id_,
            file=file,
    ...
    def set_device_control_policies_precedence_request(
        self, requests_setpolicyprecedencereqv1_ids, requests_setpolicyprecedencereqv1_platform_name
    ):
        data = assign_params(
            ids=requests_setpolicyprecedencereqv1_ids, platform_name=requests_setpolicyprecedencereqv1_platform_name
        )
    ...
    def set_firewall_policies_precedence_request(
        self, requests_setpolicyprecedencereqv1_ids, requests_setpolicyprecedencereqv1_platform_name
    ):
        data = assign_params(
            ids=requests_setpolicyprecedencereqv1_ids, platform_name=requests_setpolicyprecedencereqv1_platform_name
    ...
    def set_prevention_policies_precedence_request(
        self, requests_setpolicyprecedencereqv1_ids, requests_setpolicyprecedencereqv1_platform_name
    ):
        data = assign_params(
            ids=requests_setpolicyprecedencereqv1_ids, platform_name=requests_setpolicyprecedencereqv1_platform_name
    ...
    def set_sensor_update_policies_precedence_request(
        self, requests_setpolicyprecedencereqv1_ids, requests_setpolicyprecedencereqv1_platform_name
    ):
        data = assign_params(
            ids=requests_setpolicyprecedencereqv1_ids, platform_name=requests_setpolicyprecedencereqv1_platform_name
    ...
    def setrt_response_policies_precedence_request(
        self, requests_setpolicyprecedencereqv1_ids, requests_setpolicyprecedencereqv1_platform_name
    ):
        data = assign_params(
            ids=requests_setpolicyprecedencereqv1_ids, platform_name=requests_setpolicyprecedencereqv1_platform_name
    ...
    def tokenscreate_request(
        self, api_tokencreaterequestv1_expires_timestamp, api_tokencreaterequestv1_label, api_tokencreaterequestv1_type
    ):
        data = assign_params(
            expires_timestamp=api_tokencreaterequestv1_expires_timestamp,
            label=api_tokencreaterequestv1_label,
            type=api_tokencreaterequestv1_type,
        )
    ...
    def tokensupdate_request(
        self, ids, api_tokenpatchrequestv1_expires_timestamp, api_tokenpatchrequestv1_label, api_tokenpatchrequestv1_revoked
    ):
        params = assign_params(ids=ids)
        data = assign_params(
            expires_timestamp=api_tokenpatchrequestv1_expires_timestamp,
            label=api_tokenpatchrequestv1_label,
            revoked=api_tokenpatchrequestv1_revoked,
        )

        headers = self.cs_client._headers

        response = self.cs_client.http_request(
            "patch", "installation-tokens/entities/tokens/v1", params=params, json_data=data, headers=headers
        )
    ...
    def update_actionv1_request(
        self,
        domain_updateactionrequest_frequency,
        domain_updateactionrequest_id,
        domain_updateactionrequest_recipients,
        domain_updateactionrequest_status,
    ):
        data = assign_params(
            frequency=domain_updateactionrequest_frequency,
            id=domain_updateactionrequest_id,
            recipients=domain_updateactionrequest_recipients,
            status=domain_updateactionrequest_status,
        )
    ...
    def update_detects_by_idsv2_request(
        self,
        domain_detectsentitiespatchrequest_assigned_to_uuid,
        domain_detectsentitiespatchrequest_comment,
        domain_detectsentitiespatchrequest_ids,
        domain_detectsentitiespatchrequest_show_in_ui,
        domain_detectsentitiespatchrequest_status,
    ):
        data = assign_params(
            assigned_to_uuid=domain_detectsentitiespatchrequest_assigned_to_uuid,
            comment=domain_detectsentitiespatchrequest_comment,
            ids=domain_detectsentitiespatchrequest_ids,
            show_in_ui=domain_detectsentitiespatchrequest_show_in_ui,
            status=domain_detectsentitiespatchrequest_status,
        )
    ...
    def update_device_tags_request(
        self,
        domain_updatedevicetagsrequestv1_action,
        domain_updatedevicetagsrequestv1_device_ids,
        domain_updatedevicetagsrequestv1_tags,
    ):
        data = assign_params(
            action=domain_updatedevicetagsrequestv1_action,
    ...
    def update_notificationsv1_request(
        self,
        domain_updatenotificationrequestv1_assigned_to_uuid,
    ...
    def update_rulesv1_request(
        self,
        domain_updaterulerequestv1_filter,
        domain_updaterulerequestv1_id,
        domain_updaterulerequestv1_name,
        domain_updaterulerequestv1_permissions,
        domain_updaterulerequestv1_priority,
    ):
        data = [
            assign_params(
                filter=domain_updaterulerequestv1_filter,
                id=domain_updaterulerequestv1_id,
                name=domain_updaterulerequestv1_name,
                permissions=domain_updaterulerequestv1_permissions,
                priority=domain_updaterulerequestv1_priority,
            )
        ]
    ...
    def update_sensor_visibility_exclusionsv1_request(
        self,
        requests_svexclusionupdatereqv1_comment,
        requests_svexclusionupdatereqv1_groups,
        requests_svexclusionupdatereqv1_id,
        requests_svexclusionupdatereqv1_value,
    ):
        data = assign_params(
            comment=requests_svexclusionupdatereqv1_comment,
            groups=requests_svexclusionupdatereqv1_groups,
            id=requests_svexclusionupdatereqv1_id,
            value=requests_svexclusionupdatereqv1_value,
        )
    ...
    def updateioa_exclusionsv1_request(
        self,
        requests_ioaexclusionupdatereqv1_cl_regex,
        requests_ioaexclusionupdatereqv1_comment,
        requests_ioaexclusionupdatereqv1_description,
        requests_ioaexclusionupdatereqv1_detection_json,
        requests_ioaexclusionupdatereqv1_groups,
        requests_ioaexclusionupdatereqv1_id,
        requests_ioaexclusionupdatereqv1_ifn_regex,
        requests_ioaexclusionupdatereqv1_name,
        requests_ioaexclusionupdatereqv1_pattern_id,
        requests_ioaexclusionupdatereqv1_pattern_name,
    ):
        data = assign_params(
            cl_regex=requests_ioaexclusionupdatereqv1_cl_regex,
            comment=requests_ioaexclusionupdatereqv1_comment,
            description=requests_ioaexclusionupdatereqv1_description,
            detection_json=requests_ioaexclusionupdatereqv1_detection_json,
            groups=requests_ioaexclusionupdatereqv1_groups,
            id=requests_ioaexclusionupdatereqv1_id,
            ifn_regex=requests_ioaexclusionupdatereqv1_ifn_regex,
            name=requests_ioaexclusionupdatereqv1_name,
            pattern_id=requests_ioaexclusionupdatereqv1_pattern_id,
            pattern_name=requests_ioaexclusionupdatereqv1_pattern_name,
        )
    ...
    def updateioc_request(
        ...
        response = self.cs_client.http_request(
            "patch", "indicators/entities/iocs/v1", params=params, json_data=data, headers=headers
        )

        return response

    def updateml_exclusionsv1_request(
        self,
        requests_svexclusionupdatereqv1_comment,
        requests_svexclusionupdatereqv1_groups,
        requests_svexclusionupdatereqv1_id,
    ...
    def updatepolicycontainer_request(
        self,
        fwmgr_api_policycontainerupsertrequestv1_default_inbound,
        fwmgr_api_policycontainerupsertrequestv1_default_outbound,
        fwmgr_api_policycontainerupsertrequestv1_enforce,
        fwmgr_api_policycontainerupsertrequestv1_is_default_policy,
        fwmgr_api_policycontainerupsertrequestv1_platform_id,
        fwmgr_api_policycontainerupsertrequestv1_policy_id,
        fwmgr_api_policycontainerupsertrequestv1_rule_group_ids,
        fwmgr_api_policycontainerupsertrequestv1_test_mode,
        fwmgr_api_policycontainerupsertrequestv1_tracking,
    ):
        data = assign_params(
            default_inbound=fwmgr_api_policycontainerupsertrequestv1_default_inbound,
            default_outbound=fwmgr_api_policycontainerupsertrequestv1_default_outbound,
            enforce=fwmgr_api_policycontainerupsertrequestv1_enforce,
            is_default_policy=fwmgr_api_policycontainerupsertrequestv1_is_default_policy,
            platform_id=fwmgr_api_policycontainerupsertrequestv1_platform_id,
            policy_id=fwmgr_api_policycontainerupsertrequestv1_policy_id,
            rule_group_ids=fwmgr_api_policycontainerupsertrequestv1_rule_group_ids,
            test_mode=fwmgr_api_policycontainerupsertrequestv1_test_mode,
            tracking=fwmgr_api_policycontainerupsertrequestv1_tracking,
        )
    ...
    def updaterulegroup_request(
        self,
        comment,
        fwmgr_api_rulegroupmodifyrequestv1_diff_operations,
        fwmgr_api_rulegroupmodifyrequestv1_diff_type,
        fwmgr_api_rulegroupmodifyrequestv1_id,
        fwmgr_api_rulegroupmodifyrequestv1_rule_ids,
        fwmgr_api_rulegroupmodifyrequestv1_rule_versions,
        fwmgr_api_rulegroupmodifyrequestv1_tracking,
    ):
        params = assign_params(comment=comment)
        data = assign_params(
            diff_operations=fwmgr_api_rulegroupmodifyrequestv1_diff_operations,
            diff_type=fwmgr_api_rulegroupmodifyrequestv1_diff_type,
            id=fwmgr_api_rulegroupmodifyrequestv1_id,
            rule_ids=fwmgr_api_rulegroupmodifyrequestv1_rule_ids,
            rule_versions=fwmgr_api_rulegroupmodifyrequestv1_rule_versions,
        ...
        response = self.cs_client.http_request(
            "patch", "fwmgr/entities/rule-groups/v1", params=params, json_data=data, headers=headers
        )

        return response

    def updaterulegroup_mixin0_request(
        self,
        api_rulegroupmodifyrequestv1_comment,
        api_rulegroupmodifyrequestv1_description,
        api_rulegroupmodifyrequestv1_enabled,
        api_rulegroupmodifyrequestv1_id,
        api_rulegroupmodifyrequestv1_name,
        api_rulegroupmodifyrequestv1_rulegroup_version,
    ):
        data = assign_params(
            comment=api_rulegroupmodifyrequestv1_comment,
            description=api_rulegroupmodifyrequestv1_description,
            enabled=api_rulegroupmodifyrequestv1_enabled,
            id=api_rulegroupmodifyrequestv1_id,
            name=api_rulegroupmodifyrequestv1_name,
            rulegroup_version=api_rulegroupmodifyrequestv1_rulegroup_version,
        )
    ...
    def updaterules_request(
        self,
        api_ruleupdatesrequestv1_comment,
        api_ruleupdatesrequestv1_rule_updates,
        api_ruleupdatesrequestv1_rulegroup_id,
        api_ruleupdatesrequestv1_rulegroup_version,
    ):
        data = assign_params(
            comment=api_ruleupdatesrequestv1_comment,
            rule_updates=api_ruleupdatesrequestv1_rule_updates,
            rulegroup_id=api_ruleupdatesrequestv1_rulegroup_id,
    ...
    def upload_samplev2_request(self, body, upfile, file_name, comment, is_confidential):
        ...
        response = self.cs_client.http_request(
            "post", "samples/entities/samples/v2", params=params, json_data=data, headers=headers
        )
    ...
    def upload_samplev3_request(self, body, upfile, file_name, comment, is_confidential):
        ...
        response = self.cs_client.http_request(
            "post", "samples/entities/samples/v3", params=params, json_data=data, headers=headers
        )
...
def add_role_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.domainMSSPRoleResponseV1", outputs_key_field="", outputs=response, raw_response=response
    )
...
def aggregate_allow_list_command(client, args):
    ...
    response = client.aggregate_allow_list_request(
        msa_aggregatequeryrequest_date_ranges,
        msa_aggregatequeryrequest_field,
        msa_aggregatequeryrequest_filter,
        msa_aggregatequeryrequest_interval,
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.msaAggregatesResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def aggregate_block_list_command(client, args):
    ...
    response = client.aggregate_block_list_request(
        msa_aggregatequeryrequest_date_ranges,
        msa_aggregatequeryrequest_field,
        msa_aggregatequeryrequest_filter,
        msa_aggregatequeryrequest_interval,
...
def aggregate_detections_command(client, args):
    ...
    response = client.aggregate_detections_request(
        msa_aggregatequeryrequest_date_ranges,
        msa_aggregatequeryrequest_field,
        msa_aggregatequeryrequest_filter,
        msa_aggregatequeryrequest_interval,
...
def aggregate_device_count_collection_command(client, args):
    ...
    response = client.aggregate_device_count_collection_request(
        msa_aggregatequeryrequest_date_ranges,
        msa_aggregatequeryrequest_field,
        msa_aggregatequeryrequest_filter,
        msa_aggregatequeryrequest_interval,
...
def aggregate_notificationsv1_command(client, args):
    ...
    response = client.aggregate_notificationsv1_request(
        msa_aggregatequeryrequest_date_ranges,
        msa_aggregatequeryrequest_field,
        msa_aggregatequeryrequest_filter,
        msa_aggregatequeryrequest_interval,
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.domainAggregatesResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def aggregateevents_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.fwmgrapiAggregatesResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def aggregatefc_incidents_command(client, args):
    ...
    response = client.aggregatefc_incidents_request(
        msa_aggregatequeryrequest_date_ranges,
        msa_aggregatequeryrequest_field,
        msa_aggregatequeryrequest_filter,
        msa_aggregatequeryrequest_interval,
...
def aggregatepolicyrules_command(client, args):
    ...
    response = client.aggregatepolicyrules_request(
        fwmgr_msa_aggregatequeryrequest_date_ranges,
        fwmgr_msa_aggregatequeryrequest_field,
        fwmgr_msa_aggregatequeryrequest_filter,
        fwmgr_msa_aggregatequeryrequest_interval,
...
def aggregaterulegroups_command(client, args):
    ...
    response = client.aggregaterulegroups_request(
        fwmgr_msa_aggregatequeryrequest_date_ranges,
        fwmgr_msa_aggregatequeryrequest_field,
        fwmgr_msa_aggregatequeryrequest_filter,
        fwmgr_msa_aggregatequeryrequest_interval,
...
def aggregaterules_command(client, args):
    ...
    response = client.aggregaterules_request(
        fwmgr_msa_aggregatequeryrequest_date_ranges,
        fwmgr_msa_aggregatequeryrequest_field,
        fwmgr_msa_aggregatequeryrequest_filter,
        fwmgr_msa_aggregatequeryrequest_interval,
...
def aggregates_detections_global_counts_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.msaFacetsResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def aggregates_events_command(client, args):
    ...
    response = client.aggregates_events_request(
        msa_aggregatequeryrequest_date_ranges,
        msa_aggregatequeryrequest_field,
        msa_aggregatequeryrequest_filter,
        msa_aggregatequeryrequest_interval,
...
def aggregates_events_collections_command(client, args):
    ...
    response = client.aggregates_events_collections_request(
        msa_aggregatequeryrequest_date_ranges,
        msa_aggregatequeryrequest_field,
        msa_aggregatequeryrequest_filter,
        msa_aggregatequeryrequest_interval,
...
def apipreemptproxypostgraphql_command(client, args):
    ...
    command_results = CommandResults(outputs_prefix="CrowdStrike", outputs_key_field="", outputs=response, raw_response=response)
...
def auditeventsquery_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.msaQueryResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def auditeventsread_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.apiauditEventDetailsResponseV1", outputs_key_field="", outputs=response, raw_response=response
    )
...
def batch_active_responder_cmd_command(client, args):
    ...
    response = client.batch_active_responder_cmd_request(
        timeout,
        timeout_duration,
        domain_batchexecutecommandrequest_base_command,
        domain_batchexecutecommandrequest_batch_id,
...
def batch_admin_cmd_command(client, args):
    ...
    response = client.batch_admin_cmd_request(
        timeout,
        timeout_duration,
        domain_batchexecutecommandrequest_base_command,
        domain_batchexecutecommandrequest_batch_id,
...
def batch_cmd_command(client, args):
    ...
    response = client.batch_cmd_request(
        timeout,
        timeout_duration,
        domain_batchexecutecommandrequest_base_command,
        domain_batchexecutecommandrequest_batch_id,
...
def batch_get_cmd_command(client, args):
    ...
    response = client.batch_get_cmd_request(
        timeout,
        timeout_duration,
        domain_batchgetcommandrequest_batch_id,
        domain_batchgetcommandrequest_file_path,
...
def batch_init_sessions_command(client, args):
    ...
    response = client.batch_init_sessions_request(
        timeout,
        timeout_duration,
        domain_batchinitsessionrequest_existing_batch_id,
        domain_batchinitsessionrequest_host_ids,
...
def create_actionsv1_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.domainActionEntitiesResponseV1", outputs_key_field="", outputs=response, raw_response=response
    )
...
def create_rulesv1_command(client, args):
    ...
    response = client.create_rulesv1_request(
        sadomain_createrulerequestv1_filter,
        sadomain_createrulerequestv1_name,
        sadomain_createrulerequestv1_permissions,
        sadomain_createrulerequestv1_priority,
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.domainRulesEntitiesResponseV1", outputs_key_field="", outputs=response, raw_response=response
    )
...
def create_user_groups_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.domainUserGroupsResponseV1", outputs_key_field="", outputs=response, raw_response=response
    )
...
def createcid_groups_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.domainCIDGroupsResponseV1", outputs_key_field="", outputs=response, raw_response=response
    )
...
def createioc_command(client, args):
    ...
    response = client.createioc_request(
        api_iocviewrecord_batch_id,
        api_iocviewrecord_created_by,
        api_iocviewrecord_created_timestamp,
        api_iocviewrecord_description,
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.apiMsaReplyIOC", outputs_key_field="", outputs=response, raw_response=response
    )
...
def createml_exclusionsv1_command(client, args):
    ...
    response = client.createml_exclusionsv1_request(
        requests_mlexclusioncreatereqv1_comment,
        requests_mlexclusioncreatereqv1_excluded_from,
        requests_mlexclusioncreatereqv1_groups,
        requests_mlexclusioncreatereqv1_value,
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.responsesMlExclusionRespV1", outputs_key_field="", outputs=response, raw_response=response
    )
...
def createrule_command(client, args):
    ...
    response = client.createrule_request(
        api_rulecreatev1_comment,
        api_rulecreatev1_description,
        api_rulecreatev1_disposition_id,
        api_rulecreatev1_field_values,
...
def createrulegroup_command(client, args):
    ...
    response = client.createrulegroup_request(
        clone_id,
        li_ary,
        comment,
        fwmgr_api_rulegroupcreaterequestv1_description,
...
def crowd_score_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.apiMsaEnvironmentScoreResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def customersettingsread_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.apicustomerSettingsResponseV1", outputs_key_field="", outputs=response, raw_response=response
    )
...
def delete_actionv1_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.domainQueryResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def delete_notificationsv1_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.domainNotificationIDResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def delete_rulesv1_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.domainRuleQueryResponseV1", outputs_key_field="", outputs=response, raw_response=response
    )
...
def delete_user_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.msaReplyMetaOnly", outputs_key_field="", outputs=response, raw_response=response
    )
...
def delete_user_groups_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.msaEntitiesResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def deleteaws_accounts_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.modelsBaseResponseV1", outputs_key_field="", outputs=response, raw_response=response
    )
...
def deleteaws_accounts_mixin0_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.msaMetaInfo", outputs_key_field="", outputs=response, raw_response=response
    )
...
def deletecspm_aws_account_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.registrationBaseResponseV1", outputs_key_field="", outputs=response, raw_response=response
    )
...
def deleterulegroups_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.fwmgrapiQueryResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def devices_count_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.apiMsaReplyIOCDevicesCount", outputs_key_field="", outputs=response, raw_response=response
    )
...
def devices_ran_on_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.apiMsaReplyDevicesRanOn", outputs_key_field="", outputs=response, raw_response=response
    )
...
def download_sensor_installer_by_id_command(client, args):
    ...
    try:
        ...
        demisto.debug(f"Failed extracting filename from response headers - [{err!s}]")
...
def entitiesprocesses_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.apiMsaProcessDetailResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def get_aggregate_detects_command(client, args):
    ...
    response = client.get_aggregate_detects_request(
        msa_aggregatequeryrequest_date_ranges,
        msa_aggregatequeryrequest_field,
        msa_aggregatequeryrequest_filter,
        msa_aggregatequeryrequest_interval,
...
def get_assessmentv1_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.domainAssessmentsResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def get_behaviors_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.apiMsaExternalBehaviorResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def get_children_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.domainChildrenResponseV1", outputs_key_field="", outputs=response, raw_response=response
    )
...
def get_clusters_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.k8sregGetClustersResp", outputs_key_field="", outputs=response, raw_response=response
    )
...
def get_combined_sensor_installers_by_query_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.domainSensorInstallersV1", outputs_key_field="", outputs=response, raw_response=response
    )
...
def get_device_login_history_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.deviceHistoryLogin", outputs_key_field="", outputs=response, raw_response=response
    )
...
def get_device_network_history_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.deviceNetworkHistory", outputs_key_field="", outputs=response, raw_response=response
    )
...
def get_firewall_policies_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.responsesFirewallPoliciesV1", outputs_key_field="", outputs=response, raw_response=response
    )
...
def get_helm_values_yaml_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.k8sregHelmYAMLResp", outputs_key_field="", outputs=response, raw_response=response
    )
...
def get_host_groups_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.responsesHostGroupsV1", outputs_key_field="", outputs=response, raw_response=response
    )
...
def get_incidents_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.apiMsaExternalIncidentResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def get_intel_actor_entities_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.domainActorsResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def get_intel_report_entities_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.domainNewsResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def get_intel_rule_entities_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.domainRulesResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def get_locations_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.k8sregGetLocationsResp", outputs_key_field="", outputs=response, raw_response=response
    )
...
def get_mal_query_metadatav1_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.malquerySampleMetadataResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def get_mal_query_quotasv1_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.malqueryRateLimitsResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def get_mal_query_requestv1_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.malqueryRequestResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def get_prevention_policies_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.responsesPreventionPoliciesV1", outputs_key_field="", outputs=response, raw_response=response
    )
...
def get_reports_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.falconxReportV1Response", outputs_key_field="", outputs=response, raw_response=response
    )
...
def get_roles_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.domainUserRoleResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def get_scans_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.mlscannerScanV1Response", outputs_key_field="", outputs=response, raw_response=response
    )
...
def get_scans_aggregates_command(client, args):
    ...
    response = client.get_scans_aggregates_request(
        msa_aggregatequeryrequest_date_ranges,
        msa_aggregatequeryrequest_field,
        msa_aggregatequeryrequest_filter,
        msa_aggregatequeryrequest_interval,
...
def get_sensor_visibility_exclusionsv1_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.responsesSvExclusionRespV1", outputs_key_field="", outputs=response, raw_response=response
    )
...
def get_submissions_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.falconxSubmissionV1Response", outputs_key_field="", outputs=response, raw_response=response
    )
...
def get_summary_reports_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.falconxSummaryReportV1Response", outputs_key_field="", outputs=response, raw_response=response
    )
...
def getaws_accounts_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.modelsAWSAccountsV1", outputs_key_field="", outputs=response, raw_response=response
    )
...
def getaws_accounts_mixin0_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.k8sregGetAWSAccountsResp", outputs_key_field="", outputs=response, raw_response=response
    )
...
def getaws_settings_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.modelsCustomerConfigurationsV1", outputs_key_field="", outputs=response, raw_response=response
    )
...
def getcspm_policy_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.registrationPolicyResponseV1", outputs_key_field="", outputs=response, raw_response=response
    )
...
def getevents_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.fwmgrapiEventsResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def getfirewallfields_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.fwmgrapiFirewallFieldsResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def getioa_exclusionsv1_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.responsesIoaExclusionRespV1", outputs_key_field="", outputs=response, raw_response=response
    )
...
def getioa_users_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.registrationIOAUserResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def getpatterns_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.apiPatternsResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def getplatforms_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.fwmgrapiPlatformsResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def getplatforms_mixin0_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.apiPlatformsResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def getrt_response_policies_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.responsesRTResponsePoliciesV1", outputs_key_field="", outputs=response, raw_response=response
    )
...
def getrulegroups_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.fwmgrapiRuleGroupsResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def getrulegroups_mixin0_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.apiRuleGroupsResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def getrules_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.fwmgrapiRulesResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def getrules_mixin0_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.apiRulesResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def getruletypes_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.apiRuleTypesResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def grant_user_role_ids_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.domainUserRoleIDsResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def indicatorcombinedv1_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.apiIndicatorRespV1", outputs_key_field="", outputs=response, raw_response=response
    )
...
def indicatorcreatev1_command(client, args):
    ...
    response = client.indicatorcreatev1_request(
        retrodetects, ignore_warnings, api_indicatorcreatereqsv1_comment, api_indicatorcreatereqsv1_indicators
    )
    command_results = CommandResults(outputs_prefix="CrowdStrike", outputs_key_field="", outputs=response, raw_response=response)
...
def indicatordeletev1_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.apiIndicatorQueryResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def indicatorsearchv1_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.apiIndicatorQueryRespV1", outputs_key_field="", outputs=response, raw_response=response
    )
...
def indicatorupdatev1_command(client, args):
    ...
    api_indicatorupdatereqsv1_bulk_update = assign_params(
        action=api_indicatorupdatereqsv1_bulk_update_action,
        applied_globally=api_indicatorupdatereqsv1_bulk_update_applied_globally,
        description=api_indicatorupdatereqsv1_bulk_update_description,
        expiration=api_indicatorupdatereqsv1_bulk_update_expiration,
        filter=api_indicatorupdatereqsv1_bulk_update_filter,
        host_groups=api_indicatorupdatereqsv1_bulk_update_host_groups,
        mobile_action=api_indicatorupdatereqsv1_bulk_update_mobile_action,
        platforms=api_indicatorupdatereqsv1_bulk_update_platforms,
        severity=api_indicatorupdatereqsv1_bulk_update_severity,
        source=api_indicatorupdatereqsv1_bulk_update_source,
    ...
    response = client.indicatorupdatev1_request(
        retrodetects,
        ignore_warnings,
        api_indicatorupdatereqsv1_bulk_update,
        api_indicatorupdatereqsv1_comment,
...
def list_available_streamso_auth2_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.maindiscoveryResponseV2", outputs_key_field="", outputs=response, raw_response=response
    )
...
def post_mal_query_entities_samples_multidownloadv1_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.malqueryExternalQueryResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def post_mal_query_exact_searchv1_command(client, args):
    ...
    malquery_externalexactsearchparametersv1_options = assign_params(
        filter_filetypes=malquery_externalexactsearchparametersv1_options_filter_filetypes,
        filter_meta=malquery_externalexactsearchparametersv1_options_filter_meta,
        limit=malquery_externalexactsearchparametersv1_options_limit,
        max_date=malquery_externalexactsearchparametersv1_options_max_date,
        max_size=malquery_externalexactsearchparametersv1_options_max_size,
        min_date=malquery_externalexactsearchparametersv1_options_min_date,
        min_size=malquery_externalexactsearchparametersv1_options_min_size,
    )
...
def post_mal_query_fuzzy_searchv1_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.malqueryFuzzySearchResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def post_mal_query_huntv1_command(client, args):
    ...
    malquery_externalhuntparametersv1_options = assign_params(
        filter_filetypes=malquery_externalhuntparametersv1_options_filter_filetypes,
        filter_meta=malquery_externalhuntparametersv1_options_filter_meta,
        limit=malquery_externalhuntparametersv1_options_limit,
        max_date=malquery_externalhuntparametersv1_options_max_date,
        max_size=malquery_externalhuntparametersv1_options_max_size,
        min_date=malquery_externalhuntparametersv1_options_min_date,
...
def processes_ran_on_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.apiMsaReplyProcessesRanOn", outputs_key_field="", outputs=response, raw_response=response
    )
...
def query_combined_device_control_policy_members_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.responsesPolicyMembersRespV1", outputs_key_field="", outputs=response, raw_response=response
    )
...
def query_combined_group_members_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.responsesHostGroupMembersV1", outputs_key_field="", outputs=response, raw_response=response
    )
...
def query_combined_sensor_update_builds_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.responsesSensorUpdateBuildsV1", outputs_key_field="", outputs=response, raw_response=response
    )
...
def query_devices_by_filter_scroll_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.domainDeviceResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def query_incidents_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.apiMsaIncidentQueryResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def query_submissions_mixin0_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.mlscannerQueryResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def queryfirewallfields_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.fwmgrmsaQueryResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def queryio_cs_command(client, args):
    ...
    response = client.queryio_cs_request(
        types,
        values,
        from_expiration_timestamp,
        to_expiration_timestamp,
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.apiMsaReplyIOCIDs", outputs_key_field="", outputs=response, raw_response=response
    )
...
def regenerateapi_key_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.k8sregRegenAPIKeyResp", outputs_key_field="", outputs=response, raw_response=response
    )
...
def retrieve_user_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.domainUserMetaDataResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def rtr_aggregate_sessions_command(client, args):
    ...
    response = client.rtr_aggregate_sessions_request(
        msa_aggregatequeryrequest_date_ranges,
        msa_aggregatequeryrequest_field,
        msa_aggregatequeryrequest_filter,
        msa_aggregatequeryrequest_interval,
...
def rtr_check_active_responder_command_status_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.domainStatusResponseWrapper", outputs_key_field="", outputs=response, raw_response=response
    )
...
def rtr_execute_active_responder_command_command(client, args):
    ...
    response = client.rtr_execute_active_responder_command_request(
        domain_commandexecuterequest_base_command,
        domain_commandexecuterequest_command_string,
        domain_commandexecuterequest_device_id,
        domain_commandexecuterequest_id,
...
def rtr_execute_admin_command_command(client, args):
    ...
    response = client.rtr_execute_admin_command_request(
        domain_commandexecuterequest_base_command,
        domain_commandexecuterequest_command_string,
        domain_commandexecuterequest_device_id,
        domain_commandexecuterequest_id,
...
def rtr_execute_command_command(client, args):
    ...
    response = client.rtr_execute_command_request(
        domain_commandexecuterequest_base_command,
        domain_commandexecuterequest_command_string,
        domain_commandexecuterequest_device_id,
        domain_commandexecuterequest_id,
...
def rtr_get_put_files_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.binservclientMsaPFResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def rtr_list_all_sessions_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.domainListSessionsResponseMsa", outputs_key_field="", outputs=response, raw_response=response
    )
...
def rtr_list_files_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.domainListFilesResponseWrapper", outputs_key_field="", outputs=response, raw_response=response
    )
...
def rtr_list_sessions_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.domainSessionResponseWrapper", outputs_key_field="", outputs=response, raw_response=response
    )
...
def tokenscreate_command(client, args):
    ...
    response = client.tokenscreate_request(
        api_tokencreaterequestv1_expires_timestamp, api_tokencreaterequestv1_label, api_tokencreaterequestv1_type
    )
    command_results = CommandResults(outputs_prefix="CrowdStrike", outputs_key_field="", outputs=response, raw_response=response)
...
def tokensread_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.apitokenDetailsResponseV1", outputs_key_field="", outputs=response, raw_response=response
    )
...
def tokensupdate_command(client, args):
    ...
    response = client.tokensupdate_request(
        ids, api_tokenpatchrequestv1_expires_timestamp, api_tokenpatchrequestv1_label, api_tokenpatchrequestv1_revoked
    )
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.msaQueryResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def update_actionv1_command(client, args):
    ...
    response = client.update_actionv1_request(
        domain_updateactionrequest_frequency,
        domain_updateactionrequest_id,
        domain_updateactionrequest_recipients,
        domain_updateactionrequest_status,
...
def update_detects_by_idsv2_command(client, args):
    ...
    response = client.update_detects_by_idsv2_request(
        domain_detectsentitiespatchrequest_assigned_to_uuid,
        domain_detectsentitiespatchrequest_comment,
        domain_detectsentitiespatchrequest_ids,
        domain_detectsentitiespatchrequest_show_in_ui,
...
def update_device_tags_command(client, args):
    ...
    response = client.update_device_tags_request(
        domain_updatedevicetagsrequestv1_action,
        domain_updatedevicetagsrequestv1_device_ids,
        domain_updatedevicetagsrequestv1_tags,
    )
...
def update_rulesv1_command(client, args):
    ...
    response = client.update_rulesv1_request(
        domain_updaterulerequestv1_filter,
        domain_updaterulerequestv1_id,
        domain_updaterulerequestv1_name,
        domain_updaterulerequestv1_permissions,
...
def updateaws_account_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.msaBaseEntitiesResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def updateioa_exclusionsv1_command(client, args):
    ...
    response = client.updateioa_exclusionsv1_request(
        requests_ioaexclusionupdatereqv1_cl_regex,
        requests_ioaexclusionupdatereqv1_comment,
        requests_ioaexclusionupdatereqv1_description,
        requests_ioaexclusionupdatereqv1_detection_json,
...
def updatepolicycontainer_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.fwmgrmsaReplyMetaOnly", outputs_key_field="", outputs=response, raw_response=response
    )
...
def updaterulegroup_command(client, args):
    ...
    response = client.updaterulegroup_request(
        comment,
        fwmgr_api_rulegroupmodifyrequestv1_diff_operations,
        fwmgr_api_rulegroupmodifyrequestv1_diff_type,
        fwmgr_api_rulegroupmodifyrequestv1_id,
...
def updaterulegroup_mixin0_command(client, args):
    ...
    response = client.updaterulegroup_mixin0_request(
        api_rulegroupmodifyrequestv1_comment,
        api_rulegroupmodifyrequestv1_description,
        api_rulegroupmodifyrequestv1_enabled,
        api_rulegroupmodifyrequestv1_id,
...
def updaterules_command(client, args):
    ...
    response = client.updaterules_request(
        api_ruleupdatesrequestv1_comment,
        api_ruleupdatesrequestv1_rule_updates,
        api_ruleupdatesrequestv1_rulegroup_id,
        api_ruleupdatesrequestv1_rulegroup_version,
...
def validate_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.apiValidationResponseV1", outputs_key_field="", outputs=response, raw_response=response
    )
...
def verifyaws_account_access_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="CrowdStrike.modelsVerifyAccessResponseV1", outputs_key_field="", outputs=response, raw_response=response
    )
...
def main():
    ...
    try:
        ...
        return_error(f"Failed to execute {command} command. Error: {e!s}", e)
