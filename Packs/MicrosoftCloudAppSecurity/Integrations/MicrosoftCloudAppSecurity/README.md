...
2. Search for MicrosoftCloudAppSecurity.
 Click **Add instance** to create and configure a new integration instance.
    ...
    |------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------| --- | --- |
    | Server URL \(e.g., https://example.net\) | The server URL used to connect (In the security center, go to Settings >> Clod Apps >> About tab, the API URL is displayed)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | True |
