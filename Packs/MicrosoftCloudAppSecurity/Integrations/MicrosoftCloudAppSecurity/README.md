...
>|---|---|---|---|---|---|---|
>| 60edead2cdbeaf0b87e13377 | 2021-07-13T16:18:15.126000 | Impossible travel activity | <p>The user John Example (john@example.onmicrosoft.com) perform failed sign in activities from remote locations that are considered an impossible travel activity.<br/>The user performed failed sign in activities from 1.2.3.6 in Netherlands and 188.120.142.178 in Israel within 96 minutes.<br/>If these are IP addresses that are known and safe, add them in the <a href="#/subnet">IP address range page</a> to improve the accuracy of the alerts.</p> | N/A | Medium | true |
