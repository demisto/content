...
2. Search for MicrosoftCloudAppSecurity.
 Click **Add instance** to create and configure a new integration instance.
    ...
    |------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------| --- | --- |
    | Server URL \(e.g., https://example.net\) | The server URL used to connect (Select Settings from the left pane >> Select Clod Apps >> In the ‘About’ tab, the API URL should be displayed)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | True |
