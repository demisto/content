...
def parser(
    ...
    return date_obj.replace(tzinfo=datetime.UTC)
...
def fetch_incidents(
    ...
    last_fetch_time = from_time.replace(tzinfo=datetime.UTC)
    ...
    for record in records:
        ...
        incident_created_time = incident_created_time.replace(tzinfo=datetime.UTC)
...
def get_fetch_time(last_fetch: dict, first_fetch_time: str) -> datetime:
    ...
    start_fetch.replace(tzinfo=datetime.UTC)
    return start_fetch
