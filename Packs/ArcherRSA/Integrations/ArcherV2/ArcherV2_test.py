...
from ArcherV2 import (
    ...
    extract_from_xml,
    fetch_incidents,
    generate_field_contents,
    generate_field_value,
    get_errors_from_res,
    get_fetch_time,
    parser,
    search_records_by_report_command,
    search_records_soap_request,
    upload_and_associate_command,
    validate_xml_conditions,
)
...
AUTH_LOGIN_RES = {"RequestedObject": {"SessionToken": "session-id"}, "IsSuccessful": True}
...
FIELD_DEFINITION_RES = [
    ...
    {
        "IsSuccessful": True,
        "RequestedObject": {"Id": 2, "Type": 1, "Name": "Device Name", "IsRequired": True, "RelatedValuesListId": 8},
    },
]
...
GET_LEVELS_BY_APP = {
    "level": 123,
    "mapping": {
        "1": {"Type": 7, "Name": "External Links", "FieldId": "1", "IsRequired": False, "RelatedValuesListId": None},
        "2": {"Type": 1, "Name": "Device Name", "FieldId": "2", "IsRequired": True, "RelatedValuesListId": 8},
    },
}
        ...
        "Children": [
            {
                ...
                "Children": [{"Data": {"Id": 88888, "Name": "level 2", "IsSelectable": False}, "Depth": 1}],
                "Depth": 0,
            },
            {
                "Data": {
...
GET_RECORD_RES_SUCCESS = {
    ...
    "RequestedObject": {
        "Id": 1010,
        "LevelId": 123,
        "FieldContents": {"2": {"Type": 1, "Value": "The device name", "FieldId": 2}},
    },
    "IsSuccessful": True,
    "ValidationMessages": [],
}
...
INCIDENT_RECORD = {
    "record": {"Id": "227602", "Status": "New", "Name": "Incident 01", "Date/Time Reported": "2018-03-26T10:03:32.243Z"},
    "raw": {
        "@contentId": "227602",
        "@levelId": "67",
        ...
        "Field": [
            {
                ...
                "@type": "4",
                "ListValues": {"ListValue": {"@id": "466", "@displayName": "New", "#text": "New"}},
            },
            {
                "@id": "305",
...
INCIDENT_RECORD_US_TZ = {
    "record": {"Id": "227603", "Title": "Test", "created date": "2/25/2021 8:45:55 AM"},
    "raw": {
        "@contentId": "227603",
        "@levelId": "67",
        "@levelGuid": "b0c2d9a1-167c-4fee-ad91-4b4e7b098b4b",
        ...
        "@parentId": "0",
        "Field": [
            {"@id": "35339", "@guid": "9c5e3de1-299b-430f-998a-185ad86e2e79", "@type": "1", "#text": "Test"},
            {
                "@id": "53075",
...
GET_RESPONSE_NOT_SUCCESSFUL_JSON = {
    "IsSuccessful": False,
...
MOCK_READABLE_SEARCH_RECORDS_BY_REPORT = (
...
MOCK_RESULTS_SEARCH_RECORDS_BY_REPORT = {
    "Records": {
        ...
        "Metadata": {
            "FieldDefinitions": {
                "FieldDefinition": [
                    {"@id": "1580", "@name": "Policy Name", "@alias": "Policy_Name"},
        ...
        "Record": {
            ...
            "@parentId": "0",
            "Field": [
                {"@id": "1580", "@type": "1", "#text": "00.0 Introduction"},
                {"@id": "1583", "@type": "1", "#text": "Information"},
            ],
        },
    }
}
...
GET_LEVEL_RES_2 = [
    {
        "RequestedObject": {"Type": 1, "Id": 1580, "LevelId": 3, "Name": "Policy Name", "Alias": "Policy_Name"},
        "IsSuccessful": True,
    },
    {
        "RequestedObject": {"Type": 1, "Id": 1583, "LevelId": 3, "Name": "Policy Statement", "Alias": "Policy_Statement"},
        "IsSuccessful": True,
    },
]
...
RES_DEPTH_1 = {
    ...
    "ValuesList": [
        ...
        {"Id": 83999, "Name": "Group & Other Non-Healthcare (Reportable)", "IsSelectable": False, "Parent": "root", "Depth": 0},
        {
            ...
            "Name": "Group D&L, Run-off Businesses (Operating)",
            "IsSelectable": False,
            "Parent": "Group & Other Non-Healthcare (Reportable)",
            "Depth": 1,
        },
        {"Id": 84001, "Name": "Health Services (Reportable)", "IsSelectable": False, "Parent": "root", "Depth": 0},
        {
            ...
            "Name": "Pharmacy Operations (Operating)",
            "IsSelectable": False,
            "Parent": "Health Services (Reportable)",
            "Depth": 1,
        },
        {"Id": 84005, "Name": "Integrated Medical (Reportable)", "IsSelectable": False, "Parent": "root", "Depth": 0},
        {
            ...
            "Name": "Commercial (Operating)",
            "IsSelectable": False,
            "Parent": "Integrated Medical (Reportable)",
            "Depth": 1,
        },
        {
            "Id": 84012,
...
RES_DEPTH_2 = {
    ...
    "ValuesList": [
        ...
        },
        {
            ...
            "Name": "Cigna Home Delivery (Sub Segments)",
            "IsSelectable": False,
            "Parent": "Pharmacy Operations (Operating)",
            "Depth": 2,
        },
        {
            "Id": 84004,
...
class TestArcherV2:
    ...
    def test_get_level_by_app_id(self, requests_mock):
        requests_mock.post(f"{BASE_URL}api/core/security/login", json=AUTH_LOGIN_RES)
        requests_mock.get(f"{BASE_URL}api/core/system/level/module/1", json=GET_LEVEL_RES)
        requests_mock.get(f"{BASE_URL}api/core/system/fielddefinition/level/123", json=FIELD_DEFINITION_RES)
        client = Client(BASE_URL, "", "", "", "", 400)
        levels = client.get_level_by_app_id("1")
        assert levels == GET_LEVELS_BY_APP

    @pytest.mark.parametrize(
        "requested_object, is_successful", [(GET_RESPONSE_NOT_SUCCESSFUL_JSON, False), (GET_RESPONSE_SUCCESSFUL_JSON, True)]
    )
    def test_update_session(self, mocker, requests_mock, requested_object, is_successful):
        requests_mock.post(f"{BASE_URL}api/core/security/login", json=requested_object)
    ...
    def test_generate_field_contents(self):
        ...
        """
        client = Client(BASE_URL, "", "", "", "", 400)
        field = generate_field_contents(
            client, '{"Device Name":"Macbook\\Name\\"Test"}', GET_LEVELS_BY_APP["mapping"], {"depth": 1}
        )
    ...
    def test_get_record_failed(self, requests_mock):
        requests_mock.post(f"{BASE_URL}api/core/security/login", json=AUTH_LOGIN_RES)
        requests_mock.get(f"{BASE_URL}api/core/content/1010", json=GET_RECORD_RES_failed)
        client = Client(BASE_URL, "", "", "", "", 400)
    ...
    def test_get_record_success(self, requests_mock):
        requests_mock.post(f"{BASE_URL}api/core/security/login", json=AUTH_LOGIN_RES)
        requests_mock.get(f"{BASE_URL}api/core/content/1010", json=GET_RECORD_RES_SUCCESS)
        requests_mock.get(f"{BASE_URL}api/core/system/level/module/1", json=GET_LEVEL_RES)
        requests_mock.get(f"{BASE_URL}api/core/system/fielddefinition/level/123", json=FIELD_DEFINITION_RES)
        client = Client(BASE_URL, "", "", "", "", 400)
    ...
    def test_search_records(self, requests_mock):
        requests_mock.post(f"{BASE_URL}api/core/security/login", json=AUTH_LOGIN_RES)
        requests_mock.post(f"{BASE_URL}ws/general.asmx", text=GET_TOKEN_SOAP)

        requests_mock.get(f"{BASE_URL}api/core/system/level/module/1", json=GET_LEVEL_RES)
        requests_mock.get(f"{BASE_URL}api/core/system/fielddefinition/level/123", json=FIELD_DEFINITION_RES)
        requests_mock.post(f"{BASE_URL}ws/search.asmx", text=SEARCH_RECORDS_RES)
        client = Client(BASE_URL, "", "", "", "", 400)
    ...
    def test_search_records_soap_request(self, field_name: str, field_to_search_by_id: str, expected_condition: str):
        """
        Given:
        ...
        """
        xml_request = search_records_soap_request(
            "token",
            "app_id",
            "display_fields",
            "field_id",
    ...
    @pytest.mark.parametrize(
        ...
        [
            pytest.param(
                {"fieldValueList": {}},
                1,
                id="Cache miss (empty cache)",
            ),
            pytest.param(
                {"fieldValueList": {"304__1": VALUE_LIST_FIELD_DATA}},
                0,
                id="Cache hit (same id and depth)",
            ),
            pytest.param(
                {"fieldValueList": {"304__2": VALUE_LIST_FIELD_DATA}},
                1,
    ...
    def test_get_field_value_list(
        ...
        """
        Given:
            - Integration context cache.

        When:
            - Running get_field_value_list.

        Then:
            - Ensure API requests are not performed if the matching data exists in the integration context.
            - Ensure correct field value list is returned.
        """
        field_id = 304
        depth = 1
        ...
        field_definition_request = requests_mock.get(
            f"{BASE_URL}api/core/system/fielddefinition/{field_id}",
            json=GET_FIElD_DEFINITION_RES,
        )
        value_list_request = requests_mock.get(
            f"{BASE_URL}api/core/system/valueslistvalue/valueslist/62",
            json=VALUE_LIST_RES,
        )
        ...
        assert login_request.call_count == expected_api_call_count
        assert field_definition_request.call_count == expected_api_call_count
        assert value_list_request.call_count == expected_api_call_count
    ...
    def test_get_field_value_list_nested_response(self, requests_mock, args, expected_response):
        ...
        requests_mock.post(f"{BASE_URL}api/core/security/login", json=AUTH_LOGIN_RES)
        requests_mock.get(f"{BASE_URL}api/core/system/fielddefinition/304", json=GET_FIElD_DEFINITION_RES)
        requests_mock.get(f"{BASE_URL}api/core/system/valueslistvalue/valueslist/62", json=NESTED_VALUE_LIST_RES)
        client = Client(BASE_URL, "", "", "", "", 400)
    ...
    def test_generate_field_value_values_list_input(self, requests_mock):
        ...
        requests_mock.post(f"{BASE_URL}api/core/security/login", json=AUTH_LOGIN_RES)
        requests_mock.get(f"{BASE_URL}api/core/system/fielddefinition/304", json=GET_FIElD_DEFINITION_RES)
        requests_mock.get(f"{BASE_URL}api/core/system/valueslistvalue/valueslist/62", json=VALUE_LIST_RES)
    ...
    def test_generate_field_external_link_input(self):
        ...
        field_key, field_value = generate_field_value(
            ...
            "",
            {"Type": 7},
            [{"value": "github", "link": "https://github.com"}, {"value": "google", "link": "https://google.com"}],
            {"depth": 1},
        )
        assert field_key == "Value"
        assert field_value == [{"Name": "github", "URL": "https://github.com"}, {"Name": "google", "URL": "https://google.com"}]
    ...
    def test_generate_field_values_list_with_other(self, requests_mock, mocker):
        ...
        client = Client(BASE_URL, "", "", "", "", 400)
        field_key, field_value = generate_field_value(
            client, "", {"Type": 4, "FieldId": 1234}, {"ValuesList": ["NA"], "OtherText": "test"}, {"depth": 1}
        )
        assert field_key == "Value"
    ...
    def test_generate_invalid_field_users_groups_input(self):
        ...
        assert (
            'The value of the field: test must be a dictionary type and include a list under "users" key or '
            '"groups" key e.g: {"Policy Owner":{"users":[20],"groups":[30]}}' in str(e.value)
        )

    @pytest.mark.parametrize(
        "field_value, result", [([1, 2], [{"ContentID": 1}, {"ContentID": 2}]), (1234, [{"ContentID": 1234}])]
    )
    ...
    def test_generate_field_value(self, requests_mock):
        ...
        requests_mock.get(f"{BASE_URL}api/core/system/fielddefinition/16172", json=GET_FIElD_DEFINITION_RES)
        requests_mock.post(f"{BASE_URL}api/core/security/login", json=AUTH_LOGIN_RES)
        requests_mock.get(f"{BASE_URL}api/core/system/valueslistvalue/valueslist/62", json=VALUE_LIST_RES_FOR_SOURCE)

        client = Client(BASE_URL, "", "", "", "", 400)
        field_key, field_value = generate_field_value(
            client,
            "Source",
            {"FieldId": "16172", "IsRequired": False, "Name": "Source", "RelatedValuesListId": 2092, "Type": 4},
            "ArcSight",
            1,
        )
        assert field_key == "Value"
    ...
    def test_fetch_time_change(self, mocker):
        ...
        params = {"applicationId": "75", "applicationDateField": "Date/Time Reported"}
        record = copy.deepcopy(INCIDENT_RECORD)
        record["record"]["Date/Time Reported"] = date_time_reported
        record["raw"]["Field"][1]["@xmlConvertedValue"] = date_time_reported
        last_fetch = get_fetch_time({"last_fetch": "2018-03-01T10:03:00Z"}, params.get("fetch_time", "3 days"))
    ...
    def test_two_fetches(self, mocker):
        ...
        mocker.patch.object(client, "search_records", side_effect=[([record1], {}), ([record2], {})])
        incidents, next_fetch = fetch_incidents(client, params, last_fetch, "305")
        assert last_fetch < next_fetch
    ...
    def test_fetch_got_exact_same_time(self, mocker):
        ...
        record["record"]["Date/Time Reported"] = date_time_reported
        record["raw"]["Field"][1]["@xmlConvertedValue"] = date_time_reported
        last_fetch = get_fetch_time({"last_fetch": date_time_reported}, params.get("fetch_time", "3 days"))
        mocker.patch.object(client, "search_records", return_value=([record], {}))
        incidents, next_fetch = fetch_incidents(client, params, last_fetch, "305")
        assert last_fetch == next_fetch
        assert not incidents, "Should not get new incidents."
    ...
    def test_same_record_returned_in_two_fetches(self, mocker):
        ...
        """
        client = Client(BASE_URL, "", "", "", "", 400)
        mocker.patch.object(client, "search_records", side_effect=[([INCIDENT_RECORD_US_TZ], {}), ([INCIDENT_RECORD_US_TZ], {})])
        params = {"applicationId": "75", "applicationDateField": "created date"}
        field_time_id = "53075"
    ...
    def test_search_records_by_report_command(self, mocker):
        ...
        client = Client(BASE_URL, "", "", "", "", 400)
        mocker.patch.object(client, "do_soap_request", return_value=[SEARCH_RECORDS_BY_REPORT_RES, SEARCH_RECORDS_BY_REPORT_RES])
    ...
    @pytest.mark.parametrize(
        "integration_context, is_login_expected, http_call_attempt_results",
        [
            ...
            (
                ...
                True,
                [{"status_code": 401}, {"status_code": 401}, {"status_code": 200, "json": {"res": "some_res"}}],
            ),
        ],
    )
    def test_do_rest_request(self, mocker, requests_mock, integration_context, is_login_expected, http_call_attempt_results):
        ...
        client = Client(BASE_URL, "", "", "", "", 400)
        mocker.patch("ArcherV2.get_integration_context", return_value=integration_context)
        login_mocker = requests_mock.post(f"{BASE_URL}api/core/security/login", json=AUTH_LOGIN_RES)
        rest_mocker = requests_mock.get(f"{BASE_URL}test_requests", http_call_attempt_results)
    ...
    @pytest.mark.parametrize(
        "integration_context, is_new_token_expected, http_call_attempt_results",
        [
            ...
            (
                {"token": "TOKEN"},
                True,
                [{"status_code": 500}, {"status_code": 500}, {"status_code": 200, "text": SEARCH_RECORDS_RES}],
            ),
        ],
    )
    def test_do_soap_request(self, mocker, requests_mock, integration_context, is_new_token_expected, http_call_attempt_results):
        ...
        client = Client(BASE_URL, "", "", "", "", 400)
        mocker.patch("ArcherV2.get_integration_context", return_value=integration_context)
        new_token_mocker = requests_mock.post(f"{BASE_URL}ws/general.asmx", text=GET_TOKEN_SOAP)
        soap_mocker = requests_mock.post(f"{BASE_URL}ws/search.asmx", http_call_attempt_results)

        search_commands_args = {
            "app_id": 1,
            "display_fields": '<DisplayField name="External Links">1</DisplayField>'
    ...
    def test_upload_and_associate_command_single_file(self, mocker):
        ...
        args = {"applicationId": "app1", "contentId": "content1", "associatedField": "field1", "entryId": "entry1"}
