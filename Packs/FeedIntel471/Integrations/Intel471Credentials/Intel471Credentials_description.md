...
5. In Cortex, open the Intel471 Credentials integration instance and paste the values into the **Username** and **Password** fields, then save and test the instance.
