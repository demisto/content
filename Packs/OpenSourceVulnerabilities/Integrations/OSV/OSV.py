...
def osv_get_vuln_by_id_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        outputs_prefix="OSV.Vulnerability", outputs_key_field="", outputs=response, raw_response=response
    )
...
def osv_query_affected_by_commit_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    if response:
        command_results = CommandResults(
            outputs_prefix="OSV.VulnerabilityList", outputs_key_field="", outputs=response["vulns"], raw_response=response
        )
    else:
