...
RESOLUTION = [
    ...
    "Communication Tasks: https://docs-cortex.paloaltonetworks.com/r/Cortex-XSOAR/6.10/"
    + "Cortex-XSOAR-Administrator-Guide/Communication-Tasks",

    "Sub-playbook Tutorial: https://docs-cortex.paloaltonetworks.com/r/Cortex-XSOAR/6.10/"
    + "Cortex-XSOAR-Administrator-Guide/Configure-a-Sub-playbook-Loop",
]
