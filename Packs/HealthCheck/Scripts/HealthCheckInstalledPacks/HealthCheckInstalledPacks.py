...
if len(packs) > 70:
    res.append({"category": "Content packs", "severity": "Medium",
                ...
                "resolution": "Delete unneeded packs, refer to:  https://docs-cortex.paloaltonetworks.com/r/Cortex-XSOAR/6.10/"
                "Cortex-XSOAR-Administrator-Guide/Delete-a-Content-Pack"
                })
