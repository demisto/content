...
def checkKeyValue(config):
    ...
    for key, value in config.items():
            ...
            res.append(
                {
                    ...
                    "severity": "Medium",
                    "description": DESCRIPTION[0].format(key),
            ...
            res.append(
                {
                    "category": "Configuration",
                    "severity": "Medium",
                    "description": DESCRIPTION[1].format(key),
            ...
            res.append(
                {
                    "category": "Configuration",
                    "severity": "Medium",
                    "description": DESCRIPTION[2].format(key, value),
        ...
        if key == "db.index.entry.disable" and value == "false":
            res.append(
                {"category": "Configuration", "severity": "High", "description": DESCRIPTION[3], "resolution": RESOLUTION[3]}
            )
            continue
            ...
            res.append(
                {
                    "category": "Configuration",
                    "severity": "Medium",
                    "description": DESCRIPTION[2].format(key, str(value)),
...
try:
    ...
    if AE:
        res.append(
            {"category": "Configuration", "severity": "Medium", "description": DESCRIPTION[4], "resolution": RESOLUTION[7]}
        )

    results = CommandResults(
        readable_output="HealthCheckConfServer Done", outputs_prefix="HealthCheck.ActionableItems", outputs=res
    )
