...
def get_ec2_sg_public_rules(
    group_id, ip_permissions, checked_protocol=None, checked_from_port=None, checked_to_port=None, region=None, include_ipv6="no"
):
    """
    ...
    for rule in ip_permissions:
        ...
        if from_port and to_port:
            ...
            bad_rule.update({"fromPort": from_port, "toPort": to_port})
...
def main(args):
    ...
    readable_output = tableToMarkdown(
        "Public Security Group Rules", public_rules, ["groupId", "ipProtocol", "fromPort", "toPort", "cidrIp", "region"]
    )

    context = {"AWS": {"EC2": {"SecurityGroup": {"PublicRules": public_rules}}}}
