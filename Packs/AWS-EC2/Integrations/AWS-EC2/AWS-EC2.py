...
def test_module() -> str:
    ...
    if ROLE_NAME:
        ...
        if fails:
            ...
            raise DemistoException(f"AssumeRole with role name {ROLE_NAME!r} failed for the following accounts: {fail_ids}.")
    return "ok"
...
def describe_regions_command(args: dict) -> CommandResults:
    ...
    for region in response["Regions"]:
        data.append({"Endpoint": region["Endpoint"], "RegionName": region["RegionName"]})
...
def allocate_address_command(args: dict) -> CommandResults:
    ...
    return CommandResults(
        outputs=data, outputs_prefix="AWS.EC2.ElasticIPs", readable_output=tableToMarkdown("AWS EC2 ElasticIP", data)
    )
...
def create_image_command(args: dict) -> CommandResults:
    client = build_client(args)
    obj = vars(client._client_config)
    kwargs = {"Name": args.get("name"), "InstanceId": args.get("instanceId")}
    ...
    return CommandResults(outputs=data, outputs_prefix="AWS.EC2.Images", readable_output=tableToMarkdown("AWS EC2 Images", data))
...
def modify_volume_command(args: dict) -> CommandResults:
    ...
    return CommandResults(
        outputs={"Modification": raw, "VolumeId": raw["VolumeId"]},
        outputs_prefix="AWS.EC2.Volumes",
        outputs_key_field="VolumeId",
...
def create_tags_command(args: dict) -> CommandResults:
    client = build_client(args)
    kwargs = {"Resources": parse_resource_ids(args.get("resources")), "Tags": parse_tag_field(args.get("tags"))}
...
def create_volume_command(args: dict) -> CommandResults:
    ...
    if args.get("kmsKeyId") is not None:
        kwargs.update({"KmsKeyId": args.get("kmsKeyId")})
    if args.get("tags") is not None:
        kwargs.update({"TagSpecifications": [{"ResourceType": "volume", "Tags": parse_tag_field(args.get("tags"))}]})
    ...
    return CommandResults(
        outputs=data, outputs_prefix="AWS.EC2.Volumes", readable_output=tableToMarkdown("AWS EC2 Volumes", data)
    )
...
def run_instances_command(args: dict) -> CommandResults:
    client = build_client(args)
    obj = vars(client._client_config)
    kwargs = {"MinCount": arg_to_number(args.get("count")), "MaxCount": arg_to_number(args.get("count"))}  # type: dict
    ...
    if args.get("ebsDeleteOnTermination") is not None:
        BlockDeviceMappings["Ebs"].update({"DeleteOnTermination": argToBoolean(args.get("ebsDeleteOnTermination"))})
    ...
    if args.get("iamInstanceProfileArn") is not None:
        kwargs.update({"IamInstanceProfile": {"Arn": args.get("iamInstanceProfileArn")}})
    if args.get("iamInstanceProfileName") is not None:
        kwargs.update(
            {  # type: ignore
                "IamInstanceProfile": {"Name": args.get("iamInstanceProfileName")}
            }
        )
    if args.get("launchTemplateId") is not None:
        kwargs.update({"LaunchTemplate": {"LaunchTemplateId": args.get("launchTemplateId")}})
    if args.get("launchTemplateName") is not None:
        kwargs.update({"LaunchTemplate": {"LaunchTemplateName": args.get("launchTemplateName")}})
    ...
    if args.get("tags") is not None:
        kwargs.update({"TagSpecifications": [{"ResourceType": "instance", "Tags": parse_tag_field(args.get("tags"))}]})
    if args.get("host_id"):
        kwargs.update({"Placement": {"HostId": args.get("host_id")}})
...
def get_latest_ami_command(args: dict) -> CommandResults:
    ...
    try:
        ...
        raise DemistoException(f"Could not decode/encode the raw response - {err_msg}")
    return CommandResults(outputs=image, outputs_prefix="AWS.EC2.Images", readable_output=tableToMarkdown("AWS EC2 Images", data))
...
def create_security_group_command(args: dict) -> CommandResults:
    ...
    return CommandResults(
        outputs=data, outputs_prefix="AWS.EC2.SecurityGroups", readable_output=tableToMarkdown("AWS EC2 Security Groups", data)
    )
...
def copy_image_command(args: dict) -> CommandResults:
    ...
    data = {"ImageId": response["ImageId"], "Region": obj["_user_provided_options"]["region_name"]}
...
def copy_snapshot_command(args: dict) -> CommandResults:
    ...
    data = {"SnapshotId": response["SnapshotId"], "Region": obj["_user_provided_options"]["region_name"]}
...
def monitor_instances_command(args: dict) -> CommandResults:
    ...
    for instance in response["InstanceMonitorings"]:
        data.append({"InstanceId": instance["InstanceId"], "MonitoringState": instance["Monitoring"]["State"]})
...
def get_password_data_command(args: dict) -> CommandResults:
    ...
    try:
        ...
        raise DemistoException(f"Date could not be parsed. Please check the date again.\n{e}")
    data = {"InstanceId": response["InstanceId"], "PasswordData": response["PasswordData"], "Timestamp": time_stamp}
...
def create_fleet_command(args: dict) -> CommandResults:
    ...
    if args.get("SpotAllocationStrategy") is not None:
        SpotOptions.update({"AllocationStrategy": args.get("SpotAllocationStrategy")})
    if args.get("InstanceInterruptionBehavior") is not None:
        SpotOptions.update({"InstanceInterruptionBehavior": args.get("InstanceInterruptionBehavior")})
    if args.get("InstancePoolsToUseCount") is not None:
        SpotOptions.update({"InstancePoolsToUseCount": args.get("InstancePoolsToUseCount")})
    ...
    if args.get("SingleAvailabilityZone") is not None:
        SpotOptions.update({"SingleAvailabilityZone": argToBoolean(args.get("SingleAvailabilityZone"))})
    if args.get("MinTargetCapacity") is not None:
        SpotOptions.update({"MinTargetCapacity": arg_to_number(args.get("MinTargetCapacity"))})
    ...
    if args.get("OnDemandAllocationStrategy") is not None:
        OnDemandOptions.update({"AllocationStrategy": args.get("OnDemandAllocationStrategy")})
    if args.get("OnDemandSingleInstanceType") is not None:
        SpotOptions.update({"SingleInstanceType": argToBoolean(args.get("OnDemandSingleInstanceType"))})
    if args.get("OnDemandSingleAvailabilityZone") is not None:
        SpotOptions.update({"SingleAvailabilityZone": argToBoolean(args.get("OnDemandSingleAvailabilityZone"))})
    if args.get("OnDemandMinTargetCapacity") is not None:
        SpotOptions.update({"MinTargetCapacity": arg_to_number(args.get("OnDemandMinTargetCapacity"))})
    ...
    if args.get("LaunchTemplateId") is not None:
        LaunchTemplateSpecification.update({"LaunchTemplateId": args.get("LaunchTemplateId")})
    if args.get("LaunchTemplateName") is not None:
        LaunchTemplateSpecification.update({"LaunchTemplateName": args.get("LaunchTemplateName")})
    if args.get("LaunchTemplateVersion") is not None:
        LaunchTemplateSpecification.update({"Version": str(args.get("LaunchTemplateVersion"))})
    ...
    if args.get("OverrideSubnetId") is not None:
        ...
        for i, item in enumerate(arr):
            if len(Overrides) - 1 < i:
                Overrides.append({})
            Overrides[i].update({"SubnetId": item})
    ...
    if args.get("OverrideAvailabilityZone") is not None:
        ...
        for i, item in enumerate(arr):
            if len(Overrides) - 1 < i:
                Overrides.append({})
            Overrides[i].update({"AvailabilityZone": item})
    ...
    if args.get("OverrideWeightedCapacity") is not None:
        ...
        for i, item in enumerate(arr):
            if len(Overrides) - 1 < i:
                Overrides.append({})
            Overrides[i].update({"WeightedCapacity": item})
    ...
    if args.get("OverridePriority") is not None:
        ...
        for i, item in enumerate(arr):
            if len(Overrides) - 1 < i:
                Overrides.append({})
            Overrides[i].update({"Priority": item})
    ...
    if args.get("TotalTargetCapacity") is not None:
        TargetCapacitySpecification.update({"TotalTargetCapacity": arg_to_number(args.get("TotalTargetCapacity"))})
    if args.get("OnDemandTargetCapacity") is not None:
        TargetCapacitySpecification.update({"OnDemandTargetCapacity": arg_to_number(args.get("OnDemandTargetCapacity"))})
    if args.get("SpotTargetCapacity") is not None:
        TargetCapacitySpecification.update({"SpotTargetCapacity": arg_to_number(args.get("SpotTargetCapacity"))})
    if args.get("DefaultTargetCapacityType") is not None:
        TargetCapacitySpecification.update({"DefaultTargetCapacityType": args.get("DefaultTargetCapacityType")})
    ...
    if args.get("Tags") is not None:
        ...
        for i, item in enumerate(arr):
            ...
            tg = item.split(":")
            TagSpecifications[i].update({"ResourceType": tg[0], "Tags": parse_tag_field(tg[1])})
    ...
    raw = json.loads(output)
    return CommandResults(outputs=raw, outputs_prefix="AWS.EC2.Fleet", readable_output=tableToMarkdown("AWS EC2 Fleet", data))
...
def delete_fleet_command(args: dict) -> CommandResults:
    ...
    try:
        ...
        raise DemistoException(f"Could not decode/encode the raw response - {err_msg}")
    return CommandResults(
        outputs=raw, outputs_prefix="AWS.EC2.DeletedFleets", readable_output=tableToMarkdown("AWS Deleted Fleets", data)
    )
        ...
        data.append(
            {
                ...
                "LaunchTemplateId": item["LaunchTemplateConfigs"][0]["LaunchTemplateSpecification"]["LaunchTemplateId"],
...
def create_launch_template_command(args: dict) -> CommandResults:
    ...
    if args.get("iamInstanceProfileArn") is not None and args.get("iamInstanceProfileName") is not None:
        LaunchTemplateData.update(
            {"IamInstanceProfile": {"Arn": args.get("iamInstanceProfileArn"), "Name": args.get("iamInstanceProfileName")}}
        )
    ...
    if args.get("AvailabilityZone") is not None:
        LaunchTemplateData.update({"Placement": {"AvailabilityZone": args.get("AvailabilityZone")}})
    if args.get("AvailabilityZoneGroupName") is not None:
        LaunchTemplateData.update({"Placement": {"GroupName": args.get("AvailabilityZoneGroupName")}})
    if args.get("PlacementTenancy") is not None:
        LaunchTemplateData.update({"Placement": {"Tenancy": args.get("PlacementTenancy")}})
    if args.get("PlacementAffinity") is not None:
        LaunchTemplateData.update({"Placement": {"Affinity": args.get("PlacementAffinity")}})
    if args.get("PlacementHostId") is not None:
        LaunchTemplateData.update({"Placement": {"HostId": args.get("PlacementHostId")}})
    if args.get("PlacementSpreadDomain") is not None:
        LaunchTemplateData.update({"Placement": {"SpreadDomain": args.get("PlacementSpreadDomain")}})
    ...
    if args.get("InstanceInitiatedShutdownBehavior") is not None:
        LaunchTemplateData.update({"InstanceInitiatedShutdownBehavior": args.get("InstanceInitiatedShutdownBehavior")})
    if args.get("UserData") is not None:
    ...
    if args.get("ElasticGpuSpecificationsType") is not None:
        ...
        for i, item in enumerate(arr):
            ...
            ElasticGpuSpecifications[i].update({"Type": item})
    ...
    if args.get("ElasticInferenceAcceleratorsType") is not None:
        ...
        for i, item in enumerate(arr):
            ...
            ElasticInferenceAccelerators[i].update({"Type": item})
    if ElasticGpuSpecifications:
    ...
    if args.get("MarketType") is not None:
        InstanceMarketOptions.update({"MarketType": args.get("MarketType")})

    SpotOptions = {}  # type: dict
    if args.get("SpotInstanceType") is not None:
        SpotOptions.update({"SpotInstanceType": args.get("SpotInstanceType")})
    if args.get("BlockDurationMinutes") is not None:
        SpotOptions.update({"BlockDurationMinutes": args.get("BlockDurationMinutes")})
    if args.get("SpotValidUntil") is not None:
        SpotOptions.update({"ValidUntil": parse_date(args.get("SpotValidUntil"))})
    if args.get("SpotInstanceInterruptionBehavior") is not None:
        SpotOptions.update({"InstanceInterruptionBehavior": args.get("SpotInstanceInterruptionBehavior")})
    if args.get("SpotMaxPrice") is not None:
        SpotOptions.update({"MaxPrice": args.get("SpotMaxPrice")})
    ...
    try:
        ...
        raise DemistoException(f"Could not decode/encode the raw response - {err_msg}")
    return CommandResults(
        outputs=raw, outputs_prefix="AWS.EC2.LaunchTemplates", readable_output=tableToMarkdown("AWS LaunchTemplates", data_hr)
    )
...
def describe_internet_gateway_command(args: dict) -> CommandResults:
    ...
    for i, internet_gateway in enumerate(response["InternetGateways"]):
        data.append({"InternetGatewayId": internet_gateway["InternetGatewayId"], "OwnerId": internet_gateway["OwnerId"]})
        ...
        if "Attachments" in internet_gateway:
            for attachment in internet_gateway["Attachments"]:
                data[i].update({"State": attachment["State"], "VpcId": attachment["VpcId"]})
...
def create_traffic_mirror_session_command(args: dict) -> CommandResults:
    ...
    if args.get("Tags") is not None:
        ...
        for i, item in enumerate(arr):
            ...
            tg = item.split(":")
            tag_specifications[i].update({"ResourceType": tg[0], "Tags": parse_tag_field(tg[1])})
...
def allocate_hosts_command(args: dict) -> CommandResults:
    ...
    return CommandResults(
        outputs=data, outputs_prefix="AWS.EC2.Host", readable_output=tableToMarkdown("AWS EC2 Dedicated Host ID", data)
    )
...
def create_vpc_endpoint_command(args: dict) -> CommandResults:
    ...
    kwargs = {}
    kwargs.update({"VpcId": args.get("vpcId"), "ServiceName": args.get("serviceName")})
