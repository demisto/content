...
def test_gh_get_policy_command(requests_mock):
    ...
    client = Client(base_url="https://api.greathorn.com/v2", verify=False, headers={"Authentication": "Bearer some_api_key"})
...
def test_gh_remediate_message_command(requests_mock):
    ...
    args = {"eventId": "14807", "action": "quarantine"}
...
def test_gh_revert_remediate_message_command(requests_mock):
    ...
    args = {"eventId": "14807", "action": "quarantinerelease"}
