...
class Client(BaseClient):
    ...
    def get_policy(self, policy_id: str | None = None) -> dict[str, Any]:
        if policy_id:
            return self._http_request(method="GET", url_suffix=f"/policy/{policy_id}")
        else:
    ...
    def set_policy(self, policy_id: str, update_method: str, policy_json: dict[str, Any]) -> dict[str, Any]:
        ...
        return self._http_request(method=update_method, url_suffix=f"/policy/{policy_id}", json_data=policy_json)
    ...
    def remediate_message(self, action: str, action_args: dict | None) -> dict[str, Any]:
        return self._http_request(method="POST", url_suffix=f"/remediation/{action}", json_data=action_args)

    def revert_remediate_message(self, action: str, action_args: dict | None) -> dict[str, Any]:
        return self._http_request(method="POST", url_suffix=f"/remediation/revert/{action}", json_data=action_args)
