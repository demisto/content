...
from ThreatExchangeV2 import (
    ThreatExchangeV2Status,
    calculate_dbot_score,
    calculate_engines,
    convert_string_to_epoch_time,
    flatten_outputs_paging,
...
class TestsThreatExchangeV2:
    ...
    malicious_suspicious_test_input = [
        {STATUS: ThreatExchangeV2Status.MALICIOUS},
        {STATUS: ThreatExchangeV2Status.UNKNOWN},
    ...
    four_engines_three_positive_test_input = [
        {STATUS: ThreatExchangeV2Status.MALICIOUS},
        {STATUS: ThreatExchangeV2Status.MALICIOUS},
        {STATUS: ThreatExchangeV2Status.MALICIOUS},
        {STATUS: ThreatExchangeV2Status.UNKNOWN},
    ...
    raw_response_without_before_after = {"data": [], "paging": {"cursors": {}}}
    expected_output_without_before_after = {"data": [], "paging": {"before": None, "after": None}}

    raw_response_without_cursors = {"data": [], "paging": {}}
    expected_output_without_cursors = {"data": [], "paging": {"before": None, "after": None}}
    ...
    def test_get_reputation_data_statuses(self):
        ...
        expected_output = [
            ThreatExchangeV2Status.MALICIOUS,
            ThreatExchangeV2Status.SUSPICIOUS,
            ThreatExchangeV2Status.NON_MALICIOUS,
            ThreatExchangeV2Status.UNKNOWN,
        ]
        assert get_reputation_data_statuses(reputation_data=data) == expected_output

    @pytest.mark.parametrize(
        "reputation_data_input, expected_output, error_msg",
        [
    ...
    def test_dbot_score_calculation(self, reputation_data_input: list[dict], expected_output: Common.DBotScore, error_msg: str):
        """
        Given:
    ...
    def test_calculate_engines(self, reputation_data_input: list[dict], expected_output: tuple[int, int], error_msg: str):
        """
        Given:
    ...
    @pytest.mark.parametrize(
        "raw_response_input, expected_output",
        [
    ...
    @pytest.mark.parametrize("date_input, expected_output", [("2021-05-01T12:00:00", 1619870400), (None, None)])
