...
def upload_file_command(args: Dict[str, Any], client: Client) -> PollResult:
    ...
    if file_size < maximum_chunk_size:
        response = client.upload_file(file_path=file_path, file_name=file_name, folder_id=folder_id, as_user=as_user)
        ...
        response = client.commit_file(file_path, as_user, parts, upload_url_suffix)
