...
| --- | --- | --- | --- |
| MessageID | The Message ID of the email to retrieve.  | incident.apdinternalmessageid | Optional |
| EmailFrom | Email address of the reporting user. | incident.emailfrom | Optional |
...
| EmailTo | Email address of the reporting user. | incident.emailto | Optional |
