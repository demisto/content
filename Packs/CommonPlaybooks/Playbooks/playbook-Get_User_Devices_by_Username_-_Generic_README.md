...
Please note that not all of the supported integrations will be able to retrieve this information.
...
| GsuiteCustomerID | In case of using Google Workspace, a customer ID is needed. |  | Optional |
...
| GSuite.MobileDevices.MobileListObjects.userAgent | Gives information about the mobile device such as the operating system version. | unknown |
...
| JAMF.MobileDevice.wifi_mac_address | The mobile device WIFI MAC address. | unknown |
...
| UserDevices.Type | Devices types retrieved by this playbook. | unknown |
...
![Get User Devices by Username - Generic](../doc_files/Get_User_Devices_by_Username_-_Generic.png)
