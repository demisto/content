...
| AutoBlockIndicators | Possible values: True/False.  Default: True.<br/>Should the given indicators be automatically blocked, or should the user be given the option to choose?<br/><br/>If set to False - the user will be prompted to select which indicators to block.<br/>If set to True - no prompt will appear, and all provided indicators will be blocked automatically. | True | Optional |
