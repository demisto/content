...
Also, this playbook leverages the 'iam-get-user' generic command through the sub-playbook 'Account Enrichment - IAM'.

## Dependencies
This playbook uses the following sub-playbooks, integrations, and scripts.

### Sub-playbooks
* Account Enrichment - IAM 
...
| Domain | Optional - This input is needed for the IAM-get-user command \(used in the Account Enrichment - IAM playbook\). Please provide the domain name that the user is related to.<br/>Example: @demisto.com |  | Optional |
