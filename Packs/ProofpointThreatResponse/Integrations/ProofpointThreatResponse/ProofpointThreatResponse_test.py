...
def get_fetch_data():
    with open(os.path.dirname(__file__) + 'test_data/raw_response.json', 'r') as f:
...
def test_get_incident_command_expand_events_false(mocker, requests_mock):
    ...
    """
    base_url = 'https://server_url/'
    with open(os.path.dirname(__file__) + 'test_data/incident_expand_events_false.json', 'r') as f:
...
def test_search_quarantine_command(mocker, requests_mock):
    ...
    """
    base_url = 'https://server_url/'
    with open(os.path.dirname(__file__) + 'test_data/incidents.json', 'r') as f:
        incident = json.loads(f.read())
