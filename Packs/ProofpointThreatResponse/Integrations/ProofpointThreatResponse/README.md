...
| check_for_exact_time_match| If true, the command will check for quarantined emails with the exact reception time of the email. Else, the verification of the quarantined email will use the message ID and the recipient email only. Default is true. | False |
