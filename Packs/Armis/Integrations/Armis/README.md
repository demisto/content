...
```json
{
	"Armis": {
		"Alert": {
			"activityIds": [
				23314066, 23316462, 23317202, 23326470, 23341779, 23342441
			],
			"activityUUIDs": [
			...
			"alertId": 3984,
			"connectionIds": [923419, 923501, 924451],
...
```json
{
	"Armis": {
		"Alert": {
			"activityIds": [22060159],
			"activityUUIDs": ["nTiGqXcBAAAC-vCTfzPN"],
			"alertId": 3821,
			"connectionIds": [],
...
```json
{
	"Armis": {
		"Device": {
			...
			"tags": ["MERAKI_NETWORK=Winslow Truganina", "Corporate"],
			"type": "TVs",
			"user": "",
			"visibility": "Full"
		}
...
```json
{
	"Armis": {
		"Device": {
			...
			"tags": ["MERAKI_NETWORK=Winslow Campbellfield"],
			"type": "Servers",
			"user": "",
			"visibility": "Full"
		}
...
```json
{
	"Armis": {
		"User": {
			...
			"title": "Administrator",
			"username": "admin",
			"lastLoginTime": "2021-03-11T20:32:33.494314+00:00",
			"role": "Admin",
			"roleAssignment": "Admin",
			"location": "38 In numis veritas 28, Campbellfield VIC 3061 Australia",
			"phone": "123456789",
