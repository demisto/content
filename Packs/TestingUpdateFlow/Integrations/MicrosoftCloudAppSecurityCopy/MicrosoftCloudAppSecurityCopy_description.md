...
## Grant Cortex XSOAR Authorization in Microsoft Cloud App Security API
...
---
[View Integration Documentation](https://xsoar.pan.dev/docs/reference/integrations/microsoft-cloud-app-security)