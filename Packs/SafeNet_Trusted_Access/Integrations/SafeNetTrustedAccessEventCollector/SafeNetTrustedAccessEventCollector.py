...
def main() -> None:  # pragma: no cover
    ...
    try:
        ...
        client = Client(base_url=base_url, verify=verify_certificate, headers=headers, proxy=proxy, ok_codes=(200, 201, 204))
        ...
        if command == "test-module":
            ...
            if argToBoolean(args.get("should_push_events", "true")):
                send_events_to_xsiam(events, params.get("vendor", "safenet"), params.get("product", "trusted_access"))
