...
- Removed the ***PAN-OS - Block Domain - External Dynamic List*** sub-playbook. This playbook is deprecated and has reached its end of life.
(EOL) and is no longer supported. Use Generic Export Indicators Service instead