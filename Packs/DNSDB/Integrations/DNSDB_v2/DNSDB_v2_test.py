...
class TestClient(object):
    ...
    def test_rrset_bailiwick(self, requests_mock):
        ...
        requests_mock.get(
            '{server}/dnsdb/v2/lookup/{mode}/{type}/{name}/{rrtype}/{bailiwick}?swclient={swclient}&version={version}'.format(
                # noqa: E501
                server=DNSDB.DEFAULT_DNSDB_SERVER,
                mode='rrset',
                type='name',
    ...
    def test_offset(self, requests_mock):
        ...
        requests_mock.get(
            '{server}/dnsdb/v2/lookup/{mode}/{type}/{name}?offset={offset}&swclient={swclient}&version={version}'.format(
                # noqa: E501
                server=DNSDB.DEFAULT_DNSDB_SERVER,
                mode='rrset',
                type='name',
