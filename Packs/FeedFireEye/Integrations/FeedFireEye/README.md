...
3. Click __Add instance__ to create and configure a new integration instance.
    ...
    | Traffic Light Protocol color | Traffic Light Protocol color for indicators fetched from feed. More information about the protocol can be found at https://us-cert.cisa.gov/tlp. |
