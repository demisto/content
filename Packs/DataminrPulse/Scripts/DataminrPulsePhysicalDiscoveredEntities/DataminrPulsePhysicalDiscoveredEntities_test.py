...
from DataminrPulsePhysicalDiscoveredEntities import main, demisto, PANEL_NAME
import json
import os
...
def test_main_with_valid_discovered_entities_data_in_light_mode(mocker):
    ...
    mock_return = mocker.patch("DataminrPulsePhysicalDiscoveredEntities.return_results")
...
def test_main_with_invalid_discovered_entities_data(mocker):
    ...
    mock_return = mocker.patch("DataminrPulsePhysicalDiscoveredEntities.return_error")
