...
from DataminrPulseIntelAgentsCyberContext import main, demisto, PANEL_NAME
import json
import os
...
def test_main_with_valid_intel_agents_cyber_context_data_in_light_mode(mocker):
    """
    Test the main function with valid intel agents cyber context data in light mode.
    """
    ...
    mock_return = mocker.patch("DataminrPulseIntelAgentsCyberContext.return_results")
...
def test_main_with_valid_intel_agents_cyber_context_data_in_dark_mode(mocker):
    """
    Test the main function with valid intel agents cyber context data in dark mode.
    """
    intel_agents_data = util_load_json(
        os.path.join(os.path.dirname(os.path.realpath(__file__)), "test_data/intel_agents_data.json")
    )
...
def test_main_with_no_intel_agents_cyber_context_data(mocker):
    """
    Test the main function with no intel agents cyber context data.
    """
...
def test_main_with_invalid_intel_agents_cyber_context_data(mocker):
    """
    Test the main function with invalid intel agents cyber context data.
    """
    incident: dict = {
        "CustomFields": {
    ...
    mock_return = mocker.patch("DataminrPulseIntelAgentsCyberContext.return_error")
