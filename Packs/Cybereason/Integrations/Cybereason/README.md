...
<p><strong>IMPORTANT</strong>: In order to properly fetch incidents, you need to set the pre-processing script to <em><strong>CybereasonPreProcessing</strong></em> for the incident type you configure in each integration instance. For example, if you select incident type Malware, you need to create a pre-process rule for the Malware incident type to run script <em><strong>CybereasonPreProcessing</strong></em>.</p>
...
<p><strong>Pre-Process Rule for Malware Indicator Type</strong></p>

![Screen Shot 2022-04-12 at 7 36 25 PM](https://user-images.githubusercontent.com/91506078/163082004-934a05d7-841d-47b1-a9d7-071cc32d4a60.png)
