...
#     assert out.outputs['Name'] == 'desktop-vg9ke2u'
...
#     # mocker.patch.object(demisto, 'results')
#     out = json.loads(query_processes_command(client, args))

#     assert out.outputs[0]['EntryContext']['Process'][0]['SHA1'] == "1f912d4bec338ef10b7c9f19976286f8acc4eb97"
...
#     assert out.outputs[0]['EntryContext']['Connection'][0]['ServerAddress'] == "192.168.1.103"
...
#     assert out.outputs[0]['EntryContext']['Cybereason']['Machine'] == "desktop-vg9ke2u"
...
#     assert out.outputs[0]['EntryContext']['Cybereason']['Malops'][0]['GUID'] == "11.3651150229438589171"
...
#     mocker.patch.object(demisto, 'results')
#     update_malop_status_command(client, demisto.args)
#     result = demisto.results.call_args[0]
...
#     mocker.patch.object(demisto, 'results')
#     prevent_file_command(client, demisto.args)
#     result = demisto.results.call_args[0]
...
#     assert out.outputs[0]['EntryContext']['Process']['MD5'] == "fc61fdcad5a9d52a01bd2d596f2c92b9"
#     assert out.outputs[0]['EntryContext']['Process']['Prevent'] == "false"
...
#     # assert out.outputs[0].get('ContentsFormat', '') == 'json'
#     assert out.outputs[0]['Cybereason']['Domain']['Name'] == "www2.bing.com"
...
#     mocker.patch.object(demisto, 'results')
#     query_user_command(client, demisto.args)
#     result = demisto.results.call_args[0]
...
# def test_available_remediation_actions_command(mocker, requests_mock):
...
#     available_remediation_actions_command(client, demisto.args)
#     result = demisto.results.call_args[0]
...
#         headers=HEADERS,
#         proxy=True)
#     args = {"malopGuid": "11.-7780537507363356527", "userName": "prashant@metronlabs.com"}
#     # mocker.patch.object(demisto, 'params', return_value=params)
...
#     assert out.outputs[0]['Download']['progress']['MalopID'] == "11.-7780537507363356527"
...
#     mocker.patch.object(demisto, 'results')
#     download_fetchfile_command(client, demisto.args)
#     result = demisto.results.call_args[0]
#     assert result[0].get('ContentsFormat', '') == 'json'
...
#     close_fetchfile_command(client, demisto.args)
#     result = demisto.results.call_args[0]
...
#         "timeout": 60})
#     quarantine_file_command(client, demisto.args)
#     result = demisto.results.call_args[0]
...
#         "timeout": 60})
#     unquarantine_file_command(client, demisto.args)
#     result = demisto.results.call_args[0]
...
#         "comment": "Unquarantine the File",
#         "timeout": 60})
#     block_file_command(client, demisto.args)
#     result = demisto.results.call_args[0]
...
#     assert out.outputs[0]['actionType'] == "SchedulerScan"
#     assert out.outputs[0]['startTime'] == "1652279731232"
...
#     mocker.patch.object(demisto, 'results')
#     malware_query_command(client, demisto.args)
#     result = demisto.results.call_args[0]
#     assert result[0].get('ContentsFormat', '') == 'json'
...
#     unsuspend_process_command(client, demisto.args)
#     result = demisto.results.call_args[0]
...
#         "timeout": "30"})
#     kill_prevent_unsuspend_command(client, demisto.args)
#     result = demisto.results.call_args[0]
...
#         "malopGuid": "11.-7780537507363356527",
#         "targetId": "-1845090846.-1424333057657783286",
#         "userName": "prashanth@metronlabs.com",
...
#         "comment": "Remove the registry key",
#         "timeout": "30"})
#     output = delete_registry_key_command(client, args)
#     result = demisto.results.call_args[0]
#     assert 'Delete registry key remediation action status is: SUCCESS' in output[0].get('HumanReadable', '')
