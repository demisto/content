...
[Palo Alto Networks Device Security API User Guide](https://pan.dev/iot/api/iot-public-api-new)
...
***
Device Security get device command - get a single device's details.
...
```device-security-get-device id=00:0f:e5:04:14:4c```
...
***
Device Security list devices command
...
***
Device Security list vulnerabilities.
...
```device-security-list-vulns limit=2 offset=0```
...
***
Resolving a Device Security alert.
...
***
Resolving a Device Security vulnerability.
...
```device-security-resolve-vuln full_name=CVE-2019-10960 id=vuln-b12d4f0a reason=test```
