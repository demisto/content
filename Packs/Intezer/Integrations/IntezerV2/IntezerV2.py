...
def enrich_dbot_and_display_file_analysis_results(intezer_result: dict, file_metadata: dict):
    ...
    dbot_entry, file = _get_dbot_and_file_entries(intezer_result, file_metadata)
...
def _get_dbot_and_file_entries(file_analysis_result: dict, file_metadata: dict) -> Tuple[List[dict], dict]:
...
def enrich_dbot_and_display_url_analysis_results(intezer_result, intezer_api):
    ...
    if 'downloaded_file' in intezer_result:
        ...
        file_dbot_entry, file_entry = _get_dbot_and_file_entries(download_file_result, metadata)
