...
def mock_client():
    return Client(base_url='https://test.com', verify=False, proxy=False, client_id='client_id',
...
TOKEN_TEST = [({'access_token': 'integration_context_token', 'valid_until': 1000}, 'integration_context_token'),
              ({}, 'new_access_token'),
...
def test_get_access_token(mocker, requests_mock, integration_context, expected_token):
    ...
    requests_mock.post(
        ...
        json={'access_token': 'new_access_token', 'expires_in': 1})
