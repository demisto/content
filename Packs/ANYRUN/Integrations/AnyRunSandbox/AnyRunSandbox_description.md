...
This section explains how to configure the instance of ANY.RUN Cloud Sandbox in Cortex XSOAR.  
...
| Base domain      | The base domain for the ANY.RUN connection. By default, the domain is any.run.
...
|-----------------|------------------------|
| any.run         | Default
| anyrun.us       | Special access required