...
This playbook triggers automated remediation for all SafeBreach generated
...
|---|---|---|---|---|---|---|
| 5 | Blacklist malicious domains | Web | 0.42 | Medium | 2 | Domain |
| 9 | Prevent malware to be written to disk | Endpoint | 0.36 | Medium | 3 | Hash |
...
|FQDN/IP (71)|
|---|
| codeluxsoftware.com.,<br />866448.com.,<br />a1.weilwords2.com.br.|
