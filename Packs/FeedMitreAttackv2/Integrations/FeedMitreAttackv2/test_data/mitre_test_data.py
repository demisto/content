...
COURSE_OF_ACTION = {
    "response": {
        ...
        "external_references": [
            {"external_id": "T1151", "source_name": "mitre-attack", "url": "https://attack.mitre.org/mitigations/T1151"}
        ],
...
INTRUSION_SET = {
    "response": {
        "external_references": [
            {"external_id": "G0066", "source_name": "mitre-attack", "url": "https://attack.mitre.org/groups/G0066"},
            {"description": "(Citation: Security Affairs Elderwood Sept 2012)", "source_name": "Elderwood"},
        ],
    ...
    "map_result": {
        ...
        "modified": "2021-03-02T22:40:11.097Z",
        "publications": [
            {"link": "", "source": "Elderwood", "title": "(Citation: Security Affairs Elderwood Sept " "2012)", "timestamp": ""}
        ],
...
MALWARE = {
    "response": {
        ...
        "external_references": [
            {"external_id": "S0206", "source_name": "mitre-attack", "url": "https://attack.mitre.org/software/S0206"},
            {
...
TOOL = {
    "response": {
        ...
        "external_references": [
            {"external_id": "S0194", "source_name": "mitre-attack", "url": "https://attack.mitre.org/software/S0194"}
        ],
        "x_mitre_platforms": ["Windows"],
...
resource-library/reports/Op_Dust_Storm_Report.pdf",
 ...
 Japan or South Korea.",
        "publications": [
            {
                "link": "https://s7d2.scene7.com/is/content/cylance/prod/cylance-web/en-us/resources/knowledge-center/\
resource-library/reports/Op_Dust_Storm_Report.pdf",
...
ATTACK_PATTERNS = [
    {
        ...
        "external_references": [
            {"source_name": "mitre-attack", "external_id": "T1111.001", "url": "https://attack.mitre.org/techniques/T1111/001"},
            {
    ...
    },
    {
        ...
        "created_by_ref": "identity--c78cb6e5-0c4b-4611-8297-d1b8b55e40b5",
        "external_references": [
            {"source_name": "mitre-attack", "external_id": "T1111", "url": "https://attack.mitre.org/techniques/T1111"},
            {"source_name": "Scan", "url": "https://test.org", "description": "Test. (2012). Retrieved October 20, 2020."},
        ],
