...
| Certificate (Required for HTTPS)   | (For Cortex XSOAR 6.x, Cortex XSOAR 8 On-prem and Cloud engine, and Cortex XSIAM engine) For use with HTTPS - the certificate that the service should use.  <br> (For Cortex XSOAR 8 Cloud server and Cortex XSIAM server) Custom certificates are not supported.                                                                                                                                                                                  | False        |
| Private Key (Required for HTTPS)   | (For Cortex XSOAR 6.x, Cortex XSOAR 8 On-prem and Cloud engine, and Cortex XSIAM engine) For use with HTTPS - the private key that the service should use.  <br> (For Cortex XSOAR 8 Cloud server and Cortex XSIAM server) Private keyse are not supported.                                                                                                                                                                                  | False        |
