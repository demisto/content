...
2. Grant the the below mentioned OAuth [scope](https://cloud.google.com/logging/docs/reference/v2/rest/v2/entries/list) to the Service Account to enable the Service Account to perform certain Google Cloud API commands.
