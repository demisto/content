...
class Client:
    ...
    def list_blobs_request(self, container_name: str, limit: str = None, prefix: str = None, marker: str = None) -> str:
        ...
        response = self.ms_client.http_request(
            method="GET", url_suffix=f"{container_name}", params=params, resp_type="text"
        )
    ...
    def get_blob_request(self, container_name: str, blob_name: str) -> Response:
        ...
        """
        response = self.ms_client.http_request(
            method="GET", url_suffix=f"{container_name}/{blob_name}", resp_type="response"
        )
    ...
    def get_blob_properties_request(self, container_name: str, blob_name: str) -> Response:
        ...
        response = self.ms_client.http_request(
            method="HEAD", url_suffix=f"{container_name}/{blob_name}", resp_type="response"
        )
...
def list_containers_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    readable_output = tableToMarkdown(
        readable_message, outputs, headers=["name"], headerTransform=string_to_table_header
    )
