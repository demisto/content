...
| **Argument Name** | **Description** | **Required** |
| --- | --- | --- |
| project_id | The project ID for this request. Required for Cortex Platform (which includes Cortex XSIAM version &gt;=3.0). Optional for Cortex XSOAR and Cortex XSIAM version &lt; 3.0, where it can be retrieved from the integration configuration. | Optional |
| image | Name of the image resource to return. | Required |
