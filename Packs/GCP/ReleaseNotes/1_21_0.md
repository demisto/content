...
Migrated the **Google Resource Manager** integration from the **GoogleResourceManager** content pack into the unified **Google Cloud Platform** integration. Added the following commands:
