...
4. Click **Add instance** to create and configure a new integration instance.
    ...
    | Issue Field to fetch by | This is how the field \(e.g, created date\) is applied to the query. For example: "created >= \{created date in last run\} ORDER BY created ASC". | False |
