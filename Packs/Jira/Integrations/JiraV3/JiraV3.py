...
def get_remote_data_command(
    ...
    try:
        ...
        demisto.debug(f"Error in Jira incoming mirror for incident {parsed_args.remote_incident_id}" f"Error message: {str(e)}")
...
def update_remote_system_command(
    ...
    try:
        ...
        demisto.error(
            f"Error in Jira outgoing mirror for incident {remote_args.remote_incident_id} \n" f"Error message: {str(e)}"
        )
    finally:
        return remote_id
