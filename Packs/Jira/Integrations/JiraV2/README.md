...
3. **Authentiction**: As of June 2019, basic authentication using passwords for Jira Cloud is no longer supported. Use an API token or OAuth 1.0 instead or OAuth 2.0 (authentication code). As of this writing, Jira Data Center (unlike Jira Cloud) still supports basic authentication.
