...
![image](../../doc_files/mirror-configuration.png/n)
...
![image](../../doc_files/mirror_incoming_mapper_fields.png/n)
...
Jira supports.
![](../../doc_files/outgoing_editor_7.png/n)
...
![image](../../doc_files/mirror-files.png/n)
...
![image](../../doc_files/edit_incident_via_layout.png/n)
...
![](../../doc_files/create_new_field_1.png/n)
...
![](../../doc_files/settings_find_layout_2.png/n)

### Add the new field to the incoming mapper:

1. Go to Settings -> Integrations -> Servers & Services -> in the search bar type “Jira”.
2. Open the integration settings by clicking on the button:![](../../doc_files/setting_btn.png/n) or by clicking on "Add instance" if you don&#39;t have Jira already configured in your system.  
...
![](../../doc_files/fetch_incidents_3.png/n)
...
![](../../doc_files/con_mapper_in_4.png/n)

4. Click on the button:![](../../doc_files/edit_mapper_btn.png/n) in order to edit the selected mapper. It will open the "Incident Incoming Mapping Editor".  
...
![](../../doc_files/incoming_editor_5.png /n)
...
![](../../doc_files/map_in_incident_6.png/n)
...
1. Go to Settings -> Integrations -> Servers & Services -> in the search bar type “Jira”.
2. Open the integration settings by clicking on the button: ![](../../doc_files/setting_btn.png/n)
...
4. Click on the button: ![](../../doc_files/edit_mapper_btn.png/n) in order to edit the selected mapper. It will open the "Incident Outgoing Mapping Editor".
...
![](../../doc_files/map_out_field_8.png/n)
...
![](../../doc_files/download_as_json_10.png/n)
...
![](../../doc_files/upload_json_11.png/n)
...
![](../../doc_files/list_transitions.png/n)
