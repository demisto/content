...
from FeedThreatVault import Client, fetch_indicators_command, main, parse_indicator_for_fetch, threatvault_get_indicators_command
...
def test_threatvault_main_command_success(mocker):
    ...
    mocker.patch.object(
        FeedThreatVault,
        "threatvault_get_indicators_command",
