...
- The integration now supports MIRROR IN and OUT between XSOAR and Sumo Logic Cloud SIEM. Note: The mirror works for Sumo Logic Insight incidents only, as Sumo Logic Signals are immutable
- For Mirror: 
