...
def execute_command_mock(command, args):
                ...
                "data": [
                    {
                        ...
                        "labels": [{"type": "signals", "value": [{"id": "00853cdd-763e-3e31-a2e4-f74277922f9f"}]}],
                    }
                ],
            }
        }
    ...
    incident_searchv2_raw = [
        {
            "Contents": [
                {
                    "Contents": {
                        "data": [{"id": "11", "rawType": "Sumo Logic Signal"}, {"id": "11", "rawType": "Sumo Logic Signal"}]
                    }
                }
            ]
        }
    ...
    link_incident_raw = [
        {"Contents": {"total": 1, "data": [{"id": "11", "rawType": "Sumo Logic Insight", "linkedIncidents": ["12", "13"]}]}}
    ]
