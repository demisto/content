...
def test_get_incident_message_ids(requests_mock):
    ...
    """
    mock_response = util_load_json(os.path.dirname(__file__) + "/test_data/test_get_incident_message_ids.json")
...
def test_get_remediation_action(requests_mock):
    ...
    mock_response = util_load_json(os.path.dirname(__file__) + "/test_data/test_get_remediation_action.json")
    requests_mock.get(url + '/3875', json=mock_response)
    client = Client(api_key=API_KEY, instance_name=TENANT_NAME)
...
def test_get_incidents_list(requests_mock):
    ...
    mock_response = util_load_json(os.path.dirname(__file__) + "/test_data/test_get_incidents_list.json")
    ...
    mock_response_for_incident_id = util_load_json(os.path.dirname(__file__) + "/test_data/test_response_for_6484.json")
...
def test_fetch_incidents_command(requests_mock):
    ...
    incidents_response = util_load_json(os.path.dirname(__file__) + "/test_data/test_get_incidents_list.json")
