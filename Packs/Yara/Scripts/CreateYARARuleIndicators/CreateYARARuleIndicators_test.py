...
from CreateYARARuleIndicators import build_indicator, build_relationships, parse_metadata, parse_rules
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            [{"Contents": '{"Attack_Pattern":["Internal Spearphishing"]}'}],
            EntityRelationship(
                entity_a="Test_Rule_2", entity_a_type="YARA Rule", entity_b="APT42", entity_b_type="Malware", name="related-to"
            ),
        ),
        (
