...
def predict_phishing_words(
    ...
    if is_model_applied_on_a_single_incidents:
        ...
        return predict_batch_incidents_light_output(email_subject, email_body, phishing_model, model_type, min_text_length)
...
def predict_single_incident_full_output(
    email_subject,
    email_body,
    is_return_error,
    label_threshold,
    ...
    return {
        ...
        "HumanReadable": tableToMarkdown(
            ...
            explain_result_hr,
            headers=["TextTokensHighlighted", "Label", "Confidence", "PositiveWords", "NegativeWords"],
            removeNull=True,
        ),
        "HumanReadableFormat": formats["markdown"],
        "EntryContext": {"DBotPredictPhishingWords": explain_result},
    }
