...
from DBotPreprocessTextData import (
    Tokenizer,
    clean_html_from_text,
    clean_text_of_incidents_list,
    concat_text_fields,
    hash_word,
    is_text_in_input_language,
    main,
    pre_process_batch,
    read_file,
    remove_duplicate_by_indices,
    remove_foreign_language,
    remove_line_breaks,
    remove_short_text,
    whitelist_dict_fields,
)
...
def test_concat_text_field(mocker):
    data = [
        ...
        {"body": "TestBody", "subject": "TestSubject"},
        {"body2": "TestBody2", "subject": "TestSubject"},
    ]
