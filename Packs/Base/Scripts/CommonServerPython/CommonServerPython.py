...
def set_last_mirror_run(last_mirror_run):
    ...
    Before XSOAR version 6.6.0: we don't set the given data`.
    ...
    if is_demisto_version_ge('6.6.0'):
        ...
        return "You cannot use setLastMirrorRun as your version is below 6.6.0"


def get_last_mirror_run():
    """
    This function gets the mirror last run: from XSOAR version 6.6.0: using `demisto.getLastMirrorRun()`.
    Before XSOAR version 6.6.0: we don't get the given data`.
    :rtype: ``dict``
    :return: All indicators from the feed's last run
    """
    if is_demisto_version_ge('6.6.0'):
        ...
        return "You cannot use getLastMirrorRun as your version is below 6.6.0"
