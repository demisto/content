...
urlRegex = r"(?i)[\[({\"']*(?:(?:(?:https?|hxxps?|s?ftps?|meows?)[:-](?:\/\/|\\\\|3A__))(?:[-_\d\w]+\[?\.\]?)+[-_\d\w\[\]]+(?::\d+)?(?:[/*#?]*(?:[?\d\w+&@'#%=~_\\\/$!:.;*–—―\-|\[\]]*|[(][\-\d\w+&@#\/%=~_$?!:,;*–—―|\[\]]*[)])*)|(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)|(?:(?:[\[\]\w\dֿ]+\[?\.\]?)+[\w]+))(?::[\d]+)?\/(?:[\-\w+&@#\/%=~_$?!\\:,;*–—―|.\])]+(?:\d*)?)+|(?:(?:https?|s?ftps?|hxxps?):(?:\/\/|\\\\))[\d][\S]+|((https?|s?ftps?|hxxps?):((\/\/)|(\\\\)))?(\[)?(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))(\])?(:[\d]+)?(((\/|\\)[\d]+(\/|\\)[-\d\w+&@'#\/%=~_$!\-:.;\\*–—―|\[\]]+)|((\/|\\)[^\d \n\t]+)))[\])}\"']*"  # noqa: E501
