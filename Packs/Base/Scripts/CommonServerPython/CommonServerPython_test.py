...
from CommonServerPython import (xml2json, json2xml, entryTypes, formats, tableToMarkdown, underscoreToCamelCase,
                                ...
                                censor_request_logs, censor_request_logs, safe_sleep, get_engine_base_url,
...
@pytest.mark.parametrize('data, instance_name, expected_result',
...
def test_get_engine_base_url(mocker):
    ...
    mock_response = {
        'body': {'engines': [
            {'id': '1111', 'baseUrl': '10.180.188.33:443'},
            {'id': '2222', 'baseUrl': '10.180.188.44:443'}
            ]},
        }
    mocker.patch.object(demisto, 'internalHttpRequest', return_value=mock_response)
    res = get_engine_base_url('1111')
    assert res == '10.180.188.33:443'
