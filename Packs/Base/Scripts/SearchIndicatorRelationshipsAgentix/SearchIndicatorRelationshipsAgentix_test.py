...
def test_get_relationships_with_entities_types_calls_filter_function(mocker):
    ...
    When: Calling get_relationships with entities and related_entities_types parameters
    ...
    result = get_relationships({"entities": ["malware.exe"], "related_entities_types": ["File"], "limit": 10})
