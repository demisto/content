To allow access to EWS O365, an administrator has to approve the Demisto app using an admin consent flow, by clicking on the following [Cortex XSOAR Application](https://oproxy.demisto.ninja/ms-ews-o365) (Cortex XSOAR - EWS O365).
