...
***
Create a transport rule (mail flow rule) in the organization. At least one action (reject_message_reason_text, quarantine, or delete_message) must be provided.
...
***
Modify an existing transport rule (mail flow rule) in the organization.
