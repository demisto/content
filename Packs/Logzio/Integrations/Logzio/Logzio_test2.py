...
client = Logzio.Client("us", "ac4f3246-c684-4194-9ac9-709b33bc33a9",
                       # "8f974a9b-b83f-47cb-8fd7-4361fe3d198e",
                       "d6ce53bb-2f01-4bf7-9141-2324e7be399a",
                       True, False)
# Logzio.test_module(client)
args = {
    # "id": "e9ef3227-7ed8-4060-8c25-4d78e9571537"
    "id": "a32150ed-e189-4324-836a-05a36fcabd8f"
}
# results = Logzio.get_rule_logs_by_id_command(client, args)
# print(results)
# print(len(results["Contents"]))
# inc, last = Logzio.fetch_incidents(client, {}, None, ["LOW", "MEDIUM", "HIGH"], '5 days')
...
# while True:
#     time.sleep(60)
#     inc, last = Logzio.fetch_incidents(client, last, None, ["MEDIUM", "HIGH"], '1 hour')
#     print(inc)
#     print(last)
# #
args = {
    "query": "ThreatType:trojan OR input.type:tcp",
    # "key1": "EPOevent.SoftwareInfo.Event.CommonFields.SourceURL",
    # "value1": "http:",
    "size": 10,
    # "from_time": "2020-05-05T00:59:14.963",
    # "to_time": "1580376254000"
    "timeout": "16"
}


print (json.dumps(Logzio.search_logs_command(client, args)))
class TestLogzio:
