...
class TestLogzio:
    def test_logzio_fetch_incidents(self, requests_mock):
        requests_mock.post(f"{BASE_URL}{Logzio.TRIGGERED_RULES_API_SUFFIX}", json=TRIGGERED_RULES_RESPONSE_BODY)
        ...
        # Second fetch checks
        requests_mock.post(f"{BASE_URL}{Logzio.TRIGGERED_RULES_API_SUFFIX}", json=TRIGGERED_RULES_EMPTY_RESPONSE_BODY)
    ...
    def test_logzio_get_rule_logs(self, requests_mock):
        ...
        requests_mock.post(f"{BASE_URL}{Logzio.SEARCH_RULE_LOGS_API_SUFFIX}", json=RULE_LOGS_RESPONSE_BODY)
