...
SEARCH_LOGS_RESPONSE_EMPTY_BODY = {"hits": {"hits": []}}
...
TRIGGERED_RULES_EMPTY_RESPONSE_BODY = {"results": []}
...
class TestLogzio:
    def test_logzio_fetch_incidents(self, requests_mock):
        requests_mock.post("{}{}".format(BASE_URL, Logzio.TRIGGERED_RULES_API_SUFFIX), json=TRIGGERED_RULES_RESPONSE_BODY)
        ...
        # Second fetch checks
        requests_mock.post("{}{}".format(BASE_URL, Logzio.TRIGGERED_RULES_API_SUFFIX), json=TRIGGERED_RULES_EMPTY_RESPONSE_BODY)
    ...
    def test_logzio_search_logs_command(self, requests_mock):
        client = Logzio.Client("us", "fake-security-token", "fake-operational-token", False, False)
        args = {"query": "name:test", "size": 20, "from_time": "1581261159", "to_time": "1581174759"}
    ...
    def test_logzio_search_command_human_date(self, requests_mock):
        client = Logzio.Client("us", "fake-security-token", "fake-operational-token", False, False)
        args = {"from_time": "2020-03-29T14:46:17.236Z", "to_time": "2020-03-29T18:46:17.236Z"}
    ...
    def test_logzio_get_rule_logs(self, requests_mock):
        client = Logzio.Client("us", "fake-security-token", "fake-operational-token", False, False)
        args = {"id": 123, "size": 100, "page_size": 2}

        requests_mock.post("{}{}".format(BASE_URL, Logzio.SEARCH_RULE_LOGS_API_SUFFIX), json=RULE_LOGS_RESPONSE_BODY)
