...
__Note__: The search time range can span over 2 calender days at most. If you supply a time range greater than that,
the search window will be the __last__ 2 calender days within the range you supplied.
