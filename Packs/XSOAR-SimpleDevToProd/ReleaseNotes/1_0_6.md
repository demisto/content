...
- Updated to add Core Rest API to tooltip: **XSOAR Dev Instance Name**

- Updated to add Core Rest API to tooltip: **XSOAR Dev to Prod Method**

- Updated to add Core Rest API to tooltip: **XSOAR Prod Instance Name**
...
- Formatting Changes from SDK: **XSOAR Dev to Prod**
