...
| GoogleCloudSCC.FindingV2.muteInitiator | String | The additional information about the mute operation, for example, the mute configuration that muted the finding and the user who muted the finding. |
| GoogleCloudSCC.FindingV2.muteUpdateTime | Date | The time at which the finding was muted or unmuted, in ISO 8601 format \(e.g., 2026-09-15T12:34:56Z\). |
| GoogleCloudSCC.FindingV2.eventTime | Date | The time the finding was first detected, in ISO 8601 format \(e.g., 2026-09-15T12:34:56Z\). |
