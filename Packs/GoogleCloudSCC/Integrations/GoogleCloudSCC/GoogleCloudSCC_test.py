...
def test_fetch_incidents(pubsub_client):
    ...
    with open(os.path.dirname(__file__) + 'test_data/fetch_incidents_data.json') as file:
...
def test_prepare_hr_and_ec_for_list_findings():
    ...
    with open(os.path.dirname(__file__) + 'test_data/list_finding_response.json') as f:
        finding_response = json.load(f)
    with open(os.path.dirname(__file__) + 'test_data/list_finding_ec.json') as f:
...
def test_findings_list_command(client):
    ...
    with open(os.path.dirname(__file__) + 'test_data/list_finding_response.json') as file:
        mock_data = json.load(file)
    with open(os.path.dirname(__file__) + 'test_data/list_finding_ec.json') as f:
        finding_ec = json.load(f)
    with open(os.path.dirname(__file__) + 'test_data/list_finding_hr.md') as f:
        hr_output = f.read()
...
def test_prepare_hr_and_ec_for_list_assets():
    ...
    with open(os.path.dirname(__file__) + 'test_data/list_asset_response.json') as f:
        asset_response = json.load(f)
    with open(os.path.dirname(__file__) + 'test_data/list_asset_ec.json') as f:
...
def test_asset_list_command(client):
    ...
    with open(os.path.dirname(__file__) + 'test_data/list_asset_response.json') as file:
        mock_data = json.load(file)
    with open(os.path.dirname(__file__) + 'test_data/list_asset_ec.json') as f:
        asset_ec = json.load(f)
    with open(os.path.dirname(__file__) + 'test_data/list_asset_hr.md') as f:
        hr_output = f.read()
    GoogleNameParser.get_organization_id = Mock(return_value='123')
...
def test_prepare_hr_and_ec_for_update_finding():
    ...
    with open(os.path.dirname(__file__) + 'test_data/update_finding_response.json') as f:
        finding_response = json.load(f)
...
def test_prepare_hr_and_ec_for_cloud_assets_list():
    ...
    with open(os.path.dirname(__file__) + 'test_data/cloud_assets_list_response.json') as f:
        cloud_assets_response = json.load(f)

    with open(os.path.dirname(__file__) + 'test_data/cloud_assets_list_ec.json') as f:
...
def test_cloud_asset_list_command(cloud_asset_client):
    ...
    with open(os.path.dirname(__file__) + 'test_data/cloud_assets_list_response.json') as file:
        mock_data = json.load(file)
    with open(os.path.dirname(__file__) + 'test_data/cloud_assets_list_ec.json') as f:
        asset_ec = json.load(f)
    with open(os.path.dirname(__file__) + 'test_data/cloud_assets_list_hr.md') as f:
        hr_output = f.read()
    GoogleNameParser.get_organization_id = Mock(return_value='123')
...
def test_cloud_asset_owner_get_command(cloud_asset_client, test_case, project_names, max_iterations, call_count):
    ...
    with open(os.path.dirname(__file__) + 'test_data/cloud_assets_owners_get_response.json') as file:
        mock_data = json.load(file)['test-cases'][test_case]
    with open(os.path.dirname(__file__) + 'test_data/cloud_assets_owners_get_hr.json') as file:
...
def test_finding_update_command(client, mocker):
    ...
    with open(os.path.dirname(__file__) + 'test_data/update_finding_response.json') as file:
        mock_data = json.load(file)
    with open(os.path.dirname(__file__) + 'test_data/update_finding_ec.json') as f:
        finding_ec = json.load(f)
    with open(os.path.dirname(__file__) + 'test_data/update_finding_hr.md') as f:
        hr_output = f.read()
...
def test_prepare_hr_and_ec_for_cloud_asset_owners_get():
    ...
    with open(os.path.dirname(__file__) + 'test_data/cloud_assets_owners_get_assets.json') as f:
        cloud_assets_response = json.load(f)

    with open(os.path.dirname(__file__) + 'test_data/cloud_assets_owners_get_ec.json') as f:
        cloud_assets_ec = json.load(f)
