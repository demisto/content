...
Added the **ProofpointTAPMostAttackedUsers** script to export a list of ProofPointTAP most attacked users to the Cortex XSOAR
  widget.
...
Added the **ProofPointTAP - Event Enrichment** playbook to get information about the forensics of threats and campaigns for an event.