...
- Added the classifier:
    - Proofpoint TAP Classifier - Supported to version 6.0.0 of Cortex XSOAR.
    - Proofpoint TAP v2 - Supported to version 5.5.0 of Cortex XSOAR.
...
##### ProofPointTAP - Event Enrichment

- Added the **ProofPointTAP - Event Enrichment** playbooks in order to get information about the forensics of threat and campaign of
  event.