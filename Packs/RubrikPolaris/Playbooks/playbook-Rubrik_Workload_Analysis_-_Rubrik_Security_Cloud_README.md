...
| domains | The optional comma-separated list of domain\(s\)/hostname\(s\) for which to use workload information to increase the XSOAR incident severity. |  | Optional |
