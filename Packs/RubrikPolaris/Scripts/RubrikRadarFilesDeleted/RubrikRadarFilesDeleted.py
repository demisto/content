...
def main() -> None:
    ...
    try:
        ...
        if not radar_files_deleted:
            html = f"<div style={DIV_HTML_STYLE}><h1 style={GREEN_HTML_STYLE}{str(radar_files_deleted)} Files Added</h1></div>"
        else:
            html = f"<div style={DIV_HTML_STYLE}><h1 style={ORANGE_HTML_STYLE}{str(radar_files_deleted)} Files Added</h1></div>"
