...
- Added two new options in the Rubrik Polaris integration settings that allow the user to map the Radar Critical and Warning event severity levels to various XSOAR severity levels upon incident fetch.  The default severity mappings are currently:  Radar Critical -> XSOAR HIGH and Radar Warning -> XSOAR LOW.
...
#### Playbooks
##### New: Rubrik Post Intrusion Ransomware Investigation
...
Playbook settings and mapping:
 ...
 - (DEPRECATED).  This playbook has now been deprecated.  Please refer to and use the Rubrik Post Intrusion Ransomware Investigation playbook instead.
...
- Varius changes to the mapping file to accomodate new fields.
