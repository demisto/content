...
def search_incidents_by_params_command(client: Client, args: dict[str, Any]) -> CommandResults:
    ...
    statusId = args.get('statusId')
    subStatusId = args.get('subStatusId')
    teamId = args.get('teamId')
    unitId = args.get('unitId')
    creatorId = args.get('creatorId')
    requesterId = args.get('requesterId')
    itemId = args.get('itemId')
    priorityId = args.get('priorityId')
    assignedUserId = args.get('assignedUserId')
    createdTimeGTE = args.get('createdTimeGTE')
    createdTimeLT = args.get('createdTimeLT')
    updatedTimeGTE = args.get('updatedTimeGTE')
    updatedTimeLT = args.get('updatedTimeLT')
