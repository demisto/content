...
class Client(BaseClient):
    ...
    def get_session_token(self, get_new_token: bool = False):
        if get_new_token:
            response = self.fortimanager_http_request(
                "exec", "/sys/login/user", json_data={"user": self.username, "passwd": self.password}, add_session_token=False
            )
    ...
    def fortimanager_http_request(
        ...
        body: dict = {
            ...
            "method": method,
            "verbose": 1,
            "params": [{"option": "object member", "url": url}],
        }
        ...
        response = self._http_request(method="POST", url_suffix="jsonrpc", json_data=body)
        return response

    def fortimanager_api_call(
        self,
        method: str,
        url: str,
        data_in_list: dict = None,
...
def list_adom_devices_command(client, args):
    ...
    return CommandResults(
        ...
        readable_output=tableToMarkdown(
            f"ADOM {get_global_or_adom(client, args)} Devices",
            hr_devices_data,
            removeNull=True,
...
def list_adom_devices_groups_command(client, args):
    ...
    return CommandResults(
        ...
        readable_output=tableToMarkdown(
            f"ADOM {get_global_or_adom(client, args)} Device Groups",
            device_groups_data,
            removeNull=True,
            headerTransform=string_to_table_header,
            headers=headers,
...
def list_firewall_addresses_command(client, args):
    ...
    headers = (
        ["name", "type", "subnet", "start-ip", "end-ip", "fqdkn", "wildcard", "country", "wildcard-fqdn", "sdn", "comment"]
...
def create_address_command(client, args):
    client.fortimanager_api_call(
        "add",
        f"/pm/config/{get_global_or_adom(client, args)}/obj/firewall/address",
...
def create_address_group_command(client, args):
    ...
    client.fortimanager_api_call("add", f"/pm/config/{get_global_or_adom(client, args)}/obj/firewall/addrgrp", data_in_list=data)
...
def update_address_group_command(client, args):
    ...
    data["member"] = data.get("member").split(",")
    client.fortimanager_api_call(
        "update", f"/pm/config/{get_global_or_adom(client, args)}/obj/firewall/addrgrp", data_in_list=data
    )
...
def list_service_categories_command(client, args):
    service_categories = client.fortimanager_api_call(
        "get",
        f"/pm/config/"
    ...
    return CommandResults(
        ...
        readable_output=tableToMarkdown(
            "Service Categories", service_categories, removeNull=True, headerTransform=string_to_table_header, headers=headers
        ),
...
def list_service_groups_command(client, args):
    service_groups = client.fortimanager_api_call(
        "get",
        f"/pm/config/"
        f"{get_global_or_adom(client, args)}"
    ...
    return CommandResults(
        ...
        readable_output=tableToMarkdown(
            "Service Groups", service_groups, removeNull=True, headerTransform=string_to_table_header, headers=headers
        ),
...
def create_service_group_command(client, args):
    ...
    data["member"] = data.get("member").split(",")
    client.fortimanager_api_call(
        "add", f"/pm/config/{get_global_or_adom(client, args)}/obj/firewall/service/group", data_in_list=data
    )
...
def update_service_group_command(client, args):
    ...
    client.fortimanager_api_call(
        "update", f"/pm/config/{get_global_or_adom(client, args)}/obj/firewall/service/group", data_in_list=data
    )
...
def list_custom_service_command(client, args):
    custom_services = client.fortimanager_api_call(
        "get",
        f"/pm/config/"
        f"{get_global_or_adom(client, args)}"
    ...
    return CommandResults(
        ...
        readable_output=tableToMarkdown(
            "Custom Services", custom_services, removeNull=True, headerTransform=string_to_table_header, headers=headers
        ),
...
def create_custom_service_command(client, args):
    client.fortimanager_api_call(
        "add",
        f"/pm/config/{get_global_or_adom(client, args)}/obj/firewall/service/custom",
        data_in_list=setup_request_data(args, ["adom"]),
    )
...
def list_policy_packages_command(client, args):
    ...
    return CommandResults(
        ...
        readable_output=tableToMarkdown(
            "Policy Packages", policy_packages, removeNull=True, headerTransform=string_to_table_header, headers=headers
        ),
...
def list_policies_command(client, args):
    ...
    return CommandResults(
        ...
        outputs=policies,
        readable_output=tableToMarkdown(
            f"ADOM {client.adom} Policy Package {args.get('package')} Policies",
            policies,
            removeNull=True,
            headerTransform=string_to_table_header,
            headers=headers,
...
def move_policy_command(client, args):
    ...
    return (
        f"Moved policy with ID {args.get('policy')} {args.get('option')} {args.get('target')} "
...
def list_dynamic_interface_command(client, args):
    ...
    return CommandResults(
        ...
        readable_output=tableToMarkdown(
            f"ADOM {client.adom} Dynamic Interfaces",
            dynamic_interfaces,
            removeNull=True,
            headerTransform=string_to_table_header,
            headers=headers,
...
def install_policy_package_command(client, args):
    response = client.fortimanager_api_call(
        "exec",
        ...
        json_data={
            ...
            "scope": [{"name": args.get("name"), "vdom": args.get("vdom")}],
        },
    )
...
def install_policy_package_status_command(client, args):
    ...
    return CommandResults(
        ...
        outputs=task_data,
        readable_output=tableToMarkdown(
            f"Installation Task {args.get('task_id')} Status",
            task_data,
            removeNull=True,
            headerTransform=string_to_table_header,
            headers=headers,
...
def main() -> None:
    ...
    try:
        client = Client(url=base_url, credentials=creds, verify=verify_certificate, proxy=proxy, adom=adom)
