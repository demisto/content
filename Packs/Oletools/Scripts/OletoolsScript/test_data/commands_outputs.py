oleid_output = {
    "sha256": "5e39dc43ecf63d3e670f757991691f0b10317d4eb83662d0898a40149927372f",
    ...
    "ole_command_result": {
        ...
        "XLM_Macros": {"Value": "No", "Ole_Risk": "none", "Description": "This file does not contain Excel 4/XLM macros."},
...
olevba_otuput = {
    ...
    "ole_command_result": {
        ...
        "macro_analyze": [
            {"Type": "AutoExec", "Keyword": "Document_Open", "Description": "Runs when the Word or Publisher document is opened"},
            {
                "Type": "Suspicious",
...
oleid_decrypted_output = {
    "sha256": "c3b4854dd73688154069cfe467b6899d2f77f6420a7a1bf8e22eacbe5eef811b",
    "file_name": "ActiveBarcode-Demo-Bind-Text.docm",
    "ole_command_result": {
        "File_format": {"Value": "MS Word 2007+ Macro-Enabled Document (.docm)", "Ole_Risk": "info", "Description": ""},
        "Container_format": {"Value": "OpenXML", "Ole_Risk": "info", "Description": "Container type"},
