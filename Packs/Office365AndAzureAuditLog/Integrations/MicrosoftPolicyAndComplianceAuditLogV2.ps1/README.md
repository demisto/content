...
This integration was integrated and tested with version xx of MicrosoftPolicyAndComplianceAuditLogV2

## Configure Microsoft Policy And Compliance V2 (Audit Log) on Cortex XSOAR

1. Navigate to **Settings** > **Integrations** > **Servers & Services**.
2. Search for Microsoft Policy And Compliance V2 (Audit Log).
