...
def test_parse_report_and_return_results():
    test_response = util_load_json(os.path.dirname(__file__) + '/test_data/tiscale_response.json')
    test_context = util_load_json(os.path.dirname(__file__) + '/test_data/tiscale_context.json')
...
def test_parse_upload_report_and_return_results():
    test_response = util_load_json(os.path.dirname(__file__) + '/test_data/tiscale_upload_response.json')
    test_context = util_load_json(os.path.dirname(__file__) + '/test_data/tiscale_upload_context.json')
