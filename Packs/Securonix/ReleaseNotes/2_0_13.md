...
- Updated the ***securonix-get-incident*** and ***securonix-list-incidents*** commands to include the Spotter query in the HR and context by upgrading to the latest version of the API.
