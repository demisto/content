...
def main():
    try:
        ...
        if not violations:
            ...
            headers = ["Eventid", "Violator", "Policyname", "Riskthreatname", "Tenantname", "Category", "Jobstarttime"]

            human_readable = tableToMarkdown(heading, t=remove_empty_elements(violation_output), headers=headers, removeNull=True)
