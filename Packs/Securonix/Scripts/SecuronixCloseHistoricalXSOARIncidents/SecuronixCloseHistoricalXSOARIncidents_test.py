...
def test_get_securonix_incident_id():
    ...
    with open(os.path.dirname(__file__) + 'test_data/mock_incident_contents.json', 'r') as f:
...
def test_is_securonix_incident_closed_when_incident_is_in_progress():
    ...
    with open(os.path.dirname(__file__) + 'test_data/incident_activity_history_get_response.json', 'r') as f:
...
def test_close_xsoar_incident_script_success(mock_return, mock_execute_command, mock_args):
    ...
    with open(os.path.dirname(__file__) + 'test_data/mock_incidents.json', 'r') as f:
