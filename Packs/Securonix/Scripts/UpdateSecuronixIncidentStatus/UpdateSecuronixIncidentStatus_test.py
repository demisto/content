...
MOCK_INCIDENT = {"id": "100", "CustomFields": {"securonixincidentstatus": "new"}}
MOCK_RESPONSE_PERFORM_ACTION = [{"Contents": "submitted", "ContentsFormat": "text", "EntryContext": None, "Type": 4}]
MOCK_RESPONSE_ADD_COMMENT = [{"Contents": True, "ContentsFormat": "text", "EntryContext": None, "Type": 4}]
