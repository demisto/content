...
def main():
    ...
    try:
        ...
        if current_incident_state.lower() != active_state.lower() and current_incident_state.lower() != close_state.lower():
            ...
            if current_incident_state.lower() != close_state.lower():
                ...
                if not isinstance(command_resp, bool):
                    ...
                    return return_results(
                        f"Successfully closed incident {incident_id} on Securonix.\n"
        ...
        return_error(f"Failed to execute CloseSecuronixIncidents. Error: {exception!s}")
