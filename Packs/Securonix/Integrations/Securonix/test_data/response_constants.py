...
RESPONSE_DEFAULT_ASSIGNEE = {"result": {"type": "USER", "value": "admin"}}
RESPONSE_POSSIBLE_THREAT_ACTIONS = {
    "result": ["Mark as concern and create incident", "Non-Concern", "Mark in progress (still investigating)"]
}
RESPONSE_LIST_RESOURCE_GROUPS = (
            ...
            "incidentItems": [
                {
                    ...
                    "isWhitelisted": False,
                    "watchlisted": True,
                    "tenantInfo": {"tenantid": 1, "tenantname": "Securonix", "tenantcolor": "#000000", "tenantshortcode": "SE"},
...
RESPONSE_PERFORM_ACTION_ON_INCIDENT = {"result": "submitted"}
RESPONSE_LIST_WATCHLISTS = {"result": ["Domain_Admin", "Privileged_Users", "Privileged_Accounts", "Recent_Hires"]}
...
RESPONSE_ENTITY_IN_WATCHLIST = {"status": "OK", "messages": ["EntityId provided present in test234?"], "result": ["YES"]}
...
RESPONSE_FETCH_INCIDENT_ITEM = {
    ...
    "parentCaseId": "",
    "priority": "low",
    "reason": ["Resource: BLUECOAT", "Policy: Uploads to personal websites", "Threat: Data egress via network uploads"],
    "riskscore": 0,
    "sandBoxPolicy": False,
    "statusCompleted": False,
    "tenantInfo": {"tenantcolor": "#000000", "tenantid": 1, "tenantname": "Securonix", "tenantshortcode": "SE"},
    "url": "demisto.com",
    "violatorId": "12",
    ...
    "incidentItems": [
        {
            ...
            "reason": [
                ...
                {
                    "Policies": {
                        "stage1": {"s1": ["TestEmailTemplate1", "TestEmailTemplate2"]},
...
RESPONSE_FETCH_THREATS = [
    {
        ...
        "policies": ["Response-PB-ActivityAccount-Manual"],
    }
]
...
RESPONSE_GET_INCIDENT_ACTIVITY_HISTORY_6_4 = {
    "status": "OK",
    "messages": ["Get activity stream details for incident ID [2849604490]"],
    "result": {
        "activityStreamData": [
            {
                "caseid": "2849604490",
                "actiontaken": "CREATED",
                "status": "Open",
                "comment": [{"Comments": "Incident created while executing playbook - Create Security Incident"}],
...
RESPONSE_LIST_WHITELISTS_ENTRY = {
    "status": "OK",
    "messages": [" WhiteList Name | Whitelist Type | Tenant Name "],
    "result": ["Dummy Whitelist 1 | Automated | test_tenant", "Dummy Whitelist 2 | Automated | test_tenant"],
}

RESPONSE_GET_WHITELIST_ENTRY = {
    "status": "OK",
    "messages": ["whitelistname : Dummy Threat Model MM", "Entity/Attribute : Expiry Date"],
    "result": {"TEST123": "09/28/2035 21:21:19"},
}
RESPONSE_CREATE_WHITELIST = {
    "status": "OK",
    "messages": ["New Global whitelist created Successfully ..!", "whitelistname : test_whitelist"],
    "result": [],
}
...
RESPONSE_ADD_WHITELIST_ENTRY_6_4 = {
    "status": "OK",
    "messages": ["entity added to global whitelist Successfully...!"],
    "result": [],
}
RESPONSE_DELETE_WHITELIST_ENTRY = {
    "status": "OK",
    "messages": ["Whitelist Name : test_ng"],
    "result": ["EmployeeId Item removed from whitelist Successfully ..! "],
}
...
RESPONSE_LOOKUP_TABLE_ENTRIES_LIST = [
    {
        "defaultenrichedevent": ["0", "Attempt", "Cisco Netflow", "Connection Statistics", "Network", "destinationport"],
    ...
    {
        "defaultenrichedevent": ["1", "Attempt", "Cisco Netflow", "Connection Statistics", "Network", "destinationport"],
        "value_fieldname": "destinationport",
        "value_vendor": "Cisco Netflow",
        "value_categoryobject": "Network",
...
RESPONSE_GET_INCIDENT_WORKFLOW = {
    "status": "OK",
    "messages": ["Get incident workflow for incident ID [123456] - [TestWorkFlow]"],
    "result": {"workflow": "TestWorkFlow"},
}

RESPONSE_GET_INCIDENT_STATUS = {
    "status": "OK",
    "messages": ["Get incident status for incident ID [123456] - [TestStatus]"],
    "result": {"status": "TestStatus"},
}

RESPONSE_GET_INCIDENT_AVAILABLE_ACTIONS = {
    "status": "OK",
    "messages": ["Get possible actions for incident ID [100289], incident status [Open]"],
    "result": [
        {
            "actionDetails": [
                {
...
RESPONSE_ADD_COMMENT_TO_INCIDENT = {"status": "OK", "messages": ["Add comment to incident id - [100289]"], "result": True}
...
DELETE_LOOKUP_TABLE_ENTRIES_INVALID_LOOKUP_KEYS = [
    {"errorCode": 404, "errorMessage": "Error deleting the key! Please check the input params!key1", "errorType": "Functional"}
]
...
MIRROR_RESPONSE_GET_INCIDENT_ACTIVITY_HISTORY_ATTACHMENT = {
    "status": "OK",
    "messages": ["Get activity stream details for incident ID [5010212504]"],
    "result": {
        "activityStreamData": [
            {
                "caseid": "1234",
                "actiontaken": "CREATED",
                "status": "Open",
                "comment": [{"Comments": "Incident created while executing playbook - ServiceNow - Create Incident"}],
