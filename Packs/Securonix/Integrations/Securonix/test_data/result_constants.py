...
EXPECTED_DEFAULT_ASSIGNEE = {
    "Securonix.Workflows(val.Workflow === obj.Workflow)": {"Workflow": "SOCTeamReview", "Type": "USER", "Value": "admin"}
}
EXPECTED_POSSIBLE_THREAT_ACTIONS = {
    "Securonix.ThreatActions": ["Mark as concern and create incident", "Non-Concern", "Mark in progress (still investigating)"]
}
...
EXPECTED_LIST_WATCHLISTS = {
    "Securonix.WatchlistsNames": ["Domain_Admin", "Privileged_Users", "Privileged_Accounts", "Recent_Hires"]
}
...
EXPECTED_ENTITY_IN_WATCHLIST = {
    "Securonix.EntityInWatchlist(val.Entityname === obj.Entityname)": {"Watchlistname": "test234", "Entityname": "1002"}
}
...
EXPECTED_GET_INCIDENT_ATTACHMENT_HISTORY_6_4 = [
    {"Contents": "", "ContentsFormat": "text", "Type": 3, "File": "test.txt", "FileID": "6c8964a3-aebd-4a4e-9d12-63b08c82372f"}
]
...
EXPECTED_LIST_WHITELISTS_ENTRY = {
    "Securonix.Whitelist(val.WhitelistName === obj.WhitelistName && val.TenantName === obj.TenantName)": [
        {"WhitelistName": "Dummy Whitelist 1", "WhitelistType": "Automated", "TenantName": "test_tenant"},
        {"WhitelistName": "Dummy Whitelist 2", "WhitelistType": "Automated", "TenantName": "test_tenant"},
    ]
}
EXPECTED_GET_WHITELIST_ENTRY = {
    "Securonix.Whitelist(val.WhitelistName === obj.WhitelistName && val.TenantName === obj.TenantName)": {
        "WhitelistName": "test_whitelist",
        "Entries": [{"Entity/Attribute": "TEST123", "ExpiryDate": "09/28/2035 21:21:19"}],
    }
}
...
EXPECTED_DELETE_LOOKUP_TABLE_CONFIG_AND_DATA = {
    "Securonix.LookupTable(val.lookupTableName === obj.lookupTableName)": {"lookupTableName": "test", "isDeleted": True}
}
...
EXPECTED_LOOKUP_TABLE_ENTRIES_LIST = {
    "Securonix.LookupTableEntries(val.lookupuniquekey === obj.lookupuniquekey)": [
        {
            "entry": [
                {"key": "fieldname", "value": "destinationport"},
                {"key": "vendor", "value": "Cisco Netflow"},
                {"key": "categoryobject", "value": "Network"},
                {"key": "categoryoutcome", "value": "Attempt"},
                {"key": "categorybehavior", "value": "Connection Statistics"},
                {"key": "key", "value": "0"},
            ],
...
EXPECTED_FETCH_INCIDENT = {
    ...
    "reason": [
        ...
        "Policy: Emails with large File attachments",
        "Threat: Data egress attempts",
        {"Policies": {"stage1": {"s1": ["TestEmailTemplate1", "TestEmailTemplate2"]}, "stage2": {"s2": ["TestEmailtemplate3"]}}},
    ],
    ...
    "policy_stages_json": {"stage1:s1": ["TestEmailTemplate1", "TestEmailTemplate2"], "stage2:s2": ["TestEmailtemplate3"]},
    "policy_stages_table": [
        {"Policies": "TestEmailTemplate1, TestEmailTemplate2", "Stage Name": "stage1:s1"},
...
EXPECTED_XSOAR_STATE_MAPPING = {
    "ACTIVE": {"action": "Start Investigation", "status": "in progress"},
    "DONE": {"action": "Close Incident", "status": "completed"},
}
