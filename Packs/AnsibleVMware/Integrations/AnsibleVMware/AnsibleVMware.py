...
def main() -> None:
    ...
    try:
        if command == "test-module":
            ...
            return_results(generic_ansible("VMware", "vmware_category_info", args, int_params, host_type, creds_mapping))
            ...
            return_results(
                generic_ansible("VMware", "vmware_content_deploy_template", args, int_params, host_type, creds_mapping)
            )
        elif command == "vmware-content-library-info":
            return_results(generic_ansible("VMware", "vmware_content_library_info", args, int_params, host_type, creds_mapping))
        elif command == "vmware-content-library-manager":
            return_results(
                generic_ansible("VMware", "vmware_content_library_manager", args, int_params, host_type, creds_mapping)
            )
            ...
            return_results(generic_ansible("VMware", "vmware_datastore_cluster", args, int_params, host_type, creds_mapping))
        elif command == "vmware-datastore-info":
            return_results(generic_ansible("VMware", "vmware_datastore_info", args, int_params, host_type, creds_mapping))
            ...
            return_results(generic_ansible("VMware", "vmware_drs_group_info", args, int_params, host_type, creds_mapping))
            ...
            return_results(generic_ansible("VMware", "vmware_dvs_portgroup", args, int_params, host_type, creds_mapping))
        elif command == "vmware-dvs-portgroup-find":
            return_results(generic_ansible("VMware", "vmware_dvs_portgroup_find", args, int_params, host_type, creds_mapping))
        elif command == "vmware-dvs-portgroup-info":
            return_results(generic_ansible("VMware", "vmware_dvs_portgroup_info", args, int_params, host_type, creds_mapping))
            ...
            return_results(generic_ansible("VMware", "vmware_dvswitch_lacp", args, int_params, host_type, creds_mapping))
        elif command == "vmware-dvswitch-nioc":
            return_results(generic_ansible("VMware", "vmware_dvswitch_nioc", args, int_params, host_type, creds_mapping))
        elif command == "vmware-dvswitch-pvlans":
            return_results(generic_ansible("VMware", "vmware_dvswitch_pvlans", args, int_params, host_type, creds_mapping))
        elif command == "vmware-dvswitch-uplink-pg":
            return_results(generic_ansible("VMware", "vmware_dvswitch_uplink_pg", args, int_params, host_type, creds_mapping))
            ...
            return_results(generic_ansible("VMware", "vmware_guest_boot_info", args, int_params, host_type, creds_mapping))
        elif command == "vmware-guest-boot-manager":
            return_results(generic_ansible("VMware", "vmware_guest_boot_manager", args, int_params, host_type, creds_mapping))
        elif command == "vmware-guest-custom-attribute-defs":
            return_results(
                generic_ansible("VMware", "vmware_guest_custom_attribute_defs", args, int_params, host_type, creds_mapping)
            )
        elif command == "vmware-guest-custom-attributes":
            return_results(
                generic_ansible("VMware", "vmware_guest_custom_attributes", args, int_params, host_type, creds_mapping)
            )
        elif command == "vmware-guest-customization-info":
            return_results(
                generic_ansible("VMware", "vmware_guest_customization_info", args, int_params, host_type, creds_mapping)
            )
            ...
            return_results(generic_ansible("VMware", "vmware_guest_disk_info", args, int_params, host_type, creds_mapping))
            ...
            return_results(generic_ansible("VMware", "vmware_guest_network", args, int_params, host_type, creds_mapping))
        elif command == "vmware-guest-powerstate":
            return_results(generic_ansible("VMware", "vmware_guest_powerstate", args, int_params, host_type, creds_mapping))
        elif command == "vmware-guest-screenshot":
            return_results(generic_ansible("VMware", "vmware_guest_screenshot", args, int_params, host_type, creds_mapping))
        elif command == "vmware-guest-sendkey":
            return_results(generic_ansible("VMware", "vmware_guest_sendkey", args, int_params, host_type, creds_mapping))
        elif command == "vmware-guest-snapshot":
            return_results(generic_ansible("VMware", "vmware_guest_snapshot", args, int_params, host_type, creds_mapping))
            ...
            return_results(generic_ansible("VMware", "vmware_guest_tools_upgrade", args, int_params, host_type, creds_mapping))
        elif command == "vmware-guest-tools-wait":
            return_results(generic_ansible("VMware", "vmware_guest_tools_wait", args, int_params, host_type, creds_mapping))
            ...
            return_results(generic_ansible("VMware", "vmware_host_active_directory", args, int_params, host_type, creds_mapping))
        elif command == "vmware-host-capability-info":
            return_results(generic_ansible("VMware", "vmware_host_capability_info", args, int_params, host_type, creds_mapping))
        elif command == "vmware-host-config-info":
            return_results(generic_ansible("VMware", "vmware_host_config_info", args, int_params, host_type, creds_mapping))
        elif command == "vmware-host-config-manager":
            return_results(generic_ansible("VMware", "vmware_host_config_manager", args, int_params, host_type, creds_mapping))
        elif command == "vmware-host-datastore":
            return_results(generic_ansible("VMware", "vmware_host_datastore", args, int_params, host_type, creds_mapping))
        elif command == "vmware-host-dns-info":
            return_results(generic_ansible("VMware", "vmware_host_dns_info", args, int_params, host_type, creds_mapping))
            ...
            return_results(generic_ansible("VMware", "vmware_host_feature_info", args, int_params, host_type, creds_mapping))
        elif command == "vmware-host-firewall-info":
            return_results(generic_ansible("VMware", "vmware_host_firewall_info", args, int_params, host_type, creds_mapping))
        elif command == "vmware-host-firewall-manager":
            return_results(generic_ansible("VMware", "vmware_host_firewall_manager", args, int_params, host_type, creds_mapping))
        elif command == "vmware-host-hyperthreading":
            return_results(generic_ansible("VMware", "vmware_host_hyperthreading", args, int_params, host_type, creds_mapping))
            ...
            return_results(generic_ansible("VMware", "vmware_host_kernel_manager", args, int_params, host_type, creds_mapping))
        elif command == "vmware-host-lockdown":
            return_results(generic_ansible("VMware", "vmware_host_lockdown", args, int_params, host_type, creds_mapping))
            ...
            return_results(generic_ansible("VMware", "vmware_host_ntp_info", args, int_params, host_type, creds_mapping))
        elif command == "vmware-host-package-info":
            return_results(generic_ansible("VMware", "vmware_host_package_info", args, int_params, host_type, creds_mapping))
        elif command == "vmware-host-powermgmt-policy":
            return_results(generic_ansible("VMware", "vmware_host_powermgmt_policy", args, int_params, host_type, creds_mapping))
        elif command == "vmware-host-powerstate":
            return_results(generic_ansible("VMware", "vmware_host_powerstate", args, int_params, host_type, creds_mapping))
            ...
            return_results(generic_ansible("VMware", "vmware_host_service_info", args, int_params, host_type, creds_mapping))
        elif command == "vmware-host-service-manager":
            return_results(generic_ansible("VMware", "vmware_host_service_manager", args, int_params, host_type, creds_mapping))
            ...
            return_results(generic_ansible("VMware", "vmware_host_ssl_info", args, int_params, host_type, creds_mapping))
        elif command == "vmware-host-vmhba-info":
            return_results(generic_ansible("VMware", "vmware_host_vmhba_info", args, int_params, host_type, creds_mapping))
        elif command == "vmware-host-vmnic-info":
            return_results(generic_ansible("VMware", "vmware_host_vmnic_info", args, int_params, host_type, creds_mapping))
        elif command == "vmware-local-role-info":
            return_results(generic_ansible("VMware", "vmware_local_role_info", args, int_params, host_type, creds_mapping))
        elif command == "vmware-local-role-manager":
            return_results(generic_ansible("VMware", "vmware_local_role_manager", args, int_params, host_type, creds_mapping))
        elif command == "vmware-local-user-info":
            return_results(generic_ansible("VMware", "vmware_local_user_info", args, int_params, host_type, creds_mapping))
        elif command == "vmware-local-user-manager":
            return_results(generic_ansible("VMware", "vmware_local_user_manager", args, int_params, host_type, creds_mapping))
        elif command == "vmware-maintenancemode":
            return_results(generic_ansible("VMware", "vmware_maintenancemode", args, int_params, host_type, creds_mapping))
            ...
            return_results(generic_ansible("VMware", "vmware_object_role_permission", args, int_params, host_type, creds_mapping))
            ...
            return_results(generic_ansible("VMware", "vmware_portgroup_info", args, int_params, host_type, creds_mapping))
        elif command == "vmware-resource-pool":
            return_results(generic_ansible("VMware", "vmware_resource_pool", args, int_params, host_type, creds_mapping))
        elif command == "vmware-resource-pool-info":
            return_results(generic_ansible("VMware", "vmware_resource_pool_info", args, int_params, host_type, creds_mapping))
            ...
            return_results(generic_ansible("VMware", "vmware_target_canonical_info", args, int_params, host_type, creds_mapping))
        elif command == "vmware-vcenter-settings":
            return_results(generic_ansible("VMware", "vmware_vcenter_settings", args, int_params, host_type, creds_mapping))
        elif command == "vmware-vcenter-statistics":
            return_results(generic_ansible("VMware", "vmware_vcenter_statistics", args, int_params, host_type, creds_mapping))
        elif command == "vmware-vm-host-drs-rule":
            return_results(generic_ansible("VMware", "vmware_vm_host_drs_rule", args, int_params, host_type, creds_mapping))
            ...
            return_results(generic_ansible("VMware", "vmware_vm_storage_policy_info", args, int_params, host_type, creds_mapping))
        elif command == "vmware-vm-vm-drs-rule":
            return_results(generic_ansible("VMware", "vmware_vm_vm_drs_rule", args, int_params, host_type, creds_mapping))
        elif command == "vmware-vm-vss-dvs-migrate":
            return_results(generic_ansible("VMware", "vmware_vm_vss_dvs_migrate", args, int_params, host_type, creds_mapping))
            ...
            return_results(generic_ansible("VMware", "vmware_vmkernel_info", args, int_params, host_type, creds_mapping))
        elif command == "vmware-vmkernel-ip-config":
            return_results(generic_ansible("VMware", "vmware_vmkernel_ip_config", args, int_params, host_type, creds_mapping))
            ...
            return_results(generic_ansible("VMware", "vmware_vspan_session", args, int_params, host_type, creds_mapping))
            ...
            return_results(generic_ansible("VMware", "vcenter_extension_info", args, int_params, host_type, creds_mapping))
