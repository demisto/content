...
class VisionClient(BaseClient):
    ...
    def quarantine_jobs_list(
        self, page: Optional[int], size: Optional[int], sort: str, exclude_quarantine_emails: bool, body: dict
    ) -> Dict[str, Any]:
        """Get quarantine jobs.
    ...
    def list_iocs(
        self, source: str, page: int, size: int, include_expired: bool, since: Optional[str], sort_string: Optional[str]
    ) -> dict[str, Any]:
