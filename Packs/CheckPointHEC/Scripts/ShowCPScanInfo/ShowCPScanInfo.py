...
def get_scan_info(entity: str, instance: str) -> tuple[bool, str]:
    scan_info = demisto.executeCommand("checkpointhec-get-scan-info", {"entity": entity, "using": instance})[0]["Contents"]
...
def main():  # pragma: no cover
    try:
        ...
        return_results({"ContentsFormat": EntryFormat.JSON, "Type": EntryType.NOTE, "Contents": scan_info})
