...
>### Job Templates List
>|name|id|type|url|created|modified|description|job_type|inventory|project|playbook|limit|extra_vars|job_tags|skip_tags|timeout|last_job_run|last_job_failed|next_job_run|status|host_config_key|survey_enabled|become_enabled|custom_virtualenv|credential|vault_credential|
>|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
...
>### Credentials List
>|name|id|type|url|created|modified|description|organization|credential_type|inputs|
>|---|---|---|---|---|---|---|---|---|---|
