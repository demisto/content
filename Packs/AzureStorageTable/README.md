...
<br>
This pack contains an integration, with a main goal to manage Azure Storage Tables services.<br>
Integration capabilities:

- Create, delete and retrieve tables information.
- Manage table entities.