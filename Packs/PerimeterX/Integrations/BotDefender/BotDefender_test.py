...
def _test_base_score(requests_mock, actual_score, expected_score):
    ...
    mock_response = {"max_risk_score": actual_score}
    ...
    args = {"ip": ip_addresses}

    thresholds = {"good_threshold": 5, "suspicious_threshold": 50, "bad_threshold": 90, "unknown_threshold": 0}
...
def _test_perimeterx_get_investigate_details_base(requests_mock, search_type):
    mock_response = {
        ...
        "topIncidentTypes": [{"incidentType": "Spoof", "count": 2106}, {"incidentType": "Bot Behavior", "count": 702}],
        "catpchaSolves": 200,
        "trafficOverTime": [],
    ...
    args = {"search_type": search_type, "search_term": ip_address}
