...
def load_oob_model():
    ...
    confusion_matrix_no_all = {
        k: {sub_k: sub_v for sub_k, sub_v in v.items() if sub_k != "All"} for k, v in confusion_matrix_no_all.items()
    }
    res = demisto.executeCommand(
        "evaluateMLModel",
        {
            ...
            "modelName": OUT_OF_THE_BOX_MODEL_NAME,
            "modelEvaluationVectors": {"Ypred": y_pred, "Ytrue": y_test, "YpredProb": y_pred_prob},
