...
from HashIncidentsFields import hash_incident, is_key_match_fields_to_hash, pattern_match
...
context1 = {
    ...
    "multipleDictsValue": {"test": {"first": {"word1": "1", "word2": "2"}, "second": ["word3", "word4"]}},
}
...
context3 = {
    ...
    "multipleDictsValue": {"test": {"first": {"word1": "4", "word2": "2"}, "second": ["word3", "word4"]}},
}
...
def test_hash(mocker):
    ...
    assert (
        result["Contents"][0]["labels"][0]["type"] == hashlib.md5(str(incident1["labels"][0]["type"]).encode("utf-8")).hexdigest()
    )
