...
1. Navigate to **Settings** -> **Data Sources & Configurations** -> **Add New**. 
2. If you have already configured a **Custom - HTTP based Collector**, select the **3 dots**, and then select **+ Add New**. If not, select **+ Add New**, search for "http" and then select **Connect**.  
