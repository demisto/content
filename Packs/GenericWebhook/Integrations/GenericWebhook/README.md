...
| Engines (Cortex XSOAR 8 Cloud, Cortex XSOAR 8 On-Prem, Cortex XSIAM, Cortex 6.x) | No | - Basic authentication (username and password) <br><br> - Custom certificate <br> **NOTE**: For more information about setting up custom certificates for engines, see [Configure an engine to use custom certificates](https://docs-cortex.paloaltonetworks.com/r/Cortex-XSOAR/8/Cortex-XSOAR-Cloud-Documentation/Configure-an-engine-to-use-custom-certificates). |
