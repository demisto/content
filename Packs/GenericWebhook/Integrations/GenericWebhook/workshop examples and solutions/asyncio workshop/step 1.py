...
async def main():
    tasks = [asyncio.create_task(send_post_request_async("step_1")), asyncio.create_task(send_post_request_async("step_1")), asyncio.create_task(send_post_request_async("step_1"))]
    results = await send_get_request_async("step_1")
    print(results)
