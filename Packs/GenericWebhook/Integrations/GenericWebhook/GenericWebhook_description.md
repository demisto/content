...
#### Security
- We recommend using authentication even if it's not required to validate the requests sent from your app. If you do not use authentication it might result in incident creation from unexpected requests.
