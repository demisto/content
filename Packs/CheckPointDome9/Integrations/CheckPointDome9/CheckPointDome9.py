...
class Client(BaseClient):
    ...
    def access_lease_invitation_delete_request(self, invitation_id: str) -> str:
        ...
        Returns:
            Dict[str, Any]: API response from Dome9.
        """
        return self._http_request("DELETE", f"AccessLeaseInvitation/{invitation_id}", resp_type="text")

    def findings_search_request(
        self,
        max_fetch: int,
        alert_severity: List[str] = None,
        alert_region: List[str] = None,
        alert_entity_type: List[str] = None,
        alert_acknowledged: bool = None,
    ) -> dict[str, Any]:
        """Search findings.
        ...
        data = {"pageSize": max_fetch, "sorting": {"fieldName": "createdTime", "direction": 1}, "filter": {"fields": fields}}
        response = self._http_request("POST", "Compliance/Finding/search", json_data=data)

        return response

    def ip_list_create_request(self, name: str, description: str, items: List[dict[str, Any]] = None) -> dict[str, Any]:
    ...
    def ip_list_update_request(self, list_id: str, description: str, items: List[dict[str, Any]] = None) -> str:
    ...
    def ip_list_metadata_delete_request(
        ...
        response = self._http_request("DELETE", "IpAddressMetadata", params=params, resp_type="text")
    ...
    def compliance_remediation_create_request(
        self, ruleset_id: str, rule_logic_hash: str, comment: str, cloudbots: list
    ) -> dict[str, Any]:
        ...
        data = {"rulesetId": ruleset_id, "ruleLogicHash": rule_logic_hash, "cloudBots": cloudbots, "comment": comment}
    ...
    def compliance_remediation_delete_request(self, remediation_id: str) -> str:
        ...
        Returns:
            Dict[str, Any]: API response from Dome9.
        """
        return self._http_request("DELETE", f"ComplianceRemediation/{remediation_id}", resp_type="text")
    ...
    def security_group_attach_request(
        ...
        response = self._http_request("POST", f"cloudinstance/{instance_id}/sec-groups", json_data=data)
    ...
    def security_group_service_delete_request(self, sg_id: str, service_id: str) -> str:
        ...
        Returns:
            Dict[str, Any]: API response from Dome9.
        """
        response = self._http_request("DELETE", f"cloudsecuritygroup/{sg_id}/services/Inbound/{service_id}", resp_type="text")

        return response

    def security_group_tags_update_request(self, sg_id: str, key: str, value: str) -> dict[str, Any]:
        ...
        data = remove_empty_elements(
            {
                ...
                "scope": [{"data": {"id": data_id, "name": data_name}, "isValid": is_valid, "type": scope_type}],
            }
        )
        response = self._http_request("POST", f"cloudsecuritygroup/{sg_id}/services/{policy_type}", json_data=data)
        return response
    ...
    def security_group_service_update_request(
        ...
        response = self._http_request("PUT", f"cloudsecuritygroup/{sg_id}/services/{policy_type}", json_data=data)
    ...
    def security_group_instance_detach_request(
        ...
        response = self._http_request("DELETE", f"cloudinstance/{instance_id}/sec-groups", json_data=data)
    ...
    def protection_mode_update_request(self, sg_id: str, protection_mode: str) -> dict[str, Any]:
        ...
        response = self._http_request("POST", f"cloudsecuritygroup/{sg_id}/protection-mode", json_data=data)
    ...
    def findings_bundle_get_request(self, bundle_id: str, rule_logic_hash: str) -> dict[str, Any]:
        ...
        response = self._http_request("GET", f"Compliance/Finding/bundle/{bundle_id}", params=params)
        return response
...
def attach_comment_to_ip(ip_list: List[str], comment_list: List[str], description: str = None) -> List:
...
def create_sg_list(fix_output: list) -> list:
    ...
    for sg in fix_output:
        ...
        outbound_services_type, outbound_services_data = get_service_type_and_data(outbound_services)
...
def access_lease_delete_command(client: Client, args: dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        readable_output="Access Lease Deleted successfully",
        outputs_prefix="CheckPointDome9.AccessLease",
        outputs_key_field="",
        outputs=response,
        raw_response=response,
...
def access_lease_invitation_delete_command(client: Client, args: dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        readable_output="Access Lease Invitation Deleted successfully",
        outputs_prefix="CheckPointDome9.AccessLease.Invitation",
        outputs_key_field="",
        outputs=response,
        raw_response=response,
...
def findings_search_command(client: Client, args: dict[str, Any]) -> CommandResults:
    ...
    readable_output = tableToMarkdown(
        ...
        metadata=pagination_message,
        t=fix_output,
        headers=["id", "alertType", "severity", "region", "status", "action", "cloudAccountId", "description"],
        headerTransform=string_to_table_header,
    )
...
def ip_list_create_command(client: Client, args: dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        readable_output="IP list created successfully",
...
def ip_list_update_command(client: Client, args: dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        readable_output="IP list updated successfully",
        outputs_prefix="CheckPointDome9.IpList",
        outputs_key_field="",
        outputs=response,
        raw_response=response,
...
def ip_list_get_command(client: Client, args: dict[str, Any]) -> CommandResults:
    ...
    readable_output = tableToMarkdown(
        name="IP list", t=ip_lists, headers=["id", "name", "items", "description"], headerTransform=string_to_table_header
    )
    command_results = CommandResults(
        readable_output=readable_output,
        outputs_prefix="CheckPointDome9.IpList",
...
def ip_list_delete_command(client: Client, args: dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        readable_output="IP list deleted successfully",
        outputs_prefix="CheckPointDome9.IpList",
        outputs_key_field="id",
        outputs=response,
        raw_response=response,
...
def ip_list_metadata_create_command(client: Client, args: dict[str, Any]) -> CommandResults:
    ...
    readable_output = tableToMarkdown(
        name="IP List metadata created successfully", t=response, headerTransform=string_to_table_header
    )
    command_results = CommandResults(
        readable_output=readable_output,
        outputs_prefix="CheckPointDome9.IpList.Metadata",
...
def ip_list_metadata_update_command(client: Client, args: dict[str, Any]) -> CommandResults:
    ...
    readable_output = tableToMarkdown(
        name="IP List metadata updated successfully", t=response, headerTransform=string_to_table_header
    )
    command_results = CommandResults(
        readable_output=readable_output,
        outputs_prefix="CheckPointDome9.IpList.Metadata",
...
def ip_list_metadata_delete_command(client: Client, args: dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        readable_output="IP List metadata deleted successfully",
        outputs_prefix="CheckPointDome9.IpList.Metadata",
        outputs_key_field="",
        outputs=response,
        raw_response=response,
...
def compliance_remediation_delete_command(client: Client, args: dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        readable_output="Remediation deleted successfully",
        outputs_prefix="CheckPointDome9.ComplianceRemediation",
        outputs_key_field="id",
        outputs=response,
        raw_response=response,
...
def security_group_instance_attach_command(client: Client, args: dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        readable_output="Security group attach successfully",
...
def security_group_tags_update_command(client: Client, args: dict[str, Any]) -> CommandResults:
    ...
    readable_output = tableToMarkdown(name="Tag updated successfully", t=response, headerTransform=string_to_table_header)
...
def security_group_service_create_command(client: Client, args: dict[str, Any]) -> CommandResults:
    ...
    readable_output = tableToMarkdown(
        name="Security group service created successfully", t=sg_service, headerTransform=string_to_table_header
    )
...
def security_group_service_update_command(client: Client, args: dict[str, Any]) -> CommandResults:
    ...
    response = client.security_group_service_update_request(
        ...
        description,
        data_id,
        data_name,  # type: ignore[arg-type]
        scope_type,
        is_valid,
        inbound,
        icmptype,  # type: ignore[arg-type]
        icmpv6type,
    )  # type: ignore[arg-type]
    ...
    readable_output = tableToMarkdown(
        name="Security group service updated successfully", t=sg_service, headerTransform=string_to_table_header
    )
...
def security_group_instance_detach_command(client: Client, args: dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        readable_output="Security group detach successfully",
        outputs_prefix="CheckPointDome9.Instance",
        outputs_key_field="id",
        outputs=response,
        raw_response=response,
...
def security_group_protection_mode_update_command(client: Client, args: dict[str, Any]) -> CommandResults:
    """Change the protection mode for an AWS security group (FullManage or ReadOnly).
    ...
    readable_output = tableToMarkdown(
        name="protection mode updated for security group :", t=security_group_list, headerTransform=string_to_table_header
    )
...
def instance_list_command(client: Client, args: dict[str, Any]) -> CommandResults:
    ...
    readable_output = tableToMarkdown(
        name="AWS instances", metadata=pagination_message, t=instance_list, headerTransform=string_to_table_header
    )
...
def check_ip_list_security_group_attach_command(client: Client, args: dict[str, Any]) -> CommandResults:
    ...
    readable_output = tableToMarkdown(
        name="Security Groups:", metadata=pagination_message, t=security_group_list, headerTransform=string_to_table_header
    )
...
def global_search_get_command(client: Client, args: dict[str, Any]) -> CommandResults:
    ...
    readable_output = tableToMarkdown(name="Global Search", t=alerts, headerTransform=string_to_table_header)
...
def cloud_trail_get_command(client: Client, args: dict[str, Any]) -> CommandResults:
    ...
    readable_output = tableToMarkdown(name="Cloud Trail", t=cloud_trail_output, headerTransform=string_to_table_header)
...
def findings_bundle_get_command(client: Client, args: dict[str, Any]) -> CommandResults:
    ...
    readable_output = tableToMarkdown(name="Findings Bundle", t=response, headerTransform=string_to_table_header)
    command_results = CommandResults(
        readable_output=readable_output,
...
def organizational_unit_view_get_command(client: Client, args: dict[str, Any]) -> CommandResults:
    ...
    readable_output = tableToMarkdown(name="Organizational Unit View", t=response, headerTransform=string_to_table_header)
...
def organizational_unit_flat_get_command(client: Client, args: dict[str, Any]) -> CommandResults:
    ...
    readable_output = tableToMarkdown(
        name="Organizational Unit Flat", metadata=pagination_message, t=fix_output, headerTransform=string_to_table_header
    )
...
def organizational_unit_get_command(client: Client, args: dict[str, Any]) -> CommandResults:
    ...
    readable_output = tableToMarkdown(
        name="Organizational Unit", t=organizational_unit_list, headerTransform=string_to_table_header
    )
...
def main() -> None:
    ...
    commands = {
        ...
        "dome9-security-group-protection-mode-update": security_group_protection_mode_update_command,
