...
| **Path** | **Type** | **Description** |
| --- | --- | --- |
| CheckPointDome9.GlobalSearch.environments | String | The Global Search environments. | 
| CheckPointDome9.GlobalSearch.alerts | String | The Global Search alerts. | 
| CheckPointDome9.GlobalSearch.assets | String | The Global Search assets. | 
