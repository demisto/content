...
class Client(BaseClient):
    ...
    def create_fact(
        ...
        data = assign_params(
            ...
            origin_type=fact_origin_type,
            limit_count=fact_limit_count,
            technique_id=fact_technique_id,
            trait=fact_trait,
            source=fact_source,
            score=fact_score,
            value=fact_value,
    ...
    def create_fact_source(
        self, source_name, source_adjustments, source_relationships, source_rules, source_facts, source_plugin
    ):
        data = assign_params(
            name=source_name,
    ...
    def create_adversary(
        ...
        data = assign_params(
            name=adversary_name,
            tags=adversary_tags,
            objective=adversary_objective,
            atomic_ordering=adversary_atomic_ordering,
            plugin=adversary_plugin,
    ...
    def create_agent(
        self,
        agent_watchdog,
        agent_deadman_enabled,
        agent_ppid,
        agent_pid,
        agent_proxy_receivers,
        agent_origin_link_id,
        agent_available_contacts,
        agent_platform,
        agent_host,
        agent_group,
        agent_location,
        ...
        data = assign_params(
            ...
            deadman_enabled=agent_deadman_enabled,
            ppid=agent_ppid,
            pid=agent_pid,
            proxy_receivers=agent_proxy_receivers,
            origin_link_id=agent_origin_link_id,
            available_contacts=agent_available_contacts,
            platform=agent_platform,
            host=agent_host,
            group=agent_group,
            location=agent_location,
            display_name=agent_display_name,
            upstream_dest=agent_upstream_dest,
            host_ip_addrs=agent_host_ip_addrs,
            sleep_max=agent_sleep_max,
            architecture=agent_architecture,
            sleep_min=agent_sleep_min,
            server=agent_server,
            contact=agent_contact,
            executors=agent_executors,
            privilege=agent_privilege,
            username=agent_username,
            trusted=agent_trusted,
            proxy_chain=agent_proxy_chain,
            paw=agent_paw,
    ...
    def create_operation(
        ...
        data = assign_params(
            ...
            use_learning_parsers=use_learning_parsers,
            source=source,
            jitter=jitter,
            adversary=adversary,
    ...
    def create_ability(
        ...
        ability_singleton,
        ability_technique_name,
        ability_repeatable,
        ability_description,
    ):
        data = assign_params(
            ability_id=ability_ability_id,
            name=ability_name,
            buckets=ability_buckets,
            technique_id=ability_technique_id,
            delete_payload=ability_delete_payload,
            executors=ability_executors,
            privilege=ability_privilege,
            requirements=ability_requirements,
            plugin=ability_plugin,
            access=ability_access,
            tactic=ability_tactic,
            additional_info=ability_additional_info,
            singleton=ability_singleton,
            technique_name=ability_technique_name,
            repeatable=ability_repeatable,
    ...
    def create_potentiallink(
        ...
        data = assign_params(
            ...
            id=link_id,
            collect=link_collect,
            pid=link_pid,
            visibility=link_visibility,
            finish=link_finish,
            pin=link_pin,
            jitter=link_jitter,
            agent_reported_time=link_agent_reported_time,
            deadman=link_deadman,
            used=link_used,
            host=link_host,
    ...
    def delete_agent(self, paw):
        ...
        response = self._http_request(
            "delete", f"api/v2/agents/{paw}", headers=headers, resp_type="response", ok_codes=[200, 204]
        )
    ...
    def delete_fact_source(self, id_):
        ...
        response = self._http_request("delete", f"api/v2/sources/{id_}", headers=headers, resp_type="response")
    ...
    def delete_operation(self, id_):
        ...
        response = self._http_request(
            "delete", f"api/v2/operations/{id_}", headers=headers, resp_type="response", ok_codes=[200, 204]
        )
        return response
    ...
    def delete_facts(
        ...
        data = assign_params(
            ...
            score=fact_score,
            value=fact_value,
            collected_by=fact_collected_by,
        )
        headers = self._headers
    ...
    def delete_ability(self, ability_id):
        ...
        response = self._http_request(
            "delete", f"api/v2/abilities/{ability_id}", headers=headers, resp_type="response", ok_codes=[200, 204]
        )
    ...
    def delete_adversary(self, adversary_id):
        ...
        response = self._http_request(
            "delete", f"api/v2/adversaries/{adversary_id}", headers=headers, ok_codes=[200, 204], resp_type="response"
        )
    ...
    def delete_schedule(self, id_):
        ...
        response = self._http_request(
            "delete", f"api/v2/schedules/{id_}", headers=headers, ok_codes=[200, 204], resp_type="response"
        )
    ...
    def update_agent_config(
        self, watchdog, sleep_min, deployments, deadman_abilities, untrusted_timer, bootstrap_abilities, sleep_max, implant_name
    ):
        data = assign_params(
            watchdog=watchdog,
            sleep_min=sleep_min,
            ...
            untrusted_timer=untrusted_timer,
    ...
    def update_adversary(
        ...
        adversarytags,
        adversaryobjective,
        adversaryhas_repeatable_abilities,
        adversaryatomic_ordering,
        adversaryplugin,
        ...
        data = assign_params(
            name=adversaryname,
            tags=adversarytags,
            objective=adversaryobjective,
            has_repeatable_abilities=adversaryhas_repeatable_abilities,
            atomic_ordering=adversaryatomic_ordering,
            plugin=adversaryplugin,
    ...
    def update_fact_source(
        self, id_, source_name, source_adjustments, source_relationships, source_id, source_rules, source_facts, source_plugin
    ):
        data = assign_params(
            name=source_name,
            adjustments=source_adjustments,
    ...
    def update_objective(self, id_, name, goals, description):
        data = assign_params(name=name, goals=goals, description=description)
        headers = self._headers
    ...
    def update_operation_fileds(self, id_, obfuscator, autonomous, state):
        data = assign_params(obfuscator=obfuscator, autonomous=autonomous, state=state)
        headers = self._headers
    ...
    def update_main_config(self, property, value):
        ...
        response = self._http_request(
            "patch", "api/v2/config/main", json_data=data, headers=headers, ok_codes=[200, 204], resp_type="response"
        )
...
def create_fact_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.Facts", outputs_key_field="", outputs=response, raw_response=response
    )
...
def create_fact_source_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.Sources", outputs_key_field="", outputs=response, raw_response=response
    )
...
def create_adversary_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.Adversaries", outputs_key_field="adversary_id", outputs=response, raw_response=response
    )
...
def create_agent_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.Agents", outputs_key_field="paw", outputs=response, raw_response=response
    )
...
def create_operation_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.Operations", outputs_key_field="id", outputs=response, raw_response=response
    )
...
def create_objective_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    response = client.create_objective(name, goals, description)
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.Objectives", outputs_key_field="", outputs=response, raw_response=response
    )
...
def create_relationship_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    relationship_source = assign_params(
        unique=relationship_source_unique,
        name=relationship_source_name,
        links=relationship_source_links,
        relationships=relationship_source_relationships,
        origin_type=relationship_source_origin_type,
        created=relationship_source_created,
        limit_count=relationship_source_limit_count,
        technique_id=relationship_source_technique_id,
        trait=relationship_source_trait,
        source=relationship_source_source,
        score=relationship_source_score,
        value=relationship_source_value,
        collected_by=relationship_source_collected_by,
    )
    ...
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.Relationship", outputs_key_field="", outputs=response, raw_response=response
    )
...
def create_ability_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    response = client.create_ability(
        ability_ability_id,
        ability_name,
        ability_buckets,
        ability_technique_id,
    ...
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.Abilities", outputs_key_field="", outputs=response, raw_response=response
    )
...
def create_potentiallink_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    link_ability = assign_params(
        ability_id=link_ability_ability_id,
        name=link_ability_name,
        buckets=link_ability_buckets,
        technique_id=link_ability_technique_id,
        delete_payload=link_ability_delete_payload,
        executors=link_ability_executors,
        privilege=link_ability_privilege,
        requirements=link_ability_requirements,
        plugin=link_ability_plugin,
        access=link_ability_access,
        tactic=link_ability_tactic,
        additional_info=link_ability_additional_info,
        singleton=link_ability_singleton,
        technique_name=link_ability_technique_name,
        repeatable=link_ability_repeatable,
    ...
    link_executor = assign_params(
        name=link_executor_name,
        cleanup=link_executor_cleanup,
        platform=link_executor_platform,
        language=link_executor_language,
        uploads=link_executor_uploads,
        variations=link_executor_variations,
        build_target=link_executor_build_target,
        payloads=link_executor_payloads,
        timeout=link_executor_timeout,
        parsers=link_executor_parsers,
        command=link_executor_command,
        additional_info=link_executor_additional_info,
        code=link_executor_code,
    )
    link_paw = args.get("link_paw")
    link_output = args.get("link_output")

    response = client.create_potentiallink(
        operation_id,
        link_relationships,
        link_id,
        link_collect,
    ...
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.Link", outputs_key_field="", outputs=response, raw_response=response
    )
...
def create_schedule_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    schedule_task = assign_params(
        ...
        autonomous=schedule_task_autonomous,
        id=schedule_task_id,
        objective=schedule_task_objective,
        visibility=schedule_task_visibility,
        state=schedule_task_state,
        group=schedule_task_group,
        host_group=schedule_task_host_group,
        planner=schedule_task_planner,
        obfuscator=schedule_task_obfuscator,
        chain=schedule_task_chain,
        use_learning_parsers=schedule_task_use_learning_parsers,
        source=schedule_task_source,
        jitter=schedule_task_jitter,
        start=schedule_task_start,
        adversary=schedule_task_adversary,
        auto_close=schedule_task_auto_close,
    )
    schedule_id = args.get("schedule_id")

    response = client.create_schedule(schedule_schedule, schedule_task, schedule_id)
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.Schedule", outputs_key_field="", outputs=response, raw_response=response
    )
...
def delete_agent_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(readable_output=f"Agent with paw {paw} was deleted successfully.")
    return command_results
...
def delete_fact_source_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(readable_output=f"Fact Source with ID {fact_source_id} was deleted successfully.")
    return command_results
...
def delete_operation_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(readable_output=f"Operation with Id {operation_id} was deleted successfully.")
    return command_results
...
def delete_facts_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.Facts", outputs_key_field="", outputs=output, raw_response=response
    )
...
def delete_relationships_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    response = client.delete_relationships(
        relationship_unique, relationship_origin, relationship_edge, relationship_source, relationship_score, relationship_target
    )
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.Relationships", outputs_key_field="", outputs=response, raw_response=response
    )
...
def delete_ability_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(readable_output=f"Ability with ID {ability_id} was deleted successfully.")
    return command_results
...
def delete_adversary_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(readable_output=f"Adversary with ID {adversary_id} was deleted successfully.")
    return command_results
...
def delete_schedule_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(readable_output=f"Schedule with ID {schedule_id} deleted successfully.")
    return command_results
...
def get_abilities_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.Abilities", outputs_key_field="ability_id", outputs=response, raw_response=response
    )
...
def get_agents_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.Agents", outputs_key_field="", outputs=response, raw_response=response
    )
...
def get_config_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    response["name"] = name
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.Config", outputs_key_field="Name", outputs=response, raw_response=response
    )
...
def get_contacts_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.Contacts", outputs_key_field="", outputs=response, raw_response=response
    )
...
def get_deploy_commands_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.DeployCommands", outputs_key_field=["command", "name"], outputs=output, raw_response=response
    )
...
def get_facts_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.Facts", outputs_key_field="unique", outputs=output, raw_response=output
    )
...
def get_health_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.CalderaInfo", outputs_key_field="", outputs=response, raw_response=response
    )
...
def get_obfuscators_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.Obfuscators", outputs_key_field="name", outputs=response, raw_response=response
    )
...
def get_objectives_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.Objectives", outputs_key_field="id", outputs=response, raw_response=response
    )
...
def get_operation_links_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.OperationLinks", outputs_key_field="id", outputs=response, raw_response=response
    )
...
def get_planners_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.Planners", outputs_key_field="", outputs=response, raw_response=response
    )
...
def get_plugins_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.Plugins", outputs_key_field="name", outputs=response, raw_response=response
    )
...
def get_relationships_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    output = response.get("found")
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.Relationships", outputs_key_field="unique", outputs=output, raw_response=response
    )
...
def get_schedules_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.Schedules", outputs_key_field="id", outputs=response, raw_response=response
    )
...
def get_sources_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.Sources", outputs_key_field="id", outputs=response, raw_response=response
    )
...
def get_operation_eventlogs_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    output = {"id": operation_id, "EventLogs": response}
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.Operations", outputs_key_field="operation_id", outputs=output, raw_response=response
    )
...
def get_operation_report_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    output = {"id": operation_id, "OperationReport": response}
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.Operations", outputs_key_field="operation_id", outputs=output, raw_response=response
    )
...
def replace_ability_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    response = client.replace_ability(
        ability_id,
        ability_name,
        ability_buckets,
        ability_technique_id,
    ...
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.Abilities", outputs_key_field="id", outputs=response, raw_response=response
    )
...
def replace_schedule_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    partial_schedule_task = assign_params(
        name=partial_schedule_task_name,
        autonomous=partial_schedule_task_autonomous,
        id=partial_schedule_task_id,
        objective=partial_schedule_task_objective,
        visibility=partial_schedule_task_visibility,
        state=partial_schedule_task_state,
        group=partial_schedule_task_group,
        host_group=partial_schedule_task_host_group,
        planner=partial_schedule_task_planner,
        obfuscator=partial_schedule_task_obfuscator,
        ...
        jitter=partial_schedule_task_jitter,
        start=partial_schedule_task_start,
        adversary=partial_schedule_task_adversary,
    ...
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.Schedules", outputs_key_field="", outputs=response, raw_response=response
    )
...
def update_agent_config_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    response = client.update_agent_config(
        watchdog, sleep_min, deployments, deadman_abilities, untrusted_timer, bootstrap_abilities, sleep_max, implant_name
    )
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.AgentConfig", outputs_key_field="", outputs=response, raw_response=response
    )
...
def update_adversary_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    response = client.update_adversary(
        adversary_id,
        adversaryname,
        adversarytags,
        adversaryobjective,
    ...
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.Adversaries", outputs_key_field="", outputs=response, raw_response=response
    )
...
def update_fact_source_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    response = client.update_fact_source(
        fact_source_id,
        source_name,
        source_adjustments,
...
def update_objective_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    response = client.update_objective(objective_id, name, goals, description)
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.Objectives", outputs_key_field="", outputs=response, raw_response=response
    )
...
def update_operation_fields_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    response = client.update_operation_fileds(operation_id, obfuscator, autonomous, state)
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.Operations", outputs_key_field="id", outputs=response, raw_response=response
    )
...
def update_main_config_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(readable_output=f"{property} updated to {value} in main config.")
    return command_results
...
def update_facts_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    partial_factupdaterequest_updates = assign_params(
        unique=unique,
        name=name,
        links=links,
    ...
    partial_factupdaterequest_criteria = assign_params(
        unique=criteria_unique,
        name=criteria_name,
        links=criteria_links,
        relationships=criteria_relationships,
        origin_type=criteria_origin_type,
        created=criteria_created,
        limit_count=criteria_limit_count,
        technique_id=criteria_technique_id,
        trait=criteria_trait,
...
def update_relationships_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    partial_relationshipupdate_updates = assign_params(
        unique=unique, origin=origin, edge=edge, source=source, score=score, target=target
    )
    criteria_unique = args.get("criteria_unique")
    ...
    partial_relationshipupdate_criteria = assign_params(
        unique=criteria_unique,
        origin=criteria_origin,
        edge=criteria_edge,
        source=criteria_source,
        score=criteria_score,
        target=criteria_target,
    )

    response = client.update_relationships(partial_relationshipupdate_updates, partial_relationshipupdate_criteria)
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.Relationships", outputs_key_field="", outputs=response, raw_response=response
    )
...
def update_ability_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    response = client.update_ability(
        ability_id,
        name,
        buckets,
        technique_id,
...
def update_operation_link_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        outputs_prefix="MitreCaldera.Links", outputs_key_field="", outputs=response, raw_response=response
    )
