...
if operation_id:
    ...
    if isinstance(res, dict) and "facts" in res:
        ...
        command_results = CommandResults(readable_output=tableToMarkdown("Operation Facts", caldera_operation_facts))
    else:
        command_results = CommandResults(readable_output="### Operation Facts\n\nNo data.")
else:
