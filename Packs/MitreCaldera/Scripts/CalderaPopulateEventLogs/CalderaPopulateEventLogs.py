...
if operation_id:
    ...
    if isinstance(res, list):
        ...
        command_results = CommandResults(readable_output=tableToMarkdown("Event Logs", events))
    else:
        command_results = CommandResults(readable_output=tableToMarkdown("Event Logs", []))
else:
    command_results = CommandResults(readable_output=tableToMarkdown("Operation Facts", []))
