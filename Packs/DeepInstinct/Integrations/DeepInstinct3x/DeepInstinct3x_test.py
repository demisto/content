...
params = {"apikey": "key", "base_url": "https://demisto.poc.deepinstinctweb.com", "after_id": 0}
...
mock_policies = [
    {"id": 2, "os": "IOS", "name": "iOS Default Policy", "is_default_policy": True, "msp_name": "MSP 1", "msp_id": 1},
