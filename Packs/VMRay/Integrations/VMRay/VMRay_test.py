...
def test_upload_sample_command(mocker):
    ...
    """
    expected_output = "Error in API call to VMRay [200] - [{'error_msg': 'Submission not stored because no jobs were " \
                      "created \\nThere is a possibility this file has been analyzed before. Please try using the " \
                      "command with the argument: reanalyze=true.', 'submission_filename': 'example.pdf'}]"
