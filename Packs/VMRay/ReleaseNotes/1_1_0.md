...
#### Overview
​
The VMRay Cortex XSOAR Connector has been updated to support all of the latest features of the VMRay Platform, most notable among which is complete support for the new verdict evaluation system introduced in v4.0 of the VMRay Platform, which replaced the severity scoring system. Retrieval of recursive analysis results is also supported now with the addition of child and parent sample results. The new Summary JSON v2, also introduced in v4.0 of the Platform, is also fully supported.
​
#### Integrations
##### VMRay
