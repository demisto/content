To allow access to EWS O365, an administrator has to approve the Cortex XSOAR app using an admin consent flow, by clicking on the following [link](https://oproxy.demisto.ninja/ms-ews-o365).
