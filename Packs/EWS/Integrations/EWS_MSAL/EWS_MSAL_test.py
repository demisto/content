...
from EWS_MSAL import (ExpandGroup, GetSearchableMailboxes, EWSClient, fetch_emails_as_incidents,
...
def test_fetch_and_mark_as_read(mocker):
    ...
    client.get_folder_by_path = mock_get_folder_by_path
    client.folder_name = 'Inbox'
    mark_item_as_read = mocker.patch('EWS_MSAL.mark_item_as_read')
