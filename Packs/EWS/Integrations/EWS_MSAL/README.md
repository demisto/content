...
3.  Click **Add instance** to create and configure a new integration instance.
    ...
    *   **Username**: User credential of the user who will be used for authentication
    *   **Password**: User credential of the user who will be used for authentication
    *   **Tenant ID**: Tenant ID of the self deployed Azure application
    *   **Client ID**: Application ID of the self deployed Azure application
    *   **API Permission**: API Permission to request for API scope. Default is EWS.AccessAsUser.All  
    *   **Redirect URL**: The redirect URL configured on the self deployed Azure application
    ...
    *   **No Proxy**: add the no proxy domain list (e.g *.test.com,login.abc.com)
