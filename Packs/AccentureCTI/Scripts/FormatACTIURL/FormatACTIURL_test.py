...
def test_url_to_uuid_func():
    ...
    intelligence_alert_link = 'https://intelgraph.idefense.com/#/node/intelligence_alert'\
        '/view/a487dfdc-08b4-49a09-82ea-2d934c27d901'
    intelligence_report_link = 'https://intelgraph.idefense.com/#/node/intelligence_report'\
        '/view/a487dfdc-08b4-49a09-82ea-2d934c27d901'
