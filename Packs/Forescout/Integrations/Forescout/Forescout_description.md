...
3. Create a username and password by clicking the *Add* button, and completing the fields. These are the credentials that you will enter when configuring the XSOAR-Forescout integration: *Web API Username* and *Password*. 
4. Select *Client IPs* towards the top of the main area of the dialog, next to *User Settings*. 
5. Add the IP address where your XSOAR instance is hosted or allow requests from all IP addresses to make sure that requests made by the XSOAR-Forescout integration will be permitted. 
...
The username and password entered in the account-creation dialog are the credentials that you will enter when configuring the XSOAR-Forescout integration: *Data Exchange (DEX) Username* and *Password*.
