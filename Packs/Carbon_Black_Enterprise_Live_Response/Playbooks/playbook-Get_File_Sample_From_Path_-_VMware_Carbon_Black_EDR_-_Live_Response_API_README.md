...
## Playbook Image
---
![Get File Sample From Path - VMware Carbon Black EDR - Live Response API](../doc_files/Get_File_Sample_From_Path_-_VMware_Carbon_Black_EDR_Live_Response_API.png)
