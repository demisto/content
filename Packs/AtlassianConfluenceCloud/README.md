...
6. Select the **scopes** to determine what the API token can do in Jira or Confluence.
    - *select **Confluence***.
7. Select **Create**
8. Select **Copy to clipboard**, then paste the token in your XSIAM integration.
...
| API Token | Your API token generated in "Create an API token with scopes" section. | True |
