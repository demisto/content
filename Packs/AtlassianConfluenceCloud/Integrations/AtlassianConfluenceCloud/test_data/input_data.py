...
exception_handler_params = [
    ...
    (507, "The server encountered an internal error for Atlassian Confluence Cloud " "and was unable to complete your request."),
]
...
comment_create_invalid_args = [
    ...
    ({"body_value": "hello", "body_representation": "abc", "container_id": "1234"}, MESSAGES["INVALID_BODY_REPRESENTATION"]),
]
...
create_space_invalid_args = [
    ...
    ({"unique_key": "!@#$", "name": "space_name", "advanced_permissions": '{"subjects":"user"}'}, MESSAGES["INVALID_SPACE_KEY"]),
    (
        {
    ...
    (
        {
            "unique_key": "unique",
            "name": "gKcpqsOfX80ySDWwDXwU1WtcxPurxpvo2IQGXoJFpYsaoreivzjKRqOQ"
    ...
    (
        {"unique_key": "unique", "name": "space_name", "is_private_space": True, "advanced_permissions": '{"subjects":"user"}'},
...
content_update_invalid_arg_value = [
    ({"content_id": "2097159", "title": "", "type": "page", "version": 2}, MESSAGES["REQUIRED_ARGUMENT"].format("title")),
    ({"content_id": "2097159", "title": "dummy", "type": "", "version": 2}, MESSAGES["REQUIRED_ARGUMENT"].format("type")),
    ({"content_id": "2097159", "title": "dummy", "type": "dummy", "version": 2}, MESSAGES["INVALID_CONTENT_TYPE_UPDATE_CONTENT"]),
    (
        {
            "content_id": "2097159",
            "title": "dummy",
