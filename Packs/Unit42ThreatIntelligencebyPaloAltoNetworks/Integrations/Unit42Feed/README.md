...
- *HTTP 403 Forbidden* error when fetching indicators behind a corporate proxy or firewall.
  - This occurs when the proxy or firewall blocks outbound requests to the Unit 42 Feed API endpoint (`prod-us.tas.crtx.paloaltonetworks.com`), which is not listed in the standard XSOAR System Requirements documentation.
