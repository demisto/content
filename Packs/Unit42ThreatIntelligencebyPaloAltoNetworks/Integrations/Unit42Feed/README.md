...
| Indicator Fetch Limit | Maximum total number of indicators to fetch per feed run. The limit is distributed equally among all active types (Threat Objects, IP, Domain, URL, File). The last type (File) receives any remaining quota. Default is 100000. Maximum allowed value is 100000. | False |
