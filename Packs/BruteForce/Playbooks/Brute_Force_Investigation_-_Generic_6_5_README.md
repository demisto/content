...
| internal_range | A list of internal IP ranges to check IP addresses against. The comma-separated list should be provided in a CIDR notation. For example, a list of ranges would be: '172.16.0.0/12,10.0.0.0/8,192.168.0.0/16' \(without quotes\). | lists.PrivateIPs | Optional |
