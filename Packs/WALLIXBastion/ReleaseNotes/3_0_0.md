...
- Added suggestions for enum arguments (i.e having predefined values) and booleans

- fix support for empty lists arguments
...
- Updated wab-add-service-in-device parameters:
    - set service_post_subprotocols as non required 
    - add service_post_seamless_connection option for RAWTCPIP

- Updated wab-edit-service-of-device: parameters:
    - add optional parameters service_post_subprotocols
    - add service_put_seamless_connection option for RAWTCPIP

- Updated wab-edit-application parameters:
    - add optional parameters application_put_global_domains
...
- **Breaking changes:** removed WAB.profile_get.gui_features.dashboards from wab-get-profile(s)

- **Breaking changes:** removed WAB.profile_get.gui_features.dashboards from wab-get-profile(s)

- **Breaking changes:** removed WAB.application_get.tags.id from wab-get-application(s)

- **Breaking changes:** removed WAB.device_get.tags.id from wab-get-device(s)
