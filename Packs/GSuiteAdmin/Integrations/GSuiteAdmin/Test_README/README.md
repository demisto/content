...
This integration was integrated and tested with version xx of GSuiteAdmin_Test
...
#### Command example
```!gsuite-user-get user=admin@demistodev.com```
#### Context Example
```json
{
    "GSuite": {
        "User": {
            ...
            "emails": [
                ...
                {
                    "address": "admin@demistodev.com.test-google-a.com"
                }
            ],
            "etag": "\"CTyc505ppdmJR2motHVsU17kzItOkPo5vYViqlSF0rU/4JTpgVo9qYBpK8eWDoCgVlbocHo\"",
            "firstName": "Tomer",
            "fullName": "Tomer Malache",
            "id": "103020731686044834269",
            ...
            "primaryEmail": "admin@demistodev.com",
            "recoveryEmail": "tmalache@paloaltonetworks.com",
            "recoveryPhone": "+972545429435",
            "suspended": false,
            "thumbnailPhotoEtag": "\"CTyc505ppdmJR2motHVsU17kzItOkPo5vYViqlSF0rU/1tCzePvsSvFlaVVRtPil5xGYwGU\"",
            "thumbnailPhotoUrl": "https://www.google.com/s2/photos/private/AIbEiAIAAABDCN2z4KPs7vL1KSILdmNhcmRfcGhvdG8qKDBjMDJkNTgwZDdkMTYxMThhN2QzYTk1NmI4Y2JiMzE1NDY0YTQ2NzgwAQVPp6h6qB6E9qGR6Nld0kG9dur2"
        }
    }
}
```
...
>### Retrieved details for user admin@demistodev.com
...
>|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
>| 103020731686044834269 | C02f0zfqw | admin@demistodev.com | Tomer | Malache | false | false | / | true | 2016-05-18T10:45:01.000Z | Value: 77777777<br/>Type: home | Address: admin@demistodev.com<br/>Primary: True | false | tmalache@paloaltonetworks.com | +972545429435 |
...
#### Command example
```!gsuite-group-get group=atlassiantest@demistodev.com```
#### Context Example
```json
{
    "GSuite": {
        "Group": {
            "adminCreated": true,
            "description": "Atlassian Test Group",
            "directMembersCount": "1",
            "email": "atlassiantest@demistodev.com",
            "etag": "\"CTyc505ppdmJR2motHVsU17kzItOkPo5vYViqlSF0rU/Kkh2m8afa_YuoY66uStUitE9T98\"",
            "id": "01mrcu090jzgjvl",
            "kind": "admin#directory#group",
            "name": "Atlassian Test Group",
            "nonEditableAliases": [
                "atlassiantest@demistodev.com.test-google-a.com"
            ]
        }
    }
}
...
>|---|---|---|---|
>| 01mrcu090jzgjvl | atlassiantest@demistodev.com | Atlassian Test Group | true |
