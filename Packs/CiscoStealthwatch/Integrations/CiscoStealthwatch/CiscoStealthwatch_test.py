...
def test_cisco_stealthwatch_get_top_alarming_tags_command(requests_mock):
    from cisco_stealthwatch import Client, cisco_stealthwatch_get_top_alarming_tags_command
...
def test_cisco_stealthwatch_list_security_events_results_command(requests_mock):
    from cisco_stealthwatch import Client, cisco_stealthwatch_list_security_events_results_command
