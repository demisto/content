...
def test_cisco_stealthwatch_query_flows_initialize_command(requests_mock):
    ...
    req_mock = requests_mock.post(
        "https://sw-reporting/v2/tenants//flows/queries", json=mock_response, headers={"X-XSRF-TOKEN": "some token"}
    )
...
def test_cisco_stealthwatch_query_flows_status_command(requests_mock):
    ...
    requests_mock.get(
        "https://sw-reporting/v2/tenants//flows/queries/602a96e7e4b0d6d2a200ea94",
        json=mock_response,
...
def test_cisco_stealthwatch_query_flows_results_command(requests_mock):
    ...
    requests_mock.post("https://token/v2/authenticate", cookies={"cookies": "jar"})
    requests_mock.get("https://sw-reporting/v2/tenants//flows/queries//results", json=mock_response)
    client = Client(base_url="https://", auth=("", ""), verify=False, proxy=False)
...
def test_cisco_stealthwatch_list_tags_command(requests_mock):
    ...
    requests_mock.post("https://token/v2/authenticate", cookies={"cookies": "jar"})
    requests_mock.get("https://sw-reporting/v1/tenants//internalHosts/tags", json=mock_response)
    client = Client(base_url="https://", auth=("", ""), verify=False, proxy=False)
...
def test_cisco_stealthwatch_get_tag_command(requests_mock):
    ...
    requests_mock.post("https://token/v2/authenticate", cookies={"cookies": "jar"})
    requests_mock.get("https://smc-configuration/rest/v1/tenants//tags/", json=mock_response)
    client = Client(base_url="https://", auth=("", ""), verify=False, proxy=False)
...
def test_cisco_stealthwatch_list_tenants_all_command(requests_mock):
    ...
    requests_mock.post("https://token/v2/authenticate", cookies={"cookies": "jar"})
    requests_mock.get("https://sw-reporting/v1/tenants", json=mock_response)
    client = Client(base_url="https://", auth=("", ""), verify=False, proxy=False)
...
def test_cisco_stealthwatch_list_tenants_one_command(requests_mock):
    ...
    requests_mock.post("https://token/v2/authenticate", cookies={"cookies": "jar"})
    requests_mock.get("https://sw-reporting/v1/tenants/x", json=mock_response)
    client = Client(base_url="https://", auth=("", ""), verify=False, proxy=False)
...
def test_cisco_stealthwatch_get_tag_hourly_traffic_report_command(requests_mock):
    ...
    requests_mock.post("https://token/v2/authenticate", cookies={"cookies": "jar"})
    requests_mock.get("https://sw-reporting/v1/tenants/x/internalHosts/tags/y/traffic/hourly", json=mock_response)
    client = Client(base_url="https://", auth=("", ""), verify=False, proxy=False)
...
def test_cisco_stealthwatch_get_top_alarming_tags_command(requests_mock):
    ...
    requests_mock.post("https://token/v2/authenticate", cookies={"cookies": "jar"})
    requests_mock.get("https://sw-reporting/v1/tenants/x/internalHosts/alarms/topHosts", json=mock_response)
    client = Client(base_url="https://", auth=("", ""), verify=False, proxy=False)
...
def test_cisco_stealthwatch_list_security_events_initialize_command(requests_mock):
    from CiscoStealthwatch import Client, cisco_stealthwatch_list_security_events_initialize_command

    mock_response = util_load_json("test_data/list_security_events_initialize.json")
    requests_mock.post("https://token/v2/authenticate", cookies={"cookies": "jar"})
    requests_mock.post("https://sw-reporting/v1/tenants/x/security-events/queries", json=mock_response)
    client = Client(base_url="https://", auth=("", ""), verify=False, proxy=False)
    response = cisco_stealthwatch_list_security_events_initialize_command(client, "x", time_range="1 day")
...
def test_cisco_stealthwatch_list_security_events_status_command(requests_mock):
    ...
    requests_mock.post("https://token/v2/authenticate", cookies={"cookies": "jar"})
    requests_mock.get("https://sw-reporting/v1/tenants//security-events/queries/x", json=mock_response)
    client = Client(base_url="https://", auth=("", ""), verify=False, proxy=False)
...
def test_cisco_stealthwatch_list_security_events_results_command(requests_mock):
    ...
    requests_mock.post("https://token/v2/authenticate", cookies={"cookies": "jar"})
    requests_mock.get("https://sw-reporting/v1/tenants//security-events/results/x", json=mock_response)
    client = Client(base_url="https://", auth=("", ""), verify=False, proxy=False)
