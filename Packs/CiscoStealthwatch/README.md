...
- Runs queries on Cisco Stealthwatch flows and return its results to the context.
...
<u>Configure Custom syslog format:</u>
1. Login into the Stealthwatch Management Console (SMC).
2. Go to **Configuration > Response Management**.
3. Click On the **Syslog Formats** tab and then click on **Add New**.
...
4. In the Message box, paste the below format:
...
<u>Configure syslog message action:</u>
1. Login into the Stealthwatch Management Console (SMC).
2. Go to **Configuration > Response Management**.
3. Click On the **Actions** tab and then click on **Add** > **Syslog Message**.
4. Configure the below parameters in the opened window:
...
5. Click on the **Test Action** button and if everything is good, click save.

<u>Configure Rule:</u>
1. Login into the Stealthwatch Management Console (SMC).
2. Go to **Configuration > Response Management**.
3. Click On the **Rules** tab and then click on **Add New Rule**.
4. Click on **Host Alarm**.
...
7. In the **Associated Actions** section, enable the syslog action message you configured before (for both active and inactive).
