...
[Required IAM policy for collecting audit logs](https://docs.oracle.com/en-us/iaas/Content/Audit/Tasks/viewinglogevents.htm)
...
| Event types to fetch | The type of the events to fetch. Default value is 'Audit'. | True |
