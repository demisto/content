...
This integration was integrated and tested with version xx of Slack IAM_copy
## Configure Slack IAM_copy on Cortex XSOAR

1. Navigate to **Settings** > **Integrations** > **Servers & Services**.
2. Search for Slack IAM_copy.
3. Click **Add instance** to create and configure a new integration instance.
    ...
    | iam-create-user Command Enabled | False |
    | iam-update-user Command Enabled | False |
    | iam-disable-user Command Enabled | False |
