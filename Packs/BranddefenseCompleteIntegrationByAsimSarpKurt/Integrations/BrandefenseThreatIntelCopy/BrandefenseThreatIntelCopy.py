...
class Client(BaseClient):
    ...
    def check_module(self) -> dict:
        url = "https://api.brandefense.com/v1/tisp/search?value__icontains=covid"
        headers = {
            'Authorization': 'Token 56ec83fe80551bea2e0e30e1f7d40b69fb2316c8',
            'User-Agent': 'Mozilla/5.0 (compatible; barikat/0.1; +www.barikat.com.tr>)'}
