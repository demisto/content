...
- Added support for additional types of policies in the command ***mimecast-get-policy***.
- Added support for additional types of policies in the command ***mimecast-delete-policy***.
