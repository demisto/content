WITH_OUT_DUP_TEST = {
    ...
    "last_run_potential_dup": ["12345", "SDGSFDGS4345434534"],
}
...
EMPTY_EVENTS_LIST = {"audit_events": [], "last_run_potential_dup": ["123", "LKJFDIGO87S443", "SADF"], "res": []}
...
AUDIT_LOG_RESPONSE = {
    "meta": {"status": 200, "pagination": {"pageSize": 10, "next": "1234"}},
    "data": [
        {
            ...
            "data": [
                {
                    ...
                    "Rcpt": ["jeff.skilling@paloaltonetworks.mime.integration.com"],
                    "AttSize": 0,
                    "Attempt": 17,
                    "Snt": 0,
