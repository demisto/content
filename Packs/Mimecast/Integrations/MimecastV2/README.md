...
3. Click **Add instance** to create and configure a new integration instance.
    ...
    | Client ID | For API 2.0 | False |
    | Client Secret | For API 2.0 | False |
    | Client Secret |  | False |
    | App ID | For API 1.0 | False |
    | User Email Address (Use for auto token refresh) | For API 1.0 | False |
    | Password |  | False |
    | User Email Address (Use for auto token refresh) | For API 1.0 | False |
    | Password | For API 1.0 | False |
    | App Key | For API 1.0 | False |
    | App Key |  | False |
    | App key | For API 1.0 | False |
    | AccessKey | For API 1.0 | False |
    | Secret Key | For API 1.0 | False |
    | Secret Key |  | False |
    | SecretKey | For API 1.0 | False |
    | Fetch incidents |  | False |
    | Fetch URL incidents |  | False |
    | Fetch attachment incidents |  | False |
    | Fetch impersonation incidents |  | False |
    | Fetch incident types | Fetch specific incident types. Default value is "All". | False |
    | Incident type |  | False |
...
| pageSize | Number of results per page to display. | Optional | 
...
| limit | The maximum number of results to return. Possible values are: . Default is 20. | Optional | 
...
***
Deprecated. Use mimecast-list-policies instead.
...
***
Get a list of messages for a given user. This is an archive search command.
...
| view | The message list type, must be one of: inbox or sent, default is inbox. Possible values are: INBOX, SENT. Default is INBOX. | Optional | 
...
| **Argument Name** | **Description** | **Required** |
| --- | --- | --- |
| resultsNumber | This parameter is ignored, use the 'limit' parameter instead. | Optional | 
| fromDate | Start date of logs to return in the following format 2015-11-16T14:49:18+0000. Default is the start of the current day. | Optional | 
| toDate | End date of logs to return in the following format 2015-11-16T14:49:18+0000. Default is time of request. | Optional | 
| resultType | Filters logs by scan result. Possible values are: clean, malicious, all. Default is malicious. | Optional | 
| limit | The maximum number of results to return. Default is 100. | Optional | 
| page | Page number you would like to view. Each page contains page_size values. Must be used along with page_size. Possible values are: . | Optional | 
| page_size | Number of results per page to display. Possible values are: . | Optional | 
...
| searchField | The field to search. Default is all (meaning all of the preceding fields). Possible values are: senderAddress, recipientAddress, subject, policy, all. | Optional | 
...
| attachmentName | The Mimecast attachment name. When used, the file name and its extension will be included in the context data. Can be retrieved from mimecast-get-message command. | Optional | 
...
| **Argument Name** | **Description** | **Required** |
| --- | --- | --- |
| group_id | The group ID to return. Can be retrieved by running the mimecast-find-groups command. | Required | 
| limit | The maximum number of results to return. | Optional | 
...
| **Argument Name** | **Description** | **Required** |
| --- | --- | --- |
| group_id | The group ID to add the user to. Can be retrieved by running the mimecast-find-groups command. | Required | 
...
| from_date | API start parameter. Datetime format is ISO 8601. e.g., 2022-07-11T14:49:18+0000. Possible values are: . | Optional | 
| to_date | API end parameter  Datetime format ISO 8601. e.g., 2022-07-11T14:49:18+0000. Possible values are: . | Optional | 
...
| route | A comma-separated list of routes to filter by. Possible values are: internal, outbound, inbound. | Optional | 
...
| **Argument Name** | **Description** | **Required** |
| --- | --- | --- |
| ids | A comma-separated list of the Mimecast IDs of the messages to load. This is returned by the /api/message-finder/search endpoint. (mimecast-search-message command). Possible values are: . | Required | 
| show_recipient_info | When argument is true all data from recipientInfo object is presented at command response. Possible values are: true, false. Default is true. | Optional | 
| show_delivered_message | When argument is true all data from deliveredMessage object is presented at command response. Possible values are: true, false. Default is false. | Optional | 
| show_retention_info | When argument is true all data from retentionInfo object is presented at command response. Possible values are: true, false. Default is true. | Optional | 
| show_spam_info | When argument is true all spamInfo block is presented at command response. Possible values are: true, false. Default is true. | Optional | 
...
| from_date | Datetime format ISO 8601. e.g., 2022-07-11T14:49:18+0000. Possible values are: . | Optional | 
| to_date | Datetime format ISO 8601. e.g., 2022-07-11T14:49:18+0000. Possible values are: . | Optional | 
...
| **Argument Name** | **Description** | **Required** |
| --- | --- | --- |
| ids | A comma-separated list of Mimecast secure IDs IDs are extracted from the mimecast-list-held-message command. Possible values are: . | Required | 
...
| **Argument Name** | **Description** | **Required** |
| --- | --- | --- |
| id | Mimecast secure ID. ID can be extracted from the mimecast-list-held-message command. Possible values are: . | Required | 
...
| Mimecast.ProcessingMessage.messages.attachment | Boolean | Whether there is an attachment in the message. | 
...
| Mimecast.ProcessingMessage.messages.priority | String | Message priority. | 
...
| **Argument Name** | **Description** | **Required** |
| --- | --- | --- |
| from_date | Datetime format ISO 8601. e.g., 2022-07-11T14:49:18+0000. Possible values are: . | Required | 
| to_date | Datetime format ISO 8601. e.g., 2022-07-11T14:49:18+0000. Possible values are: . | Required | 
