...
def test_list_policies_command(mocker):
    ...
    expected_response =  {'meta': {'status': 200}, 'data': [{'addressAlterationSetId': 'eN11111', 'id': 'eN111', 'policy': {'description': 'test2', 'fromPart': 'envelope_from', 'from': {'type': 'internal_addresses'}, 'to': {'type': 'internal_addresses'}, 'fromType': 'internal_addresses', 'toType': 'internal_addresses', 'fromEternal': True, 'toEternal': True, 'fromDate': '1900-01-01T00:00:00+0000', 'toDate': '2100-01-01T23:59:59+0000', 'override': False, 'bidirectional': False, 'conditions': {}, 'enabled': True, 'enforced': False}}], 'fail': []}
    mocker.patch.object(MimecastV2, 'request_with_pagination_api2', return_value=expected_response)
...
def test_update_antispoofing_bypass_policy_command(mocker):
    ...
    args = {'description': 'test_1', 'enabled': 'true', 'from_eternal': 'true', 'id': 'eNo11111', 'option': 'disable_bypass', 'to_eternal': 'true'}
    expected_response =  {'meta': {'status': 200}, 'data': [{'option': 'disable_bypass', 'id': 'eNo11111', 'policy': {'description': 'test_1', 'fromPart': 'envelope_from', 'from': {'type': 'everyone'}, 'to': {'type': 'everyone'}, 'fromType': 'everyone', 'toType': 'everyone', 'fromEternal': True, 'toEternal': True, 'fromDate': '1900-01-01T00:00:00+0000', 'toDate': '2100-01-01T23:59:59+0000', 'override': False, 'bidirectional': False, 'conditions': {}, 'enabled': True, 'enforced': False, 'createTime': '2024-05-06T13:48:16+0000', 'lastUpdated': '2024-05-07T13:26:34+0000'}}], 'fail': []}
    mocker.patch.object(MimecastV2, 'http_request', return_value=expected_response)
