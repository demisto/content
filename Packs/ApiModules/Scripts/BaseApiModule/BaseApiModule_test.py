"""Tests for BaseApiModule - testing BaseCollector, CollectorBlueprint, and related components."""
...
# Import from ContentClientApiModule (base classes and utilities)
from ContentClientApiModule import (  # noqa: E402
    APIKeyAuthHandler,
...
# Import from BaseApiModule (collector-specific classes)
from BaseApiModule import (  # noqa: E402
    BaseCollector,
    CollectorBlueprint,
    CollectorRequest,
    PaginationConfig,
...
def test_deduplication_with_key():
    ...
    # Verify state
    assert result.state.deduplication is not None
...
def test_deduplication_state_persistence(integration_context):
    ...
    # Save state
    state = result1.state
    # Manually sync metadata for test
...
# =============================================================================
# Authentication Tests (via BaseCollector)
# =============================================================================
...
def test_cursor_pagination_state_persistence(integration_context):
    """Test cursor-based pagination with state persistence."""
    respx.get("https://api.example.com/v1/events").mock(
        side_effect=[
...
def test_concurrent_shards_collect_in_parallel():
    """Test concurrent shard collection."""
...
def test_resume_from_state_snapshot():
    """Test resuming collection from a saved state."""
...
def test_blueprint_builder_success():
    ...
    assert blueprint.request.pagination is not None
...
def test_builder_with_rate_limit():
    ...
    assert blueprint.rate_limit is not None
...
def test_builder_with_timeout():
    ...
    assert blueprint.timeout is not None
...
def test_builder_with_retry_policy():
    ...
    assert blueprint.retry_policy is not None
...
# =============================================================================
# Diagnostic and Health Check Tests
# =============================================================================
