...
def test_replace_response_names_string():
    ...
    When:
        - Calling replace_response_names on the string.
    Then:
...
def test_replace_response_names_list():
    ...
    When:
        - Calling replace_response_names on the list.
    Then:
...
def test_replace_response_names_dict():
    ...
    When:
        - Calling replace_response_names on the dictionary.
    Then:
...
def test_replace_response_names_nested():
    ...
    When:
        - Calling replace_response_names on the nested structure.
    Then:
...
def test_replace_response_names_noop():
    """
    Given:
        - Non-string, non-list, non-dict objects (e.g., int, None).
    When:
        - Calling replace_response_names on these objects.
    Then:
