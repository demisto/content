...
def parse_subnet_mappings(subnets_str):
    ...
    for f in subnets_str.split(";"):
        ...
        subnets.append({"SubnetId": match.group(1), "AllocationId": match.group(2)})
    return subnets
...
def add_tags_to_certificate(args, aws_client):
    ...
    kwargs = {"CertificateArn": args.get("certificateArn"), "Tags": parse_tag_field(args.get("tags"))}
