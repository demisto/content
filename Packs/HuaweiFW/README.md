...
<html>
<head>
    <title>Huawei Firewall Integration</title>
    <style>
        table, th, td {
...
<body>
    ...
    <h2>Overview</h2>
    <p>
        The Huawei USG6000E series consists of AI-based firewalls designed for enterprises. These devices leverage intelligent threat detection and collaborative defense to proactively protect against advanced threats.
        <br>
...
<~XSIAM>
    ...
    <ul>
        <li>Data modeling rules to normalize Huawei Firewall logs ingested into Cortex XSIAM via the Broker VM.</li>
        <li>Ingested logs can be queried in XQL Search using the `huawei_fw_raw` dataset.</li>
    </ul>
    ...
    <p>
    MMM dd yyyy HH:mm:ss <br>
    Example: "Aug 16 2024 12:30:50"
    </p>
