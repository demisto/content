...
```!PreProcessImage action=grayscale file_entry_id=<file_entry_id_example>```
...
```!PreProcessImage action=sharpened file_entry_id=<file_entry_id_example>```
...
```!PreProcessImage action=grayscale file_entry_id=<file_entry_id_example> image_resize_width=500```
