We recommend using the Unit42 v2 Feed instead. The Unit42 ATOMs Feed is more aligned with the STIX format, and includes more objects, such as Campgain, Course of Action and Relationships.
