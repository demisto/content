...
class Client(BaseClient):
    ...
    def __init__(self, base_url: str, username: str, password: str, use_ssl: bool, use_proxy: bool):
        super().__init__(urljoin(base_url, "/api/v1/"), auth=(username, password), verify=use_ssl, proxy=use_proxy)

    def list_hosts_request(
        self,
    ...
    def get_alert_pcap_request(self, alert_id: int) -> bytes:
        ...
        return self._http_request(method="GET", url_suffix=f"alert_pcaps/{alert_id}", resp_type="content")

    def list_sensors_request(
        self, offset: Optional[int] = None, limit: Optional[int] = None, all_sensors: Optional[bool] = None
    ) -> List[dict[str, Any]]:
        """
        ...
        params = remove_empty_elements({"offset": offset, "limit": limit, "all_sensors": all_sensors})

        return self._http_request(method="GET", url_suffix="sensors", params=params)

    def list_sensor_modules_request(
        self, sensor_id: int, offset: Optional[int] = None, limit: Optional[int] = None
    ) -> List[dict[str, Any]]:
        """
        ...
        return self._http_request(method="GET", url_suffix=f"sensors/{sensor_id}/modules", params=params)

    def update_sensor_module_request(
        self,
        sensor_id: int,
        module_id: int,
        ...
        params = remove_empty_elements(
            {"name": name, "description": description, "started": started, "operational_mode": operational_mode}
        )

        return self._http_request(method="PUT", url_suffix=f"sensors/{sensor_id}/modules/{module_id}", params=params)
    ...
    def delete_sensor_module_request(self, sensor_id: int, module_id: int) -> None:
        ...
        self._http_request(method="DELETE", url_suffix=f"sensors/{sensor_id}/modules/{module_id}", resp_type="text")

    def get_ip_blacklist_request(
        self, sensor_id: int, offset: Optional[int] = None, limit: Optional[int] = None
    ) -> List[dict[str, Any]]:
        """
        ...
        return self._http_request(method="GET", url_suffix=f"sensors/{sensor_id}/itl/itl_sec_udb_bip/blacklist", params=params)
    ...
    def add_ip_blacklist_request(self, sensor_id: int, address: str, comment: str = "") -> None:
        ...
        self._http_request(
            method="POST", url_suffix=f"sensors/{sensor_id}/itl/itl_sec_udb_bip/blacklist", json_data=body, resp_type="text"
        )

    def get_domain_blacklist_request(
        self, sensor_id: int, offset: Optional[int] = None, limit: Optional[int] = None
    ) -> List[dict[str, Any]]:
        """
        ...
        return self._http_request(method="GET", url_suffix=f"sensors/{sensor_id}/itl/itl_sec_udb_dns_bd/blacklist", params=params)

    def add_domain_blacklist_request(self, sensor_id: int, domain_name: str, comment: str = "") -> None:
        """
        ...
        self._http_request(
            method="POST", url_suffix=f"sensors/{sensor_id}/itl/itl_sec_udb_dns_bd/blacklist", json_data=body, resp_type="text"
        )

    def get_ssl_client_blacklist_request(
        self, sensor_id: int, offset: Optional[int] = None, limit: Optional[int] = None
    ) -> List[dict[str, Any]]:
        """
        ...
        return self._http_request(
            method="GET", url_suffix=f"sensors/{sensor_id}/itl/itl_sec_udb_ssl_bja3/blacklist", params=params
        )

    def add_ssl_client_blacklist_request(self, sensor_id: int, application_name: str, ja3_hash: str, comment: str = "") -> None:
        """
        ...
        self._http_request(
            method="POST", url_suffix=f"sensors/{sensor_id}/itl/itl_sec_udb_ssl_bja3/blacklist", json_data=body, resp_type="text"
        )

    def get_file_operation_blacklist_request(
        self, sensor_id: int, offset: Optional[int] = None, limit: Optional[int] = None
    ) -> List[dict[str, str]]:
        """
        ...
        return self._http_request(method="GET", url_suffix=f"sensors/{sensor_id}/itl/itl_sec_udb_bfo/blacklist", params=params)

    def add_file_operation_blacklist_request(
        self, sensor_id: int, matching_type: str, file_or_folder: str, operation: str, comment: str = ""
    ) -> None:
        """
        ...
        body = [{"matching_type": matching_type, "file_or_folder": file_or_folder, "operation": operation, "comment": comment}]

        self._http_request(
            method="POST", url_suffix=f"sensors/{sensor_id}/itl/itl_sec_udb_bfo/blacklist", json_data=body, resp_type="text"
        )
    ...
    def get_diagnostic_logs_request(self, cc_info: Optional[bool] = None, sensor_id: Optional[str] = None) -> bytes:
        """
        ...
        return self._http_request(method="GET", url_suffix="diagnostic_logs", params=params, resp_type="content")

    def list_group_policies_request(self, offset: Optional[int] = None, limit: Optional[int] = None) -> List[dict[str, Any]]:
        """
    ...
    def create_group_policy_request(self, name: str, description: str, constraints: List[dict[str, Any]]) -> dict[str, Any]:
        """
    ...
    def update_group_policy_request(
        self, policy_id: int, name: str, description: str, constraints: List[dict[str, Any]]
    ) -> dict[str, Any]:
        """
        ...
        return self._http_request(method="PUT", url_suffix=f"group_policy/{policy_id}", json_data=remove_empty_elements(body))
    ...
    def delete_group_policy_request(self, policy_id: int) -> None:
        ...
        self._http_request(method="DELETE", url_suffix=f"group_policy/{policy_id}", resp_type="text")

    def assign_group_policy_hosts_request(self, policy_id: int, filter_type: str, filter_value: str) -> dict[str, Any]:
        """
        ...
        return self._http_request(method="POST", url_suffix=f"group_policy/{policy_id}/add_hosts", json_data=body)

    def unassign_group_policy_hosts_request(self, policy_id: int, filter_type: str, filter_value: str) -> dict[str, Any]:
        """
        ...
        return self._http_request(method="POST", url_suffix=f"group_policy/{policy_id}/remove_hosts", json_data=body)

    def list_ip_reuse_domains_request(self, offset: Optional[int] = None, limit: Optional[int] = None) -> List[dict[str, Any]]:
        """
    ...
    def list_hosts_changelog_request(
        self,
        offset: Optional[int] = None,
        limit: Optional[int] = None,
        host_id: Optional[int] = None,
    ...
    def _http_request(
        self, method: str, url_suffix: str = "", full_url: str = None, headers: dict[str, str] = None, *args, **kwargs
    ):
    ...
    def _get_csrf_token(self) -> str:
        session_response = self._http_request(method="GET", url_suffix="sensors", resp_type="response")
...
def validate_fetch_params(max_fetch: int, first_fetch: str) -> None:
    ...
    if max_fetch > MAX_FETCH_INCIDENTS:
        return_error(f"The Maximum number of incidents per fetch should not exceed {MAX_FETCH_INCIDENTS}.")
...
def list_hosts_command(client: Client, args: dict[str, str]) -> CommandResults:
    ...
    response = client.list_hosts_request(
        offset=offset, limit=limit, last_seen=last_seen, id_min=id_min, sort_field=sort_field, sort_ascending=sort_ascending
    )
    ...
    outputs = filter_results(outputs, ip=ip_addresses, vlans=vlan_ids, mac_addresses=mac_addresses, sensor_ids=sensor_ids)
    ...
    return CommandResults(
        outputs_prefix="ForescoutEyeInspect.Host",
...
def list_links_command(client: Client, args: dict[str, str]) -> CommandResults:
    ...
    response = client.list_links_request(
        offset=offset,
        limit=limit,
        src_host_id=src_host_id,
        dst_host_id=dst_host_id,
    ...
    return CommandResults(
        outputs_prefix="ForescoutEyeInspect.Link",
        outputs_key_field="id",
        outputs=outputs,
        readable_output=readable_output,
        raw_response=response,
...
def get_vulnerability_info_command(client: Client, args: dict[str, str]) -> CommandResults:
    ...
    return CommandResults(
        outputs_prefix="ForescoutEyeInspect.CVE",
        outputs_key_field="id",
        outputs=response,
        readable_output=readable_output,
        raw_response=response,
...
def list_alerts_command(client: Client, args: dict[str, str]) -> CommandResults:
    ...
    outputs = filter_results(outputs, sensor_name=sensor_names, vlan=vlan_ids, severity=severities, status=statuses)
    ...
    return CommandResults(
        outputs_prefix="ForescoutEyeInspect.Alert",
...
def get_alert_pcap_command(client: Client, args: dict[str, str]) -> dict[str, Any]:
    ...
    return fileResult(filename=f"alert_{alert_id}_sniff.pcap", data=response, file_type=EntryType.ENTRY_INFO_FILE)
...
def list_sensors_command(client: Client, args: dict[str, str]) -> CommandResults:
    ...
    outputs = filter_results(outputs, name=names, address=addresses, port=ports, type=sensor_types, state=states)
    ...
    return CommandResults(
        outputs_prefix="ForescoutEyeInspect.Sensor",
        outputs_key_field="id",
        outputs=outputs,
        readable_output=readable_output,
        raw_response=response,
...
def list_sensor_modules_command(client: Client, args: dict[str, str]) -> CommandResults:
    ...
    readable_output = tableToMarkdown(
        f"Sensor {sensor_id} Modules List:",
        outputs,
        removeNull=True,
    ...
    return CommandResults(
        outputs_prefix="ForescoutEyeInspect.SensorModule",
        outputs_key_field="id",
        outputs=outputs,
        readable_output=readable_output,
        raw_response=response,
...
def update_sensor_module_command(client: Client, args: dict[str, str]) -> CommandResults:
    ...
    response = client.update_sensor_module_request(
    ...
    readable_output = tableToMarkdown(
        f"Updated Module {module_id} of Sensor {sensor_id}:",
        response,
        removeNull=True,
...
def get_ip_blacklist_command(client: Client, args: dict[str, str]) -> CommandResults:
    ...
    readable_output = tableToMarkdown(
        f"IP Blacklist of Sensor {sensor_id}:",
        outputs,
        removeNull=True,
    ...
    return CommandResults(
        outputs_prefix="ForescoutEyeInspect.IPBlacklist",
...
def add_ip_blacklist_command(client: Client, args: dict[str, str]) -> CommandResults:
    ...
    readable_output = tableToMarkdown(
        f"New IP Blacklist Entry of Sensor {sensor_id}:",
        outputs,
        removeNull=True,
        headers=["address", "comment"],
        headerTransform=to_table_header,
...
def get_domain_blacklist_command(client: Client, args: dict[str, str]) -> CommandResults:
    ...
    readable_output = tableToMarkdown(
        f"Domain Blacklist of Sensor {sensor_id}:",
        outputs,
        removeNull=True,
    ...
    return CommandResults(
        outputs_prefix="ForescoutEyeInspect.DomainBlacklist",
...
def add_domain_blacklist_command(client: Client, args: dict[str, str]) -> CommandResults:
    ...
    client.add_domain_blacklist_request(
        sensor_id=sensor_id,  # type: ignore[arg-type]
    ...
    readable_output = tableToMarkdown(
        f"New Domain Blacklist Entry of Sensor {sensor_id}",
        outputs,
        removeNull=True,
        headers=["domain_name", "comment"],
        headerTransform=to_table_header,
...
def get_ssl_client_blacklist_command(client: Client, args: dict[str, str]) -> CommandResults:
    ...
    response = client.get_ssl_client_blacklist_request(
        sensor_id=sensor_id,  # type: ignore[arg-type]
        offset=offset,
        limit=limit,
    )
    ...
    readable_output = tableToMarkdown(
        f"SSL Client Applications Blacklist of Sensor {sensor_id}:",
        outputs,
        removeNull=True,
    ...
    return CommandResults(
        outputs_prefix="ForescoutEyeInspect.SSLClientBlacklist",
...
def add_ssl_client_blacklist_command(client: Client, args: dict[str, str]) -> CommandResults:
    ...
    client.add_ssl_client_blacklist_request(
        sensor_id=sensor_id,  # type: ignore[arg-type]
    ...
    readable_output = tableToMarkdown(
        f"New SSL Client Blacklist Entry of Sensor {sensor_id}:",
        outputs,
        removeNull=True,
        headers=["application_name", "ja3_hash", "comment"],
        headerTransform=to_table_header,
...
def get_file_operation_blacklist_command(client: Client, args: dict[str, str]) -> CommandResults:
    ...
    response = client.get_file_operation_blacklist_request(
        sensor_id=sensor_id,  # type: ignore[arg-type]
        offset=offset,
        limit=limit,
    )
    ...
    return CommandResults(
        outputs_prefix="ForescoutEyeInspect.FileOperationBlacklist",
...
def add_file_operation_blacklist_command(client: Client, args: dict[str, str]) -> CommandResults:
    ...
    client.add_file_operation_blacklist_request(
        sensor_id=sensor_id,  # type: ignore[arg-type]
    ...
    outputs = {"matching_type": matching_type, "file_or_folder": file_or_folder, "operation": operation, "comment": comment}
    readable_output = tableToMarkdown(
...
def get_diagnostics_information_command(client: Client, *_) -> CommandResults:
    ...
    return CommandResults(
        outputs_prefix="ForescoutEyeInspect.CCInfo",
...
def get_diagnostic_logs_command(client: Client, args: dict[str, str]) -> dict[str, Any]:
    ...
    return fileResult(filename="command_center_diagnostic_logs.zip", data=response, file_type=EntryType.ENTRY_INFO_FILE)
...
def create_group_policy_command(client: Client, args: dict[str, str]) -> CommandResults:
    ...
    response = client.create_group_policy_request(name=name, description=description, constraints=constraints)
    readable_output = tableToMarkdown(
    ...
    readable_output += tableToMarkdown(
        ...
        removeNull=True,
        headers=["type", "operator", "os_version", "firmware_version", "open_ports_tcp", "open_ports_udp"],
        headerTransform=to_table_header,
    )
...
def update_group_policy_command(client: Client, args: dict[str, str]) -> CommandResults:
    ...
    response = client.update_group_policy_request(
    ...
    readable_output = tableToMarkdown(
        "Updated Group Policy:", response, removeNull=True, headers=["id", "name", "description"], headerTransform=to_table_header
    )
...
def delete_group_policy_command(client: Client, args: dict[str, str]) -> CommandResults:
    ...
    return CommandResults(readable_output=f"## The group policy {policy_id} was successfully deleted!")
...
def assign_group_policy_hosts_command(client: Client, args: dict[str, str]) -> CommandResults:
    ...
    response = client.assign_group_policy_hosts_request(
        policy_id=policy_id,  # type: ignore[arg-type]
...
def unassign_group_policy_hosts_command(client: Client, args: dict[str, str]) -> CommandResults:
    ...
    response = client.unassign_group_policy_hosts_request(
        policy_id=policy_id,  # type: ignore[arg-type]
        filter_type=filter_type,
        filter_value=filter_value,
    )
...
def list_ip_reuse_domains_command(client: Client, args: dict[str, str]) -> CommandResults:
    ...
    return CommandResults(
        outputs_prefix="ForescoutEyeInspect.IPReuseDomain",
        outputs_key_field="id",
        outputs=outputs,
        readable_output=readable_output,
        raw_response=response,
...
def list_hosts_changelog_command(client: Client, args: dict[str, str]) -> CommandResults:
    ...
    response = client.list_hosts_changelog_request(
        offset=offset,
        limit=limit,
        host_id=host_id,
        start_timestamp=start_timestamp,
    ...
    return CommandResults(
        outputs_prefix="ForescoutEyeInspect.HostChangeLog",
        outputs_key_field="id",
        outputs=outputs,
        readable_output=readable_output,
        raw_response=response,
...
def test_module(client: Client, should_fetch: bool, first_fetch: str, max_fetch: int) -> str:
    ...
    try:
        ...
        if "Error in API call [401]" in str(e):
            return_error("The provided credentials are invalid. Please check you entered the right username and password.")
        else:
            raise
...
def fetch_alerts(client: Client, last_time: datetime, max_fetch: int, last_incident_id: int) -> List[dict[str, Any]]:
    """
    ...
    offset = 0
    while max_fetch > 0:
        results = client.list_alerts_request(
            offset=offset,  # type: ignore[union-attr,call-overload]
            limit=max_fetch,
            start_timestamp=last_time.isoformat(),
        )["results"]
        offset += len(results)
...
def fetch_incidents(client: Client, first_fetch: str, max_fetch: int) -> None:
    ...
    incidents = []
    for alert in alerts:
        incidents.append({"name": alert["event_type_names"][0], "occurred": alert["timestamp"], "rawJSON": json.dumps(alert)})
...
def main():
    ...
    try:
        ...
        if "Error in API call [401]" in str(e):
            return_error("You are not authorized to use Forescout EyeInspect. Please validate your username and password.")
