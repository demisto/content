...
The log forwarding of Siemens SiPass is configured using a [file collection](https://docs-cortex.paloaltonetworks.com/r/Cortex-XDR/Cortex-XDR-Documentation/Activate-the-Files-and-Folders-Collector).
