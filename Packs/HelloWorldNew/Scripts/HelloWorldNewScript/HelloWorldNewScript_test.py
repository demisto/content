"""HelloWorldNew Script for Cortex XSOAR - Unit Tests file

This file contains the Unit Tests for the HelloWorldNew Script based
...
demisto-sdk lint -d Packs/HelloWorldNew/Scripts/HelloWorldNewScript
...
Also please check the HelloWorldNew Integration Unit Tests file.

"""

from HelloWorldNewScript import say_hello, say_hello_command
