...
- Updated the Group-IB Threat Intelligence & Attribution Feed integration to %%UPDATE_CONTENT_ITEM_CHANGE_DESCRIPTION%%.
...
- Updated the Group-IB Threat Intelligence (mapper) mapper to %%UPDATE_CONTENT_ITEM_CHANGE_DESCRIPTION%%.
...
- Updated the GIB Compromised Events Table incident field to %%UPDATE_CONTENT_ITEM_CHANGE_DESCRIPTION%%.

##### GIB ID

- Updated the GIB ID incident field to %%UPDATE_CONTENT_ITEM_CHANGE_DESCRIPTION%%.

##### New: GIB TLP

- New: Added a new incident field- GIB TLP that %%UPDATE_CONTENT_ITEM_DESCRIPTION%%.
