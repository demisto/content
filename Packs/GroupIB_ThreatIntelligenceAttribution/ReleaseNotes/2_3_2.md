...
- Updated the GIB Scanner Sources incident field to %%UPDATE_CONTENT_ITEM_CHANGE_DESCRIPTION%%.

##### GIB Severity

- Updated the GIB Severity incident field to %%UPDATE_CONTENT_ITEM_CHANGE_DESCRIPTION%%.
...
- Updated the GIB Attacks Deface Layout layout to %%UPDATE_CONTENT_ITEM_CHANGE_DESCRIPTION%%.
