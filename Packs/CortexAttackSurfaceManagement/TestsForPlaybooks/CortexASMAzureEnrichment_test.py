...
def playbook_tasks_data():
    ...
    playbook_data = helper.load_yaml_file('./Packs/CortexAttackSurfaceManagement/Playbooks/Cortex_ASM_-_Azure_Enrichment.yml')
...
@pytest.mark.parametrize('asm_system_id_types', ["ASSET-ID", "ASSET-NAME", "ASSET-RG", "ASSET-SG", "ASSET-NIC"])
...
@pytest.mark.parametrize('grid_field_data', [({"gridfield": "asmsystemids", "val1": "ASSET-TYPE", "val2": "Azure Compute"})])
