...
def playbook_tasks_data():
    ...
    playbook_data = helper.load_yaml_file('./Packs/CortexAttackSurfaceManagement/Playbooks/Cortex_ASM_-_ServiceNow_CMDB_Enrichment.yml')
...
@pytest.mark.parametrize('asm_system_id_types', ["SNOW-CMDB-NIC", "SNOW-CMDB-Parent", "SNOW-CMDB-COMPANY", "SNOW-CMDB-ASSIGN"])
