...
[![Active Response in Cortex Xpanse](../../doc_files/Active_Response_in_Cortex_Xpanse.jpg/n)](https://www.youtube.com/watch?v=rryAQ23uuqw "Active Response in Cortex Xpanse")
...
![Cortex ASM - Active Directory Enrichment](../../doc_files/Cortex_ASM_-_Active_Directory_Enrichment.png/n)
...
![Cortex ASM - ASM Alert](../../doc_files/Cortex_ASM_-_ASM_Alert.png/n)

#### Cortex ASM - AWS Enrichment

A playbook that given the IP address enriches AWS information relevant to ASM alerts.

![Cortex ASM - AWS Enrichment](../../doc_files/Cortex_ASM_-_AWS_Enrichment.png/n)

#### Cortex ASM - Azure Enrichment

A playbook that given the IP address enriches Azure information relevant to ASM alerts.

![Cortex ASM - Azure Enrichment](../../doc_files/Cortex_ASM_-_Azure_Enrichment.png/n)

#### Cortex ASM - Certificate Enrichment

A playbook to enrich certificate information.

![Cortex ASM - Certificate Enrichment](../../doc_files/Cortex_ASM_-_Certificate_Enrichment.png/n)
...
![Cortex ASM - Cortex Endpoint Enrichment](../../doc_files/Cortex_ASM_-_Cortex_Endpoint_Enrichment.png/n)
...
![Cortex ASM - Cortex Endpoint Remediation](../../doc_files/Cortex_ASM_-_Cortex_Endpoint_Remediation.png/n)

#### Cortex ASM - Detect Service

A playbook that utilizes the Remediation Confirmation Scan service to check for mitigated vulnerabilities.

![Cortex ASM - Detect Service](../../doc_files/Cortex_ASM_-_Detect_Service.png/n)
...
![Cortex ASM - Email Notification](../../doc_files/Cortex_ASM_-_Email_Notification.png/n)

#### Cortex ASM - Enrichment

A playbook that is used as a container folder for all enrichments of ASM alerts.

![Cortex ASM - Enrichment](../../doc_files/Cortex_ASM_-_Enrichment.png/n)

#### Cortex ASM - GCP Enrichment

A playbook that given the IP address enriches GCP information relevant to ASM alerts.

![Cortex ASM - GCP Enrichment](../../doc_files/Cortex_ASM_-_GCP_Enrichment.png/n)
...
![Cortex ASM - Instant Message](../../doc_files/Cortex_ASM_-_Instant_Message.png/n)
...
![Cortex ASM - Jira Notification](../../doc_files/Cortex_ASM_-_Jira_Notification.png/n)
...
![Cortex ASM - On Prem Enrichment](../../doc_files/Cortex_ASM_-_On_Prem_Enrichment.png/n)
...
![Cortex ASM - On Prem Remediation](../../doc_files/Cortex_ASM_-_On_Prem_Remediation.png/n)
...
![Cortex ASM - Prisma Cloud Enrichment](../../doc_files/Cortex_ASM_-_Prisma_Cloud_Enrichment.png/n)

#### Cortex ASM - Qualys Enrichment

Playbook that given the IP address enriches Qualys information relevant to ASM alerts.

![Cortex ASM - Qualys Enrichment](../../doc_files/Cortex_ASM_-_Qualys_Enrichment.png/n)

#### Cortex ASM - Rapid7 Enrichment

A playbook that given the IP address enriches Rapid7 information relevant to ASM alerts.

![Cortex ASM - Rapid7 Enrichment](../../doc_files/Cortex_ASM_-_Rapid7_Enrichment.png/n)
...
![Cortex ASM - Remediation Confirmation Scan](../../doc_files/Cortex_ASM_-_Remediation_Confirmation_Scan.png/n)
...
![Cortex ASM - Remediation Guidance](../../doc_files/Cortex_ASM_-_Remediation_Guidance.png/n)
...
![Cortex ASM - Remediation Objectives](../../doc_files/Cortex_ASM_-_Remediation_Objectives.png/n)
...
![Cortex ASM - Remediation Path Rules](../../doc_files/Cortex_ASM_-_Remediation_Path_Rules.png/n)

#### Cortex ASM - Remediation

A playbook that is used as a container folder for all remediation of ASM alerts.

![Cortex ASM - Remediation](../../doc_files/Cortex_ASM_-_Remediation.png/n)

#### Cortex ASM - Service Ownership

Playbook that identifies and recommends the most likely owners of a given service.

![Cortex ASM - Remediation](../../doc_files/Cortex_ASM_-_Service_Ownership.png/n)
...
![Cortex ASM - ServiceNow ITSM Enrichment](../../doc_files/Cortex_ASM_-_ServiceNow_ITSM_Enrichment.png/n)
...
![Cortex ASM - ServiceNow Notification](../../doc_files/Cortex_ASM_-_ServiceNow_Notification.png/n)

#### Cortex ASM - Splunk Enrichment

A playbook that given the IP address enriches Splunk information relevant to ASM alerts.

![Cortex ASM - Splunk Enrichment](../../doc_files/Cortex_ASM_-_Splunk_Enrichment.png/n)

#### Cortex ASM - Tenable.io Enrichment

A playbook that given the IP address enriches Tenable.io information relevant to ASM alerts.

![Cortex ASM - Tenable.io Enrichment](../../doc_files/Cortex_ASM_-_Tenable_io_Enrichment.png/n)
...
![GenerateASMReport](../../doc_files/GenerateASMReport.png/n)
...
![InferWhetherServiceIsDev](../../doc_files/InferWhetherServiceIsDev.png/n)
...
![RemediationPathRuleEvaluation](../../doc_files/RemediationPathRuleEvaluation.png/n)
