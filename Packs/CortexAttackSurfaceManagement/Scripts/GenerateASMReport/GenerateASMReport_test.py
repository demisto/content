...
def test_service_format(mocker):
    ...
    result = service_format(
        {
            "service_type": "test",
            "service_name": "name",
            "first_observed": 1680850320000,
            "last_observed": 1683306120000,
            "domain": "acme.com",
            "details": {"tlsVersions": [{"tlsVersion": "1.2"}]},
        }
    )
    assert result == [
        {"Field": "Service Type", "Value": "test"},
        {"Field": "Service Name", "Value": "name"},
        {"Field": "Active Classifications", "Value": "n/a"},
        {"Field": "Business Units", "Value": "n/a"},
        {"Field": "Provider", "Value": "n/a"},
        {"Field": "IP Addresses", "Value": "n/a"},
        {"Field": "Port", "Value": "n/a"},
        {"Field": "Protocol", "Value": "n/a"},
        {"Field": "First Observed", "Value": "2023-04-07"},
        {"Field": "Last Observed", "Value": "2023-05-05"},
        {"Field": "Domains", "Value": "acme.com"},
        {"Field": "TLS", "Value": "1.2"},
    ]
    ...
    result = asset_format(
        {
            ...
            "details": {
                "ip_ranges": {"range": {"FIRST_IP": "1.1.1.1", "LAST_IP": "2.2.2.2", "EXPLAINERS": ["Associated with acme.com"]}}
            },
        }
    )
    assert result == [
        {"Field": "Asset Name", "Value": "name"},
        {"Field": "Business Units", "Value": "n/a"},
        {"Field": "Asset Type", "Value": "type"},
        {"Field": "Detected Services on Asset", "Value": "n/a"},
        {"Field": "IPs", "Value": "1.1.1.1"},
        {"Field": "Domains", "Value": "acme.com"},
        {"Field": "Associated IP Range", "Value": "1.1.1.1 - 2.2.2.2"},
        {"Field": "IP Range Attribution Details", "Value": "Associated with acme.com"},
        {"Field": "First Observed", "Value": "2023-04-07"},
        {"Field": "Last Observed", "Value": "2023-05-05"},
        {"Field": "Explainers", "Value": "this explains stuff"},
    ]
