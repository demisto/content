...
def build_template(args: Dict[str, Any]) -> List[Dict[str, Any]]:
    ...
    with open("/Users/mdagan/dev/demisto/content/Packs/CortexAttackSurfaceManagement/Scripts/GenerateASMReport/cortex_img.png", "rb") as file:
        # Read the binary data from the file
        cortex_img = file.read()
