...
URL_SUFFIX = {"FETCH_INCIDENTS": "get_incidents", "GET_COLUMN": "get_columns", "GET_COUNT": "get_count", "TEST_API": "test_api"}

CHECK_ARG_MOCK_DATA = {"test_int": 15, "test_str": "logsign", "test_list": [1, 2, 3], "test_dict": {"str": "unix"}}
    ...
    "incidents": [
        {
            ...
            "Details": {"Flags": "0x400000", "LogProfile": "Threat Alert", "ThreatID": "Virus/Win32.WGeneric.hjykm(3081002)"},
            ...
            "EventMap": {"Type": "Virus", "ID": 20503, "Context": "Security", "Info": "Virus Block", "SubType": "Block"},
            "External": {"IP": "228.x.249.122"},
            "Event": {
                "SystemID": 302991,
            ...
            "URL": {"Category": "any", "Domain": "po.sen260216kk.exe", "Scheme": "http"},
            "Internal": {"IP": "192.168.1.17"},
            "Action": {"Object": "192.168.1.17"},
            "Protocol": {"Name": "tcp"},
            "Severity": {"ID": 4, "Name": "warning"},
            "_es_type": "flow@alert@generic_log",
            "Session": {"ID": "48247132", "Direction": "client-to-server"},
            "Time": {"Received": "2021-04-21 14:05:01", "Generated": "2021-04-21 14:05:13"},
            "Rule": {"Name": "rule5"},
            "Alert": {
