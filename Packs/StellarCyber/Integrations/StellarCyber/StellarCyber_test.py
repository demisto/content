...
def test_fetch_incidents(client, requests_mock):
    ...
    requests_mock.get(
        f"{SERVER_URL}/connect/api/data/stellar-index-v1-ser-5593fbd8b0444b1eaef5a89589d788d2-64486c346020c889507f32ae-2024.03.07-000033/_search?q=_id:{test_alert_id}",
...
def test_get_modified_remote_data_command(client, requests_mock):
    args = {
        "lastUpdate": "2021-05-01T00:00:00"
    }
    mock_get_updated_cases = util_load_json(
        './test_data/outputs/get_new_incidents.json'
    )
    mock_token = {
        'data': {
            'access_token': 'example',
    ...
    assert results.modified_incident_ids == ['7443:6aeb2aae7d8d4ef0820136f42d107db4']


def test_get_remote_data_command(client, requests_mock):
    args = {
        "id": "7443:6aeb2aae7d8d4ef0820136f42d107db4",
        "lastUpdate": "2021-05-01T00:00:00"
    }
    mock_get_updated_case = util_load_json(
        './test_data/outputs/get_new_incidents.json'
    )
    mock_case_summary = util_load_json('./test_data/outputs/get_incident_summary.json')
    mock_response_get_alert = util_load_json('./test_data/outputs/get_alert.json')
    ...
    assert results.mirrored_object == mock_command_response
