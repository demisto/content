...
### Pack Contents
1. `ZeroNetworksSegmentEventCollector` integration - integrates with Zero Networks Segment API to fetch and process audit and network events.
2. Log Normalization - XDM mapping for key event types.
