...
In order to use the collector, please use the following option to collect events from the vendor (remove the irrelevant collectors from the list and also remove their sections):
