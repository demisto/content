...
```!azure-nsg-security-rule-delete security_group_name=alerts-nsg security_rule_name=wow```
...
```!azure-nsg-security-rule-create direction=Inbound security_group_name=alerts-nsg security_rule_name=rulerule source=1.1.1.1```
...
```!azure-nsg-security-rule-update security_group_name=alerts-nsg security_rule_name=XSOAR_Rule action=Allow description=description```
...
```!azure-nsg-security-rule-get security_group_name=alerts-nsg security_rule_name=wow```
