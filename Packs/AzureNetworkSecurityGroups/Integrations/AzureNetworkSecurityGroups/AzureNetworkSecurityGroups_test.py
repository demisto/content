...
def test_list_groups_command(mocker):
    ...
    results = list_groups_command(
        client, args={}, params={"subscription_id": "subscriptionID", "resource_group_name": "resourceGroupName"}
    )
...
def test_azure_nsg_public_ip_addresses_list(mocker):
    ...
    http_mock_request = mocker.patch.object(
        client, "http_request", return_value=util_load_json("test_data/list_public_ip_addresses.json")
    )
    results = azure_nsg_public_ip_addresses_list_command(
        client, args={}, params={"subscription_id": "subscriptionID", "resource_group_name": "resourceGroupName"}
    )
    http_mock_request.assert_called_with(
        "GET",
        full_url="https://management.azure.com/subscriptions/subscriptionID/resourceGroups/resourceGroupName/providers/Microsoft.Network/publicIPAddresses",
...
def test_azure_nsg_virtual_networks_list(mocker):
    ...
    client = mock_client(mocker)
    http_mock_request = mocker.patch.object(
        client, "http_request", return_value=util_load_json("test_data/list_virtual_networks.json")
    )
    results = azure_nsg_virtual_networks_list_command(
        client, args={}, params={"subscription_id": "subscriptionID", "resource_group_name": "resourceGroupName"}
    )
    http_mock_request.assert_called_with(
        "GET",
        full_url="https://management.azure.com/subscriptions/subscriptionID/resourceGroups/resourceGroupName/providers/Microsoft.Network/virtualNetworks",
        params={"api-version": "2024-05-01"},
    )
...
def test_azure_nsg_networks_interfaces_list(mocker):
    ...
    client = mock_client(mocker)
    http_mock_request = mocker.patch.object(
        client, "http_request", return_value=util_load_json("test_data/list_networks_interfaces.json")
    )
    results = azure_nsg_networks_interfaces_list_command(
        client, args={}, params={"subscription_id": "subscriptionID", "resource_group_name": "resourceGroupName"}
    )
    http_mock_request.assert_called_with(
        "GET",
        full_url="https://management.azure.com/subscriptions/subscriptionID/resourceGroups/resourceGroupName/providers/Microsoft.Network/networkInterfaces",
        params={"api-version": "2024-05-01"},
    )
    ...
    assert (
        res.get("virtualMachineId")
        == "/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Compute/\
virtualMachines/vm1"
    )
...
def test_create_azure_nsg_security_group(mocker):
    ...
    res = azure_nsg_security_group_create_command(
        client,
        args={"security_group_name": "securityGroup", "location": "westus"},
        params={"subscription_id": "subscriptionID", "resource_group_name": "resourceGroupName"},
    )
    http_mock_request.assert_called_with(
        "PUT",
        full_url="https://management.azure.com/subscriptions/subscriptionID/resourceGroups/resourceGroupName/providers/Microsoft.Network/networkSecurityGroups/securityGroup",
        params={"api-version": "2024-05-01"},
...
def test_create_azure_nsg_network_interfaces(mocker):
    ...
    client = mock_client(mocker)
    http_mock_request = mocker.patch.object(client, "http_request", return_value=util_load_json("test_data/put_data.json"))
    res = azure_nsg_network_interfaces_create_command(
        client,
        args={
            "nic_name": "nic_name",
            "location": "westus",
    ...
    http_mock_request.assert_called_with(
        "PUT",
        full_url="https://management.azure.com/subscriptions/subscriptionID/resourceGroups/resourceGroupName/providers/Microsoft.Network/networkInterfaces/nic_name",
        params={"api-version": "2024-05-01"},
        data=data,
    )
...
def test_create_rule_command(mocker):
    ...
    create_rule_command(
        ...
        args={
            ...
            "security_rule_name": "test_rule",
            "direction": "Inbound",
            "action": "Allow",
            "protocol": "Any",
            "source": "Any",
            "source_ports": "900-1000",
...
def test_list_rules_command(mocker):
    ...
    result = list_rules_command(
        client,
        args={"security_group_name": "groupName"},
        params={"subscription_id": "subscriptionID", "resource_group_name": "resourceGroupName"},
    )
...
def test_test_module_command_with_managed_identities(mocker, requests_mock, client_id):
    ...
    from AzureNetworkSecurityGroups import MANAGED_IDENTITIES_TOKEN_URL, Resources, main
...
def test_reformat_data():
    ...
    data = {"a": "b", "c": {"d": "e", "f": "g", "k": [{"1": "11", "2": "12"}, {"1": "13", "2": "14"}]}}

    excepted_data = {
        "a": "b",
        "c": {"d": "e", "f": "g", "k": [{"1": "11", "2": "12"}, {"1": "13", "2": "14"}]},
