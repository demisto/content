...
- Export secret value
- Execute a DSM Plugin with desired input
- Encrypt and Decrypt data using cryptographic keys

**_NOTE:_**  Only the secrets, keys, and plugins corresponding to the DSM Groups that the DSM Application is a member of will be accessible. Refer to documentation at [Fortanix DSM Support Portal](https://support.fortanix.com/)
