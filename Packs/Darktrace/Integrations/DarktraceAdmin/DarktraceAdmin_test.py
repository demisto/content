...
def test_get_similar_devices(requests_mock):
    ...
    requests_mock.get("https://mock.darktrace.com/similardevices?did=1&count=2", json=mock_api_response)
...
def test_get_external_endpoint_details(requests_mock):
    ...
    requests_mock.get(
        "https://mock.darktrace.com/endpointdetails?hostname=cats.com&additionalinfo=true&devices=true&score=true",
    ...
    args = {"endpointType": "hostname", "endpointValue": "cats.com", "additionalInfo": "true", "devices": "true", "score": "true"}
...
def test_run_advanced_search_analysis(requests_mock):
    ...
    requests_mock.get(
        "https://mock.darktrace.com/advancedsearch/api/analyze/@fields.source_ip/"
...
def test_post_to_watched_list(requests_mock):
    ...
    requests_mock.post("https://mock.darktrace.com/intelfeed", json=mock_api_response)

    client = Client(base_url="https://mock.darktrace.com", verify=False, auth=("examplepub", "examplepri"))

    # WHEN the specified device id is 1 and there are 2 results max desired
    args = {"endpointsToWatch": "8.8.8.8", "description": "Add the ip to watched domain list"}
...
def test_get_tagged_devices(requests_mock):
    ...
    requests_mock.get("https://mock.darktrace.com/tags/entities?tag=Admin&fulldevicedetails=true", json=mock_api_response)
...
def test_get_tags_for_device(requests_mock):
    ...
    requests_mock.get("https://mock.darktrace.com/tags/entities?did=1", json=mock_api_response)
...
def test_post_tag_to_device(requests_mock):
    ...
    requests_mock.post("https://mock.darktrace.com/tags/entities", json=mock_api_response)

    client = Client(base_url="https://mock.darktrace.com", verify=False, auth=("examplepub", "examplepri"))

    # WHEN the specified device id is 1 and there are 2 results max desired
    args = {"tagName": "Admin", "deviceId": 2}
