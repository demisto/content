...
def main() -> None:
    ...
    # Collect API tokens
    public_api_token = demisto.params().get('public_creds', {}).get('password') or demisto.params().get('public_api_token', '')
    private_api_token = demisto.params().get('private_creds', {}).get('password') or demisto.params().get('private_api_token', '')
