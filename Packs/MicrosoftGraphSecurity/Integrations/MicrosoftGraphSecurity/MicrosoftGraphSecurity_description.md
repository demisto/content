...
If you previously had an API V1 configured based on the credentials obtained from this method, please refer to the link above to gain new credentials with the relevant permissions.
