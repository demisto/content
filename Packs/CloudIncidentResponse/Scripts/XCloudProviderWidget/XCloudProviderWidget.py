...
COLORS = {"AWS": "ff0000", "GCP": "339966", "Azure": "0000ff"}
...
def get_cloudprovider_html_result():
    ...
    return {"ContentsFormat": EntryFormat.HTML, "Type": EntryType.NOTE, "Contents": html_result}
...
def main():
    try:
        ...
        return_error(f"Failed to execute CloudProviderWidget. Error: {ex!s}")
