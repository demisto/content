    ...
    try:
        ...
        if event_type == "AWS":
            results = CommandResults(
                ...
                outputs={
                    "arn": event_info[0],
                    "access_key_id": event_info[1],
                    "resource_name": event_info[2],
                    "source_ip": event_info[3],
                    "username": event_info[4],
                    "event_name": event_info[5],
        ...
        # Extract information from GCP event
            ...
            results = CommandResults(
                outputs_prefix="CloudIndicators",
                outputs={
                    "resource_name": event_info[0],
                    "source_ip": event_info[1],
                    "username": event_info[2],
                    "event_name": event_info[3],
                    "user_agent": event_info[4],
                },
            )
