...
3. Click **Add instance** to create and configure a new integration instance.
    ...
    | **Parameter** | **Required** |
    | --- | --- |
    | Server URL (e.g. https://defense.conferdeploy.net) | True |
...
| state | Workflow state to update. Possible values are: dismissed, open. | Optional | 
...
| status | The device status. Supports comma-separated values. Possible values are: PENDING, REGISTERED, UNINSTALLED, DEREGISTERED, ACTIVE, INACTIVE, ERROR, ALL, BYPASS_ON, BYPASS, QUARANTINE, SENSOR_OUTOFDATE, DELETED, LIVE. | Optional | 
...
| target_priority | Device target priority. Supports comma-separated values. Possible values are: LOW, MEDIUM, HIGH, MISSION_CRITICAL. | Optional | 
| limit | Maximum number of rows to return. Default is 20. | Optional | 
| sort_field | Sort Fields. Possible values are: target_priority, policy_name, name, last_contact_time, av_pack_version. | Optional | 
| sort_order | Sort Order for field. Possible values are: ASC, DESC. Default is DESC. | Optional | 
...
| **Argument Name** | **Description** | **Required** |
| --- | --- | --- |
| group_results | Whether to group results. Possible values are: true, false. Default is true. | Optional | 
...
| sort_field | Field by which to sort the results. Can be "first_event_time", or "last_event_time". Possible values are: first_event_time, last_event_time. Default is first_event_time. | Optional | 
...
| tags_enabled | Whether to enable watchlist tags. Can be "true" or "false". Possible values are: true, false. | Optional | 
| alerts_enabled | Enable watchlist alerts. Possible values are: true, false. | Optional | 
...
| expiration_seconds | The number of seconds to make the download URLs available for. Default is 300. | Optional | 
| download_to_xsoar | Download the file to XSOAR. Possible values are: true, false. Default is false. | Optional | 
...
| event_type | The event type to search. Possible values are: filemod, netconn, regmod, modload, crossproc, childproc. | Optional | 
| limit | The maximum number of rows to return. Default is 20. | Optional | 
| query | A free-style query. For example, "process_name:svchost.exe". | Optional | 
| start_time | First appearance time range (&lt;number&gt; &lt;time unit&gt;, e.g., 1 hour, 30 minutes). Default is 1 day ago. | Optional | 
| end_time | Last appearance time range (&lt;number&gt; &lt;time unit&gt;, e.g., 1 hour, 30 minutes). Default is current time. | Optional | 
