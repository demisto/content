...
class Client(BaseClient):
    ...
    def test_module_request(self):
        ...
        body = {
            "criteria": {"group_results": True, "minimum_severity": 3},
    ...
    def search_alerts_request(
        self,
        minimum_severity: None | int = None,
        create_time: None | dict = None,
        device_os_version: None | list = None,
        policy_id: None | list = None,
        alert_tag: None | list = None,
        alert_id: None | list = None,
        device_username: None | list = None,
        device_id: None | list = None,
        device_os: None | list = None,
        process_sha256: None | list = None,
        policy_name: None | list = None,
        reputation: None | list = None,
        alert_type: None | list = None,
        device_name: None | list = None,
        process_name: None | list = None,
        sort_field: None | str = None,
    ...
    def alert_workflow_update_request(
        self,
        alert_id: str,
        state: None | str = None,
        comment: None | str = None,
        determination: None | str = None,
        time_range: None | str = None,
        start: None | str = None,
        end: None | str = None,
        closure_reason: None | str = None,
    ) -> dict:
    ...
    def devices_list_request(
        self,
        device_id: None | list = None,
        status: None | list = None,
        device_os: None | list = None,
        last_contact_time: dict[str, str | None] | None = None,
        ad_group_id: None | list = None,
        policy_id: None | list = None,
        target_priority: None | list = None,
        limit: None | int = None,
        sort_field: None | str = None,
        sort_order: None | str = None,
    ) -> dict:
    ...
    def device_quarantine_request(self, device_id: None | list = None) -> None:
        ...
        body = {"action_type": "QUARANTINE", "device_id": device_id, "options": {"toggle": "ON"}}
    ...
    def device_unquarantine_request(self, device_id: None | list = None) -> None:
        ...
        body = {"action_type": "QUARANTINE", "device_id": device_id, "options": {"toggle": "OFF"}}
    ...
    def device_bypass_request(self, device_id: None | list = None) -> None:
        ...
        body = {"action_type": "BYPASS", "device_id": device_id, "options": {"toggle": "ON"}}
    ...
    def device_unbypass_request(self, device_id: None | list = None) -> None:
        ...
        body = {"action_type": "BYPASS", "device_id": device_id, "options": {"toggle": "OFF"}}
    ...
    def device_background_scan_request(self, device_id: None | list = None) -> None:
        ...
        body = {"action_type": "BACKGROUND_SCAN", "device_id": device_id, "options": {"toggle": "ON"}}
    ...
    def device_background_scan_request_stop(self, device_id: None | list = None) -> None:
        ...
        body = {"action_type": "BACKGROUND_SCAN", "device_id": device_id, "options": {"toggle": "OFF"}}
    ...
    def create_watchlist_request(
        self,
        watchlist_name: None | str = None,
        description: None | str = None,
        tags_enabled: None | bool = None,
        alerts_enabled: None | bool = None,
        report_ids: None | list = None,
        classifier: None | dict = None,
    ) -> dict:
        suffix_url = f"/threathunter/watchlistmgr/v3/orgs/{self.cb_org_key}/watchlists"
        body = assign_params(
            name=watchlist_name,
    ...
    def update_watchlist_request(
        self,
        watchlist_id: None | str = None,
        watchlist_name: None | str = None,
        description: None | str = None,
        tags_enabled: None | bool = None,
        alerts_enabled: None | bool = None,
    ...
    def create_report_request(
        ...
        body = assign_params(title=title, description=description, severity=severity, iocs=iocs, tags=tags, timestamp=timestamp)
        return self._http_request("POST", suffix_url, json_data=body)
    ...
    def get_file_request(self, sha256: None | list = None, expiration_seconds: None | int = None) -> dict:
        ...
        body = assign_params(sha256=sha256, expiration_seconds=expiration_seconds)
    ...
    def create_search_process_request(
        self,
        process_hash: str,
        process_name: str,
        event_id: str,
        ...
        body = assign_params(
            criteria=assign_params(process_hash=process_hash_list, process_name=process_name_list, event_id=[event_id]),
            query=query,
            rows=limit,
            start=start,
        )
        ...
        time_range = {"end": end_iso, "start": start_iso}
    ...
    def create_search_event_by_process_request(
        self,
        process_guid: str,
        event_type: str,
        query: str,
        ...
        body = assign_params(criteria=assign_params(event_type=argToList(event_type)), query=query, rows=limit, start=start)
        timestamp_format = "%Y-%m-%dT%H:%M:%S.%fZ"
        start_iso = parse_date_range(start_time, date_format=timestamp_format)[0]
        if end_time:
            end_iso = parse_date_range(end_time, date_format=timestamp_format)[0]
...
def alert_list_command(client: Client, args: dict) -> CommandResults | str:
    ...
    create_time = assign_params(start=args.get("start_time"), end=args.get("end_time"))
    ...
    result = client.search_alerts_request(
        minimum_severity,
        create_time,
        device_os_version,
        policy_id,
...
def alert_workflow_update_command_with_polling(args: dict, client: Client) -> PollResult:
    ...
    response = client.alert_workflow_update_get_request(request_id)
    ...
    if request_status == "CREATED":
        message = CommandResults(readable_output="Checking again in 60 seconds...")
        demisto.debug(f"{LOG_INIT} returning PollResult with continue_to_poll=True")
        return PollResult(
            partial_result=message, response=None, continue_to_poll=True, args_for_next_run={"request_id": request_id, **args}
        )
        ...
        message = CommandResults(
            ...
            readable_output=tableToMarkdown(
                f'Successfully updated the alert: "{alert_id}"',
                {
...
def list_devices_command(client: Client, args: dict) -> CommandResults | str:
    ...
    device_os = argToList(args.get("device_os"))
    last_contact_time = {"start": args.get("start_time"), "end": args.get("end_time")}
    if args.get("start_time") and not args.get("end_time"):
        last_contact_time = {"start": args.get("start_time"), "end": datetime.now().strftime("%Y-%m-%dT%H:%M:%S.000Z")}
    ...
    result = client.devices_list_request(
        device_id, status, device_os, last_contact_time, ad_group_id, policy_id, target_priority, limit, sort_field, sort_order
    )
    ...
    endpoint = Common.Endpoint(
        id=device.get("id"), os=device.get("os"), mac_address=device.get("mac_address"), os_version=device.get("os_version")
    )
...
def create_watchlist_command(client: Client, args: dict) -> CommandResults:
    ...
    classifier = assign_params(key=args.get("classifier_key"), value=args.get("classifier_value"))

    if classifier and report_ids:
        raise Exception("Please specify report or classifier but not both.")

    headers = ["Name", "ID", "Description", "Create_timestamp", "Tags_enabled", "Alerts_enabled", "Report_ids", "Classifier"]

    result = client.create_watchlist_request(watchlist_name, description, tags_enabled, alerts_enabled, report_ids, classifier)
    contents = {
        "Name": result.get("name"),
        "ID": result.get("id"),
        "Description": result.get("description"),
    ...
    readable_output = tableToMarkdown(
        f'The watchlist "{watchlist_name}" created successfully.', contents, headers, removeNull=True
    )
    results = CommandResults(
        outputs_prefix="CarbonBlackEEDR.Watchlist",
        outputs_key_field="ID",
...
def update_watchlist_command(client: Client, args: dict) -> CommandResults:
    ...
    result = client.update_watchlist_request(
        watchlist_id, watchlist_name, description, tags_enabled, alerts_enabled, report_ids, classifier
    )
    contents = {
        "Name": result.get("name"),
        "ID": result.get("id"),
    ...
    readable_output = tableToMarkdown(
        f'The watchlist "{watchlist_id}" was updated successfully.', contents, headers, removeNull=True
    )
    results = CommandResults(
        outputs_prefix="CarbonBlackEEDR.Watchlist",
        outputs_key_field="id",
...
def create_report_command(client: Client, args: dict) -> CommandResults:
    ...
    ioc_contents = []
    iocs = assign_params(ipv4=ipv4, ipv6=ipv6, dns=dns, md5=md5, query=ioc_query)
    headers = ["ID", "Title", "Timestamp", "Description", "Severity", "Link", "IOCs_v2", "Tags", "Visibility"]
...
def get_file_command(client: Client, args: dict) -> CommandResults:
    ...
    for file_ in found_files:
        contents.append({"sha256": file_.get("sha256"), "url": f"[{file_.get('url')}]({file_.get('url')})"})
...
def process_search_command_with_polling(args: dict, client: Client) -> PollResult:
    ...
    if not job_id:  # if this is the first time
        ...
        response = client.create_search_process_request(
            process_name=process_name,
        ...
        return PollResult(
            partial_result=CommandResults(readable_output=f"job_id is {response.get('job_id')}."),
            response=None,
            continue_to_poll=True,
    ...
    if status == "In Progress":
        message = CommandResults(readable_output=f"Checking again in {interval_in_seconds} seconds...")
        return PollResult(
            partial_result=message, response=None, continue_to_poll=True, args_for_next_run={"job_id": job_id, **args}
        )
        ...
        message = CommandResults(
            outputs_prefix="CarbonBlackEEDR.SearchProcess",
            outputs=output,
...
def process_search_command_without_polling(client: Client, args: dict) -> CommandResults:
    ...
    raw_respond = client.create_search_process_request(
        process_name=process_name,
        process_hash=process_hash,
        event_id=event_id,
        query=query,
...
def event_by_process_search_command(client: Client, args: dict) -> CommandResults:
    ...
    found_num_readable += (
        f"Showing items {start} - {min(start + limit - 1, result.get('num_found'))}." if result.get("num_found") else ""
    )
    readable += found_num_readable

    return CommandResults(
        outputs_prefix="CarbonBlackEEDR.SearchEvent",
        outputs=result.get("results"),
        outputs_key_field="event_guid",
        raw_response=result,
...
def add_threat_tags_command(client: Client, args: dict) -> CommandResults:
    ...
    outputs = {"ThreatID": threat_id, "Tags": result.get("tags")}
...
def add_threat_notes_command(client: Client, args: dict) -> CommandResults:
    ...
    outputs = {"ThreatID": threat_id, "Notes": notes}
...
def add_alert_notes_command(client: Client, args: dict) -> CommandResults:
    ...
    outputs = {"AlertID": alert_id, "Notes": notes}
...
def get_threat_tags_command(client: Client, args: dict) -> CommandResults:
    ...
    outputs = {"ThreatID": threat_id, "Tags": result.get("list")}
...
def main():
    ...
    try:
        client = Client(base_url=base_url, use_ssl=verify_certificate, use_proxy=proxy, token=token, cb_org_key=cb_org_key)
        ...
        if demisto.command() == "test-module":
            ...
            incidents, last_run = fetch_incidents(
                client, fetch_time, fetch_limit, last_run=check_get_last_run(demisto.getLastRun())
            )
