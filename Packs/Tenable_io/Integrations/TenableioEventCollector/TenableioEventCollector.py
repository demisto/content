...
def main() -> None:  # pragma: no cover
    ...
    try:
        ...
        if command == 'test-module':
            ...
            tmp = assets_last_run.get('tmp') or 0
            ...
            new_assets_last_run.update({"tmp": tmp + 1})
