...
<hr>
<p>Pause all scans inputted as an array. Comma separated values. Will work only if the scan status is 'Running'.
</p>
<h5>Base Command</h5>
...
<tr>
<td style="width: 230px;">scanId</td>
<td style="width: 344px;">The unique id of the scan. Comma separated values.</td>
<td style="width: 134px;">Required</td>
</tr>
</tbody>
</table>
