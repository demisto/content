...
MOCK_VULN_DETAILS = {
    "info": {
        "accepted_count": 0,
        "count": 1496,
        "description": ("The remote host answers to an ICMP timestamp request. This allows an attacker to know the date that is "
                        "set on the targeted machine, which may assist an unauthenticated, remote attacker in defeating"
                        "time based authentication protocols.\n\nTimestamps returned from machines running Windows Vista / 7 /"
                        "2008 / 2008 R2 are deliberately incorrect, but usually within 1000 seconds of the actual system time."),
        "discovery": {
