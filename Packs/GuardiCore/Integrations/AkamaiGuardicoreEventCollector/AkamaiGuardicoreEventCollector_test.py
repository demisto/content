...
from AkamaiGuardicoreEventCollector import Client
...
def test_login_valid_token(mocker: MockerFixture):
    ...
    mocker.patch.object(Client, "_is_access_token_valid", return_value=True)
    mocker.patch(
        "AkamaiGuardicoreEventCollector.get_integration_context",
...
def test_login_invalid_token(mocker: MockerFixture):
    ...
    client = MockClient
    client.generate_new_token = mocker.Mock()
    mocker.patch.object(Client, "_is_access_token_valid", return_value=False)
