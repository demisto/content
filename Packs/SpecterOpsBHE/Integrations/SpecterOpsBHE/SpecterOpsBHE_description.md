...
Configure a SpecterOpsBHE integration instance by providing following mandatory details:
- **(Required)** **(Required)** BloodHound Enterprise Domain (for example, https://example.bloodhoundenterprise.io)
- **(Required)** Token ID 
- **(Required)** Token Key
- Proxy URL
- Proxy URL username
