...
from test_data.test_variables import (
    NO_ARTICLE,
    NO_ARTICLE_RES,
    ONE_ARTICLE,
    ONE_ARTICLE_HTML,
    ONE_ARTICLE_HTML_RES,
    ONE_ARTICLE_NOT_PUBLISHED,
    ONE_ARTICLE_NOT_PUBLISHED_RES,
    ONE_ARTICLE_RES,
    ONE_ARTICLE_STRING,
    ONE_ARTICLE_STRING_FORMATTED,
    TWO_ARTICLES,
    TWO_ARTICLES_RES,
    TWO_ARTICLES_STRING,
)
...
@pytest.mark.parametrize(
    "parsed_response, limit, expected_result",
    [
...
@pytest.mark.parametrize(
    "data, is_version_ge_65, text_output",
    [
