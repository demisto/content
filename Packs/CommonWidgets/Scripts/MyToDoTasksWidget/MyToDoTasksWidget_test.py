...
import pytest
from MyToDoTasksWidget import get_clickable_incident_id, get_open_to_do_tasks_of_current_user
...
def test_open_to_do_tasks_of_current_user(mocker):
    ...
    mocker.patch.object(demisto, "internalHttpRequest", return_value={"statusCode": 200, "body": json.dumps(res_body)})
