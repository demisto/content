...
answers = {
    ...
    "08" : ["noneofyourbusiness.io"," noneofyourbusiness.io"],
    "09" : ["true positive"],
    "10" : ["keepcalmandstaysecure"],
    "11" : ["192.42.116.193"],
    "12" : ["ctf cloud use case"],
    "13" : ["hastalavistababy","hasta lavista baby","hasta la vista baby","hast alavi stababy"],
    "14" : ["4331"],
    "15" : ["detected"],
    "16" : ["xdr agent is not installed","xdr agent is not communicating with the xdr server"]
