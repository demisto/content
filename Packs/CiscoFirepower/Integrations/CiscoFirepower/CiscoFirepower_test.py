...
from CiscoFirepower import raw_response_to_context_network_groups, raw_response_to_context_policy_assignment, raw_response_to_context_access_policy
    ...
    (
        {
            ...
            "links": {
                "self": "https://10.8.49.215/api/fmc_config/v1/domai"
            },
            "metadata": {
                "domain": {
...
INPUT_TEST_RAW_RESPONSE_TO_CONTEXT_NETWORK_GROUPS = [({
            ...
            "links": {
                "self": "https://10.8.49.215/api/fmc_config/v1/domain/e276abec-e0f2-11e3"
            },
            "literals": [
                {
                    "type": "Network",
    ...
    (
        {
            ...
            "links": {
                "self": "https://10.8.49.215/api/fmc_config/v1/domain/e276abec-e0f2-11e3-8169-6d9ed49b625f"
            },
            "name": "BPS-Testing",
            "policy": {
                "id": "000C29A8-BA3B-0ed3-0000-124554069675",
    ...
    (
        {
            ...
            "id": "000C29A8-BA3B-0ed3-0000-124554069675",
            "links": {
                "self": "https://10.8.49.215/api/fmc_config/v1/domain/e276abec-e0f2-11e3-8169-6d9ed49b625f/policy"
            },
            "metadata": {
                "domain": {
                    "id": "e276abec-e0f2-11e3-8169-6d9ed49b625f",
...
INPUT_TEST_RAW_RESPONSE_TO_CONTEXT_RULS = [(
        ...
        },
        {
            ...
            'SourceZones': {'Objects': []},
            'Urls': {'Addresses': [{'URL': 'google.com'}, {'URL': 'google.co.il'}],
                  'Objects': []},
