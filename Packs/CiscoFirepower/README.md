...
To collect logs from Cisco Firepower, use the information described to configure the eStreamer service [here](https://www.cisco.com/c/en/us/td/docs/security/firepower/710/api/estreamer/EventStreamerIntegrationGuide.html) to configure log streaming to XSIAM in CEF format.
