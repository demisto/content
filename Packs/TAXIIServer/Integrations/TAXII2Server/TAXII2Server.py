...
#         if mitre_id := (xsoar_indicator.get('CustomFields') or {}).get('mitreid'):
...
#         stix_object, extension_definition, extensions_dict = create_extension_definition(object_type,
#                                                                                           extensions_dict, xsoar_type,
