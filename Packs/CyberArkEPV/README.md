...
MAYA TEST An example of an XSL file can be found [here](https://raw.githubusercontent.com/demisto/content/master/Packs/CyberArkEPV/doc_files/XSIAM.xsl). This file can be used directly within the target vault.
