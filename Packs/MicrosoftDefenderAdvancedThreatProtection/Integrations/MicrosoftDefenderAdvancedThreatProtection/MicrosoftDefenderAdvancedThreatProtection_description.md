...
This integration can use OAuth 2.0 and OpenID Connect standard-compliant authentication services to sign-in or delegate authentication. For more information, refer to the [Microsoft identity platform overview](https://learn.microsoft.com/en-us/entra/identity-platform/v2-overview).
