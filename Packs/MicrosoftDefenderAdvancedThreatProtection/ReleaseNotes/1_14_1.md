...
- This alert will trigger in an event where Malware detected by Microsoft Defender for Endpoints
...
If you wish to link this playbook to the relevant alerts automatically, we recommend using the following filters when configuring the playbook triggers: Alert Source = Correlation AND Alert Name = Malware detected by Microsoft Defender for Endpoint (Available from Cortex XSOAR 6.6.0).
