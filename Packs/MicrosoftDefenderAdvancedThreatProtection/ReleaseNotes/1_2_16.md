...
- Deprecated the following commands as they used a beta endpoint.
    ...
    - ***microsoft-atp-indicator-create-network*** command, use **microsoft-atp-sc-indicator-update** instead.
    - ***microsoft-atp-indicator-create-file*** command, use **microsoft-atp-sc-indicator-update** instead.
