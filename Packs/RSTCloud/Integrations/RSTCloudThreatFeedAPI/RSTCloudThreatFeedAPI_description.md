...
- Set the thresholds for IP, Domain, URL, Hash indicator types: below or equal a threshold means that an indicator will be marked as Suspicious, above means it will be marked as Malicious
