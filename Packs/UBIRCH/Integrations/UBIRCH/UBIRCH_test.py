...
def test_get_error_definition() -> None:
    ...
    """
    incident_auth_1000 = {"errorCode": "1000", "microservice": "niomon-auth"}
    ...
    incident_enricher_0000 = {"errorCode": "0000", "microservice": "niomon-enricher"}
    ...
    incident_unknown1 = {}
    incident_unknown2 = {"errorCode": "1000", "microservice": "niomon"}
    incident_unknown3 = {"errorCode": "5000", "microservice": "niomon-auth"}
