...
def test_get_zone_events_command(requests_mock, client_mock):
    requests_mock.get('https://api.example.bastille.cloud/detection/zones',
                      json=MOCK_ZONE_EVENTS_RESPONSE)
...
def test_get_device_events_command(requests_mock, client_mock):
    requests_mock.get('https://api.example.bastille.cloud/detection/devices',
                      json=MOCK_DEVICE_EVENTS_RESPONSE)
...
MOCK_ADD_DEVICE_TAG_RESPONSE = {
    'status': 'updated'
}


def test_set_device_tag_command(requests_mock, client_mock):
    requests_mock.post('https://api.example.bastille.cloud/admin/devices/action.addTag',
                       json=MOCK_ADD_DEVICE_TAG_RESPONSE)
    args = {
...
MOCK_REMOVE_DEVICE_TAG_RESPONSE = {
    'status': 'updated'
}
