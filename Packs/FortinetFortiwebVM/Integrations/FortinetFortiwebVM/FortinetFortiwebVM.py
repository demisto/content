...
def protected_hostname_group_create_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = generate_simple_command_results(object_type=OutputTitle.PROTECTED_HOSTNAME_GROUP.value,
                                                      object_name=name,
...
def protected_hostname_member_update_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    response = client.protected_hostname_member_update_request(group_name=group_name,
                                                               ...
                                                               ignore_port=args.get('ignore_port'),
                                                               include_subdomains=args.get('include_subdomains'))
    command_results = generate_simple_command_results(object_type=OutputTitle.PROTECTED_HOSTNAME_MEMBER.value,
...
def ip_list_group_create_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = generate_simple_command_results(object_type=OutputTitle.IP_LIST_GROUP.value,
...
def ip_list_member_update_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    response = client.ip_list_member_update_request(group_name=group_name,
                                                    ...
                                                    severity=severity,
                                                    trigger_policy=args.get('trigger_policy'))
    command_results = generate_simple_command_results(object_type=OutputTitle.IP_LIST_MEMBER.value,
                                                      object_name=member_id,
                                                      action=OutputTitle.UPDATED.value,
                                                      response=response)
    return command_results
...
def http_content_routing_member_update_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = generate_simple_command_results(object_type=OutputTitle.HTTP_CONTENT_ROUTING_MEMBER.value,
                                                      object_name=id,
                                                      action=OutputTitle.UPDATED.value,
                                                      response=response)
    return command_results
...
def geo_ip_group_create_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = generate_simple_command_results(object_type=OutputTitle.GEO_IP_GROUP.value,
                                                      object_name=name,
                                                      action=OutputTitle.CREATED.value,
                                                      response=response)
...
def geo_ip_member_delete_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = generate_simple_command_results(object_type=OutputTitle.GEO_IP_MEMBER.value,
                                                      object_name=member_id,
                                                      action=OutputTitle.DELETED.value,
                                                      response=response)
    return command_results
...
def server_policy_create_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = generate_simple_command_results(object_type=OutputTitle.SERVER_POLICY.value,
                                                      object_name=name,
                                                      action=OutputTitle.CREATED.value,
                                                      response=response)
...
def custom_whitelist_url_update_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    response = client.custom_whitelist_url_update_request(id=id,
                                                          ...
                                                          status=args.get('status'))
    command_results = generate_simple_command_results(object_type=OutputTitle.CUSTOM_WHITELIST_URL.value,
                                                      object_name=id,
                                                      action=OutputTitle.UPDATED.value,
                                                      response=response)
...
def custom_whitelist_parameter_update_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    response = client.custom_whitelist_parameter_update_request(id=id,
                                                                ...
                                                                domain_type=args.get('domain_type'),
                                                                domain=args.get('domain'))
    command_results = generate_simple_command_results(object_type=OutputTitle.CUSTOM_WHITELIST_PARAMETER.value,
                                                      object_name=id,
                                                      action=OutputTitle.UPDATED.value,
                                                      response=response)
...
def custom_whitelist_cookie_update_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    response = client.custom_whitelist_cookie_update_request(id=id,
                                                             ...
                                                             path=args.get('path'),
                                                             status=args.get('status'))
    command_results = generate_simple_command_results(object_type=OutputTitle.CUSTOM_WHITELIST_COOKIE.value,
                                                      object_name=id,
                                                      action=OutputTitle.UPDATED.value,
                                                      response=response)
...
def custom_whitelist_header_field_update_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = generate_simple_command_results(object_type=OutputTitle.CUSTOM_WHITELIST_HEADER_FIELD.value,
                                                      object_name=id,
                                                      action=OutputTitle.UPDATED.value,
                                                      response=response)
    return command_results
...
def custom_whitelist_delete_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = generate_simple_command_results(object_type=OutputTitle.CUSTOM_WHITELIST_MEMBER.value,
                                                      object_name=id,
                                                      action=OutputTitle.DELETED.value,
                                                      response=response)
    return command_results
...
def custom_predifined_whitelist_update_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = generate_simple_command_results(object_type=OutputTitle.CUSTOM_PREDIFINED.value,
                                                      object_name=id,
                                                      action=OutputTitle.UPDATED.value,
                                                      response=response)
    return command_results
...
def generate_simple_command_results(object_type: str, object_name: str, action: str,
                                    response: Dict[str, Any]) -> CommandResults:
