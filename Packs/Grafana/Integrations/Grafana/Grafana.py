...
class Client(BaseClient):
    ...
    def alerts_list_request(
        self,
        dashboard_id: Optional[List[str]] = None,
        panel_id: str = None,
        query: str = None,
        state: List[str] = None,
        limit: str = None,
        folder_id: List[str] = None,
        dashboard_query: str = None,
        dashboard_tag: List[str] = None,
    ):
    ...
    def user_update_request(self, user_id: str, email: str = None, name: str = None, login: str = None, theme: str = None):
    ...
    def user_add_to_team_request(self, team_id: str, user_id: str):
        ...
        response = self._http_request(
            "POST", f"api/teams/{team_id}/members", json_data=data, headers=self._headers, ok_codes=(200, 400)
        )
...
def parse_alerts(alerts: List[Dict[str, Any]], limit: int, last_fetch: datetime, last_id_fetched: int):
    ...
    alerts.sort(
        key=lambda alert: (
            dateparser.parse(alert["newStateDate"]).replace(tzinfo=utc),  # type: ignore
            alert["id"],
        )
    )
...
def alert_to_incident(alert: Dict[str, Any]):
    ...
    incident = {"name": alert["name"], "occurred": alert["newStateDate"], "rawJSON": json.dumps(alert), "type": alert["type"]}
    return incident
...
def alerts_list_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    responses = client.alerts_list_request(dashboard_id, panel_id, query, state, limit, folder_id, dashboard_query, dashboard_tag)
    ...
    command_results = CommandResults(
        ...
        readable_output=tableToMarkdown(
            "Existing Alerts:", responses, headers=headers, removeNull=True, headerTransform=pascalToSpace, url_keys=["url"]
        ),
    )
...
def alert_get_by_id_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        ...
        raw_response=response,
        readable_output=tableToMarkdown(
            f"Alert {alert_id} Results:", response, headers=headers, removeNull=True, headerTransform=pascalToSpace
        ),
    )
...
def users_search_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        ...
        + tableToMarkdown(
            "Existing Users:", response, headers=headers, removeNull=True, headerTransform=pascalToSpace, url_keys=["avatarUrl"]
        ),
    )
...
def users_organization_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        ...
        raw_response=response,
        readable_output=tableToMarkdown(
            f"Organizations For User {user_id}:", response, removeNull=True, headerTransform=pascalToSpace
        ),
    )
...
def user_update_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        readable_output=tableToMarkdown(
            f"Successfully Updated User {user_id}:", response, removeNull=True, headerTransform=pascalToSpace
        )
    )
...
def annotation_create_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        ...
        raw_response=response,
        readable_output=tableToMarkdown(
            f'Successfully Created Annotation {response["id"]}:', response, removeNull=True, headerTransform=pascalToSpace
        ),
    )
...
def user_add_to_team_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        readable_output=tableToMarkdown(
            f"Successfully Added User {user_id} to Team {team_id}:", response, removeNull=True, headerTransform=pascalToSpace
        )
    )
...
def user_remove_from_team_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        readable_output=tableToMarkdown(
            f"Successfully Removed User {user_id} from Team {team_id}:", response, removeNull=True, headerTransform=pascalToSpace
        )
    )
...
def team_add_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        ...
        raw_response=response,
        readable_output=tableToMarkdown(
            f'Successfully Created Team {response["teamId"]}:', response, removeNull=True, headerTransform=pascalToSpace
        ),
    )
...
def team_delete_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        readable_output=tableToMarkdown(
            f"Successfully Deleted Team {team_id}:", response, removeNull=True, headerTransform=pascalToSpace
        )
    )
...
def org_create_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        ...
        raw_response=response,
        readable_output=tableToMarkdown(
            f'Successfully Created Organization {response["orgId"]}:', response, removeNull=True, headerTransform=pascalToSpace
        ),
    )
...
def org_get_by_name_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        ...
        raw_response=response,
        readable_output=tableToMarkdown(
            f'Organization "{name}" Results:', response, headers=headers, removeNull=True, headerTransform=pascalToSpace
        ),
    )
...
def org_get_by_id_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        ...
        raw_response=response,
        readable_output=tableToMarkdown(
            f"Organization {org_id} Results:", response, headers=headers, removeNull=True, headerTransform=pascalToSpace
        ),
    )
...
def dashboards_search_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        ...
        + tableToMarkdown(
            "Existing Dashboards:", response, headers=headers, removeNull=True, headerTransform=pascalToSpace, url_keys=["url"]
        ),
    )
...
def test_module(client: Client, params: dict) -> None:
    ...
    try:
        ...
        if params["isFetch"]:
            ...
            client.alerts_list_request(
                dashboard_id=argToList(params.get("dashboard_id")),
                panel_id=params.get("panel_id"),
                query=params.get("alert_name"),
...
def fetch_incidents(
    ...
    alert_name: str = None,
    state: str = None,
    limit: Optional[int] = MAX_INCIDENTS_TO_FETCH,
) -> List[dict]:
    ...
    alerts = client.alerts_list_request(
        dashboard_id=argToList(dashboard_id), panel_id=panel_id, query=alert_name, state=argToList(state)
    )
