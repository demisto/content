...
FILE_INSTANCE_RESPONSE = util_load_json(os.path.dirname(__file__) + '/test_data/file_instance_data.json')
DOMAIN_INSTANCE_RESPONSE = util_load_json(os.path.dirname(__file__) + '/test_data/domain_instance_data.json')
ENDPOINT_INSTANCE_RESPONSE = util_load_json(os.path.dirname(__file__) + '/test_data/endpoint_instance.json')
ENDPOINT_FILE_ASSOCIATION_RESPONSE = util_load_json(os.path.dirname(__file__) + '/test_data/endpoint_file_association.json')
DOMAIN_FILE_ASSOCIATION_RESPONSE = util_load_json(os.path.dirname(__file__) + '/test_data/domain_file_association.json')
ENDPOINT_DOMAIN_ASSOCIATION_RESPONSE = util_load_json(os.path.dirname(__file__) + '/test_data/endpoint_domain_association.json')
DENY_LIST_RESPONSE = util_load_json(os.path.dirname(__file__) + '/test_data/deny_list.json')
ALLOW_LIST_RESPONSE = util_load_json(os.path.dirname(__file__) + '/test_data/deny_list.json')
EVENT_LIST_RESPONSE = util_load_json(os.path.dirname(__file__) + '/test_data/event_list_data.json')
EVENT_8001_DATA = util_load_json(os.path.dirname(__file__) + '/test_data/event_typeid_8001_data.json')
EVENT_8007_DATA = util_load_json(os.path.dirname(__file__) + '/test_data/event_typeid_8007_data.json')
EVENT_8015_DATA = util_load_json(os.path.dirname(__file__) + '/test_data/event_typeid_8015_data.json')
AUDIT_EVENT_RESPONSE = util_load_json(os.path.dirname(__file__) + '/test_data/audit_event_data.json')
SYSTEM_ACTIVITY_RESPONSE = util_load_json(os.path.dirname(__file__) + '/test_data/system_activity.json')
INCIDENT_LIST_RESPONSE = util_load_json(os.path.dirname(__file__) + '/test_data/incident_list_data.json')
INCIDENT_COMMENT_RESPONSE = util_load_json(os.path.dirname(__file__) + '/test_data/incident_comment_data.json')
INCIDENT_EVENT_FOR_INCIDENT = util_load_json(os.path.dirname(__file__) + '/test_data/incident_event_data.json')
ENDPOINT_COMMAND_STATUS = util_load_json(os.path.dirname(__file__) + '/test_data/endpoint_command_status.json')
ENDPOINT_COMMAND_ISOLATE = util_load_json(os.path.dirname(__file__) + '/test_data/endpoint_command_isolate_endpoint.json')
ENDPOINT_COMMAND_REJOIN = util_load_json(os.path.dirname(__file__) + '/test_data/endpoint_command_rejoin.json')
ENDPOINT_COMMAND_CANCEL = util_load_json(os.path.dirname(__file__) + '/test_data/endpoint_command_cancel.json')
ENDPOINT_COMMAND_DELETE = util_load_json(os.path.dirname(__file__) + '/test_data/endpoint_command_delete_endpoint_file.json')
HEADER_LIST = util_load_json(os.path.dirname(__file__) + '/test_data/header_list.json')
SANDBOX_ISSUE_COMMAND = util_load_json(os.path.dirname(__file__) + '/test_data/sandbox_issue_command.json')
SANDBOX_STATUS_COMMAND = util_load_json(os.path.dirname(__file__) + '/test_data/sandbox_status_command.json')
SANDBOX_VERDICT_COMMAND = util_load_json(os.path.dirname(__file__) + '/test_data/sandbox_verdict_command.json')
