    ...
    mock_responses = [
        {
            "url": args[0] + args[1],
            "status_code": args[2],
            "resp": {"meta": {"error": args[3], "error_data": args[4], "paging": False, "history": False}, "payload": args[1]},
        }
    ]
    ...
    mock_responses = [
        {
            ...
            "status_code": args[1],
            "resp": {
                "meta": {"error": args[2], "error_data": args[3], "paging": False, "history": False},
...
def mock_requests_get(*args):
    ...
    if args[0] == "https://probe-1/vision2/data/files":
        if args[2] == 1:
            return MockResponse(
                {
                    "meta": {"error": False, "error_data": None, "paging": False, "history": False},
                    "payload": [
                        {
                            "id": "18360fb0-72f7-442a-9e9c-fb1be462e037",
                            "user": "admin",
                            "name": "Main",
                            "probeName": "probe1",
                            "probeSerialNumber": "NNG0123456789",
                            "type": "rotation_file_v2",
                            "size": "2.00TB",
                            "usage": "1.82TB",
                            "visionEnabled": True,
                            "status": {"inUse": False},
            ...
            return MockResponse(
                {"meta": {"error": "Error", "error_data": None, "paging": False, "history": False}, "payload": []}, args[1]
            )
        ...
        return MockResponse(
            {
                ...
                "payload": [
                    ...
                    {
                        "id": "698a82fc-e954-c5f7-f691-19afe609bb18",
                        "type": "rotation_file_v2",
                        "name": "Main",
                        "probeName": "probe1",
                        "vision": True,
                        "status": {"inUse": True},
                        "tags": ["all", "rotation-file"],
                    },
                ],
            },
            args[1],
            ...
            return MockResponse(
                {
                    ...
                    "payload": {
                        "state": "complete",
                        "progress": 100,
                        "data": [{"id": "18360fb0-72f7-442a-9e9c-fb1be462e037", "name": "probe-1:Main"}],
...
@pytest.mark.parametrize("arg", ["http://probe-1.test.com", "http://probe-1", "http://10.0.0.1", "https://probe-1"])
...
@pytest.mark.parametrize(
    ...
    [
        ...
        },
        {
            ...
            "end": "",
            "search_window": "3600",
            "src_host_list": "a.b.c.d",
            "dest_host_list": "",
            "src_port_list": "",
            "dest_port_list": "",
        },
        {
            "start": "2020-03-23T18:31:25+000",
            "end": "",
            "search_window": "3600",
            "src_host_list": "a.b.c.d",
            "dest_host_list": "",
        ...
        {
            "start": "2020-03-23T18:31:25",
            "end": "2020-03-23T18:32:25",
            "search_window": "3600",
            "src_host_list": "",
            "dest_host_list": "",
            "src_port_list": "",
...
@pytest.mark.parametrize(
    "args", [{"jobid": "18360fb0"}, {"jobid": "18360fb0-72f7-442a-9e9c"}, {"jobid": " 18360fb0-72f7-442a-9e9cfb1be462e037"}]
)
...
class TestEndaceAPPSearch:
    ...
    search_args = {
        "start": "2020-02-28T16:15:02",
        "end": "2020-02-28T16:16:02",
        "timeframe": "1h",
        "src_host_list": "a.b.c.3,a.b.c.4,a.b.c.5",
        "dest_host_list": "",
        "src_port_list": "",
        "dest_port_list": "",
        "protocol": "",
    ...
    @pytest.mark.parametrize(
        "input_var, expected",
        [(("https://probe-1/vision2/data/files", 200, 1), ("NoError", "18360fb0-72f7-442a-9e9c-fb1be462e037", "Started"))],
    )
    def test_endace_create_search_command_files(self, input_var, expected, monkeypatch):
        ...
        def mock_post(*args, **kwargs):
            return mocked_requests_post(
                "https://probe-1/vision2/data/queries/", "18360fb0-72f7-442a-9e9c-fb1be462e037", 200, False, None
            )
    ...
    @pytest.mark.parametrize(
        "input_var, expected",
        [(("18360fb0-72f7-442a-9e9c-fb1be462e037", 200), ("NoError", "18360fb0-72f7-442a-9e9c-fb1be462e037", "Deleted"))],
    )
    def test_endace_delete_search_task_command(self, input_var, expected, monkeypatch):
        ...
        def mock_delete(*args):
            return mocked_requests_delete(f"https://probe-1/vision2/data/queries/{input_var[0]}", input_var[1], False, None)
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                ...
                ("NoError", "18360fb0-72f7-442a-9e9c-fb1be462e037", "complete", "100", ["probe-1:Main"], 10000),
            )
        ],
    )
    def test_endace_get_search_status_command(self, input_var, expected, monkeypatch):
        ...
        def mock_get_queries(*args):
            return mock_requests_get(f"https://probe-1/vision2/data/queries/{input_var[0]}", input_var[1], input_var[3])
...
class TestEndaceAPPArchive:
    ...
    search_args = {
        ...
        "end": "2020-02-28T16:16:02",
        "timeframe": "1h",
        "src_host_list": "a.b.c.3,a.b.c.4",
        "dest_host_list": "",
        "src_port_list": "",
        "dest_port_list": "",
        "protocol": "",
        "archive_filename": "eventid_1234567890",
    }
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                ("https://probe-1/vision2/data/archive/", "18360fb0-72f7-442a-9e9c-fb1be462e037", 200, False, None),
    ...
    @pytest.mark.parametrize(
        "input_var, expected",
        [
            (("archived_1234567890", 200, 1, 1), ("NoError", "archived_1234567890", "Finished")),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (("18360fb0-72f7-442a-9e9c-fb1be462e037", 200, False, False, "archived", 1), ("NoError", "archived", "FileNotFound")),
            (("18360fb0-72f7-442a-9e9c-fb1be462e037", 200, None, False, "archived", 3), ("NoError", "archived", "FileNotFound")),
            (
...
class TestEndaceAppDownload:
    ...
    @pytest.mark.parametrize(
        "input_var, expected",
        {(("archived_1234567890", 1, "28.61MB", "1"), ("NoError", 0, "FileExceedsSizeLimit", "archived_1234567890", "admin"))},
    )
    def test_endace_download_pcap_command(self, input_var, expected, monkeypatch):
        ...
        _, output, _ = Endace.endace_download_pcap_command(app, {"filename": input_var[0], "filesizelimit": input_var[3]})
