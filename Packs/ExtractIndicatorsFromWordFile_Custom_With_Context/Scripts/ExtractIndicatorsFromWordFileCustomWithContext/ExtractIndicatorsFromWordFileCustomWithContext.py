...
register_module_line('ExtractIndicatorsFromWordFile', 'start', __line__())
...
def main():
    ...
    """
    res = demisto.executeCommand("extractIndicators", {'text': parser.all_data})[0]
    indicators_hr = res[u'Contents']
    indicators_ctx = res['EntryContext']
    print(res['EntryContext'])
...
register_module_line('ExtractIndicatorsFromWordFile', 'end', __line__())
