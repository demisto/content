...
UTM_PIVOT = "?pivot=Vectra-XSOAR-1.0.11"  # temp replacement for the get_pack_version()
...
def get_detections_list_hr(detections) -> CommandResults:
    ...
    human_readable = tableToMarkdown(
        "",
        hr_dict,
        ["ID", "Detection Type", "Category", "Src IP", "Number Of Events", "State", "Tags", "Last Timestamp"],
        removeNull=True,
    )
