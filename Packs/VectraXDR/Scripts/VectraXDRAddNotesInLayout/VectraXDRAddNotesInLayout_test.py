...
def test_vectra_xdr_add_notes_with_notes(mocker):
    ...
    notes_response = [
        {"id": 328, "date_created": "2023-07-27T05:46:26Z", "date_modified": "2023-07-27T05:47:06Z",
         "created_by": "api_client", "modified_by": "api_client", "note": "check_1"},
        {"id": 328, "date_created": "2023-07-27T05:46:26Z", "date_modified": "2023-07-27T05:47:06Z",
         "created_by": "api_client", "modified_by": "api_client", "note": "check_2"}
    ]
    mocker.patch.object(demisto, 'incident', return_value={
        'CustomFields': {
            'vectraxdrentitynotes': [json.dumps(note) for note in notes_response]
        }
    })
