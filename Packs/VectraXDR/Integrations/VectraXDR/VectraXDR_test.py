...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"entity_id": "1", "entity_type": "account", "page": "0"}, ERRORS["INVALID_INTEGER_VALUE"].format("page")),
        ({"entity_id": "1", "entity_type": "account", "page_size": "0"}, ERRORS["INVALID_INTEGER_VALUE"].format("page_size")),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"detection_ids": ",12,", "page": "0"}, ERRORS["INVALID_INTEGER_VALUE"].format("page")),
        ({"detection_ids": ",12,", "page_size": "0"}, ERRORS["INVALID_INTEGER_VALUE"].format("page_size")),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"entity_id": "0", "entity_type": "account", "note": "test_note"}, ERRORS["INVALID_INTEGER_VALUE"].format("entity_id")),
        ({"entity_id": "-1", "entity_type": "account", "note": "test_note"}, ERRORS["INVALID_INTEGER_VALUE"].format("entity_id")),
        (
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"entity_type": "account"}, ERRORS["REQUIRED_ARGUMENT"].format("entity_id")),
        ({"entity_id": "0", "entity_type": "account", "tags": " , tag1"}, ERRORS["INVALID_INTEGER_VALUE"].format("entity_id")),
        ({"entity_id": "-1", "entity_type": "account", "tags": "tag1"}, ERRORS["INVALID_INTEGER_VALUE"].format("entity_id")),
        ({"entity_id": "1.5", "entity_type": "account", "tags": "tag1"}, ERRORS["INVALID_INTEGER_VALUE"].format("entity_id")),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"entity_id": "1", "entity_type": "account", "tags": " , "}, ERRORS["REQUIRED_ARGUMENT"].format("tags")),
        ({"entity_type": "account"}, ERRORS["REQUIRED_ARGUMENT"].format("entity_id")),
        ({"entity_id": "0", "entity_type": "account"}, ERRORS["INVALID_INTEGER_VALUE"].format("entity_id")),
        ({"entity_id": "-1", "entity_type": "account"}, ERRORS["INVALID_INTEGER_VALUE"].format("entity_id")),
        ({"entity_id": "1.5", "entity_type": "account"}, ERRORS["INVALID_INTEGER_VALUE"].format("entity_id")),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"entity_id": "1", "entity_type": "account", "user_id": "0"}, ERRORS["INVALID_INTEGER_VALUE"].format("user_id")),
        ({"entity_id": "1", "entity_type": "account", "user_id": "-1"}, ERRORS["INVALID_INTEGER_VALUE"].format("user_id")),
        ({"entity_id": "1", "entity_type": "account", "user_id": "1.5"}, ERRORS["INVALID_INTEGER_VALUE"].format("user_id")),
        (
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"assignment_id": "0", "user_id": "2"}, ERRORS["INVALID_INTEGER_VALUE"].format("assignment_id")),
        ({"assignment_id": "-1", "user_id": "2"}, ERRORS["INVALID_INTEGER_VALUE"].format("assignment_id")),
        ({"assignment_id": "1.5", "user_id": "2"}, ERRORS["INVALID_INTEGER_VALUE"].format("assignment_id")),
        ({"user_id": "0", "assignment_id": "2"}, ERRORS["INVALID_INTEGER_VALUE"].format("user_id")),
        ({"user_id": "-1", "assignment_id": "2"}, ERRORS["INVALID_INTEGER_VALUE"].format("user_id")),
        ({"user_id": "1.5", "assignment_id": "2"}, ERRORS["INVALID_INTEGER_VALUE"].format("user_id")),
    ],
)
...
def test_vectra_entity_assignment_resolve_valid_arguments(requests_mock, client):
    ...
    requests_mock.put(BASE_URL + ENDPOINTS["RESOLVE_ASSIGNMENT_ENDPOINT"].format(args.get("assignment_id")), json=assignment_res)
    # Call the function
        ...
        (
            ...
            ERRORS["INVALID_OUTCOME"].format(
                ", ".join(
                    [
                        item["title"]
                        for item in util_load_json(f"{TEST_DATA_DIR}/entity_assignment_outcome_list_response.json").get("results")
                    ]
                )
            ),
        ),
...
def test_vectra_entity_detections_mark_fixed_valid_arguments(requests_mock, client):
    ...
    with open(f"{TEST_DATA_DIR}/mark_entity_detections_fixed_hr.md") as f:
        result_hr = f.read()
    args = {"entity_id": "334", "entity_type": "account"}
...
def test_vectra_entity_detections_mark_fixed_with_no_detections(requests_mock, client):
    ...
    """
    response = util_load_json(f"{TEST_DATA_DIR}/mark_or_unmark_detections_fixed_response.json")
    args = {"entity_id": "1", "entity_type": "account"}
    requests_mock.get(
...
@pytest.mark.parametrize(
    "args,error_msg",
    [
        ({"entity_id": "", "entity_type": "account"}, ERRORS["REQUIRED_ARGUMENT"].format("entity_id")),
        (
            {"entity_id": "1", "entity_type": "invalid_type"},
            ERRORS["INVALID_COMMAND_ARG_VALUE"].format("entity_type", ", ".join(VALID_ENTITY_TYPE)),
        ),
...
@pytest.mark.parametrize(
    "args,error_msg",
    [
        ({"page": "1", "page_size": "-1"}, ERRORS["INVALID_INTEGER_VALUE"].format("page_size")),
        ({"page": "1.5", "page_size": "2"}, ERRORS["INVALID_INTEGER_VALUE"].format("page")),
    ],
)
...
def test_get_remote_data_command_entity_needs_update(capfd, client, mocker):
    ...
    mocker.patch(
        "VectraXDR.VectraClient.get_entity_request",
        return_value={
            "id": 1,
            "type": "host",
            "detection_set": ["1"],
    ...
    mocker.patch(
        "demistomock.params",
        return_value={
            "urgency_score_low_threshold": "test",
    ...
    mocker.patch(
        "VectraXDR.VectraClient.get_entity_request",
        return_value={"id": 1, "type": "account", "urgency_score": 90, "last_modified_timestamp": "2023-09-20T09:00:00+00:00"},
    )
...
def test_get_remote_data_command_entity_needs_update_notes(client, mocker):
    ...
    mocker.patch(
        ...
        return_value={
            "id": 1,
            "type": "host",
            "last_modified_timestamp": "2023-09-20T19:00:00+00:00",
            "urgency_score": 90,
