...
3. Click **Add instance** to create and configure a new integration instance.
    ...
    | Reopen closed incidents via mirroring | If selected, it reopens previously closed incidents. If not selected, new incidents will be created.<br/><br/>Note: This flow is triggered only when the relevant entity is still active and the previously fetched incident is closed. | False |
