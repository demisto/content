...
***
Waits until EC2 instances are in the 'stopped' state. Checks every waiter_delay arg value seconds until a successful state is reached (default max waiter_max_attempts arg value  attempts).
