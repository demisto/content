...
- Added support for the **aws-ec2-snapshot-completed-waiter** command, a waiter function that waits until a snapshot is complete.- Added support for **aws-lambda-function-create** command that creates a lambda function. to create a function, you need a deployment package and an execution role.
