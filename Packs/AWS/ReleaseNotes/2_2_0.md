...
- Added support for **aws-s3-bucket-enable-bucket-access-logging-quick-action**, which enables server access logging for the S3 bucket.
...
- Added support for **aws-ec2-image-attribute-set-ami-to-private-quick-action**, which revokes public launch permissions for the EC2 AMI.
...
- Added support for **aws-rds-db-cluster-enable-deletion-protection-quick-action**, which enables deletion protection for the RDS DB cluster to prevent accidental deletion.
...
- Added support for **aws-rds-db-instance-modify-enable-automatic-backup-quick-action**, which enables the automatic backup settings for the RDS DB instance with a default retention period of 30 days.
...
- Added support for **aws-rds-db-instance-enable-multi-az-quick-action**, which enables Multi-AZ deployment for the RDS database instance to enhance availability and durability.
