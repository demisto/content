...
- Added support for the **aws-ec2-snapshots-describe** command to describe specified EBS snapshots or all EBS snapshots available to you.to describes the specified EBS snapshots available to you or all of the EBS snapshots available to you.
