...
- Added support for the **aws-ec2-snapshots-describe** to describes the specified EBS snapshots available to you or all of the EBS snapshots available to you.
- Added support for the **aws-ec2-snapshot-delete** to deletes the specified EBS snapshot.
- Added support for the **aws-ec2-snapshot-copy** to copies a point-in-time snapshot of an EBS volume and stores it in Amazon S3.
- Added support for the **aws-ec2-snapshot-completed-waiter** which is a waiter function that waits until the snapshot is complete.