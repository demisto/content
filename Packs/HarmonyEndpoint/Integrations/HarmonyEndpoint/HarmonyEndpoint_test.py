...
@pytest.fixture()
def mock_client() -> HarmonyEndpoint.Client:
    """
...
def test_job_status_get_command(
    requests_mock,
    mock_client: HarmonyEndpoint.Client,
    ...
    command_results = HarmonyEndpoint.job_status_get_command(command_args, mock_client)

    assert command_results.raw_response == mock_response
    assert command_results.outputs == mock_response
    assert command_results.outputs_prefix == "Harmony.Job"
...
def test_ioc_list_command(
    ...
    command_results = HarmonyEndpoint.ioc_list_command(command_args, mock_client)

    assert command_results.raw_response == mock_response
    assert command_results.outputs == mock_response["content"]
    assert command_results.outputs_prefix == "Harmony.IOC"
    assert command_results.outputs_key_field == "id"
...
def test_ioc_update_command(
    ...
    command_results = HarmonyEndpoint.ioc_update_command(command_args, mock_client)
...
def test_ioc_create_command(
    ...
    command_results = HarmonyEndpoint.ioc_create_command(
        {"type": "Domain", "value": "example.com", "comment": "Suspicious domain"}, mock_client
    )
...
def test_ioc_delete_command(
    ...
    command_results = HarmonyEndpoint.ioc_delete_command(command_args, mock_client)
...
def test_rule_assignments_get_command(
    ...
    command_results = HarmonyEndpoint.rule_assignments_get_command({"rule_id": 1}, mock_client)

    assert command_results.outputs_prefix == "Harmony.Rule"
    assert command_results.outputs_key_field == "id"
    assert command_results.raw_response == mock_response
...
def test_rule_assignments_add_command(
    ...
    command_results = HarmonyEndpoint.rule_assignments_add_command(
...
def test_rule_assignments_remove_command(
    ...
    command_results = HarmonyEndpoint.rule_assignments_remove_command(
        {"rule_id": 1, "entities_ids": ["3", "4"]}, mock_client
    )
...
def test_rule_metadata_list_command(
    ...
    command_results = HarmonyEndpoint.rule_metadata_list_command(command_args, mock_client)
        ...
        (
            ...
            CommonServerPython.PollResult(
                response=CommonServerPython.CommandResults(
                    ...
                    outputs_prefix="Harmony.PushOperation",
...
def test_schedule_command(
    ...
    with (
        unittest.mock.patch("HarmonyEndpoint.get_integration_context", return_value=integration_context),
        unittest.mock.patch("HarmonyEndpoint.set_integration_context") as mock_set_integration_context,
    ):
        poll_result: CommonServerPython.PollResult = HarmonyEndpoint.schedule_command(
            client=mock_client,
            args=args,
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            "POST",
            HarmonyEndpoint.rule_policy_install_command,
        ...
        (
            ...
            "GET",
            HarmonyEndpoint.rule_modifications_get_command,
            {"rule_id": "1994", "job_id": None},
        ...
        (
            "harmony-ep-push-operation-status-list",
            "GET",
            HarmonyEndpoint.push_operation_status_list_command,
        ...
        (
            ...
            "POST",
            HarmonyEndpoint.push_operation_get_command,
            {"remediation_operation_id": "11081994", "filter_text": None, "job_id": None},
            "remediation/11081994/results/slim",
        ),
        (
            "harmony-ep-push-operation-abort",
            "POST",
            HarmonyEndpoint.push_operation_abort_command,
            {"remediation_operation_id": "11081994", "job_id": None},
        ...
        (
            "harmony-ep-anti-malware-scan",
            "POST",
            HarmonyEndpoint.anti_malware_scan_command,
            {
                "comment": "test",
                "computer_ids": ["3"],
        ...
        (
            ...
            "POST",
            HarmonyEndpoint.anti_malware_update_command,
            {
                "comment": "test",
                "computer_ids": ["3"],
                "groups_ids_to_exclude": ["a"],
        ...
        (
            ...
            "POST",
            HarmonyEndpoint.anti_malware_restore_command,
            {
                "comment": "test",
                "computer_ids": ["3"],
                "groups_ids_to_exclude": ["a"],
        ...
        (
            ...
            "POST",
            HarmonyEndpoint.indicator_analyze_command,
            {
                "indicator_type": "IP",
        ...
        (
            ...
            "POST",
            HarmonyEndpoint.file_quarantine_command,
            {
                "file_type": "PATH",
        ...
        (
            ...
            "POST",
            HarmonyEndpoint.file_restore_command,
            {
                "file_type": "PATH",
                "file_value": "file_name",
                "computer_ids": ["3"],
        ...
        (
            ...
            "POST",
            HarmonyEndpoint.remediation_computer_isolate_command,
            {
                "file_type": "PATH",
                "file_value": "file_name",
                "computer_ids": ["3"],
        ...
        (
            ...
            "POST",
            HarmonyEndpoint.remediation_computer_deisolate_command,
            {
                "file_type": "PATH",
                "file_value": "file_name",
                "computer_ids": ["3"],
        ...
        (
            ...
            "POST",
            HarmonyEndpoint.computer_reset_command,
            {
                "computer_ids": ["3"],
                "inform_user": True,
                "allow_postpone": True,
        ...
        (
            ...
            "POST",
            HarmonyEndpoint.computer_repair_command,
            {
                "computer_ids": ["3"],
                "inform_user": True,
                "allow_postpone": True,
        ...
        (
            ...
            "POST",
            HarmonyEndpoint.computer_shutdown_command,
            {
                "computer_ids": ["3"],
                "inform_user": True,
                "allow_postpone": True,
        ...
        (
            ...
            "POST",
            HarmonyEndpoint.computer_list_command,
            {
                "computer_ids": ["3"],
                "job_id": None,
            },
        ...
        (
            ...
            "POST",
            HarmonyEndpoint.process_information_get_command,
            {
                "computer_ids": ["3"],
                "inform_user": True,
                "allow_postpone": True,
        ...
        (
            ...
            "POST",
            HarmonyEndpoint.process_terminate_command,
            {
                "computer_ids": ["3"],
                "name": "test",
                "inform_user": True,
        ...
        (
            ...
            "POST",
            HarmonyEndpoint.agent_registry_key_add_command,
            {
                "computer_ids": ["3"],
                "hive": "hive",
                "key": "key",
        ...
        (
            ...
            "POST",
            HarmonyEndpoint.agent_registry_key_delete_command,
            {
                "computer_ids": ["3"],
                "hive": "hive",
                "key": "key",
        ...
        (
            ...
            "POST",
            HarmonyEndpoint.agent_file_copy_command,
            {
                "computer_ids": ["3"],
        ...
        (
            ...
            "POST",
            HarmonyEndpoint.agent_file_move_command,
            {
                "computer_ids": ["3"],
                "destination_absolute_path": "destination_absolute_path",
                "source_absolute_path": "source_absolute_path",
        ...
        (
            ...
            "POST",
            HarmonyEndpoint.agent_file_delete_command,
            {
                "computer_ids": ["3"],
        ...
        (
            ...
            "POST",
            HarmonyEndpoint.agent_vpn_site_add_command,
            {
                "computer_ids": ["3"],
        ...
        (
            ...
            "POST",
            HarmonyEndpoint.agent_vpn_site_remove_command,
            {
                "computer_ids": ["3"],
...
def test_all_schedule_commands(
    ...
    with (
        unittest.mock.patch("HarmonyEndpoint.schedule_command") as mock_schedule_command,
...
def test_validate_pagination_arguments(page_size, page, limit):
    ...
    with pytest.raises(ValueError):
        HarmonyEndpoint.validate_pagination_arguments(page=page, page_size=page_size, limit=limit)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"page": "2", "page_size": "5"}, (1, 5, "Showing page 2.\nCurrent page size: 5.")),
        ({"page": "3", "page_size": "5", "limit": "15"}, (2, 5, "Showing page 3.\nCurrent page size: 5.")),
    ],
)
def test_get_pagination_args(args: dict[str, str], expected):
    ...
    with unittest.mock.patch(
        "CommonServerPython.arg_to_number", side_effect=lambda x: int(x) if x is not None else None
    ):
        with unittest.mock.patch("HarmonyEndpoint.validate_pagination_arguments") as mock_validate:
            assert HarmonyEndpoint.get_pagination_args(args) == expected
...
def test_validate_filter_arguments():
    ...
    with pytest.raises(ValueError) as exc_info:
        HarmonyEndpoint.validate_filter_arguments(column_name="invalid_name", filter_type="equals")
