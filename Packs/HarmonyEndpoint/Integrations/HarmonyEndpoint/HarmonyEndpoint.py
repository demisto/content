...
class Client(BaseClient):
    ...
    def login(self):
        """Login to Harmony with the generated temporary token and get new token for Harmony."""
        self._session.cookies.clear()
...
def update_command_results(
    ...
    if SCHEDULED_COMMANDS_MAPPER[command_name].headers == DEFAULT_HEADERS:
        command_results.outputs_prefix = "Harmony.PushOperation"
    else:
        command_results.outputs_prefix = f"Harmony.{SCHEDULED_COMMANDS_MAPPER[command_name].outputs_prefix}"
