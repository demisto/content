...
| hostSetName | The name of the host set to be searched.<br/><br/>Separate multiple search values by commas only \(without spaces or any special characters\). |  | Required |
