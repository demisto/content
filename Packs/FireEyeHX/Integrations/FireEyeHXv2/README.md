...
| FireEyeHX.Hosts.os.platform | Unknown | The family of operating systems. Valid values are win, osx, and linux. | 
...
| --- | --- | --- |
| FireEyeHX.Hosts._id | String | FireEye HX Agent ID. | 
| FireEyeHX.Hosts.last_sysinfo | String | The last sis info. | 
| FireEyeHX.Hosts.requested_by_actor | String | Requested by actor. | 
| FireEyeHX.Hosts.requested_on | String | Requested on. | 
| FireEyeHX.Hosts.contained_by_actor | String | Contained by actor. | 
| FireEyeHX.Hosts.contained_on | String | Contained on. | 
| FireEyeHX.Hosts.queued | Boolean | Is it in queued | 
| FireEyeHX.Hosts.excluded | Boolean | Is it in excluded | 
| FireEyeHX.Hosts.missing_software | Boolean | Is it missing software | 
| FireEyeHX.Hosts.reported_clone | Boolean | Is there reported clone | 
| FireEyeHX.Hosts.state | String | The state | 
| FireEyeHX.Hosts.state_update_time | String | The state update time | 
| FireEyeHX.Hosts.url | String | The URL | 
