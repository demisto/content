...
STANDARD_INVESTIGATIVE_DETAILS_OSX = {  # pragma: no cover
    "commands": [
        ...
        {"name": "groups"},
        {
            ...
            "parameters": [
                {"name": "Path", "value": "/"},
                {"name": "Regex", "value": "^(?:Applications|Library|System|User|bin|cores|opt|private|sbin|usr)+"},
                {"name": "Include Remote Locations", "value": False},
                {"name": "Depth", "value": -1},
                {"name": "MD5", "value": True},
                {"name": "SHA1", "value": False},
                {"name": "SHA256", "value": False},
                {"name": "Verify Digital Signatures", "value": False},
                {"name": "AND Operator", "value": False},
                {"name": "Include Files", "value": True},
                {"name": "Include Directories", "value": True},
                {"name": "Preserve Times", "value": False},
            ],
        },
        {
            "name": "persistence",
        ...
        },
        {
            ...
            "parameters": [
                ...
                {"name": "SHA1", "value": False},
                {"name": "SHA256", "value": False},
                {"name": "Verify Digital Signatures", "value": True},
                {"name": "Preserve Times", "value": False},
            ],
        },
        {"name": "processes-api"},
        {
            "name": "urlhistory",
            "parameters": [
                {"name": "TargetBrowser", "value": "Chrome"},
                {"name": "TargetBrowser", "value": "Firefox"},
                {"name": "TargetBrowser", "value": "Safari"},
            ],
        },
        ...
        {"name": "stateagentinspector", "parameters": [{"name": "eventTypes", "value": []}]},
        {"name": "syslog"},
    ]
}
STANDARD_INVESTIGATIVE_DETAILS_LINUX = {
    "commands": [
        {"name": "sysinfo"},
        {
            ...
            "parameters": [
                {"name": "Path", "value": "/"},
                {"name": "Regex", "value": "^(?:usr|lib|lib64|opt|home|sbin|bin|etc|root)+"},
                {"name": "Include Remote Locations", "value": False},
                {"name": "Depth", "value": -1},
                {"name": "MD5", "value": True},
                {"name": "SHA1", "value": False},
        ...
        {"name": "processes-api"},
        {"name": "ports"},
        {"name": "shell-history", "parameters": [{"name": "ShellList", "value": ["bash", "zsh", "ksh93"]}]},
    ]
}
STANDARD_INVESTIGATIVE_DETAILS_WIN = {
    "commands": [
        {"name": "sysinfo"},
        {"name": "disks", "parameters": [{"name": "Prevent Hibernation", "value": True}]},
        {"name": "volumes", "parameters": [{"name": "Prevent Hibernation", "value": True}]},
        {"name": "useraccounts", "parameters": [{"name": "Prevent Hibernation", "value": True}]},
        {"name": "prefetch", "parameters": [{"name": "Prevent Hibernation", "value": True}]},
        {
            "name": "files-raw",
            "parameters": [
                {"name": "Prevent Hibernation", "value": True},
                {"name": "Active Files", "value": True},
                {"name": "Deleted Files", "value": True},
                {"name": "Parse NTFS INDX Buffers", "value": True},
                {"name": "Path", "value": "%systemdrive%"},
                {"name": "Depth", "value": -1},
                {"name": "MD5", "value": True},
                {"name": "SHA1", "value": False},
                {"name": "SHA256", "value": False},
                {"name": "Analyze Entropy", "value": False},
                {"name": "Enumerate Imports", "value": False},
                {"name": "Enumerate Exports", "value": False},
                {"name": "Analyze File Anomalies", "value": False},
                {"name": "Verify Digital Signatures", "value": False},
                {"name": "Strings", "value": False},
                {"name": "AND Operator", "value": False},
                {"name": "Include Files", "value": True},
                {"name": "Include Directories", "value": True},
                {"name": "Get Resources", "value": False},
                {"name": "Get Resource Data", "value": False},
                {"name": "Get Version Info", "value": False},
            ],
        },
        {
            "name": "persistence",
        ...
        {
            "name": "registry-raw",
            "parameters": [{"name": "Prevent Hibernation", "value": True}, {"name": "Type", "value": "All"}],
        },
        {
            "name": "tasks",
            "parameters": [
                ...
                {"name": "Verify Digital Signatures", "value": True},
                {"name": "Preserve Times", "value": False},
                {"name": "raw mode", "value": False},
            ],
        },
        {"name": "eventlogs", "parameters": [{"name": "Prevent Hibernation", "value": True}]},
        {
            ...
            "parameters": [
                ...
                {"name": "SHA1", "value": False},
                {"name": "SHA256", "value": False},
                {"name": "MemD5", "value": False},
                {"name": "enumerate imports", "value": True},
                {"name": "enumerate exports", "value": True},
                {"name": "Verify Digital Signatures", "value": True},
                {"name": "sections", "value": True},
                {"name": "ports", "value": True},
                {"name": "handles", "value": True},
                {"name": "detect injected dlls", "value": True},
                {"name": "raw mode", "value": False},
                {"name": "strings", "value": False},
            ],
        },
        {
            ...
            "parameters": [
                {"name": "Prevent Hibernation", "value": True},
                {"name": "GetThumbnails", "value": False},
                {"name": "GetIndexedPageContent", "value": False},
            ],
        },
        {"name": "ports", "parameters": [{"name": "Prevent Hibernation", "value": True}]},
        {
            "name": "services",
            "parameters": [
                {"name": "Prevent Hibernation", "value": True},
...
TABLE_POLLING_COMMANDS = {
    "searching": {"type": "searchId", "message": "Searching... , started polling for id "},
    "acquisition": {"type": "acquisition_id", "message": "Acquisition is not yet ready, started polling for id "},
}
...
class Client(BaseClient):
    def __init__(self, base_url: str, verify: bool = True, proxy: bool = False, auth: Optional[tuple] = None):
        ...
        super().__init__(base_url, verify=verify, proxy=proxy, ok_codes=tuple(range(200, 205)), headers=headers, auth=auth)
    ...
    def get_token_request(self):
        ...
        try:
            response = self._http_request(method="GET", url_suffix="token", resp_type="response")
    ...
    def list_host_set_policy_request(self, offset: int, limit: int, policy_id: str = ""):
        ...
        return self._http_request(method="GET", url_suffix="host_set_policies", params=params)

    def list_host_set_policy_by_hostSetId_request(self, host_set_id):
        return self._http_request(method="GET", url_suffix=f"host_sets/{host_set_id}/host_set_policies")

    def assign_host_set_policy_request(self, body: Dict[str, Any]):
        return self._http_request(method="POST", url_suffix="host_set_policies", json_data=body, return_empty_response=True)

    def delete_host_set_policy_request(self, host_set_id, policy_id):
        return self._http_request(
            method="DELETE", url_suffix=f"host_sets/{host_set_id}/host_set_policies/{policy_id}", return_empty_response=True
        )
    ...
    def get_hosts_by_agentId_request(self, agent_id: str):
        return self._http_request(method="GET", url_suffix=f"hosts/{agent_id}")

    def get_hosts_request(
        self,
        limit=None,
        offset=None,
        ...
        return self._http_request(method="GET", url_suffix="hosts", params=params, headers=self._headers)

    def get_host_set_information_request(self, body, host_set_id):
        url = f"host_sets/{host_set_id}" if host_set_id else "host_sets"
        return self._http_request(method="GET", url_suffix=url, params=body)
    ...
    def approve_containment_request(self, agent_id: str):
        return self._http_request(
            method="PATCH", url_suffix=f"hosts/{agent_id}/containment", json_data={"state": "contain"}, return_empty_response=True
        )

    def cancel_containment_request(self, agent_id: str):
        self._http_request(method="DELETE", url_suffix=f"hosts/{agent_id}/containment", return_empty_response=True)
    ...
    def get_list_containment_request(self, offset: int, limit: int, state_update_time: str):
        ...
        return self._http_request(method="GET", url_suffix="containment_states", params=params)
    ...
    def delete_host_set_request(self, host_set_id: str):
        return self._http_request(method="DELETE", url_suffix=f"host_sets/{host_set_id}", return_empty_response=True)
    ...
    def create_static_host_set_request(self, host_set_name: str, hosts_ids: List[str]):
        ...
        return self._http_request(method="POST", url_suffix="/host_sets/static", json_data=body)
    ...
    def update_static_host_set_request(self, host_set_id, host_set_name, add_host_ids, remove_host_ids):
        ...
        return self._http_request(method="PUT", url_suffix=f"/host_sets/static/{host_set_id}", json_data=body)
    ...
    def create_dynamic_host_set_request(self, host_set_name, query, query_key, query_value, query_operator):
        ...
        return self._http_request(method="POST", url_suffix="/host_sets/dynamic", json_data=body)

    def update_dynamic_host_set_request(self, host_set_id, host_set_name, query, query_key, query_value, query_operator):
        body = self.create_dynamic_host_request_body(host_set_name, query, query_key, query_value, query_operator)

        return self._http_request(method="PUT", url_suffix=f"/host_sets/dynamic/{host_set_id}", json_data=body)

    @staticmethod
    def create_static_host_request_body(host_set_name: str, host_ids_to_add: list, host_ids_to_remove: list):
        body = {"name": host_set_name, "changes": [{"command": "change", "add": host_ids_to_add, "remove": host_ids_to_remove}]}
    ...
    def create_dynamic_host_request_body(host_set_name: str, query: str, query_key: str, query_value: str, query_operator: str):
        ...
        if query:
            ...
            body["query"] = {"key": query_key, "value": query_value, "operator": query_operator}
    ...
    def data_acquisition_request(self, agent_id: str, body: Dict):
        return self._http_request(method="POST", url_suffix=f"hosts/{agent_id}/live", json_data=body)

    def data_acquisition_information_request(self, acquisition_id):
        return self._http_request(method="GET", url_suffix=f"acqs/live/{acquisition_id}").get("data")

    def delete_data_acquisition_request(self, acquisition_id):
        self._http_request(method="DELETE", url_suffix=f"acqs/live/{acquisition_id}", return_empty_response=True)

    def data_collection_request(self, acquisition_id):
        return self._http_request(method="GET", url_suffix=f"acqs/live/{acquisition_id}.mans", resp_type="content")

    def file_acquisition_request(self, agent_id, file_name, file_path, comment=None, external_id=None, req_use_api=None):
        body = assign_params(
            req_path=file_path, req_filename=file_name, comment=comment, external_id=external_id, req_use_api=req_use_api
        )

        return self._http_request(method="POST", url_suffix=f"hosts/{agent_id}/files", json_data=body).get("data")

    def file_acquisition_information_request(self, acquisition_id):
        return self._http_request(method="GET", url_suffix=f"acqs/files/{acquisition_id}").get("data")
    ...
    def delete_triage_acquisition_request(self, acquisition_id: str):
        ...
        self._http_request(method="DELETE", url_suffix=f"acqs/triages/{acquisition_id}", return_empty_response=True)
    ...
    def get_alerts_request(
        ...
        if filter_query:
            return self._http_request(
                "GET", url_suffix=f"alerts?filterQuery={filter_query}", params=params, headers=self._headers
            )

        else:
            return self._http_request("GET", url_suffix="alerts", params=params, headers=self._headers)

    def get_alert_request(self, alert_id: int):
        return self._http_request(method="GET", url_suffix=f"/alerts/{alert_id}", headers=self._headers)
    ...
    def suppress_alert_request(self, alert_id: int):
        ...
        return self._http_request(method="DELETE", url_suffix=f"/alerts/{alert_id}", return_empty_response=True)
    ...
    def get_indicator_request(self, category, name):
        ...
        """
        try:
            return self._http_request(method="GET", url_suffix=f"/indicators/{category}/{name}", raise_on_status=True)["data"]
    ...
    def get_indicator_conditions_request(self, category: str, name: str, offset: int, enabled: Optional[bool] = True):
        ...
        try:
            return self._http_request(method="GET", url_suffix=f"/indicators/{category}/{name}/conditions", params=params)
    ...
    def append_conditions_request(self, name: str, category: str, body: str):
        ...
        return self._http_request(method="PATCH", url_suffix=f"/indicators/{category}/{name}/conditions", data=body)
    ...
    def new_indicator_request(self, category, body: Dict[str, Any]):
        ...
        try:
            return self._http_request(method="POST", url_suffix=f"indicators/{category}", json_data=body)
    ...
    def get_search_by_id_request(self, search_id: int):
        return self._http_request(method="GET", url_suffix=f"searches/{search_id}")

    def get_search_list_request(
        self, offset: int, limit: int, state: str = None, host_set_id: int = None, actor_username: str = None, sort: str = None
    ):
        params = assign_params(offset=offset, limit=limit, state=state, sort=sort)
        ...
        return self._http_request(method="GET", url_suffix="searches", params=params)
    ...
    def delete_search_request(self, search_id):
        ...
        self._http_request(method="DELETE", url_suffix=f"searches/{search_id}", return_empty_response=True)
    ...
    def search_request(self, body: Dict):
        return self._http_request(method="POST", url_suffix="searches", json_data=body)
...
def host_set_entry(host_sets: List[Dict]) -> List[Dict]:
    return [{"Name": host_set.get("name"), "ID": host_set.get("_id"), "Type": host_set.get("type")} for host_set in host_sets]


def general_context_from_event(alert: Dict):
    def file_context(values: Dict):
        dbot = Common.DBotScore(
            values.get("fileWriteEvent/md5"), DBotScoreType.FILE, integration_name="FireEye-HX", score=Common.DBotScore.NONE
        )
        return Common.File(
            dbot,
    ...
    def ip_context(values: Dict):
        dbot = Common.DBotScore(
            values.get("ipv4NetworkEvent/remoteIP"), DBotScoreType.IP, integration_name="FireEye-HX", score=Common.DBotScore.NONE
        )
        return Common.IP(values.get("ipv4NetworkEvent/remoteIP"), dbot_score=dbot)

    context_map = {"fileWriteEvent": file_context, "ipv4NetworkEvent": ip_context}
...
def organize_search_body_query(argForQuery: tuple, args: Dict):
    ...
    if argForQuery[0] == "fieldSearchName":
        ...
        for searchValue in argToList(argForQuery[1]):
            query.append(
                assign_params(
                    field=arg_to_query_field_map[argForQuery[0]],
...
# TODO: Helper function triage acq
...
def get_indicator_command_result(alert: Dict[str, Any]) -> CommandResults:
    if alert.get("event_type") == "fileWriteEvent":
        ...
        md_table = tableToMarkdown(
            name="File",
            t={
                "Name": event_values.get("fileWriteEvent/fileName"),
        ...
        return CommandResults(outputs_prefix="File", indicator=indicator, readable_output=md_table)

    elif alert.get("event_type") == "ipv4NetworkEvent":
        indicator = general_context_from_event(alert)
        event_values = alert.get("event_values", {})
        md_table = tableToMarkdown(name="Ip", t={"Ipv4": event_values.get("ipv4NetworkEvent/remoteIP")})
        return CommandResults(outputs_prefix="Ip", indicator=indicator, readable_output=md_table)
...
def get_all_indicators(
    client: Client, category=None, search=None, share_mode=None, sort=None, created_by=None, alerted=None, limit=None
):
...
def get_indicator_conditions(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    conditions = get_all_enabled_conditions(client, args.get("category"), args.get("name"))

    conditions_entries = [get_condition_entry(condition) for condition in conditions]

    md_table = tableToMarkdown(name=f"Indicator '{args.get('name')}' Alerts on", t=conditions_entries)

    return CommandResults(
        outputs_prefix="FireEyeHX.Conditions", outputs_key_field="_id", outputs=conditions, readable_output=md_table
    )
...
def query_fetch(reported_at=None, first_fetch: str = None):
    ...
    query += (
        '"'
        + timestamp_to_datestring(parse_date_range("1 days", to_timestamp=True, utc=False)[1])
        + '"'
        + '],"field":"reported_at"}'
    )
...
def parse_alert_to_incident(alert: Dict, pattern: Pattern) -> Dict:
    ...
    incident_name = "{event_type_parsed}: {indicator}".format(
        event_type_parsed=pattern.sub(r"\g<1> \g<2>", event_type).title(), indicator=indicator
    )

    incident = {"name": incident_name, "occurred": alert.get("event_at"), "rawJSON": json.dumps(alert)}
    return incident
...
def list_policy_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        outputs_prefix="FireEyeHX.Policy", outputs_key_field="_id", outputs=response, raw_response=response, readable_output=md
    )
...
def list_host_set_policy_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    for_table = []
    for entry in response["data"]["entries"]:
        for_table.append({"Policy Id": entry["policy_id"], "Host Set Id": entry["persist_id"]})
...
def assign_host_set_policy_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    response = None
    try:
        response = client.assign_host_set_policy_request({"persist_id": host_set_id, "policy_id": policy_id})
        message = "Success"
    except Exception as e:
        if "400" in str(e):
            demisto.debug(str(e))
    ...
    return CommandResults(readable_output=message, outputs_prefix="FireEyeHX.Policy", outputs=response)
...
def get_all_hosts_information_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    md = tableToMarkdown(name="FireEye HX Get Hosts Information", t=outputs, headers=headers_for_table)

    return CommandResults(
        outputs_prefix="FireEyeHX.Hosts", outputs_key_field="_id", outputs=outputs, raw_response=hosts, readable_output=md
    )
...
def get_host_information_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    md = tableToMarkdown(name="FireEye HX Get Host Information", t=for_table, headers=headers_for_table)

    return CommandResults(outputs_prefix="FireEyeHX.Hosts", outputs_key_field="_id", outputs=host, readable_output=md)
...
def get_host_set_information_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    if len(host_set) > 0:
        md_table = tableToMarkdown(
            name="FireEye HX Get Host Sets Information", t=host_set_entry(host_set), headers=["Name", "ID", "Type"]
        )
    ...
    return CommandResults(
        outputs_prefix="FireEyeHX.HostSets", outputs_key_field="_id", outputs=host_set, readable_output=md_table
    )
...
def get_list_containment_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    response = client.get_list_containment_request(offset=offset, limit=limit, state_update_time=state_update_time)["data"][
        "entries"
    ]
    ...
    headers_for_table = [
        ...
        "Containment Origin",
        "Containment Date",
        "Last System information date",
    ]
    md = tableToMarkdown(name="List Containment", t=for_table, headers=headers_for_table)

    return CommandResults(outputs_prefix="FireEyeHX.Hosts", outputs_key_field="_id", outputs=response, readable_output=md)
...
def approve_containment_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    return CommandResults(outputs_prefix="FireEyeHX.Hosts", readable_output=message)
...
def delete_host_set_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    return CommandResults(outputs_prefix="FireEyeHX.HostSets", outputs_key_field="_id", outputs=outputs, readable_output=message)
...
def create_static_host_set_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    return CommandResults(
        outputs_prefix="FireEyeHX.HostSets", outputs_key_field="_id", outputs=data, readable_output=message, raw_response=response
    )
...
def update_dynamic_host_set_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    data = {}
    try:
        response = client.update_dynamic_host_set_request(
            host_set_id, host_set_name, query, query_key, query_value, query_operator
        )
        if data := response.get("data"):
            data["deleted"] = False
            date = datetime.strptime(data["_revision"][:-6], "%Y%m%d%H%M%S%f")
...
def data_acquisition_command(client: Client, args: Dict[str, Any]) -> tuple[CommandResults, bool, str]:
    ...
    if acquisition_info.get("state") != "COMPLETE":
        return (
            CommandResults(readable_output=f"Acquisition request was successful\nAcquisition ID: {acquisition_id}"),
            False,
            str(acquisition_id),
        )
...
def data_acquisition_with_polling_command(client: Client, args: Dict[str, Any]):
    return run_polling_command(
        client, args, "fireeye-hx-data-acquisition", data_acquisition_command, result_data_acquisition, "acquisition"
    )
...
def delete_data_acquisition_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    return CommandResults(readable_output=f"data acquisition {args.get('acquisitionId')} deleted successfully")
...
def file_acquisition_command(client: Client, args: Dict[str, Any]) -> tuple[CommandResults, bool, str]:
    if "acquisition_id" not in args:
        ...
        acquisition_info = client.file_acquisition_request(
            args.get("agentId"), args.get("fileName"), args.get("filePath"), req_use_api=use_api
        )
    ...
    if state not in ["COMPLETE", "ERROR", "FAILED"]:
        return (
            CommandResults(readable_output=f"acquisition request was successful, Acquisition Id: {acquisition_id}"),
            False,
            acquisition_id,
        )
...
# TODO: Start of Triage demisto calls
...
def get_host_acqs(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    return CommandResults(
        outputs_prefix="FireEyeHX.Host.Acquisitions", outputs=acquisition_info, readable_output="some boilerplate"
    )
...
def get_all_alerts_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    md_table = tableToMarkdown(name="FireEye HX Get Alerts", t=alerts_entries, headers=headers_for_table)
    ...
    return CommandResults(outputs_key_field="_id", outputs=results_outputs, readable_output=md_table)
...
def get_alert_command(client: Client, args: Dict[str, Any]) -> List[CommandResults]:
    ...
    alert_table = tableToMarkdown(name=f"FireEye HX Get Alert # {alert_id}", t=alert_entry, headers=headers_for_table)

    event_type = alert.get("event_type")
    event_type = event_type if event_type else "NewEvent"
    event_type = re.sub("([a-z])([A-Z])", r"\g<1> \g<2>", event_type).title()
    event_table = tableToMarkdown(name=event_type, t=alert.get("event_values"))
...
def suppress_alert_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    return CommandResults(readable_output=f"Alert {alert_id} suppressed successfully.")
...
def get_indicators_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    md_table = tableToMarkdown(name=f"FireEye HX Get Indicator- {args.get('name')}", t=for_table, headers=headers_for_table)

    return CommandResults(
        outputs_prefix="FireEyeHX.Indicators", outputs_key_field="_id", outputs=indicators, readable_output=md_table
    )
...
def get_indicator_command(client: Client, args: Dict[str, Any]) -> List[CommandResults]:
    ...
    indicator = client.get_indicator_request(args.get("category"), args.get("name"))
    ...
    md_table = tableToMarkdown(
        name=f"FireEye HX Get Indicator- {args.get('name')}", t=get_indicator_entry(indicator), headers=headers_for_table
    )

    return [
        CommandResults(
            outputs_prefix="FireEyeHX.Indicators", outputs_key_field="_id", outputs=indicator, readable_output=md_table
        ),
...
def append_conditions_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    md = tableToMarkdown(
        name="The conditions were added successfully", t={"Name": name, "Category": category, "Conditions": body}
    )

    return CommandResults(outputs_prefix="FireEyeHX.Conditions", outputs=response, readable_output=md)
...
def delete_condition_command(client: Client, args: Dict[str, str]) -> CommandResults:
    ...
    human_readable_args = f"condition {condition_id} ({condition_type}) of indicator {indicator_name} ({category})".replace(
        "'", ""
    )
    response = None
...
def start_search_with_polling_command(client: Client, args: Dict[str, Any]) -> Union[CommandResults, List[CommandResults]]:
    return run_polling_command(client, args, "fireeye-hx-search", start_search_command, search_result_get_command, "searching")
...
def get_search_list_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    if args.get("searchId"):
        ...
        response = client.get_search_list_request(
            offset=offset, limit=limit, state=state, host_set_id=hostSetId, actor_username=actorUsername, sort=sort
        )["data"]["entries"]
    ...
    md = tableToMarkdown(name="", t=for_table, headers=headers_for_table)

    return CommandResults(outputs_prefix="FireEyeHX.Search", outputs_key_field="_id", outputs=response, readable_output=md)
...
def search_stop_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    return CommandResults(outputs_prefix="FireEyeHX.Search", outputs_key_field="_id", outputs=responses, readable_output=md)
...
def search_result_get_command(client: Client, args: Dict[str, Any]) -> List[CommandResults]:
    ...
    for result in results:
        ...
        for entry in result[:entries_amount]:
            ...
            for res in entry.get("results", []):
                for_table.append(
                    {"Item Type": res.get("type"), "Summary": [f"**{k}:** {v}" for k, v in res.get("data", {}).items()]}
                )

            md = tableToMarkdown(name=Title, t=for_table, headers=["Item Type", "Summary"])

            commandsResults.append(
                CommandResults(outputs_prefix="FireEyeHX.Search", outputs_key_field="_id", outputs=entry, readable_output=md)
            )
    ...
    if "stopSearch" in args:
        ...
        if len(commandsResults) > 0:
            ...
            commandsResults.append(CommandResults(readable_output=message))
...
def run_polling_command(client, args, cmd, post_func, get_func, t):
    ...
    if not is_ready:
        ...
        scheduled_command = ScheduledCommand(
            command=cmd, next_run_in_seconds=interval_in_secs, args=args, timeout_in_seconds=1800
        )
...
def main() -> None:
    ...
    commands = {
        ...
        "fireeye-hx-host-get-acuistitions": get_host_acqs,
    }
    ...
    try:
        client = Client(base_url=base_url, verify=verify_certificate, proxy=proxy, auth=(user_name, password))
