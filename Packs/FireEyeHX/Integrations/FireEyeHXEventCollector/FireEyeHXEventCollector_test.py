...
from FireEyeHXEventCollector import Client, fetch_events, get_events_command, populate_modeling_rule_fields
...
def test_fetch_events(mocker):
    ...
    events = fetch_events(
        client=client, max_fetch="100", first_fetch="2023-02-01T11:21:12.135Z", min_id="100", should_push_events=True
    )
    assert len(events) == 2
