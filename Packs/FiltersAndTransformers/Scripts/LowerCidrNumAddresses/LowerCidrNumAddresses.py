...
def cidr_network_addresses_lower_from_const(ip_cidr: str, max_num_addresses: str) -> bool:
    ...
    return ip_cidr_obj.num_addresses < int(max_num_addresses)
...
def main():
    ...
    for cidr in ip_cidrs:
        is_lower = cidr_network_addresses_lower_from_const(ip_cidr=cidr, max_num_addresses=max_num_addresses)
