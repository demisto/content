...
class Formatter:
    ...
    def __extract(
        self,
        source: str,
        extractor: Optional[Callable[[str, Optional[ContextData], Optional[Dict[str, Any]]], Any]],
...
def extract_value(source: Any, dx: Optional[ContextData], node: Optional[Dict[str, Any]] = None) -> Any:
    ...
    def __extract_dt(dtstr: str, dx: Optional[ContextData], node: Optional[Dict[str, Any]] = None) -> Any:
        try:
...
class Translator:
    ...
    def translate(
        self, source: Any, pattern_mapping: Union[List[Dict[str, Any]], Dict[str, Any]], priority: str, algorithm: str
    ) -> Tuple[Any, bool]:
