...
def test_search():
    ...
    assert result == [{"Value": "1.1.1.1", "Type": "IPV4_ADDRESS"}, {"Value": "2.2.2.2", "Type": "IPV4_ADDRESS"}]
...
def test_search_string(mocker):
    ...
    assert res == ([{"Value": "1.1.1.1", "Type": "IPV4_ADDRESS"}, {"Value": "2.2.2.2", "Type": "IPV4_ADDRESS"}])
