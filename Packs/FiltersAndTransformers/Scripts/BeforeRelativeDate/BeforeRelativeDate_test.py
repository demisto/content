...
from Packs.FiltersAndTransformers.Scripts.BeforeRelativeDate.BeforeRelativeDate import main
...
def test_date_match(mocker):
    ...
    args_value = {"left": "2020-10-12T22:17:17", "right": "1 minute ago"}
...
def test_date_match_non_iso(mocker):
    ...
    return bool true.
    """
    args_value = {"left": "2020-10-12", "right": "30 minute ago"}
    mocker.patch.object(demisto, "args", return_value=args_value)
    mocker.patch.object(demisto, "results")
    main()
...
def test_date_no_match(mocker):
    ...
    """
    args_value = {"left": "2099-01-01T00:00:00", "right": "1 day ago"}
    mocker.patch.object(demisto, "args", return_value=args_value)
    mocker.patch.object(demisto, "results")
    main()
...
def test_date_with_timezone(mocker):
    ...
    """
    args_value = {"left": "2099-08-21 17:22:13 UTC", "right": "1 day ago"}
    mocker.patch.object(demisto, "args", return_value=args_value)
    mocker.patch.object(demisto, "results")
    main()
