...
def test_main(mocker):
    ...
    mocker.patch.object(demisto, "args", return_value={"value": EMAIL_ADDRESSES, "domain_list": DOMAIN_LIST})
    ...
    mocker.patch.object(demisto, "args", return_value={"value": EMAIL_ADDRESSES_LIST, "domain_list": DOMAIN_LIST})
    mocker.patch.object(demisto, "results")
    main()
    assert demisto.results.call_count == 1
    results = demisto.results.call_args[0][0]
