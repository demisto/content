...
- Provides a script to check the reputation of X509 certificates performing important security controls and validations on the cert against best practices.