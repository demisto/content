...
from Lumu import (
    ...
    comment_a_specific_incident_command,
    consult_incidents_updates_through_rest_command,
    fetch_incidents,
    get_cache_command,
    get_hmac_sha256,
    generate_hmac_sha256_msg,
    get_mapping_fields_command,
    get_modified_remote_data_command,
    get_remote_data_command,
    is_msg_from_third_party,
    mark_incident_as_read_command,
    mute_incident_command,
    retrieve_a_specific_incident_details_command,
    retrieve_a_specific_label_command,
    retrieve_closed_incidents_command,
    retrieve_endpoints_by_incident_command,
    retrieve_incidents_command,
    retrieve_labels_command,
    retrieve_muted_incidents_command,
    retrieve_open_incidents_command,
    test_module as t_module,
...
official_response_retrieve_labels_request = {
    "labels": [
        {"id": 51, "name": "Mi Ofi", "relevance": 1},
        {"id": 112, "name": "Lab1", "relevance": 1},
        {"id": 113, "name": "Lab2", "relevance": 1},
        {"id": 134, "name": "cd test", "relevance": 1},
    ],
    "paginationInfo": {"page": 1, "items": 4, "next": 2},
}


official_response_retrieve_a_specific_label_request = {"id": 51, "name": "Mi Ofi", "relevance": 1}
...
official_response_retrieve_incidents_request = {
    "items": [
        {
            ...
            "status": "open",
            "contacts": 10,
            "adversaries": ["waste4think.eu"],
            "adversaryId": "waste4think.eu",
            "adversaryTypes": ["Phishing"],
            "description": "Phishing domain",
            "labelDistribution": {"4055": 6, "548": 4},
            "totalEndpoints": 3,
        ...
        },
        {
            ...
            "status": "open",
            "contacts": 4,
            "adversaries": ["jits.ac.in"],
            "adversaryId": "jits.ac.in",
            "adversaryTypes": ["Malware"],
            "description": "QakBot",
            "labelDistribution": {"1791": 1, "548": 3},
            "totalEndpoints": 2,
    ...
    "paginationInfo": {"page": 1, "items": 50, "next": 2},
}
...
dummy_response_retrieve_a_specific_incident_details_request = {
    ...
    "firstContactDetails": {"isPlayback": False},
    "lastContactDetails": {
...
official_response_retrieve_endpoints_by_incident_request = {
    ...
    "paginationInfo": {"page": 1, "items": 50},
}
    ...
    "updates": [
        {
            "IncidentUpdated": {
                ...
                "incident": {
                    ...
                    "adversaryTypes": ["Spam"],
                    "description": "Activity Test Query",
                    "labelDistribution": {"0": 999, "4055": 4, "4061": 3, "1580": 1},
                    "totalEndpoints": 4,
        ...
        },
        {
            "IncidentUpdated": {
                ...
                "incident": {
                    ...
                    "status": "open",
                    "contacts": 1028,
                    "adversaries": ["greetland.net"],
                    "adversaryId": "greetland.net",
                    "adversaryTypes": ["Mining"],
                    "description": "CryptoMining domain",
                    "labelDistribution": {"2148": 5, "805": 8, "0": 1015},
                    "totalEndpoints": 5,
...
def test_is_msg_from_third_party():
    response = is_msg_from_third_party(
        "key", "comment hmacsha256:2761f9f96a30ffcded82c45a99b75f45fe20b4b971ec344f2cb523a8e2fa0ae0"
    )  # noqa: E501
    assert response is True

    response = is_msg_from_third_party(
        "key", "comments hmacsha256:2761f9f96a30ffcded82c45a99b75f45fe20b4b971ec344f2cb523a8e2fa0ae0"
    )  # noqa: E501
    assert response is False
...
def test_retrieve_incidents_command(mock_retrieve_incidents_request):
    client = Client("server_url", False, "proxy", {})
    args = {
        "fromDate": "2023-01-01T14:40:14.939Z",
...
@patch.object(
    Client,
    "retrieve_a_specific_incident_details_request",
    return_value=dummy_response_retrieve_a_specific_incident_details_request,
)  # noqa: E501
...
def test_comment_a_specific_incident_command(mock_comment_a_specific_incident_request, mock_prefix, mock_hash_gen):
    client = Client("server_url", False, "proxy", {})
    args = {"lumu_incident_id": "14fd84b0-9bdd-11ed-a0c7-dd6f8e69d343", "comment": "comment"}
...
def test_comment_a_specific_incident_command_raise_error(mock_comment_a_specific_incident_request, mock_prefix, mock_hash_gen):
    client = Client("server_url", False, "proxy", {})
    args = {"lumu_incident_id": "14fd84b0-9bdd-11ed-a0c7-dd6f8e69d343", "comment": "comment"}
...
@patch.object(
    Client, "retrieve_endpoints_by_incident_request", return_value=official_response_retrieve_endpoints_by_incident_request
)  # noqa: E501
def test_retrieve_endpoints_by_incident_command(mock_retrieve_endpoints_by_incident_request):
    client = Client("server_url", False, "proxy", {})
    args = {"page": 5, "items": 4, "lumu_incident_id": "abc"}
...
@patch.object(
    Client, "mark_incident_as_read_request", side_effect=DemistoException("Failed to parse json object from response: b''")
)  # noqa: E501
...
@patch.object(
    Client,
    "consult_incidents_updates_through_rest_request",
    return_value=dummy_response_consult_incidents_updates_through_rest_request,
)  # noqa: E501
def test_consult_incidents_updates_through_rest_command(mock_consult_incidents_updates_through_rest_request):
    client = Client("server_url", False, "proxy", {})
    args = {"offset": 5, "items": 2, "time": 4}
...
def test_fetch_incidents(
    mock_consult_incidents_updates_through_rest_request,
...
def test_get_modified_remote_data_command(mock_integration_context, mock_set_integration_context, mock_debug):
    ...
    mock_integration_context.return_value = {"cache": [["abc", "dfg"], ["jhg"]], "lumu_incidentsId": []}
    response = get_modified_remote_data_command(client, args)
...
def test_get_remote_data_command(mock_retrieve_a_specific_incident_details_request, mock_args, mock_debug):
    ...
    assert entries == [
        {
            "Type": 1,
            "Contents": "mute - from XSOAR Cortex 20230124_120758 , hmacsha256:90369dbefcf13550a9451e52e3c750f6f28159e71b403aa6402cb544cc678748",
            "ContentsFormat": "markdown",
            "Note": True,
        },
        {
            "Type": 1,
            "Contents": "Incident ID:  14fd84b0-9bdd-11ed-a0c7-dd6f8e69d343 \nDate of first contact: N/A \nAdversary type: Spam \nDescription: Activity Test Query \nTotal contacts: 95 \nTotal Endpoints: 3 \nURL: https://portal.lumu.io/compromise/incidents/show/14fd84b0-9bdd-11ed-a0c7-dd6f8e69d343/detections",
            "ContentsFormat": "markdown",
            "Note": True,
        },
    ]  # noqa: E501
    ...
    assert incident == {
        ...
        "actions": [
            {
                ...
                "userId": 0,
                "action": "mute",
                "comment": "from XSOAR Cortex 20230124_120758 , hmacsha256:90369dbefcf13550a9451e52e3c750f6f28159e71b403aa6402cb544cc678748",
            }
        ],
        "status": "muted",
        "statusTimestamp": "2023-01-24T12:08:01.619Z",
        ...
        "comment": "mute - from XSOAR Cortex 20230124_120758 , hmacsha256:90369dbefcf13550a9451e52e3c750f6f28159e71b403aa6402cb544cc678748",
...
def test_get_mapping_fields_command():
    ...
    assert response.scheme_types_mappings.fields == {
        "mute": "the description for the Lumu field",
...
def test_update_remote_system_command(
    mock_args,
    mock_debug,
    mock_mute_incident_request,
    mock_unmute_incident_request,
...
@patch("Lumu.demisto.debug")
@patch("Lumu.UpdateRemoteSystemArgs")
def test_update_remote_system_command_unknown_error(
    mock_args,
    mock_debug,
    mock_mute_incident_request,
    mock_unmute_incident_request,
