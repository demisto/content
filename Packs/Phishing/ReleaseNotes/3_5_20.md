...
- The "Spear Phishing Investigation" Playbook designed to detect patterns that indicates a spear phishing attempt by the attacker. (Available from Cortex XSOAR 6.5.0).
