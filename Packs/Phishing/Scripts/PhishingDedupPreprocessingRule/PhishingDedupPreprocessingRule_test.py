...
def executeCommand(command, args=None):
    ...
    if command == "CloseInvestigationAsDuplicate":  # noqa: RET503
        EXISTING_INCIDENT_ID = args["duplicateId"]  # noqa: RET503
...
def test_eliminate_urls_extensions():
    url = (
        "https://urldefense.proofpoint.com/v2/url?u=http-3A__fridmancpa.com_&d=DwIGaQ&c=XRWvQHnpdBDRh-yzrHjqLpXuH"
