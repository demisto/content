...
- Using alert fields and not alert labels.
...
| Email | The receiver email address. | alert.emailto | Optional |
| EmailCC | The email CC addresses. | alert.emailcc | Optional |
| EmailFrom | The sender email address. | alert.emailfrom | Optional |
| EmailSubject | The email subject. | alert.emailsubject | Optional |
| EmailText | The email text. | alert.emailbody | Optional |
| EmailHtml | The email HTML. | alert.emailhtml | Optional |
| EmailHeaders | The email headers. | alert.phishingreporteremailheaders | Optional |
| EmailFormat | The email format. | alert.emailformat | Optional |
...
| MessageID | The original email message ID to retrieve. Holds the value of the "Message-ID" header of the original email. This value is passed as an input to the "Get Original Email - Generic v2" playbook. | alert.emailmessageid | Optional |
| UserID | The user's email address to retrieve the original email. This value is passed as an input to the "Get Original Email - Generic v2" playbook. | alert.emailto | Optional |
| Thread-Topic | The value of the "Thread-Topic" header which holds the original email subject, needed for forwarded email scenarios. It is passed as an input to the "Get Original Email - Generic v2" playbook to use in the relevant sub-playbooks. | alert.emailsubject | Optional |
