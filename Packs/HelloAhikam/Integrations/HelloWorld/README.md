This is the Hello Ahikam integration for getting started and learn how to build an integration with Cortex XSOAR.
...
This integration was built to interact with the sample SOAR Hello Ahikam API To check the API source code go to [GitHub](https://github.com/fvigo/soarhelloAhikam).

## Configure HelloAhikam on Cortex XSOAR

1. Navigate to **Settings** > **Integrations** > **Servers & Services**.
2. Search for HelloAhikam.
3. Click **Add instance** to create and configure a new integration instance.
    ...
    | API Key |  | True |
    | Score threshold for IP reputation command | Set this to determine the HelloAhikam score that will determine if an IP is malicious \(0-100\) | False |
    | Score threshold for domain reputation command | Set this to determine the HelloAhikam score that will determine if a domain is malicious \(0-100\) | False |
...
#### Command Example
```!helloAhikam-say-hello name="Hello Dbot"```
...
### helloAhikam-search-alerts
***
Search HelloAhikam Alerts.
...
| **Path** | **Type** | **Description** |
| --- | --- | --- |
| HelloAhikam.Alert.alert_id | String | Alert ID. | 
| HelloAhikam.Alert.alert_status | String | Alert status. Can be 'ACTIVE' or 'CLOSED'. | 
| HelloAhikam.Alert.alert_type | String | Alert type. For example 'Bug' or 'Vulnerability'. | 
| HelloAhikam.Alert.created | Date | Alert created time. Format is ISO8601 \(i.e. '2020\-04\-30T10:35:00.000Z'\). | 
| HelloAhikam.Alert.name | String | Alert name. | 
| HelloAhikam.Alert.severity | String | Alert severity. Can be 'Low', 'Medium', 'High' or 'Critical'. | 


#### Command Example
```!helloAhikam-search-alerts severity="Critical" start_time="3 days" max_results=2 status="ACTIVE"```
        ...
        "Alert": [
            {
                ...
                "name": "Hello Ahikam Alert of type Feature",
                "severity": "Critical"
            },
            {
                ...
                "name": "Hello Ahikam Alert of type Bug",
                "severity": "Critical"
            }
        ]
    }
...
>|---|---|---|---|---|---|
>| 158cfeb2-84bf-498d-a10d-a55c3445d76e | ACTIVE | Feature | 2020-05-06T20:39:07.000Z | Hello Ahikam Alert of type Feature | Critical |
>| c61eec7e-3114-46e2-be71-a82572b98fc3 | ACTIVE | Bug | 2020-05-06T07:49:51.000Z | Hello Ahikam Alert of type Bug | Critical |
...
| HelloAhikam.Alert.alert_id | String | Alert ID. | 
| HelloAhikam.Alert.created | Date | Alert created time. Format is ISO8601 \(i.e. '2020\-04\-30T10:35:00.000Z'\). | 
| HelloAhikam.Alert.description | String | Alert description. | 
| HelloAhikam.Alert.device_id | String | ID of the device involved in the alert. | 
| HelloAhikam.Alert.device_ip | String | IP Address of the device involved in the alert. | 
| HelloAhikam.Alert.location | String | Location of the device involved in the alert. | 
| HelloAhikam.Alert.user | String | User involved in the alert. | 


#### Command Example
```!helloAhikam-get-alert alert_id=695b3238-05d6-4934-86f5-9fff3201aeb0```
...
>### HelloAhikam Alert 695b3238-05d6-4934-86f5-9fff3201aeb0
...
### helloAhikam-update-alert-status
***
...
| --- | --- | --- |
| HelloAhikam.Alert.alert_id | String | Alert ID. | 
| HelloAhikam.Alert.updated | Date | Alert update time. Format is ISO8601 \(i.e. '2020\-04\-30T10:35:00.000Z'\). | 
| HelloAhikam.Alert.alert_status | String | Alert status. Can be 'ACTIVE' or 'CLOSED'. | 


#### Command Example
```!helloAhikam-update-alert-status alert_id=695b3238-05d6-4934-86f5-9fff3201aeb0 status="CLOSED"```
...
| HelloAhikam.IP.asn | String | The autonomous system name for the IP address. | 
| HelloAhikam.IP.asn_cidr | String | The ASN CIDR. | 
| HelloAhikam.IP.asn_country_code | String | The ASN country code. | 
| HelloAhikam.IP.asn_date | Date | The date on which the ASN was assigned. | 
| HelloAhikam.IP.asn_description | String | The ASN description. | 
| HelloAhikam.IP.asn_registry | String | The registry the ASN belongs to. | 
| HelloAhikam.IP.entities | String | Entities associated to the IP. | 
| HelloAhikam.IP.ip | String | The actual IP address. | 
| HelloAhikam.IP.network.cidr | String | Network CIDR for the IP address. | 
| HelloAhikam.IP.network.country | Unknown | The country of the IP address. | 
| HelloAhikam.IP.network.end_address | String | The last IP address of the CIDR. | 
| HelloAhikam.IP.network.events.action | String | The action that happened on the event. | 
| HelloAhikam.IP.network.events.actor | Unknown | The actor that performed the action on the event. | 
| HelloAhikam.IP.network.events.timestamp | String | The timestamp when the event occurred. | 
| HelloAhikam.IP.network.handle | String | The handle of the network. | 
| HelloAhikam.IP.network.ip_version | String | The IP address version. | 
| HelloAhikam.IP.network.links | String | Links associated to the IP address. | 
| HelloAhikam.IP.network.name | String | The name of the network. | 
| HelloAhikam.IP.network.notices.description | String | The description of the notice. | 
| HelloAhikam.IP.network.notices.links | Unknown | Links associated with the notice. | 
| HelloAhikam.IP.network.notices.title | String | Title of the notice. | 
| HelloAhikam.IP.network.parent_handle | String | Handle of the parent network. | 
| HelloAhikam.IP.network.raw | Unknown | Additional raw data for the network. | 
| HelloAhikam.IP.network.remarks | Unknown | Additional remarks for the network. | 
| HelloAhikam.IP.network.start_address | String | The first IP address of the CIDR. | 
| HelloAhikam.IP.network.status | String | Status of the network. | 
| HelloAhikam.IP.network.type | String | The type of the network. | 
| HelloAhikam.IP.query | String | IP address that was queried. | 
| HelloAhikam.IP.raw | Unknown | Additional raw data for the IP address. | 
| HelloAhikam.IP.score | Number | Reputation score from HelloAhikam for this IP \(0 to 100, where higher is worse\). | 
...
| IP.ASN | String | The autonomous system name for the IP address. | 
| HelloAhikam.Domain.address | String | Domain admin address. | 
| HelloAhikam.Domain.city | String | Domain admin city. | 
| HelloAhikam.Domain.country | String | Domain admin country. | 
| HelloAhikam.Domain.creation_date | Date | Domain creation date. Format is ISO8601. | 
| HelloAhikam.Domain.dnssec | String | DNSSEC status. | 
| HelloAhikam.Domain.domain | String | The domain name. | 
| HelloAhikam.Domain.domain_name | String | Domain name options. | 
| HelloAhikam.Domain.emails | String | Contact emails. | 
| HelloAhikam.Domain.expiration_date | Date | Expiration date. Format is ISO8601. | 
| HelloAhikam.Domain.name | String | Domain admin name. | 
| HelloAhikam.Domain.name_servers | String | Name server. | 
| HelloAhikam.Domain.org | String | Domain organization. | 
| HelloAhikam.Domain.referral_url | Unknown | Referral URL. | 
| HelloAhikam.Domain.registrar | String | Domain registrar. | 
| HelloAhikam.Domain.score | Number | Reputation score from HelloAhikam for this domain \(0 to 100, where higher is worse\). | 
| HelloAhikam.Domain.state | String | Domain admin state. | 
| HelloAhikam.Domain.status | String | Domain status. | 
| HelloAhikam.Domain.updated_date | Date | Updated date. Format is ISO8601. | 
| HelloAhikam.Domain.whois_server | String | WHOIS server. | 
| HelloAhikam.Domain.zipcode | Unknown | Domain admin zipcode. | 
...
| **Path** | **Type** | **Description** |
| --- | --- | --- |
| HelloAhikam.Scan.scan_id | string | Unique ID of the scan. | 
| HelloAhikam.Scan.status | string | Status of the scan \('RUNNING' or 'COMPLETE'\). | 
| HelloAhikam.Scan.hostname | string | The hostname the scan is run against. | 


#### Command Example
```!helloAhikam-scan-start hostname="example.com"```
...
| **Argument Name** | **Description** | **Required** |
| --- | --- | --- |
| scan_id | List of Scan IDs. helloAhikam-scan-start returns "scan_id". | Required | 
...
#### Command Example
```!helloAhikam-scan-status scan_id="100"```
...
| **Path** | **Type** | **Description** |
| --- | --- | --- |
| HelloAhikam.Scan.entities.entity-id | String | Scanned entity ID. | 
| HelloAhikam.Scan.entities.ip_address | String | Scanned entity IP address. | 
| HelloAhikam.Scan.entities.type | String | Scanned entity type. | 
| HelloAhikam.Scan.entities.vulnerability_status | String | Scanned entity vulnerability status. | 
| HelloAhikam.Scan.entities.vulns | String | Scanned entity CVE. | 
| HelloAhikam.Scan.scan_id | String | Unique ID of the scan. | 
| HelloAhikam.Scan.status | String | Status of the scan \('RUNNING' or 'COMPLETE'\). | 
...
#### Command Example
```!helloAhikam-scan-results scan_id=100 format=json```
