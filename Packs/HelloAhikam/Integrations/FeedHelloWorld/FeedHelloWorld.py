"""HelloAhikam Feed Integration for Cortex XSOAR (aka Demisto)
...
class Client(BaseClient):
    ...
    For this HelloAhikam Feed implementation, no special attributes defined
    """
...
def get_indicators_command(client: Client,
    ...
    human_readable = tableToMarkdown('Indicators from HelloAhikam Feed:', indicators,
...
def main():
    ...
    try:
        ...
        elif command == 'helloAhikam-get-indicators':
