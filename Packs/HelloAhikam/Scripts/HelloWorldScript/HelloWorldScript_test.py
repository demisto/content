"""HelloAhikam Script for Cortex XSOAR - Unit Tests file

This file contains the Unit Tests for the HelloAhikam Script based
...
demisto-sdk lint -d Packs/HelloAhikam/Scripts/HelloAhikamScript
...
Also please check the HelloAhikam Integration Unit Tests file.

"""

from HelloAhikamScript import say_hello, say_hello_command
