...
ERROR_MSG = (
    "ERROR: The authentication code has been reset"
...
def get_access_token():
    ...
    response: requests.Response = requests.post(ACCESS_TOKEN_URL, data=data, verify=DISABLE_SSL)
...
def PaLM_output(response) -> CommandResults:
    ...
    if response and isinstance(response, dict):
        ...
        results = CommandResults(
            readable_output=markdown, outputs_prefix="GoogleVertexAIResponse", outputs_key_field="predictions", outputs=context
        )
