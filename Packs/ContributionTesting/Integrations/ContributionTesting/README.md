...
This integration was integrated and tested with version xx of Contribution Testing

## Configure Contribution Testing on Cortex XSOAR

1. Navigate to **Settings** > **Integrations** > **Servers & Services**.
2. Search for Contribution Testing.
