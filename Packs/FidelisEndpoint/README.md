...
| sort | Sorts the result before applying take and skip. Can be any property name of the alert object.כFor example: "insertionDate Descending"</br> | Optional | 
