...
class Client(BaseClient):
    ...
    def list_alerts(self, limit: str = None, sort: str = None, start_date=None, end_date=None) -> dict:
        ...
        params = assign_params(take=limit, sort=sort, startDate=start_date, endDate=end_date)
    ...
    def get_host_info(self, host_name: str, ip_address: str) -> dict:
        ...
        params = {
            "accessType": "3",
            "search": json.dumps({"searchFields": [{"fieldName": field_name, "values": [{"value": value}]}]}),
        }
    ...
    def search_file(self, host=None, md5=None, file_extension=None, file_path=None, file_size=None) -> dict:
        ...
        body = assign_params(
            hosts=host, md5Hashes=md5, fileExtensions=file_extension, filePathHints=file_path, fileSize=file_size
        )
    ...
    def execute_script(
        ...
        answer: str | int = "",
        time_out: int = None,
        additional_answer: None | str = None,
    ) -> dict:
    ...
    def kill_process(self, script_id: str = None, pid: int = None, time_out: int = None, endpoint_ip=None) -> dict:
        url_suffix = "/jobs/createTask"
        body = {
            "queueExpirationInhours": None,
            "wizardOverridePassword": False,
            ...
            "isPlaybook": False,
            "taskOptions": [
                {"integrationOutputFormat": None, "scriptId": script_id, "questions": [{"paramNumber": 1, "answer": pid}]}
            ],
        }
    ...
    def delete_file(self, script_id: str = None, file_path: str = None, time_out: int = None, endpoint_ip=None) -> dict:
        ...
        body = {
            ...
            "isPlaybook": False,
            "taskOptions": [
                {"integrationOutputFormat": None, "scriptId": script_id, "questions": [{"paramNumber": 1, "answer": file_path}]}
            ],
        }
    ...
    def network_isolation(
        self, script_id: str = None, allowed_server: str = None, time_out: int = None, endpoint_ip=None
    ) -> dict:
        url_suffix = "/jobs/createTask"
        body = {
            "queueExpirationInhours": None,
            ...
            "taskOptions": [
                {
                    "integrationOutputFormat": None,
                    "scriptId": script_id,
                    "questions": [{"paramNumber": 1, "answer": allowed_server}],
                }
            ],
        }
    ...
    def remove_network_isolation(self, script_id: str = None, time_out: int = None, endpoint_ip: list = None) -> dict:
        ...
        body: dict = {
            ...
            "endpoints": endpoint_ip,
            "isPlaybook": False,
            "taskOptions": [{"integrationOutputFormat": None, "scriptId": script_id, "questions": [{}]}],
        }
    ...
    def query_file_by_hash(
        self, limit: str = None, start_time: str = None, end_time: str = None, logic: str = None, file_hash: str = None
    ) -> dict:
        url_suffix = "/v2/events"
        params = assign_params(pageSize=limit)
        body = {
            "dateRange": {"start": start_time, "end": end_time},
            "resultFields": [
                "endpointName",
                "eventType",
                "processStartTime",
            ...
            "criteriaV3": {
                ...
                "filter": {
                    ...
                    "logic": logic,
                    "filters": [{"filterType": "criteria", "column": "hash", "operator": "=", "value": file_hash}],
                },
            },
        }
    ...
    def query_by_process_name(
        self, limit: str = None, start_time: str = None, end_time: str = None, logic: str = None, process_name: str = None
    ) -> dict:
        url_suffix = "/v2/events"
        params = assign_params(pageSize=limit)
        body = {
            ...
            "criteriaV3": {
                ...
                "filter": {
                    "filterType": "composite",
                    "logic": logic,
                    "filters": [{"filterType": "criteria", "column": "name", "operator": "=", "value": process_name}],
                },
            },
        }
        response = self._http_request("POST", url_suffix, params=params, json_data=body)
    ...
    def query_by_remote_ip(
        self, limit: str = None, start_time: str = None, end_time: str = None, logic: str = None, remote_ip: str = None
    ) -> dict:
        url_suffix = "/v2/events"
        params = assign_params(pageSize=limit)
        body = {
            ...
            "criteriaV3": {
                ...
                "filter": {
                    "filterType": "composite",
                    "logic": logic,
                    "filters": [{"filterType": "criteria", "column": "remoteIP", "operator": "=", "value": remote_ip}],
                },
            },
        }
        response = self._http_request("POST", url_suffix, params=params, json_data=body)
    ...
    def query_by_dns_request(
        self, limit: str = None, start_time: str = None, end_time: str = None, logic: str = None, url: str = None
    ) -> dict:
        url_suffix = "/v2/events"
        params = assign_params(pageSize=limit)
        body = {
            "dateRange": {"start": start_time, "end": end_time},
            "resultFields": ["endpointName"],
            "criteriaV3": {
                "relationshipFilter": None,
                "entityType": "dns",
                "filter": {
                    "filterType": "composite",
                    "logic": logic,
                    "filters": [{"filterType": "criteria", "column": "dnsQuestion", "operator": "=~", "value": url}],
                },
            },
        }
        response = self._http_request("POST", url_suffix, params=params, json_data=body)
        ...
        body = {
            ...
            "criteriaV3": {
                ...
                "filter": {
                    ...
                    "logic": logic,
                    "filters": [
                        {"filterType": "criteria", "column": "dnsQuestion", "operator": "=~", "value": domain},
                        {"filterType": "criteria", "column": "localIP", "operator": "=", "value": source_ip},
                    ],
                },
            },
        }
...
def file_search(client: Client, args: dict) -> tuple[str, dict, dict]:
    ...
    contents = {"JobID": data.get("jobId"), "JobResultID": data.get("jobResultId")}
...
def file_search_status(client: Client, args: dict) -> tuple[str, dict, dict]:
    ...
    contents = {"JobID": job_id, "JobResultID": job_result_id, "Status": data.get("status", "Unclassified")}
...
def file_search_reasult_metadata(client: Client, args: dict) -> tuple[str, dict, dict]:
    ...
    entry_context = {"FidelisEndpoint.File(val.ID && val.ID === obj.ID)": contents, outputPaths["file"]: file_standards}
...
def list_scripts_command(client: Client, *_) -> tuple[str, dict, dict]:
    ...
    for script in scripts:
        contents.append({"ID": script.get("id"), "Name": script.get("name"), "Description": script.get("description")})
...
def execute_script_command(client: Client, args: dict) -> tuple[str, dict, dict]:
    ...
    context = {"ID": script_id, "JobID": job_id}
...
def get_script_result(client: Client, args: dict):
    job_id = args.get("job_id")
    headers = ["ID", "Name", "EndpointID", "EndpointName", "PID", "User", "SHA1", "MD5", "Path", "WorkingDirectory", "StartTime"]
...
def query_file_by_hash_command(client: Client, args: dict) -> tuple[str, dict, dict]:
    ...
    context = []
    file_standards = []
    headers = ["PID", "EndpointName", "Name", "Path", "User", "Hash", "ProcessStartTime", "Parameters", "ParentName", "EventType"]
    ...
    entry_context = {"FidelisEndpoint.Query(val.Hash && val.Hash === obj.Hash)": context, outputPaths["file"]: file_standards}
    human_readable = tableToMarkdown("Fidelis Endpoint file hash query results", contents, headers=headers, removeNull=True)
    return human_readable, entry_context, response
...
def query_connection_by_remote_ip_command(client: Client, args: dict) -> tuple[str, dict, dict]:
    ...
    human_readable = tableToMarkdown(
        "Fidelis Endpoint query results for connection by remote IP", contents, headers=headers, removeNull=True
    )
    return human_readable, entry_context, response
...
def query_dns_request_command(client: Client, args: dict) -> tuple[str, dict, dict]:
    ...
    contents = []
    context = []
    headers = ["EndpointName", "LocalIP", "LocalPort", "RemoteIP", "RemotePort", "ProcessStartTime", "DnsAnswer", "EventType"]
    ...
    human_readable = tableToMarkdown(
        "Fidelis Endpoint query results for the DNS request", contents, headers=headers, removeNull=True
    )
    return human_readable, entry_context, response
...
def query_by_server_ip_command(client: Client, args: dict) -> tuple[str, dict, dict]:
    ...
    human_readable = tableToMarkdown(
        "Fidelis Endpoint query results for the DNS request by server IP", contents, headers=headers, removeNull=True
    )
    return human_readable, entry_context, response
...
def query_by_source_ip(client: Client, args: dict) -> tuple[str, dict, dict]:
    ...
    contents = []
    context = []
    headers = ["EndpointName", "LocalIP", "LocalPort", "RemoteIP", "RemotePort", "ProcessStartTime", "DnsQuestion", "DnsAnswer"]
    ...
    entry_context = {"FidelisEndpoint.Query(val.TargetID && val.TargetID === obj.TargetID)": context}
    human_readable = tableToMarkdown(
        "Fidelis Endpoint query results for the DNS request by source IP", contents, headers=headers, removeNull=True
    )
    return human_readable, entry_context, response
...
def query_events_command(client: Client, args: dict) -> tuple[str, dict, dict]:
    ...
    response = client.query_events(limit, start_time, end_time, logic, column, value, entity_type, operator, additional_filter)
    if not response.get("success"):
        raise Exception(response.get("error"))
    res = response.get("data", {})
    events = res.get("events", [])
    ...
    entry_context = {"FidelisEndpoint.Query(val.PID && val.PID === obj.PID)": context}
    human_readable = tableToMarkdown("Fidelis Endpoint query events result", contents, headers=headers, removeNull=True)
    return human_readable, entry_context, response
...
def fetch_incidents(client: Client, fetch_time: str, fetch_limit: str, last_run: dict) -> tuple[list, dict]:
    ...
    response = client.list_alerts(limit=fetch_limit, sort="createDate Ascending", start_date=last_fetched_alert_create_time)
    alerts = response.get("data", {}).get("entities", [])
    ...
    for alert in alerts:
        ...
        incident = {"name": f"Fidelis Endpoint alert {alert_id}", "occurred": alert_create_date, "rawJSON": json.dumps(alert)}
        incidents.append(incident)
        latest_alert_create_date = alert_create_date
        latest_alert_id = alert_id

    return incidents, {"last_fetched_alert_create_time": latest_alert_create_date, "last_fetched_alert_id": latest_alert_id}
