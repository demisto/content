...
@pytest.mark.parametrize(
    "arg1, arg2, expected_output", [("given", "given", False), ("given", None, True), (None, "yes", True), (None, None, False)]
)
...
def test_create_alert(mocker):
    ...
    mock_client = OpsGenieV3.Client(base_url="")
    mocker.patch.object(mock_client, "create_alert", return_value=util_load_json("test_data/request.json"))
    mocker.patch.object(mock_client, "get_request", return_value=util_load_json("test_data/create_alert.json", True))
...
def test_get_alerts(mocker):
    ...
    mocker.patch("CommonServerPython.get_demisto_version", return_value={"version": "6.2.0"})
    mock_client = OpsGenieV3.Client(base_url="")
    mocker.patch.object(mock_client, "list_alerts", return_value=util_load_json("test_data/get_alerts.json"))
...
def test_delete_alert(mocker):
    ...
    mocker.patch("CommonServerPython.get_demisto_version", return_value={"version": "6.2.0"})
    mock_client = OpsGenieV3.Client(base_url="")
    mocker.patch.object(mock_client, "delete_alert", return_value=util_load_json("test_data/request.json"))
    mocker.patch.object(mock_client, "get_request", return_value=util_load_json("test_data/delete_alert.json", True))
...
def test_ack_alert(mocker):
    ...
    mocker.patch("CommonServerPython.get_demisto_version", return_value={"version": "6.2.0"})
    mock_client = OpsGenieV3.Client(base_url="")
    mocker.patch.object(mock_client, "ack_alert", return_value=util_load_json("test_data/request.json"))
    mocker.patch.object(mock_client, "get_request", return_value=util_load_json("test_data/ack_alert.json", True))
...
def test_close_alert(mocker):
    ...
    mocker.patch("CommonServerPython.get_demisto_version", return_value={"version": "6.2.0"})
    mock_client = OpsGenieV3.Client(base_url="")
    mocker.patch.object(mock_client, "close_alert", return_value=util_load_json("test_data/request.json"))
    mocker.patch.object(mock_client, "get_request", return_value=util_load_json("test_data/close_alert.json", True))
...
def test_assign_alert(mocker):
    ...
    """
    mock_client = OpsGenieV3.Client(base_url="")
    mocker.patch.object(mock_client, "assign_alert", return_value=util_load_json("test_data/request.json"))
    mocker.patch.object(mock_client, "get_request", return_value=util_load_json("test_data/assign_alert.json", True))
...
def test_add_responder_alert(mocker):
    ...
    """
    mock_client = OpsGenieV3.Client(base_url="")
    mocker.patch.object(mock_client, "add_responder_alert", return_value=util_load_json("test_data/request.json"))
    mocker.patch.object(mock_client, "get_request", return_value=util_load_json("test_data/add_responder_alert.json", True))
...
def test_get_escalations(mocker):
    ...
    """
    mock_client = OpsGenieV3.Client(base_url="")
    mocker.patch.object(mock_client, "get_escalations", return_value=util_load_json("test_data/get_escalations.json"))
...
def test_get_escalation(mocker):
    ...
    """
    mock_client = OpsGenieV3.Client(base_url="")
    mocker.patch.object(mock_client, "get_escalation", return_value=util_load_json("test_data/get_escalations.json"))
...
def test_escalate_alert(mocker):
    ...
    """
    mock_client = OpsGenieV3.Client(base_url="")
    mocker.patch.object(mock_client, "escalate_alert", return_value=util_load_json("test_data/request.json"))
    mocker.patch.object(mock_client, "get_request", return_value=util_load_json("test_data/escalate_alert.json", True))
...
def test_add_alert_tag(mocker):
    ...
    mocker.patch("CommonServerPython.get_demisto_version", return_value={"version": "6.2.0"})
    mock_client = OpsGenieV3.Client(base_url="")
    mocker.patch.object(mock_client, "add_alert_tag", return_value=util_load_json("test_data/request.json"))
    mocker.patch.object(mock_client, "get_request", return_value=util_load_json("test_data/add_alert_tag.json", True))
...
def test_remove_alert_tag(mocker):
    ...
    mocker.patch("CommonServerPython.get_demisto_version", return_value={"version": "6.2.0"})
    mock_client = OpsGenieV3.Client(base_url="")
    mocker.patch.object(mock_client, "remove_alert_tag", return_value=util_load_json("test_data/request.json"))
    mocker.patch.object(mock_client, "get_request", return_value=util_load_json("test_data/remove_alert_tag.json", True))
...
def test_get_alert_attachments(mocker):
    ...
    """
    mock_client = OpsGenieV3.Client(base_url="")
    mocker.patch.object(mock_client, "get_alert_attachments", return_value=util_load_json("test_data/get_alert_attachments.json"))
...
def test_get_on_call(mocker):
    ...
    """
    mock_client = OpsGenieV3.Client(base_url="")
    mocker.patch.object(mock_client, "get_on_call", return_value=util_load_json("test_data/delete_incident.json"))
...
def test_create_incident(mocker):
    ...
    mocker.patch("CommonServerPython.get_demisto_version", return_value={"version": "6.2.0"})
    mock_client = OpsGenieV3.Client(base_url="")
    mocker.patch.object(mock_client, "create_incident", return_value=util_load_json("test_data/request.json"))
    mocker.patch.object(mock_client, "get_request", return_value=util_load_json("test_data/create_incident.json", True))
...
def test_delete_incident(mocker):
    ...
    mocker.patch("CommonServerPython.get_demisto_version", return_value={"version": "6.2.0"})
    mock_client = OpsGenieV3.Client(base_url="")
    mocker.patch.object(mock_client, "delete_incident", return_value=util_load_json("test_data/request.json"))
    mocker.patch.object(mock_client, "get_request", return_value=util_load_json("test_data/delete_incident.json", True))
...
def test_get_incidents(mocker):
    ...
    mocker.patch("CommonServerPython.get_demisto_version", return_value={"version": "6.2.0"})
    mock_client = OpsGenieV3.Client(base_url="")
    mocker.patch.object(mock_client, "list_incidents", return_value=util_load_json("test_data/get_incidents.json"))
...
def test_responders_to_json():
    ...
    """
    mock_client = OpsGenieV3.Client(base_url="")
    res = mock_client.responders_to_json(responders=["team", "id", 1, "schedule", "name", "a"], responder_key="responders")
...
def test_close_incident(mocker):
    ...
    mocker.patch("CommonServerPython.get_demisto_version", return_value={"version": "6.2.0"})
    mock_client = OpsGenieV3.Client(base_url="")
    mocker.patch.object(mock_client, "close_incident", return_value=util_load_json("test_data/request.json"))
    mocker.patch.object(mock_client, "get_request", return_value=util_load_json("test_data/close_incident.json", True))
...
def test_resolve_incident(mocker):
    ...
    mocker.patch("CommonServerPython.get_demisto_version", return_value={"version": "6.2.0"})
    mock_client = OpsGenieV3.Client(base_url="")
    mocker.patch.object(mock_client, "resolve_incident", return_value=util_load_json("test_data/request.json"))
    mocker.patch.object(mock_client, "get_request", return_value=util_load_json("test_data/resolve_incident.json", True))
...
def test_add_responder_incident(mocker):
    ...
    """
    mock_client = OpsGenieV3.Client(base_url="")
    mocker.patch.object(mock_client, "add_responder_incident", return_value=util_load_json("test_data/request.json"))
    mocker.patch.object(mock_client, "get_request", return_value=util_load_json("test_data/add_responder_incident.json", True))
...
def test_add_tag_incident(mocker):
    ...
    mocker.patch("CommonServerPython.get_demisto_version", return_value={"version": "6.2.0"})
    mock_client = OpsGenieV3.Client(base_url="")
    mocker.patch.object(mock_client, "add_tag_incident", return_value=util_load_json("test_data/request.json"))
    mocker.patch.object(mock_client, "get_request", return_value=util_load_json("test_data/add_tag_incident.json", True))
...
def test_remove_tag_incident(mocker):
    ...
    mocker.patch("CommonServerPython.get_demisto_version", return_value={"version": "6.2.0"})
    mock_client = OpsGenieV3.Client(base_url="")
    mocker.patch.object(mock_client, "remove_tag_incident", return_value=util_load_json("test_data/request.json"))
    mocker.patch.object(mock_client, "get_request", return_value=util_load_json("test_data/remove_tag_incident.json", True))
...
def test_get_teams(mocker):
    ...
    """
    mock_client = OpsGenieV3.Client(base_url="")
    mocker.patch.object(mock_client, "list_teams", return_value=util_load_json("test_data/get_teams.json"))
...
def test_fetch_incidents_command_no_result(mocker):
    ...
    mocker.patch("CommonServerPython.get_demisto_version", return_value={"version": "6.2.0"})
    mock_client = OpsGenieV3.Client(base_url="")
    mocker.patch.object(mock_client, "list_alerts", return_value=util_load_json("test_data/empty_response.json"))
    mocker.patch.object(mock_client, "list_incidents", return_value=util_load_json("test_data/empty_response.json"))
    mocker.patch.object(OpsGenieV3, "_get_utc_now", return_value=datetime(2021, 11, 26))
    mocker.patch.object(OpsGenieV3, "_parse_fetch_time", return_value="2021-11-23T12:19:48Z")
    res, last_run = OpsGenieV3.fetch_incidents_command(mock_client, {"max_fetch": 1})
    assert len(res) == 0
    assert last_run == {
        "Alerts": {"lastRun": "2021-11-26T00:00:00Z", "next_page": None},
...
def test_fetch_with_paging_only_alerts(mocker):
    ...
    mock_client = OpsGenieV3.Client(base_url="")
    mocker.patch.object(mock_client, "list_alerts", return_value=util_load_json("test_data/get_alerts.json"))
    mocker.patch.object(mock_client, "get_paged", return_value=util_load_json("test_data/get_alerts_without_next.json"))
    mocker.patch.object(OpsGenieV3, "_get_utc_now", return_value=datetime(2021, 11, 26))
    mocker.patch.object(OpsGenieV3, "_parse_fetch_time", return_value="2021-11-23T12:19:48Z")
    res, last_run = OpsGenieV3.fetch_incidents_command(mock_client, {"max_fetch": 2, "event_types": OpsGenieV3.ALERT_TYPE})
    assert last_run == {
        "Alerts": {
            "lastRun": "2021-11-26T00:00:00Z",
            "next_page": "https://api.opsgenie.com/v2/alerts?limit=1&sort=createdAt&offset=1&order=desc",
    ...
    res, last_run = OpsGenieV3.fetch_incidents_command(
        mock_client, {"max_fetch": 2, "event_types": OpsGenieV3.ALERT_TYPE}, last_run
    )
    assert last_run == {
        "Alerts": {"lastRun": "2021-11-26T00:00:00Z", "next_page": None},
        "Incidents": {"lastRun": None, "next_page": None},
...
def test_fetch_with_paging_only_incidents(mocker):
    ...
    mock_client = OpsGenieV3.Client(base_url="")
    mocker.patch.object(mock_client, "list_incidents", return_value=util_load_json("test_data/get_incidents.json"))
    mocker.patch.object(mock_client, "get_paged", return_value=util_load_json("test_data/get_incidents_without_next.json"))
    mocker.patch.object(OpsGenieV3, "_get_utc_now", return_value=datetime(2021, 11, 26))
    mocker.patch.object(OpsGenieV3, "_parse_fetch_time", return_value="2021-11-23T12:19:48Z")
    res, last_run = OpsGenieV3.fetch_incidents_command(mock_client, {"max_fetch": 2, "event_types": OpsGenieV3.INCIDENT_TYPE})
    assert last_run == {
        "Incidents": {
            "lastRun": "2021-11-26T00:00:00Z",
            "next_page": "https://api.opsgenie.com/v1/incidents?limit=1&sort=insertedAt&offset=1&order=desc",
    ...
    mocker.patch.object(demisto, "getLastRun", return_value=last_run)
    res, last_run = OpsGenieV3.fetch_incidents_command(
        mock_client, {"max_fetch": 2, "event_types": OpsGenieV3.INCIDENT_TYPE}, last_run
    )
    assert last_run == {
        "Incidents": {"lastRun": "2021-11-26T00:00:00Z", "next_page": None},
        "Alerts": {"lastRun": None, "next_page": None},
...
def test_build_query_fetch():
    ...
    Then:
        - Ensure the return data is correct
    """
    args = {"query": "createdAt < 147039484114", "status": "Open", "is_fetch_query": True, "priority": "P1,P3", "tags": "1,2"}
    mock_client = OpsGenieV3.Client(base_url="")
...
def test_build_query_not_fetch():
    ...
    Then:
        - Ensure the return data is correct
    """
    args = {"query": "createdAt < 147039484114", "status": "Open", "is_fetch_query": False, "priority": "P1,P3", "tags": "1,2"}
    mock_client = OpsGenieV3.Client(base_url="")
    res = mock_client.build_query(args)
...
def test_build_query_not_fetch_without_query():
    ...
    Then:
        - Ensure the return data is correct
    """
    args = {"status": "Open", "is_fetch_query": False, "priority": "P1,P3", "tags": "1,2"}
    mock_client = OpsGenieV3.Client(base_url="")
    res = mock_client.build_query(args)
...
def test_responders_to_json_empty_value():
    ...
    """
    mock_client = OpsGenieV3.Client(base_url="")
    res = mock_client.responders_to_json(responders={}, responder_key="responder")
    assert res == {}
...
def test_get_team_routing_rules(mocker):
    mock_client = OpsGenieV3.Client(base_url="")
    mocker.patch.object(
        mock_client, "get_team_routing_rules", return_value=util_load_json("test_data/get_team_routing_rules.json")
    )
...
def test_get_alert_logs(mocker):
    ...
    mocker.patch("CommonServerPython.get_demisto_version", return_value={"version": "6.2.0"})
    mock_client = OpsGenieV3.Client(base_url="")
    mocker.patch.object(mock_client, "get_alert_logs", return_value=util_load_json("test_data/get_alert_logs.json"))
...
def test_add_alert_note(mocker):
    ...
    mocker.patch("CommonServerPython.get_demisto_version", return_value={"version": "6.2.0"})
    mock_client = OpsGenieV3.Client(base_url="")
    mocker.patch.object(mock_client, "add_alert_note", return_value=util_load_json("test_data/request.json"))
    mocker.patch.object(mock_client, "get_request", return_value=util_load_json("test_data/add_alert_note.json", True))
...
def test_add_alert_details(mocker):
    ...
    mocker.patch("CommonServerPython.get_demisto_version", return_value={"version": "6.2.0"})
    mock_client = OpsGenieV3.Client(base_url="")
    mocker.patch.object(mock_client, "add_alert_details", return_value=util_load_json("test_data/request.json"))
    mocker.patch.object(mock_client, "get_request", return_value=util_load_json("test_data/add_alert_details.json", True))
