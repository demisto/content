...
def mock_client_func_for_paginate_with_page_num_and_size(args, pagination_args):
    ...
    assert args == "args"
    return {"results": list(range((page - 1) * count, page * count))}
...
def mock_client_func_for_paginate_with_token(args):
    ...
    return {"results": list(range(marker, marker + page_size)), "marker": marker + page_size}


@pytest.mark.parametrize(
    "token, page_size, limit, expected",
    [
        (1, 3, 10, ([1, 2, 3], 4)),
...
def test_fetch_incidents(mocker, data):
    ...
    request.assert_called_with(*data.http_func_args["args"], **data.http_func_args["kwargs"])
...
def test_attack_report_command(mocker):
    ...
    request.assert_called_with(*attack_report.http_func_args["args"], **attack_report.http_func_args["kwargs"])
...
def test_takedown_list_command(mocker):
    ...
    request.assert_called_with(*takedown_list.http_func_args["args"], **takedown_list.http_func_args["kwargs"])
...
def test_takedown_update_command(mocker):
    ...
    request.assert_called_with(*takedown_update.http_func_args["args"], **takedown_update.http_func_args["kwargs"])
...
def test_takedown_escalate_command(mocker):
    ...
    request.assert_called_with(*takedown_escalate.http_func_args["args"], **takedown_escalate.http_func_args["kwargs"])
...
def test_takedown_note_create_command(mocker):
    ...
    request.assert_called_with(*takedown_note_create.http_func_args["args"], **takedown_note_create.http_func_args["kwargs"])
...
def test_attack_type_list_command(mocker):
    ...
    request.assert_called_with(*attack_type_list.http_func_args["args"], **attack_type_list.http_func_args["kwargs"])
...
def test_submission_list_command(mocker):
    ...
    request.assert_called_with(*submission_list.http_func_args["args"], **submission_list.http_func_args["kwargs"])
...
def test_submission_list_command_with_uuid(mocker):
    ...
    request.assert_called_with(
        *submission_list_with_uuid.http_func_args["args"], **submission_list_with_uuid.http_func_args["kwargs"]
    )


@pytest.mark.parametrize("data", [file_report_submit_with_entry_id, file_report_submit_with_file_name_and_content])
...
def test_submission_file_list_command(mocker):
    ...
    request.assert_called_with(*submission_file_list.http_func_args["args"], **submission_file_list.http_func_args["kwargs"])
...
def test_email_report_submit_command(mocker):
    ...
    request.assert_called_with(*email_report_submit.http_func_args["args"], **email_report_submit.http_func_args["kwargs"])
...
def test_submission_mail_get_command(mocker):
    ...
    request.assert_called_with(*submission_mail_get.http_func_args["args"], **submission_mail_get.http_func_args["kwargs"])
...
def test_url_report_submit_command(mocker):
    ...
    request.assert_called_with(*url_report_submit.http_func_args["args"], **url_report_submit.http_func_args["kwargs"])
...
def test_submission_url_list_command(mocker):
    ...
    request.assert_called_with(*submission_url_list.http_func_args["args"], **submission_url_list.http_func_args["kwargs"])
...
def test_file_screenshot_get_command(mocker):
    ...
    request.assert_called_with(*file_screenshot_get.http_func_args["args"], **file_screenshot_get.http_func_args["kwargs"])
...
def test_file_screenshot_get_with_404(mocker):
    ...
    request.assert_called_with(
        *file_screenshot_get_404.http_func_args["args"], **file_screenshot_get_404.http_func_args["kwargs"]
    )
...
def test_mail_screenshot_get_command(mocker):
    ...
    request.assert_called_with(*mail_screenshot_get.http_func_args["args"], **mail_screenshot_get.http_func_args["kwargs"])
...
def test_url_screenshot_get_command(mocker):
    ...
    request.assert_called_with(*url_screenshot_get.http_func_args["args"], **url_screenshot_get.http_func_args["kwargs"])
