...
EPO_SYSTEM_ATTRIBUTE_MAP_EXTENDED = {
    ...
    'IsPortable': 'EPOComputerProperties.IsPortable',
    'LastAgentHandler': 'EPOComputerProperties.LastAgentHandler',
    'NetAddress': 'EPOComputerProperties.NetAddress',
    'NumOfCPU': 'EPOComputerProperties.NumOfCPU',
    'OSBitMode': 'EPOComputerProperties.OSBitMode',
