...
SCOPE_BY_CONNECTION = {
    "Device Code": "offline_access Group.ReadWrite.All TeamMember.ReadWrite.All Team.ReadBasic.All",
...
class Client:
    ...
    def list_teams_request(self) -> dict:
        return self.ms_client.http_request(
            method="GET", url_suffix="/beta/groups?$filter=resourceProvisioningOptions/Any(x:x eq 'Team')"
        )

    @logger
    def get_team_request(self, team_id: str) -> dict:
        return self.ms_client.http_request(method="GET", url_suffix=f"/v1.0/teams/{team_id}")
...
def create_team(client: Client, args: dict) -> str:
    ...
    client.create_team_request(
        ...
        allow_members_create_private_channels=argToBoolean(args.get("allow_members_create_private_channels", "false")),
        ...
        allow_members_add_remove_connectors=argToBoolean(args.get("allow_members_add_remove_connectors", "false")),
...
def list_teams(client: Client) -> CommandResults:
    ...
    return CommandResults(
        ...
        readable_output=tableToMarkdown("Microsoft Teams List", teams, ["id", "displayName", "createdDateTime", "description"]),
        outputs=teams,
