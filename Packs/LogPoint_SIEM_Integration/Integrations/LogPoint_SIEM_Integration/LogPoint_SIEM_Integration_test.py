...
def test_get_incidents_command(requests_mock):
    ...
    requests_mock.get("https://test.com/incidents", json=mock_response)
...
def test_get_incident_data_command(requests_mock):
    ...
    requests_mock.get("https://test.com/get_data_from_incident", json=mock_response)
...
def test_add_incident_comment_command(requests_mock):
    ...
    sample_add_incident_comment_response = {"success": True, "message": "Comments added"}
    mock_response = sample_add_incident_comment_response
    requests_mock.post("https://test.com/add_incident_comment", json=mock_response)
    ...
    args = {"incident_obj_id": "1262bd8cce113de890854455", "comment": "Hello world"}
...
def test_assign_incidents_command(requests_mock):
    ...
    sample_assign_incidents_response = {"success": True, "message": "Incidents re-assigned"}
    mock_response = sample_assign_incidents_response
    requests_mock.post("https://test.com/assign_incident", json=mock_response)
    ...
    args = {"incident_obj_ids": "1262bd8cce113de890854455,1262bd8cce113de890854456", "new_assignee": "12b0eacfd8cce4334eef1700"}
...
def test_resolve_incidents_command(requests_mock):
    ...
    sample_resolve_incidents_response = {"success": True, "message": "Incidents resolved"}
    mock_response = sample_resolve_incidents_response
    requests_mock.post("https://test.com/resolve_incident", json=mock_response)
    ...
    args = {"version": "0.1", "incident_obj_ids": "1262bd8cce113de890854455,1262bd8cce113de890854456"}
...
def test_close_incidents_command(requests_mock):
    ...
    sample_close_incidents_response = {"success": True, "message": "Incidents closed"}
    mock_response = sample_close_incidents_response
    requests_mock.post("https://test.com/close_incident", json=mock_response)
...
def test_reopen_incidents_command(requests_mock):
    ...
    sample_reopen_incidents_response = {"success": True, "message": "Incidents reopened"}
...
def test_get_users_command(requests_mock):
    ...
    requests_mock.get("https://test.com/get_users", json=mock_response)
...
def test_get_searchid_command(requests_mock):
    ...
    args = {"query": "| chart count() by col_type", "time_range": "Last 30 minutes", "limit": 10, "repos": []}
