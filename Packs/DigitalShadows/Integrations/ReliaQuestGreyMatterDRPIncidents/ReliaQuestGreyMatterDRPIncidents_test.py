...
from ReliaQuestGreyMatterDRPIncidents import Client
    ...
    return [
        {
            ...
            "risk-factors": ["Exposed on open source", "Plain text password", "More than a year old when raised"],
            "title": "The alert title",
            "description": "A description of this alert",
            "assets": [{"id": "1de8c226-16ef-4c44-a2b4-11a769e6b377"}],
...
class ClientMock:
    ...
    def http_request_side_effect(self, method: str, url_suffix: str, params: Dict | None = None, **kwargs):
        if url_suffix == "/v1/triage-item-events":
            ...
            "/v1/exposed-credential-alerts",
            "/v1/impersonating-domain-alerts",
            "/v1/impersonating-subdomain-alerts",
            "/v1/unauthorized-code-commit-alerts",
    ...
    return [
        {
            ...
            "state": "unread",
            "raised": "date",
            "source": {item_type: triage_item_id},
...
def create_assets(asset_ids: List[str]) -> List[Dict]:
    return [{"id": _id, "type": f"asset-{_id}", "approval-state": "accepted", "display-value": "test"} for _id in asset_ids]
