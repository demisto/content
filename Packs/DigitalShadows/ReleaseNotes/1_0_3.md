...
- Added a layout to better display Digital Shadows Client Incident data

##### New: Digital Shadows Intelligence Incident Layout
- Added a layout to better display Digital Shadows Intelligence Incident data
...
- Added a mapper to better populate XSOAR incident fields from Digital Shadows incidents

#### Classifiers
##### New: Digital Shadows Incident Classifier
- Classifier for Digital Shadows Incidents
...
#### Incident Fields
- **DS Impact**
Added field to capture the description of the potential impact of the risk identified by Digital Shadows
- **DS Mitigation**
Added field to capture the mitigation advice provided by Digital Shadows