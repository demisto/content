...
from NetskopeEventCollector_parallel import Client
...
def test_dedup_by_id():
    ...
    """
    from NetskopeEventCollector_parallel import dedup_by_id
...
def test_test_module_v2(mocker):
    ...
    """
    from NetskopeEventCollector_parallel import test_module
...
def test_populate_parsing_rule_fields():
    ...
    """
    from NetskopeEventCollector_parallel import populate_parsing_rule_fields
...
def test_get_all_events(mocker):
    ...
    """
    from NetskopeEventCollector_parallel import get_all_events
...
def test_get_events_command(mocker):
    ...
    """
    from NetskopeEventCollector_parallel import get_events_command
    client = Client(BASE_URL, 'dummy_token', 'v2', False, False)
