...
ALL_SUPPORTED_EVENT_TYPES = ['page', 'application', 'audit', 'network']
...
class Client(BaseClient):
    ...
    def get_events_request_v1(self, event_type: str, last_run: dict, skip: int = None) -> Dict:
        # body = {
    ...
    def get_alerts_request_v1(self, last_run: dict, skip: int = None) -> list[Any] | Any:  # pragma: no cover
        """
    ...
    def get_events_request_v2(self, event_type: str, last_run: dict, skip: int = None) -> Dict:
...
def get_all_events(client: Client, event_type: str, last_run: dict, skip: int) -> list:
    """
...
def get_events_v1(client: Client, last_run: dict, limit: Optional[int] = None) -> List[Any] | Any:  # pragma: no cover
    ...
    for event_type in ALL_SUPPORTED_EVENT_TYPES:
        ...
        if len(results) == MAX_EVENTS_PAGE_SIZE:
            all_events = get_all_events(client, event_type, last_run, skip)
        ...
        for event in results.reverse()[:limit]:
...
def main() -> None:  # pragma: no cover
    ...
    vendor, product = params.get('vendor', 'Shelly'), params.get('product', 'Shelly')
