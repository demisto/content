...
class Client(BaseClient):
    ...
    def get_events_request_v1(self, event_type: str, last_run: dict) -> Dict:
        # body = {
    ...
    def get_alerts_request_v1(self, last_run: dict) -> list[Any] | Any:  # pragma: no cover
        """
    ...
    def get_events_request_v2(self, event_type: str, last_run: dict) -> Dict:
