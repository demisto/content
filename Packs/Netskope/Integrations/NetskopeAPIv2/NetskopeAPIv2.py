...
class TimeArgs(NamedTuple):
    start_time_number: Optional[int]
    end_time_number: Optional[int]
    insertion_start_time_number: Optional[int]
    insertion_end_time_number: Optional[int]
...
def get_last_run(args: Dict[str, Any], incident_type: str) -> Tuple[Optional[Any], int]:
...
def get_updated_list_client(response: Union[List, Dict]) -> List:
...
def get_updated_url_list(response: Union[List, Dict]) -> List:
    """Updates URL list response.
...
def parse_start_end_times(
    start_str: str, end_str: Optional[str]
...
def arg_to_seconds_timestamp(arg: Union[str, datetime]) -> Optional[int]:
    """
...
def optional_arg_to_boolean(arg: Union[str, bool, None]) -> Optional[bool]:
