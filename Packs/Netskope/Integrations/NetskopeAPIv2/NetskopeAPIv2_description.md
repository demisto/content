...
3. On the newly opened window, in the left sidebar, click on "Tools" >> "REST API v2".
4. On the REST API v2 page, click on the "NEW TOKEN" button.
5. Click on "ADD ENDPOINT" to add the following endpoints to your API token:
    ...
    - api/v2/scim/Users
6. Make sure to fill in the "EXPIRE IN" & "TOKEN NAME" fields and click "SAVE".
...
The server URL consists Netskope account name and region.
