...
## Configure Netskope on Cortex XSOAR
...
| --- | --- | --- |
| query | Free query to filter the events. For example, "app eq Dropbox". | Optional |
...
| **Argument Name** | **Description** | **Required** |
| --- | --- | --- |
| query | Free query to filter the alerts. For example, "alert_name like 'test'". | Optional |
...
| **Argument Name** | **Description** | **Required** |
| --- | --- | --- |
| query | Free query on the clients, based on the client fields. For example, "host_info.hostname eq 'xxx'". | Optional |
| limit | The maximum amount of clients to retrieve. Default is 50. | Optional |
| page | The page number of the clients to retrieve (minimum is 1). Default is 1. | Optional |
