...
class DataExplorerClient:
    ...
    def search_query_execute_request(self, database_name: str, query: str,
        ...
        """
            ...
            client_activity_prefix argument and a random UUID.
        Args:
    ...
    def running_search_query_delete_request(self, database_name: str, client_activity_id: str, reason: str) -> Dict[
        str, Any]:
        """
