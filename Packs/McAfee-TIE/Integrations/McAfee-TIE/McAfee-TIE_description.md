...
To connect the McAfee TIE using the DXL TIE client, you need to create certificates and configure DXL. For more information, see the [DXL documentation](https://github.com/demisto/content/blob/master/Integrations/McAfee_DXL/README.md). After you complete this configuration, you will have the following files.
