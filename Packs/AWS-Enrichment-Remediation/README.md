...
#### AWS - Security Group Remediation v2
AWS - Security Group Remediation playbook more selectively determine which security groups are over-permissive, copies them and remove only the over-permissive portions.
