...
![AWS - Enrichment](../../doc_files/AWS_-_Enrichment.png/n)
...
![AWS - Security Group Remediation](../../doc_files/AWS_-_Security_Group_Remediation.png/n)
...
![AWS - Security Group Remediation v2](../../doc_files/AWS_-_Security_Group_Remediation_v2.png/n)

#### AWS - Unclaimed S3 Bucket Validation
AWS - Unclaimed S3 Bucket Validation playbook validates the unclaimed S3 bucket details.

![AWS - Unclaimed S3 Bucket Validation](../../doc_files/AWS_-_Unclaimed_S3_Bucket_Validation.png/n)

#### AWS - Unclaimed S3 Bucket Remediation
AWS - Unclaimed S3 Bucket Remediation playbook creates the unclaimed S3 bucket so other vectors can't claim the bucket.

![AWS - Unclaimed S3 Bucket Remediation](../../doc_files/AWS_-_Unclaimed_S3_Bucket_Remediation.png/n)
