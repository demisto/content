...
Added the *AWS - Security Group Remediation v2* playbook to more selectively determine which security groups are over-permissive, copies them and remove only the over-permissive portions.
