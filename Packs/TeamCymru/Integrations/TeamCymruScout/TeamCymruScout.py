...
class Client(BaseClient):
    ...
    def ip_request(self, ip: str, start_date: str | None, end_date: str | None, days: int | None, size: int | None) -> dict:
        """
    ...
    def scout_indicator_search_request(
        self, query: str, start_date: str | None, end_date: str | None, days: int | None, size: int | None
    ) -> dict:
        """
