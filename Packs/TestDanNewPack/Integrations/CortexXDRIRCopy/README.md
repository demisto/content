...
This integration was integrated and tested with version xx of Cortex XDR - IR_copy
...
| gte_first_seen | GTE irst seen timestamp in milliseconds. | Optional | 
...
***
Initiates a new endpoint script execution of shell commands. This command will be deprecated soon, use `xdr-script-commands-execute` instead.
