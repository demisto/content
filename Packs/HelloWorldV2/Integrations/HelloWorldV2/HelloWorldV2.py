...
def test_module(client: Client, name: str) -> str:
    ...
    :type name: ``str``
    :param name: Name argument to say hello to
...
def main() -> None:
    ...
    try:
        ...
        if demisto.command() == 'test-module':
            ...
            result = test_module(client, 'Dan')
            return_results(result)

        elif demisto.command() == 'helloworld-say-hello-new':
            return_results(say_hello_command(client, demisto.args()))

        elif demisto.command() == 'helloworld-get-alert-new':
