...
@pytest.mark.parametrize(
    "given_interval, fetch_interval, expected_min_interval",
    [less_then_max, a_bit_less_then_max, more_then_max, take_closer_second_value, take_closer_first_value],
)
...
@freeze_time("2022-11-23 11:00:00 UTC")
@pytest.mark.parametrize(
    "given_interval, fetch_interval, expected_min_interval", [take_min_sent_with_value, take_min_sent_without_value]
)
...
datetime_or_human_to_datetime = (
    datetime(2022, 11, 30, 00, 28, 24, tzinfo=utc) or "24 hours",
...
@pytest.mark.parametrize(
    "given_interval, expected_datetime",
    [
        human_to_datetime,
