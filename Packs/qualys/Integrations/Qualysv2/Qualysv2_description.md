...
- If a subscription has multiple users, all users with any user role (except Contact) can be used in setting up instance of this integration. Each user’s permissions correspond to their assigned user role.
