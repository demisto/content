...
def generate_asset_tag_xml_request_body(args: Dict[str, str], command_name: str):
    ...
    match command_name:
        case "qualys-asset-tag-list":
            pass
            # TODO: finish list case: check best way to pass 'Criteria' arguments
        ...
        case "qualys-asset-tag-create" | "qualys-asset-tag-update":
            ...
            if child_names := argToList(args.get("child_name")):
                ...
                ET.SubElement(children, _action)

                for child in child_names:
                    tag_simple = ET.Element("TagSimple")
                    ET.SubElement(tag_simple, child)
...
def qualys_command_flow_manager(
    ...
    # TODO: until this point everything should work. make sure there are appropriate 'result_handler' functions for the tag request outputs. if not, create new handler functions @ """ HANDLERS """ segment.
...
def main():
    ...
    try:
        ...
        if requested_command == "test-module":
            ...
            return_results(qualys_command_flow_manager(client, args, requested_command, commands_methods[requested_command]))
