First launches a  remediation report and then fetch the report when it's ready.
...
## Playbook Image
---
![Launch And Fetch Remediation Report - Qualys](../doc_files/Launch_And_Fetch_Remediation_Report_-_Qualys.png)