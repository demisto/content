...
| Authentication Type | The type of authentication. Relevant only for Cortex XSOAR and Cortex XSIAM. On Cortex Platform, authentication is handled automatically and this field is ignored. Can be Client Credentials Flow \(recommended\), Device Code Flow, Authorization Code Flow, or Azure Managed Identities. | False |
...
| --- | --- | --- |
| subscription_id | The Azure subscription ID. Required for Cortex XSIAM (version &gt;= 3.0) and Cortex Cloud; optional for Cortex XSOAR and Cortex XSIAM (version &lt; 3.0), where it can be retrieved from the integration configuration. | Optional |
