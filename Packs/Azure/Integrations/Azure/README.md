...
| tier | The tier of the firewall policy. Possible values are Standard, Premium, or Basic. Possible values are: Standard, Premium, Basic. Default is Standard. | Required | 
| threat_intelligence_mode | The operation mode for threat intelligence. Possible values are Alert, Deny, or Off. Possible values are: Alert, Deny, Off. | Optional | 
