...
3. Click **Add instance** to create and configure a new integration instance.
    ...
    | Index time field (for sorting sort and limiting data) | The time field on which sorting and limiting is done. If using nested field, separate fields name using a dot. | False |
