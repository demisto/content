from XFE_v2 import Client, ip_command, url_command, cve_get_command, cve_search_command, file_command, whois_command
...
MOCK_INVALID_IP_RESP = {"ip": "8.8.8.8", "history": [], "subnets": [], "cats": {}, "score": 1, "tags": []}

MOCK_URL_RESP = {
    "result": {
        "url": "https://www.google.com",
        "cats": {"Search Engines / Web Catalogs / Portals": True},
        "score": 1,
        "categoryDescriptions": {"Search Engines / Web Catalogs / Portals": "This category contains search engines."},
    },
    "associated": [
        {
            "url": "google.com",
...
MOCK_CVE_RESP = [
    {
        ...
        "stdcode": ["BID-67054", "SA58224", "CVE-2014-2601"],
        "platforms_affected": ["HP Integrated Lights-Out 2 (iLO2) 2.23"],
...
MOCK_RECENT_CVE_RESP = [
    {
        ...
        "platforms_affected": ["WordPress Resim Ara plugin for WordPress 1.0"],
        "platforms_dependent": ["WordPress WordPress"],
        "exploitability": "High",
...
MOCK_HASH_RESP = {
    "malware": {
        ...
        "family": ["tsunami"],
        "familyMembers": {"tsunami": {"count": 61}},
        "risk": "high",
    },
    "tags": [],
}
...
MOCK_HOST_RESP = {
    ...
    "contact": [{"type": "registrant", "organization": "Google LLC", "country": "United States"}],
    "extended": {
        "createdDate": "1997-09-15T07:00:00.000Z",
        "updatedDate": "2019-09-09T15:39:04.000Z",
        "expiresDate": "2028-09-13T07:00:00.000Z",
    ...
    "rows": [
        {
            ...
            "references": [
                ...
                {"link_target": "", "link_name": "CVE-2019-11873", "description": "wolfSSL 4.0.0 has a Buffer Overflow."},
            ],
            "report_confidence": "Confirmed",
        }
    ],
