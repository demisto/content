...
def test_opnsense_alias_mod(requests_mock):
    ...
    mock_args = {
        "uuid": "8abfa542-4031-4e63-9ccd-34ffd31886d4",
        "description": "MyRenamedAlias",
        "content": "1.2.3.4",
        "name": "RenamedAlias",
    }
    mock_response = util_load_json("test_data/opnsense_alias_mod.json")
    requests_mock.get(
        "https://opnsense.mockserver.com/api/firewall/alias/getItem/8abfa542-4031-4e63-9ccd-34ffd31886d4/", json=mock_response
    )
    mock_response2 = {"result": "saved"}
    requests_mock.post(
        "https://opnsense.mockserver.com/api/firewall/alias/setItem/8abfa542-4031-4e63-9ccd-34ffd31886d4/", json=mock_response2
    )
    client = Client(MOCK_PARAMETERS)
...
def test_opnsense_alias_del(requests_mock):
    ...
    requests_mock.post(
        "https://opnsense.mockserver.com/api/firewall/alias/delItem/8abfa542-4031-4e63-9ccd-34ffd31886d4/", json=mock_response
    )
    client = Client(MOCK_PARAMETERS)
...
def test_opnsense_states_del(requests_mock):
    ...
    requests_mock.post(
        "https://opnsense.mockserver.com/api/diagnostics/firewall/delState/0006466200000003/ef725303", json=mock_response
    )
    client = Client(MOCK_PARAMETERS)
...
def test_opnsense_category_list(requests_mock):
    ...
    mock_response = {
        "rows": [
            {"uuid": "cef2c7d7-68d8-41aa-b6b8-1cac38554d58", "name": "Categ1", "auto": "1", "color": ""},
...
def test_opnsense_category_del(requests_mock):
    ...
    mock_response = {"result": "deleted"}
    requests_mock.post(
        "https://opnsense.mockserver.com/api/firewall/category/delItem/e291bafc-0696-457b-aa97-6377af4a818a/", json=mock_response
    )
    client = Client(MOCK_PARAMETERS)
...
def test_opnsense_category_get(requests_mock):
    ...
    requests_mock.get(
        "https://opnsense.mockserver.com/api/firewall/category/getItem/e291bafc-0696-457b-aa97-6377af4a818a/", json=mock_response
    )
    client = Client(MOCK_PARAMETERS)
...
def test_opnsense_category_mod(requests_mock):
    ...
    mock_response = {"category": {"name": "NewCategory", "auto": "0", "color": ""}}
    requests_mock.get(
        "https://opnsense.mockserver.com/api/firewall/category/getItem/8abfa542-4031-4e63-9ccd-34ffd31886d4/", json=mock_response
    )
    mock_response2 = {"result": "saved"}
    requests_mock.post(
        "https://opnsense.mockserver.com/api/firewall/category/setItem/8abfa542-4031-4e63-9ccd-34ffd31886d4/", json=mock_response2
    )
    client = Client(MOCK_PARAMETERS)
...
def test_opnsense_fw_rule_list(requests_mock):
    ...
    mock_response = {
        "rows": [
            {"uuid": "443ebf6b-e4d5-4317-84ad-dca961b4821d", "enabled": "1", "sequence": "1", "description": "Rule1"},
            {"uuid": "443ebf6b-e4d5-4317-84ad-dca961b4821d", "enabled": "1", "sequence": "1", "description": "Rule2"},
        ],
        "rowCount": 1,
        "total": 1,
        "current": 1,
...
def test_opnsense_fw_rule_get(requests_mock):
    ...
    requests_mock.get(
        "https://opnsense.mockserver.com/api/firewall/filter/getRule/e37b5bb2-b96f-455a-a2cb-5542103e5ac2/", json=mock_response
    )
    client = Client(MOCK_PARAMETERS)
...
def test_opnsense_fw_rule_del(requests_mock):
    ...
    mock_response = {"result": "deleted"}
    requests_mock.post(
        "https://opnsense.mockserver.com/api/firewall/filter/delRule/e37b5bb2-b96f-455a-a2cb-5542103e5ac2/", json=mock_response
    )
    client = Client(MOCK_PARAMETERS)
...
def test_opnsense_fw_rule_mod(requests_mock):
    ...
    mock_response2 = {"result": "saved"}
    requests_mock.post(
        "https://opnsense.mockserver.com/api/firewall/filter/setRule/e37b5bb2-b96f-455a-a2cb-5542103e5ac2/", json=mock_response2
    )
    client = Client(MOCK_PARAMETERS)
