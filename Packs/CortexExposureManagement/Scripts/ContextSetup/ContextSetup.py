...
def context_setup(keys: list[str], vals: dict, res_list: list) -> list[str]:
    ...
    :param res_list: list of current entries in context key (or blank list)
...
def context_setup_command(args: dict[str, str]) -> CommandResults:
    ...
    result = context_setup(keys, vals, orig)
