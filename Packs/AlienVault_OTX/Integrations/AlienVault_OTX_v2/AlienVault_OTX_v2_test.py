...
FILE_ANALYSIS_RAW_RESPONSE = {
    ...
    "analysis": {
        ...
        "has_S3": True,
        "plugins": {},
        "datetime_int": "2016-04-14T12:24:43",
...
URL_RAW_RESPONSE = {
    ...
    "pulse_info": {
        ...
        "references": [],
        "related": {
            "alienvault": {"adversary": [], "industries": [], "malware_families": [], "unique_indicators": 0},
            "other": {"adversary": [], "industries": [], "malware_families": [], "unique_indicators": 0},
        },
    },
    "sections": ["general", "url_list", "http_scans", "screenshot"],
    "type": "url",
    "type_title": "URL",
    "validation": [],
...
DOMAIN_RAW_RESPONSE = {
    ...
    "pulse_info": {
        ...
        "references": [],
        "related": {
            "alienvault": {"adversary": [], "industries": [], "malware_families": []},
            "other": {"adversary": [], "industries": [], "malware_families": []},
        },
    },
    ...
    "type_title": "Domain",
    "validation": [
        {"message": "Whitelisted domain alienvault.com", "name": "Whitelisted domain", "source": "majestic"},
        {"message": "Whitelisted domain alienvault.com", "name": "Whitelisted domain", "source": "whitelist"},
    ],
...
DOMAIN_EC = {
    "Domain(val.Name && val.Name == obj.Name)": [{"Name": {"domain": "otx.alienvault.com"}}],
    "DBotScore(val.Indicator && val.Indicator == obj.Indicator && val.Vendor == obj.Vendor && val.Type == obj.Type)": [
        {
            "Indicator": {"domain": "otx.alienvault.com"},
            "Type": "domain",
            "Vendor": "AlienVault OTX v2",
            "Score": 1,
            "Reliability": "C - Fairly reliable",
...
IP_RAW_RESPONSE_WITH_RELATIONSHIPS = {
        ...
        "pulses": [
            {
                ...
                "attack_ids": [
                    ...
                    {"display_name": "T1040 - Network Sniffing", "id": "T1040", "name": "Network Sniffing"},
                    {"display_name": "T1053 - Scheduled Task/Job", "id": "T1053", "name": "Scheduled Task/Job"},
                    {
                        "display_name": "T1060 - Registry Run Keys / Startup Folder",
                        "id": "T1060",
                        "name": "Registry Run Keys / Startup Folder",
                    },
                    {"display_name": "T1071 - Application Layer Protocol", "id": "T1071", "name": "Application Layer Protocol"},
                ],
                "author": {
                ...
                "public": 1,
                "pulse_source": "web",
                "references": ["The following is the full set of results for the 2016 Windows World Cup"],
    ...
    "type": "IPv4",
    "type_title": "IPv4",
    "validation": [{"message": "contained in whitelisted prefix", "name": "Whitelisted IP", "source": "whitelist"}],
    ...
    "IP(val.Address && val.Address == obj.Address)": [
        {
            ...
            "ASN": "AS36647 YAHOO-GQ1",
            "Geo": {"Location": "37.751:-97.822", "Country": "US"},
            "Relationships": [
                {
...
IP_URL_RAW_RESPONSE_WITH_RELATIONSHIPS = {
    "url_list": [
        {
            "url": "mojorojorestaurante.com",
            "date": "2022-01-03T08:21:31",
            "domain": "mojorojorestaurante.com",
            "hostname": "mojorojorestaurante.com",
            "result": {"urlworker": {"ip": "8.8.8.8", "http_code": 200}, "safebrowsing": {"matches": []}},
            "httpcode": 200,
            "gsb": [],
            "encoded": "https%3A//mojorojorestaurante.com",
        }
    ],
    "page_num": 1,
    "limit": 10,
...
IP_DNS_RAW_RESPONSE_WITH_RELATIONSHIPS = {
    "passive_dns": [
        {
            "address": "8.8.8.8",
            "first": "2022-01-04T08:25:39",
            "last": "2022-01-04T08:25:39",
            "hostname": "nguyenhoangai-4g.xyz",
            "record_type": "A",
...
@pytest.mark.parametrize(
    "raw_response_general,raw_response_analysis,expected",
    [
...
def test_url_command_not_found(mocker):
    ...
    """
    url = (
        "http://url2447.staywell.com/asm/unsubscribe/?user_id=275860%5C%5Cu0026data=LeFzS0ZTdINxJN2UMVFvyPotO31n"
...
@pytest.mark.parametrize(
    "raw_response,url_raw_response,file_raw_response,dns_raw_response,expected",
...
def test_ip_command(
    mocker, ip_, raw_response, url_raw_response, file_raw_response, dns_raw_response, expected_ec, expected_relationships
):
    """
    Given
    - An IPv4 address.
...
@pytest.mark.parametrize(
    "entities_list,field_name,expected_results",
    [
        (
        ...
        (
            [{"url": "www.site1.com"}, {"url": "www.site1.com"}, {"url": "www.site2.com"}, {"url": "www.site1.com"}],
            "url",
