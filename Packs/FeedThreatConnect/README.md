The Threat Connect feed provides access to published IOCs that contain known indicators. You can configure the number of indicators to be returned. The default is 500.
