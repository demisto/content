...
function tableFromEnvironments(response) {
    ...
    for (var i = 0; i < environmentsKeys.length; i++){
        ...
        table[i] = {
            ...
            'total VMS': currentEnvironment.VMs_total,
...
function csResult(hash, environmentId, fileType, jobID) {
    ...
    var cmdUrl = (version === 'v1') ? '/api/result/' + hash + '?type=json&environmentId=' + args.environmentId : '/api/v2/report/' + csID + '/file/' + fileType;
