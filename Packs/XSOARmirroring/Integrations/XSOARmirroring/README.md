...
3. Click **Add instance** to create and configure a new integration instance.
    ...
    | Reset mirror | Will mirror all notes,tags and attachments for incidents. Notice can impact performance if combined with "Reset the "last run" timestamp" and multiple incidents in system. | False |
