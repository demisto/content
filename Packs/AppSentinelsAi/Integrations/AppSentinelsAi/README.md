...
| Fetch events |  | False |
| Maximum number of audit logs per fetch | Maximum number of Audit Logs entries to retrieve per fetch cycle. | False |
...
| first_fetch | The UTC date or relative timestamp from where to start fetching events. Supported formats: N minutes, N hours, N days, N weeks, N months, N years, yyyy-mm-dd, yyyy-mm-ddTHH:MM. | Optional |
