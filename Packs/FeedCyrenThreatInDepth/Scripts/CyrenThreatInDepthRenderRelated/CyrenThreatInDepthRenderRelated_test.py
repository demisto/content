        ...
        "cyrenfeedrelationships": [
            {
                ...
                "timestamp": "2020-10-28T14:45:24.921Z",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        " test ",
        "IndicatorType",
        "RepuTation,Indicator Type",
        "other,Indicator Type",
        "Indicator Type,other,Reputation",
    ],
)
...
@pytest.mark.parametrize(
    "columns",
    [
        "Indicator Type, Reputation   ,  Value",
        "   Indicator Type, Reputation   ,  Value     ",
        "   Indicator Type, Reputation   ,  Value     ,Value",
        "Indicator Type",
        " Indicator Type      ",
    ],
)
...
def test_cyren_feed_relationship_with_search_response_other_columns(mocker, indicator):
    """
    Given: File hash indicator.
    When: Running cyren_feed_relationship command.
    Then: Verify expected results returns
...
RELATED_INDICATOR_OBJECTS_PACK = [
    (
        ...
        "relates to",
        "some-type",
        "2020-10-28T14:45:24.921Z",
        "phishing",
        Common.DBotScore.BAD,
        {
            "Value": "value1\n",
            "Reputation": "Bad (3)",
            "Entity Category": "phishing",
            "Relationship Type": "relates to",
            "Indicator Type": "some-type",
            "Timestamp UTC": "2020-10-28, 14:45:24",
        },
    ),
    (
        "value1",
    ...
    (
        ...
        Common.DBotScore.SUSPICIOUS,
        {
            ...
            "Relationship Type": "relates to",
            "Indicator Type": "some-type",
            "Timestamp UTC": "2020-10-28, 00:00:00",
        },
    ),
    (
        "value1",
        ...
        Common.DBotScore.SUSPICIOUS,
        {
            ...
            "Relationship Type": "relates to",
            "Indicator Type": "some-type",
            "Timestamp UTC": "11",  # Invalid timestamp
        },
    ),
]
...
def test_create_related_indicator_object(
    ...
    """
    from CyrenThreatInDepthRenderRelated import create_relationship_object

    assert (
        create_relationship_object(value, relationship_type, indicator_type, timestamp, entity_category, reputation)
        == expected_output
    )
