...
def test_fetch_indicators_output_ip_reputation(requests_mock, ip_reputation):
    ...
    assert created[0]["fields"] == {"updateddate": "2020-10-29T05:15:29.062Z",
    ...
    assert created[1]["fields"] == {"updateddate": "2020-10-29T05:15:29.062Z",
    ...
    assert created[2]["fields"] == {"updateddate": "2020-10-29T05:15:29.062Z",
    ...
    assert created[3]["fields"] == {"updateddate": "2020-10-29T05:15:29.062Z",
    ...
    assert created[4]["fields"] == {"updateddate": "2020-10-29T05:15:29.062Z",
    ...
    assert created[5]["fields"] == {"updateddate": "2020-10-29T05:15:29.062Z",
                                    "published": "2020-10-29T05:15:29.062Z",
    ...
    assert created[6]["fields"] == {"updateddate": "2020-10-29T05:15:29.062Z",
    ...
    assert created[7]["fields"] == {"updateddate": "2020-10-29T05:15:29.062Z",
                                    "published": "2020-10-29T05:15:29.062Z",
...
def test_fetch_indicators_output_malware_files(requests_mock, malware_files):
    ...
    assert created[0]["fields"] == {
        "cyrenfeedrelationships": [{"indicatortype": "SHA-256",
    ...
    assert created[1]["fields"] == {"updateddate": "2020-10-28T14:45:24.921Z",
    ...
    assert created[3]["fields"] == {"updateddate": "2020-10-28T14:45:24.921Z",
                                    "published": "2020-10-28T14:45:24.921Z",
    ...
    assert created[5]["fields"] == {"updateddate": "2020-10-28T14:45:24.921Z",
    ...
    assert created[7]["fields"] == {"updateddate": "2020-10-28T14:45:24.921Z",
...
def test_fetch_indicators_output_malware_urls(requests_mock, malware_urls):
    ...
    assert created[0]["fields"] == {
        "cyrenfeedrelationships": [{"indicatortype": "URL",
    ...
    assert created[2]["fields"] == {"indicatoridentification": "045541ea-fd19-5c08-bb60-437ce08cc08f",
    ...
    assert created[5]["fields"] == {"indicatoridentification": "05040e64-a035-5014-8564-9c8faaf4da83",
                                    "updateddate": "2020-11-01T17:45:16.268Z",
                                    "published": "2020-11-01T17:45:16.268Z",
                                    "cyrenfeedrelationships": [
                                        {"indicatortype": "IP",
    ...
    assert created[6]["fields"] == {"indicatoridentification": "05040e64-a035-5014-8564-9c8faaf4da84",
                                    "updateddate": "2020-11-01T17:45:16.268Z"}
    assert created[6]["score"] == Common.DBotScore.NONE
    ...
    assert created[7]["fields"] == {"updateddate": "2020-11-01T17:45:16.268Z",
...
def test_fetch_indicators_output_phishing_urls(requests_mock, phishing_urls):
    ...
    assert created[1]["fields"] == {"indicatoridentification": "025859f4-4b07-58de-953b-0ed2bdc7ee0f",
    ...
    assert created[3]["fields"] == {"indicatoridentification": "054f305a-f39c-51b7-b2c3-9f8c281ff1ea",
                                    "updateddate": "2020-11-01T17:05:26.347Z",
    ...
    assert created[5]["fields"] == {"indicatoridentification": "054f305a-f39c-51b7-b2c3-9f8c281ff1eb",
                                    "updateddate": "2020-11-01T17:05:26.347Z",
                                    "cyrenfeedrelationships": [
                                        {"indicatortype": "IP",
                                         "relationshiptype": "resolves to",
    ...
    assert created[7]["fields"] == {"updateddate": "2020-11-01T17:05:26.347Z",
...
@pytest.mark.parametrize("offset_data, context_data, offset, expected_text, expected_offset", [
    (
        {"startOffset": 1, "endOffset": 1000}, {}, None,
        (
    ...
    (
        {"startOffset": 1, "endOffset": 1000}, {}, 900,
        (
    ...
    (
        {"startOffset": 1, "endOffset": 1000}, {}, 1000,
        (
            "Reset Cyren Threat InDepth ip_reputation feed client offset to 1000 "
            "(API provided max offset of 1000, was not set before)."
        ),
    ...
    (
        {"startOffset": 1, "endOffset": 1000}, {}, 1001,
        (
            "Reset Cyren Threat InDepth ip_reputation feed client offset to 1000 "
            "(API provided max offset of 1000, was not set before)."
        ),
...
@pytest.mark.parametrize("offset_data, context_data, expected_text", [
    ...
    (
        {"startOffset": 1, "endOffset": 1000}, {"offset": 500},
        (
