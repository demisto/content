...
class VTFile(Common.File):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(dbot_score, **kwargs)
...
class VTIP(Common.IP):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(ip, dbot_score, **kwargs)
...
class VTURL(Common.URL):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(url, dbot_score, **kwargs)
...
class VTDomain(Common.Domain):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(domain, dbot_score, **kwargs)
...
class Client(BaseClient):
    ...
    def __init__(self, params: dict):
        ...
        super().__init__(
            ...
            headers={"x-apikey": params["credentials"]["password"], "x-tool": "CortexVirusTotalV3"},
        )
    ...
    def get_relationship(self, indicator: str, indicator_type: str, relationship: str) -> dict:
        ...
        See Also:
            ...
            https://docs.virustotal.com/reference/ip-relationships
        """
        return self._http_request("GET", urljoin(urljoin(indicator_type, indicator), relationship))
...
class ScoreCalculator:
    ...
    def __init__(self, params: dict):
        ...
        self.relationship_threshold = {
            "malicious": arg_to_number_must_int(
                params["relationship_threshold"], arg_name="Relationship Files Malicious Threshold", required=True
            ),
            "suspicious": arg_to_number_must_int(
    ...
    def is_malicious_or_suspicious_by_relationship_files(self, relationship_files_response: dict, lookback=20) -> int:
        ...
        if total_suspicious >= self.relationship_threshold["suspicious"]:
            ...
            return Common.DBotScore.SUSPICIOUS
        self.logs.append(f'Found safe by relationship files. {total_malicious} < {self.relationship_threshold["suspicious"]}')
        return Common.DBotScore.GOOD

    def analyze_premium_scores(self, indicator: str, base_score: int, relationship_functions: List[Callable[[str], dict]]) -> int:
    ...
    def analyze_premium_url_score(self, client: Client, url: str, base_score: int) -> int:
        ...
        return self.analyze_premium_scores(
            url, base_score, [client.get_url_communicating_files, client.get_url_downloaded_files, client.get_url_referrer_files]
        )
    ...
    def analyze_premium_domain_score(self, client: Client, domain: str, base_score: int) -> int:
        ...
        return self.analyze_premium_scores(
            domain,
            base_score,
            [client.get_domain_communicating_files, client.get_domain_downloaded_files, client.get_domain_referrer_files],
        )
    ...
    def analyze_premium_ip_score(self, client: Client, ip: str, base_score: int) -> int:
        ...
        """
        return self.analyze_premium_scores(
            ip, base_score, [client.get_ip_communicating_files, client.get_ip_downloaded_files, client.get_ip_referrer_files]
        )
...
def _get_domain_indicator(client: Client, score_calculator: ScoreCalculator, domain: str, raw_response: dict):
    ...
    vt_vendors_which_flagged_malicious = {
        x["engine_name"]: x["result"]
        for x in attributes.get("last_analysis_results", {}).values()
...
def build_domain_output(
    ...
    return CommandResults(
        ...
        readable_output=tableToMarkdown(
            ...
            headers=["id", "Registrant Country", "Registrar", "last_modified", "reputation", "positives"],
            removeNull=True,
