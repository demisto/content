...
def test_fetch_indicators_command(mocker):
    ...
    assert fields['tags'] == ['elf']
    assert fields['ssdep'] == '192:YRNBDSQzGNtEhwAowjDll4dFA/4OJaVw:wCQzGNtijowjD4jAQy'
    assert fields['size'] == 8316
    assert fields['times_submitted'] == 1
