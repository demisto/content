    ...
    "data": [
        {
            ...
            "links": {"self": "https://www.virustotal.com/ui/intelligence/retrohunt_jobs/Diviei-1637919938"},
        }
    ],
    "links": {"self": "https://www.virustotal.com/ui/users/Diviei/retrohunt_jobs?limit=10"},
    "meta": {"count": 1},
}
    ...
    "data": [
        {
            ...
            "links": {"self": "https://www.virustotal.com/loremipsum"},
            "context_attributes": {"rule_name": "wannacry_2", "match_in_subfile": False},
        }
    ],
    "links": {"self": "https://www.virustotal.com/loremipsum", "next": "https://www.virustotal.com/loremipsum"},
    "meta": {"count": 1, "cursor": "STI1Ci4="},
}


def test_fetch_indicators_command(mocker):
    client = Client("https://fake")
    mocker.patch.object(client, "fetch_jobs", return_value=MOCK_VT_JOBS)
    mocker.patch.object(client, "fetch_job_matches", return_value=MOCK_VT_JOB_MATCHES)
