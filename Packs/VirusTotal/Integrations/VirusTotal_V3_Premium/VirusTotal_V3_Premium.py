...
def convert_epoch_to_readable(
    readable_inputs: dict, keys: Iterable[str] = ("start_date", "creation_date", "finish_date")
) -> dict:
...
def get_time_range_object(start_time: Optional[str] = None, end_time: Optional[str] = None) -> Dict[str, int]:
    ...
    if start_time and end_time:
        ...
        time_range = {"start": int(start_date.timestamp()), "end": int(end_date.timestamp())}
    elif start_time:
...
def raise_if_hash_not_valid(file_hash: str, valid_hashes: Union[tuple, str] = ("sha256", "sha1", "md5")):
...
class Client(BaseClient):
    def __init__(self, params: dict):
        ...
        super().__init__(
            ...
            headers={"x-apikey": self.api_key, "x-tool": "CortexVirusTotalV3Premium"},
        )
    ...
    def download_file(self, file: str) -> requests.Response:
        ...
        """
        return self._http_request("GET", f"files/{file}/download", allow_redirects=True, resp_type="response")
    ...
    def create_zip(self, hashes: list, password: Optional[str] = None) -> dict:
        ...
        """
        body: dict = {"hashes": hashes}
        if password:
            body["password"] = password
        return self._http_request("POST", "intelligence/zip_files", json_data={"data": body})
    ...
    def get_zip(self, zip_id: str) -> dict:
        ...
        """
        return self._http_request("GET", f"intelligence/zip_files/{zip_id}")
    ...
    def get_pcap_beaviour(self, report_id) -> dict:
        ...
        """
        return self._http_request("GET", f"file_behaviours/{report_id}/pcap", resp_type="content")
    ...
    def search_intelligence(
        ...
        return self._http_request(
            "GET",
            "intelligence/search",
            params=assign_params(query=query, cursor=cursor, order=order, limit=limit, descriptors_only=descriptors_only),
        )
    ...
    def get_livehunt_rule_by_id(self, id_: str):
        ...
        """
        return self._http_request("GET", f"intelligence/hunting_rulesets/{id_}")
    ...
    def list_livehunt_rules(
        ...
        return self._http_request(
            "GET", "intelligence/hunting_rulesets", params=assign_params(filter=filter_, limit=limit, order=order)
        )

    def create_livehunt_rule(
        self, name: str, yara_rule: str, enabled: Optional[bool], limit: Optional[int], notification_emails: Optional[List[str]]
    ) -> dict:
            ...
            json_data={
                "data": {
                    ...
                    "attributes": assign_params(
                        name=name, enabled=enabled, rules=yara_rule, limit=limit, notification_emails=notification_emails
                    ),
                }
            },
        )
    ...
    def update_livehunt_rule(
        ...
        See Also:
            https://docs.virustotal.com/reference/create-hunting-ruleset
        """
        params = assign_params(enabled=enabled, rules=yara_rule, limit=limit, notification_emails=notification_emails)
        assert params, "Found nothing to update"
        return self._http_request(
            "PATCH",
            f"intelligence/hunting_rulesets/{id_}",
            json_data={"data": {"type": "hunting_ruleset", "id": id_, "attributes": params}},
        )
    ...
    def delete_livehunt_rule(self, id_: str):
        ...
        """
        self._http_request("DELETE", f"intelligence/hunting_rulesets/{id_}", resp_type="text")
    ...
    def list_notifications(
        ...
        return self._http_request(
            "GET", "intelligence/hunting_notifications", params=assign_params(filter=filter_, limit=limit, cursor=cursor)
        )
    ...
    def list_notifications_files(self, filter_: Optional[str], cursor: Optional[str] = None, limit: Optional[int] = None):
        ...
        """
        return self._http_request(
            "GET", "intelligence/hunting_notification_files", params=assign_params(filter=filter_, limit=limit, cursor=cursor)
        )
    ...
    def list_files_by_rule(self, id_: str, cursor: Optional[str] = None, limit: Optional[int] = None) -> dict:
        ...
        return self._http_request(
            ...
            params=assign_params(cursor=cursor, limit=limit),
        )

    def list_retrohunt_jobs(
        self, filter_: Optional[str] = None, cursor: Optional[str] = None, limit: Optional[int] = None
    ) -> dict:
        ...
        """
        return self._http_request(
            "GET", "intelligence/retrohunt_jobs", params=assign_params(filter=filter_, limit=limit, cursor=cursor)
        )
        ...
        return self._http_request(
            ...
            json_data={
                "data": {
                    "type": "retrohunt_job",
                    "attributes": assign_params(
                        rules=rules, notification_email=notification_email, corpus=corpus, time_range=time_range
                    ),
                }
            },
        )
    ...
    def get_retrohunt_job_by_id(self, id_: str) -> dict:
        ...
        """
        return self._http_request("GET", f"intelligence/retrohunt_jobs/{id_}")
    ...
    def get_retrohunt_job_matching_files(self, id_: str) -> dict:
        ...
        """
        return self._http_request("GET", f"intelligence/retrohunt_jobs/{id_}/matching_files")
    ...
    def get_quota_limits(self, id_: str) -> dict:
        ...
        """
        return self._http_request("GET", f"users/{id_}/overall_quotas")
...
def search_intelligence(client: Client, args: dict) -> CommandResults:
    ...
    data = raw_response["data"]
    return CommandResults(f"{INTEGRATION_ENTRY_CONTEXT}.IntelligenceSearch", "id", outputs=data, raw_response=raw_response)
...
def get_livehunt_rule(client: Client, args: dict) -> CommandResults:
    ...
    return CommandResults(
        ...
        outputs=data,
        raw_response=raw_response,
        readable_output=tableToMarkdown(f"Livehunt Ruleset {id_}", readable_output, headers=["name", "enabled", "rule_names"]),
    )
...
def list_livehunt_rules(client: Client, args: dict) -> CommandResults:
    ...
    raw_response = client.list_livehunt_rules(limit=limit, name=name, enabled=enabled, rule_content=rule_content, order=order)
    data = raw_response.get("data", [])
    return CommandResults(
        f"{INTEGRATION_ENTRY_CONTEXT}.LiveHuntRule",
        "id",
        ...
        readable_output=tableToMarkdown(
            ...
            [{**item.get("attributes", {}), "id": item.get("id")} for item in data],
...
def create_livehunt_rule(client: Client, args: dict) -> CommandResults:
    ...
    return CommandResults(
        ...
        readable_output=tableToMarkdown(
            ...
            {**outputs, **outputs.get("attributes", {})},
...
def delete_livehunt_rules(client: Client, args: dict) -> CommandResults:
    ...
    return CommandResults(readable_output=f'Rule "{id_}" was deleted successfully')
...
def list_notifications(client: Client, args: dict) -> CommandResults:
    ...
    return CommandResults(
        ...
        "id",
        readable_output=tableToMarkdown("Notifications found:", outputs.get("data", {}), headers=["id"]),
        outputs=outputs,
        raw_response=raw_response,
    )
...
def list_files_by_rule(client: Client, args: dict) -> CommandResults:
    ...
    return CommandResults(
        f"{INTEGRATION_ENTRY_CONTEXT}.LiveHuntFiles",
        "id",
        readable_output=tableToMarkdown(f"Files found by rule {id_}", data),
        outputs=data,
        raw_response=raw_response,
    )
...
def get_retrohunt_job_by_id(client: Client, args: dict) -> CommandResults:
    ...
    data = raw_response.get("data", {})
    readable_inputs = {**data, **data.get("attributes", {})}
    ...
    return CommandResults(
        f"{INTEGRATION_ENTRY_CONTEXT}.RetroHuntJob",
        "id",
        readable_output=tableToMarkdown(f"Retrohunt job: {id_}", readable_inputs),
        outputs=data,
        raw_response=raw_response,
    )
...
def search_file(client: Client, args: dict) -> CommandResults:
    ...
    return CommandResults(
        ...
        "Query",
        readable_output=tableToMarkdown(f'Found hashes for query: "{query}"', hashes, headers=["Found hashes"]),
        outputs={"Query": query, "SearchResult": hashes},
        raw_response=raw_response,
    )
