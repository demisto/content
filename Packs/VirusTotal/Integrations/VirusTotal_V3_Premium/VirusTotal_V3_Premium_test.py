...
from VirusTotal_V3_Premium import (
    Client,
...
class TestTimeHelpers:
    ...
    @pytest.mark.parametrize(
        "start_time, end_time", [("not a real date", None), ("not a real date", "not a real date"), (None, "today")]
    )
...
class TestFetchIncidents:
    ...
    def test_fetch_incidents_with_no_incidents(self, mocker):
        ...
        mocker.patch.object(self.ClientMock, "list_notifications", return_value={"data": []})
...
class TestHelpers:
    ...
    def test_convert_epoch_to_readable_no_key(self):
        assert convert_epoch_to_readable({"something_else": 1617056782}) == {"something_else": 1617056782}
