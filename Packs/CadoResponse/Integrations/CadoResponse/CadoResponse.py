...
class Client(BaseClient):
    ...
    def heartbeat(self) -> dict[str, Any]:
        ...
        return self._http_request(method="GET", url_suffix="/system/status")
    ...
    def create_project(self, project_name: str, project_description: str | None) -> dict[str, Any]:
        ...
        payload: dict[str, Any] = {"caseName": project_name, "description": project_description}

        return self._http_request(method="POST", url_suffix="/projects", json_data=payload)
    ...
    def get_project(self, project_id: int | None) -> dict[str, Any]:
        ...
        return self._http_request(method="GET", url_suffix=f"/projects/{project_id}")
    ...
    def list_projects(self, limit: int) -> List[dict[str, Any]]:
        ...
        data: List[dict[str, Any]] = self._http_request(method="GET", url_suffix="/projects")
    ...
    def get_pipeline(self, pipeline_id: int | None, project_id: int | None) -> dict[str, Any]:
        ...
        return self._http_request(
            method="GET", url_suffix="/tasks/pipelines", params={"project_id": project_id, "pipeline_id": pipeline_id}
        )
    ...
    def list_instances(self, project_id: int | None, region: str | None, limit: int) -> List[dict[str, Any]]:
        ...
        data: dict[str, Any] = self._http_request(
            method="GET", url_suffix=f"/projects/{project_id}/imports/ec2", params={"region": region}
        )
    ...
    def list_buckets(self, project_id: int | None, limit: int) -> dict[str, Any]:
        ...
        data: dict[str, Any] = self._http_request(method="GET", url_suffix=f"/projects/{project_id}/imports/s3")

        data["buckets"] = data["buckets"][:limit]

        return data

    def trigger_instance_acquisition(
        self,
        project_id: int | None,
        ...
        return self._http_request(method="POST", url_suffix=f"/projects/{project_id}/imports/ec2", json_data=payload)

    def trigger_bucket_acquisition(self, project_id: int | None, bucket: str | None, file_name: str | None) -> dict[str, Any]:
        ...
        payload: dict[str, Any] = {"bucket": bucket, "file_name": file_name}

        return self._http_request(method="POST", url_suffix=f"/projects/{project_id}/imports/s3", json_data=payload)
...
def create_project_command(client: Client, args: dict[str, Any]) -> CommandResults:
    ...
    return CommandResults(outputs_prefix="CadoResponse.Project", outputs_key_field="id", outputs=result)
...
def list_project_command(client: Client, args: dict[str, Any]) -> CommandResults:
    ...
    return CommandResults(outputs_prefix="CadoResponse.Projects", outputs_key_field="id", outputs=result)
...
def get_pipeline_command(client: Client, args: dict[str, Any]) -> CommandResults:
    ...
    return CommandResults(outputs_prefix="CadoResponse.Pipelines", outputs_key_field="pipeline_id", outputs=result)
...
def list_ec2_command(client: Client, args: dict[str, Any]) -> CommandResults:
    ...
    return CommandResults(outputs_prefix="CadoResponse.EC2Instances", outputs_key_field="id", outputs=result)
...
def list_s3_command(client: Client, args: dict[str, Any]) -> CommandResults:
    ...
    return CommandResults(outputs_prefix="CadoResponse.S3Buckets", outputs=result)
...
def trigger_ec2_command(client: Client, args: dict[str, Any]) -> CommandResults:
    ...
    result: dict[str, Any] = client.trigger_instance_acquisition(
        project_id, instance_id, region, bucket, compress, include_disks, include_hash, include_logs, include_screenshot
    )
...
def trigger_s3_command(client: Client, args: dict[str, Any]) -> CommandResults:
    ...
    return CommandResults(
        outputs_prefix="CadoResponse.S3Acquisition", outputs_key_field="pipeline_id", outputs=result.get("pipelines")
    )
...
def main() -> None:
    ...
    try:
        client: Client = Client(base_url=base_url, verify=verify_certificate, headers=headers, proxy=proxy)
