...
- **Breaking changes**: The 'Export Profile' configuration parameter of type text has been replaced with the new 'Export Profiles' parameter of type multi-select.
