...
| Number of Export Requests per Fetch | Number of API calls per fetch to export events for each configured Digital Guardian ARC export profile. The value should be set to between 1 and 5. Default is 1. | False |
