    ...
    "content": [
        {
            ...
            "feature": [
                ...
                {"accessorKey": "classification", "displayName": "Classification", "type": "string", "value": "malicious"},
...
@pytest.mark.parametrize(
    ...
    [
        ("accounts", "board-leak/leaks/accounts", BOARDLEAK_ACCOUNTS_RESPONSE, "Darkmon.BoardLeak.Account", "username", "victim"),
        (
            "combo-lists",
...
def test_yaml_advertises_sort_arg_with_correct_default(yml, cmd_name, expected_default):
    ...
    assert sort_arg.get("defaultValue") == expected_default, (
        f"{cmd_name}: YAML default sort {sort_arg.get('defaultValue')!r} != " f"expected {expected_default!r}"
    )
        ...
        "content": [
            {
                "type": "Domains",
                "feature": [
                    {"accessorKey": "classification", "displayName": "Classification", "type": "string", "value": classification},
                ],
            },
        ],
        "page": {},
