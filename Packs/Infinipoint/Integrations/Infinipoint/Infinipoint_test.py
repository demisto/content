...
def test_get_programs_command(requests_mock):
    from Infinipoint import Client, infinipoint_command

    mock_response = util_load_json("test_data/get_assets_programs.json")

    requests_mock.post("http://test.com/api/assets/programs", json=mock_response)

    args = {"name": "VMware"}

    client = Client(base_url="http://test.com", verify=False, headers={"Authentication": "Bearer some_api_key"})
...
def test_get_hardware_command(requests_mock):
    ...
    requests_mock.post("http://test.com/api/assets/hardware", json=mock_response)
    args = {"os_type": "4"}
    client = Client(base_url="http://test.com", verify=False, headers={"Authentication": "Bearer some_api_key"})
...
def test_get_users_command(requests_mock):
    ...
    requests_mock.post("http://test.com/api/assets/users", json=mock_response)
    args = {"source": "GCP API"}
    client = Client(base_url="http://test.com", verify=False, headers={"Authentication": "Bearer some_api_key"})
...
def test_get_devices_command(requests_mock):
    ...
    requests_mock.post("http://test.com/api/devices", json=mock_response)
    args = {"os_type": "1"}
    client = Client(base_url="http://test.com", verify=False, headers={"Authentication": "Bearer some_api_key"})
...
def test_get_vulnerable_devices_command(requests_mock):
    ...
    requests_mock.post("http://test.com/api/vulnerability/devices", json=mock_response)
...
def test_get_tag_command(requests_mock):
    ...
    requests_mock.post("http://test.com/api/tags", json=mock_response)
    args = {"name": "et"}
    client = Client(base_url="http://test.com", verify=False, headers={"Authentication": "Bearer some_api_key"})
...
def test_get_queries_command(requests_mock):
    ...
    requests_mock.post("http://test.com/api/all-scripts/search", json=mock_response)
...
def test_run_queries_command(requests_mock):
    from Infinipoint import Client, run_queries_command

    mock_response = util_load_json("test_data/run-queries.json")
    requests_mock.post("http://test.com/api/all-scripts/execute", json=mock_response)
...
def test_device_details_command(requests_mock):
    ...
    requests_mock.get(f'http://test.com/api/discover/details/{args.get("discoveryId")}', json=mock_response)
    client = Client(base_url="http://test.com", verify=False, headers={"Authentication": "Bearer some_api_key"})
