...
1. Visit the [QRadar API versions page](https://www.ibm-community.com/support/knowledgecenter/SS42VS_SHR/com.ibm.qradarapi.doc/c_rest_api_getting_started.html) for a full list of available API versions according to the QRadar version.
...
- Visit [QRadar Filter Syntax Documentation](https://www.ibm-community.com/docs/en/qradar-common?topic=versions-filter-syntax) for explanation about filter syntax.
- Visit [QRadar Offense Documentation](https://www.ibm-community.com/docs/en/qradar-common?topic=card-offenses) for a list of all possible fields to be used in the filter.
