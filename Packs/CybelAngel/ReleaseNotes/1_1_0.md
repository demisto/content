...
- Added the following parameters:
  - **Event Types To Fetch** parameter.
  - **The maximum number of Domain watchlist events  per fetch** parameter.
  - **The maximum number of Credential watchlist events per fetch** parameter.
  - **Fetch events** parameter.
