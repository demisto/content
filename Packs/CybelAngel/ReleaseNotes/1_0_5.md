...
- New: Added a new incident field- CybelAngel Liveness that %%UPDATE_CONTENT_ITEM_DESCRIPTION%%.
...
- New: Added a new incident type- CybelAngel that %%UPDATE_CONTENT_ITEM_DESCRIPTION%%
...
- New: Added a new mapper- CybelAngel that %%UPDATE_CONTENT_ITEM_DESCRIPTION%%.
...
- New: Added a new layout- CybelAngel that %%UPDATE_CONTENT_ITEM_DESCRIPTION%%.
