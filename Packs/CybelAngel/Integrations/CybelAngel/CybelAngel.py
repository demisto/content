...
register_module_line('CybelAngel', 'start', __line__())
# pack version: 1.0.0
"""
   ...
   class Client(BaseClient):
    ...
    def main() -> None:
       ...
       # Get Cybelangel credentials
        ...
        first_fetch_interval = int(demisto.params().get('first_fetch_interval'))
    ...
    register_module_line('CybelAngel', 'end', __line__())
