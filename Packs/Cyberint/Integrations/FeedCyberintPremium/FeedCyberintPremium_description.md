...
1. In Cortex (XSOAR or XSIAM), navigate to **Settings → Integrations → Servers & Services** (XSOAR) or **Settings → Configurations → Data Collection → Automation & Feed Integrations** (XSIAM), search for **Check Point EM IoC Intelligence Feed**, and click **Add instance**.
