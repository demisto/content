...
REQUEST_URL6 = f"{BASE_URL}/api/v1/url?value=http://dummy.com"
REQUEST_URL7 = f"{BASE_URL}/api/v1/ipv4?value=1.1.1.1"
REQUEST_URL8 = f"{BASE_URL}/api/v1/domain?value=dummy.com"
REQUEST_URL9 = f"{BASE_URL}/api/v1/file/sha256?value=6a7b02c43837dcb8e40d271edb88d13d2e723c721a74931857aaef4853317789"
TOKEN = "example_token"
