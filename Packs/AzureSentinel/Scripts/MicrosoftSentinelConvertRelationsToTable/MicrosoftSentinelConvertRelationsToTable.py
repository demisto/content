...
def convert_to_table(context_results: str) -> CommandResults:
    ...
    context_formatted = [format_relation(relation) for relation in context_results]
...
def main():  # pragma: no cover
    context = dict_safe_get(demisto.callingContext, ["context", "Incidents", 0, "CustomFields", "microsoftsentinelrelations"], {})
