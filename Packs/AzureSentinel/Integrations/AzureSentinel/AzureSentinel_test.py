...
from AzureSentinel import AzureSentinelClient, list_incidents_command, list_incident_relations_command, incident_add_comment_command, \
...
class TestIncidentData:
    ...
    def test_limited_list_incidents(self, args, client, mocker):
        """
        Given:
            - A limit parameter for the tested command
            - An app client object
        When:
            - Calling function list_incidents_command
        Then:
            - Ensure the results holds the expected incidents list data
            - Ensure next link was returned
        """
        ...
        # validate
        next_link = outputs[NEXT_LINK_CONTEXT_KEY]['URL']
