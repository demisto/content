...
class Client(BaseClient):
    ...
    def asset_search(self, params: dict = None):
        ...
        return self._http_request(method="GET", url_suffix=url_suffix, params=params, headers=self._headers)

    def asset_delete(self, asset_ids: list):
        url_suffix = "/org/assets/bulk/delete"
        params_value = f"[{','.join(asset_ids)}]"
        return self._http_request(
            method="DELETE", url_suffix=url_suffix, params={"asset_ids": params_value}, headers=self._headers
        )
    ...
    def comment_add(self, asset_id, comment):
        ...
        return self._http_request(method="PATCH", url_suffix=url_suffix, json_data=body, headers=self._headers)
    ...
    def service_delete(self, service_id: str):
        ...
        return self._http_request(method="DELETE", url_suffix=url_suffix, headers=self._headers)
    ...
    def tag_delete(self, asset_id: str, tags: str):
        url_suffix = f"/org/assets/{asset_id}/tags"
        tags_body = {"tags": tags}
        return self._http_request(method="PATCH", url_suffix=url_suffix, headers=self._headers, json_data=tags_body)
...
def asset_search_command(client: Client, args: dict) -> CommandResults:
    ...
    human_readable = tableToMarkdown("Asset", message, removeNull=True)
    return CommandResults(
        outputs_prefix="RunZero.Asset", outputs_key_field="id", outputs=outputs, raw_response=raw, readable_output=human_readable
    )
...
def asset_delete_command(client: Client, args: dict) -> CommandResults:
    ...
    return CommandResults(outputs_prefix="RunZero.Asset", raw_response=raw, readable_output=message)
...
def comment_add_command(client: Client, args: dict) -> CommandResults:
    ...
    return CommandResults(raw_response=raw, readable_output=message)
...
def tags_add_command(client: Client, args: dict) -> CommandResults:
    ...
    return CommandResults(outputs_prefix="RunZero.Tag", raw_response=raw, readable_output=message)
...
def service_search_command(client: Client, args: dict) -> CommandResults:
    ...
    human_readable = tableToMarkdown("Service", message, removeNull=True)
    return CommandResults(
...
def service_delete_command(client: Client, args: dict) -> CommandResults:
    ...
    return CommandResults(outputs_prefix="RunZero.Service", raw_response=raw, readable_output=message)


def quota_get_command(client: Client) -> CommandResults:
    raw = client.quota_get()
    message = parse_raw_quota_get(raw)
    human_readable = tableToMarkdown("Quota", message, removeNull=False)
    return CommandResults(
        outputs_prefix="RunZero.Quota", outputs_key_field="id", outputs=raw, raw_response=raw, readable_output=human_readable
    )
...
def wireless_lan_search_command(client: Client, args: dict) -> CommandResults:
    ...
    human_readable = tableToMarkdown("Wireless", message, removeNull=True)
    return CommandResults(
...
def wireless_lan_delete_command(client: Client, args: dict) -> CommandResults:
    ...
    return CommandResults(
        outputs_prefix="RunZero.WirelessLAN", outputs_key_field=None, outputs=None, raw_response=raw, readable_output=message
    )
