...
class TestCommandsFunctions:
    ...
    def test_fetch_incidents_no_incidents(self, requests_mock, client):
        ...
        # Test no incidents
        requests_mock.get(
            "https://caseapi.phishlabs.com/v1/data/cases?offset=0&maxRecords=20",
        ...
        tested_incidents_response, tested_last_run_response = fetch_incidents_command(
            client, fetch_time="1 days", last_run="2019-11-10T02:30:37Z", max_records=20
        )
    ...
    def test_fetch_incidents_last_run(self, requests_mock, client):
        ...
        tested_incidents_response, tested_last_run_response = fetch_incidents_command(
            client, fetch_time="1 days", last_run="2019-11-30T18:42:02Z", max_records=20
        )
...
class TestClientMethods:
    ...
    def test_get_cases_limit_filte_less_exsits(self, requests_mock, client):
        ...
        requests_mock.get(
            "https://caseapi.phishlabs.com/v1/data/cases?maxRecords=3",
            json=load_params_from_json("./test_data/raw_response_1.json"),
        )
    ...
    def test_get_cases_limit_filter_exact_results(self, requests_mock, client):
        ...
        requests_mock.get(
            "https://caseapi.phishlabs.com/v1/data/cases?offset=0&maxRecords=7",
            json=load_params_from_json("./test_data/raw_response_1.json"),
        )
        requests_mock.get(
            "https://caseapi.phishlabs.com/v1/data/cases?offset=5&maxRecords=7",
    ...
    def test_get_cases_limit_filter_overflow_results(self, requests_mock, client):
        ...
        requests_mock.get(
            "https://caseapi.phishlabs.com/v1/data/cases?offset=0&maxRecords=10",
            json=load_params_from_json("./test_data/raw_response_1.json"),
        )
        requests_mock.get(
            "https://caseapi.phishlabs.com/v1/data/cases?offset=5&maxRecords=10",
            json=load_params_from_json("./test_data/raw_response_2.json"),
        )
        requests_mock.get(
            "https://caseapi.phishlabs.com/v1/data/cases?offset=7&maxRecords=10",
            json=load_params_from_json("./test_data/raw_response_3.json"),
        )
        expected_response = load_params_from_json("./test_data/client_methods/get_cases/limit_filter/output_2.json")
    ...
    def test_get_cases_begin_date_filter_second_request(self, requests_mock, client):
        ...
        requests_mock.get(
            "https://caseapi.phishlabs.com/v1/data/cases?offset=5&maxRecords=20",
            json=load_params_from_json("./test_data/raw_response_2.json"),
        )
    ...
    def test_get_cases_begin_date_filter_overflow(self, requests_mock, client):
        ...
        requests_mock.get(
            "https://caseapi.phishlabs.com/v1/data/cases?offset=7&maxRecords=20",
            json=load_params_from_json("./test_data/raw_response_3.json"),
        )
    ...
    def test_get_cases_combined_filters_first_second_request(self, requests_mock, client):
        ...
        tested_response = client.get_cases(end_date="2019-11-29T02:34:00Z", begin_date="2019-11-10T02:09:17Z")
        assert tested_response == expected_response, (
            "Failed - end date in first request and begin date in second "
    ...
    def test_get_cases_combined_filters_second_request(self, requests_mock, client):
        ...
        requests_mock.get(
            "https://caseapi.phishlabs.com/v1/data/cases?offset=0&maxRecords=1",
            json=load_params_from_json("./test_data/raw_response_1.json"),
        )
        requests_mock.get(
            "https://caseapi.phishlabs.com/v1/data/cases?offset=5&maxRecords=1",
            json=load_params_from_json("./test_data/raw_response_2.json"),
        )
        expected_response = load_params_from_json("./test_data/client_methods/get_cases/combined_filters/output_3.json")
        tested_response = client.get_cases(end_date="2019-11-29T02:34:00Z", begin_date="2019-11-10T02:09:17Z", max_records=1)
        assert tested_response == expected_response, (
            "Failed - end date in first request and begin date in second "
            "request - get cases should query twice and return 3 case"
        )
