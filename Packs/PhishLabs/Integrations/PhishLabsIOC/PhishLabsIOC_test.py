...
def test_populate_context_files():
    from PhishLabsIOC import create_phishlabs_object, get_file_properties, populate_context
    ...
    phishlabs_result = [
        {
            ...
            "Attribute": [
                {"CreatedAt": "2019-05-14T13:03:45Z", "Type": None, "Name": "md5", "Value": "c8092abd8d581750c0530fa1fc8d8318"},
                {"CreatedAt": "2019-05-14T13:03:45Z", "Type": None, "Name": "filetype", "Value": "application/zip"},
                {"CreatedAt": "2019-05-14T13:03:45Z", "Type": None, "Name": "name", "Value": "Baycc.zip"},
            ],
        }
    ]

    global_entry = {"Name": file_name, "Type": file_type, "MD5": file_md5}

    global_result = [{"Name": "Baycc.zip", "Type": "application/zip", "MD5": "c8092abd8d581750c0530fa1fc8d8318"}]
...
def test_populate_context_emails():
    from PhishLabsIOC import create_phishlabs_object, get_email_properties, populate_context
    ...
    phishlabs_result = [
        {
            ...
            "Attribute": [
                ...
                {"CreatedAt": "2019-05-13T16:54:18Z", "Type": None, "Name": "from", "Value": "foo@test.com"},
                {"CreatedAt": "2019-05-13T16:54:18Z", "Type": None, "Name": "to", "Value": "example@gmail.com"},
            ],
        }
    ]

    global_entry = {"To": email_to, "From": email_from, "Body": email_body, "Subject": email.get("value")}
