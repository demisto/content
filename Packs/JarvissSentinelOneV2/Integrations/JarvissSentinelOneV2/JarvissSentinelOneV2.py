...
def main():
    ...
    commands: Dict[str, Dict[str, Callable]] = {
        'common': {
            'jarv-sentinelone-get-activities': get_activities_command,
            'jarv-sentinelone-get-threats': get_threats_command,
            'jarv-sentinelone-mitigate-threat': mitigate_threat_command,
            'jarv-sentinelone-get-hash': get_hash_command,
            'jarv-sentinelone-get-white-list': get_white_list_command,
            'jarv-sentinelone-create-white-list-item': create_white_item_command,
            'jarv-sentinelone-get-sites': get_sites_command,
            'jarv-sentinelone-get-site': get_site_command,
            'jarv-sentinelone-reactivate-site': reactivate_site_command,
            'jarv-sentinelone-list-agents': list_agents_command,
            'jarv-sentinelone-get-agent': get_agent_command,
            'jarv-sentinelone-get-groups': get_groups_command,
            'jarv-sentinelone-move-agent': move_agent_to_group_command,
            'jarv-sentinelone-delete-group': delete_group,
            'jarv-sentinelone-connect-agent': connect_agent_to_network,
            'jarv-sentinelone-disconnect-agent': disconnect_agent_from_network,
            'jarv-sentinelone-broadcast-message': broadcast_message,
            'jarv-sentinelone-get-events': get_events,
            'jarv-sentinelone-create-query': create_query,
            'jarv-sentinelone-get-processes': get_processes,
            'jarv-sentinelone-shutdown-agent': shutdown_agents,
            'jarv-sentinelone-uninstall-agent': uninstall_agent,
        },
        '2.0': {
            'jarv-sentinelone-mark-as-threat': mark_as_threat_command,
            'jarv-sentinelone-resolve-threat': resolve_threat_command,
            'jarv-sentinelone-agent-processes': get_agent_processes,
        },
        '2.1': {
            'jarv-sentinelone-threat-summary': get_threat_summary_command,
            'jarv-sentinelone-add-hash-to-blocklist': add_hash_to_blocklist,
            'jarv-sentinelone-remove-hash-from-blocklist': remove_hash_from_blocklist,
            'jarv-sentinelone-get-blocklist': get_blocklist,
            'jarv-sentinelone-fetch-file': fetch_file,
            'jarv-sentinelone-download-fetched-file': download_fetched_file,
        },
    }
