...
class Client(BaseClient):
    ...
    def _login(self):
        ...
        """
        self._http_request(
            "POST", full_url=f"{self._base_url}/api/auth/login", data={"username": self.username, "password": self.password}
        )
    ...
    def validate_authentication_params(
        self, username: str = None, password: str = None, api_key: str = None, is_fetch: bool = None
    ):
        if username == TOKEN_INPUT_IDENTIFIER:
            ...
            if api_key:
                raise ValueError(
                    f"When specifying {username=}, the API Token must be provieded using in the password field"
    ...
    def get_notable_users_request(self, api_unit: str = None, num: str = None, limit: int = None) -> dict:
        ...
        Returns:
            notable users
        """
        params = {"unit": api_unit, "num": num, "numberOfResults": limit}
    ...
    def user_sequence_request(self, username: str = None, parse_start_time=None, parse_end_time=None) -> dict:
        ...
        """
        params = {"username": username, "startTime": parse_start_time, "endTime": parse_end_time}
    ...
    def list_top_domains_request(self, sequence_id: str = None, sequence_type: str = None) -> dict:
        ...
        """
        params = {"sequenceId": sequence_id, "sequenceType": sequence_type}
    ...
    def list_asset_next_events_request(
        self,
        asset_id: str = None,
        event_time: int = None,
        ...
        array_type_params = {"eventTypes": event_types, "eventCategories": event_categories, "sequenceTypes": sequence_types}
    ...
    def list_security_alerts_request(
        self, asset_id: str = None, sort_by: str = None, sort_order: int = None, limit: int = None
    ) -> dict:
        """
        Args:
            asset_id: ID of the asset to fetch info for
        ...
        """
        params = {"sortBy": sort_by, "sortOrder": sort_order, "numberOfResults": limit}
    ...
    def search_rules_request(self, keyword: str = None, filter_exp: str = None) -> list | dict:
        ...
        """
        params = {"keyword": keyword, "filter": filter_exp}
    ...
    def add_watchlist_items_from_csv_request(
        self, watchlist_id: str = None, watch_until_days: int = None, csv_file: str = None, category: str = None
    ) -> dict:
        """
        Args:
        ...
        if file_path:
            ...
            form_data = {"watchUntilDays": watch_until_days, "category": category}
    ...
    def add_watchlist_items_by_name_request(
        self, watchlist_id: str = None, watch_until_days: int = None, items: list = None, category: str = None
    ) -> dict:
        """
        Args:
            watchlist_id: ID of the watchlist to search assets for
        ...
        params = {"watchUntilDays": watch_until_days, "category": category}
    ...
    def search_asset_in_watchlist_request(
        self, keyword: str = None, watchlist_id: str = None, limit: int = None, is_exclusive: str = None, search_by_ip: str = None
    ) -> dict:
        """
        Args:
    ...
    def remove_watchlist_items_request(self, watchlist_id: str = None, items: list = None, category: str = None) -> dict:
        """
        Args:
        ...
        params = {"watchlistId": watchlist_id, "category": category}
        array_type_params = {"items[]": items}
        query_params_str = get_query_params_str(params, array_type_params)
    ...
    def list_context_table_records_request(
        self, context_table_name: str = None, page_size: int = None, page_number: int = None
    ) -> dict:
        """
        Args:
    ...
    def update_session_id_of_context_table(self, context_table_name: str = None, session_id: str = None, replace: bool = False):
    ...
    def add_context_table_records_request(
        self, context_table_name: str, records_list: list[str], key_only: bool, session_id: str = None
    ) -> dict:
        """
        Args:
            context_table_name: The context table name.
        ...
        payload = {"records": parse_context_table_records_list(records_list, fmt=record_item_format)}
    ...
    def update_context_table_records_request(
        self, context_table_name: str, records_list: list[str], key_only: bool, session_id: str = None
    ) -> dict:
        """
        Args:
    ...
    def delete_context_table_records_request(self, context_table_name: str, records: list[str], session_id: str = None) -> dict:
        """
        Args:
            context_table_name: The context table name.
        ...
        params = {"sessionId": session_id} if session_id else {}
        payload = {"records": parse_context_table_records_list(records, fmt="id", is_delete=True)}
    ...
    def add_context_table_records_from_csv_request(
        self,
        ...
        if file_path:
            ...
            if not session_id and response.get("sessionId"):
                self.update_session_id_of_context_table(context_table_name, session_id=response.get("sessionId"), replace=replace)
    ...
    def get_notable_session_details_request(
        self, asset_id: str = None, sort_by: str = None, sort_order: int = None, limit: int = None
    ) -> dict:
        """
        Args:
    ...
    def get_notable_sequence_details_request(self, asset_id: str = None, parse_start_time=None, parse_end_time=None):
        """
        Args:
            asset_id: ID of the asset to fetch info for
            parse_start_time: start time
        ...
        """
        params = {"assetId": asset_id, "startTime": parse_start_time, "endTime": parse_end_time}
    ...
    def get_notable_sequence_event_types_request(self, asset_sequence_id: str = None, search_str: str = None):
        ...
        """
        params = {"assetSequenceId": asset_sequence_id, "searchStr": search_str}
        response = self._http_request("GET", url_suffix=f"/uba/api/asset/sequence/{asset_sequence_id}/eventTypes", params=params)
        return response

    def get_list_incidents(self, query_params: dict):
        return self._http_request("GET", url_suffix="/ir/api/incident/list", params=query_params)
    ...
    def get_single_incident(self, incident_id: str, username: str = None):
        ...
        return self._http_request("GET", url_suffix=f"/ir/api/incident/{incident_id}", headers=headers)
...
def aggregated_events_to_xsoar_format(asset_id: str, events: list[Any]) -> tuple[list[Any], str]:
    ...
    for activity in aggregated_events_data:
        if isinstance(activity["count"], int) and activity["count"] > 0:
            ...
            title = (
                f"{activity['count']} {activity['event_type']} event(s) "
                f"between {activity['start_time']} and {activity['end_time']}"
            )
            human_readable += (
                tableToMarkdown(title, activity_events, removeNull=True, headerTransform=underscoreToCamelCase) + "\n"
            )
...
def create_context_table_updates_outputs(name: str, raw_response: dict) -> tuple[Any, dict[str, Any]]:
    ...
    human_readable = tableToMarkdown(
        f"Context Table {name} Update Details", outputs, headerTransform=pascalToSpace, removeNull=True, metadata=metadata_str
    )
    ...
    if "user" in incident:
        for key in keys:
            ...
            if key in incident["highestRiskSession"] and incident["highestRiskSession"][key]:
                incident["highestRiskSession"][key] = (
                    convert_unix_to_date(incident["highestRiskSession"][key]).split(".")[0] + "Z"
                )
    return incident


def build_incident_response_query_params(
    query: str | None,
...
def get_user_sessions(client: Client, args: dict) -> tuple[str, dict, dict]:
    ...
    entry_context = {
        "Exabeam.User(val.SessionID && val.SessionID === obj.SessionID)": {"Username": username, "Session": contents}
    }
...
def get_watchlist(client: Client, *_) -> tuple[str, dict, dict]:
    ...
    for list_ in watchlist:
        contents.append({"WatchlistID": list_.get("watchlistId"), "Title": list_.get("title"), "Category": list_.get("category")})
...
def get_session_info_by_id(client: Client, args: dict) -> tuple[Any, dict[str, Any | None], dict[Any, Any]]:
    ...
    human_readable = tableToMarkdown(
        f"Session {session_id} Information", session_info, removeNull=True, headerTransform=pascalToSpace
    )
...
def list_top_domains(client: Client, args: dict) -> tuple[Any, dict[str, dict[Any, Any]], Any | None]:
    ...
    human_readable = tableToMarkdown(
        f"Sequence {sequence_id} Top Domains", top_domains, removeNull=True, headerTransform=pascalToSpace
    )
...
def list_triggered_rules(client: Client, args: dict) -> tuple[Any, dict[str, Any | None], dict[Any, Any]]:
    ...
    human_readable = tableToMarkdown(f"Sequence {sequence_id} Triggered Rules", triggered_rules, removeNull=True)
...
def get_asset_info(client: Client, args: dict[str, str]) -> tuple[Any, dict[str, Any | None], dict[Any, Any]]:
    ...
    human_readable = tableToMarkdown(f"Asset {asset_id} Information", asset_info, removeNull=True, headerTransform=pascalToSpace)
...
def list_asset_next_events(client: Client, args: dict[str, str]) -> tuple[Any, dict[str, list[Any]], dict[Any, Any]]:
    ...
    events_raw_data = client.list_asset_next_events_request(
        asset_id, event_time, number_of_events, anomaly_only, event_categories, event_types, event_type_include, sequence_types
    )
...
def list_security_alerts_by_asset(client: Client, args: dict[str, str]) -> tuple[Any, dict[str, list[Any]], dict[Any, Any]]:
    ...
    human_readable = tableToMarkdown(
        f"Asset {asset_id} Security Alerts", security_alerts, removeNull=True, headerTransform=underscoreToCamelCase
    )
...
def get_rules_model_definition(client: Client, args: dict[str, str]) -> tuple[Any, dict[str, Any], Any | None]:
    ...
    human_readable = tableToMarkdown(f"Model {model_name} Definition", model, headerTransform=pascalToSpace, removeNull=True)
...
def search_asset_in_watchlist(client: Client, args: dict[str, str]) -> tuple[Any, dict[str, Any], Any | None]:
    ...
    entry_context = {
        "Exabeam.AssetInfo((val.ipAddress && val.ipAddress === obj.ipAddress) ||"
        "(val.hostName && val.hostName === obj.hostName))": assets
    }
    human_readable = tableToMarkdown(
        f"Watchlist {watchlist_id} Assets Search Results", assets, headerTransform=pascalToSpace, removeNull=True
    )
...
def list_context_table_records(client: Client, args: dict[str, str]) -> tuple[Any, dict[str, Any], Any | None]:
    ...
    entry_context = {"Exabeam.ContextTable(val.Name && val.Name === obj.Name)": {"Name": context_table_name, "Record": records}}
    human_readable = tableToMarkdown(
        f"Context Table `{context_table_name}` Records",
        records,
...
def add_context_table_records(client: Client, args: dict[str, str]) -> tuple[Any, dict[str, Any], Any | None]:
    ...
    record_updates_raw_data = client.add_context_table_records_request(context_table_name, records_list, key_only, session_id)
...
def update_context_table_records(client: Client, args: dict[str, str]) -> tuple[Any, dict[str, Any], Any | None]:
    ...
    record_updates_raw_data = client.update_context_table_records_request(context_table_name, records, key_only, session_id)
    human_readable, entry_context = create_context_table_updates_outputs(context_table_name, record_updates_raw_data)
    return human_readable, entry_context, record_updates_raw_data
...
def add_context_table_records_from_csv(client: Client, args: dict[str, str]) -> tuple[Any, dict[str, Any], Any | None]:
    ...
    record_updates_raw_data = client.add_context_table_records_from_csv_request(
        context_table_name, file_entry_id, has_header, session_id, replace
    )
    human_readable, entry_context = create_context_table_updates_outputs(context_table_name, record_updates_raw_data)
    return human_readable, entry_context, record_updates_raw_data
...
def get_notable_session_details(client: Client, args: dict[str, str]) -> tuple[Any, dict[str, Any], Any | None]:
    ...
    for username, status in executive_user.items():
        executive_user_flags.append({username: status})
...
def list_incidents(client: Client, args: dict[str, str]):
    ...
    if incident_ids:
        ...
        if any((query, incident_type, priority, status)):
            query_params = build_incident_response_query_params(
                query,
                incident_type,
                priority,
                status,
...
def fetch_exabeam_incidents(client: Client, args: dict[str, str], last_run: dict[str, Any]) -> tuple[list, dict]:
    incidents: list[dict] = []
    look_back = arg_to_number(args.get("look_back")) or 1.0
    ...
    q = {
        "queryMap": {
            ...
            "priority": priority,
            "createdAt": [start_time_as_milisecound, end_time_as_milisecound],
        },
        "sortBy": "createdAt",
        "sortOrder": "asc",
        "idOnly": False,
    ...
    incidents_filtered = filter_incidents_by_duplicates_and_limit(
        incidents_res=incidents_res, last_run=last_run, fetch_limit=limit, id_field="incidentId"
    )
    demisto.debug(f"After filtering, there are {len(incidents_filtered)} incidents")

    for incident in incidents_filtered:
        incident["createdAt"] = datetime.fromtimestamp(incident.get("baseFields", {}).get("createdAt") / 1000.0).strftime(
            DATETIME_FORMAT_MILISECONDS
        )
