...
|Account|Additional _ Info|Alert _ Id|Alert _ Name|Alert _ Severity|Alert _ Type|Dest _ Host|Dest _ Ip|Dest _ Port|Entity _Asset_ Id|Event _ Id|Event _ Type|Hash|Host|Local _ Asset|Malware _ Url|Md 5|Process|Process _ Name|Rawlog _ Time|Sensor _ Id|Session _ Id|Session _ Order|Source|Src _Dest_ Alert|Src _ Host|Src _ Ip|Src _ Port|Time|User|Vendor|
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
