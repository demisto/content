...
def get_channels_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        outputs_prefix="Camlytics.Channels", outputs_key_field="channel_id", outputs=response, raw_response=response
    )
...
def get_events_totals_by_rule_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        outputs_prefix="Camlytics.EventsTotalsRule", outputs_key_field="", outputs=response, raw_response=response
    )
...
def get_events_totals_by_type_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        outputs_prefix="Camlytics.EventsTotalsType", outputs_key_field="", outputs=response, raw_response=response
    )
...
def get_events_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    command_results = CommandResults(
        outputs_prefix="Camlytics.Events", outputs_key_field="event_id", outputs=response, raw_response=response
    )
