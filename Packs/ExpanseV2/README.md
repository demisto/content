...
- This pack also includes a generic playbook called **Xpasne Incident Handling - Generic** and a matching incoming mapper called **XpanseV2 Generic - Incoming Mapper**. In order to use it, please configure the instance without any classifier, choose **Xpanse Issue - Generic** as the incident type and **XpanseV2 Generic - Incoming Mapper** as the incoming mapper.
