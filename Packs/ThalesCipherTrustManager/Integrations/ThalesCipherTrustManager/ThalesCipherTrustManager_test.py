...
GROUPS_LIST_TEST_ARGS = [
    ...
    {CLIENT_ID: "client1"},
    {GROUP_NAME: "group2", USER_ID: "user2"},
    {CONNECTION: "connection2", CLIENT_ID: "client2"},
    {GROUP_NAME: "group3", USER_ID: "user3", CONNECTION: "connection3", CLIENT_ID: "client3"},
]
...
GROUP_CREATE_TEST_ARGS = [
    ...
    {NAME: "group2", DESCRIPTION: "description2"},
]
GROUP_DELETE_TEST_ARGS = [{GROUP_NAME: "group1"}, {GROUP_NAME: "group2", FORCE: "true"}]
GROUP_UPDATE_TEST_ARGS = [{GROUP_NAME: "group1", DESCRIPTION: "description1_updated"}]
USER_TO_GROUP_ADD_TEST_ARGS = [{GROUP_NAME: "group1", USER_ID: "user1"}]
USER_TO_GROUP_REMOVE_TEST_ARGS = [
    {GROUP_NAME: "group1", USER_ID: "user1"},
]
...
USER_UPDATE_TEST_ARGS = [
    ...
    {USER_ID: "local|f4k3-u51d-1234", EXPIRES_AT: "never", ALLOWED_AUTH_METHODS: "none", ALLOWED_CLIENT_TYPES: "none"},
]
USER_DELETE_TEST_ARGS = [
    {USER_ID: "user1"},
]
USER_PASSWORD_CHANGE_TEST_ARGS = [
    {USERNAME: "user1", PASSWORD: "old_password", NEW_PASSWORD: "new_password", AUTH_DOMAIN: "local_account"},
]
...
LOCAL_CA_SELF_SIGN_TEST_ARGS = [
    ...
    ({LOCAL_CA_ID: "localca-123e4567-e89b-12d3-a456-426614174000", "not_after": "2024-12-31T23:59:59Z", "duration": "365"}),
    (
        {
            LOCAL_CA_ID: "localca-123e4567-e89b-12d3-a456-426614174000",
...
EXTERNAL_CA_DELETE_TEST_ARGS = [{EXTERNAL_CA_ID: "123e456"}]
...
@pytest.mark.parametrize(
    "limit, page, page_size, expected_skip, expected_limit",
    [
        ("100", "2", "25", 25, 25),
        ("200", None, None, 0, 200),
        (None, "2", "30", 30, 30),
...
@pytest.mark.parametrize("limit, page, page_size", [(None, "1", "2001"), (None, "invalid", "30"), ("invalid", None, None)])
...
@pytest.mark.parametrize(
    "param_name, argument_value, expected_output",
    [("test_date", "never", ""), ("test_date", "2023-05-26T15:30:00", "2023-05-26T15:30:00.000000Z"), ("test_date", None, None)],
)
...
@pytest.mark.parametrize(
    "request_data, argument_value, expected_login_flags",
    [
...
def test_group_list_command(mock_get_group_list, args):
    ...
    client = CipherTrustClient(
        username=MOCK_USERNAME, password=MOCK_PASSWORD, server_url=MOCK_SERVER_URL, verify=False, proxy=False
    )
...
def test_local_ca_list_command(mock_get_local_ca_list, args):
    ...
    mock_outputs = [
        remove_keys_from_dict(output, ["csr", "cert"]) for output in mock_get_local_ca_list.return_value.get("resources")
    ]
...
def test_certificate_list_command(mock_get_certificates_list, args):
    ...
    mock_outputs = [
        remove_keys_from_dict(output, ["csr", "cert"]) for output in mock_get_certificates_list.return_value.get("resources")
    ]
    client = CipherTrustClient(
        username=MOCK_USERNAME, password=MOCK_PASSWORD, server_url=MOCK_SERVER_URL, verify=False, proxy=False
    )
...
def test_external_ca_list_command(mock_get_external_ca_list, args):
    ...
    mock_get_external_ca_list.return_value = util_load_json("test_data/mock_external_ca_list_response.json")
