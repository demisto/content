...
This integration was integrated and tested with version xx of HelloWorld-contrib-test

## Configure HelloWorld-contrib-test on Cortex XSOAR

1. Navigate to **Settings** > **Integrations** > **Servers & Services**.
2. Search for HelloWorld-contrib-test.
