Use the Netscout Arbor Edge Defense Integration to detect and stop both inbound threats and outbound communication from internal compromised hosts.
This integration was integrated and tested with version 2 of NetscoutAED
