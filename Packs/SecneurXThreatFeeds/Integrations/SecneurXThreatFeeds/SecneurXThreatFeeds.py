...
def getIndicatorsCommand(client: Client, args: dict[str, int]) -> CommandResults:
    ...
    if feedJson:
        ...
        readableOutput = tableToMarkdown(
            "SecneurX Threat Feeds Indicators: ", t=finalIndicatorList, headers=["type", "value", "fields"]
        )
        command_result = CommandResults(
            outputs_prefix="", outputs_key_field="", outputs={}, readable_output=readableOutput, raw_response=finalIndicatorList
        )
