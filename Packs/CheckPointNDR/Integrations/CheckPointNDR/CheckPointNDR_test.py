...
from CheckPointNDR import Client, fetch_incidents, parse_insights
from CheckPointNDR import test_module as check_module
...
def test_parse_insights():
    ...
    mock_result = (
        util_load_json("./test_data/checkpointndr-parse_insights-output.json"),
