...
class Client(BaseClient):
    ...
    def runs_list_request(self, workspace_id: str | None=None,
                          ...
                          page_number: int | None = None, page_size: int | None = None) -> dict:
        params = {}
        if not run_id:
            if filter_status:
    ...
    def list_policies(self, organization_name: str | None = None, policy_kind: str | None = None, 
        ...
        if not policy_id:
            ...
            if not organization_name:
                raise DemistoException(f"Please provide either the instance param 'Default Organization Name' or the command argument 'organization_name'")
    ...
    def list_policy_sets(self, organization_name: str | None, policy_set_id: str | None, 
                         versioned: bool, policy_set_kind: str | None, include: str | None,
                         policy_set_name: str | None, page_number: int | None,
    ...
    def list_policy_checks(self, run_id: str | None, policy_check_id: str | None,
                           page_number: int | None, page_size: int | None) -> dict: 
...
def runs_list_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    res = client.runs_list_request(workspace_id, run_id, filter_status)
...
def policy_set_list_command(client: Client, args: Dict[str, Any]) -> CommandResults:
    ...
    versioned = argToBoolean(args.get('versioned', False))
