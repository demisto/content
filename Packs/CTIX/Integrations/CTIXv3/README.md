...
| Max incidents per fetch | Maximum number of CTIX report incidents to fetch per cycle. Default is 50. | False |
...
| Max indicators per fetch | Maximum number of indicators to fetch per cycle. Default is 2000. | False |
...
```!ctix-saved-result-set label_name=test```
