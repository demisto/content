...
```json
{
    ...
    "Domain": {
        ...
        "Malicious": {
            "Description": "Hello World returned reputation 93",
            "Vendor": "HelloWorld"
        },
