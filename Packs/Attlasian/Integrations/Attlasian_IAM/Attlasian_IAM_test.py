...
APP_USER_OUTPUT = {
    ...
    "userName": "Demisto",
    "emails": [{"value": "testdemisto@paloaltonetworks.com", "type": "work", "primary": True}],
    "name": {"familyName": "test1", "givenName": "demisto2"},
    "meta": {
        "resourceType": "User",
    ...
    "groups": [],
    "urn:scim:schemas:extension:atlassian-external:1.0": {"atlassianAccountId": "5f45327791e67a003fed461e"},
...
def mock_client():
    client = Client(base_url="https://test.com", directory_id="test123", verify=False, headers={})
    return client
