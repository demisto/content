...
`Client Credentials Flow` - Application permission.<br />
`Authorization Code Flow` - Delegated permission.<br />
...
OR
- `Sites.Selected - Application`: Provides read and write access to specific sites.<br />
...
Client Credentials Flow - `Sites.ReadWrite.All - Application`<br />
Authorization Code Flow - `Files.ReadWrite.All - Delegated`
...
Client Credentials Flow - `Sites.Read.All - Application`<br />
