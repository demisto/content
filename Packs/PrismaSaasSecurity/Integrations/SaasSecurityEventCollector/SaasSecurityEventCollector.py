...
def get_max_fetch(limit: Optional[int]) -> int:
    ...
    4. if limit > DEFAULT_LIMIT (50000) - make sure it will always be DEFAULT_LIMIT (50000).
    ...
    if limit:
        ...
        if limit < 10:
            limit = 10
        if limit > DEFAULT_LIMIT:  # do not allow limit of more than 5000 to avoid timeouts
            limit = DEFAULT_LIMIT
