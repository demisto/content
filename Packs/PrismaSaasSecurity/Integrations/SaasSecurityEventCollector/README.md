...
3. Click **Add instance** to create and configure a new integration instance.
    ...
    | The maximum number of iterations to retrieve events. | In order to prevent timeouts, set this parameter to limit the number of iterations for retrieving event, Note - the default value is the recommended value to prevent timeouts. Default is 150. | False |
