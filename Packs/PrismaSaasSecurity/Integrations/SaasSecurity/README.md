...
3. Click **Add instance** to create and configure a new integration instance.
    ...
    | Fetch only incidents with matching App IDs | A comma-separated list of Application IDs. Run the ***saas-security-get-apps*** command to return the **Application ID**, **Name**, and **Type** for all applications. | False |
...
6. Add the **Client ID** and **Client Secret** to Cortex XSOAR.<br/>
...
| --- | --- | --- |
| limit | The number of incidents to pull. Maximum is 200, minimum is 10. Default is 50. | Optional | 
...
| app_ids | A comma-separated list of application IDs. Run the ***saas-security-get-apps*** command to return the Application ID, Name, and Type for all applications. | Optional | 
| state | The state of the incidents. If empty, retrieves all states. Possible values: "All", "Open", and "Closed". | Optional | 
| severity | The severity of the incidents. If none is selected, all severities will be pulled. Possible values: "1", "2", "3", "4", and "5". | Optional | 
...
| SaasSecurity.Incident.created_at | Date | The date the incident was created. For example, 2021-08-23T09:26:25.872Z. | 
| SaasSecurity.Incident.updated_at | Date | The date the incident was last updated. For example, 2021-08-24T09:26:25.872Z. | 
...
| --- | --- | --- |
| id | The incident ID. | Required | 
| category | The reason for closing the incident. Possible values: "Misidentified", "No Reason", and "Business Justified". | Required | 
...
| SaasSecurity.IncidentState.resolution_date | Date | The date the incident was resolved. | 
...
| remove_inherited_sharing | Used when the remediation type is “Remove public sharing”. When set to true, all the parent folders with a shared URL will be removed. | Optional | 
...
| SaasSecurity.Remediation.action_date | Date | The date the remediation action was taken. | 
| SaasSecurity.Remediation.status | String | The remediation action status. | 
