...
def test_list_app_findings_command(requests_mock):
    ...
    requests_mock.get("https://www.shiftleft.io/orgs/2c089ac1-3378-44d5-94da-9507e84351c3/apps/shiftleft-java-example/findings", json=mock_response)

    client = ShiftLeftClient(
        base_url="https://www.shiftleft.io",
        verify=False,
    )
    args = {"app_name": "shiftleft-java-example", "severity": "critical", "type": ["vuln"], "version": None}
