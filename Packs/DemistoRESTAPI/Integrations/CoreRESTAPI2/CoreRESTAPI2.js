...
const HOSTED_XSOAR_VERSION = '8.0.0';
...
isHosted = function () {
    ...
    if  (((platform === "xsoar") && (isDemistoVersionGE(HOSTED_XSOAR_VERSION))) || platform === "x2") {
        return true
    }
    return false
}
// if using XSIAM or XSOAR > 7.9 we will add the /xsoar suffix
if  (isHosted()) {
