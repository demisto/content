...
Provide Auth ID only when using<~XSIAM> Cortex XSIAM </~XSIAM><~XSOAR> Cortex XSOAR 8.0.0 and above. If the version is less than 8.0.0, you can leave it empty </~XSOAR>.
