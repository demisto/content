...
var responseDict = {
    ...
    'userRetrieveAll': /<soapenv:Body>((.|\n)*)<\/soapenv:Body>/,
    'IPListRetrieveAll': /<soapenv:Body>((.|\n)*)<\/soapenv:Body>/,
    ...
    'portListRetrieveAll': /<soapenv:Body>((.|\n)*)<\/soapenv:Body>/,
    'portListRetrieveByName': /<soapenv:Body>((.|\n)*)<\/soapenv:Body>/,
    'portListRetrieve': /<soapenv:Body>((.|\n)*)<\/soapenv:Body>/,
    'hostDetailRetrieveByName': /<soapenv:Body>((.|\n)*)<\/soapenv:Body>/,
    'DPIRuleRetrieveAllByHostID': /<soapenv:Body>((.|\n)*)<\/soapenv:Body>/
};
...
var commandToMethod = {
    ...
    'trendmicro-user-retrieve-all': 'userRetrieveAll',
    'trendmicro-ip-retrieve-all': 'IPListRetrieveAll',
    'trendmicro-port-retrieve-all': 'portListRetrieveAll',
    'trendmicro-port-retrieve-by-name': 'portListRetrieveByName',
    'trendmicro-port-retrieve': 'portListRetrieve',
    'trendmicro-host-details-retrieve-name': 'hostDetailRetrieveByName',
    'trendmicro-rule-retrieve-by-hostid': 'DPIRuleRetrieveAllByHostID'
};
...
var methodDict = {
        ...
        'userRetrieveAll': '<urn:userRetrieveAll>' + sessionData + '</urn:userRetrieveAll>',
        'IPListRetrieveAll': '<urn:IPListRetrieveAll>' + sessionData + '</urn:IPListRetrieveAll>',
        ...
        'portListRetrieveAll': '<urn:portListRetrieveAll>' + sessionData + '</urn:portListRetrieveAll>',
        'portListRetrieveByName':'<urn:portListRetrieveByName><urn:name>%name%</urn:name>' + sessionData + '</urn:portListRetrieveByName>',
        'portListRetrieve':'<urn:portListRetrieve><urn:id>%id%</urn:id>' + sessionData + '</urn:portListRetrieve>',
        'hostDetailRetrieveByName':'<urn:hostDetailRetrieveByName><urn:hostname>%hostname%</urn:hostname><urn:hostDetailLevel>%hostDetailLevel%</urn:hostDetailLevel>' + sessionData + '</urn:hostDetailRetrieveByName>',
        'DPIRuleRetrieveAllByHostID':'<urn:DPIRuleRetrieveAllByHostID><urn:id>%id%</urn:id>' + sessionData + '</urn:DPIRuleRetrieveAllByHostID>',
};
