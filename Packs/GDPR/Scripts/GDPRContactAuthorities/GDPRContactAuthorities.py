...
AUTHORITY_DETAILS = {
    ...
    "Liechtenstein": {"Name": "Data Protection Office", "Email": "info.dss@llv.li", "Tel": "+423 236 6090", "Site": ""},
    "Norway": {"Name": "Datatilsynet", "Email": "postkasse@datatilsynet.no", "Tel": "+47 22 39 69 00", "Site": ""},
    "Switzerland": {
...
if country in AUTHORITY_DETAILS:
    ...
    human_readable = tableToMarkdown(f"{country} - Supervisory Authority Information", new_country, headers=headers)
