...
REPUTATION_RESPONSE_UNREACHABLE_MALICIOUS_DOMAIN = {
    ...
    "googleSafeBrowsingSupport": 1,
    "isSafeUrl": 0,
    "malwareEngineAnalysisDescription": "Unreachable - HTTP Error Code: 503",
    "malwareEngineAnalysisEnabled": 1,
    "malwareEngineAnalysisSuccess": 1,
    "malwareEngineIsSafeUrl": 1,
    "malwareEngineResultCode": 2,
    "message": "Status: Suspicious Url. Please see below.",
    "realtimeCloudLookupDomainIsGrey": 0,
    "realtimeCloudLookupEnabled": 1,
    "realtimeCloudLookupIsSafeUrl": 1,
    "realtimeCloudLookupRiskDescription": "",
    ...
    "reputationDatabaseBotnetDetection": 0,
    "reputationDatabaseEnabled": 1,
    "reputationDatabaseIsSafeUrl": 0,
    "reputationDatabaseLookupSuccess": 1,
    "reputationDatabaseMalwareDetection": 1,
    "url": "unreachable.com",
    "webRequestHeuristicBlockUnreachableSites": "1",
    "webRequestHeuristicDescription": "Heuristic Engine Detection",
    "webRequestHeuristicIsSafeUrl": 0,
...
def test_add_entity_to_block_list(requests_mock, mocker):
    ...
    requests_mock.put(
        "https://pswg.com/json/controls/blockList?currentPolicyBeingEdited=1", json={"message": "URL added successfully."}
    )
...
def test_add_entity_to_allow_list(requests_mock, mocker):
    ...
    client = get_mock_client(mocker)
    requests_mock.put(
        "https://pswg.com/json/controls/allowList?currentPolicyBeingEdited=1", json={"message": "URL added successfully."}
    )
...
def test_add_entity_to_policy_layer_list(requests_mock, mocker):
    ...
    requests_mock.get(
        ...
        json={"entries": [{"customCategoryName": "Test Policy Layer", "customCategoryNumber": 1, "customCategoryId": 1}]},
    )

    requests_mock.put("https://pswg.com/json/controls/policyLayers/urls", json={"message": "URL added successfully."})
...
def test_remove_entity_from_policy_layer_list(requests_mock, mocker):
    ...
    requests_mock.delete("https://pswg.com/json/controls/policyLayers/urls", json={"message": "URL removed successfully."})
...
def test_remove_entity_from_block_list(requests_mock, mocker):
    ...
    client = get_mock_client(mocker)
    requests_mock.delete(
        "https://pswg.com/json/controls/blockList?currentPolicyBeingEdited=1", json={"message": "URL removed successfully."}
    )
...
def test_ip_lookup(requests_mock, mocker):
    ...
    requests_mock.post("https://pswg.com/json/controls/urlLookup", json=REPUTATION_RESPONSE_UNREACHABLE_BENIGN_IP)
...
def test_domain_lookup_malicious(requests_mock, mocker):
    ...
    requests_mock.post("https://pswg.com/json/controls/urlLookup", json=REPUTATION_RESPONSE_UNREACHABLE_MALICIOUS_DOMAIN)
...
def test_domain_lookup_suspicious(requests_mock, mocker):
    ...
    requests_mock.post("https://pswg.com/json/controls/urlLookup", json=REPUTATION_RESPONSE_UNREACHABLE_SUSPICIOUS_DOMAIN)
...
def test_reputation_get_headers():
    ...
    expected = [
        ...
        "categories",
        "isSafeUrl",
        "malwareEngineAnalysisSuccess",
        "malwareEngineAnalysisDescription",
        "reputationDatabaseLookupSuccess",
        "reputationDatabaseMalwareDetection",
        "reputationDatabaseBotnetDetection",
        "webRequestHeuristicSuccess",
        "webRequestHeuristicProtectionLevel",
        "webRequestHeuristicDescription",
        "googleSafeBrowsingSuccess",
        "googleSafeBrowsingIsSafeUrl",
        "googleSafeBrowsingDescription",
        "realtimeCloudLookupSuccess",
        "realtimeCloudLookupDomainIsGrey",
        "realtimeCloudLookupRiskDescription",
    ]
    assert results == expected
