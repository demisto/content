...
from Tripwire import Client, fetch_incidents, filter_elements, filter_nodes, filter_rules, filter_versions, get_fetch_start_time
...
def test_filter_versions():
    ...
    expected_filter = (
        "ruleId=1&ruleName=2&nodeId=3&id=4&elementId=5&elementName=6&nodeLabel=7&hash=8&baselineVersion"
