...
- New: This trigger is responsible for handling 'Unusual process accessed web browser credentials and executed by a terminal process' alerts<~XSIAM> (Available from Cortex XSIAM %%XSIAM_VERSION%%).</~XSIAM>
