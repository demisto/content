...
- New: This trigger is responsible for handling the 'Azure AD account unlock/successful password reset' alert<~XSIAM> (Available from Cortex XSIAM %%XSIAM_VERSION%%).</~XSIAM>
