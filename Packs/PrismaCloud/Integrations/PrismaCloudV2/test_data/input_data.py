...
from PrismaCloudV2 import (
    ERROR_NOT_ENOUGH_ARGS,
    ERROR_RELATIVE_TIME_UNIT,
    ERROR_TO_NOW_TIME_UNIT,
    ERROR_TOO_MANY_ARGS,
    FETCH_DEFAULT_TIME,
    TIME_FILTER_BASE_CASE,
)
...
full_alert = {
    ...
    "metadata": {"saveSearchId": "search-id-1"},
    "policy": {
        "policyId": "a11b2cc3-1111-2222-33aa-a1b23ccc4dd5",
        "name": "Policy name",
        "policyType": "config",
    ...
    "alertRules": [],
    "history": [
        {"modifiedBy": "Prisma Cloud", "modifiedOn": 1668017403014, "status": "resolved", "reason": "RESOURCE_UPDATED"},
        {"modifiedOn": 1598377179374, "status": "open", "reason": "NEW_ALERT"},
        {"modifiedBy": "Someone", "modifiedOn": 1580391961367, "status": "resolved", "reason": "RESOURCE_DELETED"},
        {"modifiedBy": "Someone", "modifiedOn": 1580390976108, "status": "open", "reason": "NEW_ALERT"},
    ],
    "resource": {
        ...
        "cloudAccountGroups": ["a account group", "ALLAccounts"],
        "region": "AWS Virginia",
        "regionId": "us-east-1",
...
nested_url_field = (
    {"id": "P-11111", "policy": {}, "resource": {"url": "suffix"}},
    "resource.url",
...
suffix_with_beginning_char = (
    {"id": "P-11111", "policy": {}, "url": "/suffix"},
    "url",
    {"id": "P-11111", "policy": {}, "url": "https://app.prismacloud.io/suffix"},
)
url_field_nonexistent = (
    {"id": "P-11111", "policy": {}, "url": "/suffix"},
    "policy.url",
    {"id": "P-11111", "policy": {}, "url": "/suffix"},
)
...
# test_handle_filters
with_filters = (
    "alert.status=open,alert.status=resolved, policy.remediable=true ",
    [
...
start_at_first_fetch_default = (
    1676880716607,
    FETCH_DEFAULT_TIME,
    None,
    None,
    {"type": "absolute", "value": {"endTime": 1676880716607, "startTime": 1675767600000}},
)
start_at_first_fetch2 = (
    1676880716607,
    "1 hour",
    20,
    None,
    {"type": "absolute", "value": {"endTime": 1676880716607, "startTime": 1676023200000}},
)
start_at_first_fetch = (
    1676880716607,
    "1 hour",
    None,
    None,
...
start_at_last_run_time_with_look_back = (
    1676880716607,
    "2 hours",
    20,
    1676023200000,
    {"type": "absolute", "value": {"endTime": 1676880716607, "startTime": 1676022000000}},
)
start_at_last_run_time = (
    1676880716607,
    "2 hours",
    0,
    1676023200000,
...
incident2 = {
    "name": "Policy Two - P-222222",
    "occurred": "2001-09-09T00:28:50Z",
    "rawJSON": '{"id": "P-222222", "alertTime": 999995330000, "policy": {"name": ' '"Policy Two", "severity": "high"}}',
    "severity": 3,
}
incident3 = {
    "name": "Policy Tree - P-333333",
    "occurred": "2001-09-09T00:28:50Z",
    "rawJSON": '{"id": "P-333333", "alertTime": 999995330000, "policy": {"name": ' '"Policy Tree", "severity": "informational"}}',
    "severity": 0.5,
}
truncated_alert6 = {"id": "P-666666", "alertTime": 1000000120000, "policy": {"name": "Policy Six", "severity": "medium"}}
incident6 = {
    "name": "Policy Six - P-666666",
...
incident_no_policy = {
    "name": "No policy - P-888888",
    "occurred": "2001-09-09T01:48:50Z",
    "rawJSON": '{"id": "P-888888", "alertTime": 1000000130000, ' '"mirror_direction": null, "mirror_instance": ""}',
    "severity": 0,
}

# test_filter_alerts
# arguments: limit, expected_incidents, expected_updated_fetched_ids
low_limit_for_filter = (1, [incident6], {"N-111111": 1000000000000, "P-222222": 999996400000, "P-666666": 1000000120000})
exactly_limit_for_filter = (
    2,
    [incident6, incident7],
    {"N-111111": 1000000000000, "P-222222": 999996400000, "P-666666": 1000000120000, "P-777777": 1000000130000},
)
high_limit_for_filter = (
    200,
    [incident6, incident7],
    {"N-111111": 1000000000000, "P-222222": 999996400000, "P-666666": 1000000120000, "P-777777": 1000000130000},
)
...
# arguments: limit, expected_incidents, expected_updated_fetched_ids
low_limit_for_filter__updated_alert_time = (
    1,
    [incident6],
    {"N-111111": 1000000000001, "P-222222": 999996400000, "P-666666": 1000000120000},
)
exactly_limit_for_filter__updated_alert_time = (
    2,
    [incident6, incident7],
    {"N-111111": 1000000000001, "P-222222": 999996400000, "P-666666": 1000000120000, "P-777777": 1000000130000},
)
high_limit_for_filter__updated_alert_time = (
    200,
    [incident6, incident7],
    {"N-111111": 1000000000001, "P-222222": 999996400000, "P-666666": 1000000120000, "P-777777": 1000000130000},
)
...
low_limit_for_request = (
    ...
    [incident6],
    {"P-111111": 1000000110000, "P-222222": 999996400000, "P-666666": 1000000120000},
    1000000120000,
)
exactly_limit_for_request = (
    2,
    [
        {"items": [truncated_alert6], "nextPageToken": "token"},
        {"items": [truncated_alert7], "nextPageToken": "token"},
    ...
    [incident6, incident7],
    {"P-111111": 1000000110000, "P-222222": 999996400000, "P-666666": 1000000120000, "P-777777": 1000000130000},
    1000000130000,
)
more_than_limit_for_request = (
    2,
    [
...
fetch_no_incidents = ({}, {"first_fetch": "1 day"}, [], {}, 1000000130000, {}, 1000000130000)
fetch_with_last_run = (
    {"time": 999990000000, "fetched_ids": {}},
    {"first_fetch": "1 hour"},
    [incident2],
...
# mirroring_tests
alert_search_request_response = [
    {"id": "P-1111111", "status": "resolved"},
...
alert_get_details_request_dismissed_alert_raw_response = {
    ...
    "dismissalNote": "test dismiss",
    "policy": {"name": "alert name"},
    "alertTime": "2023-08-16T11:39:36Z",
    "firstSeen": "2023-08-16T11:39:36Z",
}

alert_get_details_request_snoozed_alert_raw_response = {
    "id": "test id",
    "status": "snoozed",
    "reason": "USER_SNOOZED",
    "dismissalNote": "test snooze",
    "policy": {"name": "alert name"},
    "alertTime": "2023-08-16T11:39:36Z",
    "firstSeen": "2023-08-16T11:39:36Z",
}

alert_get_details_request_resolved_alert_raw_response = {
    "id": "test id",
    "status": "resolved",
    "reason": "RESOLVED",
    "policy": {"name": "alert name"},
...
alert_get_details_request_reopened_alert_raw_response = {
    "id": "test id",
    "status": "open",
...
get_remote_alert_data_dismissed_alert_updated_object = {
    "status": "dismissed",
    "reason": "USER_DISMISSED",
    "dismissalNote": "test dismiss",
    "policy": {"name": "alert name"},
...
get_remote_alert_data_snoozed_alert_updated_object = {
    "status": "snoozed",
    "reason": "USER_SNOOZED",
    "dismissalNote": "test snooze",
    "policy": {"name": "alert name"},
...
get_remote_alert_data_resolved_alert_updated_object = {
    "status": "resolved",
    "reason": "RESOLVED",
    "dismissalNote": "",
    "policy": {"name": "alert name"},
...
get_remote_alert_data_reopened_alert_updated_object = {
    "status": "open",
    "reason": "USER_REOPENED",
    "dismissalNote": "",
    "policy": {"name": "alert name"},
