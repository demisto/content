...
- **Prisma Cloud ID** - Associated with **Prisma Cloud - VM Alert Prioritization** incident type. The same apply for the rest of the fields in the list.
- **Prisma Cloud Reason**
- **Prisma Cloud Rules**
- **Prisma Cloud Status**
- **Prisma Cloud Time**
...
This playbook will run when a new incident is created with the **Prisma Cloud - VM Alert Prioritization** incident type whicih also includes a dedicated layout. (Available from Cortex XSOAR 6.8.0)
