...
| --- | --- | --- | --- |
| AzureIndicatorTagName | Use this input to define which tag to apply to Azure indicators. An example tag can be allowlist\_review. If no tags are specified in the input, the tag allowlist\_review will be used.  |  | Optional |
...
## Playbook Image
---
![Playbook Image](../doc_files/TIM_-_Process_Azure_indicators.png)
