...
* Define your Permissions by checking and/or clearing the appropriate check box.
  1. Allow the 'Queue' service.
  2. Allow the 'Service' and 'Object' resource types.
  3. Please allow the following permissions: 'Read', 'Write', 'Delete', 'List', 'Create', 'Add', 'Update', 'Process' and 'Immutable storage' in order to be able to achieve all integration use-cases.
