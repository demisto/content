...
def test_azure_storage_queue_update_messages_command(requests_mock):
    ...
    url = (
        f"{BASE_URL}/{queue_name}/messages/{message_id}?{SAS_TOKEN}"
...
def test_azure_storage_queue_delete_messages_command(requests_mock):
    ...
    result = delete_message_command(client, {"queue_name": queue_name, "message_id": message_id, "pop_receipt": pop_receipt})
...
def test_test_module_command_with_managed_identities(mocker, requests_mock, client_id):
    ...
    from AzureStorageQueue import MANAGED_IDENTITIES_TOKEN_URL, main
