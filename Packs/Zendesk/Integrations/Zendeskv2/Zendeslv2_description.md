Use the Zendesk V2 integration to preform operation related to users, tickets, attachments and more. 
...
please look at the commands description for more information on the required permission.
