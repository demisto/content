...
def main():
    ...
    url = params.get('url')
    cb_custom_key = params.get('credentials_custom_key', {}).get('password') or params.get('custom_key')
    cb_custom_id = params.get('credentials_custom_key', {}).get('password') or params.get('custom_id')
