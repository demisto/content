...
| activate | Whether GuardDuty should start using the uploaded ThreatEntitySet to generate findings. Possible values are: True, False. Default is True. | Required |
