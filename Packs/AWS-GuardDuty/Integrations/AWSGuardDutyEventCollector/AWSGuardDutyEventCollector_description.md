...
- Guard Duty Severity level: 'The severity level or higher of findings to be fetched. Possible values: Low, Medium, or High. For example, if you set the severity level to Medium, only findings with severity level Medium or High will be fetched.'
