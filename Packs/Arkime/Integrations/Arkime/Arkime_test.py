...
from Packs.Arkime.Integrations.Arkime.CommonServerPython import EntryType
...
length_above_max = (150, 100, 100)
negative_length = (-1, None, 1)

length_validness_input = [length_in_range, length_above_max, negative_length]


@pytest.mark.parametrize('length, max_length, expected_length', length_validness_input)
def test_length_validness(length: int, max_length: int, expected_length: int):
...
page_number_is_None = (None, 20, 0, 20, 0, 20)
page_size_is_None = (4, None, 200, 50, 4, 50)

calculate_offset_and_limit_input = [page_number_and_page_size, page_number_is_None, page_size_is_None]
