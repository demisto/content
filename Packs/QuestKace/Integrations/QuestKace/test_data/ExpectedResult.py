    ...
    "QuestKace.Ticket(val.ID === obj.ID)": [
        {
            ...
            "Submitter": {"ID": 10, "UserName": "admin", "Email": "admin@demisto.local", "FullName": "admin"},
            "Asset": {"ID": 2, "AssetTypeID": 5, "Name": "Macbook Pro", "OwnerID": 10, "AssetClassID": 0},
            "Machine": {"ID": 1, "Name": "Macbook Pro"},
            "Priority": {"ID": 2, "Name": "High", "Ordinal": 0, "Color": "red", "IsSlaEnabled": 0},
