...
This integration was integrated and tested with version xx of ItayIsTestingAgain

## Configure ItayIsTestingAgain on Cortex XSOAR

1. Navigate to **Settings** > **Integrations** > **Servers & Services**.
2. Search for ItayIsTestingAgain.
