EXPECTED_RECORDS_LIST_WITH_RECORDS = {
    "ServiceNowCMDB(val.ID===obj.ID)": {
        "Class": "test_class",
        "Records": [
            {"sys_id": "0ad329e3db27901026fca015ca9619fb", "name": "Test record 1"},
            {"sys_id": "2a41eb4e1b739810042611b4bd4bcb9d", "name": "Test record 2"},
            {"sys_id": "38b05eb1db7f581026fca015ca96198a", "name": "Test record 3"},
        ],
    }
}

EXPECTED_RECORDS_LIST_NO_RECORDS = {"ServiceNowCMDB(val.ID===obj.ID)": {"Class": "test_class"}}
        ...
        "OutboundRelations": [
            {
                ...
                "target": {
                    ...
                    "link": "https://test.service-now.com/api/now/cmdb/instance/cmdb_ci/62cfa627c0a8010e01f01b87035ba803",
