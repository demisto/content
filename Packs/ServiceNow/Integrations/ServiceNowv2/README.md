...
| close_ticket_multiple_options | Define the closing method for XSOAR Incident. When selected, closing / resolving the ServiceNow ticket is mirrored in Cortex XSOAR. /
If the instance is already configured with ***close_incident*** leave this field as None /
Otherwise, change this field to 'closed' or 'resolved' to determine the ticket closing method. | False |
