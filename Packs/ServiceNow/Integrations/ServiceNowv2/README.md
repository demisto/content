...
***
Implements the ask and data collection task interface
...
| **Argument Name** | **Description** | **Required** |
| --- | --- | --- |
| message | The message the ask or data collection generated. | Optional | 
| messageType | The type of message that should be send. | Optional | 
| to | Must be the ServiceNow ticket id. | Optional | 
