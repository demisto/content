...
4. To ensure that mirroring works:
   ...
   5. To enable mirroring to close a ticket in ServiceNow, under the **Mirrored XSOAR Ticket closure method** dropdown, select the ticket closing method,
...
16. To enable mirroring when closing an incident or ticket in Cortex XSOAR and ServiceNow, select the *closed* option from the **Mirrored XSOAR Ticket closure method** dropdown and **Close Mirrored ServiceNow Ticket** respectively.
17. Click **Done**.
...
17. Configure any **Custom Fields to Mirror**. These must start with "u_". This is available for ServiceNow v2 version 2.2.10 and later.  
  **Note:**  
  To enable mirroring custom fields, make a copy of the incoming and outgoing mappers and add the custom fields to the copies (see STEP 2 and STEP 3). Select these copies in the integration instance **Mapper (incoming)** and **Mapper (outgoing)** settings.
18. To enable mirroring when closing an incident or ticket in Cortex XSOAR and ServiceNow, select the *closed* option from the **Mirrored XSOAR Ticket closure method** dropdown **Close Mirrored ServiceNow Ticket** respectively.
19. Click **Done**.
...
| Ticket is not closing. | Verify the integration instance is configured correctly for the *Mirrored XSOAR Ticket closure method* or *Close Mirrored ServiceNow Ticket* fields.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
