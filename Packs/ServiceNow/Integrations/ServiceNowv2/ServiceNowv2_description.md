...
3. The grant type used to get an access token is `Client credentials`. Please see [Snow documentation](https://docs.servicenow.com/bundle/tokyo-platform-security/page/administer/security/concept/c_OAuthApplications.html) for more information.
