...
from test_data.response_constants import RESPONSE_TICKET, RESPONSE_MULTIPLE_TICKET, RESPONSE_UPDATE_TICKET, \
    ...
    RESPONSE_QUERY_COMPUTERS, RESPONSE_GET_TABLE_NAME, RESPONSE_UPDATE_TICKET_ADDITIONAL, RESPONSE_UPLOAD_FILE_TYPE
from test_data.result_constants import EXPECTED_TICKET_CONTEXT, EXPECTED_MULTIPLE_TICKET_CONTEXT, \
    ...
    EXPECTED_GET_TABLE_NAME, EXPECTED_UPDATE_TICKET_ADDITIONAL, EXPECTED_UPLOAD_FILE_TYPE
...
@pytest.mark.parametrize('command, args, response, expected_result, expected_auto_extract', [
    ...
    (upload_file_command, {'id': "sys_id", 'file_id': "entry_id", 'file_name': 'test_file', 'file_type': 'pdf'},
     RESPONSE_UPLOAD_FILE_TYPE, EXPECTED_UPLOAD_FILE_TYPE, True),
