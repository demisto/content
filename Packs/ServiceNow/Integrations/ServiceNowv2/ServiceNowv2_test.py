...
from ServiceNowv2 import get_server_url, get_ticket_context, get_ticket_human_readable, \
    ...
    ServiceNowClient, oauth_test_module, login_command, get_modified_remote_data_command, escape_build_query
...
def test_escape_build_query(query, escaped, result):
    """Unit test
    Given
    - an ampersand
    When
    - no escaping the ampersand
    - when escaping the ampersand
    Then
    -  Validate the query field is escaped correctly.
    """
