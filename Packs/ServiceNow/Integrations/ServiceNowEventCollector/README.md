...
***
Returns audit logs events extracted from ServiceNow. This command is used for developing/debugging and is to be used with caution, as it can create events, leading to events duplication and exceeding the API request limitation.
...
| offset | Starting record index for which to begin retrieving records. | Optional | 
