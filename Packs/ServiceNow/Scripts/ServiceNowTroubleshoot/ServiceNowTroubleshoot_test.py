...
from ServiceNowTroubleshoot import (
    categorize_active_incidents,
    filter_instances_data,
    get_integrations_details,
    parse_disabled_instances,
    parse_enabled_instances,
)
    ...
    enabled_instances_health = {
        "ServiceNow v2_instance_2": {
            ...
            "configvalues": {
                ...
                "mirror_limit": "100",
                "mirror_notes_for_new_incidents": "False",
                "proxy": "False",
                "server_close_custom_state": "None",
                "server_custom_close_code": "None",
                "sysparm_query": "stateNOT IN6,7",
                "ticket_type": "incident",
                "timestamp_field": "opened_at",
                "update_timestamp_field": "sys_updated_on",
                "url": "https://url_dummy/",
            ...
            "health": {
                "id": "ServiceNow v2.ServiceNow v2_instance_2",
                "version": 16,
                "sequenceNumber": 454401,
                "primaryTerm": 1,
                "modified": "2025-01-27T09:26:49.458264357Z",
                "sizeInBytes": 516,
                "sortValues": ["5994"],
                "brand": "ServiceNow v2",
                "instance": "ServiceNow v2_instance_2",
                "incidentsPulled": 10,
                "incidentsDropped": 0,
                "lastPullTime": "2025-01-27T09:26:45.226409678Z",
                "lastError": "",
            },
        }
    }
