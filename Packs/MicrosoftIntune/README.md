...
- In XQL queries, use: *|filter _collector_name=<Name_of_IntuneInstance_from_Azure_Event_Hub_Configuration>*
- In Datamodel queries, use: *|xdm.observer.name=<Name_of_IntuneInstance_from_Azure_Event_Hub_Configuration>*
