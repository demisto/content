...
#     res = SESSION.request(method, BASE_URL + url_suffix, verify=USE_SSL, params=params, data=data)
...
#     contents.append({"Name": service_name, "Ports": {"TCP": tcp_range, "UDP": udp_range}})
#     service_context.append({"Name": service_name, "Ports": {"TCP": tcp_range, "UDP": udp_range}})
...
#             "ReadableContentsFormat": formats["markdown"],
#             "HumanReadable": tableToMarkdown(
#                 "FortiGate firewall service " + service_name + " created successfully", contents
#             ),
#             "EntryContext": context,
#         }
#     )
...
#     payload = {"name": service_name, "tcp-portrange": tcp_range, "udp-portrange": udp_range}
...
#     payload = {"ip_addresses": ip_addresses_array, "expiry": time_to_expire}
...
#     payload = {"ip_addresses": ip_addresses_array}
#     response = http_request("POST", uri_suffix, data=json.dumps(payload))
#     return response
...
#     payload = {"policyid": int(policy_id), "q_origin_key": int(policy_id), policy_field: policy_field_value}
...
#     uri_suffix = "cmdb/firewall/policy/" + policy_id
#     params = {"action": "move", position: neighbour}
...
#     payload = {"member": new_address_group_members}
...
#     payload = {"name": group_name, "member": [{"name": address}]}
