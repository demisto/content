...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            {"address": "2001:0db8:85a3:0000:0000:8a2e:0370:7334", "mask": "64"},
            True,
            "ipprefix",
        ),
        (
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            {"address": "0.0.0.0"},
            "Missing arguments for the group Subnet, please provide all: ['address', 'mask']",
        ),
        (
            {"address": "0.0.0.0", "fqdn": "example.com"},
            "Arguments must only come from one group. Mixed groups: FQDN, Subnet",
        ),
    ],
)
