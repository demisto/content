...
def test_ip_command(requests_mock):
    ...
    client = Client(base_url="https://ipqualityscore.com/api/json/ip/api_key_here", verify=False)
    ip_suspicious_score_threshold = 75
    ip_malicious_score_threshold = 85
    reliability = "A - Completely reliable"
    args = {"ip": "15.99.160.255"}
...
def test_email_command(requests_mock):
    ...
    client = Client(base_url="https://ipqualityscore.com/api/json/email/api_key_here", verify=False)
    email_suspicious_score_threshold = 75
    email_malicious_score_threshold = 85
    reliability = "A - Completely reliable"
    args = {"email": "someone@gmail.com"}
    response = email_command(client, args, email_suspicious_score_threshold, email_malicious_score_threshold, reliability)
...
def test_url_command(requests_mock):
    ...
    requests_mock.get("https://ipqualityscore.com/api/json/url/api_key_here/https%3A%2F%2Fgoogle.com", json=mock_response)
    client = Client(base_url="https://ipqualityscore.com/api/json/url/api_key_here", verify=False)
    url_suspicious_score_threshold = 75
    url_malicious_score_threshold = 85
    reliability = "A - Completely reliable"
    args = {"url": "https://google.com"}
    response = url_command(client, args, url_suspicious_score_threshold, url_malicious_score_threshold, reliability)
