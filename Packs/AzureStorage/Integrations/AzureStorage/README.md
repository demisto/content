...
***
Run this command to get the all or spesific account storage details
...
| sku | Gets or sets the SKU name, required. | Required | 
| kind | Indicates the type of storage account, required. Possible values are: Storage, StorageV2, BlobStorage, FileStorage, BlockBlobStorage. | Required | 
| location | Gets or sets the location of the resource, required. | Required | 
...
***
Run this command to get the blob service properties of a spesific account storage
