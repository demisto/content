...
from AzureStorage import (
    ASClient,
    storage_account_create_update,
    storage_account_list,
    storage_blob_containers_create,
    storage_blob_containers_list,
    storage_blob_containers_update,
    storage_blob_service_properties_get,
    storage_blob_service_properties_set,
)
...
def test_storage_account_list(client, mocker):
    ...
    result = storage_account_list(
        client=client, args={}, params={"subscription_id": subscription_id, "resource_group_name": resource_group_name}
    )
    expected_hr = (
...
def test_storage_account_single(client, mocker):
    ...
    result = storage_account_list(
        ...
        params={"subscription_id": subscription_id, "resource_group_name": resource_group_name},
    )
    expected_hr = (
        "### Azure Storage Account List\n"
        "|Account Name|Subscription ID|Resource Group|Kind|Status Primary|Status Secondary|Location|\n"
...
def test_storage_account_create_update(client, mocker):
    ...
    result = storage_account_create_update(
        client=client,
        args={"account_name": "account_name", "sku": "Standard_GRS", "kind": "Storage", "location": "eastus"},
        params={"subscription_id": subscription_id, "resource_group_name": resource_group_name},
    )
    expected_hr = (
...
def test_storage_blob_service_properties_get(client, mocker):
    ...
    result = storage_blob_service_properties_get(
        client=client,
        args={"account_name": "account_name"},
        params={"subscription_id": subscription_id, "resource_group_name": resource_group_name},
    )
...
def test_storage_blob_service_properties_set(client, mocker):
    ...
    result = storage_blob_service_properties_set(
        client=client,
        args={"account_name": "account_name"},
        params={"subscription_id": subscription_id, "resource_group_name": resource_group_name},
    )
...
def test_storage_blob_containers_create(client, mocker):
    ...
    result = storage_blob_containers_create(
        client=client,
        args={"account_name": "account_name", "container_name": "test"},
        params={"subscription_id": subscription_id, "resource_group_name": resource_group_name},
    )
...
def test_storage_blob_containers_update(client, mocker):
    ...
    result = storage_blob_containers_update(
        client=client,
        args={"account_name": "account_name", "container_name": "test"},
        params={"subscription_id": subscription_id, "resource_group_name": resource_group_name},
    )
...
def test_storage_blob_containers_list(client, mocker):
    ...
    result = storage_blob_containers_list(
        client=client,
        args={"account_name": "account_name"},
        params={"subscription_id": subscription_id, "resource_group_name": resource_group_name},
    )
...
def test_test_module_command_with_managed_identities(mocker, requests_mock, client_id):
    ...
    from AzureStorage import MANAGED_IDENTITIES_TOKEN_URL, Resources, main
