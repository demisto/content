                    ...
                    rows=[
                        RowData(
                            cells=[
                                ...
                                KeyValuePair(
                                    key="labels",
                                    value= base64.b64encode('["{\\"label\\": {\\"name\\": \\"VIP User\\", \\"type\\": \\"LABEL_TYPE_INFORMATIVE\\", \\"tooltip\\": \\"VIP User\\", \\"created_by\\": 10, \\"risk_level\\": 0, \\"description\\": \\"VIP User\\"}}",'
                                                            '"{\\"label\\": {\\"name\\": \\"GSuite Admin\\", \\"type\\": \\"LABEL_TYPE_INFORMATIVE\\", \\"tooltip\\": \\"GSuite Admin\\", \\"created_by\\": 10, \\"risk_level\\": 0, \\"description\\": \\"GSuite Admin\\"}}",'
                                                            '"{\\"label\\": {\\"name\\": \\"Okta Admin\\", \\"type\\": \\"LABEL_TYPE_INFORMATIVE\\", \\"tooltip\\": \\"Okta Admin\\", \\"created_by\\": 10, \\"risk_level\\": 0, \\"description\\": \\"Okta Admin\\"}}"]'.encode(ENCODING)).decode(ENCODING)),
                            ]
                        )
                    ]
                ),
