...
def get_alerts_and_table_response() -> Tuple[GetIncidentTableResponse, Dict[str, Any]]:
    alert = {
        "alert": {
            ...
            "description": "1 sensitive file exposed publicly by gal@reco.ai (part of Reco IL)",
                ...
                "aggregationRuleToKey": [
                    {
                        ...
                        "aggregationKey": {
                            "stringKey": "\"gal@reco.ai\""
                        }
                    },
                    {
                        "aggregationRule": {
                            "aggregationDuration": "3600s"
                        },
                        "aggregationKey": {
                            "timeKey": "2023-05-03T10:21:04.078627293Z"
                        }
                    }
                ]
            },
