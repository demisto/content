...
HTML_DOMAIN_SECTION = util_load_json(os.path.dirname(__file__) + '/test_data/tests_data_1.json')
...
def test_grab_domain_table():
    ...
    expected_result = util_load_json(os.path.dirname(__file__) + '/test_data/tests_data_2.json')
