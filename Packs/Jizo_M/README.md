The Jizo M pack allows interaction with Jizo Manager API which contains several endpoints that allow user to recover different types of alerts and their corresponding data.
