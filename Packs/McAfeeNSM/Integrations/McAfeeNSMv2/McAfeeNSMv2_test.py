...
def test_get_session(mocker, mcafeensmv2_client):
    ...
    str_to_encode = "username:password"
    mock_session_result = {"session": "ABC3AC9AB39EE322C261B733272FC49F", "userId": "1"}
...
test_pagination_params = [(records_list[:2], 50, 1, 2), (records_list2[:2], 50, 2, 2), (records_list[:3], 3, None, None)]
...
def test_alerts_list_pagination():
    ...
    domain_id = 0
    limit = 50
    result_list = alerts_list_pagination(
        records_list, limit, page, page_size, time_period, start_time, end_time, state, search, filter_arg, client, domain_id
    )
    assert records_list == result_list


test_response_cases_params = [("Deny", "DENY"), ("Stateless Ignore", "STATELESS_IGNORE")]
...
test_rule_object_type_cases_params = [
    ("Endpoint IP V.4", "HOST_IPV_4", "up"),
...
@pytest.mark.parametrize(
    "source_rule_object_id, source_rule_object_type, destination_rule_object_id, "
    "destination_rule_object_type, create_or_update, expected_error",
    check_source_and_destination_params,
)
def test_check_source_and_destination(
...
from_to_list1 = [{"FromAddress": "1.1.1.1", "ToAddress": "2.2.2.2"}]
expected_result1 = ("IPv4AddressRange", {"IPV4RangeList": from_to_list1})
expected_result2 = ("HostIPv4", {"hostIPv4AddressList": ["1.1.1.1"]})
expected_result3 = ("Network_IPV_4", {"networkIPV4List": ["1.1.1.1"]})
create_body_create_rule_params = [
    ("IPV_4_ADDRESS_RANGE", [], 4, from_to_list1, expected_result1),
...
check_args_create_rule_params = [
    ...
    (
        ...
        None,
        4,
        'If the "rule_object_type" is “Endpoint IP V.4”'
    ...
    (
        ...
        None,
        4,
        'If the "rule_object_type" is Endpoint'
...
@pytest.mark.parametrize("rule_type, address, from_address, to_address, number, expected_error", check_args_create_rule_params)
...
overwrite_source_destination_object_params = [
    (120, "HOST_IPV_6", "Destination", [{"RuleObjectId": 120, "RuleObjectType": "HOST_IPV_6"}]),
    (-1, None, "Destination", [{"RuleObjectId": -1, "RuleObjectType": None}]),
    (None, None, "Source", [{"RuleObjectId": "117", "Name": "Range V6 Test", "RuleObjectType": "IPV_6_ADDRESS_RANGE"}]),
]


@pytest.mark.parametrize(
    "rule_object_id, rule_object_type, dest_or_src, expected_obj", overwrite_source_destination_object_params
)
...
def test_create_firewall_policy_command(mocker, mcafeensmv2_client):
            ...
            "MemberRuleList": [
                {
                    ...
                    "Response": "SCAN",
                    "Direction": "EITHER",
                    "SourceAddressObjectList": [{"RuleObjectId": 1, "RuleObjectType": "NETWORK_IPV_6"}],
                    "DestinationAddressObjectList": [{"RuleObjectId": -1, "RuleObjectType": None}],
    ...
    http_request.assert_called_with(method="POST", url_suffix="/firewallpolicy", json_data=expected_body)
...
def test_update_firewall_policy_command(mocker, mcafeensmv2_client):
    ...
    args1 = {"policy_id": "147", "domain": "0", "source_rule_object_id": "12", "source_rule_object_type": "Range IP V.4"}
    expected_body1 = {
        "Name": "n",
        "DomainId": "0",
        "VisibleToChild": True,
            ...
            "MemberRuleList": [
                {
                    ...
                    "SourceAddressObjectList": [
                        ...
                        {"RuleObjectId": 12, "RuleObjectType": "IPV_4_ADDRESS_RANGE"},
                    ],
                    "DestinationAddressObjectList": [{"Name": "Any", "RuleObjectId": "-1", "RuleObjectType": None}],
                    "SourceUserObjectList": [{"RuleObjectId": "-1", "Name": "Any", "RuleObjectType": "USER"}],
                    "ServiceObjectList": [
                        {
                            "RuleObjectId": "-1",
            ...
            "MemberRuleList": [
                {
                    ...
                    "Response": "SCAN",
                    "Direction": "EITHER",
                    "SourceAddressObjectList": [{"RuleObjectId": 12, "RuleObjectType": "IPV_4_ADDRESS_RANGE"}],
                    "DestinationAddressObjectList": [{"Name": "Any", "RuleObjectId": "-1", "RuleObjectType": None}],
                    "SourceUserObjectList": [{"RuleObjectId": "-1", "Name": "Any", "RuleObjectType": "USER"}],
                    "ServiceObjectList": [{"RuleObjectId": "-1", "Name": "Any", "RuleObjectType": None, "ApplicationType": None}],
                    "ApplicationObjectList": [],
            ...
            "MemberRuleList": [
                {
                    ...
                    "DestinationAddressObjectList": [{"RuleObjectId": 12, "RuleObjectType": "IPV_4_ADDRESS_RANGE"}],
                    "SourceUserObjectList": [{"RuleObjectId": "-1", "Name": "Any", "RuleObjectType": "USER"}],
                    "ServiceObjectList": [
                        {
                            "RuleObjectId": "-1",
    ...
    http_request.assert_called_with(method="PUT", url_suffix="/firewallpolicy/147", json_data=expected_body1)
    update_firewall_policy_command(mcafeensmv2_client, args2)
    http_request.assert_called_with(method="PUT", url_suffix="/firewallpolicy/147", json_data=expected_body2)
    update_firewall_policy_command(mcafeensmv2_client, args3)
    http_request.assert_called_with(method="PUT", url_suffix="/firewallpolicy/147", json_data=expected_body3)
...
def test_create_rule_object_command(mocker, mcafeensmv2_client):
    ...
    expected_body = {
        "RuleObjDef": {
            ...
            "description": "a new rule in the way",
            "name": "new rule",
            "HostIPv6": {"hostIPv6AddressList": ["1111:1111:1111:1111:1111:1111:1111:1111"]},
        }
    }
    mocker.patch.object(McAfeeNSMv2, "VERSION", "V9x")
    create_rule_object_command(mcafeensmv2_client, args)
    http_request.assert_called_with(method="POST", url_suffix="/ruleobject", json_data=expected_body)
...
def test_update_rule_object_command(mocker, mcafeensmv2_client):
    ...
    args1 = {"rule_id": "113", "domain": "0", "description": "updated description", "address_ip_v.4": "5.5.5.5/55"}
    expected_body1 = {
        "RuleObjDef": {
            "domain": 0,
            ...
            "Network_IPV_4": {"networkIPV4List": ["3.3.3.3/33", "4.4.4.4/44", "5.5.5.5/55"]},
        }
    }
    ...
    expected_body2 = {
        "RuleObjDef": {
            ...
            "description": "updated description",
            "name": "Network ip Test",
            "Network_IPV_4": {"networkIPV4List": ["5.5.5.5/55"]},
        }
    }
    mocker.patch.object(McAfeeNSMv2, "VERSION", "V9x")
    ...
    http_request.assert_called_with(method="PUT", url_suffix="/ruleobject/113", json_data=expected_body1, resp_type="response")
    update_rule_object_command(mcafeensmv2_client, args2)
    http_request.assert_called_with(method="PUT", url_suffix="/ruleobject/113", json_data=expected_body2, resp_type="response")
...
def test_get_alerts_command(mocker, mcafeensmv2_client):
    ...
    args = {"domain_id": "0", "time_period": "CUSTOM", "start_time": "12/17/2000 14:14", "end_time": "12/18/2022 00:26:45"}
...
args1_update_alerts = {"state": "Acknowledged"}
args2_update_alerts = {
    "state": "Acknowledged",
...
update_alerts_command_params = [
    (args1_update_alerts, "Error! You must specify a new alert state or a new assignee"),
...
@pytest.mark.parametrize(
    "input, output",
    [
        (777, {"method": "GET", "url_suffix": "/domain/9/policyassignments/device/777"}),
        (None, {"method": "GET", "url_suffix": "/domain/9/policyassignments/device"}),
    ],
)
...
@pytest.mark.parametrize(
    "input, output",
    [
        ({"mock": 777}, {"firewallPolicy": "mock", "firewallPortPolicy": "mock", "ipsPolicy": "mock", "mock": 777}),
...
def test_assign_interface_policy_request__with_and_without_custom_json(mocker, mcafeensmv2_client, input, output):
    ...
    """
    http_request = mocker.patch.object(mcafeensmv2_client, "_http_request")
    Client.assign_interface_policy_request(
        mcafeensmv2_client,
        domain_id=9,
        interface_id=9,
        custom_policy_json=input,
        firewall_policy="mock",
        firewall_port_policy="mock",
        ips_policy="mock",
    )
...
@pytest.mark.parametrize(
    "input, output", [(777, "/domain/9/policyassignments/interface/777"), (None, "/domain/9/policyassignments/interface")]
)
...
@pytest.mark.parametrize(
    ...
    [
        (
            (
                {
                    "from_to_list": [{"FromAddress": "1.1.1.1", "ToAddress": "2.2.2.2"}],
                    "rule_type": "IPV_4_ADDRESS_RANGE",
                    "address": [],
                    "number": 4,
                    "state": "Enabled",
                },
                ("IPv4AddressRange", {"IPV4RangeList": [{"FromAddress": "1.1.1.1", "ToAddress": "2.2.2.2", "state": 1}]}),
            )
        ),
        (
            (
            ...
            (
                {
                    ...
                    "rule_type": "NETWORK_IPV_6",
                    "address": ["Network IP V.6"],
                    "number": 6,
                    "state": "Disabled",
                }
            ),
...
def test_create_body_create_rule_for_v10__with_different_arguments(input, output):
    ...
    res = create_body_create_rule_for_v10(
...
def test_create_body_update_rule_for_v10(input, output):
    ...
    res = create_body_update_rule_for_v10(
        rule_type=input.get("rule"),
        address=[{"test": "test", "value": "1234"}, "789"],
        number=9,
        from_to_list=input.get("from_to_list"),
    )
    ...
    test_input = [
        {
            ...
            "HostIPv4": {
                "hostIPv4AddressList": [
                    {"ruleObjectID": 130, "value": "1.1.1.1", "state": 0, "comment": "", "userID": 0, "changedState": 0}
                ]
            },
            "HostIPv6": None,
        }
...
@pytest.mark.parametrize(
    "input, output",
    [
        ({"input_lst": [{"mOCK": "130", "Hos": "7"}, {"mocER": "130", "MOCKER": "7"}], "check_lst": ["mOCK"]}, [{"MOCK": "130"}]),
        (
...
@pytest.mark.parametrize(
    "input, output",
    [
        ({"domain_id": 0, "device_id": 0}, [{"interfaceId": "mock"}, {"interfaceId": "mock"}]),
...
def test_list_device_interface_command__with_different_arguments(mocker, input, output, mcafeensmv2_client):
    ...
    mocker.patch.object(mcafeensmv2_client, "list_device_interface_request", return_value={})
    mocker.patch.object(
        McAfeeNSMv2, "capitalize_key_first_letter", return_value=[{"interfaceId": "mock"}, {"interfaceId": "mock"}]
    )
...
@pytest.mark.parametrize(
    "input, output",
    [
        ({"domain_id": 0}, [{"policyId": "mock"}, {"policyId": "mock"}]),
        ({"domain_id": 777, "limit": 1}, [{"policyId": "mock"}]),
        ({"domain_id": 777, "limit": 1, "all_results": True}, [{"policyId": "mock"}, {"policyId": "mock"}]),
    ],
)
def test_list_device_policy_command__with_different_arguments(mocker, input, output, mcafeensmv2_client):
    ...
    mocker.patch.object(mcafeensmv2_client, "list_device_policy_request", return_value={})
...
@pytest.mark.parametrize(
    "input, output",
    [
        ({"domain_id": 0}, [{"deviceId": "mock"}, {"deviceId": "mock"}]),
...
def test_list_domain_device_command_with_different_arguments(mocker, mcafeensmv2_client, input, output):
    ...
    mocker.patch.object(mcafeensmv2_client, "list_domain_device_request", return_value={})
...
@pytest.mark.parametrize(
    ...
    [
        (
            {"interface_id": None, "return_value": [{"policyId": "mock"}, {"policyId": "mock"}]},
            [{"policyId": "mock"}, {"policyId": "mock"}],
        ),
        (
            {"interface_id": 777, "return_value": [{"policyId": "mock"}, {"policyId": "mock"}]},
            [{"policyId": "mock"}, {"policyId": "mock"}],
        ),
    ],
)
def test_list_interface_policy_command__with_multiple_different_arguments(mocker, mcafeensmv2_client, input, output):
    ...
    mocker.patch.object(mcafeensmv2_client, "list_interface_policy_request", return_value={})
    mocker.patch.object(McAfeeNSMv2, "capitalize_key_first_letter", return_value=input.get("return_value"))
    res = list_interface_policy_command(
        client=mcafeensmv2_client,
        args={"domain_id": 0, "interface_id": input.get("interface_id"), "limit": 1, "all_results": True},
    )
    assert res.outputs == output
...
def test_get_device_configuration_command(mocker, mcafeensmv2_client):
    ...
    mocker.patch.object(
        mcafeensmv2_client,
        "get_device_configuration_request",
...
def test_deploy_device_configuration_command(mocker, mcafeensmv2_client, input, output):
    ...
    mocker.patch.object(ScheduledCommand, "raise_error_if_not_supported", return_value=None)
    mocker.patch.object(mcafeensmv2_client, "deploy_device_configuration_request", return_value={"RequestId": "123"})
    mocker.patch.object(mcafeensmv2_client, "check_deploy_device_configuration_request_status", return_value=input)
    mocker.patch.object(McAfeeNSMv2, "deploy_polling_message", return_value=input)
    res = deploy_device_configuration_command(
        args={
            "device_id": 0,
...
@pytest.mark.parametrize("input, output", [("m", 1), ("x", 0)])
