...
## Configure DEV Costco - Gmail on Cortex XSOAR

1. Navigate to **Settings** > **Integrations** > **Servers & Services**.
2. Search for DEV Costco - Gmail.
...
### gmail-list-delegates
***
List all delegates for a user's inbox.
...
| **Argument Name** | **Description** | **Required** |
| --- | --- | --- |
| userid | User's email address. The "me" special value can be used to indicate the authenticated user. | Required | 
...
| **Path** | **Type** | **Description** |
| --- | --- | --- |
| Gmail.delegtes.delegateEmail | string | Delegate email address. | 
| Gmail.delegates.Mailbox | string | Mailbox containing the delegate. | 
| Gmail.delegates.VerificationStatus | unknown | Verification status of the delegate. | 
