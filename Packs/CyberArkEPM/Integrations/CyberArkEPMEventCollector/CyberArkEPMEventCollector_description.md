...
6. **Configure token expiration and bind the service user** — In the web app **Tokens** tab, set the token expiration period and save. In the **Permissions** tab, add the service user and save. The web app status should become **Deployed**.
