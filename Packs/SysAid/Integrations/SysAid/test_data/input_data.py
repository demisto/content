...
asset_readable_response_value_more_than_one = (
    [
        {
            "group": "\\",
            "id": "0A-3E-E9-13-2B-E4",
            "info": [
                {"key": "model", "keyCaption": "Model", "value": "t3.large", "valueCaption": "t3.large", "valueClass": ""},
                {
                    "key": "cpu_model",
                ...
                {"key": "description", "keyCaption": "Description", "value": "", "valueCaption": "", "valueClass": ""},
                {"key": "storage", "keyCaption": "Storage", "value": "100 Gb", "valueCaption": "100 Gb", "valueClass": ""},
            ],
        ...
        },
        {
            ...
            "info": [
                {"key": "model", "keyCaption": "Model", "value": "Galaxy S22", "valueCaption": "Galaxy S22", "valueClass": ""},
                {"key": "cpu_model", "keyCaption": "CPU Model", "value": "", "valueCaption": "", "valueClass": ""},
                {
                    "key": "description",
    ...
    "value",
    [
        {"id": "0A-3E-E9-13-2B-E4", "info": ["Model: t3.large"], "name": "EC2AMAZ-S0GM752"},
        {
            "id": "5171019c-fa80-4905-a577-c95eb518de90",
...
asset_readable_response_value_null = (
    [
        {
            "group": "\\",
            "id": "0A-3E-E9-13-2B-E4",
            "info": [
                {"key": "model", "keyCaption": "Model", "value": "", "valueCaption": "Not Empty", "valueClass": ""},
                {"key": "description", "keyCaption": "Description", "value": "", "valueCaption": "Not Empty", "valueClass": ""},
            ],
            "name": "EC2AMAZ-S0GM752",
        }
    ],
...
asset_readable_response_valueCaption_null = (
    [
        {
            "group": "\\",
            "id": "0A-3E-E9-13-2B-E4",
            "info": [
                {"key": "model", "keyCaption": "Model", "value": "2", "valueCaption": "", "valueClass": ""},
                {"key": "description", "keyCaption": "Description", "value": "6", "valueCaption": "", "valueClass": ""},
            ],
            "name": "EC2AMAZ-S0GM752",
        }
    ],
...
asset_readable_response_valueCaption_not_null = (
    {
        "group": "\\",
        "id": "0A-3E-E9-13-2B-E4",
        "info": [
...
filter_response = [
    {
        "caption": "Priority",
        "id": "priority",
        "metadata": {"limit": 500, "offset": 0, "total": 6},
        "type": "list",
        "values": [
            {"caption": "All", "id": "${list.all}"},
            {"caption": "Highest", "id": "1"},
            {"caption": "Very High", "id": "2"},
            {"caption": "High", "id": "3"},
            {"caption": "Normal", "id": "4"},
            {"caption": "Low", "id": "5"},
        ],
    },
    {
        "caption": "Assigned to",
        "id": "responsibility",
        "metadata": {"limit": 500, "offset": 0, "total": 1},
        "type": "list",
        "values": [{"caption": "sysaid-dmst", "id": "1"}],
    },
    {
        "caption": "Request user",
        "id": "request_user",
        "metadata": {"limit": 500, "offset": 0, "total": 3},
        "type": "list",
        "values": [
            {"caption": "Adi Dmst", "id": "3"},
            {"caption": "sysaid-dmst", "id": "1"},
...
service_record_expected_output = [
    {
        "Modify time": "03/15/2022 04:53:20 AM",
    ...
    {
        "Modify time": "03/07/2022 09:08:01 AM",
        "Service Record Type": "Incident",
        "Status": "New",
        "id": "28",
    ...
    {
        "Modify time": "03/20/2022 11:08:56 AM",
        "Service Record Type": "Incident",
        "Status": "New",
        "id": "33",
        "title": "Try Test",
...
service_record_expected_response_output = [
    {
        ...
        "status": "New",
        "title": "Cannot access email - Test ",
        "update_time": "03/15/2022 04:53:20 AM",
        "canArchive": True,
        "canDelete": True,
        "canUpdate": True,
        "hasChildren": False,
    ...
    },
    {
        ...
        "status": "New",
        "title": "Cannot connect to a Wi-Fi network",
        "update_time": "03/07/2022 09:08:01 AM",
        "canArchive": True,
        "canDelete": True,
        "canUpdate": True,
        "hasChildren": False,
    ...
    },
    {
        ...
        "status": "New",
        "title": "Try Test",
        "update_time": "03/20/2022 11:08:56 AM",
        "canArchive": True,
        "canDelete": True,
        "canUpdate": True,
        "hasChildren": False,
...
extract_filters_args = [
    extract_filters_no_args,
    extract_filters_empty_args,
    extract_filters_one_arg,
    extract_filters_two_args,
    extract_filters_different_amount_value_args,
    extract_filters_different_amount_key_args,
]
...
service_record_regular_info = [
    {"key": "agreement", "value": "1"},
    {"key": "change_category", "value": "0"},
    {"key": "cust_notes", "value": "This is a note for the API"},
    {"key": "description", "value": "This is a test incident"},
    {"key": "escalation", "value": "0"},
    {"key": "impact", "value": "4"},
    {"key": "priority", "value": "5"},
    {"key": "problem_sub_type", "value": "Tablet"},
    {"key": "problem_type", "value": "Mobile Devices"},
    {"key": "responsibility", "value": "1"},
    {"key": "sr_type", "value": "1"},
    {"key": "status", "value": "2"},
    {"key": "sub_type", "value": "6"},
    {"key": "third_level_category", "value": "Cannot access email"},
    {"key": "title", "value": "Cannot access email - Test"},
]

service_record_all_args = {
    "id": "6",
    "agreement": "1",
    "change_category": "0",
    "cust_notes": "This is a note for the API",
    ...
    "third_level_category": "Cannot access email",
    "title": "Cannot access email - Test",
    "custom_fields_keys": "key1,key2",
    "custom_fields_values": "value1,value2",
}
service_record_all_info = [
    {"key": "agreement", "value": "1"},
    {"key": "change_category", "value": "0"},
    {"key": "cust_notes", "value": "This is a note for the API"},
    {"key": "description", "value": "This is a test incident"},
...
fetch_request_args = [
    (
        "all",
        False,
        "1,2,5,6,8,18,19,22,23,24,25,26,27,30,31,32,33",
            ...
            "info": [
                {
                    ...
                    "keyCaption": "Modify time",
                    "value": 1646662419673,
                    "valueCaption": "03/08/2022 09:13:39 AM",
                    "valueClass": "",
                }
            ],
        },
...
filter_service_records_by_id_input = [
    keep_all_service_records_first_fetch,
    keep_all_service_records_not_first,
    keep_one_service_record_greater_id_same_time,
]
...
no_alerts = ([], 150, datetime.datetime(2022, 1, 16, 10, 0, 3), "5", datetime.datetime(2022, 1, 16, 10, 0, 3), "5", [])
    ...
    [
        ...
        },
        {
            ...
            "info": [
                ...
                {"key": "sr_type", "keyCaption": "Service Record Type", "value": 10, "valueCaption": "Request", "valueClass": ""},
            ],
        },
        {
            "id": "31",
            "info": [
                ...
                {"key": "sr_type", "keyCaption": "Service Record Type", "value": 4, "valueCaption": "Change", "valueClass": ""},
            ],
        },
    ],
    100,
...
after_one_service_record_was_fetched_high_limit = (
    [
        {
            "id": "25",
            "info": [
...
after_one_service_record_was_fetched_low_limit = (
    [
        {
            "id": "25",
            "info": [
...
fetch_from_closer_time_given_iso = ("2022-01-27T11:00:00", "2022-01-29T9:00:00", datetime.datetime(2022, 1, 29, 9, 0, 0))

calculate_fetch_start_datetime_input = [
    first_fetch_hour_ago,
    first_fetch_day_ago,
    fetch_from_closer_time_last_fetched,
    fetch_from_closer_time_given_human,
    fetch_from_closer_time_given_iso,
]

# test_get_service_record_update_time
service_record_update_time = {
    "id": "25",
    "info": [
        {
            "key": "update_time",
...
service_record_to_incident_context_input = [
    (raw_service_record_incident, incident_context),
