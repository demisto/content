...
RESOLVE_ALERT_RESPONSE = {"success": True}
GET_ASSETS_RESPONSE = {
    "count_filtered": 1,
    "count_in_page": 1,
    "count_total": 1,
...
def test_claroty_authentication(mocker, requests_mock):
    client = _create_client(mocker, requests_mock, "https://website.com:5000/auth/authenticate", MOCK_AUTHENTICATION, "POST")
...
def test_claroty_resolve_alerts(mocker, requests_mock):
    client = _create_client(
        mocker, requests_mock, "https://website.com:5000/ranger/ranger_api/resolve_alerts", RESOLVE_ALERT_RESPONSE, "POST"
    )
