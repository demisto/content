...
def test_execute_response_action(mock_response):
    ...
    result = execute_response_action_command(client, {'actionType': 'KILL_CONTAINER', 'container_id': '123456789012', "callerId": "test_kill_container_07"})
...
def test_create_system_capture(mock_response):
    ...
    mock_response.return_value.status_code = HTTPStatus.OK
    client = Client(base_url='https://us2.app.sysdig.com', verify=False, headers={'Authorization': 'Bearer token'}, proxy=False)
    result = create_system_capture_command(client, {'host_name': 'ip-1-2-3-4.us-west-1.compute.internal', 'container_id': '123456789012', "capture_name": "test_capture", "agent_id": "123456789012", "customer_id": "123456789012", "machine_id": "aa:bb:cc:11:22:33"})
