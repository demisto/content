...
def test_add_fields_event():
    ...
    """
    from OnePassword import EVENT_DATE_FORMAT, FILTER_DATE_FORMAT, add_fields_to_event, arg_to_datetime
...
def test_push_events(mocker: MockerFixture):
    ...
    """
    from OnePassword import PRODUCT as EXPECTED_PRODUCT
    from OnePassword import VENDOR as EXPECTED_VENDOR
    from OnePassword import push_events
...
def test_get_events_command(authenticated_client: Client, mocker: MockerFixture):
    ...
    """
    from OnePassword import flattenTable, get_events_command
