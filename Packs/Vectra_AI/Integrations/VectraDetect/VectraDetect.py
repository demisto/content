...
DEFAULT_STATE = {"state": "active", "resolved": "false"}
...
class Client(BaseClient):
    ...
    def search_detections(
        ...
        **kwargs,
        ...
        query_params: dict[str, Any] = {"page": 1, "order_field": "last_timestamp"}
        ...
        return self.http_request(method="GET", params=query_params, url_suffix=f"{API_SEARCH_ENDPOINT_DETECTIONS}")

    def list_detections_by_host_id(
        self, host_id: str, state: str = "active", detection_category: str = "", detection_type: str = ""
    ) -> dict:
        """
        ...
        :rtype: ``Dict``
        """
        params = assign_params(detection_category=detection_category, detection_type=detection_type, state=state, host_id=host_id)
    ...
    def search_accounts(
        ...
        **kwargs,
        ...
        # Execute request
        demisto.debug("Executing API request")
        return self.http_request(method="GET", params=query_params, url_suffix=f"{API_SEARCH_ENDPOINT_ACCOUNTS}")
    ...
    def search_hosts(
        ...
        **kwargs,
        ...
        # Execute request
        return self.http_request(method="GET", params=query_params, url_suffix=f"{API_SEARCH_ENDPOINT_HOSTS}")

    def search_assignments(
        self, id=None, account_ids=None, host_ids=None, assignee_ids=None, outcome_ids=None, resolved=None
    ) -> dict[str, Any]:
        """
        ...
        # Execute request
        return self.http_request(method="GET", params=query_params, url_suffix=f"{API_ENDPOINT_ASSIGNMENT}{url_addon}")

    def search_outcomes(self, id=None, max_results=None) -> dict[str, Any]:
        """
        ...
        # Execute request
        return self.http_request(method="GET", params=query_params, url_suffix=f"{API_ENDPOINT_OUTCOMES}{url_addon}")

    def search_users(self, id=None, last_login_datetime=None, role=None, type=None, username=None) -> dict[str, Any]:
        """
        ...
        # Execute request
        return self.http_request(method="GET", params=query_params, url_suffix=f"{API_ENDPOINT_USERS}{url_addon}")
    ...
    def get_pcap_by_detection_id(self, id: str):
        ...
        # Execute request
        return self.http_request(method="GET", url_suffix=f"{API_ENDPOINT_DETECTIONS}/{id}/pcap", resp_type="response")
    ...
    def markasfixed_by_detection_id(self, id: str, fixed: bool):
        ...
        json_payload = {"detectionIdList": [id], "mark_as_fixed": "true" if fixed else "false"}
    ...
    def add_tags(self, id: str, type: str, tags: list[str]):
        ...
        # Execute get request
        api_response = self.http_request(method="GET", url_suffix=f"{API_TAGGING}/{type}/{id}")

        current_tags: list[str] = api_response.get("tags", [])

        json_payload = {"tags": list(set(current_tags).union(set(tags)))}

        # Execute request
        return self.http_request(method="PATCH", url_suffix=f"{API_TAGGING}/{type}/{id}", json_data=json_payload)
    ...
    def del_tags(self, id: str, type: str, tags: list[str]):
        ...
        json_payload = {"tags": list(set(current_tags).difference(set(tags)))}
    ...
    def create_outcome(self, category: str, title: str):
        ...
        json_payload = {"title": raw_title, "category": raw_category}

        # Execute request
        return self.http_request(method="POST", url_suffix=API_ENDPOINT_OUTCOMES, json_data=json_payload)

    def update_assignment(
        self,
        assignee_id: str,
        assignment_id: str = None,  # type: ignore
        account_id: str = None,
        host_id: str = None,
    ):  # type: ignore
        """
        ...
        if assignment_id:  # Reassign an existing assignment
            ...
            return self.http_request(method="PUT", url_suffix=f"{API_ENDPOINT_ASSIGNMENT}{url_addon}", json_data=json_payload)
        elif account_id:
            # Test Entity ID
            try:
            ...
            json_payload.update({"assign_account_id": account_id})

            # Execute request
            return self.http_request(method="POST", url_suffix=API_ENDPOINT_ASSIGNMENT, json_data=json_payload)
        elif host_id:
            # Test Entity ID
            try:
            ...
            json_payload.update({"assign_host_id": host_id})
    ...
    def resolve_assignment(
        ...
        if rule_name:
            ...
            json_payload.update({"triage_as": rule_name, "detection_ids": list(detection_ids_set)})

        # Execute request
        return self.http_request(
            method="PUT", url_suffix=f"{API_ENDPOINT_ASSIGNMENT}/{assignment_id}/resolve", json_data=json_payload
        )
    ...
    def delete_assignment(self, assignment_id: str = ""):  # type: ignore
        ...
        if assignment_id:
            url_addon = f"/{assignment_id}"
            return self.http_request(method="DELETE", url_suffix=f"{API_ENDPOINT_ASSIGNMENT}{url_addon}", resp_type="response")
        return None
    ...
    def markasfixed_by_detection_ids(self, ids_list: list):
        ...
        json_payload = {"detectionIdList": ids_list, "mark_as_fixed": "true"}
    ...
    def remove_note_request(
        self,
        entity_type: str = None,
        entity_id: int = None,  # type: ignore
        note_id: str = None,
    ...
    def update_group_members_request(self, group_id: int = None, members: list = None) -> dict:  # type: ignore
        ...
        return self.http_request(method="PATCH", url_suffix=f"{API_ENDPOINT_GROUPS}/{group_id}", json_data=body)

    def list_assignments_request(
        self, accounts: str | None = None, hosts: str | None = None, page_size: int | None = None
    ) -> dict:
        """
    ...
    def update_entity_tags_request(
        self, entity_id: str | None = None, entity_type: str | None = None, tag_list: list | None = None
    ):
        """
...
def validate_fetch_incident_params(integration_params: dict):
    ...
    if (max_incidents_per_fetch // len(fetch_entity_types)) == 0:
        raise ValueError(
            f"Max incidents per fetch ({max_incidents_per_fetch}) must be >= "
...
def build_search_query_for_detections(
    entity_id: str, fetch_type: str, detection_category: str = "", detection_type: str = ""
) -> str:
    """
...
def detection_to_incident(detection: dict):
    ...
    incident_last_run = {
        "last_timestamp": dateparser.parse(
            extracted_data.get("LastTimestamp"),  # type: ignore
...
def host_to_incident(client: Client, host: dict, detection_category: str = "", detection_type: str = ""):
    ...
    detections = []
    detections_data = client.list_detections_by_host_id(str(host.get("id")), "active", detection_category, detection_type)
...
def account_to_incident(client: Client, account: dict, detection_category: str = "", detection_type: str = ""):
    ...
    groups_response = client.list_group_request(group_type="account", account_names=[account.get("display_name")])  # type: ignore
...
def get_last_run_details(integration_params: dict, is_test: bool = False) -> dict:
    ...
    for entity_type in ENTITY_TYPES:
        if entity_type in fetch_entity_types:
            ...
            last_timestamp = dateparser.parse(
                fetch_first_time,  # type: ignore
                settings={"TO_TIMEZONE": "UTC"},
            ).isoformat()  # type: ignore
            last_id = 0
            empty_last_run: dict = {"last_timestamp": last_timestamp, "id": last_id, "last_created_events": []}
    ...
    if date:
        ...
        if look_back:
            ...
            if look_back_int != 0:
                ...
                demisto.debug(
                    "Manipulated time as backward search. "
...
def get_list_notes_command_hr(notes: dict, entity_id: int | None, entity_type: str) -> str:  # type: ignore
    ...
    # Prepare human-readable output table
    human_readable = tableToMarkdown(
        "Notes Table", hr_dict, ["Note ID", "Note", "Created By", "Created Date", "Modified By", "Modified Date"], removeNull=True
    )
    return human_readable
        ...
        if api_response.get("count") == 0:
            ...
            for event in api_results:
                if len(entity_incidents) >= max_created_incidents:
                    demisto.debug(
                        f"{entity_type} - Maximum created incidents has been reached ({max_created_incidents})."
...
def get_remote_data_command(client: Client, integration_params: dict = {}) -> GetRemoteDataResponse:
    ...
    updated_severity_score = severity_string_to_int(
        scores_to_severity(remote_incident_data.get("threat"), remote_incident_data.get("certainty"))
    )
    ...
    if len(detection_set) != 0:
        if vectra_entity_type == "account":
            ...
            detections_data = client.list_detections_by_host_id(vectra_entity_id, "active", detection_category, detection_type)
            detections = detections_data.get("results", [])
            for detection in detections:
                detection["url"] = forge_entity_url("detection", detection.get("id"))
...
def send_close_notes(
    client: Client,
    data: dict,
    xsoar_incident_id: str,
        ...
        # Remove assignment in Vectra if incident is reopened.
            ...
            if assignment:
                ...
                if not assignment.get("resolved_by"):
                    demisto.debug(
                        f"Removing assignment with the ID: {assignment_id} for the incident having"
...
def vectra_search_outcomes_command(client: Client, **kwargs) -> CommandResults:
    ...
    if count == 0:
        ...
        readable_output = tableToMarkdown(
            name=f"Outcomes table (Showing max {MAX_RESULTS} entries)", t=outcomes_data, headers=readable_output_keys
        )
...
def vectra_get_account_by_id_command(client: Client, id: str) -> CommandResults:
    ...
    if count == 0:
        ...
        readable_output = tableToMarkdown(
            name=f"Account ID {id} details table", t=account_data, url_keys=["URL"], date_fields=["LastDetectionTimestamp"]
        )
...
def vectra_get_assignment_by_id_command(client: Client, id: str) -> CommandResults:
    ...
    if obtained_assignment is None:
        ...
        readable_output = tableToMarkdown(
            name=f"Assignment ID {id} details table", t=assignment_data, date_fields=["AssignedDate", "ResolvedDate"]
        )
...
def vectra_assignment_assign_command(
    client: Client,
    assignee_id: str = None,  # type: ignore
    account_id: str = None,
    host_id: str = None,  # type: ignore
    ...
    if (
        ((assignment_id is None) and (account_id is None) and (host_id is None))
    ...
    readable_output = tableToMarkdown(name="Assignment details table", t=assignment_data)
...
def vectra_assignment_resolve_command(
    client: Client,
    assignment_id: str = None,
    outcome_id: str = None,  # type: ignore
    note: str = None,
    detections_filter: str = None,  # type: ignore
    filter_rule_name: str = None,
    detections_list: str = None,
):  # type: ignore
    """
    ...
    if detections_filter == "Filter Rule":
        ...
        api_response = client.resolve_assignment(
...
def vectra_get_outcome_by_id_command(client: Client, id: str) -> CommandResults:
    ...
    if obtained_id is None:
        ...
        readable_output = tableToMarkdown(name=f"Outcome ID {id} details table", t=outcome_data)
...
def vectra_outcome_create_command(client: Client, category: str, title: str) -> CommandResults:
    ...
    readable_output = tableToMarkdown(name="Newly created Outcome details table", t=outcome_data)
...
def vectra_get_user_by_id_command(client: Client, id: str) -> CommandResults:
    ...
    if obtained_id is None:
        ...
        readable_output = tableToMarkdown(name=f"Vectra User ID {id} details table", t=user_data, date_fields=["LastLoginDate"])
...
def add_tags_command(client: Client, type: str, id: str, tags: str) -> CommandResults:
    ...
    # 404 API error will be raised by the Client class
    command_result = CommandResults(readable_output=f'Tags "{tags}" successfully added.', raw_response=api_response)
...
def del_tags_command(client: Client, type: str, id: str, tags: str) -> CommandResults:
    ...
    # 404 API error will be raised by the Client class
    command_result = CommandResults(readable_output=f'Tags "{tags}" successfully deleted.', raw_response=api_response)
...
def tag_list_command(client: Client, entity_type: str, args: dict) -> CommandResults:
    ...
    return CommandResults(
        outputs_prefix=f"Vectra.{entity_type.capitalize()}",
...
def note_update_command(client: Client, entity_type: str, args: dict) -> CommandResults:
    ...
    notes = client.update_note_request(
        entity_id=entity_id,
...
def note_list_command(client: Client, entity_type: str, args: dict) -> CommandResults:  # type: ignore
    ...
    return CommandResults(
        outputs={}, raw_response=notes_raw_response, readable_output=f"Couldn't find any notes for provided {entity_type}."
    )


def markall_detections_asfixed_command(
    client: Client,
    type: str,
