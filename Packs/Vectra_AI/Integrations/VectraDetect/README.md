...
3. Click **Add instance** to create and configure a new integration instance.
    ...
    | Entity types to fetch | Choose what to fetch - Accounts, Hosts and/or Detections. \(Default - Accounts &amp;amp; Hosts\) | True |
    | Accounts fetch query | Only "active" Accounts matching this fetch query will be fetched. Will be used only if "Accounts" is selected in the "Entity types to fetch". \(default - account.threat:&amp;gt;=50 AND account.certainty:&amp;gt;=50\) | False |
