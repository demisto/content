**/!\ Caution: This version breaks backward compatibility due to removed/renamed incident fields when Feching Incidents for ***classifier-Vectra_Detect_-_Incoming_Mapper*** mapper.**  
**Please find more details on the Mapper changes. /!\\**
...
##### Vectra Detect (Beta)
  ...
  - Added support for Vectra Account entity, allowing you to create incidents and/or interact with Vectra Account entities
    - New integration instance settings regarding _Fetches incidents_:
      - New _Accounts fetch query_ setting (which default to _account.threat:>=50_)
      - New entity type choice _Accounts_ under the _Entity types to fetch_ setting
    - New commands:
