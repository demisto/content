...
function fetchIncidents(){
    ...
    console.log("Responses are: "+JSON.stringify(responseTickets))
    ...
    responseTickets.forEach(function(responseTicket){
        ...
        if(statuses.indexOf(responseTicket.status) !== -1 && excludeHealthFilter && excludeMarkedTickets){
            ...
            console.log("Debug version so we are not marking tickets.")
        }
    });
        console.log("Acknowledged tickets are: "+JSON.stringify(ticketVersionsObject))
    ...
    console.log("Incidents created are: "+JSON.stringify(incidents))
