...
It returns an actual JSON string in correct format for calling salesforce-create-object using the replaced values from the user we cloned from and passed into dArgs{}.
"""
