...
import pytest
from KasperskySecurityCenter import (
    GROUP_FIELDS,
    ...
    list_host_software_patches,
    list_hosts,
    list_policies,
    list_software_applications,
...
def test_list_software_applications(client, requests_mock):
    ...
    assert result.outputs == [app.get("value") for app in api_response.get("PxgRetVal", {}).get("GNRL_EA_PARAM_1", [])]
