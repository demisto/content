...
def test_ip_enrichment_script_end_to_end_with_batch_file(mocker):
    ...
    Then:
        ...
        - Core prevalence are mapped/preserved.
    """
    ...
    def _fake_execute_list_of_batches(self, list_of_batches, brands_to_run=None, verbose=False):
        ...
        # ----- Batch 2: prevalence, enrichIndicators -----
...
def test_ip_enrichment_script_with_internal_ip(mocker):
    """
    Given:
        - One internal IP.
    When:
    ...
    Then:
        - get-endpoint-data command is executed.
