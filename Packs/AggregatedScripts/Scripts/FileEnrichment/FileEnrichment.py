...
def find_matching_dbot_score(dbot_scores: list[dict], file_context: dict[str, Any]) -> dict:
    ...
    """
    demisto.debug(f"FileEnrichment test find_matching_dbot_score: {dbot_scores=} {file_context=}.")
    hashes_in_context = {(file_context.get(hash_type) or "").casefold() for hash_type in HASH_TYPES if
                                             hash_type in file_context}
