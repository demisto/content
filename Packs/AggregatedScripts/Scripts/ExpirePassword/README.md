...
| --- | --- |
| user_id | List of users IDs of the users to expire their password. At least one of "user_id", "user_name" or "user_email" is required. |
| user_name | List of names of the users to expire their password. At least one of "user_id", "user_name" or "user_email" is required. |
