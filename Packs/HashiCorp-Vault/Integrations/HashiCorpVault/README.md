...
| aws_roles_list | A comma delimited list of roles names to generate credentials for. If not mentioned, we will generate credentials for all roles in the path. | Optional | 
