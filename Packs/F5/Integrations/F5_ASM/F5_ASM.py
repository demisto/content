...
BLOCKING_SETTINGS_REFERENCE = {
    "evasions": "evasionReference",
...
class Client(BaseClient):
    ...
    def get_id(self, md5: str, resource_name: str, action: str, compare_value: str):
        ...
        """
        url_suffix = "asm/server-technologies" if action == "server-technologies-general" else f"asm/policies/{md5}/{action}/"
    ...
    def set_id(self, md5: str, resource_id: str, resource_name: str, action: str, compare_value: str = "name") -> str:
    ...
    def get_policy_self_link(self, policy_md5):
        ...
        response = self._http_request(
            method="GET", url_suffix="asm/policies", headers=self.headers, params={"items": [{"name": policy_md5}]}
        )
    ...
    def update_policy_blocking_setting(
        self,
        policy_md5: str,
        endpoint: str,
        description: str,
        ...
        return self._http_request(
            method="PATCH", url_suffix=url_suffix, headers=self.headers, json_data=remove_empty_elements(json_body)
        )
    ...
    def list_policies(self, self_link: str, kind: str, items):
        ...
        return self._http_request(
            method="GET",
            url_suffix="asm/policies",
            headers=self.headers,
            params={"selfLink": self_link, "kind": kind, "items": items},
        )
    ...
    def create_policy(
        ...
        return self._http_request(
            method="POST", url_suffix="asm/policies", headers=self.headers, json_data=remove_empty_elements(body)
        )

    def apply_policy(self, policy_reference_link: str):
        body = {"policyReference": {"link": policy_reference_link}}
        return self._http_request(method="POST", url_suffix="asm/tasks/apply-policy", headers=self.headers, json_data=body)

    def export_policy(self, filename: str, minimal: bool, policy_reference_link: str):
        body = {"filename": filename, "minimal": minimal, "policyReference": {"link": policy_reference_link}}
        return self._http_request(method="POST", url_suffix="asm/tasks/export-policy", headers=self.headers, json_data=body)

    def delete_policy(self, policy_md5: str):
        return self._http_request(method="DELETE", url_suffix=f"asm/policies/{policy_md5}", headers=self.headers, json_data={})

    def get_policy_md5(self):
        return self._http_request(method="GET", url_suffix="asm/policies", headers=self.headers, params={})

    def list_policy_methods(self, policy_md5: str):
        return self._http_request(
            method="GET", headers=self.headers, json_data={}, url_suffix=f"asm/policies/{policy_md5}/methods"
        )

    def add_policy_method(self, policy_md5: str, new_method_name: str, act_as_method: str):
        body = {"name": new_method_name, "actAsMethod": act_as_method.upper()}
        return self._http_request(
            method="POST", headers=self.headers, json_data=body, url_suffix=f"asm/policies/{policy_md5}/methods"
        )

    def update_policy_method(self, policy_md5: str, method_id: str, method_name: str, act_as_method: str):
        method_id = self.set_id(policy_md5, method_id, method_name, "methods")
        body = {"name": method_name, "actAsMethod": act_as_method.upper()}
        return self._http_request(
            method="PATCH", headers=self.headers, json_data=body, url_suffix=f"asm/policies/{policy_md5}/methods/{method_id}"
        )

    def delete_policy_method(self, policy_md5: str, method_id: str, method_name: str):
        method_id = self.set_id(policy_md5, method_id, method_name, "methods")
        return self._http_request(
            method="DELETE", headers=self.headers, json_data={}, url_suffix=f"asm/policies/{policy_md5}/methods/{method_id}"
        )

    def list_policy_file_types(self, policy_md5: str):
        return self._http_request(
            method="GET", headers=self.headers, json_data={}, url_suffix=f"asm/policies/{policy_md5}/filetypes"
        )

    def add_policy_file_type(
        self,
        policy_md5: str,
        new_file_type: str,
        query_string_length: int,
        check_post_data_length: bool,
        response_check: bool,
        check_request_length: bool,
    ...
    def update_policy_file_type(
        ...
        return self._http_request(
            method="PATCH", headers=self.headers, json_data=body, url_suffix=f"asm/policies/{policy_md5}/filetypes/{file_type_id}"
        )
    ...
    def delete_policy_file_type(self, policy_md5: str, file_type_id: str, file_type_name: str):
        ...
        return self._http_request(method="DELETE", headers=self.headers, json_data={}, url_suffix=url_suffix)

    def list_policy_cookies(self, policy_md5: str):
        return self._http_request(
            method="GET", headers=self.headers, json_data={}, url_suffix=f"asm/policies/{policy_md5}/cookies"
        )

    def add_policy_cookie(
        self,
        policy_md5: str,
        new_cookie_name: str,
        perform_staging: bool,
        ...
        return self._http_request(
            method="POST", headers=self.headers, json_data=body, url_suffix=f"asm/policies/{policy_md5}/cookies"
        )

    def update_policy_cookie(
        self,
        policy_md5: str,
        cookie_id: str,
        cookie_name: str,
        ...
        return self._http_request(
            method="PATCH", headers=self.headers, json_data=body, url_suffix=f"asm/policies/{policy_md5}/cookies/{file_type_id}"
        )

    def delete_policy_cookie(self, policy_md5: str, cookie_id: str, cookie_name: str):
        file_type_id = self.set_id(policy_md5, cookie_id, cookie_name, "cookies")
        return self._http_request(
            method="DELETE", headers=self.headers, json_data={}, url_suffix=f"asm/policies/{policy_md5}/cookies/{file_type_id}"
        )

    def list_policy_hostnames(self, policy_md5: str):
        return self._http_request(
            method="GET", headers=self.headers, json_data={}, url_suffix=f"asm/policies/{policy_md5}/host-names"
        )
    ...
    def add_policy_hostname(self, policy_md5: str, name: str, include_subdomains: bool):
        ...
        return self._http_request(
            method="POST", headers=self.headers, json_data=data, url_suffix=f"asm/policies/{policy_md5}/host-names"
        )

    def update_policy_hostname(self, policy_md5: str, hostname_id: str, hostname_name: str, include_subdomains: bool):
        ...
        return self._http_request(
            method="PATCH", headers=self.headers, url_suffix=url_suffix, json_data={"includeSubdomains": include_subdomains}
        )
    ...
    def list_policy_urls(self, policy_md5: str):
        return self._http_request(method="GET", headers=self.headers, json_data={}, url_suffix=f"asm/policies/{policy_md5}/urls")
    ...
    def update_policy_url(
        self, policy_md5: str, url_id: str, url_name: str, perform_staging, description, mandatory_body, url_isreferrer
    ):
    ...
    def delete_policy_url(self, policy_md5: str, url_id: str, url_name: str):
        url_id = self.set_id(policy_md5, url_id, url_name, "urls")
        return self._http_request(
            method="DELETE", headers=self.headers, json_data={}, url_suffix=f"asm/policies/{policy_md5}/urls/{url_id}"
        )

    def list_policy_whitelist_ips(self, policy_md5: str):
        return self._http_request(
            method="GET", headers=self.headers, json_data={}, url_suffix=f"asm/policies/{policy_md5}/whitelist-ips"
        )

    def add_policy_whitelist_ip(
        self,
        policy_md5: str,
        ip_address: str,
        ip_mask,
        trusted_by_builder,
        ignore_brute_detection,
        description,
        block_requests,
        ignore_learning,
        never_log,
    ...
    def update_policy_whitelist_ip(
        self,
        policy_md5: str,
        ip_id: str,
        ip_address: str,
        ...
        ip_id = self.set_id(policy_md5, ip_id, ip_address, "whitelist-ips", compare_value="ipAddress")
    ...
    def delete_policy_whitelist_ip(self, policy_md5: str, ip_id: str, ip_address: str):
        ip_id = self.set_id(policy_md5, ip_id, ip_address, "whitelist-ips", compare_value="ipAddress")
        return self._http_request(
            method="DELETE", headers=self.headers, json_data={}, url_suffix=f"asm/policies/{policy_md5}/whitelist-ips/{ip_id}"
        )

    def list_policy_signatures(self, policy_md5: str):
        return self._http_request(
            method="GET", headers=self.headers, json_data={}, url_suffix=f"asm/policies/{policy_md5}/signatures"
        )

    def list_policy_parameters(self, policy_md5: str):
        return self._http_request(
            method="GET", headers=self.headers, json_data={}, url_suffix=f"asm/policies/{policy_md5}/parameters"
        )

    def add_policy_parameter(
        self,
        policy_md5: str,
        name: str,
        param_type,
        ...
        json_body = {
            ...
            "parameterLocation": param_location,
            "mandatory": mandatory,
            "performStaging": perform_staging,
    ...
    def update_policy_parameter(
        ...
        return self._http_request(
            method="PATCH", headers=self.headers, url_suffix=url_suffix, json_data=remove_empty_elements(json_body)
        )
    ...
    def list_policy_gwt_profiles(self, policy_md5: str):
        return self._http_request(
            method="GET", headers=self.headers, json_data={}, url_suffix=f"asm/policies/{policy_md5}/gwt-profiles"
        )

    def add_policy_gwt_profile(
        self,
        policy_md5: str,
        name: str,
        maximum_value_len: str,
    ...
    def delete_policy_gwt_profile(self, policy_md5: str, gwt_profile_id: str, gwt_profile_name: str):
        profile_id = self.set_id(policy_md5, gwt_profile_id, gwt_profile_name, "gwt-profiles")
        url_suffix = f"asm/policies/{policy_md5}/gwt-profiles/{profile_id}"
        return self._http_request(method="DELETE", headers=self.headers, url_suffix=url_suffix)

    def list_policy_json_profiles(self, policy_md5: str):
        return self._http_request(method="GET", headers=self.headers, url_suffix=f"asm/policies/{policy_md5}/json-profiles")

    def add_policy_json_profile(
        self,
        policy_md5: str,
        name: str,
        maximum_total_len: str,
        maximum_value_len: str,
        max_structure_depth: str,
        max_array_len: str,
        description: str,
        tolerate_parsing_warnings: bool,
        parse_parameters: bool,
        check_signatures: bool,
        check_metachars: bool,
    ):
        json_body = {
    ...
    def update_policy_json_profile(
        self,
        policy_md5: str,
        json_id: str,
        json_name: str,
    ...
    def list_policy_xml_profiles(self, policy_md5: str):
        return self._http_request(method="GET", headers=self.headers, url_suffix=f"asm/policies/{policy_md5}/xml-profiles")

    def add_policy_xml_profile(
        self,
        policy_md5: str,
        name: str,
        description,
        check_signatures,
        check_metachar_elements,
        check_metachar_attributes,
        enable_wss,
        inspect_soap,
        follow_links,
        use_xml_response,
        ...
        json_body = {
            ...
            "enableWss": enable_wss,
            "inspectSoapAttachments": inspect_soap,
            ...
            "defenseAttributes": {
                ...
                "allowProcessingInstructions": allow_processing_instructions == "true",
            },
        }
        return self._http_request(
            method="POST",
    ...
    def add_policy_server_technology(self, policy_md5: str, technology_id: str, technology_name: str):
        url_suffix = f"asm/policies/{policy_md5}/server-technologies"
        technology_id = self.set_id(
            policy_md5, technology_id, technology_name, "server-technologies-general", "serverTechnologyDisplayName"
        )
        json_body = {"serverTechnologyReference": {"link": technology_id}}
        return self._http_request(method="POST", headers=self.headers, url_suffix=url_suffix, json_data=json_body)

    def delete_policy_server_technology(self, policy_md5: str, technology_id, technology_name):
        technology_id = self.set_id(
            policy_md5, technology_id, technology_name, "server-technologies", "serverTechnologyDisplayName"
        )
        url_suffix = f"asm/policies/{policy_md5}/server-technologies/{technology_id}"
        return self._http_request(method="DELETE", headers=self.headers, url_suffix=url_suffix, json_data={})
...
def login(server_ip: str, username: str, password: str, verify_certificate: bool) -> str:
    ...
    response = requests.post(
        f"https://{server_ip}/mgmt/shared/authn/login",
...
def f5_get_policy_md5_command(client: Client, policy_name: str) -> CommandResults:
    ...
    command_results = CommandResults(
        outputs_prefix="f5.Policy", outputs_key_field="id", readable_output=readable_output, outputs=md5_dict, raw_response=result
    )
    return command_results


def f5_list_policies_command(client: Client, self_link: str = "", kind: str = "", items=None) -> CommandResults:
    """
    ...
    headers = ["name", "id", "type", "enforcementMode", "creatorName", "active", "createdTime", "selfLink"]
    result = result.get("items")
    if result:
        for element in result:
        ...
        readable_output = tableToMarkdown("f5 data for listing policies:", printable_result, headers, removeNull=True)
...
def f5_create_policy_command(
    ...
    """
    result = client.create_policy(name, kind, enforcement_mode, protocol_independent, parent, description, allow, active)
    headers = ["name", "id", "fullPath", "type", "description", "versionDatetime", "selfLink"]
    outputs, headers = build_output(headers, result)
    readable_output = tableToMarkdown("f5 data for creating policy:", outputs, headers, removeNull=True)

    command_results = CommandResults(
        outputs_prefix="f5.Policy", outputs_key_field="id", readable_output=readable_output, outputs=outputs, raw_response=result
    )
    return command_results
...
def f5_apply_policy_command(client: Client, policy_reference_link: str) -> CommandResults:
    ...
    outputs, headers = build_output(headers, result)
    readable_output = tableToMarkdown("f5 data for applying policy:", outputs, headers, removeNull=True)
...
def f5_export_policy_command(client: Client, filename: str, policy_reference_link: str, minimal: bool) -> CommandResults:
    """
    Export a policy.
    ...
    outputs, headers = build_output(headers, result)
    readable_output = tableToMarkdown("f5 data for exporting policy:", outputs, headers, removeNull=True)
...
def f5_delete_policy_command(client: Client, policy_md5: str) -> CommandResults:
    ...
    outputs, headers = build_output(headers, result)
    readable_output = tableToMarkdown("f5 data for deleting policy:", outputs, headers, removeNull=True)
...
def f5_add_policy_method_command(client: Client, policy_md5: str, new_method_name: str, act_as_method: str) -> CommandResults:
    """
    ...
    readable_output = tableToMarkdown("f5 data for adding policy methods:", outputs, headers, removeNull=True)
    command_results = CommandResults(
        outputs_prefix="f5.PolicyMethods",
        outputs_key_field="id",
        readable_output=readable_output,
...
def f5_update_policy_method_command(
    client: Client, policy_md5: str, method_id: str, method_name: str, act_as_method: str
) -> CommandResults:
    """
    ...
    readable_output = tableToMarkdown("f5 data for updating policy methods:", outputs, headers, removeNull=True)
    command_results = CommandResults(
        outputs_prefix="f5.PolicyMethods",
        outputs_key_field="id",
        readable_output=readable_output,
...
def f5_delete_policy_method_command(client: Client, policy_md5: str, method_id: str, method_name: str) -> CommandResults:
    """
    ...
    outputs, headers = build_output(OBJECT_FIELDS, result)
    readable_output = tableToMarkdown("f5 data for deleting policy methods:", outputs, headers, removeNull=True)
    command_results = CommandResults(
        outputs_prefix="f5.PolicyMethods",
        outputs_key_field="id",
        readable_output=readable_output,
...
def f5_add_policy_file_type_command(
    client: Client,
    policy_md5: str,
    new_file_type: str,
    query_string_length: int,
    ...
    """
    result = client.add_policy_file_type(
        policy_md5,
        new_file_type,
        query_string_length,
        check_post_data_length,
        response_check,
    ...
    outputs, headers = build_output(OBJECT_FIELDS, result)
    readable_output = tableToMarkdown("f5 data for adding policy file types:", outputs, headers, removeNull=True)
    command_results = CommandResults(
        outputs_prefix="f5.FileType",
        outputs_key_field="id",
        readable_output=readable_output,
...
def f5_update_policy_file_type_command(
    ...
    Args:
        ...
        perform_staging (bool): Indicates if the user wishes the new file type to be at staging.
    """
    result = client.update_policy_file_type(
        policy_md5,
        file_type_id,
        file_type_name,
        query_string_length,
...
def f5_delete_policy_file_type_command(client: Client, policy_md5: str, file_type_id: str, file_type_name: str) -> CommandResults:
    """
    ...
    outputs, headers = build_output(OBJECT_FIELDS, result)
    readable_output = tableToMarkdown("f5 data for deleting policy file type:", outputs, headers, removeNull=True)
    command_results = CommandResults(
        outputs_prefix="f5.FileType",
        outputs_key_field="id",
        readable_output=readable_output,
...
def f5_add_policy_cookie_command(
    client: Client,
    policy_md5: str,
    new_cookie_name: str,
    perform_staging: bool,
    ...
    """
    result = client.add_policy_cookie(
        policy_md5, new_cookie_name, perform_staging, parameter_type, enforcement_type, attack_signatures_check
    )
    outputs, headers = build_output(OBJECT_FIELDS, result)
    readable_output = tableToMarkdown(f"f5 data for adding policy cookie: {new_cookie_name}", outputs, headers, removeNull=True)
    command_results = CommandResults(
        outputs_prefix="f5.Cookies",
        outputs_key_field="id",
        readable_output=readable_output,
...
def f5_update_policy_cookie_command(
    client: Client,
    policy_md5: str,
    cookie_id: str,
    cookie_name: str,
    ...
    Args:
        ...
        attack_signatures_check (bool): Should attack signatures be checked. If enforcement type
         is set to 'enforce', this field will not get any value.
    """
    result = client.update_policy_cookie(
        policy_md5, cookie_id, cookie_name, perform_staging, parameter_type, enforcement_type, attack_signatures_check
    )
    outputs, headers = build_output(OBJECT_FIELDS, result)
    readable_output = tableToMarkdown("f5 data for updating cookie:", outputs, headers, removeNull=True)
    command_results = CommandResults(
        outputs_prefix="f5.Cookies",
        outputs_key_field="id",
        readable_output=readable_output,
...
def f5_delete_policy_cookie_command(client: Client, policy_md5: str, cookie_id: str, cookie_name: str) -> CommandResults:
    """
    ...
    outputs, headers = build_output(OBJECT_FIELDS, result)
    readable_output = tableToMarkdown("f5 data for deleting cookie:", outputs, headers, removeNull=True)
    command_results = CommandResults(
        outputs_prefix="f5.Cookies",
        outputs_key_field="id",
        readable_output=readable_output,
...
def f5_add_policy_hostname_command(client: Client, policy_md5: str, name: str, include_subdomains: bool) -> CommandResults:
    """
    ...
    outputs, headers = build_output(OBJECT_FIELDS, result)
    readable_output = tableToMarkdown("f5 data for adding policy hostname:", outputs, headers, removeNull=True)
    command_results = CommandResults(
        outputs_prefix="f5.Hostname",
        outputs_key_field="id",
        readable_output=readable_output,
...
def f5_update_policy_hostname_command(
    client: Client, policy_md5: str, hostname_id: str, hostname_name: str, include_subdomains: bool
) -> CommandResults:
    """
    ...
    Args:
        ...
        include_subdomains (bool): Indicates whether or not to include subdomains.
    """
    result = client.update_policy_hostname(policy_md5, hostname_id, hostname_name, include_subdomains)
    outputs, headers = build_output(OBJECT_FIELDS, result)
    readable_output = tableToMarkdown("f5 data for updating hostname:", outputs, headers, removeNull=True)
    command_results = CommandResults(
        outputs_prefix="f5.Hostname",
        outputs_key_field="id",
        readable_output=readable_output,
...
def f5_delete_policy_hostname_command(client: Client, policy_md5: str, hostname_id, hostname_name: str) -> CommandResults:
    """
    Delete a hostname from a selected policy.
    ...
    outputs, headers = build_output(OBJECT_FIELDS, result)
    readable_output = tableToMarkdown("f5 data for deleting hostname:", outputs, headers, removeNull=True)
    command_results = CommandResults(
        outputs_prefix="f5.Hostname",
        outputs_key_field="id",
        readable_output=readable_output,
...
def f5_add_policy_url_command(
    ...
    """
    result = client.add_policy_url(
        policy_md5, name, protocol, url_type, is_allowed, description, perform_staging, clickjacking_protection, method
    )
    outputs, headers = build_output(OBJECT_FIELDS, result)
    readable_output = tableToMarkdown("f5 data for adding policy url:", outputs, headers, removeNull=True)
    command_results = CommandResults(
        outputs_prefix="f5.Url",
        outputs_key_field="id",
        readable_output=readable_output,
...
def f5_update_policy_url_command(
    client: Client,
    policy_md5: str,
    url_id: str,
    url_name: str,
    perform_staging=None,
    description=None,
    mandatory_body=None,
    url_isreferrer=None,
) -> CommandResults:
    ...
    result = client.update_policy_url(policy_md5, url_id, url_name, perform_staging, description, mandatory_body, url_isreferrer)
    outputs, headers = build_output(OBJECT_FIELDS, result)
    readable_output = tableToMarkdown("f5 data for updating url:", outputs, headers, removeNull=True)
    command_results = CommandResults(
        outputs_prefix="f5.Url",
        outputs_key_field="id",
        readable_output=readable_output,
...
def f5_delete_policy_url_command(client: Client, policy_md5: str, url_id: str, url_name: str) -> CommandResults:
    """
    ...
    outputs, headers = build_output(OBJECT_FIELDS, result)
    readable_output = tableToMarkdown("f5 data for deleting url:", outputs, headers, removeNull=True)
    command_results = CommandResults(
        outputs_prefix="f5.Url",
        outputs_key_field="id",
        readable_output=readable_output,
...
def f5_add_policy_whitelist_ip_command(
    client: Client,
    policy_md5: str,
    ip_address: str,
    ip_mask=None,
    ...
    """
    result = client.add_policy_whitelist_ip(
        policy_md5,
        ip_address,
        ip_mask,
        trusted_by_builder,
    ...
    readable_output = tableToMarkdown("f5 data for listing whitelist IP:", printable_result, OBJECT_FIELDS, removeNull=True)
    command_results = CommandResults(
        outputs_prefix="f5.WhitelistIP",
        outputs_key_field="id",
        readable_output=readable_output,
...
def f5_update_policy_whitelist_ip_command(
    client: Client,
    policy_md5: str,
    ip_id: str,
    ip_address: str,
    ...
    Args:
        ...
        ignore_intelligence(bool): Whether or not to ignore intelligence gathered on the IP.
    """
    result = client.update_policy_whitelist_ip(
        policy_md5,
        ip_id,
        ip_address,
        trusted_by_builder,
...
def f5_delete_policy_whitelist_ip_command(client, policy_md5: str, ip_id: str, ip_address: str) -> CommandResults:
    """
...
def f5_add_policy_parameter_command(
    client,
    policy_md5: str,
    name: str,
    param_type=None,
    ...
    """
    result = client.add_policy_parameter(
        policy_md5,
        name,
        param_type,
        value_type,
    ...
    printable_result, _ = build_output(OBJECT_FIELDS, result)
    readable_output = tableToMarkdown("f5 data for adding parameter:", printable_result, OBJECT_FIELDS, removeNull=True)
    command_results = CommandResults(
        outputs_prefix="f5.Parameter",
        outputs_key_field="id",
        readable_output=readable_output,
...
def f5_update_policy_parameter_command(
    client,
    policy_md5: str,
    parameter_id: str,
    parameter_name: str,
    ...
    Args:
        ...
        sensitive(bool): Should the parameter values be masked in logs.
    """
    result = client.update_policy_parameter(
        policy_md5,
        parameter_id,
        parameter_name,
        value_type,
    ...
    printable_result, _ = build_output(OBJECT_FIELDS, result)
    readable_output = tableToMarkdown("f5 data for updating parameter:", printable_result, OBJECT_FIELDS, removeNull=True)
    command_results = CommandResults(
        outputs_prefix="f5.Parameter",
        outputs_key_field="id",
        readable_output=readable_output,
...
def f5_delete_policy_parameter_command(client, policy_md5: str, parameter_id, parameter_name) -> CommandResults:
    """
    ...
    printable_result, _ = build_output(OBJECT_FIELDS, result)
    readable_output = tableToMarkdown("f5 data for deleting parameter:", printable_result, OBJECT_FIELDS, removeNull=True)
    command_results = CommandResults(
        outputs_prefix="f5.Parameter",
        outputs_key_field="id",
        readable_output=readable_output,
...
def f5_add_policy_gwt_profile_command(
    client,
    policy_md5: str,
    name: str,
    maximum_value_len: str,
    ...
    """
    result = client.add_policy_gwt_profile(
        policy_md5,
        name,
        maximum_value_len,
        maximum_total_len,
    ...
    printable_result, _ = build_output(OBJECT_FIELDS, result)
    readable_output = tableToMarkdown("f5 data for adding GWT profile:", printable_result, OBJECT_FIELDS, removeNull=True)
    command_results = CommandResults(
        outputs_prefix="f5.GWTProfile",
        outputs_key_field="id",
        readable_output=readable_output,
...
def f5_update_policy_gwt_profile_command(
    client,
    policy_md5: str,
    gwt_profile_id: str,
    gwt_profile_name: str,
    ...
    Args:
        ...
        check_metachars(bool): Should metachar elements be checked.
    """
    result = client.update_policy_gwt_profile(
        policy_md5,
        gwt_profile_id,
        gwt_profile_name,
        maximum_value_len,
    ...
    printable_result, _ = build_output(OBJECT_FIELDS, result)
    readable_output = tableToMarkdown("f5 data for updating GWT profile:", printable_result, OBJECT_FIELDS, removeNull=True)
    command_results = CommandResults(
        outputs_prefix="f5.GWTProfile",
        outputs_key_field="id",
        readable_output=readable_output,
...
def f5_delete_policy_gwt_profile_command(client, policy_md5: str, gwt_profile_id: str, gwt_profile_name: str) -> CommandResults:
    """
    ...
    printable_result, _ = build_output(OBJECT_FIELDS, result)
    readable_output = tableToMarkdown("f5 data for deleting GWT profile:", printable_result, OBJECT_FIELDS, removeNull=True)
    command_results = CommandResults(
        outputs_prefix="f5.GWTProfile",
        outputs_key_field="id",
        readable_output=readable_output,
...
def f5_add_policy_json_profile_command(
    client,
    policy_md5: str,
    name: str,
    maximum_total_len: str,
    ...
    """
    result = client.add_policy_json_profile(
        policy_md5,
        name,
        maximum_total_len,
        maximum_value_len,
    ...
    printable_result, _ = build_output(OBJECT_FIELDS, result)
    readable_output = tableToMarkdown("f5 data for adding JSON profile:", printable_result, OBJECT_FIELDS, removeNull=True)
    command_results = CommandResults(
        outputs_prefix="f5.JSONProfile",
        outputs_key_field="id",
        readable_output=readable_output,
...
def f5_update_policy_json_profile_command(
    client,
    policy_md5: str,
    json_id: str,
    json_name: str,
    ...
    Args:
        ...
        check_metachars(bool): Should the profile check for metachar elements.
    """
    result = client.update_policy_json_profile(
        policy_md5,
        json_id,
        json_name,
        description,
    ...
    printable_result, _ = build_output(OBJECT_FIELDS, result)
    readable_output = tableToMarkdown("f5 data for updating JSON profile:", printable_result, OBJECT_FIELDS, removeNull=True)
    command_results = CommandResults(
        outputs_prefix="f5.JSONProfile",
        outputs_key_field="id",
        readable_output=readable_output,
...
def f5_delete_policy_json_profile_command(client, policy_md5: str, json_id: str, json_name: str) -> CommandResults:
    """
    ...
    printable_result, _ = build_output(OBJECT_FIELDS, result)
    readable_output = tableToMarkdown("f5 data for deleting JSON profile:", printable_result, OBJECT_FIELDS, removeNull=True)
    command_results = CommandResults(
        outputs_prefix="f5.JSONProfile",
        outputs_key_field="id",
        readable_output=readable_output,
...
def f5_add_policy_xml_profile_command(
    client,
    policy_md5: str,
    name: str,
    description=None,
    check_signatures=None,
    check_metachar_elements=None,
    check_metachar_attributes=None,
    enable_wss=None,
    inspect_soap=None,
    follow_links=None,
    use_xml_response=None,
    allow_cdata=None,
    allow_dtds=None,
    allow_external_ref=None,
    ...
    """
    result = client.add_policy_xml_profile(
        policy_md5,
        name,
        description,
        check_signatures,
    ...
    printable_result, _ = build_output(OBJECT_FIELDS, result)
    readable_output = tableToMarkdown("f5 data for adding XML profile:", printable_result, OBJECT_FIELDS, removeNull=True)
    command_results = CommandResults(
        outputs_prefix="f5.XMLProfile",
        outputs_key_field="id",
        readable_output=readable_output,
...
def f5_update_policy_xml_profile_command(
    client,
    policy_md5: str,
    xml_id: str,
    xml_name: str,
    ...
    Args:
        ...
        allow_processing_instructions (bool): Whether or not to allow processing instructions.
    """
    result = client.update_policy_xml_profile(
        policy_md5,
        xml_id,
        xml_name,
        description,
    ...
    printable_result, _ = build_output(OBJECT_FIELDS, result)
    readable_output = tableToMarkdown("f5 data for updating XML profile:", printable_result, OBJECT_FIELDS, removeNull=True)
    command_results = CommandResults(
        outputs_prefix="f5.XMLProfile",
        outputs_key_field="id",
        readable_output=readable_output,
...
def f5_delete_policy_xml_profile_command(client, policy_md5: str, xml_id: str, xml_name: str) -> CommandResults:
    """
    ...
    printable_result, _ = build_output(OBJECT_FIELDS, result)
    readable_output = tableToMarkdown("f5 data for deleting XML profile:", printable_result, OBJECT_FIELDS, removeNull=True)
    command_results = CommandResults(
        outputs_prefix="f5.XMLProfile",
        outputs_key_field="id",
        readable_output=readable_output,
...
def f5_add_policy_server_technology_command(client, policy_md5: str, technology_id: str, technology_name: str) -> CommandResults:
    """
    ...
    printable_result, _ = build_output(OBJECT_FIELDS, result)
    readable_output = tableToMarkdown("f5 data for adding server technology:", printable_result, OBJECT_FIELDS, removeNull=True)
    command_results = CommandResults(
        outputs_prefix="f5.ServerTechnology",
        outputs_key_field="id",
        readable_output=readable_output,
...
def f5_delete_policy_server_technology_command(
    client, policy_md5: str, technology_id: str, technology_name: str
) -> CommandResults:
    """
    ...
    printable_result, _ = build_output(OBJECT_FIELDS, result)
    readable_output = tableToMarkdown("f5 data for listing server technology:", printable_result, OBJECT_FIELDS, removeNull=True)
    command_results = CommandResults(
        outputs_prefix="f5.ServerTechnology",
        outputs_key_field="id",
        readable_output=readable_output,
...
def f5_list_policy_blocking_settings_command(client: Client, policy_md5: str, endpoint: str) -> CommandResults:
    """
    ...
    if result:
        for item in result:
            current_object_data = {
                ...
                "section-reference": item.get("sectionReference").get("link") if item.get("sectionReference") else None,
    ...
    readable_output = tableToMarkdown(
        f"{endpoint.capitalize()} for selected policy",
        printable_result,
        headers=[
            "id",
            "description",
...
def f5_update_policy_blocking_settings_command(
    client: Client,
    policy_md5: str,
    endpoint: str,
    description: str,
    ...
    """
    result = client.update_policy_blocking_setting(policy_md5, endpoint, description, enabled, learn, alarm, block)
    printable_result = {
...
def build_output(headers: list[str], result: dict):
    ...
    if server_tech_reference:
        printable_result["serverTechnologyName"] = server_tech_reference.get("serverTechnologyName")
