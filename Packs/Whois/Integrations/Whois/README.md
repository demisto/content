...
```json
{
    ...
    "IP": {
        ...
        "Geo": {
            "Country": "US",
            "Description": "Mountain View, California, 94043, US",
...
>### IPinfo results for 8.8.8.8
>|anycast|city|country|hostname|ip|lat|lng|loc|org|postal|readme|region|timezone|
>|---|---|---|---|---|---|---|---|---|---|---|---|---|
>| true | Mountain View | US | dns.google | 8.8.8.8 | 37.4056 | -122.0775 | 37.4056,-122.0775 | AS15169 Google LLC | 94043 | https:<span>//</span>ipinfo.io/missingauth | California | America/Los_Angeles |
