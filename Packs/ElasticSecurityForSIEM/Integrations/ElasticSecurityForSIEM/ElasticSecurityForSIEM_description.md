The Elastic Security for SIEM integration supports Elasticsearch 6.0.0 and later.
...
---
[View Integration Documentation](https://xsoar.pan.dev/docs/reference/integrations/elasticsearch-v2)