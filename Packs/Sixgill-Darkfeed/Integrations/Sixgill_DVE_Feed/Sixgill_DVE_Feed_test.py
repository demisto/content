...
expected_ioc_output = [
    {
        ...
        "fields": {
            ...
            "Datetime: 2020-06-30T00:00Z\nCVSS 3.1 score: 5.3\nCVSS 3.1 severity: MEDIUM\nNVD Link: "
            "https://nvd.nist.gov/vuln/detail/CVE-2020-15392\nNVD - last modified date: "
    ...
    },
    {
        ...
        "fields": {
            ...
            "2020-06-30T00:00Z\nCVSS 3.1 score: 9.8\nCVSS 3.1 severity: CRITICAL\nNVD Link: "
            "https://nvd.nist.gov/vuln/detail/CVE-2020-12828\nNVD - last modified date: "
    ...
    },
    {
        ...
        "fields": {
            ...
            "level: prev_level\nEvent Description: Sixgill Current score of CVE-2015-6086 changed from "
            "Low to None.\nEvent Datetime: 2020-06-30T00:00Z\nCVSS 3.1 score: None\nCVSS 3.1 severity: "
...
def mocked_request(*args, **kwargs):
    ...
    response_dict = {
        ...
        "GET": {
            "/dvefeed/ioc?limit=1000": MockedResponse(200, json.dumps(iocs_bundle[bundle_index])),
        },
    }
...
def test_fetch_indicators_command(mocker):
    ...
    client = SixgillFeedClient("client_id", "client_secret", "some_channel", FeedStream.DVEFEED, demisto, 1000)
