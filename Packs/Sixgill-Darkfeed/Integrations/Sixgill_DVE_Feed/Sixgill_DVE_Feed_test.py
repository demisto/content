...
iocs_bundle = [{
    ...
    'objects': [
            ...
            },
        {
            ...
            'external_references': [{'external_id': 'CVE-2020-15392',
                                    'source_name': 'cve'}],
            ...
            'x_sixgill_info': {'event': {
                ...
                'vector_v3': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:L/I:N/A:N'
                    ,
                             ...
                             'highest': {'date': '2020-07-27T00:00Z',
                             'value': 0.02},
                             'previouslyExploited': 0.07}},
            },
        {
            'created': '2020-08-19T23:08:05.709Z',
            'external_references': [{'external_id': 'CVE-2020-2021',
                                    'source_name': 'cve'}],
            ...
            'x_sixgill_info': {'event': {
                ...
                'vector_v3': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:C/C:H/I:H/A:H'
                    ,
                             ...
                             'highest': {'date': '2020-07-14T00:00Z',
                             'value': 9.25},
                             'previouslyExploited': 5.32}},
            },
        {
            'created': '2020-08-19T23:08:05.709Z',
            'external_references': [{'external_id': 'CVE-2020-12828',
                                    'source_name': 'cve'}],
            ...
            'x_sixgill_info': {'event': {
                ...
                'vector_v3': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H'
                    ,
                             ...
                             'highest': {'date': '2020-07-25T00:00Z',
                             'value': 8.4},
                             'previouslyExploited': 5.07}},
            },
        {
            'created': '2020-08-19T23:08:05.709Z',
            'external_references': [{'external_id': 'CVE-2020-9771',
                                    'source_name': 'cve'}],
            ...
            'x_sixgill_info': {'event': {
                ...
                'vector_v2': 'None',
                'vector_v3': 'None',
                }, 'score': {'current': None, 'highest': {'date': None,
                             'value': None},
                             'previouslyExploited': None}},
            },
        {
            'created': '2020-08-25T17:16:52.536Z',
            'external_references': [{'external_id': 'CVE-2015-6086',
                                    'source_name': 'cve'}],
            ...
            'x_sixgill_info': {'event': {
                ...
                'vector_v3': 'None',
                             ...
                             'highest': {'date': '2016-04-14T00:00Z',
                             'value': 7.02},
...
def init_params():
    return {'client_id': 'WRONG_CLIENT_ID_TEST',
...
def mocked_request(*args, **kwargs):
    ...
    response_dict = {'POST': {'/auth/token': MockedResponse(200,
                     mocked_get_token_response),
                     '/dvefeed/ioc/ack': MockedResponse(200,
                     str(submitted_indicators))},
                     'GET': {'/dvefeed/ioc?limit=1000': MockedResponse(200,
                     json.dumps(iocs_bundle[bundle_index]))}}
    ...
    if method == 'GET' and end_point == '/dvefeed/ioc?limit=1000':
        submitted_indicators = \
            len(iocs_bundle[bundle_index].get('objects')) - 2
        bundle_index += 1
    return response
...
def test_test_module_command_raise_exception(mocker):
    ...
    mocker.patch('requests.sessions.Session.send',
                 return_value=MockedResponse(400, 'error'))
...
def test_test_module_command(mocker):
    mocker.patch.object(demisto, 'params', return_value=init_params())
    mocker.patch('requests.sessions.Session.send',
                 return_value=MockedResponse(200, 'ok'))
...
def test_feed_tags_and_tlp_color(mocker, tlp_color):
    ...
    output = fetch_indicators_command(client, tags=['tag1', 'tag2'],
            tlp_color=tlp_color)
    assert all(item in output[0]['fields']['tags'] for item in ['tag1',
               'tag2'])
    if tlp_color:
