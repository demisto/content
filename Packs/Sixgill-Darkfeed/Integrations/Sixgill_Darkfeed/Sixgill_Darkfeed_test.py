...
def mocked_request(*args, **kwargs):
    ...
    response_dict = {
        'POST': {
            ...
            '/ioc/enrich':
                MockedResponse(200, json.dumps(enrich_ioc_data))
        },
        'GET': {
...
def test_ip_reputation_command(mocker):
    ...
    from Sixgill_Darkfeed import ip_reputation_command
    from sixgill.sixgill_enrich_client import SixgillEnrichClient

    client = SixgillEnrichClient("client_id",
                                 "client_secret",
                                 "some_channel")
...
def test_domain_reputation_command(mocker):
    ...
    from Sixgill_Darkfeed import domain_reputation_command
    from sixgill.sixgill_enrich_client import SixgillEnrichClient
...
def test_url_reputation_command(mocker):
    ...
    from Sixgill_Darkfeed import url_reputation_command
    from sixgill.sixgill_enrich_client import SixgillEnrichClient
...
def test_file_reputation_command(mocker):
    ...
    from Sixgill_Darkfeed import file_reputation_command
    from sixgill.sixgill_enrich_client import SixgillEnrichClient
...
def test_actor_reputation_command(mocker):
    ...
    from Sixgill_Darkfeed import actor_reputation_command
    from sixgill.sixgill_enrich_client import SixgillEnrichClient
...
def test_postid_reputation_command(mocker):
    ...
    from Sixgill_Darkfeed import postid_reputation_command
    from sixgill.sixgill_enrich_client import SixgillEnrichClient
