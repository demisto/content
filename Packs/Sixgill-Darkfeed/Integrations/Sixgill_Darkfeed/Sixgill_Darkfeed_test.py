...
expected_ioc_output = [
    ...
    },
    {
        ...
        "fields": {
            ...
            "sixgillfeedid": "darkfeed_004",
            "sixgillconfidence": 90,
            "sixgillpostreference": "https://portal.cybersixgill.com/#/search?q=" "_id:59f08fbf692f84f15353a5e946d2a1cebab92418",
    ...
    {
        "value": "http://somewebsite.rar.html",
        "type": "URL",
        "rawJSON": {
            "created": "2020-01-09T07:31:16.757Z",
            "description": "Shell access to this domain is " "being sold on dark web markets",
        ...
        "fields": {
            ...
            "sixgillconfidence": 90,
            "sixgillpostreference": "https://portal.cybersixgill.com/#/search?q=" "_id:f46cdfc3332d9a04aa63078d82c1e453fd76ba50",
            "sixgillindicatorid": "indicator--6e8b5f57-3ee2-4c4a-9283-8547754dfa09",
            "sixgilldescription": "Shell access to this domain is " "being sold on dark web markets",
            "sixgillvirustotaldetectionrate": None,
            "sixgillvirustotalurl": None,
            "sixgillmitreattcktactic": None,
    ...
    },
    {
        ...
        "rawJSON": {
            ...
            "sixgill_feedid": "darkfeed_005",
            "sixgill_feedname": "compromised_sites",
            "sixgill_postid": "c3f266e67f163e1a6" "181c0789e225baba89212a2",
            "sixgill_posttitle": "somewebsite.com",
            "sixgill_severity": 70,
            "sixgill_source": "market_magbo",
            "spec_version": "2.0",
        ...
        "fields": {
            ...
            "sixgilllanguage": "en",
            "sixgillposttitle": "somewebsite.com",
            "sixgillfeedid": "darkfeed_005",
            "sixgillconfidence": 60,
            "sixgillpostreference": "https://portal.cybersixgill.com/#/search?q=" "_id:c3f266e67f163e1a6181c0789e225baba89212a2",
    ...
    },
    {
        ...
        "fields": {
            ...
            "'source_name': 'mitre-attack'}]\n",
            "sixgillactor": "LunarEclipsed",
            "sixgillfeedname": "proxy_ips",
            "sixgillsource": "forum_nulled",
            "sixgilllanguage": "en",
            "sixgillposttitle": "✅ 9.7K HTTP/S PROXY LIST (FRESH) ✅",
            "sixgillfeedid": "darkfeed_009",
            "sixgillconfidence": 70,
            "sixgillpostreference": "https://portal.cybersixgill.com/#/search?q=" "_id:00f74eea142e746415457d0dd4a4fc747add3a1b",
            ...
            "feedrelatedindicators": [
                {"type": "MITRE ATT&CK", "value": "TA0021", "description": "https://attack.mitre.org/tactics/TA0021/"}
            ],
        },
        "score": 3,
    },
...
def mocked_request(*args, **kwargs):
    ...
    response_dict = {
        "POST": {
            ...
            "/darkfeed/ioc/ack": MockedResponse(200, str(submitted_indicators)),
        },
        "GET": {
            "/darkfeed/ioc?limit=1000": MockedResponse(200, json.dumps(iocs_bundle[bundle_index])),
        },
    }
...
def test_fetch_indicators_command(mocker):
    ...
    client = SixgillFeedClient("client_id", "client_secret", "some_channel", FeedStream.DARKFEED, demisto, 1000)
