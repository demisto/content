...
class Client(CoreClient):
    ...
    def handle_fetch_starred_incidents(self, limit: int, page_number: int, request_data: dict) -> List:
        ...
        res = self._http_request(
            method="POST", url_suffix="/incidents/get_incidents/", json_data={"request_data": request_data}, timeout=self.timeout
        )
    ...
    def get_tenant_info(self):
        reply = self._http_request(
            method="POST", url_suffix="/system/get_tenant_info/", json_data={"request_data": {}}, timeout=self.timeout
        )
        return reply.get("reply", {})
...
def get_incident_extra_data_command(client, args):
    ...
    raw_incident = {
        "incident": {
            ...
            "modification_time": 1675721186878,
            "detection_time": None,
            ...
            "data": [
                {
                    ...
                    "severity": "low",
                    "matching_status": "MATCHED",  # noqa: E501
                    "end_match_attempt_ts": None,
                    "local_insert_ts": 1671731192490,
                    "last_modified_ts": None,
                    "bioc_indicator": None,  # noqa: E501
                    "matching_service_rule_id": "fd879de7-fb74-44f0-b699-805d0b08b1fd",
                    "attempt_counter": None,  # noqa: E501
                    "bioc_category_enum_key": None,
                    "case_id": 413,
                    "is_whitelisted": False,
                    "starred": False,
                    "deduplicate_tokens": None,  # noqa: E501
                    "filter_rule_id": None,
                    "mitre_technique_id_and_name": "T1110.001 - Brute Force: Password Guessing",  # noqa: E501
                    "mitre_tactic_id_and_name": "TA0006 - Credential Access",
                    "agent_version": "7.9.0.18674",
                    "agent_ip_addresses_v6": None,  # noqa: E501
                    ...
                    "event_sub_type": 1,  # noqa: E501
                    "module_id": None,
                    "association_strength": 50,
                    "dst_association_strength": 0,
                    "story_id": "ODczNjk1Mzc1MTMwMzI1NjA1Nw==",  # noqa: E501
                    "event_id": "ODczNjk1Mzc1MTMwMzI1NjA1Nw==",
                    "event_type": "Login",
                    "event_timestamp": 1671730625375,  # noqa: E501
                    "actor_process_instance_id": "AdkP08aY7RwAAAL0AAAAAA==",
                    "actor_process_image_path": "C:\\Windows\\System32\\lsass.exe",  # noqa: E501
                    "actor_process_image_name": "lsass.exe",
                    "actor_process_command_line": "C:\\WINDOWS\\system32\\lsass.exe",  # noqa: E501
                    "actor_process_signature_status": "Signed",
                    "actor_process_signature_vendor": "Microsoft Corporation",  # noqa: E501
                    ...
                    "actor_process_causality_id": "AdkP08aY7RwAAAL0AAAAAA==",  # noqa: E501
                    "actor_causality_id": "AdkP08aY7RwAAAL0AAAAAA==",
                    "actor_process_os_pid": 756,
                    "actor_thread_thread_id": 4020,  # noqa: E501
                    ...
                    "causality_actor_causality_id": "AdkP08aY7RwAAAL0AAAAAA==",  # noqa: E501
                    ...
                    "os_actor_process_image_name": "lsass.exe",  # noqa: E501
                    "os_actor_process_command_line": "C:\\WINDOWS\\system32\\lsass.exe",
                    "os_actor_process_signature_status": "Signed",  # noqa: E501
                    ...
                    "fw_app_id": "",
                    "fw_interface_from": "",  # noqa: E501
                    "fw_interface_to": "",
                    "fw_rule": "",
                    "fw_rule_id": None,
                    "fw_device_name": "",
                    "fw_serial_number": "",  # noqa: E501
                    "fw_url_domain": None,
                    "fw_email_subject": None,
                    "fw_email_sender": None,
                    "fw_email_recipient": None,  # noqa: E501
                    "fw_app_subcategory": None,
                    "fw_app_category": None,
                    "fw_app_technology": None,
                    "fw_vsys": None,
                    "fw_xff": None,  # noqa: E501
                    "fw_misc": None,
                    "fw_is_phishing": "N/A",
                    "dst_agent_id": "",
                    "dst_causality_actor_process_execution_time": None,  # noqa: E501
                    "dns_query_name": None,
                    ...
                    "contains_featured_user": "NO",  # noqa: E501
                    "contains_featured_ip": "NO",
                    "image_name": None,
                    "container_id": None,
                    "cluster_name": None,  # noqa: E501
                    "referenced_resource": None,
                    "operation_name": None,
                    "identity_sub_type": None,
                    "identity_type": None,
                    "project": None,  # noqa: E501
                    "cloud_provider": None,
                    "resource_type": None,
                    "resource_sub_type": None,
                    "user_agent": None,  # noqa: E501
                    "alert_type": "Unclassified",
                    "resolution_status": "STATUS_010_NEW",
                    "resolution_comment": None,
                    "dynamic_fields": None,  # noqa: E501
                    "tags": "DS:PANW/XDR Agent",
                    "events_length": 1,
                    "alert_id": "150807",
                    "detection_timestamp": 1671730626096,  # noqa: E501
    ...
    if len(context_alerts) > 0:
        readable_output.append(
            tableToMarkdown("Alerts", context_alerts, headers=[key for key in context_alerts[0] if key != "host_ip"])
        )
    else:
    ...
    account_context_output = assign_params(Username=incident.get("users", ""))  # type:ignore[union-attr]
...
def get_remote_data_command(client, args):
    ...
    try:
        ...
        incident_data = get_incident_extra_data_command(
            client,
            {
    ...
    incidents = [
        {
            ...
            "creation_time": 1671731222757,
            "critical_severity_alert_count": 0,
            "description": "'Possible external RDP Brute-Force' generated by XDR"
            " Analytics detected on host dc1env12apc05 involving "
        ...
        "alerts": [
            {
                "alert_fields": {
                    "action_country": ["UNKNOWN"],
                    "action_file_name": ["dnsapi.dll"],
                    "action_file_sha256": ["7A31418E4ABC333EC28E11A05ED794A6EE930D6B2CDE84DA4F7B959B49335FE4"],
                    "action_process_signature_status": ["SIGNATURE_UNAVAILABLE"],
                    "activated": "0001-01-01T00:00:00Z",
                    "activatingingUserId": "",
                    "actor_effective_username": ["env4.local\\Administrator"],
                    "actor_process_command_line": ["C:\\Users\\administrator.ENV4\\Downloads\\8866115678\\example.exe"],
                    "actor_process_image_md5": ["1392aef7cd09a1b87ef651a0bf1c011"],
                    "actor_process_image_name": ["example.exe"],
                    "actor_process_image_path": ["C:\\Users\\administrator.ENV4\\Downloads\\8866115678\\example.exe"],
                    "actor_process_image_sha256": ["7734984082dfe13fas24264ad1c2cdc79180db273fa196bd3d2e48915d9d1e4b"],
                    "actor_process_instance_id": ["AdkwzkxP2AYAAB/YAAAAAA=="],
                    "actor_process_os_pid": [8152],
                    "actor_process_signature_status": ["SIGNATURE_UNAVAILABLE"],
                    "agent_data_collection_status": False,
                    "agent_device_domain": "env4.local",
                    "agent_file_path": ["C:\\\\Windows\\\\system32\\\\dnsapi.dll"],
                    "agent_fqdn": "DC1ENV4APC01.env4.local",
                    "agent_hostname": "DC1ENV4APC01",
                    "agent_id": "ac848acbd7504115b6624c9b1d755000",
                    "agent_install_type": "STANDARD",
                    "agent_ip_addresses": ["172.16.4.122"],
                    "agent_os_sub_type": "10.0.19044",
                    "agent_os_type": "AGENT_OS_WINDOWS",
                    "agent_version": "7.9.0.20664",
                    "agentversion": ["7.9.0.20664"],
                    ...
                    "attempt_counter": 0,
                    "case_id": 74,
                    "causality_actor_process_signature_status": ["SIGNATURE_UNAVAILABLE"],
                    "closeReason": "",
                    ...
                    "droppedCount": 0,
                    "dst_agent_os_type": ["NO_HOST"],
                    "dueDate": "0001-01-01T00:00:00Z",
                    "event_timestamp": [1674659141991],
                    "event_type": [1],
                    "events": [],
                    "external_id": "e08916bd582b401d862ddb2dcb704def",
                    "family_tags": ["DS:PANW/XDR Agent"],
                    "feedBased": False,
                    "feedbased": False,
                    "filenames": "dnsapi.dll",
                    "filepaths": ["C:\\\\Windows\\\\system32\\\\dnsapi.dll"],
                    "followup": False,
            ...
            },
            {
                "alert_fields": {
                    ...
                    "activated": "0001-01-01T00:00:00Z",
                    "actor_effective_username": ["env4.local\\Administrator"],
                    "actor_process_command_line": ['"C:\\Users\\administrator.ENV4\\Downloads\\8872230438\\wanmgr.exe" '],
                    "actor_process_image_md5": ["7265719c94c5ffbcdbb5c23428d8ca68"],
                    "actor_process_image_name": ["wanmgr.exe"],
                    "actor_process_image_path": ["C:\\Users\\administrator.ENV4\\Downloads\\8872230438\\wanmgr.exe"],
                    "actor_process_image_sha256": ["000001e7a228b2a7abdf7f7e3313324332b725e86907dde32176bddbbbb27"],
                    "actor_process_instance_id": ["Adkwy9zWJhIAAA1sAAAAAA=="],
                    "actor_process_os_pid": [3436],
                    "actor_process_signature_status": ["SIGNATURE_UNAVAILABLE"],
                    "agent_data_collection_status": False,
                    "agent_device_domain": "env4.local",
                    "agent_fqdn": "DC1ENV4APC01.env4.local",
                    ...
                    "matching_status": "UNMATCHABLE",
                    "module_id": ["WildFire"],
                    "module_name": ["COMPONENT_WILDFIRE"],
                    "notifyTime": "0001-01-01T00:00:00Z",
                    "occurred": "0001-01-01T00:00:00Z",
                    "openDuration": 0,
                    "original_severity": "SEV_030_MEDIUM",
            ...
            },
            {
                "alert_fields": {
                    ...
                    "actor_process_image_md5": ["e9aaa45159dacbc598aadfb6311eae54"],
                    "actor_process_image_name": ["000001e7a228b2a7abdf7f7e40313324332b725e86907dde32176bccbbbb27.exe"],
                    "actor_process_image_path": [
                        "C:\\Users\\administrator.ENV4\\Downloads\\8872362056\\"
                        "000001e7a228b2a7abdf7f7e40313324332b725e86907dde32176bccbbbb27.exe"
                    ],
                    "actor_process_image_sha256": ["000001e7a228b2a7abdf7f7e40313324332b725e86907dde32176bccbbbb27"],
                    "actor_process_instance_id": ["AdkwxLhiKM4AABJsAAAAAA=="],
                    "actor_process_os_pid": [4716],
                    "actor_process_signature_status": ["SIGNATURE_UNAVAILABLE"],
                    "agent_data_collection_status": False,
                    "agent_device_domain": "env4.local",
                    "agent_fqdn": "DC1ENV4APC01.env4.local",
            ...
            },
            {
                "alert_fields": {
                    ...
                    "actor_process_image_path": ["C:\\Users\\administrator.ENV4\\Downloads\\8872230438\\wanmgr.exe"],
                    "actor_process_image_sha256": ["000001e7a228b2a7abdf7f7e3313324332b725e86907dde32176bddbbbb27"],
                    "actor_process_instance_id": ["AdkwsQxs4pMAAB9YAAAAAA=="],
                    "actor_process_os_pid": [8024],
                    "actor_process_signature_status": ["SIGNATURE_UNAVAILABLE"],
                    "agent_data_collection_status": False,
                    "agent_device_domain": "env4.local",
                    "agent_fqdn": "DC1ENV4APC01.env4.local",
    ...
    try:
        if command == "test-module":
            ...
            next_run, incidents = fetch_incidents(
                ...
                first_fetch_time,
                integration_instance,
                demisto.getLastRun().get("next_run"),
                max_fetch,
                statuses,
                starred,
