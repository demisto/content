import pytest
from ManageEnginePAM360 import (
    Client,
    pam360_create_account,
    pam360_create_resource,
    pam360_fetch_account_details,
    pam360_fetch_password,
    pam360_fetch_resource_account_id,
    pam360_list_accounts,
    pam360_list_resources,
    pam360_update_account,
    pam360_update_account_password,
    pam360_update_resource,
)
...
FETCH_PASSWORD_ARGS = {"resource_id": "1", "account_id": "1"}
...
CREATE_ACCOUNT_ARGS = {"resource_id": "1", "account_name": "admin", "password": "t8BRq)<6h9g1"}

UPDATE_RESOURCE_ARGS = {"resource_id": "1", "resource_name": "SOUTH-FIN-WINSERQA-09", "resource_url": "https://pam360:8282"}
...
FETCH_ACCOUNT_DETAILS_ARGS = {"resource_id": "1", "account_id": "1"}

LIST_ALL_ACCOUNTS_ARGS = {"resource_id": "1"}
...
FETCH_RESOURCE_ACCOUNT_ID_ARGS = {"resource_name": "SOUTH-FIN-WINSERQA-09", "account_name": "administrator"}
...
def test_manageengine_pam360_commands(command, args, http_response, context, mocker):
    ...
    """
    client = Client(
        server_url="https://pam30:8282", app_token="B698EF92-B151-4E5C-969D-CA7B50DF4E9D", verify_certificate=False, proxy=False
    )
