...
def main() -> None:
    ...
    try:
        ...
        if command == 'test-module':
            ...
            return_results(generic_ansible('vmware', 'vmware_category', args, int_params, host_type))
            ...
            return_results(generic_ansible('vmware', 'vmware_cfg_backup', args, int_params, host_type))
        elif command == 'vmware-cluster':
            return_results(generic_ansible('vmware', 'vmware_cluster', args, int_params, host_type))
        elif command == 'vmware-cluster-drs':
            return_results(generic_ansible('vmware', 'vmware_cluster_drs', args, int_params, host_type))
        elif command == 'vmware-cluster-ha':
            return_results(generic_ansible('vmware', 'vmware_cluster_ha', args, int_params, host_type))
        elif command == 'vmware-cluster-info':
            return_results(generic_ansible('vmware', 'vmware_cluster_info', args, int_params, host_type))
        elif command == 'vmware-cluster-vsan':
            return_results(generic_ansible('vmware', 'vmware_cluster_vsan', args, int_params, host_type))
            ...
            return_results(generic_ansible('vmware', 'vmware_datacenter', args, int_params, host_type))
            ...
            return_results(generic_ansible('vmware', 'vmware_dns_config', args, int_params, host_type))
        elif command == 'vmware-drs-group':
            return_results(generic_ansible('vmware', 'vmware_drs_group', args, int_params, host_type))
            ...
            return_results(generic_ansible('vmware', 'vmware_drs_rule_info', args, int_params, host_type))
        elif command == 'vmware-dvs-host':
            return_results(generic_ansible('vmware', 'vmware_dvs_host', args, int_params, host_type))
            ...
            return_results(generic_ansible('vmware', 'vmware_dvswitch', args, int_params, host_type))
            ...
            return_results(generic_ansible('vmware', 'vmware_evc_mode', args, int_params, host_type))
        elif command == 'vmware-folder-info':
            return_results(generic_ansible('vmware', 'vmware_folder_info', args, int_params, host_type))
        elif command == 'vmware-guest':
            return_results(generic_ansible('vmware', 'vmware_guest', args, int_params, host_type))
            ...
            return_results(generic_ansible('vmware', 'vmware_guest_disk', args, int_params, host_type))
            ...
            return_results(generic_ansible('vmware', 'vmware_guest_find', args, int_params, host_type))
        elif command == 'vmware-guest-info':
            return_results(generic_ansible('vmware', 'vmware_guest_info', args, int_params, host_type))
        elif command == 'vmware-guest-move':
            return_results(generic_ansible('vmware', 'vmware_guest_move', args, int_params, host_type))
            ...
            return_results(generic_ansible('vmware', 'vmware_guest_video', args, int_params, host_type))
        elif command == 'vmware-guest-vnc':
            return_results(generic_ansible('vmware', 'vmware_guest_vnc', args, int_params, host_type))
        elif command == 'vmware-host':
            return_results(generic_ansible('vmware', 'vmware_host', args, int_params, host_type))
            ...
            return_results(generic_ansible('vmware', 'vmware_host_facts', args, int_params, host_type))
            ...
            return_results(generic_ansible('vmware', 'vmware_host_ipv6', args, int_params, host_type))
            ...
            return_results(generic_ansible('vmware', 'vmware_host_ntp', args, int_params, host_type))
            ...
            return_results(generic_ansible('vmware', 'vmware_host_scanhba', args, int_params, host_type))
            ...
            return_results(generic_ansible('vmware', 'vmware_host_snmp', args, int_params, host_type))
            ...
            return_results(generic_ansible('vmware', 'vmware_migrate_vmk', args, int_params, host_type))
            ...
            return_results(generic_ansible('vmware', 'vmware_portgroup', args, int_params, host_type))
            ...
            return_results(generic_ansible('vmware', 'vmware_tag', args, int_params, host_type))
        elif command == 'vmware-tag-info':
            return_results(generic_ansible('vmware', 'vmware_tag_info', args, int_params, host_type))
        elif command == 'vmware-tag-manager':
            return_results(generic_ansible('vmware', 'vmware_tag_manager', args, int_params, host_type))
            ...
            return_results(generic_ansible('vmware', 'vmware_vm_info', args, int_params, host_type))
        elif command == 'vmware-vm-shell':
            return_results(generic_ansible('vmware', 'vmware_vm_shell', args, int_params, host_type))
            ...
            return_results(generic_ansible('vmware', 'vmware_vmkernel', args, int_params, host_type))
            ...
            return_results(generic_ansible('vmware', 'vmware_vmotion', args, int_params, host_type))
        elif command == 'vmware-vsan-cluster':
            return_results(generic_ansible('vmware', 'vmware_vsan_cluster', args, int_params, host_type))
            ...
            return_results(generic_ansible('vmware', 'vmware_vswitch', args, int_params, host_type))
        elif command == 'vmware-vswitch-info':
            return_results(generic_ansible('vmware', 'vmware_vswitch_info', args, int_params, host_type))
        elif command == 'vmware-vsphere-file':
            return_results(generic_ansible('vmware', 'vsphere_file', args, int_params, host_type))
        elif command == 'vmware-vcenter-extension':
            return_results(generic_ansible('vmware', 'vcenter_extension', args, int_params, host_type))
            ...
            return_results(generic_ansible('vmware', 'vcenter_folder', args, int_params, host_type))
        elif command == 'vmware-vcenter-license':
            return_results(generic_ansible('vmware', 'vcenter_license', args, int_params, host_type))
