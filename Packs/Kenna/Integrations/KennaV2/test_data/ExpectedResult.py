    ...
    "Kenna.Vulnerabilities(val.ID === obj.ID)": [
        {
            ...
            "ScannerVulnerabilities": [
                {"ExternalID": "Kenna", "Open": True, "Port": None},
                {"ExternalID": "Kenna", "Open": True, "Port": None},
            ],
            "Severity": 1,
            "Status": "open",
...
GET_CONNECTORS_EXPECTED = {
    "Kenna.ConnectorsList(val.ID === obj.ID)": [
        {"Host": None, "ID": 152075, "Name": "Nessus XML", "Running": True},
        {"Host": None, "ID": 152076, "Name": "Generic", "Running": True},
        {"Host": None, "ID": 152077, "Name": "Checkmarx XML", "Running": True},
        {"Host": "ven01347.service-now.com:443", "ID": 152078, "Name": "ServiceNow", "Running": True},
    ]
}
SEARCH_FIXES_EXPECTED = {
    "Kenna.Fixes(val.ID === obj.ID)": [
        {
            "Assets": [{"DisplayLocator": "Kenna", "ID": 2, "Locator": "Kenna", "PrimaryLocator": "Kenna"}],
            "Category": None,
            "CveID": ["Kenna"],
            "ID": 2,
            "LastUpdatedAt": "Kenna",
...
GET_ASSETS_VULNERABILITIES_EXPECTED = {
    "Kenna.VulnerabilitiesOfAsset(val.ID === obj.ID)": [
        {"AssetID": 4, "CveID": "Kenna", "ID": 4, "Patch": True, "Status": "open", "TopPriority": True, "Score": 4}
    ]
}

GET_CONNECTOR_RUNS_EXPECTED = {
    "Kenna.ConnectorRunsList(val.ID === obj.ID)": [
        {
            "ID": 1462281,
