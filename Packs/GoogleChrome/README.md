...
This pack provides various browser events monitoring and managment such as user logins, passwords usages and websites access.

 
## Use Cases

1. Use Case: Password Management and Security
Prevent from users to use their passwords on dengerous/ unauthorized websites.
Preventing password reuse protect the organization from compromised accounts.

2. Use case: Websites Access Managment and File Downloading
Monitor and block accesses to malicious/ suspicious websites and control of harmful/ unwanted files donwloading.

3. Use Case: Browser Extensions Managment
Extensions managment allows IT administrators to test and evaluate extenstion for the organization,  allow/ block certain extentions and force installed extensions. 
...
#### Notes
- To configure Google Workspace you must have user with the corresponding persmissions.
- To configure emails data ingestions you must set up compliance email account as mentioned in the above link.
