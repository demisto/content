...
@pytest.mark.parametrize(
    ...
    [({"version": "6.10"}, "/settings/audits"), ({"version": "8.1"}, "/public_api/v1/audits/management_logs")],
)
def test_forward_audit_logs_to_splunk_main_flow(mocker, xsoar_version, expected_uri):
    ...
    execute_command_mocker = mocker.patch.object(demisto, "executeCommand", side_effect=execute_command_side_effect)
