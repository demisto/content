...
| --- | --- | --- | --- |
| AWSIndicatorTagName | Use this input to define which tag to apply to AWS indicators. An example tag can be whitelist\_review. If no tags are specified in the input, the tag whitelist\_review will be used.  |  | Optional |
...
## Playbook Image
---
![Playbook Image](../../doc_files/TIM_-_Process_AWS_indicators.png/n)