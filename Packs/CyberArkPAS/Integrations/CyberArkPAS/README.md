...
| safe_url_id                  | The URL encoded name of the safe to add a member to.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Required |
...
| safe_url_id                  | The URL encoded name of the safe to which the safe member belongs.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | Required |
...
| **Argument Name** | **Description**                                                        | **Required** |
|-------------------|------------------------------------------------------------------------| --- |
| safe_url_id       | The URL encoded name of the safe to delete a member from.              | Required |
