...
3. Click **Add instance** to create and configure a new integration instance.
    ...
    | Additional findings context outputs | Choose additional context data you wish to retrieve from the API. Be aware that requesting extensive context data may impact your server's performance. | False |
    ...
    | Severity Filter | This parameter allows you to filter findings based on their severity level. For example, a level such as "High" is acceptable. | False |
    | Impact Filter | This parameter allows you to filter findings based on their impact level. For example, a level such as "High" is acceptable. | False |
...
```json
{
    "DataBee": {
        "Device": {
            ...
            "Owner": {
                ...
                "backtrace": {
                    "email_addr": {
                        ...
                        "source": "user_inventory.time=2024-06-06 17:11:41.830"
                    },
                    "name": {
                        "feed": "sap",
                        "provider": "sap_successfactors",
                ...
                "domain": "hr.rodriguezrodriguezandhoffman.com",
                "email_addr": "stephen253@hr.rodriguezrodriguezandhoffman.com",
                "employee_uid": "62626",
                ...
                "location": {
                    ...
                    "country": "us",
                    "desc": "City :Sterling,Latitude :39.00622,Longitude:-77.4286",
                    "is_on_premises": true,
                    "isp": "comcast cable",
                    "postal_code": "12390",
                    "provider": "Bing maps",
                ...
                "manager": {
                    ...
                    "backtrace": {
                        "email_addr": {
                            ...
                            "source": "user_inventory.time=2024-06-07 04:13:04.961"
                        },
                        "name": {
                            "feed": "microsoft",
                            "provider": "microsoft_graph_api",
                    ...
                    "domain": "it.rodriguezrodriguezandhoffman.com",
                    "email_addr": "tracy548@it.rodriguezrodriguezandhoffman.com",
                    "employee_uid": "82891",
                    ...
                    "location": {
                        ...
                        "country": "us",
                        "desc": "City :Kendall,Latitude :25.67927,Longitude:-80.31727",
                        "is_on_premises": true,
                        "isp": "AT&T",
                        "postal_code": "72203",
                        "provider": "others",
            ...
            "hostname": "lt-25.hr.rodriguezrodriguezandhoffman.com",
...
>|---|---|---|---|---|---|---|---|---|---|
>| 143795e5-741a-4914-b29c-186a060d430f | Browser | GDFE654-FAKE | fd00::d5:1dcc | skin | follow | especially | lt-25.hr.rodriguezrodriguezandhoffman.com | 2024-06-09T14:39:18.801072 | 2024-06-11T19:08:41.429310 |
...
```json
{
    "DataBee": {
        "Finding": {
            ...
            "Device": {
                "hostname": "lt-58.e-markets.rodriguezrodriguezandhoffman.com",
                "ip": "10.29.64.203",
            ...
            "User": {
                ...
                "backtrace": {
                    "email_addr": {
                        "feed": "ping",
                        "provider": "ping_one",
                        "source": "user_inventory.time=2024-06-07 11:47:57.905"
                    },
                    "name": {
                        "feed": "ping",
                        "provider": "ping_one",
                ...
                "domain": "engineering.rodriguezrodriguezandhoffman.com",
                "email_addr": "kathleen302@engineering.rodriguezrodriguezandhoffman.com",
                "email_addresses": [],
                "employee_uid": "54873",
                "end_time": null,
                ...
                "ldap_person": {
                    ...
                    "location": {
                        ...
                        "country": "us",
                        "desc": "City :Far Rockaway,Latitude :40.60538,Longitude:-73.75513",
                        "is_on_premises": true,
                        "isp": "comcast cable",
                        "postal_code": "91823",
                        "provider": "Bing maps",
                    ...
                    "manager": {
                        ...
                        "backtrace": {
                            "email_addr": {
                                "feed": "ping",
                                "provider": "ping_one",
                                "source": "user_inventory.time=2024-06-06 22:23:01.919"
                            },
                            "name": {
                                "feed": "ping",
                                "provider": "ping_one",
                        ...
                        "domain": "finance.rodriguezrodriguezandhoffman.com",
                        "email_addr": "mr.728@finance.rodriguezrodriguezandhoffman.com",
                        "employee_uid": "99342",
                        ...
                        "location": {
                            ...
                            "country": "us",
                            "desc": "City :Brenham,Latitude :30.16688,Longitude:-96.39774",
                            "is_on_premises": true,
                            "isp": "comcast cable",
                            "postal_code": "20248",
...
#### Command example
```!endpoint ip=10.7.121.160```
#### Context Example
```json
{
    "Endpoint": {
        "Hostname": "desktop-20.security.rodriguezrodriguezandhoffman.com",
        "ID": "ed3437c2-a938-419e-95ea-15c04e8bdb98",
        "IPAddress": "10.7.121.160",
...
>|---|---|---|---|---|---|---|
>| desktop-20.security.rodriguezrodriguezandhoffman.com | ed3437c2-a938-419e-95ea-15c04e8bdb98 | 10.7.121.160 | aa-fa-fd-37-0a-de | Linux | 1.4 | DataBee |
