...
class Client:
    ...
    def reg_auth(self, identitytoken, registry_username, registry_password, registry_serveraddress):
        ...
        if identitytoken:
            ...
            json_string = json.dumps(
                {"username": registry_username, "password": registry_password, "serveraddress": registry_serveraddress}
            )
            self._headers["X-Registry-Auth"] = urlsafe_b64encode(json_string.encode("utf-8"))
    ...
    def config_create_request(self, configspec_name, configspec_labels, configspec_data, configspec_templating):
        data = assign_params(
            Name=configspec_name, Labels=configspec_labels, Data=configspec_data, Templating=configspec_templating
        )
    ...
    def container_create_request(
        ...
        data = assign_params(
            Hostname=containerconfig_hostname,
            Domainname=containerconfig_domainname,
            User=containerconfig_user,
            AttachStdin=containerconfig_attachstdin,
            AttachStdout=containerconfig_attachstdout,
            AttachStderr=containerconfig_attachstderr,
            ExposedPorts=containerconfig_exposedports,
            Tty=containerconfig_tty,
            OpenStdin=containerconfig_openstdin,
            StdinOnce=containerconfig_stdinonce,
            Env=containerconfig_env,
            Cmd=containerconfig_cmd,
            Healthcheck=containerconfig_healthcheck,
            ArgsEscaped=containerconfig_argsescaped,
            Image=containerconfig_image,
            Volumes=containerconfig_volumes,
            ...
            MacAddress=containerconfig_macaddress,
            OnBuild=containerconfig_onbuild,
            Labels=containerconfig_labels,
            StopSignal=containerconfig_stopsignal,
            StopTimeout=containerconfig_stoptimeout,
            Shell=containerconfig_shell,
            Binds=hostconfig_binds,
            ContainerIDFile=hostconfig_containeridfile,
            LogConfig=hostconfig_logconfig,
            NetworkMode=hostconfig_networkmode,
            PortBindings=hostconfig_portbindings,
            RestartPolicy=hostconfig_restartpolicy,
            AutoRemove=hostconfig_autoremove,
            VolumeDriver=hostconfig_volumedriver,
            VolumesFrom=hostconfig_volumesfrom,
            Mounts=hostconfig_mounts,
            CapAdd=hostconfig_capadd,
            CapDrop=hostconfig_capdrop,
            CgroupnsMode=hostconfig_cgroupnsmode,
            Dns=hostconfig_dns,
            DnsOptions=hostconfig_dnsoptions,
            DnsSearch=hostconfig_dnssearch,
            ExtraHosts=hostconfig_extrahosts,
            GroupAdd=hostconfig_groupadd,
            IpcMode=hostconfig_ipcmode,
            Cgroup=hostconfig_cgroup,
            Links=hostconfig_links,
            OomScoreAdj=hostconfig_oomscoreadj,
            PidMode=hostconfig_pidmode,
            Privileged=hostconfig_privileged,
            PublishAllPorts=hostconfig_publishallports,
            ReadonlyRootfs=hostconfig_readonlyrootfs,
            SecurityOpt=hostconfig_securityopt,
            StorageOpt=hostconfig_storageopt,
            Tmpfs=hostconfig_tmpfs,
            UTSMode=hostconfig_utsmode,
            UsernsMode=hostconfig_usernsmode,
            ShmSize=hostconfig_shmsize,
            Sysctls=hostconfig_sysctls,
            Runtime=hostconfig_runtime,
            ConsoleSize=hostconfig_consolesize,
            Isolation=hostconfig_isolation,
            MaskedPaths=hostconfig_maskedpaths,
    ...
    def container_exec_request(
        self,
        execconfig_attachstdin,
        execconfig_attachstdout,
        execconfig_attachstderr,
        execconfig_detachkeys,
        execconfig_tty,
        execconfig_env,
        execconfig_cmd,
        execconfig_privileged,
        execconfig_user,
        execconfig_workingdir,
        id_,
    ):
        data = assign_params(
            AttachStdin=execconfig_attachstdin,
            AttachStdout=execconfig_attachstdout,
            AttachStderr=execconfig_attachstderr,
            detach_keys=execconfig_detachkeys,
            Tty=execconfig_tty,
            Env=execconfig_env,
            Cmd=execconfig_cmd,
            Privileged=execconfig_privileged,
            User=execconfig_user,
    ...
    def container_logs_request(self, id_, follow, stdout, stderr, since, until, timestamps, tail):
        params = assign_params(
            follow=follow, stdout=stdout, stderr=stderr, since=since, until=until, timestamps=timestamps, tail=tail
        )
    ...
    def container_update_request(
        self,
        id_,
        resources_cpushares,
        resources_memory,
        resources_cgroupparent,
        ...
        data = assign_params(
            CpuShares=resources_cpushares,
            Memory=resources_memory,
            CgroupParent=resources_cgroupparent,
            BlkioWeight=resources_blkioweight,
            ...
            CpuPeriod=resources_cpuperiod,
            CpuQuota=resources_cpuquota,
            CpuRealtimePeriod=resources_cpurealtimeperiod,
            CpuRealtimeRuntime=resources_cpurealtimeruntime,
            CpusetCpus=resources_cpusetcpus,
            CpusetMems=resources_cpusetmems,
            ...
            NanoCPUs=resources_nanocpus,
            OomKillDisable=resources_oomkilldisable,
            Init=resources_init,
            PidsLimit=resources_pidslimit,
            Ulimits=resources_ulimits,
            CpuCount=resources_cpucount,
            CpuPercent=resources_cpupercent,
            IOMaximumIOps=resources_iomaximumiops,
    ...
    def image_commit_request(
        ...
        params = assign_params(
            container=container, repo=repo, tag=tag, comment=comment, author=author, pause=pause, changes=changes
        )
        data = assign_params(
            Hostname=containerconfig_hostname,
            Domainname=containerconfig_domainname,
    ...
    def image_create_request(self, from_image, from_src, repo, tag, message, platform):
        params = assign_params(fromImage=from_image, fromSrc=from_src, repo=repo, tag=tag, message=message, platform=platform)
    ...
    def network_create_request(
        self,
        networkconfig_name,
        networkconfig_checkduplicate,
        networkconfig_driver,
        networkconfig_internal,
        networkconfig_attachable,
        networkconfig_ingress,
        networkconfig_ipam,
        networkconfig_enableipv6,
        networkconfig_options,
        networkconfig_labels,
    ):
        data = assign_params(
            Name=networkconfig_name,
            CheckDuplicate=networkconfig_checkduplicate,
            Driver=networkconfig_driver,
            Internal=networkconfig_internal,
            Attachable=networkconfig_attachable,
            Ingress=networkconfig_ingress,
            IPAM=networkconfig_ipam,
            EnableIPv6=networkconfig_enableipv6,
            Options=networkconfig_options,
            Labels=networkconfig_labels,
        )
    ...
    def secret_create_request(
        self, secretspec_name, secretspec_labels, secretspec_data, secretspec_driver, secretspec_templating
    ):
        data = assign_params(
            Name=secretspec_name,
            Labels=secretspec_labels,
            Data=secretspec_data,
            Driver=secretspec_driver,
            Templating=secretspec_templating,
        )
    ...
    def secret_update_request(
        self, id_, secretspec_name, secretspec_labels, secretspec_data, secretspec_driver, secretspec_templating, version
    ):
        params = assign_params(version=version)
        data = assign_params(
            Name=secretspec_name,
    ...
    def service_create_request(
        ...
        data = assign_params(
            Name=servicespec_name,
            Labels=servicespec_labels,
            TaskTemplate=servicespec_tasktemplate,
            Mode=servicespec_mode,
            UpdateConfig=servicespec_updateconfig,
            RollbackConfig=servicespec_rollbackconfig,
            Networks=servicespec_networks,
    ...
    def service_logs_request(self, id_, details, follow, stdout, stderr, since, timestamps, tail):
        params = assign_params(
            details=details, follow=follow, stdout=stdout, stderr=stderr, since=since, timestamps=timestamps, tail=tail
        )
    ...
    def swarm_init_request(
        self, listenaddr, advertiseaddr, datapathaddr, datapathport, defaultaddrpool, forcenewcluster, subnetsize, spec
    ):
        data = assign_params(
    ...
    def swarm_join_request(self, listenaddr, advertiseaddr, datapathaddr, remoteaddrs, jointoken):
        data = assign_params(
            ListenAddr=listenaddr,
            AdvertiseAddr=advertiseaddr,
            DataPathAddr=datapathaddr,
    ...
    def system_auth_request(self, authconfig_username, authconfig_password, authconfig_email, authconfig_serveraddress):
        data = assign_params(
            username=authconfig_username,
            password=authconfig_password,
            email=authconfig_email,
    ...
    def volume_create_request(self, volumeconfig_name, volumeconfig_driver, volumeconfig_driveropts, volumeconfig_labels):
        data = assign_params(
            Name=volumeconfig_name, Driver=volumeconfig_driver, DriverOpts=volumeconfig_driveropts, Labels=volumeconfig_labels
        )
...
def build_prune_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="Docker.BuildPruneResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def config_create_command(client, args):
    ...
    command_results = CommandResults(outputs_prefix="Docker", outputs_key_field="", outputs=response, raw_response=response)
...
def config_inspect_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="Docker.Config", outputs_key_field="", outputs=response, raw_response=response
    )
...
def container_changes_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="Docker.ContainerChangeResponseItem", outputs_key_field="", outputs=response, raw_response=response
    )
...
def container_create_command(client, args):
    ...
    containerconfig_healthcheck = assign_params(
        Test=containerconfig_healthcheck_test,
    ...
    hostconfig_restartpolicy = assign_params(
        Name=hostconfig_restartpolicy_name, MaximumRetryCount=hostconfig_restartpolicy_maximumretrycount
    )
...
def container_delete_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="Docker.ContainerDelete", outputs_key_field="", outputs=response, raw_response=response
    )
...
def container_exec_command(client, args):
    ...
    response = client.container_exec_request(
        execconfig_attachstdin,
        execconfig_attachstdout,
        execconfig_attachstderr,
        execconfig_detachkeys,
...
def container_inspect_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="Docker.ContainerInspectResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def container_list_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="Docker.ContainerSummary", outputs_key_field="", outputs=response, raw_response=response
    )
...
def container_prune_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="Docker.ContainerPruneResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def container_top_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="Docker.ContainerTopResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def container_update_command(client, args):
    ...
    response = client.container_update_request(
        id_,
        resources_cpushares,
        resources_memory,
        resources_cgroupparent,
    ...
    command_results = CommandResults(
        outputs_prefix="Docker.ContainerUpdateResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def container_wait_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="Docker.ContainerWaitResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def distribution_inspect_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="Docker.DistributionInspectResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def exec_inspect_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="Docker.ExecInspectResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def get_plugin_privileges_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="Docker.PluginPrivilegeItem", outputs_key_field="", outputs=response, raw_response=response
    )
...
def image_build_command(client, args):
    ...
    response = client.image_build_request(
        input_stream,
        dockerfile,
        t,
        extrahosts,
...
def image_commit_command(client, args):
    ...
    response = client.image_commit_request(
        containerconfig_hostname,
        containerconfig_domainname,
        containerconfig_user,
        containerconfig_attachstdin,
...
def image_create_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="Docker.ImageCreate", outputs_key_field="Status", outputs=response, raw_response=response
    )
...
def image_delete_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="Docker.ImageDeleteResponseItem", outputs_key_field="", outputs=response, raw_response=response
    )
...
def image_history_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="Docker.HistoryResponseItem", outputs_key_field="", outputs=response, raw_response=response
    )
...
def image_inspect_command(client, args):
    ...
    command_results = CommandResults(outputs_prefix="Docker.Image", outputs_key_field="", outputs=response, raw_response=response)
...
def image_list_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="Docker.ImageSummary", outputs_key_field="", outputs=response, raw_response=response
    )
...
def image_prune_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="Docker.ImagePruneResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def image_push_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="Docker.ImagePush", outputs_key_field="", outputs=response, raw_response=response
    )
...
def image_search_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="Docker.ImageSearchResponseItem", outputs_key_field="", outputs=response, raw_response=response
    )
...
def image_tag_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="Docker.ImageTag", outputs_key_field="", outputs=response, raw_response=response
    )
...
def network_connect_command(client, args):
    ...
    container_endpointconfig = assign_params(
        IPAMConfig=container_endpointconfig_ipamconfig,
...
def network_create_command(client, args):
    ...
    networkconfig_ipam = assign_params(
        Driver=networkconfig_ipam_driver, Config=networkconfig_ipam_config, Options=networkconfig_ipam_options
    )
    ...
    response = client.network_create_request(
        networkconfig_name,
        networkconfig_checkduplicate,
        networkconfig_driver,
        networkconfig_internal,
...
def network_inspect_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="Docker.Network", outputs_key_field="", outputs=response, raw_response=response
    )
...
def network_prune_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="Docker.NetworkPruneResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def node_inspect_command(client, args):
    ...
    command_results = CommandResults(outputs_prefix="Docker.Node", outputs_key_field="", outputs=response, raw_response=response)
...
def secret_create_command(client, args):
    ...
    response = client.secret_create_request(
        secretspec_name, secretspec_labels, secretspec_data, secretspec_driver, secretspec_templating
    )
    command_results = CommandResults(outputs_prefix="Docker", outputs_key_field="", outputs=response, raw_response=response)
...
def secret_inspect_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="Docker.Secret", outputs_key_field="", outputs=response, raw_response=response
    )
...
def secret_update_command(client, args):
    ...
    response = client.secret_update_request(
        id_, secretspec_name, secretspec_labels, secretspec_data, secretspec_driver, secretspec_templating, version
    )
    command_results = CommandResults(outputs_prefix="Docker", outputs_key_field="", outputs=response, raw_response=response)
...
def service_create_command(client, args):
    ...
    servicespec_tasktemplate = assign_params(
        PluginSpec=servicespec_tasktemplate_pluginspec,
    ...
    servicespec_mode = assign_params(
        Replicated=servicespec_mode_replicated,
        Global=servicespec_mode_global,
    ...
    servicespec_updateconfig = assign_params(
        Parallelism=servicespec_updateconfig_parallelism,
    ...
    servicespec_rollbackconfig = assign_params(
        Parallelism=servicespec_rollbackconfig_parallelism,
    ...
    response = client.service_create_request(
        servicespec_name,
        servicespec_labels,
        servicespec_tasktemplate,
        servicespec_mode,
...
def service_inspect_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="Docker.Service", outputs_key_field="", outputs=response, raw_response=response
    )
...
def service_update_command(client, args):
    ...
    response = client.service_update_request(
        id_,
        servicespec_name,
        servicespec_labels,
        servicespec_tasktemplate,
    ...
    command_results = CommandResults(
        outputs_prefix="Docker.ServiceUpdateResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def swarm_init_command(client, args):
    ...
    response = client.swarm_init_request(
        listenaddr, advertiseaddr, datapathaddr, datapathport, defaultaddrpool, forcenewcluster, subnetsize, spec
    )
    if type(response) is str:
        response = {"Node ID": response}
        command_results = CommandResults(
            outputs_prefix="Docker.Swarm.Token", outputs_key_field="", outputs=response, raw_response=response
        )
    else:
        command_results = CommandResults(
            outputs_prefix="Docker.Swarm.Token", outputs_key_field="", outputs=response, raw_response=response
...
def swarm_inspect_command(client, args):
    ...
    command_results = CommandResults(outputs_prefix="Docker.Swarm", outputs_key_field="", outputs=response, raw_response=response)
...
def swarm_join_command(client, args):
    ...
    response = client.swarm_join_request(listenaddr, advertiseaddr, datapathaddr, remoteaddrs, jointoken)
    command_results = CommandResults(outputs_prefix="Docker", outputs_key_field="", outputs=response, raw_response=response)
...
def swarm_leave_command(client, args):
    ...
    if type(response) is dict:
        ...
        response = {"message": "Swarm node left."}
        command_results = CommandResults(outputs_prefix="Docker", outputs_key_field="", outputs=response, raw_response=response)
...
def swarm_unlockkey_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="Docker.UnlockKeyResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def system_auth_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="Docker.SystemAuthResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def system_data_usage_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="Docker.SystemDataUsageResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def system_events_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="Docker.SystemEventsResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def system_info_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="Docker.SystemInfo", outputs_key_field="", outputs=response, raw_response=response
    )
...
def system_version_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="Docker.SystemVersion", outputs_key_field="", outputs=response, raw_response=response
    )
...
def task_inspect_command(client, args):
    ...
    command_results = CommandResults(outputs_prefix="Docker.Task", outputs_key_field="", outputs=response, raw_response=response)
...
def volume_inspect_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="Docker.Volume", outputs_key_field="", outputs=response, raw_response=response
    )
...
def volume_list_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="Docker.VolumeListResponse", outputs_key_field="", outputs=response, raw_response=response
    )
...
def volume_prune_command(client, args):
    ...
    command_results = CommandResults(
        outputs_prefix="Docker.VolumePruneResponse", outputs_key_field="", outputs=response, raw_response=response
    )
    ...
    try:
        ...
        if any([identitytoken, registry_username, registry_password, registry_serveraddress]):
            client.reg_auth(
                ...
                registry_serveraddress=registry_serveraddress,
            )
