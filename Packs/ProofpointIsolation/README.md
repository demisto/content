...
To enable the Proofpoint Isolation Event Collector, follow these steps:
...
4. Follow the instruction in the prompt window to configure the Proofpoint Isolation Event Collector.
