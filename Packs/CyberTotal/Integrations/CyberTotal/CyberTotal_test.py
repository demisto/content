...
def test_ip(requests_mock):
    ...
    requests_mock.get(f"http://test.com/_api/search/ip/basic/{ip_to_check}", json=mock_response)

    client = Client(base_url="http://test.com", verify=False, headers={"Authorization": "Token cybertotal_api_key"})
...
def test_url(requests_mock):
    ...
    mock_response = util_load_json("test_data/reputation.json")
    requests_mock.get(f"http://test.com/_api/search/url/basic?q={url_to_check}", json=mock_response)
...
def test_domain(requests_mock):
    ...
    mock_response = util_load_json("test_data/reputation.json")
    requests_mock.get(f"http://test.com/_api/search/domain/basic/{domain_to_check}", json=mock_response)
...
def test_file(requests_mock):
    ...
    mock_response = util_load_json("test_data/reputation.json")
    requests_mock.get(f"http://test.com/_api/search/hash/basic/{file_to_check}", json=mock_response)
...
def test_ip_whois(requests_mock):
    ...
    requests_mock.get(f"http://test.com/_api/search/ip/whois/{ip_to_check}", json=mock_response)
...
def test_url_whois(requests_mock):
    ...
    url_to_check = "http://abc.com"
    mock_response = util_load_json("test_data/whois.json")
    requests_mock.get(f"http://test.com/_api/search/url/whois?q={url_to_check}", json=mock_response)

    client = Client(base_url="http://test.com", verify=False, headers={"Authorization": "Token cybertotal_api_key"})

    args = {"url": url_to_check}
...
def test_domain_whois(requests_mock):
    ...
    domain_to_check = "abc.com"
    mock_response = util_load_json("test_data/whois.json")
    requests_mock.get(f"http://test.com/_api/search/domain/whois/{domain_to_check}", json=mock_response)
