...
# Cortex XSOAR-side List used to track what's currently believed to be in a given Netskope hash list
# between playbook runs.
#
# getList/setList/createList are real core Cortex XSOAR commands (confirmed via
