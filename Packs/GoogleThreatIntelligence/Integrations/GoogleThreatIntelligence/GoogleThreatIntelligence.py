...
def _get_domain_indicator(client, score_calculator: ScoreCalculator, domain: str, raw_response: dict):
    data = raw_response.get('data', {})
    attributes = data.get('attributes', {})
    last_analysis_stats = attributes.get('last_analysis_stats', {})
...
def _get_url_indicator(client, score_calculator: ScoreCalculator, url: str, raw_response: dict):
    data = raw_response.get('data', {})
    attributes = data.get('attributes', {})
    last_analysis_stats = attributes.get('last_analysis_stats', {})
    detection_engines = sum(last_analysis_stats.values())
...
def _get_ip_indicator(client, score_calculator: ScoreCalculator, ip: str, raw_response: dict):
    data = raw_response.get('data', {})
    attributes = data.get('attributes', {})
    last_analysis_stats = attributes.get('last_analysis_stats', {})
    detection_engines = sum(last_analysis_stats.values())
