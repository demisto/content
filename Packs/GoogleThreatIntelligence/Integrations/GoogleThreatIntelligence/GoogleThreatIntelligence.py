...
RELATIONSHIP_TO_INDICATOR_TYPE = {
    "malware_families": ThreatIntel.ObjectsNames.MALWARE,
    "campaigns": ThreatIntel.ObjectsNames.CAMPAIGN,
    "threat_actors": ThreatIntel.ObjectsNames.THREAT_ACTOR,
    "software_toolkits": ThreatIntel.ObjectsNames.TOOL,
}
...
RELATIONSHIP_TYPE = {
    ...
    "cve": {
        "malware_families": EntityRelationship.Relationships.ATTRIBUTED_TO,
        "campaigns": EntityRelationship.Relationships.TARGETED_BY,
        "software_toolkits": EntityRelationship.Relationships.PART_OF,
        "threat_actors": EntityRelationship.Relationships.EXPLOITS,
        "files": EntityRelationship.Relationships.CONTAINS
    }
...
class Client(BaseClient):
    ...
    def ip(self, ip: str, relationships: str = "") -> dict:
        ...
        """
        return self._http_request("GET", f"ip_addresses/{ip}?relationships={relationships}", ok_codes=(404, 429, 200))
    ...
    def file(self, file: str, relationships: str = "") -> dict:
        ...
        """
        return self._http_request("GET", f"files/{file}?relationships={relationships}", ok_codes=(404, 429, 200))
    ...
    def private_file(self, file: str) -> dict:
        ...
        """
        return self._http_request("GET", f"private/files/{file}", ok_codes=(404, 429, 200))
    ...
    def url(self, url: str, relationships: str = ""):
        ...
        return self._http_request(
            "GET", f"urls/{encode_url_to_base64(url)}?relationships={relationships}", ok_codes=(404, 429, 200)
        )
    ...
    def private_url(self, url: str):
        ...
        """
        return self._http_request("GET", f"private/urls/{encode_url_to_base64(url)}", ok_codes=(404, 429, 200))
    ...
    def cve(self, cve: str, relationships: str = "") -> dict:
        """
        See Also:
            https://gtidocs.virustotal.com/reference/get-vulnerability
        """
        return self._http_request("GET", f"collections/vulnerability--{cve}?relationships={relationships}", params={"relationship_attributes": "name,description,type"}, ok_codes=(404, 429, 200))
    ...
    def delete_comment(self, id_: str):
        ...
        """
        self._http_request("DELETE", f"comments/{id_}", resp_type="response")
    ...
    def get_ip_comments(self, ip: str, limit: int) -> dict:
        ...
        return self._http_request("GET", f"ip_addresses/{ip}/comments", params={"limit": limit})
    ...
    def get_url_comments(self, url: str, limit: int) -> dict:
        ...
        """
        return self._http_request("GET", f"urls/{encode_url_to_base64(url)}/comments", params={"limit": limit})
    ...
    def get_hash_comments(self, file_hash: str, limit: int) -> dict:
        ...
        """
        return self._http_request("GET", f"files/{file_hash}/comments", params={"limit": limit})
    ...
    def get_domain_comments(self, domain: str, limit: int) -> dict:
        ...
        """
        return self._http_request("GET", f"domains/{domain}/comments", params={"limit": limit})
    ...
    def get_comment_by_id(self, comment_id: str) -> dict:
        ...
        """
        return self._http_request("GET", f"comments/{comment_id}")
    ...
    def add_comment(self, suffix: str, comment: str) -> dict:
        ...
        Returns:
            json of response
        """
        return self._http_request("POST", suffix, json_data={"data": {"type": "comment", "attributes": {"text": comment}}})
    ...
    def file_rescan(self, file_hash: str) -> dict:
        ...
        """
        return self._http_request("POST", f"/files/{file_hash}/analyse")
    ...
    def get_upload_url(self) -> dict:
        ...
        """
        return self._http_request("GET", "files/upload_url")
    ...
    def get_private_upload_url(self) -> dict:
        ...
        """
        return self._http_request("GET", "private/files/upload_url")
    ...
    def url_scan(self, url: str) -> dict:
        ...
        """
        return self._http_request("POST", "urls", data={"url": url})
    ...
    def private_url_scan(self, url: str) -> dict:
        ...
        """
        return self._http_request("POST", "/private/urls", data={"url": url})
    ...
    def file_sandbox_report(self, file_hash: dict, limit: int) -> dict:
        ...
        """
        return self._http_request("GET", f"files/{file_hash}/behaviours", params={"limit": limit}, ok_codes=(404, 429, 200))
    ...
    def passive_dns_data(self, id: dict, limit: int) -> dict:
        ...
        """
        return self._http_request(
            "GET", f'{"ip_addresses" if id["type"] == "ip" else "domains"}/{id["value"]}/resolutions', params={"limit": limit}
        )
    ...
    def search(self, query: str, limit: int) -> dict:
        ...
        """
        return self._http_request("GET", "search", params={"query": query, "limit": limit})
    ...
    def get_analysis(self, analysis_id: str) -> dict:
        ...
        """
        return self._http_request("GET", f"/analyses/{analysis_id}")
    ...
    def get_private_analysis(self, analysis_id: str) -> dict:
        ...
        """
        return self._http_request("GET", f"private/analyses/{analysis_id}")
    ...
    def get_private_item_from_analysis(self, analysis_id: str) -> dict:
        ...
        """
        return self._http_request("GET", f"private/analyses/{analysis_id}/item")
...
class ScoreCalculator:
    ...
    def __init__(self, params: dict):
        ...
        self.trusted_vendors_threshold = arg_to_number_must_int(
            params["preferredVendorsThreshold"], arg_name="Preferred Vendor Threshold", required=True
        )
        self.file_threshold = {
            "malicious": arg_to_number_must_int(params["fileThreshold"], arg_name="File Malicious Threshold", required=True),
        ...
        self.ip_threshold = {
            "malicious": arg_to_number_must_int(params["ipThreshold"], arg_name="IP Malicious Threshold", required=True),
            "suspicious": arg_to_number_must_int(
        ...
        self.url_threshold = {
            "malicious": arg_to_number_must_int(params["urlThreshold"], arg_name="URL Malicious Threshold", required=True),
            "suspicious": arg_to_number_must_int(
        ...
        self.domain_threshold = {
            "malicious": arg_to_number_must_int(params["domainThreshold"], arg_name="Domain Malicious Threshold", required=True),
            "suspicious": arg_to_number_must_int(
        ...
        self.sigma_ids_threshold = arg_to_number_must_int(
            params["SigmaIDSThreshold"], arg_name="Sigma and Intrusion Detection Rules Threshold", required=True
        )
        self.domain_popularity_ranking = arg_to_number_must_int(
            params["domain_popularity_ranking"], arg_name="Domain Popularity Ranking Threshold", required=True
        )
    ...
    def is_good_by_popularity_ranks(self, popularity_ranks: dict) -> Optional[bool]:
        ...
        if popularity_ranks:
            ...
            self.logs.append(f"The average of the ranks is {average} and the threshold is {self.domain_popularity_ranking}")
    ...
    def is_suspicious_by_rules(self, file_response: dict) -> bool:
        ...
        if self.crowdsourced_yara_rules_enabled:
            ...
            if (total_yara_rules := len(data.get("crowdsourced_yara_results", []))) >= self.crowdsourced_yara_rules_threshold:
                self.logs.append(
            ...
            if sigma_rules := data.get("sigma_analysis_stats"):
                ...
                if (sigma_high + sigma_critical) >= self.sigma_ids_threshold:
                    self.logs.append(f"Found malicious, {sigma_high + sigma_critical} >= {self.sigma_ids_threshold}. ")
                    return True
                else:
            ...
            if crowdsourced_ids_stats := data.get("crowdsourced_ids_stats"):
                ...
                if (ids_high + ids_critical) >= self.sigma_ids_threshold:
                    self.logs.append(f"Found malicious, {(ids_high + ids_critical) >= self.sigma_ids_threshold}.")
                    return True
                else:
                    self.logs.append("Not found malicious by sigma.")
            else:
    ...
    def is_preferred_vendors_pass_malicious(self, analysis_results: dict) -> bool:
        ...
        preferred_vendor_scores = {vendor: recent[vendor] for vendor in self.trusted_vendors if vendor in recent}
        malicious_trusted_vendors = [item for item in preferred_vendor_scores.values() if item.get("category") == "malicious"]
    ...
    def file_score(self, given_hash: str, raw_response: dict) -> int:
        ...
        if score == Common.DBotScore.SUSPICIOUS and suspicious_by_rules:
            ...
            self.logs.append(f'Hash: "{given_hash}" was found suspicious by rules analysis.')
            return Common.DBotScore.SUSPICIOUS
        elif score == Common.DBotScore.SUSPICIOUS:
            self.logs.append(f'Hash: "{given_hash}" was found suspicious by passing the threshold analysis.')
            return Common.DBotScore.SUSPICIOUS
        elif self.is_suspicious_by_gti(attributes.get("gti_assessment", {})):
            self.logs.append(f'Hash: "{given_hash}" was found suspicious by gti assessment.')
            return Common.DBotScore.SUSPICIOUS
    ...
    for relationship_type, relationship_type_raw in relationships_response.items():
        ...
        if relationships_data:
            ...
            for relation in relationships_data:
                ...
                )) or RELATIONSHIP_TO_INDICATOR_TYPE.get(relationship_type, "").title()
                if entity_b and entity_b_type and name:
                    ...
                    if entity_b_type == ThreatIntel.ObjectsNames.THREAT_ACTOR:
                        entity_b = dict_safe_get(relation, ["attributes", "name"])
                    if entity_b_type == ThreatIntel.ObjectsNames.MALWARE:
                        entity_b = dict_safe_get(relation, ["attributes", "name"])
                    if entity_b_type == ThreatIntel.ObjectsNames.CAMPAIGN:
                        entity_b = dict_safe_get(relation, ["attributes", "name"])
                    if entity_b_type == ThreatIntel.ObjectsNames.TOOL:
                        entity_b = dict_safe_get(relation, ["attributes", "name"])
                    if description := dict_safe_get(relation, ["attributes", "description"], ""):
                        custom_fields["description"] = description
                    demisto.debug(
                        f"Creating relationship from {entity_a} ({entity_a_type}) to {entity_b} ({entity_b_type}) with name {name}"
                    )
...
def _get_error_result(client: Client, ioc_id: str, ioc_type: str, message: str) -> CommandResults:
    ...
    if dbot_type == "CVE":
        return CommandResults(readable_output=desc)
...
def build_quota_exceeded_cve_output(client: Client, cve: str) -> CommandResults:
    return build_quota_exceeded_output(client, cve, "cve")


def build_error_cve_output(client: Client, cve: str) -> CommandResults:
    return build_error_output(client, cve, "cve")


def build_unknown_cve_output(client: Client, cve: str) -> CommandResults:
    return build_unknown_output(client, cve, "cve")
...
def _get_url_indicator(client: Client, score_calculator: ScoreCalculator, url: str, raw_response: dict):
    ...
    return Common.URL(
        ...
        relationships=relationships_list,
        dbot_score=Common.DBotScore(
            url, DBotScoreType.URL, INTEGRATION_NAME, score=score, reliability=client.reliability, malicious_description=logs
        ),
    )
...
def _get_ip_indicator(client: Client, score_calculator: ScoreCalculator, ip: str, raw_response: dict):
    ...
    return Common.IP(
        ...
        relationships=relationships_list,
        dbot_score=Common.DBotScore(
            ip, DBotScoreType.IP, INTEGRATION_NAME, score=score, malicious_description=logs, reliability=client.reliability
        ),
    )
...
def _get_cvss_version(cvss_vector: str) -> float:
    """
    ...
    if not cvss_vector:
        return 0
    elif cvss_version_regex := re.match(r"CVSS:(?P<version>.+?)/", cvss_vector):
        return float(cvss_version_regex.group("version"))
    else:
        return 2.0


def _get_complete_cve_sources(sources: list[dict]) -> list[dict]:
    """Extracts the complete sources from the CVE sources list.
    This function filters the sources to include only those with title, source, and url".

    Args:
        sources: The list of sources from the CVE data.

    Returns:
        A list of dictionaries containing the complete sources.
    """
    complete_sources = []
    for source in sources:
        if all(source.get(key) for key in ("title", "name", "url")):
...
def _get_cve_indicator(client: Client, cve_id: str, raw_response: dict):
    """Builds a CVE indicator from the raw response.
    ...
    cpes = attributes.get("cpes", [])

    vulnerable_product = [Common.CPE(cpe.get("uri")) for cpe_entry in cpes for cpe in [cpe_entry.get(
        "start_cpe"), cpe_entry.get("end_cpe")] if cpe is not None and "uri" in cpe]

    publications = _get_complete_cve_sources(attributes.get("sources", []))

    cvss_data = attributes.get("cvss", {})
    # Defaults to CVSSv3 if available, otherwise uses CVSSv2
    cvss = cvss_data.get("cvssv3_x", {}) if cvss_data.get("cvssv3_x") else cvss_data.get("cvssv2_0", {})

    version_history = attributes.get("version_history", [])

    # CommonServerPython file or indicator grid field needs to be normalized to key 'note' or 'notes'
    # community_notes = [Common.CommunityNotes(note=note, timestamp=epoch_to_timestamp(entry.get("date", 0)))
    #                    for entry in version_history
    #                    for note in entry.get("version_notes")
    #                    ]

    return Common.CVE(
        id=cve_id,
        cvss=cvss.get("base_score"),
        published=epoch_to_timestamp(attributes.get("date_of_disclosure")),
        modified=epoch_to_timestamp(attributes.get("last_modification_date")),
        description=attributes.get("description"),
        relationships=relationships_list,
        cvss_version=_get_cvss_version(cvss.get("vector")),
        cvss_score=cvss.get("base_score"),
        cvss_vector=cvss.get("vector"),
        tags=attributes.get("tags"),
        publications=[Common.Publications(title=publication.get("title"), link=publication.get("url"), source=publication.get("name"))
                      for publication in publications],
        vulnerable_products=vulnerable_product
    )


def build_domain_output(
    client: Client, score_calculator: ScoreCalculator, domain: str, raw_response: dict, extended_data: bool
) -> CommandResults:
    data = raw_response.get("data", {})
    attributes = data.get("attributes", {})
...
def build_url_output(
    client: Client, score_calculator: ScoreCalculator, url: str, raw_response: dict, extended_data: bool
) -> CommandResults:
    data = raw_response.get("data", {})
    attributes = data.get("attributes", {})
...
def build_ip_output(
    client: Client, score_calculator: ScoreCalculator, ip: str, raw_response: dict, extended_data: bool
) -> CommandResults:
    data = raw_response.get("data", {})
    attributes = data.get("attributes", {})
...
def build_file_output(
    client: Client, score_calculator: ScoreCalculator, file_hash: str, raw_response: dict, extended_data: bool
) -> CommandResults:
    data = raw_response.get("data", {})
    attributes = data.get("attributes", {})
...
def build_cve_output(
    client: Client, cve: str, raw_response: dict
) -> CommandResults:
    data = raw_response.get("data", {})
    attributes = data.get("attributes", {})

    relationships_response = data.get("relationships", {})
    demisto.debug(f"Creating relationships for {cve}")
    relationships_list = create_relationships(
        entity_a=cve,
        entity_a_type=FeedIndicatorType.CVE,
        relationships_response=relationships_response,
    ...
    demisto.debug(f"Relationships for {cve} created successfully {relationships_list}")

    demisto.debug(f"Building CVE indicator for {cve}")
    cve_indicator = _get_cve_indicator(client, cve, raw_response)
    demisto.debug(f"CVE indicator for {cve} built successfully {cve_indicator}")

    return CommandResults(outputs_prefix=f"{INTEGRATION_ENTRY_CONTEXT}.CVE",
                          outputs_key_field="id",
                          indicator=cve_indicator,
                          readable_output=tableToMarkdown(
                              f"Results of CVE {cve}",
                              {
                                  **attributes,
                                  "creation_date": epoch_to_timestamp(attributes.get("creation_date")),
                                  "last_modified": epoch_to_timestamp(attributes.get("last_modification_date", 0)),
...
def raise_if_cve_not_valid(cve: str):
    """Raises an error if CVE is not valid

    Args:
        cve: CVE identifier

    Raises:
        ValueError: If CVE is not valid

    Examples:
        >>> raise_if_cve_not_valid('CVE-2023-1234')
        >>> raise_if_cve_not_valid('not a cve')
        Traceback (most recent call last):
         ...
        ValueError: CVE "not a cve" is not valid
    """
    if not re.match(r"^CVE-\d{4}-\d{4,}$", cve):
        raise ValueError(f'CVE "{cve}" is not valid')
...
def ip_command(
    client: Client, score_calculator: ScoreCalculator, args: dict, relationships: str, disable_private_ip_lookup: bool
) -> List[CommandResults]:
    """
...
def domain_command(client: Client, score_calculator: ScoreCalculator, args: dict, relationships: str) -> List[CommandResults]:
    ...
    for domain in domains:
        ...
        result = build_domain_output(
            client, score_calculator, domain, raw_response, argToBoolean(args.get("extended_data", False))
        )
...
def cve_command(client: Client, args: dict, relationships: str) -> CommandResults:
    """
    1 API Call
    """
    execution_metrics = ExecutionMetrics()
    results: List[CommandResults] = []
    cve_ids = argToList(args["cve"])

    for cve in cve_ids:
        raise_if_cve_not_valid(cve)
        try:
            demisto.debug(f"Processing CVE: {cve} using relationships: {relationships}")
            raw_response = client.cve(cve, relationships)
            if raw_response.get("error", {}).get("code") == "QuotaExceededError":
                execution_metrics.quota_error += 1
                demisto.debug(f"Quota exceeded for CVE: {cve}")
                results.append(build_quota_exceeded_cve_output(client, cve))
                continue
            if raw_response.get("error", {}).get("code") == "NotFoundError":
                demisto.debug(f"CVE not found: {cve}")
                results.append(build_unknown_cve_output(client, cve))
                continue
            execution_metrics.success += 1
            demisto.debug(f"Building CVE output for {cve}")
            results.append(build_cve_output(client, cve, raw_response))
        except Exception as exc:
            # If anything happens, just keep going
            demisto.debug(f'Could not process CVE: "{cve}"\n {exc!s}')
            execution_metrics.general_error += 1
            results.append(build_error_cve_output(client, cve))
            continue
    if execution_metrics.is_supported():
        _metric_results = execution_metrics.metrics
        metric_results = cast(CommandResults, _metric_results)
...
def file_rescan_command(client: Client, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            f'File "{file_hash}" resubmitted.', data, removeNull=True, headerTransform=underscoreToCamelCase
        ),
        outputs=context,
        raw_response=raw_response,
    )
...
def upload_file(client: Client, args: dict, private: bool = False) -> List[CommandResults]:
    ...
    for entry_id in entry_ids:
        try:
            ...
            demisto.debug(err)
            demisto.results({"Type": entryTypes["error"], "ContentsFormat": formats["text"], "Contents": err})
    return results


def file_scan_and_get_analysis(client: Client, score_calculator: ScoreCalculator, args: dict, file_relationships: str):
    ...
    if not args.get("id"):
        ...
        scheduled_command = ScheduledCommand(
            ...
            args={
                ...
                "file": outputs.get(f"{INTEGRATION_ENTRY_CONTEXT}.Submission(val.id && val.id === obj.id)", {}).get("SHA256"),
...
def url_scan_and_get_analysis(client: Client, score_calculator: ScoreCalculator, args: dict, url_relationships: str):
...
def get_upload_url(client: Client) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown("New upload url acquired!", {"Upload url": upload_url}),
        outputs=context,
        raw_response=raw_response,
    )
...
def scan_url(client: Client, args: dict, private: bool = False) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown("New url submission:", data, headers=headers), outputs=context, raw_response=raw_response
    )
...
def get_comments_command(client: Client, args: dict) -> CommandResults:
    ...
    added limit
    """
    limit = arg_to_number_must_int(args.get("limit"), arg_name="limit", required=True)
    ...
    data = raw_response.get("data", {})
    context = {"indicator": resource, "comments": data}
    comments = []
    for comment in data:
...
def file_sandbox_report_command(client: Client, args: dict) -> List[CommandResults]:
    ...
    results: List[CommandResults] = []
    file_hash = args["file"]
    limit = arg_to_number(args["limit"], "limit", required=True)
        ...
        results.append(
            CommandResults(
                ...
                readable_output=tableToMarkdown(
                    ...
                    [{"id": item["id"], **item["attributes"], "link": item["links"]["self"]} for item in data],
...
def passive_dns_data(client: Client, args: dict) -> CommandResults:
    ...
    limit = arg_to_number_must_int(args["limit"], arg_name="limit", required=True)
    ...
    return CommandResults(
        ...
        readable_output=tableToMarkdown(
            ...
            [{"id": item["id"], **item["attributes"]} for item in data],
...
def get_analysis_command(client: Client, args: dict) -> CommandResults:
    ...
    return CommandResults(
        ...
        readable_output=tableToMarkdown(
            "Analysis results:",
            {**data.get("attributes", {}), "id": analysis_id},
            headers=["id", "stats", "status"],
            headerTransform=underscoreToCamelCase,
        ),
        outputs={**raw_response, "id": analysis_id},
        raw_response=raw_response,
    )
...
def private_get_analysis_command(client: Client, args: dict) -> CommandResults:
    ...
    if attributes.get("status", "") == "completed":
        ...
        # URL attributes
        if (last_analysis_stats := item_attributes.get("last_analysis_stats")) and (
            detection_engines := sum(last_analysis_stats.values())
        ):
            positive_detections = last_analysis_stats.get("malicious", 0)
...
def main(params: dict, args: dict, command: str):
    ...
    demisto.debug(f"CVE Relationships: {params.get('cve_relationships', '')}")
    ...
    cve_relationships = arg_to_relationships(params.get("cve_relationships"))
    ...
    if command == "test-module":
        ...
        results = cve_command(client, args, cve_relationships)
