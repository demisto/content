...
def test_file_command(mocker, requests_mock):
    ...
    from GoogleThreatIntelligence import Client, ScoreCalculator, file_command
    ...
    requests_mock.get(
        f"https://www.virustotal.com/api/v3/files/{file_hash}?relationships={file_relationships}", json=mock_response
    )
    ...
    for extended_data in [True, False]:
        ...
        results = file_command(
            client=client, score_calculator=mocked_score_calculator, args=demisto.args(), relationships=file_relationships
        )
...
def test_domain_command(mocker, requests_mock):
    ...
    """
    import CommonServerPython
    from GoogleThreatIntelligence import Client, ScoreCalculator, domain_command
...
def test_ip_command(mocker, requests_mock):
    ...
    """
    import CommonServerPython
    from GoogleThreatIntelligence import Client, ScoreCalculator, ip_command
...
def test_url_command(mocker, requests_mock):
    ...
    """
    import CommonServerPython
    from GoogleThreatIntelligence import Client, ScoreCalculator, url_command
...
def test_private_url_command(mocker, requests_mock):
    ...
    """
    import CommonServerPython
    from GoogleThreatIntelligence import Client, private_url_command
...
def test_not_found_file_sandbox_report_command(mocker, requests_mock):
    ...
    """
    import CommonServerPython
    from GoogleThreatIntelligence import Client, file_sandbox_report_command
...
def test_gti_assessment_command(mocker, requests_mock):
    ...
    """
    import CommonServerPython
    from GoogleThreatIntelligence import Client, ScoreCalculator, encode_url_to_base64, get_assessment_command
    ...
    for resource, resource_type, endpoint in [
        ...
        for mock_response, expected_results in [
            ...
            requests_mock.get(
                f"https://www.virustotal.com/api/v3/{endpoint}/{endpoint_resource}?relationships=", json=mock_response
            )
...
def test_gti_comments_command(mocker, requests_mock):
    ...
    """
    import CommonServerPython
    from GoogleThreatIntelligence import Client, encode_url_to_base64, get_comments_command
    ...
    for resource, resource_type, endpoint in [
        ...
        endpoint_resource = encode_url_to_base64(resource) if resource_type == "url" else resource
        requests_mock.get(f"https://www.virustotal.com/api/v3/{endpoint}/{endpoint_resource}/comments", json=mock_response)
...
def test_gti_add_comments_command(mocker, requests_mock):
    ...
    """
    import CommonServerPython
    from GoogleThreatIntelligence import Client, add_comments_command
    ...
    for resource, resource_type, endpoint in [
        ...
        endpoint_resource = encode_url_to_base64(resource) if resource_type == "url" else resource
        requests_mock.post(f"https://www.virustotal.com/api/v3/{endpoint}/{endpoint_resource}/comments", json=mock_response)
...
def test_gti_comments_by_id_command(mocker, requests_mock):
    ...
    """
    import CommonServerPython
    from GoogleThreatIntelligence import Client, get_comments_by_id_command
    ...
    requests_mock.get("https://www.virustotal.com/api/v3/comments/random_id", json=mock_response)
...
def test_gti_passive_dns(mocker, requests_mock):
    ...
    """
    import CommonServerPython
    from GoogleThreatIntelligence import Client, passive_dns_data
    ...
    requests_mock.get("https://www.virustotal.com/api/v3/ip_addresses/8.8.8.8/resolutions?limit=10", json=mock_response)
...
def test_gti_analysis_get(mocker, requests_mock):
    ...
    """
    import CommonServerPython
    from GoogleThreatIntelligence import Client, get_analysis_command
    ...
    mocker.patch.object(demisto, "args", return_value={"id": "random_id"})
    requests_mock.get("https://www.virustotal.com/api/v3/analyses/random_id", json=mock_response)
...
def test_pending_gti_private_analysis_get(mocker, requests_mock):
    ...
    """
    import CommonServerPython
    from GoogleThreatIntelligence import Client, private_get_analysis_command
    ...
    mocker.patch.object(demisto, "args", return_value={"id": "random_id"})
    requests_mock.get("https://www.virustotal.com/api/v3/private/analyses/random_id", json=mock_response)
...
def test_completed_gti_private_analysis_get(mocker, requests_mock):
    ...
    mocker.patch.object(demisto, "args", return_value={"id": "random_id"})
    requests_mock.get("https://www.virustotal.com/api/v3/private/analyses/random_id", json=mock_analysis_response)
    requests_mock.get("https://www.virustotal.com/api/v3/private/analyses/random_id/item", json=mock_item_response)
...
def test_url_scan_command(mocker, requests_mock):
    ...
    """
    import CommonServerPython
    from GoogleThreatIntelligence import Client, scan_url_command
    ...
    mocker.patch.object(demisto, "args", return_value={"url": url})
    requests_mock.post("https://www.virustotal.com/api/v3/urls", json=mock_response)
...
def test_private_url_scan_command(mocker, requests_mock):
    ...
    """
    import CommonServerPython
    from GoogleThreatIntelligence import Client, private_scan_url_command
...
def test_file_sigma_analysis_command(mocker, requests_mock):
    ...
    """
    import CommonServerPython
    from GoogleThreatIntelligence import Client, file_sigma_analysis_command
    ...
    mock_response = util_load_json("test_data/file.json")
    expected_results = util_load_json("test_data/file_extended_results.json")
    requests_mock.get(f"https://www.virustotal.com/api/v3/files/{file_hash}?relationships=", json=mock_response)
...
def test_search_command(mocker, requests_mock):
    ...
    """
    import CommonServerPython
    from GoogleThreatIntelligence import Client, search_command
    ...
    requests_mock.get("https://www.virustotal.com/api/v3/search?query=random&limit=2", json=mock_response)
...
def test_get_upload_url(mocker, requests_mock):
    ...
    """
    import CommonServerPython
    from GoogleThreatIntelligence import Client, get_upload_url
    ...
    requests_mock.get("https://www.virustotal.com/api/v3/files/upload_url", json=mock_response)
...
def test_gti_curated_collections_commands(mocker, requests_mock):
    ...
    for func, collection_type in [
        ...
        for resource, resource_type, endpoint in [
            ...
            requests_mock.get(
                f"https://www.virustotal.com/api/v3/{endpoint}/{endpoint_resource}/collections" f"?filter={filter_query}",
                json=data_json,
            )
