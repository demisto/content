...
def test_get_agent_list_command(mocker):
    ...
    mock_response = util_load_json(os.path.dirname(__file__) + "/test_data/get_AgentList.json")
...
def test_get_agent_detail_command(mocker):
    ...
    mocker.patch("PicusNG.Client.get_access_token", return_value="access_token")
    client = Client(api_key="foo", base_url="base_url", verify=False, proxy=False)
    mock_response = util_load_json(os.path.dirname(__file__) + "/test_data/get_AgentDetail.json")
    mocker.patch("PicusNG.Client.http_request", return_value=mock_response)
...
def test_get_integration_agent_list_command(mocker):
    ...
    mocker.patch("PicusNG.Client.get_access_token", return_value="access_token")
    client = Client(api_key="foo", base_url="base_url", verify=False, proxy=False)
    mock_response = util_load_json(os.path.dirname(__file__) + "/test_data/get_IntegrationAgentList.json")
    mocker.patch("PicusNG.Client.http_request", return_value=mock_response)
...
def test_get_template_list_command(mocker):
    ...
    mocker.patch("PicusNG.Client.get_access_token", return_value="access_token")
    client = Client(api_key="foo", base_url="base_url", verify=False, proxy=False)
    mock_response = util_load_json(os.path.dirname(__file__) + "/test_data/get_TemplateList.json")
    mocker.patch("PicusNG.Client.http_request", return_value=mock_response)
...
def test_create_simulation_command(mocker):
    ...
    mocker.patch("PicusNG.Client.get_access_token", return_value="access_token")
    client = Client(api_key="foo", base_url="base_url", verify=False, proxy=False)
    mock_response = util_load_json(os.path.dirname(__file__) + "/test_data/createSimulation.json")
    mocker.patch("PicusNG.Client.http_request", return_value=mock_response)
...
def test_get_simulation_list_command(mocker):
    ...
    mocker.patch("PicusNG.Client.get_access_token", return_value="access_token")
    client = Client(api_key="foo", base_url="base_url", verify=False, proxy=False)
    mock_response = util_load_json(os.path.dirname(__file__) + "/test_data/get_SimulationList.json")
    mocker.patch("PicusNG.Client.http_request", return_value=mock_response)
...
def test_simulate_now_command(mocker):
    ...
    mocker.patch("PicusNG.Client.get_access_token", return_value="access_token")
    client = Client(api_key="foo", base_url="base_url", verify=False, proxy=False)
    mock_response = util_load_json(os.path.dirname(__file__) + "/test_data/simulateNow.json")
    mocker.patch("PicusNG.Client.http_request", return_value=mock_response)
...
def test_get_simulation_detail_command(mocker):
    ...
    mocker.patch("PicusNG.Client.get_access_token", return_value="access_token")
    client = Client(api_key="foo", base_url="base_url", verify=False, proxy=False)
    mock_response = util_load_json(os.path.dirname(__file__) + "/test_data/get_SimulationDetail.json")
    mocker.patch("PicusNG.Client.http_request", return_value=mock_response)
...
def test_get_latest_simulation_result_command(mocker):
    ...
    mocker.patch("PicusNG.Client.get_access_token", return_value="access_token")
    client = Client(api_key="foo", base_url="base_url", verify=False, proxy=False)
    mock_response = util_load_json(os.path.dirname(__file__) + "/test_data/get_LatestSimulationResult.json")
    mocker.patch("PicusNG.Client.http_request", return_value=mock_response)
...
def test_get_simulation_result_command(mocker):
    ...
    mocker.patch("PicusNG.Client.get_access_token", return_value="access_token")
    client = Client(api_key="foo", base_url="base_url", verify=False, proxy=False)
    mock_response = util_load_json(os.path.dirname(__file__) + "/test_data/get_SimulationResult.json")
    mocker.patch("PicusNG.Client.http_request", return_value=mock_response)
...
def test_get_simulation_threats_command(mocker):
    ...
    mocker.patch("PicusNG.Client.get_access_token", return_value="access_token")
    client = Client(api_key="foo", base_url="base_url", verify=False, proxy=False)
    mock_response = util_load_json(os.path.dirname(__file__) + "/test_data/get_SimulationThreats.json")
    mocker.patch("PicusNG.Client.http_request", return_value=mock_response)
...
def test_get_simulation_actions_command(mocker):
    ...
    mocker.patch("PicusNG.Client.get_access_token", return_value="access_token")
    client = Client(api_key="foo", base_url="base_url", verify=False, proxy=False)
    mock_response = util_load_json(os.path.dirname(__file__) + "/test_data/get_SimulationActions.json")
    mocker.patch("PicusNG.Client.http_request", return_value=mock_response)
...
def test_get_mitigation_devices_command(mocker):
    ...
    mocker.patch("PicusNG.Client.get_access_token", return_value="access_token")
    client = Client(api_key="foo", base_url="base_url", verify=False, proxy=False)
    mock_response = util_load_json(os.path.dirname(__file__) + "/test_data/get_MitigationDevices.json")
    mocker.patch("PicusNG.Client.http_request", return_value=mock_response)
...
def test_get_signature_list_command(mocker):
    ...
    mocker.patch("PicusNG.Client.get_access_token", return_value="access_token")
    client = Client(api_key="foo", base_url="base_url", verify=False, proxy=False)
    mock_response = util_load_json(os.path.dirname(__file__) + "/test_data/get_SignatureList.json")
    mocker.patch("PicusNG.Client.http_request", return_value=mock_response)
