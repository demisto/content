...
2. Ensure the user role has both **Integrations** and **Security Events** permissions before generating the token.
3. Select **Create New Token** and copy the API token.
