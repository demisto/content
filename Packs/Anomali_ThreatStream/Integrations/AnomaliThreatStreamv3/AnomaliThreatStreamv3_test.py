...
class TestGetCommands:
    ...
    @pytest.mark.parametrize(
        ...
        argvalues=[
            ...
            ('threatstream-list-whitelist-entry', {'page': 2, 'page_size': 4}, {'limit': 4, 'offset': 4, 'order_by': '-created_ts',
                                                                                'format': 'json', 'showNote': 'true'}),
            ('threatstream-list-whitelist-entry', {}, {'limit': 50, 'format': 'json', 'showNote': 'true', 'order_by': '-created_ts'}),
