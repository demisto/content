...
from Anomali_ThreatStream_v3 import main, file_name_to_valid_string
...
def test_ioc_approval_500_error(mocker):
    mocker.patch('Anomali_ThreatStream_v3.http_request', side_effect=http_request_with_approval_mock)
...
def test_import_ioc_without_approval(mocker):
    ...
    http_mock = mocker.patch('Anomali_ThreatStream_v3.http_request', side_effect=http_request_without_approval_mock)
