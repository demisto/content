...
Note: The indicator types can be found in Appendix B of the Anomali ThreatStream API documentation.
...
| --- | --- | --- |
| ImportJson | The string output represents a JSON object. | String |

## Script Examples

### Example command

```!threatstream-build-ioc-import-json indicator_query="type: Domain"```

### Context Example

```json
{
    "ImportJson": "{'objects': [{'value': 'my.domain1.com', 'itype': 'mal_domain'}, {'value': 'my.domain2.com', 'itype': 'mal_domain'}]}"
}
```
