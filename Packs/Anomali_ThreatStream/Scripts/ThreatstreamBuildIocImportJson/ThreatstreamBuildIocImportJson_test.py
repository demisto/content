...
@pytest.mark.parametrize(
    "args, indicators_types, expected_result",
    [
        (
            {
...
@pytest.mark.parametrize(
    "email_list, md5_list, ip_list, url_list, domain_list, expected_result",
    [
...
@pytest.mark.parametrize(
    "query, indicators_types, return_value, expected_result",
    [
        (
            "type:(IP Domain)",
            {"email": "mal_email", "md5": "mal_md5", "ip": "mal_ip", "url": "mal_url", "domain": "mal_domain"},
            [
                {
                    ...
                    "Type": 3,
                    "Contents": [
                        {"id": "1", "indicator_type": "IP", "value": "1.2.4.5"},
...
@pytest.mark.parametrize(
    "args, return_value, expected_outputs, expected_readable",
    [
        (
