...
def create_grids(custom_fields, linked_incident):
    ...
    linked_integrations_data = linked_content.get("CustomFields").get("integrationstestgrid", {})  # table of the linked incident
...
def main():
    ...
    if linked_incident:
        ...
        main_incident_grid.sort(
            key=lambda incident_dict: incident_dict.get("creationdate", ""), reverse=True
