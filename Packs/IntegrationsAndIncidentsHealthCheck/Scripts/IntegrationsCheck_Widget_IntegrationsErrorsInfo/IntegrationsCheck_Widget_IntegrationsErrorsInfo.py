...
def main():
    ...
    if isinstance(list_json, list):
            ...
            list_table.append(
                {
                    ...
                    "Information": instance.get("information"),
                }
            )
        ...
        list_table.append(
            {
                "Brand": list_json.get("brand"),
                "Instance": list_json.get("instance"),
                "Category": list_json.get("category"),
                "Information": list_json.get("information"),
            }
        )
        demisto.results({"total": len(list_table), "data": list_table})
