...
@pytest.mark.parametrize('list_, expected', [
    ([{'Contents': '''[{"incidentid": "7", "numberoferrors": 2, "owner": "", "playbookname": "AutoFocusPolling", "taskid": "3",
     ...
     {'data': [{'Command Name': 'RunPollingCommand',
                'Incident Creation Date': '2020-09-29 16:48:30.261438285Z',
                'Incident ID': '7',
                'Incident Owner': '',
                'Number of Errors': 2,
               ...
               {'Command Name': 'SetGridField',
                'Incident Creation Date': '2020-09-29 14:02:45.82647067Z',
                'Incident ID': '3',
               ...
               {'Command Name': 'ad-get-user',
                'Incident Creation Date': '2020-09-30 15:44:06.930751906Z',
                'Incident ID': '48',
                'Incident Owner': 'admin',
                'Number of Errors': 2,
