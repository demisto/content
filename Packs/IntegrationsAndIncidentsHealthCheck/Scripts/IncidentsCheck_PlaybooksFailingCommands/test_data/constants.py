INCIDENT_RESULT_NO_FAILED_COMMANDS = [
    {
        ...
        "closingUserId": "",
        "created": "2020-10-03T12:11:04.144482161Z",
        "dbotCreatedBy": "admin",
        ...
        "modified": "2020-10-03T13:44:07.136165794Z",
        "name": "for ut",
...
INCIDENT_RESULT_NO_FAILED_COMMANDS_EXPECTED = {
    ...
    "stats": [{"color": "rgb(255, 23, 68)", "data": [0], "groups": None, "label": "N/A", "name": "N/A"}],
}
...
INCIDENT_RESULT_EXPECTED = {
    "params": {"layout": "vertical"},
    "stats": [
        {"color": "#0003e8", "data": [2], "groups": None, "label": "SetGridField", "name": "SetGridField"},
        {"color": "#0003e8", "data": [1], "groups": None, "label": "RunPollingCommand", "name": "RunPollingCommand"},
        {"color": "#0003e8", "data": [1], "groups": None, "label": "ad-get-user", "name": "ad-get-user"},
    ],
}
