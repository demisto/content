...
class Client(BaseClient):
    def get_transactionlog(self, page, search, locked) -> Dict[str, Any]:
        ...
        return self._http_request(method="GET", url_suffix=f"/transactionlog/?page={page}{p_search}{p_locked}", resp_type="text")
    ...
    def get_users(self, page, search, locked) -> Dict[str, Any]:
        ...
        return self._http_request(method="GET", url_suffix=f"/userlist/?page={page}{p_search}{p_locked}", resp_type="text")
    ...
    def get_ldap_users(self, page, search, locked, ldap) -> Dict[str, Any]:
        ...
        return self._http_request(method="GET", url_suffix=f"/userlist/{ldap}/?page={page}{p_search}{p_locked}", resp_type="text")
    ...
    def delete_user_token(self, username, token_devicetype, token_serialnumber) -> Dict[str, Any]:
        return self._http_request(
            method="DELETE", url_suffix=f"/user/{username}/devices/{token_devicetype}/{token_serialnumber}/", resp_type="text"
        )

    def send_user_token(self, username, token_devicetype, token_serialnumber) -> Dict[str, Any]:
        return self._http_request(
            method="POST", url_suffix=f"/user/{username}/devices/{token_devicetype}/{token_serialnumber}/send/", resp_type="text"
        )

    def send_user_virtualtoken(self, username, token_devicetype, token_serialnumber) -> Dict[str, Any]:
        return self._http_request(
            method="POST", url_suffix=f"/devices/{token_devicetype}/{token_serialnumber}/code/", resp_type="text"
        )
...
def create_user_token_virtual(client, args):
    username = args.get("username")
    post_params = {"device_type": "Virtual"}
...
def create_user_token_totmobilehybrid(client, args):
    username = args.get("username")
    post_params = {"device_type": "TOTP:Mobile:Hybrid", "serial_number": args.get("serial-number"), "password_required": ""}
