...
3. Click **Add instance** to create and configure a new integration instance.
    ...
    | Source Priority Level | Events will be fetched only for User Profiles with a Source Priority value less than or equals to the value of this parameter. | False |
