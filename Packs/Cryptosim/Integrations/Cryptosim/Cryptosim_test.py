...
def test_correlation_alerts_command(requests_mock):
    mock_response = {
        "StatusCode": 200,
        "Data": [
            {"CorrelationAlert": {"NAME": "name1", "changedKey1": "changedVal1"}, "Log": {"differentLog1": "differentValue1"}},
            {"CorrelationAlert": {"NAME": "name2", "changedKey2": "changedVal2"}, "Log": {"differentLog1": "differentValue1"}},
        ],
        "OutParameters": None,
    }

    requests_mock.post("https://test.com/correlationalertswithlogs", json=mock_response)
