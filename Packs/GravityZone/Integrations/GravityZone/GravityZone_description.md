...
For detailed API documentation, see the [Bitdefender GravityZone Public API](https://www.bitdefender.com/business/support/en/77209-125277-public-api.html).
...
1. Log in with an administrator account that has View and Analyze Data, Manage Networks, Manage Users, and Manage Company permissions.
...
8. Close the window. The new key will appear encoded in the **API keys** section, along with its details.

**Note:**
API keys provide access to sensitive data, including packages and inventory. To prevent unauthorized access, do not share your API keys.

#### Mirroring

- When enabled, mirroring synchronizes only the **Incident status** field for incidents modified in the last 24 hours.
