import pytest
from TrendMicroCAS import (
    Client,
    security_events_list_command,
    email_sweep_command,
    parse_date_to_isoformat,
    user_take_action_command,
    email_take_action_command,
    user_action_result_command,
    blocked_lists_get_command,
...
def test_user_take_action_command(mocker):
    ...
    args = {"action_type": "action_type", "account_user_email": "account_user_email1, account_user_email2"}
...
args_test_user_action_result = [{"limit": "5"}, {"start": "12 hours", "end": "10 hours"}, {"batch_id": "batch_id"}]
...
DATA_TEST_PARSE_DATE_TO_ISOFORMAT_FREE_TEXT = ["1 day", "3 months", "1 week and 1 day"]
