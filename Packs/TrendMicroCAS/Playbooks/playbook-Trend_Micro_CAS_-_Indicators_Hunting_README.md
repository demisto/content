...
| TrendMicroCAS.HuntingResults.value.mailbox | The mailbox that contains the email message. | string |
...
| TrendMicroCAS.HuntingResults.value.mail_attachments.file_sha1 | The SHA1 hash value of the attachment file. | string |
