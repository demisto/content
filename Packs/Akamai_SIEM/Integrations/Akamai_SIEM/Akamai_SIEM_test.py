...
with open(Path(__file__).parent / './Akamai_SIEM_test/TestCommandsFunctions/sec_events_empty.txt', 'r') as sec_events_empty:
    SEC_EVENTS_EMPTY_TXT = sec_events_empty.read()
with open(Path(__file__).parent / './Akamai_SIEM_test/TestCommandsFunctions/sec_events.txt', 'r') as sec_events:
