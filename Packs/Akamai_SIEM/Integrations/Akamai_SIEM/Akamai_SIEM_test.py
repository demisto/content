...
class TestCommandsFunctions:
    ...
    def test_fetch_events_command__sanity(self, client, mocker):
        ...
        for events, offset, total_events_count, _ in Akamai_SIEM.fetch_events_command(client, '3 days', 220, '', {}):  # noqa: B007
    ...
    def test_fetch_events_command__limit_is_smaller_than_page_size(self, client, requests_mock, mocker):
        ...
        for _, offset, total_events_count, new_from_time in Akamai_SIEM.fetch_events_command(client, '12 hours', 4, '50170', {}):  # noqa: B007
            last_offset = offset
    ...
    def test_fetch_events_command__limit_is_higher_than_page_size(self, client, requests_mock, mocker):
        ...
        for _, offset, total_events_count, new_from_time in Akamai_SIEM.fetch_events_command(client, '12 hours', 20, '50170', {}):  # noqa: B007
            last_offset = offset
    ...
    def test_fetch_events_command__limit_reached(self, client, requests_mock, mocker):
        ...
        for _, offset, total_events_count, _ in Akamai_SIEM.fetch_events_command(client, '12 hours', 2, '50170', {}):  # noqa: B007
            last_offset = offset
