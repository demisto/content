...
| --- | --- | --- |
| mitigationstatus_external_ticket_id | External service ticket ID. | Optional | 
| mitigationstatus_external_ticket_url | External service ticket link. | Optional | 
| mitigationstatus_id | Mitigation ID. | Optional | 
| mitigationstatus_state | Mitigation status     new - New mitigation     pending_approval - Waiting for mitigation approval     rejected - Mitigative action was rejected.     in_progress - Mitigation approved and in progress.     completed - Mitigation applied successfully. . Possible values are: new, pending_approval, rejected, in_progress, completed. | Optional | 
...
| **Argument Name** | **Description** | **Required** |
| --- | --- | --- |
| mitigationsstatus_mitigation_id | Mitigation ID. | Optional | 
| mitigationsstatus_mitigation_ids | Mitigation IDs. | Optional | 
| mitigationsstatus_state | Mitigation status     new - New mitigation     pending_approval - Waiting for mitigation approval     rejected - Mitigative action was rejected.     in_progress - Mitigation approved and in progress.     completed - Mitigation applied successfully. . Possible values are: new, pending_approval, rejected, in_progress, completed. | Optional | 
