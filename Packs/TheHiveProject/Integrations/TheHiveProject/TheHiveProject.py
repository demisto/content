...
class Client(BaseClient):
    ...
    def __init__(self, base_url=None, verify=Fimport demistomock as demisto
from CommonServerPython import *
...
if __name__ in ('__main__', '__builtin__', 'builtins'):
 ...
 # observables are not returned without specific case id RESOLVED
