...
def parse_cloud_discovery(raw_json):
    ...
    readable_outputs = tableToMarkdown("Cloud Discovery Information", data, headers=data_fields)
...
def main():
    try:
        ...
        return_error(f"Failed to execute PrismaCloudComputeParseCloudDiscoveryAlert. Error: {ex!s}")
