...
def update_group_from_images(
    remote_trusted_images: Dict[str, Any], current_trusted_images: list, trusted_group_id: str
) -> tuple[bool, str]:
    """
...
def main():
    try:
        ...
        return_error(f"Failed to execute PrismaCloudLocalTrustedImagesListUpdate. Error: {e!s}")
