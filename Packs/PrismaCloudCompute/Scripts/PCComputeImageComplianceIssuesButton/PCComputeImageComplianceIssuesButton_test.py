    ...
    (
        {
            ...
            "image_id": "9f86d081884c7d659a2feaa0c55ad015a3bf4f1b2b0b822cd15d6c15b0f00a08",
        },
        [
            {
                "ComplianceID": "6112",
...
def test_run_prisma_cloud_compute_images_scan_list(mocker):
    """
    Given:
        A specific image ID.
        Given The results from the command "prisma-cloud-compute-images-scan-list" for that image.

    When:
        Running run_prisma_cloud_compute_images_scan_list

    Then:
        Assert the returned output is the same as the given results for the given image.
    """
    ...
    returned_compliance_issues = run_prisma_cloud_compute_images_scan_list(
