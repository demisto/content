...
deployed_image_1 = {
    ...
    "clusters": ["cluster1"],
    "collections": ["All", "Access Group", "access-all"],
    ...
    "creationTime": "2015-10-19T09:17:01.62Z",
    "distro": "Linux 8",
    "err": "",
    "files": None,
    "firewallProtection": {"enabled": False, "outOfBandMode": "", "supported": False},
    "firstScanTime": "2023-09-14T19:09:45.811Z",
    "foundSecrets": None,
    "history": None,
    "hostname": "",
    "hosts": {
        "ip-1.us-east.compute.internal-i-0": {
            "accountID": "49",
            "agentless": True,
            "agentlessScanID": 486,
            "cluster": "cluster1",
        ...
        "ip-2.us-east.compute.internal-i-5": {
            "accountID": "44",
            "agentless": True,
            "agentlessScanID": 486,
            "cluster": "cluster1",
        ...
        "ip-3.us-east.compute.internal-i-6": {
            "accountID": "45",
            "agentless": True,
            "agentlessScanID": 486,
            "cluster": "cluster1",
        ...
        "ip-4.us-east.compute.internal-i-9": {
            "accountID": "47",
            "agentless": True,
            "agentlessScanID": 486,
            "cluster": "cluster1",
    ...
    "installedProducts": {"agentless": True, "docker": "a1", "hasPackageManager": True, "osDistro": "Linux 8"},
    "instances": [
        {
            "host": "ip-1.us-east.compute.internal-i-2",
            "image": "registry.io/a-example:latest",
            "modified": "2023-10-03T00:35:57.271Z",
    ...
    "repoDigests": ["registry.io/a-example@sha256:5"],
...
passed_ci_scan_image_1 = {
    ...
    "repoTag": {"registry": "pythonserver.io", "repo": "pythonserver", "tag": "67"},
    "scanID": 0,
    "scanTime": "2023-09-29T13:18:39.093Z",
    "scanVersion": "31.01.131",
    "tags": [{"registry": "pythonserver.io", "repo": "pythonserver", "tag": "67"}],
    "type": "ciImage",
    "vulnerabilitiesCount": 80,
...
@pytest.mark.parametrize(
    "list_name,get_list_response,expected_exists,expected_list",
    [
...
@pytest.mark.parametrize(
    "current_dict, deployed_images, passed_ci_scan_images, expected",
    [
        (
            {},
...
@pytest.mark.parametrize(
    "current_dict, time_frame, expected",
    [
        (
            {"image1": "2022-01-01T00:00:00", "image2": "2022-01-02T00:00:00", "image3": "2022-01-03T00:00:00"},
            "2022-01-02T00:00:00",
            {"image2": "2022-01-02T00:00:00", "image3": "2022-01-03T00:00:00"},
        ),
        (
            {
...
@pytest.mark.parametrize(
    "list_name, list_data, is_list_exist", [("test", {"image": "img1"}, True), ("test", {"image": "img2"}, False)]
)
