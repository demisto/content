![image](binary_files/72906531-0e452a00-3d3b-11ea-8703-8b97ddf30be0.png)
...
![image](binary_files/prisma_alert_raw_input.png)


* Click **outputs** to see how the script transformed the raw JSON input into a Demisto object.


![image](binary_files/prisma_alert_outputs.png)
...
![image](binary_files/prisma_instance.png)
