...
def client() -> PrismaCloudComputeClient:
    return PrismaCloudComputeClient(base_url=BASE_URL, verify="False", project="", auth=("test", "test"))
...
def test_fetch_incidents(requests_mock):
    ...
    expected_incidents = [
        {
            "name": "Prisma Cloud Compute Alert - Host Runtime Audit",
            "occurred": "2020-01-09T10:49:24.675Z",
            "severity": 0,
        ...
        {
            "name": "Prisma Cloud Compute Alert - Incident",
            "occurred": "2020-01-09T10:49:24.675Z",
            "severity": 0,
        ...
        {
            "name": "Prisma Cloud Compute Alert - Cloud Discovery",
            "occurred": "2020-01-09T10:50:08.115Z",
            "severity": 0,
        ...
        {
            "name": "Prisma Cloud Compute Alert - Container Compliance",
            "occurred": "2020-01-09T10:52:31.185Z",
            "severity": 0,
        ...
        {
            "name": "Prisma Cloud Compute Alert - Image Compliance",
            "occurred": "2020-01-09T10:52:31.185Z",
            "severity": 0,
        ...
        },
        {
            ...
            "occurred": "2020-01-09T10:53:23.865Z",
            "severity": 3,
...
def test_get_headers():
    ...
    data = [{"cve": "", "link": "", "packageVersion": "", "packages": "", "severity": "", "sourcePackage": "", "status": ""}]
...
HTTP_REQUEST_URL_WITH_QUERY_PARAMS = [
    ...
    (
        OrderedDict(collections="collections", hostname="hostname", limit="15", offset="2", id="123"),
        get_profile_container_forensic_list,
    ...
    (
        OrderedDict(collections="collections", limit="10", offset="3", id="123"),
        get_profile_host_forensic_list,
        "/profiles/host/123/forensic",
        "https://test.com/profiles/host/123/forensic?collections=collections&limit=13",
    ),
    (OrderedDict(), get_console_version, "/version", "https://test.com/version"),
    (OrderedDict(), get_custom_feeds_ip_list, "/feeds/custom/ips", "https://test.com/feeds/custom/ips"),
    (OrderedDict(cve_id="cve-2104"), get_cves, "/cves", "https://test.com/cves?id=cve-2104"),
    (
    ...
    (OrderedDict(limit="20"), get_collections, "/collections", "https://test.com/collections"),
    (
...
INVALID_LIMIT_OFFSET_ARGS = [
    ...
    ({"limit": "-1"}, get_custom_malware_feeds),
]
...
HTTP_BODY_REQUEST_PARAMS = [
    (add_custom_ip_feeds, "/feeds/custom/ips", {"ip": "1.1.1.1"}, {"feed": ["1.1.1.1"]}),
    (
        add_custom_malware_feeds,
        "/feeds/custom/malware",
        {"name": "test", "md5": "1,2,3"},
        {"feed": [{"name": "test", "md5": "1"}, {"name": "test", "md5": "2"}, {"name": "test", "md5": "3"}]},
    ),
]
...
EXPECTED_CONTEXT_OUTPUT_DATA = [
    ...
    (
        ...
        "/profiles/container",
        [
            {"state": "active", "_id": "1", "created": "2021-09-02T11:05:08.931Z"},
            {"state": "down", "_id": "2", "created": "2020-09-02T11:05:08.931Z"},
            {"state": "active", "_id": "3", "created": "2019-09-02T11:05:08.931Z"},
        ],
        "",
    ),
    (
        {"limit": "10", "offset": "0", "id": "123"},
        get_container_hosts_list,
        "/profiles/container/123/hosts",
        ["host1", "host2"],
        {"containerID": "123", "hostsIDs": ["host1", "host2"]},
    ),
    (
        {"limit": "10", "offset": "0", "id": "123", "hostname": "hostname"},
        get_profile_container_forensic_list,
        "/profiles/container/123/forensic?hostname=hostname",
        [
            {"type": "Runtime profile networking", "containerId": "1234", "port": 8000, "outbound": True},
            {"type": "Runtime profile networking", "containerId": "1234", "port": 6789, "process": "some_process"},
        ],
        {
            "containerID": "123",
            "hostname": "hostname",
    ...
    ({}, get_console_version, "/version", "21.04", ""),
    (
        {},
        get_custom_feeds_ip_list,
        "/feeds/custom/ips",
        {
            ...
            "feed": ["1.1.1.1", "5.5.5.5", "2.2.2.2", "4.4.4.4", "3.3.3.3"],
            "digest": "1234",
        },
        {
    ...
    (
        ...
        "/feeds/custom/malware",
        {
            ...
            "feed": [
                {"md5": "1234", "name": "test", "modified": 0, "allowed": False},
                {"md5": "12345", "name": "test1", "modified": 0, "allowed": False},
            ],
            "digest": "1234",
        },
        {
            "modified": "December 09, 2021 13:31:38 PM",
            "feed": [{"md5": "1234", "name": "test", "allowed": False}],
            "digest": "1234",
        },
    ),
    (
        ...
        [
            {"ID": "cve1", "Description": "description1", "CVSS": 5, "Modified": "November 23, 2020 12:50:03 PM"},
            {"ID": "cve2", "Description": "description2", "CVSS": 7, "Modified": "November 23, 2020 12:50:03 PM"},
        ],
    ),
    (
        {"cve": "cve_id_value"},
        ...
        [
            {
                ...
                "version": "24.04",
                "connected": True,
                "features": {"proxyListenerType": "none"},
                "category": "docker",
    ...
    ({"limit": "20"}, get_namespaces, "/radar/container/namespaces", ["namespace1", "namespace2", "namespace3"], ""),
    (
                ...
                "1": [
                    {
                        ...
                        "factors": {"network": True, "noSecurityProfile": True},
                    }
                ],
            },
        },
...
def test_get_impacted_resources(mocker):
    ...
    """
    from PaloAltoNetworks_PrismaCloudCompute import PrismaCloudComputeClient, get_impacted_resources
    ...
    client = PrismaCloudComputeClient(base_url=BASE_URL, verify="False", project="", auth=("test", "test"))
    assert get_impacted_resources(client, {"resourceType": "image", "cve": "CVE-2018-1270"}).raw_response == {"CVE-2018-1270": d}
...
def test_get_waas_policies(mocker):
    ...
    """
    from PaloAltoNetworks_PrismaCloudCompute import PrismaCloudComputeClient, get_waas_policies
...
def test_update_waas_policies(mocker):
    ...
    """
    from PaloAltoNetworks_PrismaCloudCompute import PrismaCloudComputeClient, update_waas_policies

    mocker.patch.object(
        PrismaCloudComputeClient, "update_waas_policies", return_value=type("Response", (object,), {"status_code": 200})
    )
    ...
    args = {"policy": policy, "action": "ban", "attack_type": "lfi", "rule_name": "WaaS rule for DVWA"}
...
def test_get_audit_firewall_container_alerts(mocker):
    ...
    """
    from PaloAltoNetworks_PrismaCloudCompute import PrismaCloudComputeClient, get_audit_firewall_container_alerts
    ...
    client = PrismaCloudComputeClient(base_url=BASE_URL, verify="False", project="", auth=("test", "test"))
    args = {"audit_type": "lfi", "ImageName": "vulnerables/web-dvwa:latest"}
...
def test_get_alert_profiles_command(requests_mock):
    ...
    """
    from PaloAltoNetworks_PrismaCloudCompute import PrismaCloudComputeClient, get_alert_profiles_command
...
def test_get_backups_command(requests_mock):
    ...
    """
    from PaloAltoNetworks_PrismaCloudCompute import PrismaCloudComputeClient, get_backups_command
...
def test_get_defender_logs_command(requests_mock):
    ...
    """
    from PaloAltoNetworks_PrismaCloudCompute import PrismaCloudComputeClient, get_logs_defender_command
    ...
    client = PrismaCloudComputeClient(base_url=BASE_URL, verify="False", project="", auth=("test", "test"))
    args = {"hostname": "test.internal", "lines": 2}
...
def test_get_defender_settings_command(requests_mock):
    ...
    """
    from PaloAltoNetworks_PrismaCloudCompute import PrismaCloudComputeClient, get_settings_defender_command
...
def test_get_logs_defender_download_command(requests_mock):
    ...
    """
    from PaloAltoNetworks_PrismaCloudCompute import PrismaCloudComputeClient, get_logs_defender_download_command
...
def test_get_file_integrity_events_command(requests_mock):
    ...
    """
    from PaloAltoNetworks_PrismaCloudCompute import PrismaCloudComputeClient, get_file_integrity_events_command
...
def test_get_ci_scan_results_list_command(requests_mock):
    ...
    Then:
        -  Ensure the outputs of requesting the defenders settings equals the raw_response object which is mocked
    """
    from PaloAltoNetworks_PrismaCloudCompute import PrismaCloudComputeClient, get_ci_scan_results_list
...
def test_get_trusted_images_command(requests_mock):
    ...
    from PaloAltoNetworks_PrismaCloudCompute import PrismaCloudComputeClient, get_trusted_images
...
def test_update_trusted_images_command(mocker):
    ...
    from PaloAltoNetworks_PrismaCloudCompute import PrismaCloudComputeClient, update_trusted_images
    ...
    http_request.assert_called_with(
        method="PUT", url_suffix="trust/data", json_data=images_list_json, resp_type="response", ok_codes=(200,)
    )
...
def test_get_container_scan_results_command(requests_mock):
    ...
    from PaloAltoNetworks_PrismaCloudCompute import PrismaCloudComputeClient, get_container_scan_results
...
def test_get_hosts_info_command(requests_mock):
    ...
    from PaloAltoNetworks_PrismaCloudCompute import PrismaCloudComputeClient, get_hosts_info
...
def test_get_runtime_container_audit_events_command(requests_mock):
    ...
    from PaloAltoNetworks_PrismaCloudCompute import PrismaCloudComputeClient, get_runtime_container_audit_events
...
@pytest.mark.parametrize(
    ...
    "action, response",
    [("archive", "Incident 1111 was successfully archived"), ("unarchive", "Incident 1111 was successfully unarchived")],
)
def test_archive_audit_incident_command(mocker, action, response):
    ...
    from PaloAltoNetworks_PrismaCloudCompute import PrismaCloudComputeClient, archive_audit_incident_command
...
def test_get_host_audit_list_command(requests_mock):
    ...
    from PaloAltoNetworks_PrismaCloudCompute import PrismaCloudComputeClient, get_container_policy_list_command
...
def test_runtime_host_audit_events_command(requests_mock):
    ...
    from PaloAltoNetworks_PrismaCloudCompute import PrismaCloudComputeClient, get_host_audit_list_command
