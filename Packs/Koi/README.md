...
This pack includes the **KOI** integration — full Koi API v2 coverage with actionable commands, enrichment with DBot scoring, and EntityRelationship linking for CVEs and file hashes.
