...
def util_mock_login(requests_mock):
    ...
    requests_mock.post("https://test.com/login", json=mock_response)
...
def test_fetch_detections(mocker, requests_mock):
    ...
    requests_mock.get("https://test.com/ioc-detections/72", json=mock_response1)
...
def test_fetch_progressions(mocker, requests_mock):
    ...
    requests_mock.get("https://test.com/trails/72", json=mock_response)
...
def test_fetch_trail_details(mocker, requests_mock):
    ...
    requests_mock.get("https://test.com/trails/prod_0_11_.agent-11:17869700", json=mock_response)
    ...
    args = {"trail_id": "prod_0_11_.agent-11:17869700"}
