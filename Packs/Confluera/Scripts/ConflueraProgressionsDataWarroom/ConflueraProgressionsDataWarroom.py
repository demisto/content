...
for _idx, progression in enumerate(progressions):
    ...
    temp_dct = {"name": "AP-" + str(progression["attackId"]), "data": [progression["riskScore"]], "color": color}

    data.append(temp_dct)

return_results({"Type": 17, "ContentsFormat": "bar", "Contents": {"stats": data, "params": {"layout": "vertical"}}})
