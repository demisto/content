...
RESULT_PARSED_INDICATORS = [
    {'type': 'URL',
     ...
     'fields': {'description': 'https://otx.alienvault.com/pulse/111'},
    ...
    {'htype': 'md5', 'type': 'File', 'stix_title': 'FileHash-MD5 - 39eb39ad9fad2710be03c18de6985c20',
     ...
     'fields': {'description': 'https://otx.alienvault.com/pulse/1111'},
...
def test_parse_inndicators():
    parsed_list, only_indicator_list = parse_indicators(TEST_DATA, [])
