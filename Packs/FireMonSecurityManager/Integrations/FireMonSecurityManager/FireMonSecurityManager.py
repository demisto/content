...
def pca_command(client, args):
    ...
    if len(list_of_device_changes) == 0:
        return CommandResults(outputs_prefix='FireMonSecurityManager.PCA',
                              ...
                              outputs="No matching rule found for this requirement, "
                                      "Please go back and update the requirement",
                              readable_output=tableToMarkdown(name="FireMon SecurityManager PCA:",
                                                              t={
                                                                  "pca": "No matching rule found for this requirement, "
                                                                         "Please go back and update the requirement"},
                                                              removeNull=True),
                              raw_response="No matching rule found for this requirement, "
                                           "Please go back and update the requirement")
