...
USERS = [
    {
        "Type": 1,
        "Contents": [
            {"id": "user1", "name": "User1", "roles": {"demisto": ["Shift1"]}},
            {"id": "user2", "name": "User2", "roles": {"demisto": ["Shift1"]}},
            {"id": "user3", "name": "User3", "roles": {"demisto": ["Shift2"]}},
            {"id": "admin", "name": "Admin", "roles": {"demisto": ["Administrator"]}},
        ],
    }
]
