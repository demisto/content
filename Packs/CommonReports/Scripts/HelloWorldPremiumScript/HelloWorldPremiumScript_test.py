"""HelloWorldPremium Script for Cortex XSOAR - Unit Tests file
This file contains the Unit Tests for the HelloWorldPremium Script based
...
Also please check the HelloWorldPremium Integration Unit Tests file.
"""
