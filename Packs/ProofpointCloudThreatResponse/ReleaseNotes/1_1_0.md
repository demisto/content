...
- Added the *priority_filters* and *sort* arguments to the ***proofpoint-ctr-incidents-list*** command, which enable filtering incidents by priority and sorting results by creation time.
