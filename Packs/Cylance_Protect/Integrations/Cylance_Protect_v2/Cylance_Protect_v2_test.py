...
def test_get_threats(mocker):
    ...
    """
    params = {'app_id': 'app_id', 'app_secret': 'app_secret', 'tid': 'tid', 'file_threshold': 'file_threshold', 'server': 'https://www.test.com'}
    mocker.patch.object(demisto, "params", returned_value=params)
