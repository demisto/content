...
def main():
    ...
    result_field = "cafdresultraw"
    answers_field = "cafdanswers"
    questions_field = "cafdquestions"
    assessment_field = "AssessmentD"
    ...
    if incident:
        ...
        if assessment_result in ['Not Achieved', 'Partially Achieved']:
            md += "### Recommendations\n\nPlease review the following questions and their responses that result in an" \
                  " 'Achieved' outcome for this objective (the list only includes questions which have not" \
