...
def main():
    ...
    if incident:
        ...
        if not_achieved or partially_achieved:
            md += "There is material available on the NCSC Website under [Table view of principles and related guidance](https://www.ncsc.gov.uk/collection/caf/table-view-principles-and-related-guidance) that will help with achieving all those that are either 'Not Achieved' or 'Partially Achived'.\n\n"

        else:
            md += "This assessment was fully 'Achieved', great work! There is nothing more to do than ensure that your standards remain as high as they are now.\n\n"
