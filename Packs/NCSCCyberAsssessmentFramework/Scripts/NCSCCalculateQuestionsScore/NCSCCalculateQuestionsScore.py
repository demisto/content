...
md = tableToMarkdown(f'Assessment results ({assessment}):', assessment_output, ['Question', 'Result', 'Reason'])
...
command_results = CommandResults(
    outputs_prefix=f'AssessmentMarkdown.{assessment}',
    outputs=md,
    readable_output=md
)
return_results(command_results)
