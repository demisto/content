...
def update_remote_system_command(client, args):
    ...
    try:
        if remote_args.incident_changed:
            ...
            remote_is_already_closed = remote_args.inc_status == 2 and current_remote_status in XDR_RESOLVED_STATUS_TO_XSOAR
            demisto.debug(
                f"remote_is_already_closed= {remote_args.inc_status == 2}, "
                f"{current_remote_status in XDR_RESOLVED_STATUS_TO_XSOAR}")
