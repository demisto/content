...
def update_remote_system_command(client, args):
    ...
    try:
        if remote_args.incident_changed:
            ...
            if is_closed and close_alerts_in_xdr and closed_without_status and not remote_is_already_closed:
            ...
            if is_closed and closed_without_status and close_alerts_in_xdr and remote_is_already_closed:
