...
| created_before | Filters cases that were created before this date. Supports English expressions like "one year". | Optional |
| created_after | Filters cases that were created after this date. Supports English expressions like "one year". | Optional |
