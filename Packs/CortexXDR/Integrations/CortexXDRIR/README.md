...
| PaloAltoNetworksXDR.Case.Issues.action_country | String | The country associated with the issue action. Returned when extra_data is set to true. |
| PaloAltoNetworksXDR.Case.Issues.agent_device_domain | String | The domain of the agent device involved in the issue. Returned when extra_data is set to true. |
| PaloAltoNetworksXDR.Case.Issues.causality_actor_process_image_sha256 | String | SHA256 hash of the causality actor process image. Returned when extra_data is set to true. |
| PaloAltoNetworksXDR.Case.Issues.module_id | String | The identifier of the module that raised the issue. Returned when extra_data is set to true. |
