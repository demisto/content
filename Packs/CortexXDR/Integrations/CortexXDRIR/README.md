...
| **Argument Name** | **Description** | **Required** |
| --- | --- | --- |
| field_name | The name of the field to get options for. You can use xdr-asset-schema-get in order to get the schema.  The field must be of type ENUM. | Required | 
