...
***
Returns a list of cases based on filters.
...
| **Argument Name** | **Description** | **Required** |
| --- | --- | --- |
| case_id | A comma-separated list of case IDs. | Optional | 
| case_domain | A comma-separated list of case domains. | Optional | 
| severity | A comma-separated list of severities. | Optional | 
| created_before | Filters cases that were created before this date. Supports English expressions like "in a year". | Optional | 
| created_after | Filters cases that were created after this date. Supports English expressions like "in a year". | Optional | 
...
| status | The status to set for the case. if the status is updated to "resolved", resolution_reason must be provided. Possible values are: new, under_investigation, resolved. | Optional | 
...
| PaloAltoNetworksXDR.CaseNetworkArtifact.network_remote_ip | String | The remote IP address involved in the artifact. | 
