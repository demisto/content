...
| assigned_user_pretty_name | Full name of the user assigned to the incident.To supply a new value in this field, you must also supply a value for assigned_user_mail in the same request. | Optional | 
