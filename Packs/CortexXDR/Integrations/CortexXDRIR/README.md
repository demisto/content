...
3. Click **Add instance** to create and configure a new integration instance.
    ...
    | Remove additional data | Whether to remove the additional data field (incident.additionaldata in the context data). This elimination is highly recommended. | False |
