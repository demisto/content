...
def test_get_remote_data_command_should_update(requests_mock):
    ...
    raw_incident = load_test_data('./test_data/get_incident_extra_data.json')
    expected_modified_incident = raw_incident['reply']['incident']
...
def test_get_remote_data_command_sync_owners(requests_mock, mocker):
    ...
    Given:
        -  an XDR client
        - arguments (id and lastUpdate time set to a lower than incident modification time)
        - a raw incident (get-extra-data results) with assigned mail some@mail.com
    When
        - running get_remote_data_command
    Then
    ...
    raw_incident = load_test_data('./test_data/get_incident_extra_data.json')
    raw_incident['reply']['incident']['assigned_user_mail'] = 'some@mail.com'
...
def test_get_update_args_owner_sync(mocker):
    ...
    assert update_args.get('assigned_user_mail') == 'some@mail.com'
...
def test_handle_outgoing_error_in_mirror__should_update(mocker):
    ...
    """
    from PaloAltoNetworks_XDR import handle_outgoing_error_in_mirror
...
def test_handle_incoming_error_in_mirror__should_update_in_only(mocker):
    ...
    """
    from PaloAltoNetworks_XDR import handle_incoming_error_in_mirror
