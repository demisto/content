...
* The API includes a limit rate of 10 API requests per minute. Therefore, in a case of a rate limit exception, the sync loop will be stopped and will resume from the last incident. 
