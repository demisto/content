...
@pytest.mark.parametrize('context_data, expected_result', [
    (util_load_json(os.path.dirname(__file__) + '/test_data/context_data1.json'), util_load_json(os.path.dirname(__file__) + '/test_data/expected_results1.json')),
    (util_load_json(os.path.dirname(__file__) + '/test_data/context_data2.json'), util_load_json(os.path.dirname(__file__) + '/test_data/expected_results2.json'))
])
