...
| MessageSubject | A message subject for the communication with the involved users. | Device control violation | Optional |
| MessageBody | A message body for the communication with the involved users. | Hello,<br/>Your user was involved with a device control violation. Please open the following link to fill in the needed information to understand the incident further. | Optional |
