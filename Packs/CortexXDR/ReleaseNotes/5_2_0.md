...
- Added a new subplaybook to display information about risky assets when such data is retrieved from the entity enrichment playbook.
##### New: Cortex XDR - Display Risky Assets

- New: This playbooks displays risky users and risky hosts, as detected by Cortex XDR's ITDR module. The data is displayed in incident fields in XDR incidents. (Available from Cortex XSOAR 6.5.0).
