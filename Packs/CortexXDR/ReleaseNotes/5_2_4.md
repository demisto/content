...
#### Mappers
##### XDR - Incoming Mapper
Added support for **Cortex XDR - Lite** incident type.

#### Integrations
##### Palo Alto Networks Cortex XDR - Investigation and Response
- Updated the default value for classifier and incident type to `Cortex XDR - Lite`.
- Updated the Docker image to: *demisto/python3:3.10.13.78960*.


#### Scripts
##### New: InvestigationVerdict
New: This widget displays the Verdict.
