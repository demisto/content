...
3. Click **Add instance** to create and configure a new integration instance.
    ...
    | API Key |  | True |
    | Optional - Tenant ID | Restrict incidents and alerts to a single tenant | False |
    | Incidents or Cases |  | True |
...
| stellar_incident_tags_add | Tags to add to incident in Stellar Cyber. | Optional | 
| stellar_incident_tags_remove | Tags to remove from incident in Stellar Cyber. | Optional | 
