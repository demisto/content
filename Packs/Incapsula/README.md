...
To setup real-time SIEM log integration via AWS S3 push, follow the **Set up log integration** [process](https://docs.imperva.com/bundle/cloud-application-security/page/settings/log-integration.htm).
