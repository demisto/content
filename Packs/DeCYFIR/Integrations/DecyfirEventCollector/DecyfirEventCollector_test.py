...
from DecyfirEventCollector import get_timestamp_from_datetime
...
def test_get_timestamp_from_datetime():
    ...
    When:
    - running get_timestamp_from_datetime

    Then:
    - the result is the correct Unix timestamp in milliseconds
    """
    dt = datetime(2025, 6, 8, 8, 37, 39, tzinfo=timezone.utc)
    expected_timestamp = 1749371859000
    result = get_timestamp_from_datetime(dt)
