...
get_hunt_request_hr = (
    "| 317440 | PE32 | 2018/01/24 | malware | 345ade2a73ee83e4f75447a26c4e78c9 | "
...
get_exact_search_request_hr = "| 1080320 | PE32 | 07c95170772e76b7e8d87f5b3535fb3a65a57a468cf9b0a42664fcd3813d21cd |"

get_request_status_inprogress_raw = {
    "meta": {"query_time": 0.1, "powered_by": "malquery-api", "trace_id": "def-456", "reqid": "abc-123", "status": "inprogress"},
    "resources": [],
}
get_request_status_inprogress_outputs = {"Request_ID": "abc-123", "Status": "inprogress"}
get_request_status_inprogress_hr = "abc-123"

client = Client(base_url="base_url", verify=False, client_id="client_id", client_secret="client_secret", proxy=False)
...
def test_exact_search_command_(mocker):
    ...
    assert result.outputs == {"Request_ID": "ac1403c0-d095-4934-5bd2-4cd45f365a45"}
...
def test_fuzzy_search_command(mocker):
    ...
    expected_context = [
        {"sha256": "e51f0a8884eb08fc43da0501ebd3776831e2fd4b0a8dd12e69866a8febe41495", "filesize": 310552, "filetype": "PE32"},
        {"sha256": "bc74f8fc37b902536b52c1157b74724edc96a586b0e3e38717dd845981443a5b", "filesize": 1672180, "filetype": "PE32"},
        {"sha256": "72b021085f62e5dc1335f878a2751bce68d95918c84215ec8dfebf491009ea09", "filesize": 1672188, "filetype": "PE32"},
        {"sha256": "5e2e1735e10684b36d30b3a3362e66cd30fb493afac8e711d92bde8372b9b6d0", "filesize": 279624, "filetype": "PE32"},
        {"sha256": "ec0d93607d777c6e3db8e98856e1b58ea8918f45b98ae601bc3f6af91fae9ec0", "filesize": 287304, "filetype": "PE32"},
        {"sha256": "c392794b98f5a1180d6f6f4abe94a5f9d9ba09cb5e25de7e6736ded4e6c9e12d", "filesize": 1661440, "filetype": "PE32"},
        {"sha256": "31c490852525bbe37ad536c153df05e1353e64c9a4bdb08505493c413db28368", "filesize": 276040, "filetype": "PE32"},
        {"sha256": "0142d5e2b43b5e1ae66c0724959b3ccc7c9022160231c9ef6fa5e571b2edc8dc", "filesize": 272384, "filetype": "PE32"},
        {"sha256": "d5023cd464d7578506770338e0fc43bd64887dbf234785b4d8f8547e57efa33d", "filesize": 19055104, "filetype": "PE32"},
        {"sha256": "9dd98c144cb29cf3ab6dfa26514b8d10ed414e32a66dd4777eae5f03c502197c", "filesize": 2673152, "filetype": "PE32"},
    ]
    assert "|filesize|filetype|sha256|" in result.readable_output
    assert "| 2673152 | PE32 | 9dd98c144cb29cf3ab6dfa26514b8d10ed414e32a66dd4777eae5f03c502197c |" in result.readable_output
...
def test_hunt_command(mocker):
    ...
    assert result.outputs == {"Request_ID": "096f6aa5-f245-4b09-790f-133bc89d4d26"}
...
@pytest.mark.parametrize(
    ...
    [
        (
            "096f6aa5-f245-4b09-790f-133bc89d4d26",
            util_load_json("test_data/get_hunt_request.json"),
            get_hunt_request_outputs,
            get_hunt_request_hr,
        ),
        (
            "fc4db762-288c-40cc-5f4f-4f19b65649a",
            util_load_json("test_data/get_exact_search_request.json"),
            get_exact_search_request_outputs,
            get_exact_search_request_hr,
        ),
        ("abc-123", get_request_status_inprogress_raw, get_request_status_inprogress_outputs, get_request_status_inprogress_hr),
    ],
)
...
def test_get_file_metadata_command(mocker):
    ...
    hr = (
        "| Arcyess | 484872 | PE32 | 2014/05/09 | malware | 43c596cabeb4c1d335ce53c3c7c4c392 | "
        "b32c34ab09e8c20e1ed93a72bcc5424a982d3042 | accc6794951290467e01b7676e8b4ba177076d54f836589ea7d3298cdf6fc995 |"
    )
    outputs = [
        {
            "sha256": "accc6794951290467e01b7676e8b4ba177076d54f836589ea7d3298cdf6fc995",
            "sha1": "b32c34ab09e8c20e1ed93a72bcc5424a982d3042",
            "md5": "43c596cabeb4c1d335ce53c3c7c4c392",
            "filesize": 484872,
            "label": "malware",
            "family": "Arcyess",
            "first_seen": "2014/05/09",
            "filetype": "PE32",
        }
    ]
    mocker.patch.object(client, "get_files_metadata", return_value=util_load_json("test_data/get_metadata_raw_response.json"))
    result = get_file_metadata_command(client, {"file": "accc6794951290467e01b7676e8b4ba177076d54f836589ea7d3298cdf6fc995"})
...
def test_samples_multidownload_command(mocker):
    ...
    mocker.patch.object(client, "samples_multidownload", return_value=util_load_json("test_data/multidownload_raw_response.json"))
    ...
    assert result.outputs == {"Request_ID": "93b55373-3b69-43cb-6ea1-2870a44e1c1e"}
...
def test_get_ratelimit_command(mocker):
    ...
    expected_hr = "|hunt_count|download_count|monitor_count|hunt_limit|download_limit|monitor_limit|refresh_time|days_left|"
    expected_outputs = {
        "hunt_count": 45,
        "download_count": 48,
        "monitor_count": 0,
