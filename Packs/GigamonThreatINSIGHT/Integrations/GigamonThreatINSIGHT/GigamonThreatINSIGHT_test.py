...
def test_test_module(requests_mock):
    ...
    mock_response = {"result_count": 10, "sensors": []}
...
def test_resolve_detection(requests_mock):
    ...
    response: CommandResults = commandResolveDetection(
        client,
        {"detection_uuid": detection_uuid, "resolution": "true_positive_mitigated", "resolution_comment": "resolution_comment"},
    )
