...
## Configure Akamai WAF_Dev on Cortex XSOAR

1. Navigate to **Settings** > **Integrations** > **Servers & Services**.
2. Search for Akamai WAF_Dev.
...
There is no context output for this command.
### akamai-get-papi-property-byname

***
get papi property info without default rule. to get default rule, please use "get-papi-property-rule" command.
...
There is no context output for this command.
### akamai-list-papi-property-bygroup
...
There is no context output for this command.
### akamai-new-papi-proerty-version
...
There is no context output for this command.
### akamai-list-papi-proerty-activations
...
There is no context output for this command.
### akamai-list-papi-property-by-hostname-command
