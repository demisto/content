...
- Improved performance significantly, especially for environmenets with large amounts of incidents, by reducing the time spent in a locked state in each phishing incident.
