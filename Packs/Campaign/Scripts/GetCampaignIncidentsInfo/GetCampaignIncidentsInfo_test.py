...
def test_update_incident_with_required_keys(mocker):
    ...
    incident_1 = {
        ...
        "id": "1",
        "name": "Campaign Test",
        "occurred": "2023-06-21T13:18:38.056972974Z",
        "recipients": [],
        "recipientsdomain": [],
        "severity": 0,
        "similarity": 1,
    ...
    incident_1_correct_format = (
        '[{"emailfrom": "","emailfromdomain": "","id": "1", "name": "Campaign Test",'
    ...
    mocker.patch(
        ...
        side_effect=([{"Contents": "[Test]"}], [{"Contents": "[]"}], [{"Type": "Test", "Contents": incident_1_correct_format}]),
    )
