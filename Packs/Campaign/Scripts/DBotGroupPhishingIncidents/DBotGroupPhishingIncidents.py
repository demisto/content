...
model_name = 'phishing_clustering'
field_for_grouping = 'emailsubject,emailbody,emailbodyhtml'
field_for_name = 'emailsubject'
...
if return_type == 'incidents':
    ...
    res = demisto.executeCommand('DBotTrainClustering', {
        ...
        'minNumberofIncidentPerCluster': demisto.args().get('minNumberofIncidentPerCluster', 4),
        'analyzer': 'word'
    })
