...
INTEGRATION_COMMANDS = [
    {"name": "SendMailIntegration", "commands": [{"name": "send-mail"}, {"name": "some-command"}]},
...
INTEGRATION_INSTANCES = [
    {"name": "SendMailIntegration_instance1", "brand": "SendMailIntegration", "enabled": "true"},
    {"name": "SendMailIntegration_instance2", "brand": "SendMailIntegration", "enabled": "true"},
    {"name": "SendMailIntegration_instance3", "brand": "SendMailIntegration", "enabled": "false"},
    {"name": "NoMailIntegration_instance1", "brand": "NoMailIntegration", "enabled": "true"},
    {"name": "NoMailIntegration_instance2", "brand": "NoMailIntegration", "enabled": "false"},
    {"name": "SomeIntegration_instance1", "brand": "SomeIntegration", "enabled": "false"},
]
