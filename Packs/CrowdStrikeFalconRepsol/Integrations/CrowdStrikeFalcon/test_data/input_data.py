...
response_incident = {
    ...
    "host_ids": ["afb5d1512a00480f53e9ad91dc3e4b55"],
    "hosts": [
        {
...
response_detection = {
    ...
    "behaviors_processed": ["pid:15dbb9d8f06b45fe9f61eb46e829d986:1560553487562:10194"],
    "date_updated": "2021-12-19T13:53:34.708949512Z",
}

response_idp_detection = {
    "added_privileges": ["AdministratorsRole"],
...
check_reopen_set_xsoar_detections_entries_args = [
    detection_new_status,
    detection_in_progress_status,
    detection_reopened_status,
    detection_true_positive_status,
    detection_false_positive_status,
...
set_xsoar_idp_or_mobile_detection_entries = [
    idp_mobile_detection_new_status,
    idp_mobile_detection_in_progress_status,
    idp_mobile_detection_reopened_status,
    idp_mobile_detection_closed_status,
]

# updated_object, entry_content, close_incident
detection_closes = ({"status": "closed"}, "dbotIncidentClose", True)
detection_reopens = ({"status": "reopened"}, "dbotIncidentReopen", True)
detection_reopens_other_status = ({"status": "true_positive"}, "dbotIncidentReopen", True)
detection_not_closed = ({"status": "in_progress"}, None, False)
detection_no_status = ({}, None, True)

set_xsoar_detection_entries_args = [
    detection_closes,
    detection_reopens,
...
field_nested_in_dict = (
    {},
    response_detection,
    ["behaviors.tactic", "behaviors.scenario", "behaviors.objective", "behaviors.technique"],
    {
        "behaviors.objective": "Falcon Detection Method",
        "behaviors.scenario": "suspicious_activity",
        "behaviors.tactic": "Malware",
...
set_updated_object_args = [
    keeping_updated_object,
    keeping_empty_updated_object,
    no_nested_fields,
    fields_not_existing,
    field_nested_dict_in_list,
...
delta_not_closed = ({"status": "new"}, True, False)
no_close = ({}, False, False)

close_in_cs_falcon_args = [
    delta_closed,
    param_no_close,
    delta_not_closed,
    no_close,
...
update_remote_detection_args = [
    detection_closed_in_xsoar,
