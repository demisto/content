EXPECTED_CREATE_REQUEST = {
    "ServiceDeskPlus(val.ID===obj.ID)": {
        "Request": {
            ...
            "Mode": {"name": "E-Mail", "id": "123640000000006665"},
            "IsRead": False,
            "CancellationRequested": False,
            "IsTrashed": False,
            "Id": "123456789",
            "Group": {"site": None, "deleted": False, "name": "Network", "id": "123640000000006681"},
            "Requester": {
                "email_id": None,
                "is_technician": False,
                "sms_mail": None,
            ...
            "Level": {"name": "Tier 1", "id": "123640000000006671"},
            "Impact": {"name": "Affects Group", "id": "123640000000008036"},
            "Priority": {"color": "#ff0000", "name": "High", "id": "123640000000006805"},
            "CreatedBy": {
            ...
            "HasNotes": False,
            "Status": "On Hold",
            "Template": {"name": "Default Request", "id": "123640000000006655"},
            "RequestType": {"name": "Incident", "id": "123640000000008391"},
            "DisplayId": "102",
            "TimeElapsed": "0",
            "Description": "The description of the request",
            "IsServiceRequest": False,
            "Urgency": {"name": "Normal", "id": "123640000000007921"},
...
EXPECTED_UPDATE_REQUEST = {
    "ServiceDeskPlus(val.ID===obj.ID)": {
        "Request": {
            ...
            "CreatedTime": "2020-06-24T12:05:00.000Z",
            "Level": {"name": "Tier 1", "id": "123640000000006671"},
            "Impact": {"name": "Affects Business", "id": "123640000000008033"},
            "Priority": {"color": "#ff0000", "name": "High", "id": "123640000000006805"},
            "CreatedBy": {
                "email_id": "email@address.com",
                "is_technician": True,
