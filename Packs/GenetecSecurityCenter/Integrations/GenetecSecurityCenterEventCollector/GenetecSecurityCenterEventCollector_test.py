...
@pytest.mark.parametrize(
    "first_iteration_response, second_iteration_response, expected_events_len_first_call,"
    ...
    [
        (
            ...
            [INCIDENT_NO_TWO, INCIDENT_NO_THREE, INCIDENT_NO_FOUR],
            2,
            1,
