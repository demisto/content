...
<p class="wysiwyg-indent4">This may indicate that a large amount of data returned from Arcsight Logger. To resolve this error, try to limit the search time range or the events list length.  See additional ways to set the search time range in ‘Additional info’ above.<br><strong>DBot error snap-shot<br></strong> ../../doc_files/ArcsightLogger_mceclip0.png"/n><strong><br></strong></p>
...
<p class="wysiwyg-indent4"> <strong>DBot error snap-shot<br></strong> ../../doc_files/ArcsightLogger_mceclip1.png"/n><strong><br></strong></p>
<p> </p>
<ul>
...
<p class="wysiwyg-indent4">../../doc_files/ArcsightLogger_mceclip2.png"/n></p>
