from RiskIQPassiveTotalSSLForIssuerEmailWidgetScript import set_arguments_for_widget_view


def test_for_ssl_for_issuer_email_widget_set_arguments_when_indicator_type_riskiqasset_and_riskiqassettype_is_empty():
    # Configure
...
def test_for_ssl_for_issuer_email_widget_set_arguments_when_indicator_type_riskiqasset_and_riskiqassettype_contact():
    # Configure

    # set argument for command
    indicator_data = {"indicator_type": "RiskIQAsset", "value": "dummy email", "CustomFields": {"riskiqassettype": "Contact"}}
    # set expected output
    expected_arguments = {"field": "issuerEmailAddress", "query": "dummy email"}
    # Execute
    arguments = set_arguments_for_widget_view(indicator_data)
    # Assert
...
def test_for_ssl_for_issuer_email_widget_set_arguments_when_indicator_type_riskiqasset():
    # Configure
...
def test_for_ssl_for_issuer_email_widget_set_arguments_when_indicator_type_email():
    # Configure

    # set argument for command
    indicator_data = {"indicator_type": "Email", "value": "dummy email"}
    # set expected output
    expected_arguments = {"field": "issuerEmailAddress", "query": "dummy email"}
    # Execute
    arguments = set_arguments_for_widget_view(indicator_data)
