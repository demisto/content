...
def test_for_host_pairs_children_widget_set_arguments_when_indicator_type_riskiqasset_and_riskiqassettype_domain():
    # Configure

    # set argument for command
    indicator_data = {"indicator_type": "RiskIQAsset", "value": "dummy domain", "CustomFields": {"riskiqassettype": "Domain"}}
    # set expected output
    expected_arguments = {"direction": "children", "query": "dummy domain"}
    # Execute
    arguments = set_arguments_for_widget_view(indicator_data)
    # Assert
...
def test_for_host_pairs_children_widget_set_arguments_when_indicator_type_riskiqasset_and_riskiqassettype_contact():
    # Configure
    ...
    # set expected output
    expected_arguments = {"direction": "children", "query": "dummy ip address"}
    # Execute
    arguments = set_arguments_for_widget_view(indicator_data)
    # Assert
    assert expected_arguments == arguments
...
def test_for_host_pairs_children_widget_set_arguments_when_indicator_type_riskiqasset():
    # Configure
...
def test_for_host_pairs_children_widget_set_arguments_for_widget_view_when_indicator_type_domain():
    # Configure
