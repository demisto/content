...
list_asi_assets_invalid_args = [
    ...
    ({"id": "100", "segment_by": "100", "page_size": 12345678901234}, MESSAGES["INVALID_PAGE_SIZE"].format(12345678901234)),
    ({"id": "100", "segment_by": "100", "page_number": -1}, MESSAGES["INVALID_PAGE_NUMBER"].format(-1)),
    ({"id": "100", "segment_by": "100", "page_number": 12345678901234}, MESSAGES["INVALID_PAGE_NUMBER"].format(12345678901234)),
]
...
list_asi_observation_invalid_args = [
    ...
    ({"cve_id": "CVE-123", "page_size": 12345678901234}, MESSAGES["INVALID_PAGE_SIZE"].format(12345678901234)),
    ({"cve_id": "CVE-123", "page_number": -1}, MESSAGES["INVALID_PAGE_NUMBER"].format(-1)),
    ({"cve_id": "CVE-123", "page_number": 12345678901234}, MESSAGES["INVALID_PAGE_NUMBER"].format(12345678901234)),
]
list_third_party_asi_assets_invalid_args = [
    ...
    ({"vendor_id": "123", "id": "100", "segment_by": "100", "page_number": -1}, MESSAGES["INVALID_PAGE_NUMBER"].format(-1)),
    (
...
list_third_party_asi_observation_invalid_args = [
    ...
    ({"id": 45998, "cve_id": "CVE-123", "page_size": 12345678901234}, MESSAGES["INVALID_PAGE_SIZE"].format(12345678901234)),
    ({"id": 45998, "cve_id": "CVE-123", "page_number": -1}, MESSAGES["INVALID_PAGE_NUMBER"].format(-1)),
    ({"id": 45998, "cve_id": "CVE-123", "page_number": 12345678901234}, MESSAGES["INVALID_PAGE_NUMBER"].format(12345678901234)),
]
