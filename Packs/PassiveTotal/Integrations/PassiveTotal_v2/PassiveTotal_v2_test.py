...
def test_pt_whois_search_command_success(request_mocker, mock_cr, client):
    ...
    with open(os.path.dirname(__file__) + 'test_data/whois_command/whois_command_readable_output.md') as f:
        dummy_readable_output = f.read()
    with open(os.path.dirname(__file__) + 'test_data/whois_command/whois_command_standard_domain_readable_output.md') as f:
...
def test_get_services_command_success(request_mocker, client):
    ...
    with open(os.path.dirname(__file__) + 'test_data/services_command/services_command_readable_output.md') as f:
...
def test_pt_get_articles_command_success(request_mocker, client):
    ...
    with open(os.path.dirname(__file__) + 'test_data/Articles/articles_command_response.json') as f:
        dummy_response = json.load(f)
    with open(os.path.dirname(__file__) + 'test_data/Articles/articles_custom_context.json') as f:
        dummy_custom_context = json.load(f)
    with open(os.path.dirname(__file__) + 'test_data/Articles/articles_command_readable_output.md') as f:
        dummy_readable_output = f.read()
    request_mocker.return_value = dummy_response
...
def test_get_data_card_command_success(request_mocker, client):
    ...
    with open(os.path.dirname(__file__) + 'test_data/Data_Card/data_card_command_readable_output.md') as f:
        readable_output = f.read()
...
def test_get_reputation_command_success(request_mocker, client):
    ...
    with open(os.path.dirname(__file__) + 'test_data/Reputation/reputation_command_readable_output.md') as f:
        readable_output = f.read()

    with open(os.path.dirname(__file__) + 'test_data/Reputation/reputation_command_context.json') as f:
        dummy_custom_context = json.load(f)
...
def test_ip_reputation_command_success(request_mocker, client):
    ...
    with open(os.path.dirname(__file__) + 'test_data/ip_reputation/ip_reputation_command_response.json', 'rb') as f:
        dummy_response = json.load(f)
    with open(os.path.dirname(__file__) + 'test_data/ip_reputation/ip_reputation_command_context.json') as f:
        dummy_custom_context = json.load(f)
    with open(os.path.dirname(__file__) + 'test_data/ip_reputation/ip_reputation_command_readable_output.md') as f:
        readable_output = f.read()
...
def test_pt_list_intel_profile_command_success(request_mocker, client):
    ...
    with open(os.path.dirname(__file__) + 'test_data/IntelProfile/intel_profile_command_response.json') as f:
        dummy_response = json.load(f)

    with open(os.path.dirname(__file__) + 'test_data/IntelProfile/intel_profile_command_context.json') as f:
        dummy_custom_context = json.load(f)

    with open(os.path.dirname(__file__) + 'test_data/IntelProfile/intel_profile_command_readable_output.md') as f:
        dummy_readable_output = f.read()
...
def test_list_intel_profile_indicators_command_success(request_mocker, client):
    ...
    with open(os.path.dirname(__file__) + 'test_data/Intel_Profile_Indicator/intel_profile_indicator_readable_output.md') as f:
        readable_output = f.read()
...
def test_pt_list_my_asi_insights_command_success(request_mocker, client):
    ...
    with open(os.path.dirname(__file__) + 'test_data/ASI_Insights/asi_insights_command_response.json') as f:
        dummy_response = json.load(f)

    with open(os.path.dirname(__file__) + 'test_data/ASI_Insights/asi_insights_command_context.json') as f:
        dummy_custom_context = json.load(f)

    with open(os.path.dirname(__file__) + 'test_data/ASI_Insights/asi_insights_command_readable_output.md') as f:
        dummy_readable_output = f.read()
...
def test_pt_list_my_asi_insights_command_key_not_present(request_mocker, client):
    ...
    with open(os.path.dirname(__file__) + 'test_data/ASI_Insights/asi_insights_command_key_not_present_response.json') as f:
        dummy_response = json.load(f)

    with open(os.path.dirname(__file__) + 'test_data/ASI_Insights/asi_insights_command_key_not_present_context.json') as f:
        dummy_custom_context = json.load(f)

    with open(os.path.dirname(__file__) + 'test_data/ASI_Insights/asi_insights_command_key_not_present_readable_output.md') as f:
        dummy_readable_output = f.read()
...
def test_list_my_attack_surfaces_command_success(request_mocker, client):
    ...
    with open(os.path.dirname(__file__) + 'test_data/Attack_Surface/attack_surface_readable_output.md') as f:
        readable_output = f.read()
...
def test_list_my_asi_assets_command_success(request_mocker, client):
    ...
    with open(os.path.dirname(__file__) + 'test_data/ASI_Assets/asi_assets_command_readable_output.md') as f:
        readable_output = f.read()
...
def test_list_third_party_asi_insights_command_success(request_mocker, client):
    ...
    with open(os.path.dirname(__file__) + 'test_data/ASI_Insights/third_party_asi_insights_command_context.json') as f:
        dummy_custom_context = json.load(f)
...
def test_list_third_party_asi_insights_command_key_not_present(request_mocker, client):
    ...
    with open(os.path.dirname(__file__) + 'test_data/ASI_Insights/third_party_asi_insights_key_not_present_context.json') as f:
        dummy_custom_context = json.load(f)
...
def test_pt_list_my_asi_insights_command_sorted_hr(request_mocker, client):
    ...
    with open(os.path.dirname(__file__) + 'test_data/ASI_Insights/asi_insights_command_sorted_hr_response.json') as f:
        dummy_response = json.load(f)

    with open(os.path.dirname(__file__) + 'test_data/ASI_Insights/asi_insights_command_sorted_readable_output.md') as f:
        dummy_readable_output = f.read()
