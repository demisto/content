...
#### Layouts
- **PassiveTotal Domain Indicator**- Layout for PassiveTotal Domain Indicator
- **PassiveTotal Email Indicator**- Layout for PassiveTotal Email Indicator
- **PassiveTotal File SHA-1 Indicator**- Layout for PassiveTotal File Indicator
- **PassiveTotal IP Indicator**- Layout for PassiveTotal IP Indicator
- **RiskIQSerialNumber Indicator**- Layout for PassiveTotal Serial Number Indicator
