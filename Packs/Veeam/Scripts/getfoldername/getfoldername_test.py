...
@pytest.mark.parametrize(
    ...
    [
        (
            [{"urn": "folder:123;folder:group-v456"}, {"urn": "folder:789"}, {"urn": "folder:group-v987;folder:group-v654"}],
            "group-v456",
        ),
        ([{"urn": "host:123"}, {"urn": "host:789"}], ""),
        ([{"urn": "folder:group-v456"}], "group-v456"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            "group-v456",
            {"outputs_prefix": "Veeam.FOLDER", "outputs": {"parsed_value": "group-v456"}},
        )
    ],
)
