...
In order to view sample events, enable events storage by selecting the checkbox of the integration parameter __Store sample events for mapping__.
...
After you finish mapping, it is recommended to turn off the __Store sample events for mapping__ to reduce performance overhead.
