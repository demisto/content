...
We use basic authentication to communicate with the product. Supply your username and password of the account that you want to use.
...
1. Run the **!ksm-event-collector-register-start** command.
...
3. Run the **!ksm-event-collector-register-complete** command with the acquired authorization code. If the account already has a registered device, run the command without supplying any arguments.
4. Run the command **!ksm-event-collector-register-test** to test that everything is working fine.
