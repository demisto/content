...
def handle_cve_5_1(cve: dict) -> dict:
    ...
    legacy = {
        ...
        "summary": next((d.get("value") for d in cna.get("descriptions", []) if d.get("lang") == "en"), ""),
        "cvss": None,
        "cvss-vector": "",
