...
##### With the DomainTools Iris App for Cortex XSOAR, the Iris dataset is available not only for ad-hoc War-Room investigations on spcific incidents, but also for automated actions.Organizations will be able to fetch a complete Iris profile for a domain name including:
