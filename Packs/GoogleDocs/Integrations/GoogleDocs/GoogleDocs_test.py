...
def test_create_document_command(mocker):
    ...
    args = {'title': 'test'}
    excepted_result = {
        'human_readable': "### The document with the title test was created. The results are:\n|DocumentId|RevisionId|Title|\n|---|---|---|\n| 123 | 456 | 'test' |\n"}
    mocker.patch.object(demisto, 'args', return_value=args)
...
def test_get_document_command(mocker):
    ...
    excepted_result = {
        'human_readable': "### The document with the title 'test' was returned. The results are:\n|DocumentId|RevisionId|Title|\n|---|---|---|\n| 123 | 456 | 'test' |\n"}
    mocker.patch.object(demisto, 'args', return_value=args)
