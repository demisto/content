...
DBOT_TYPE_MAP = {"ip": DBotScoreType.IP, "email": DBotScoreType.EMAIL}
...
class Client(BaseClient):
    ...
    def __init__(self, base_url, verify=True, proxy=False, **kwargs):
        ...
        self._headers = {"User-Agent": USER_AGENT, "x-api-key": kwargs.get("token")}

    def search(self, params: dict) -> dict[str, Any]:
        return self._http_request(method="GET", params=params, backoff_factor=0.5, retries=5)
...
def main() -> None:
    ...
    client_args = {"token": params.get("token")}
