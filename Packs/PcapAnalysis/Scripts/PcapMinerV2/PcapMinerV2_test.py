...
def test_heirarchy_to_md():
    test_heirarchy = {"First Layer": 50, "Second Layer": 50, "Third Layer": 50, "Fourth Layer": 50}
    from PcapMinerV2 import hierarchy_to_md

    assert (
        hierarchy_to_md(test_heirarchy) == "|Layer| # of Packets|% of Packets|\n|---|----|---|\n"
...
def test_conversations_to_md():
    converstation_test = {("1.1.1.1", "2.2.2.2"): 15, ("1.1.1.3", "2.2.2.2"): 15, ("1.1.1.3", "8.8.8.8"): 15}
    from PcapMinerV2 import conversations_to_md

    assert (
        conversations_to_md(converstation_test, 4) == "|A|B|# of Packets|\n|---|---|---|\n|1.1.1.1|2.2.2.2|15|\n"
        "|1.1.1.3|2.2.2.2|15|\n|1.1.1.3|8.8.8.8|15|\n"
    )
...
args_to_test = [
    ...
    (
        {2: {"ID": 2, "Input": "wow"}},
        {"ID": 2, "Input": "amazing", "new_key": "new"},
        None,
        {2: {"ID": 2, "Input": "amazing", "new_key": "new"}},
    ),  # Test that ID changed and new added
    (
        {2: {"ID": 2, "Input": "wow"}},
        {"ID": 2, "Input": "amazing", "new_key": "new"},
        10,
        {10: {"ID": 2, "Input": "amazing", "new_key": "new"}},
    ),  # Test that ID changed and new added and future_id added
