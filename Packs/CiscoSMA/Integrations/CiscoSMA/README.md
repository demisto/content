...
## Configure Cisco SMA on Cortex XSOAR

1. Navigate to **Settings** > **Integrations** > **Servers & Services**.
2. Search for Cisco SMA.
3. Click **Add instance** to create and configure a new integration instance.

    | **Parameter** | **Description** | **Required** |
    | --- | --- | --- |
    | Server URL | Base URL Example: https://dhXXXX-sma1.eu.iphmx.com/ | True |
    | Username |  | True |
    | Password |  | True |
...
| **Argument Name** | **Description** | **Required** |
| --- | --- | --- |
| message_ids | Comma separated message ids. | Required |
...
>|---|---|---|---|---|---|---|---|---|---|
>| 433 | 13538 | 423ADC9EBD9C5F1A7A64-B81D2582608C | t1@test.com | test@test.com | test 2 | 433: Quarantined by Anti-Spam/Graymail | 2022-09-11T07:55:25Z | 6.6.6.6 | 3.5 |
>| 431 | 13536 | 423ADC9EBD9C5F1A7A64-B81D2582608C | t1@test.com | test@test.com | test1 | 431: Quarantined by Anti-Spam/Graymail | 2022-09-11T07:55:15Z | 6.6.6.6 | 3.5 |
...
| CiscoSMA.Message.attachments | String | Message attachements. |
| CiscoSMA.Message.hostName | String | Email Gateway Hostname. |
| CiscoSMA.Message.direction | String | Message direction, incoming or outgoing. |
...
| CiscoSMA.Message.showSummaryTimeBox | Boolean | Is show summary timebox. |
...
| CiscoSMA.Message.showDLP | Boolean | Is DLP report available boolean. |
...
| CiscoSMA.Message.showURL | Boolean | Is URL report available boolean. |
...
| CiscoSMA.Message.showAMP | Boolean | Is AMP report available boolean. |
...
| CiscoSMA.Message.summary.lastEvent | Boolean | Event summary is last event boolean. |
| CiscoSMA.Message.allIcid | Number | ICIDs list. |
    ...
    "CiscoSMA": {
        "Message": {
            ...
            "summary": [
                ...
                {
                    "description": "SMTP delivery connection (DCID 4368) opened from Cisco IronPort interface 2.2.2.2 to IP address 66.66.66.66 on port 25.",
                    "lastEvent": false,
                    "timestamp": "2022-09-07T10:11:19Z"
                },
                {
...
>| SMTP delivery connection (DCID 4368) opened from Cisco IronPort interface 2.2.2.2 to IP address 66.66.66.66 on port 25. | 2022-09-07T10:11:19Z | false |
...
| CiscoSMA.AMPDetail.attachments | String | Message attachements. |
...
| CiscoSMA.AMPDetail.showAMPDetails | Boolean | Is show AMP details. |
...
| CiscoSMA.DLPDetail.attachments | String | Message attachements. |
...
| CiscoSMA.URLDetail.attachments | String | Message attachements. |
| CiscoSMA.URLDetail.showURLDetails | Boolean | Is show URL event details. |
    ...
    "CiscoSMA": {
        "URLDetail": {
            ...
            "urlDetails": [
                ...
                {
                    "description": "Message 21 URL: https://sunvn.net/x1OrRZcf/onIpchhYNy4wy9f4/ , URL reputation: -6.6, Condition: URL Reputation Rule.",
                    "timestamp": "2022-08-24T10:05:56Z"
                },
                {
                    "description": "Message 21 URL: http://9.9.9.9:8080 , URL reputation: -6.8, Condition: URL Reputation Rule.",
...
>| Message 21 URL: https:<span>//</span>sunvn.net/x1OrRZcf/onIpchhYNy4wy9f4/ , URL reputation: -6.6, Condition: URL Reputation Rule. | 2022-08-24T10:05:56Z |
>| Message 21 URL: http:<span>//</span>9.9.9.9:8080 , URL reputation: -6.8, Condition: URL Reputation Rule. | 2022-08-24T10:05:56Z |
...
please refer to the following link ("ESA Reporting" section in the file) in order to view the dedicated arguments for each report type.
