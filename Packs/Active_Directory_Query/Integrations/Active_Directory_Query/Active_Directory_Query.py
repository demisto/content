...
from ldap3 import (ALL, ALL_ATTRIBUTES, NTLM, SUBTREE, Connection, Entry,
                   ObjectDef, Reader, Server, Tls)
...
def test_credentials():
    ...
    result = CommandResults(
        outputs_prefix='Credentials',
        outputs_key_field='username',
        outputs=username,
        readable_output=tableToMarkdown("Credentials", username, headers="username"))
