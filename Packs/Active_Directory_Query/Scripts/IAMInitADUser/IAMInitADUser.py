...
def send_email(username: str, user_email: str, incident_id: str, email_recipient: str,
               email_subject: str, email_body: str, display_name: str | None = None, error_message: str | None = None,
