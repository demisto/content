...
BO_SUMMARY_RES = {"firstRecIdField": "fa03d51b709e4a6eb2d52885b2ef7e04", "groupSummaries": [],
                  ...
                  "busObId": "6dd53665c0c24cab86870a21cf6434ae", "displayName": "Incident", "group": False,
                  "lookup": False,
                  "major": False, "name": "Incident", "supporting": False}

ONE_STEP_ACTIONS_RES = {
    "root": {
        "childFolders": [{"name": "Config Item Tasks", "childItems": [
...
ONE_STEP_ACTIONS_OUTPUTS = {"BusinessObjectId": "6dd53665", "Actions": {"Config Item Tasks": [
    {"description": "Launches Skype to contact the Customer.", "displayName": "Call Contact",
     "id": "9389e70ed88b993cff6c66", "name": "Call Contact", "association": "6dd536621cf6434ae",
     "standInKey": "DefType:OneStepDef#Scope:Global#Id:9389e70ed88b73a6b1393434ae"}], "Buttons": [
    {"description": "Abandons the incident and opens the default dashboard", "displayName": "Cancel Incident",
     "id": "944414556c072e6e430", "name": "Cancel Incident", "association": "6dd53665ccf6434ae",
     "standInKey": "DefType:OneStepDef#Scope:Global#Id:944434ae"}]}}
