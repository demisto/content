...
This pack includes Cortex XSIAM parsing and modeling rules (XDM schema) for Synopsys Coverity enhanced usage logging.
...
The dataset name will be `synopsys_coverity_raw`
