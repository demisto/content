...
ALL_INSTANCES = {
    "Cortex Data Lake_instance_1": {
        "brand": "Cortex Data Lake",
        "category": "Analytics & SIEM",
        "defaultIgnored": "false",
        "state": "active",
    },
    "CustomScripts": {"brand": "Scripts", "category": "automation", "defaultIgnored": "false", "state": "active"},
    ...
    "InnerServicesModule": {"brand": "Builtin", "category": "Builtin", "defaultIgnored": "false", "state": "active"},
    "d2": {"brand": "d2", "category": "Endpoint", "defaultIgnored": "false", "state": "active"},
    "pan_os_fw_8.1_3000": {"brand": "Panorama", "category": "Network Security", "defaultIgnored": "false", "state": "disabled"},
    "pan_os_pano_8.1_8443": {"brand": "Panorama", "category": "Network Security", "defaultIgnored": "false", "state": "active"},
...
def test_get_firewall_serials(mocker):
    ...
    mocker.patch.object(
        ...
        return_value=[
            {
                "ModuleName": "pan_os_pano_8.1_8443",
                "Brand": "Panorama",
                                ...
                                "entry": [
                                    {
                                        ...
                                        "certificate-subject-name": "123456789012345",
                                        "family": "vm",
                                        "hostname": "PA-VM",
                                        "model": "PA-VM",
                                        "multi-vsys": "no",
                                    ...
                                    },
                                    {
                                        ...
                                        "certificate-subject-name": "123456789012346",
                                        "family": "vm",
                                        "hostname": "PA-VM",
                                        "model": "PA-VM",
                                        "multi-vsys": "no",
