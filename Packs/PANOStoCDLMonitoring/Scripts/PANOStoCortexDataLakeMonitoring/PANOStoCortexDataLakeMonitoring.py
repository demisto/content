...
def query_cdl(fw_monitor_list: list) -> CommandResults:
    ...
    all_results = [{"FirewallsWithLogsSent": firewalls_with_logs, "FirewallsWithoutLogsSent": firewalls_without_logs}]
...
def main():
    try:
        ...
        check_instance(all_instances, "Cortex Data Lake", "No active Cortex Data Lake integration found, please configure one.")
