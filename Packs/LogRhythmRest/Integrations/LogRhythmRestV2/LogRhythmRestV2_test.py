...
ALARMS_LIST = {
    "alarmsSearchDetails": [
        {"alarmId": 2, "alarmStatus": 1, "dateInserted": "2021-08-23T15:19:00"},
...
GENERATE_QUERY_TEST_DATA = [
    (23, 4, "host1", {"filterType": 23, "valueType": 4, "value": {"value": "host1", "matchType": 2}}),
        ...
        "filterGroup": {
            ...
            "filterItems": [
                ...
                },
                {
                    ...
                    "fieldOperator": 1,
                    "filterMode": 1,
                    "values": [{"filterType": 23, "valueType": 4, "value": {"value": "host1", "matchType": 2}}],
                },
                {
                    "filterItemType": 0,
                    "fieldOperator": 1,
...
def test_execute_search_query_request(requests_mock):
    ...
    CLIENT.execute_search_query_request(
        "4", "API_-_Box_Event", "host1", None, None, None, None, None, None, None, None, "127.0.0.1", "60", "60", None
    )
