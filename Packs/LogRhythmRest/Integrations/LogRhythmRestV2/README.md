...
| vendor_message_id | Vendor message ID in the log. | Optional | 
| status | Log status. | Optional | 
| result | Log result. | Optional | 
| classification | Log classification. | Optional | 
| destination_nat_ip | Destination NAT IP. | Optional | 
| nat_ip | NAT IP address of the endpoint. | Optional | 
| source_nat_ip | Source NAT IP. | Optional | 
