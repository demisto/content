...
def new_client():
    ...
    client = Client(
        ...
        verify=True,
        headers={"HOST": "test.com", "Authorization": "THISISAFAKEKEY", "Content-Type": "application/json"},
        proxy=False,
    )
...
def test_list_external_service_command(requests_mock):
    ...
    requests_mock.post("https://test.com/public_api/v1/assets/get_external_services/", json=EXTERNAL_SERVICES_RESPONSE)
...
def test_get_external_service_command(requests_mock):
    ...
    requests_mock.post("https://test.com/public_api/v1/assets/get_external_service", json=EXTERNAL_SERVICE_RESPONSE)
...
def test_list_external_ip_address_range_command(requests_mock):
    ...
    requests_mock.post("https://test.com/public_api/v1/assets/get_external_ip_address_ranges/", json=EXTERNAL_RANGES_RESPONSE)
...
def test_get_external_ip_address_range_command(requests_mock):
    ...
    requests_mock.post("https://test.com/public_api/v1/assets/get_external_ip_address_range/", json=EXTERNAL_RANGE_RESPONSE)
...
def test_list_asset_internet_exposure_command(requests_mock, args):
    ...
    requests_mock.post("https://test.com/public_api/v1/assets/get_assets_internet_exposure/", json=EXTERNAL_EXPOSURES_RESPONSE)
...
def test_get_asset_internet_exposure_command(requests_mock):
    ...
    requests_mock.post("https://test.com/public_api/v1/assets/get_asset_internet_exposure/", json=EXTERNAL_EXPOSURE_RESPONSE)
...
def test_list_alerts_command(requests_mock):
    ...
    requests_mock.post("https://test.com/public_api/v2/alerts/get_alerts_multi_events/", json=LIST_ALERTS_RESPONSE)
...
def test_list_attack_surface_rules_command(requests_mock):
    ...
    requests_mock.post("https://test.com/public_api/v1/get_attack_surface_rules/", json=ATTACK_SURFACE_RULES_RAW)

    client = new_client()
    args = {"enabled_status": "on", "severity": "high", "limit": 2}
...
def test_assign_tag_to_assets_command(requests_mock):
    ...
    requests_mock.post("https://test.com/public_api/v1/assets/tags/assets_internet_exposure/assign/", json=TAG_APPLY_RAW)

    client = new_client()
    args = {"asm_id_list": "11111111-1111-1111-1111-111111111111", "tags": "Test"}
...
def test_remove_tag_to_assets_command(requests_mock):
    ...
    requests_mock.post("https://test.com/public_api/v1/assets/tags/assets_internet_exposure/remove/", json=TAG_REMOVE_RAW)
...
def test_assign_tag_to_ranges_command(requests_mock):
    ...
    requests_mock.post("https://test.com/public_api/v1/assets/tags/external_ip_address_ranges/assign/", json=TAG_APPLY_RAW)

    client = new_client()
    args = {"range_id_list": "11111111-1111-1111-1111-111111111111", "tags": "Test"}
...
def test_remove_tag_to_ranges_command(requests_mock):
    ...
    requests_mock.post("https://test.com/public_api/v1/assets/tags/external_ip_address_ranges/remove/", json=TAG_REMOVE_RAW)
...
def test_list_incidents_command(requests_mock):
    ...
    requests_mock.post("https://test.com/public_api/v1/incidents/get_incidents/", json=LIST_INCIDENTS_RAW)
...
def test_get_incident_command(requests_mock):
    ...
    requests_mock.post("https://test.com/public_api/v1/incidents/get_incident_extra_data/", json=INCIDENT_GET_RAW)
...
def test_update_incident_command(requests_mock):
    ...
    requests_mock.post("https://test.com/public_api/v1/incidents/update_incident/", json=INCIDENT_UPDATE_RAW)
...
def test_update_alert_command(requests_mock):
    ...
    requests_mock.post("https://test.com/public_api/v1/alerts/update_alerts/", json=ALERT_UPDATE_RAW)

    client = new_client()
    args = {"alert_id_list": 602, "status": "new", "comment": "test updating"}
...
def test_successfully_add_note_to_asset_command(requests_mock):
    ...
    requests_mock.post("https://test.com/public_api/v1/assets/assets_internet_exposure/annotation", json=json_data)
...
def test_list_external_websites_command(requests_mock):
    ...
    requests_mock.post("https://test.com/public_api/v1/assets/get_external_websites/", json=EXTERNAL_WEBSITES_RESPONSE)

    client = new_client()

    args = {"authentication": "Form", "limit": 5}
...
def test_main_parameters(command_name, method_name, mocker):
    ...
    params = {
        ...
        "look_back": "5",
        "max_fetch": "10",
        "credentials": {"password": "api_key", "identifier": "auth_id"},
        "proxy": False,
        "insecure": False,
