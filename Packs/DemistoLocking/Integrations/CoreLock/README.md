<!-- HTML_DOC -->
<h2>Overview</h2>
<p>Core Lock is a mechanism that enables users to prevent concurrent execution of tasks. This is a native integration, which does not require configuration.</p>
<hr>
<h2>Commands</h2>
