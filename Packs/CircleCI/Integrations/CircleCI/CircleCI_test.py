...
from CircleCI import (
    DEFAULT_LIMIT_VALUE,
    Client,
    circleci_artifacts_list_command,
    circleci_workflow_jobs_list_command,
    circleci_workflow_last_runs_command,
    circleci_workflows_list_command,
)
...
GET_COMMON_ARGUMENTS_INPUTS = [
    ...
    (
        ...
        {"vcs_type": "x"},
        ("x", "b", "c", DEFAULT_LIMIT_VALUE),
    ),
    (
        Client("", "", False, False, vc_type="a", organization="b", project="c"),
        {"organization": "x"},
        ("a", "x", "c", DEFAULT_LIMIT_VALUE),
    ),
    (
        Client("", "", False, False, vc_type="a", organization="b", project="c"),
        {"project": "x"},
        ("a", "b", "x", DEFAULT_LIMIT_VALUE),
    ),
    (Client("", "", False, False, vc_type="a", organization="b", project="c"), {"limit": 1}, ("a", "b", "c", 1)),
    (Client("", "", False, False, vc_type="a", organization="b", project="c"), {"vcs_type": "x", "limit": 1}, ("x", "b", "c", 1)),
    (
        Client("", "", False, False, vc_type="a", organization="b", project="c"),
        {"organization": "x", "limit": 1},
        ("a", "x", "c", 1),
    ),
    (Client("", "", False, False, vc_type="a", organization="b", project="c"), {"project": "x", "limit": 1}, ("a", "b", "x", 1)),
    (
        Client("", "", False, False, vc_type="a", organization="b", project="c"),
        {"vcs_type": "x", "organization": "y"},
        ("x", "y", "c", DEFAULT_LIMIT_VALUE),
    ),
    (
        Client("", "", False, False, vc_type="a", organization="b", project="c"),
        {"vcs_type": "x", "project": "y"},
        ("x", "b", "y", DEFAULT_LIMIT_VALUE),
    ),
    (
        Client("", "", False, False, vc_type="a", organization="b", project="c"),
        {"organization": "x", "project": "y"},
        ("a", "x", "y", DEFAULT_LIMIT_VALUE),
    ),
    (
        Client("", "", False, False, vc_type="a", organization="b", project="c"),
