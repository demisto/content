...
demisto.debug('pack name = OpsGenie, pack version = 2.0.25')
...
def fetch_incidents_by_type(client: Client,
    ...
    params: Dict[str, Any] = {}
    demisto.debug("LAST RUN DICT AS RECEIVED={0}".format(last_run_dict))
    ...
    if last_run_dict.get('next_page'):
        ...
        demisto.debug("LAST RUN AS PERCEIVED BY PROGRAM={0}".format(last_run))
