...
##### New: Valid Accounts - Successful guest user invitation
...
- New: This trigger is responsible for handling Valid Accounts alerts related to successful guest user invitations.<~XSIAM> (Available from Cortex XSIAM %%XSIAM_VERSION%%).</~XSIAM>

##### New: Valid Accounts - Successful guest user invitation

- New: This trigger is responsible for handling Valid Accounts alerts related to successful guest user invitations.
