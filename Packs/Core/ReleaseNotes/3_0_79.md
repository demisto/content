...
- New: This playbook is designed to handle the following alert:
...
Requiremets: 
For any response action, you will need one of the following integrations: Azure Active Directory Users / Active Directory Users.<~XSIAM> (Available from Cortex XSIAM).</~XSIAM>
...
- New: This trigger is responsible for handling the 'A Successful login from TOR' alert<~XSIAM> (Available from Cortex XSIAM).</~XSIAM>
