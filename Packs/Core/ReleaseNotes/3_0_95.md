...
##### New Playbook: Unsigned and unpopular process performed an injection
 ...
 **Requirements**: Integrations for agent prevention rule monitoring and endpoint isolation.
