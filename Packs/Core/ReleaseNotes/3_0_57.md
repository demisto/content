...
- New: This trigger is responsible for handling Suspicious SaaS Access From a TOR Exit Node<~XSIAM> (Available from Cortex XSIAM %%XSIAM_VERSION%%).</~XSIAM>

##### New: Suspicious SaaS Access From a TOR Exit Node

New: This trigger is responsible for handling Suspicious SaaS Access From a TOR Exit Node<~XSIAM> (Available from Cortex XSIAM).</~XSIAM>
