...
- New: The `Identity Analytics - Alert Handling` playbook is triggered by Identity Analytics alerts and executes the following:
...
- Handles non-malicious alerts identified during the investigation. (Available from Cortex XSOAR 6.10.0).
