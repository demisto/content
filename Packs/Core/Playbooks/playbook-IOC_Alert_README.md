...
| --- | --- | --- | --- |
| BlockIndicatorsAutomatically | Should we block suspicious/malicious indicators automatically? Specify True/False. | False | Optional |
| ShouldCloseAutomatically | Should close the alert automatically if it's established verdict is False Positive? | True | Optional |
| PreHostContainment | Isolate the host before the investigation phase in case IOC found as suspicious. | False | Optional |
