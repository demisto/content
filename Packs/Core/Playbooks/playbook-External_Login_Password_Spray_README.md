...
Investigation:
The playbook analyzes the timestamps of the login attempts to detect patterns, checks whether any logons were successful, and retrieves the Risk Score for users that successfully logged in as part of the attack.
