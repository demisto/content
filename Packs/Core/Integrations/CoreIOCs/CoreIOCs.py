...
core_reputation_to_demisto: dict = {"GOOD": 1, "SUSPICIOUS": 2, "BAD": 3}
demisto_score_to_core: dict[int, str] = {1: "GOOD", 2: "SUSPICIOUS", 3: "BAD"}
...
def set_sync_time(time: str):
    ...
    set_integration_context(
        {
            "ts": int(date_time_obj.timestamp() * 1000),
