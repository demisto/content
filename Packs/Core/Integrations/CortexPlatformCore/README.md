...
| Core.CaseExtraData.case.detection_time | Unknown | The timestamp when the activity related to the case was first detected. |
...
| Core.CaseExtraData.case.assigned_user_mail | Unknown | The email address of the user assigned to the case. |
| Core.CaseExtraData.case.assigned_user_pretty_name | Unknown | The display name of the user assigned to the case. |
...
| Core.CaseExtraData.case.notes | Unknown | A collection of notes or comments added to the case by analysts. |
| Core.CaseExtraData.case.resolve_comment | Unknown | The comment entered by a user when resolving the case. |
| Core.CaseExtraData.case.manual_severity | Unknown | The severity level manually set by a user, which may override the calculated severity for the case. |
| Core.CaseExtraData.case.manual_description | Unknown | A description of the case that was manually entered by a user. |
| Core.CaseExtraData.case.xdr_url | String | The direct URL to view the case in the XDR platform. |
| Core.CaseExtraData.case.starred | Unknown | A flag indicating whether the case has been starred or marked as a favorite. |
| Core.CaseExtraData.case.hosts | String | A comma-separated list of hostnames involved in the case. |
...
| Core.CaseExtraData.case.manual_score | Unknown | A risk score manually assigned to the case by a user. |
...
| Core.CaseExtraData.issues.data.end_match_attempt_ts | Unknown | The timestamp of the last attempt to match the issue with others. |
| Core.CaseExtraData.issues.data.local_insert_ts | Date | The timestamp when the issue was first recorded in the system. |
| Core.CaseExtraData.issues.data.bioc_indicator | Unknown | The specific Behavioral Indicator of Compromise \(BIOC\) that triggered the issue. |
| Core.CaseExtraData.issues.data.matching_service_rule_id | Unknown | The ID of the matching service rule that identified the issue. |
| Core.CaseExtraData.issues.data.attempt_counter | Unknown | The number of times a matching attempt has been made for this issue. |
| Core.CaseExtraData.issues.data.bioc_category_enum_key | Unknown | The key representing the category of the Behavioral Indicator of Compromise \(BIOC\). |
| Core.CaseExtraData.issues.data.case_id | Number | The ID of the case to which this issue belongs. |
| Core.CaseExtraData.issues.data.is_whitelisted | Unknown | A flag indicating whether this issue has been whitelisted or suppressed. |
| Core.CaseExtraData.issues.data.starred | Unknown | A flag indicating whether this individual issue has been starred. |
| Core.CaseExtraData.issues.data.deduplicate_tokens | String | Tokens used to identify and deduplicate similar issues. |
| Core.CaseExtraData.issues.data.filter_rule_id | Unknown | The ID of any filter rule that was applied to this issue. |
| Core.CaseExtraData.issues.data.mitre_technique_id_and_name | Unknown | The specific MITRE ATT&amp;CK technique ID and name associated with the issue. |
| Core.CaseExtraData.issues.data.mitre_tactic_id_and_name | Unknown | The specific MITRE ATT&amp;CK tactic ID and name associated with the issue. |
| Core.CaseExtraData.issues.data.agent_version | Unknown | The version of the agent installed on the endpoint related to the issue. |
| Core.CaseExtraData.issues.data.agent_device_domain | Unknown | The domain of the endpoint device. |
| Core.CaseExtraData.issues.data.agent_fqdn | Unknown | The fully qualified domain name \(FQDN\) of the agent's host. |
| Core.CaseExtraData.issues.data.agent_os_type | String | The operating system type of the endpoint \(e.g., 'Windows', 'Linux'\). |
| Core.CaseExtraData.issues.data.agent_os_sub_type | Unknown | The specific version or distribution of the agent's operating system. |
| Core.CaseExtraData.issues.data.agent_data_collection_status | Unknown | The status of the agent's data collection process. |
| Core.CaseExtraData.issues.data.mac | Unknown | The primary MAC address of the endpoint. |
| Core.CaseExtraData.issues.data.mac_addresses | Unknown | A list of all MAC addresses associated with the endpoint. |
| Core.CaseExtraData.issues.data.agent_is_vdi | Unknown | A flag indicating whether the agent is installed on a Virtual Desktop Infrastructure \(VDI\) instance. |
| Core.CaseExtraData.issues.data.agent_install_type | String | The installation type of the agent. |
| Core.CaseExtraData.issues.data.agent_host_boot_time | Unknown | The last boot time of the host where the agent is installed. |
| Core.CaseExtraData.issues.data.event_sub_type | Unknown | A more specific classification of the event type. |
| Core.CaseExtraData.issues.data.module_id | Unknown | The identifier of the agent module that generated the event. |
| Core.CaseExtraData.issues.data.association_strength | Unknown | A score indicating the strength of the event's association to the case. |
| Core.CaseExtraData.issues.data.dst_association_strength | Unknown | The association strength related to the destination entity in the event. |
| Core.CaseExtraData.issues.data.story_id | Unknown | An identifier that groups a sequence of related events into a "story". |
| Core.CaseExtraData.issues.data.event_id | Unknown | The unique identifier for the event. |
...
| Core.CaseExtraData.issues.data.event_timestamp | Unknown | The timestamp when the original event occurred. |
| Core.CaseExtraData.issues.data.actor_process_instance_id | Unknown | The unique instance ID of the primary actor process. |
| Core.CaseExtraData.issues.data.actor_process_image_path | Unknown | The full file path of the actor process's executable. |
| Core.CaseExtraData.issues.data.actor_process_image_name | Unknown | The filename of the actor process's executable. |
| Core.CaseExtraData.issues.data.actor_process_command_line | Unknown | The command line used to launch the actor process. |
...
| Core.CaseExtraData.issues.data.actor_process_signature_vendor | Unknown | The vendor name from the digital signature of the actor process. |
| Core.CaseExtraData.issues.data.actor_process_image_sha256 | Unknown | The SHA256 hash of the actor process executable. |
| Core.CaseExtraData.issues.data.actor_process_image_md5 | Unknown | The MD5 hash of the actor process executable. |
| Core.CaseExtraData.issues.data.actor_process_causality_id | Unknown | The causality ID of the actor process, which links it to its parent process. |
| Core.CaseExtraData.issues.data.actor_causality_id | Unknown | The causality ID of the primary actor in the event. |
| Core.CaseExtraData.issues.data.actor_process_os_pid | Unknown | The operating system's Process ID \(PID\) of the actor process. |
| Core.CaseExtraData.issues.data.actor_thread_thread_id | Unknown | The ID of the specific thread within the actor process that initiated the action. |
| Core.CaseExtraData.issues.data.causality_actor_process_image_name | Unknown | The image name of the process that initiated the actor process \(the grandparent\). |
| Core.CaseExtraData.issues.data.causality_actor_process_command_line | Unknown | The command line of the causality actor process. |
| Core.CaseExtraData.issues.data.causality_actor_process_image_path | Unknown | The file path of the causality actor process's executable. |
| Core.CaseExtraData.issues.data.causality_actor_process_signature_vendor | Unknown | The signature vendor of the causality actor process. |
...
| Core.CaseExtraData.issues.data.causality_actor_causality_id | Unknown | The causality ID of the causality actor process. |
| Core.CaseExtraData.issues.data.causality_actor_process_execution_time | Unknown | The execution timestamp of the causality actor process. |
| Core.CaseExtraData.issues.data.causality_actor_process_image_md5 | Unknown | The MD5 hash of the causality actor process's executable. |
| Core.CaseExtraData.issues.data.causality_actor_process_image_sha256 | Unknown | The SHA256 hash of the causality actor process's executable. |
| Core.CaseExtraData.issues.data.action_file_path | Unknown | The file path of the file that was the target of an action. |
| Core.CaseExtraData.issues.data.action_file_name | Unknown | The name of the file that was the target of an action. |
| Core.CaseExtraData.issues.data.action_file_md5 | Unknown | The MD5 hash of the file that was the target of an action. |
| Core.CaseExtraData.issues.data.action_file_sha256 | Unknown | The SHA256 hash of the file that was the target of an action. |
| Core.CaseExtraData.issues.data.action_file_macro_sha256 | Unknown | The SHA256 hash of a macro embedded within the target file. |
| Core.CaseExtraData.issues.data.action_registry_data | Unknown | The data written to or read from a registry value during the action. |
| Core.CaseExtraData.issues.data.action_registry_key_name | Unknown | The name of the registry key involved in the action. |
| Core.CaseExtraData.issues.data.action_registry_value_name | Unknown | The name of the registry value involved in the action. |
| Core.CaseExtraData.issues.data.action_registry_full_key | Unknown | The full path of the registry key involved in the action. |
...
| Core.CaseExtraData.issues.data.action_process_instance_id | Unknown | The instance ID of the process that was the target of an action. |
| Core.CaseExtraData.issues.data.action_process_causality_id | Unknown | The causality ID of the target process. |
| Core.CaseExtraData.issues.data.action_process_image_name | Unknown | The executable name of the target process. |
| Core.CaseExtraData.issues.data.action_process_image_sha256 | Unknown | The SHA256 hash of the target process's executable. |
| Core.CaseExtraData.issues.data.action_process_image_command_line | Unknown | The command line of the target process. |
| Core.CaseExtraData.issues.data.action_process_signature_status | String | The signature status of the target process. |
| Core.CaseExtraData.issues.data.action_process_signature_vendor | Unknown | The signature vendor of the target process. |
| Core.CaseExtraData.issues.data.os_actor_effective_username | Unknown | The effective username of the OS-level actor responsible for the event. |
| Core.CaseExtraData.issues.data.os_actor_process_instance_id | Unknown | The instance ID of the OS actor process. |
| Core.CaseExtraData.issues.data.os_actor_process_image_path | Unknown | The file path of the OS actor process's executable. |
| Core.CaseExtraData.issues.data.os_actor_process_image_name | Unknown | The image name of the OS actor process. |
| Core.CaseExtraData.issues.data.os_actor_process_command_line | Unknown | The command line of the OS actor process. |
| Core.CaseExtraData.issues.data.os_actor_process_signature_status | String | The signature status of the OS actor process. |
| Core.CaseExtraData.issues.data.os_actor_process_signature_vendor | Unknown | The signature vendor of the OS actor process. |
| Core.CaseExtraData.issues.data.os_actor_process_image_sha256 | Unknown | The SHA256 hash of the OS actor process's executable. |
| Core.CaseExtraData.issues.data.os_actor_process_causality_id | Unknown | The causality ID of the OS actor process. |
| Core.CaseExtraData.issues.data.os_actor_causality_id | Unknown | The causality ID of the OS actor. |
| Core.CaseExtraData.issues.data.os_actor_process_os_pid | Unknown | The operating system PID of the OS actor process. |
| Core.CaseExtraData.issues.data.os_actor_thread_thread_id | Unknown | The thread ID of the OS actor. |
| Core.CaseExtraData.issues.data.fw_app_id | Unknown | The firewall application ID for the traffic. |
| Core.CaseExtraData.issues.data.fw_interface_from | Unknown | The firewall interface from which the traffic originated. |
| Core.CaseExtraData.issues.data.fw_interface_to | Unknown | The firewall interface to which the traffic was destined. |
| Core.CaseExtraData.issues.data.fw_rule | Unknown | The name of the firewall rule that matched the traffic. |
| Core.CaseExtraData.issues.data.fw_rule_id | Unknown | The unique ID of the firewall rule that matched the traffic. |
| Core.CaseExtraData.issues.data.fw_device_name | Unknown | The name of the firewall device that logged the event. |
| Core.CaseExtraData.issues.data.fw_serial_number | String | The serial number of the firewall device. |
| Core.CaseExtraData.issues.data.fw_url_domain | Unknown | The domain visited, as logged by the firewall. |
| Core.CaseExtraData.issues.data.fw_email_subject | String | The subject line of an email, as logged by the firewall. |
| Core.CaseExtraData.issues.data.fw_email_sender | Unknown | The sender of an email, as logged by the firewall. |
| Core.CaseExtraData.issues.data.fw_email_recipient | Unknown | The recipient of an email, as logged by the firewall. |
| Core.CaseExtraData.issues.data.fw_app_subcategory | Unknown | The application subcategory as identified by the firewall. |
| Core.CaseExtraData.issues.data.fw_app_category | Unknown | The application category as identified by the firewall. |
| Core.CaseExtraData.issues.data.fw_app_technology | Unknown | The application technology as identified by the firewall. |
| Core.CaseExtraData.issues.data.fw_vsys | Unknown | The virtual system on the firewall that processed the traffic. |
| Core.CaseExtraData.issues.data.fw_xff | Unknown | The X-Forwarded-For \(XFF\) header value from the traffic. |
| Core.CaseExtraData.issues.data.fw_misc | Unknown | Miscellaneous firewall log data. |
| Core.CaseExtraData.issues.data.fw_is_phishing | String | A flag indicating if the firewall identified the event as phishing. |
| Core.CaseExtraData.issues.data.dst_agent_id | Unknown | The agent ID of the destination endpoint in a lateral movement event. |
| Core.CaseExtraData.issues.data.dst_causality_actor_process_execution_time | Unknown | The execution time of the causality actor process on the destination endpoint. |
| Core.CaseExtraData.issues.data.dns_query_name | Unknown | The domain name in a DNS query event. |
| Core.CaseExtraData.issues.data.dst_action_external_hostname | Unknown | The external hostname of the destination. |
| Core.CaseExtraData.issues.data.dst_action_country | Unknown | The country of the destination. |
| Core.CaseExtraData.issues.data.dst_action_external_port | Unknown | The external port of the destination. |
...
| Core.CaseExtraData.issues.data.endpoint_id | Unknown | The unique ID of the endpoint where the issue occurred. |
...
| Core.CaseExtraData.issues.data.user_name | Unknown | The name of the user associated with the issue. |
| Core.CaseExtraData.issues.data.contains_featured_host | Unknown | A flag indicating if the issue involves a host marked as featured or critical. |
| Core.CaseExtraData.issues.data.contains_featured_user | Unknown | A flag indicating if the issue involves a user marked as featured or critical. |
| Core.CaseExtraData.issues.data.contains_featured_ip_address | Unknown | A flag indicating if the issue involves an IP address marked as featured or critical. |
...
| Core.CaseExtraData.network_artifacts.data.is_manual | Unknown | A flag indicating if the network artifact was added manually by a user. |
...
| Core.CaseExtraData.file_artifacts.data.is_malicous | Unknown | A flag indicating whether the file artifact is considered malicious. |
| Core.CaseExtraData.file_artifacts.data.is_manual | Unknown | A flag indicating if the file artifact was added manually by a user. |
| Core.CaseExtraData.file_artifacts.data.is_process | Unknown | A flag indicating if the file artifact is a process executable. |
| Core.CaseExtraData.file_artifacts.data.low_confidence | Unknown | A flag indicating if the verdict on the file artifact has low confidence. |
...
| Core.Case.detection_time | Unknown | Timestamp when the first issue was detected in the case. May be null. |
...
| Core.Case.assigned_user_mail | Unknown | Email address of the assigned user. May be null. |
| Core.Case.assigned_user_pretty_name | Unknown | Full name of the assigned user. May be null. |
...
| Core.Case.notes | Unknown | Notes related to the case. May be null. |
| Core.Case.resolve_comment | Unknown | Comments added when resolving the case. May be null. |
| Core.Case.resolved_timestamp | Number | Timestamp when the case was resolved. |
| Core.Case.manual_severity | Unknown | Severity manually assigned by the user. May be null. |
...
| Core.Case.starred | String | Indicates whether the case is starred. |
| Core.Case.starred_manually | String | True if the case was starred manually; false if starred by rules. |
| Core.Case.hosts | String | List of hosts involved in the case. |
| Core.Case.users | String | List of users involved in the case. |
| Core.Case.case_sources | String | Sources of the case. |
| Core.Case.rule_based_score | Number | Score based on rules. |
| Core.Case.manual_score | Unknown | Manually assigned score. May be null. |
| Core.Case.wildfire_hits | Number | Number of WildFire hits. |
| Core.Case.issues_grouping_status | String | Status of issue grouping. |
| Core.Case.mitre_tactics_ids_and_names | String | List of MITRE ATT&amp;CK tactic IDs and names associated with the case. |
| Core.Case.mitre_techniques_ids_and_names | String | List of MITRE ATT&amp;CK technique IDs and names associated with the case. |
| Core.Case.issue_categories | String | Categories of issues associated with the case. |
| Core.Case.original_tags | String | Original tags assigned to the case. |
| Core.Case.tags | String | Current tags assigned to the case. |
