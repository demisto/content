...
| **Argument Name** | **Description** | **Required** |
| --- | --- | --- |
| issue_id | The unique ID of the issue. | Optional | 
| severity | The severity of the issue. Possible values are: low, medium, high, critical. | Optional | 
...
| actor_process_image_sha256 | SHA256 hash of the binary file. | Optional | 
| causality_actor_process_image_sha256 | SHA256 hash of the binary file. | Optional | 
...
| host_ip | The host IP address. | Optional | 
...
| dst_action_external_hostname | The hostname connected to. In case of a proxy connection, this value will differ from action_remote_ip. | Optional | 
...
| issue_domain | The domain of the issue. Possible values are: Health, Hunting, IT, Posture, Security. | Optional | 
| issue_description | The description of the issue. | Optional | 
| os_actor_process_image_sha256 | The SHA256 hash of the OS actor process image. | Optional | 
| action_file_macro_sha256 | The SHA256 hash of the action file macro. | Optional | 
| status | The status progress. Possible values are: New, In Progress, Resolved. | Optional | 
| not_status | Not status progress. Possible values are: New, In Progress, Resolved. | Optional | 
| asset_ids | The assets ids related to the issue. | Optional | 
| assignee | The assignee of the issue. | Optional | 
