...
***
Returns a list of incidents, which you can filter by a list of incident IDs (max. 1000), the time the incident was last modified, and the time the incident was created.
