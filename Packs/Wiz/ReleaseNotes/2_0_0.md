...
- Updated the Wiz Mapper mapper to %%UPDATE_CONTENT_ITEM_CHANGE_DESCRIPTION%%.

##### Wiz Mapper Webhook

- Updated the Wiz Mapper Webhook mapper to %%UPDATE_CONTENT_ITEM_CHANGE_DESCRIPTION%%.
