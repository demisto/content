...
def test_fetch_incidents(client: AttackSurfaceManagement.Client, requests_mock, mocker):
    requests_mock.get(
        f'{SERVER_URL}/search/issues/collection%3A12341234%20collection%3A23452345%20last_seen_before%3A2023-04-17T15%3A49%3A54.000000Z%20last_seen_after%3A2023-03-18T15%3A49%3A54.000000Z%20severity_gte%3A1?page=0',
