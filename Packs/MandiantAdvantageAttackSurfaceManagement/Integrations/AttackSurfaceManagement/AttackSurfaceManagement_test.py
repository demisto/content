    ...
    "result": {
        "search": {
            "search_body": {
                "query": {
                    "bool": {
                        "must": {"range": {"first_seen": {"gte": "2022-01-01T00:00:00Z"}}},
                        "filter": {
                            "bool": {
                                "should": [
                                    {
                                        "bool": {
                                            "must": [
                                                {"match": {"collection": "collectionname_a6mz56o"}},
                                                {"range": {"last_seen": {"lte": "2023-01-31T18:59:39Z"}}},
                                            ]
                                        }
                                    }
                                ]
                ...
                "aggs": {
                    "collection_bucket": {"terms": {"field": "collection", "size": 10}},
                    "confidence": {"terms": {"field": "summary.confidence", "size": 3}},
                    "issue_name_bucket": {"terms": {"field": "name.raw", "size": 10}},
                    "severity_bucket": {"terms": {"field": "summary.severity", "size": 5}},
                    "status_bucket": {"terms": {"field": "summary.status", "size": 10}},
                    "status_new_bucket": {"terms": {"field": "summary.status_new.raw", "size": 10}},
                    "status_detailed_bucket": {"terms": {"field": "summary.status_detailed.raw", "size": 10}},
                    "ticket_list_bucket": {"terms": {"field": "summary.ticket_list.raw", "size": 50}},
                },
                "sort": [{"last_seen": "asc"}, "_doc"],
            },
        ...
        "hits": [
            {
                ...
                "summary": {
                    ...
                    "status": "open_new",
                    "category": "unknown",
                    "identifiers": [{"name": "CVE-2019-10081", "type": "CVE"}],
                    "status_new": "open",
        ...
        "aggregations": {
            ...
            "ticket_list_bucket": {"doc_count_error_upper_bound": 0, "sum_other_doc_count": 0, "buckets": []},
            "issue_name_bucket": {
                "doc_count_error_upper_bound": 0,
                "sum_other_doc_count": 2220,
                "buckets": [
                    {"key": "inferred_cve_2021_40438", "doc_count": 265},
                    {"key": "inferred_cve_2020_11022", "doc_count": 248},
                    {"key": "inferred_cve_2020_11023", "doc_count": 248},
                    {"key": "inferred_cve_2019_11358", "doc_count": 237},
                    {"key": "inferred_cve_2015_9251", "doc_count": 206},
                    {"key": "deprecated_ssl_protocol_detected", "doc_count": 178},
                    {"key": "weak_ssl_ciphers_enabled", "doc_count": 99},
                    {"key": "wordpress_api_exposed", "doc_count": 88},
                    {"key": "wordpress_admin_login_exposed", "doc_count": 81},
                    {"key": "wordpress_user_info_leak", "doc_count": 75},
                ],
            },
            "status_bucket": {
                "doc_count_error_upper_bound": 0,
                "sum_other_doc_count": 0,
                "buckets": [
                    {"key": "open_new", "doc_count": 3940},
                    {"key": "open_triaged", "doc_count": 3},
                    {"key": "closed_benign", "doc_count": 1},
                    {"key": "closed_tracked_externally", "doc_count": 1},
                ],
            },
            "collection_bucket": {
                "doc_count_error_upper_bound": 0,
                "sum_other_doc_count": 0,
                "buckets": [{"key": "collectionname_a6mz56o", "doc_count": 3945}],
            },
            "confidence": {
                "doc_count_error_upper_bound": 0,
                "sum_other_doc_count": 0,
                "buckets": [{"key": "potential", "doc_count": 2834}, {"key": "confirmed", "doc_count": 1111}],
            },
            "status_new_bucket": {
                "doc_count_error_upper_bound": 0,
                "sum_other_doc_count": 0,
                "buckets": [{"key": "open", "doc_count": 3943}, {"key": "closed", "doc_count": 2}],
            },
            "status_detailed_bucket": {"doc_count_error_upper_bound": 0, "sum_other_doc_count": 0, "buckets": []},
        },
...
MOCK_GET_REMOTE_DATA_RESPONSE = {
    ...
    "result": {
        ...
        "details": {
            ...
            "added": "2020-01-01",
            "proof": {
                "details": {"type": "tls", "enabled": "1", "version": "1.1"},
            ...
            "severity": "5",
            "references": [
                {"uri": "https://tools.ietf.org/id/draft-moriarty-tls-oldversions-diediedie-00.html", "type": "description"}
            ],
            "description": "This server is configured to allow a deprecated ssl / tls protocol.",
    ...
    "result": [
        {
            ...
            "created_by_user": {"printable_name": "test_user"},
...
def test_get_projects(client: AttackSurfaceManagement.Client, requests_mock):
    requests_mock.get(f"{SERVER_URL}/projects", headers={"content-type": "application/json"}, json=MOCK_GET_PROJECTS_RESPONSE)
...
def test_get_collections_no_project(client: AttackSurfaceManagement.Client, requests_mock):
    requests_mock.get(
        f"{SERVER_URL}/user_collections",
        request_headers={"PROJECT_ID": "1234"},
        headers={"content-type": "application/json"},
        json=MOCK_GET_COLLECTIONS_RESPONSE,
    )
...
def test_get_collections_with_project(client: AttackSurfaceManagement.Client, requests_mock):
    requests_mock.get(
        f"{SERVER_URL}/user_collections",
        request_headers={"PROJECT_ID": "5678"},
        headers={"content-type": "application/json"},
        json=MOCK_GET_COLLECTIONS_RESPONSE,
    )
...
def test_fetch_incidents(client: AttackSurfaceManagement.Client, requests_mock, mocker):
    requests_mock.get(
        ...
        headers={"content-type": "application/json", "project_id": "1234"},
        json=MOCK_FETCH_ISSUES_RESPONSE,
    )

    requests_mock.get(
        f"{SERVER_URL}/issues/2e0134b5b346a5d0a9d5ee0efe7dfb69dfcc5c1cf65a6df63568f85dc587a120",
        headers={"content-type": "application/json"},
        json=MOCK_GET_REMOTE_DATA_RESPONSE,
    )
...
def test_get_remote_data(client: AttackSurfaceManagement.Client, requests_mock, mocker):
    ...
    requests_mock.get(
        f"{SERVER_URL}/notes/issue/2e0134b5b346a5d0a9d5ee0efe7dfb69dfcc5c1cf65a6df63568f85dc587a120",
        headers={"content-type": "application/json"},
        json=MOCK_GET_REMOTE_DATA_NOTES_RESPONSE,
    )

    remote_data_params = {"id": "2e0134b5b346a5d0a9d5ee0efe7dfb69dfcc5c1cf65a6df63568f85dc587a120", "lastUpdate": "0"}
...
def test_update_remote_system(client: AttackSurfaceManagement.Client, requests_mock):
    args = {"data": {}, "entries": [], "incidentChanged": True, "remoteId": "FAKE_ID", "status": 2, "delta": {"runStatus": ""}}

    requests_mock.get(f"{SERVER_URL}/issues/FAKE_ID", json={"success": True})

    requests_mock.post(
        f"{SERVER_URL}/issues/FAKE_ID/status",
        json={"success": True, "message": "Successfully reported status as open_triaged", "result": True},
    )
