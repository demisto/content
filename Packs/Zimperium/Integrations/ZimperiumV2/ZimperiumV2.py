...
class Client(BaseClient):
    ...
    def users_search(
        ...
        if not email:
            return self._http_request(
                method="GET",
                url_suffix=f'auth/public/v1/users/{user_id if user_id else ""}',
                headers=self._headers,
                params=params,
            )

        res = self._http_request(method="GET", url_suffix="auth/public/v1/users", headers=self._headers, params=params)
    ...
    def threat_search(
        ...
        return self._http_request(method="GET", url_suffix="/threats/public/v1/threats", headers=self._headers, params=params)
    ...
    def app_version_list(self, size: Optional[int], page: Optional[int], bundle_id: Optional[str] = None):
        ...
        return self._http_request(method="GET", url_suffix="/devices/public/v1/appVersions", headers=self._headers, params=params)

    def device_by_cve_get(
        self,
        cve_id: Optional[str],
        size: Optional[int],
        page: Optional[int],
        ...
        return self._http_request(
            method="GET", url_suffix="/devices/public/v2/devices/data-cve-filter", headers=self._headers, params=params
        )
    ...
    def devices_os_version(
        ...
        return self._http_request(
            method="GET", url_suffix="/devices/public/v2/devices/data-version-filter", headers=self._headers, params=params
        )
    ...
    def cve_devices_get(self, size: Optional[int], page: Optional[int], device_id: Optional[str]):
        ...
        return self._http_request(
            method="GET", url_suffix=f"/devices/public/v2/devices/{device_id}/cves", headers=self._headers, params=params
        )
    ...
    def vulnerability_get(self, size: Optional[int], page: Optional[int]):
        ...
        return self._http_request(method="GET", url_suffix="/devices/public/v1/os-versions", headers=self._headers, params=params)
    ...
    def policy_privacy(self, policy_id: Optional[str]):
        ...
        """
        return self._http_request(
            method="GET", url_suffix=f"/mtd-policy/public/v1/privacy/policies/{policy_id}", headers=self._headers
        )
    ...
    def policy_threat(self, policy_id: Optional[str]):
        ...
        return self._http_request(
            method="GET", url_suffix=f"/mtd-policy/public/v1/trm/policies/{policy_id}", headers=self._headers
        )
    ...
    def policy_phishing(self, policy_id: Optional[str]):
        ...
        return self._http_request(
            method="GET", url_suffix=f"/mtd-policy/public/v1/phishing/policies/{policy_id}", headers=self._headers
        )
    ...
    def policy_device_inactivity_list(self, size: Optional[int], page: Optional[int], team_id: Optional[str] = None):
        ...
        return self._http_request(
            method="GET", url_suffix="/devices/public/v1/dormancy/policies", headers=self._headers, params=params
        )
    ...
    def policy_device_inactivity_get(self, policy_id: Optional[str]):
        ...
        """
        return self._http_request(
            method="GET", url_suffix=f"/devices/public/v1/dormancy/policies/{policy_id}", headers=self._headers
        )


def test_module(
    client: Client, first_fetch_time: Optional[str], fetch_query: Optional[list], max_fetch: int, look_back: int = 1
) -> str:
    """
...
def get_devices_by_cve_command(client: Client, args: dict) -> CommandResults:
    ...
    response = client.device_by_cve_get(
        cve_id=cve_id,
        size=size,
        page=page,
        after=after_srt,
    ...
    hr = tableToMarkdown(
        name=f"Devices Associated with {cve_id}",
        t=response.get("content"),
...
def devices_os_version_command(client: Client, args: dict) -> CommandResults:
    ...
    response = client.devices_os_version(
        ...
        team_id=team_id,
        deleted=deleted,
        os_patch_date=os_patch_date_str,
    )

    hr = tableToMarkdown(
        name="Device Os Version", t=response.get("content"), headers=["id", "teamId", "os"], headerTransform=pascalToSpace
    )
...
def get_cves_by_device_command(client: Client, args: dict) -> CommandResults:
    ...
    hr = tableToMarkdown(
        name=f"CVE on Device {device_id}",
        t=response.get("content"),
...
def policy_phishing_get_command(client: Client, args: dict) -> CommandResults:
    ...
    hr = tableToMarkdown(
        ...
        headers=[
            ...
            "enableDnsPhishingTutorial",
            "useLocalVpn",
            "useUrlSharing",
            "allowEndUserControl",
            "useRemoteContentInspection",
...
def policy_app_settings_get_command(client: Client, args: dict) -> CommandResults:
    ...
    hr = tableToMarkdown(
        ...
        headers=[
            ...
            "dangerzoneEnabled",
            "siteInsightEnabled",
            "phishingLocalClassifierEnabled",
            "appRiskLookupEnabled",
            "autoBatteryOptimizationEnabled",
            "autoActivateKnox",
            "privacySummaryEnabled",
            "forensicAnalysisEnabled",
            "team",
            "assigned",
            "teamId",
            "global",
...
def policy_device_inactivity_list_command(client: Client, args: dict) -> CommandResults:
    ...
    hr = tableToMarkdown(
        name="Device Inactivity List", t=response, headers=["id", "name", "teamId"], headerTransform=pascalToSpace
    )
...
def fetch_incidents(
    ...
    incidents_filtered = filter_incidents_by_duplicates_and_limit(
        incidents_res=incidents_res, last_run=last_run, fetch_limit=max_fetch, id_field="id"
    )
