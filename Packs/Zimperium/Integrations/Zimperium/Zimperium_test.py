...
def test_file_reputation(mocker):
    ...
    assert command_results.indicator[0].dbot_score.score == 1  # TODO: this will need to be updated
...
def test_file_reputation_404(mocker):
    ...
    command_results = file_reputation(client,
                                      args={'file': "aad9b2fd4606467f06931d72048ee1dff137cbc9b601860a88ad6a2c092"})
    assert command_results.indicator[0].dbot_score.score == 0  # TODO: this will need to be updated
