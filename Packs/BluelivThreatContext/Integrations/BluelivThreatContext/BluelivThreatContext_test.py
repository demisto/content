...
from BluelivThreatContext import (
    Client,
    blueliv_threatActor,
    blueliv_campaign,
    blueliv_malware,
    blueliv_indicatorIp,
    blueliv_indicatorFqdn,
    blueliv_indicatorCs,
    blueliv_attackPattern,
    blueliv_tool,
    blueliv_signature,
    blueliv_cve,
)
...
def test_blueliv_threatActor(mocker, requests_mock):
    blueliv_response = {
        "data": {
            ...
            "id": "232",
            "links": {"self": "https://tctrustoylo.blueliv.com/api/v1/threat-actor/232/"},
            "relationships": {
                "attack_patterns": {
                    "links": {
                ...
                "country": {
                    "data": {"id": "108", "type": "Country"},
                    "links": {"related": "https://tctrustoylo.blueliv.com/api/v1/country/108/"},
                },
                "cves": {
                    "links": {
...
def test_blueliv_campaign(mocker, requests_mock):
    blueliv_response = {
        "data": {
            ...
            "id": "152",
            "links": {"self": "https://tctrustoylo.blueliv.com/api/v1/campaign/152/"},
            "relationships": {
                "attack_patterns": {
                    "links": {
                ...
                "threat_actor": {
                    "data": {"id": "226", "type": "ThreatActor"},
                    "links": {"related": "https://tctrustoylo.blueliv.com/api/v1/threat-actor/226/"},
                },
                "tools": {
                    "links": {
    ...
    blueliv_response = {
        "data": {
            "attributes": {
                ...
                "analysis_signatures": ["Signature severity - Informative", "Signature severity - Malicious"],
                ...
                "ioa": {
                    "attack_patterns": [{"id": "T1022", "name": "Data Encrypted"}, {"id": "T1093", "name": "Process Hollowing"}],
                    "certificates": [],
                    "connections": {"tcp": [], "tcp_dead": ["25.20.116.113:957", "103.143.173.25:80"], "udp": []},
                    "domain": [],
                    "email": [],
                    "host": ["25.20.116.113", "103.143.173.25"],
                    "ip": ["25.20.116.113", "103.143.173.25", "192.168.56.102"],
                    "metadata": {
                        "crc32": {"original": "B7CACEE9", "unpacked": {}},
                        ...
                        "postal_code": None,
                        "signing_date": "",
                        "ssdeep": {"original": "12288:f9HFJ9rJxRX1uVVjoaWSoynxdO1FxuVVjfFoynPaVBUR8f+kN10EBO", "unpacked": {}},
                    },
                    "mutex": ["DCPERSFWBP", "DC_MUTEX-K5CAEA3", "Local\\MSCTF.Asm.MutexDefault1"],
                    "path": {
                        "filepaths": {
                            "directory_created": ["C:\\Users\\Administrator\\AppData\\Local\\Microsoft\\Windows\\Caches"],
                            "directory_enumerated": [],
                            "directory_queried": ["C:\\Users\\Administrator", "C:\\Users"],
                            "directory_removed": [],
                            "dll_loaded": ["kernel32", "OLEACC.dll"],
                            "file_copied": ["C:\\Users\\Administrator\\Documents\\MSDCSC\\msdcsc.exe"],
                            "file_created": [
                                "C:\\Windows\\System32\\oleaccrc.dll",
                                "C:\\Users\\Administrator\\AppData\\Local\\Microsoft\\Windows\\Caches\\cversions.1.db",
                            ],
                            "file_deleted": [],
                            "file_exists": ["C:\\Windows\\System32\\oleaccrc.dll", "C:\\Users\\Administrator\\Documents\\MSDCSC"],
                            "file_moved": [],
                            "file_opened": [
                                "C:\\Windows\\System32\\oleaccrc.dll",
                                "C:\\Users\\Administrator\\AppData\\Local\\Microsoft\\Windows\\Caches\\cversions.1.db",
                            ],
                            "file_read": ["C:\\Users\\desktop.ini", "C:\\Users\\Administrator\\Documents\\desktop.ini"],
                            "file_written": [],
                        },
                        "pdb_path": [],
                    },
                    "ports": {"tcp": [], "tcp_dead": [80, 957], "udp": []},
                    "process_name": ["msdcsc.exe", "sXPFvH.exe", "notepad.exe"],
                    "registry": [],
                    "regkeys": {
                        "regkey_created": ["HKEY_CURRENT_USER\\Software"],
                        "regkey_deleted": [],
                        "regkey_enumerated": ["HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\CTF\\TIP"],
                        "regkey_opened": [
                    ...
                    "url": ["http://uk.ask.com/favicon.ico", "http://www.priceminister.com/"],
                    "yara": {
                        "generic": [],
                        "memory": ["darkcomet_memory_1", "darkcomet_memory_3"],
                        "misc": {
                            "crypto": ["RIPEMD160_Constants", "SHA1_Constants"],
                            "misc": ["dbgdetect_funcs_ig"],
                            "packer": ["MinGW_1", "borland_delphi"],
                        },
                        "pre_analysis": [],
                        "url": [],
                    },
                ...
                "slugs_tags": [],
                "sources_representation": ["virustotalAPI"],
                "subtype": "DARKCOMET",
                "target": False,
                "tlp": "white",
                "types_names": ["DARKCOMET"],
                "updated_at": "2020-06-23T23:52:30.137745Z",
                "updated_at_afapi": "2020-06-15T16:30:33.293000Z",
                "uuid": None,
                "version": "none",
                "vt_matches": ["darkkomet", "fynloski", "genmalicious"],
            },
            "id": "59770710",
            "links": {"self": "https://tctrustoylo.blueliv.com/api/v1/malware/6e749976bade1/"},
            "relationships": {
                "campaigns": {
                    "links": {
                ...
                "solr_type": {
                    "data": {"id": "62", "type": "ThreatType"},
                    "links": {"related": "https://tctrustoylo.blueliv.com/api/v1/threat-type/DARKCOMET/"},
                },
                "sources": {
                    "links": {
...
def test_blueliv_indicatorFqdn(mocker, requests_mock):
    blueliv_response = {
        "data": {
            ...
            "id": "5783887",
            "links": {"self": "https://tctrustoylo.blueliv.com/api/v1/fqdn/rayanmarketing.com/"},
            "relationships": {
                "campaigns": {
                    "links": {
...
def test_blueliv_indicatorCs(mocker, requests_mock):
    blueliv_response = {
        "data": {
            ...
            "id": "6626263",
            "links": {"self": "https://tctrustoylo.blueliv.com/api/v1/crime-server/6626263/"},
            "relationships": {
                "fqdn": {
                    "data": {"id": "9633658", "type": "FQDN"},
                    "links": {"related": "https://tctrustoylo.blueliv.com/api/v1/fqdn/saveback.xyz/"},
                },
                "malware": {
                    "links": {
                ...
                "subtype": {
                    "data": {"id": "7458", "type": "ThreatType"},
                    "links": {"related": "https://tctrustoylo.blueliv.com/api/v1/threat-type/ANUBIS/"},
                },
                "tags": {
                    "links": {
...
def test_blueliv_attackPattern(mocker, requests_mock):
    blueliv_response = {
        "data": {
            ...
            "id": "686",
            "links": {"self": "https://tctrustoylo.blueliv.com/api/v1/attack-pattern/686/"},
            "relationships": {
                "campaigns": {
                    "links": {
...
def test_blueliv_tool(mocker, requests_mock):
    blueliv_response = {
        "data": {
            ...
            "id": "532",
            "links": {"self": "https://tctrustoylo.blueliv.com/api/v1/tool/532/"},
            "relationships": {
                "campaigns": {
                    "links": {
...
def test_blueliv_signature(mocker, requests_mock):
    blueliv_response = {
        "data": {
            ...
            "id": "84458",
            "links": {"self": "https://tctrustoylo.blueliv.com/api/v1/signature/84458/"},
            "relationships": {
                "attack_patterns": {
                    "links": {
        ...
        "data": {
            "attributes": {
                ...
                "references": [
                    ...
                    {"id": "DSA-4634", "type": "DEBIAN", "url": "https://www.debian.org/security/2020/dsa-4634"},
                    {
            ...
            "id": "139511",
            "links": {"self": "https://tctrustoylo.blueliv.com/api/v1/cve/CVE-2020-8794/"},
            "relationships": {
                "attack_patterns": {
                    "links": {
