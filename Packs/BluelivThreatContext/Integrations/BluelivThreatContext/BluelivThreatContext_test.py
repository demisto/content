...
def test_blueliv_threatActor(mocker, requests_mock):
    blueliv_response = {"data": {
        "attributes": {
            ...
            "modus_operandi": "Vendetta uses well designed phishing campaigns to target businesses and individuals. ",
            "name": "Vendetta",
            "objective": "This threat actor appears to be focused on stealing information from the target by using.",
            "references": [
                {
    ...
    requests_mock.get('https://tctrustoylo.blueliv.com/api/v2/gateway', json=blueliv_response)
...
def test_blueliv_malware(mocker, requests_mock):
    blueliv_response = {"data": {
        "attributes": {
            ...
            "sha512": "e7ebf12d5dc0900faafa73d090b62c1ce583858606217d935981bf3d51dbd6e63eefd67b10391b7a30766c4a3cc6",
            "slugs_tags": [],
        ...
        "relationships": {
            ...
            "threat_actors": {
                "links": {
                    ...
                    "self": "https://tctrustoylo.blueliv.com/api/v1/malware/ad53660b6d7e8d2eships/threat-actor/"
                },
                "meta": {"count": 0}
            },
            "types": {
    ...
    assert demisto.get(ind, "hash.sha1") == "5c0be68316ce77584a7b966ff40e7d61a8a98055"
        ...
        "relationships": {
            "campaigns": {
                "links": {
                    ...
                    "self": "https://tctrustoylo.blueliv.com/api/v1/fqdn/rayanmarketing.com/relationships/campaign/"
                },
                "meta": {"count": 0}
            },
            "crime_servers": {
                "links": {
                    ...
                    "self": "https://tctrustoylo.blueliv.com/api/v1/fqdn/rayanmarketing.com/relationships/crime-server/"
                },
                "meta": {"count": 0}
            },
            "ips": {
            ...
            "signatures": {
                "links": {
                    ...
                    "self": "https://tctrustoylo.blueliv.com/api/v1/fqdn/rayanmarketing.com/relationships/signature/"
                },
                "meta": {"count": 0}
            },
            "sparks": {
...
def test_blueliv_indicatorCs(mocker, requests_mock):
    ...
    entry_context = results.get('EntryContext', {})
    ind = entry_context.get('BluelivThreatContext.indicator(val.id && val.id == obj.id)', {})
    assert demisto.get(ind, "risk") == "4.0"
    assert demisto.get(ind, "sourceIds") == "642676"
...
def test_blueliv_cve(mocker, requests_mock):
    blueliv_response = {"data": {
        "attributes": {
            ...
            "description": "OpenSMTPD before 6.6.4 allows remote code execution because of an out-of-bounds read in.",
            "exploits": [
                {
        ...
        "relationships": {
            "attack_patterns": {
                "links": {
                    ...
                    "self": "https://tctrustoylo.blueliv.com/api/v1/cve/CVE-2020-8794/relationships/attack-pattern/"
                },
                "meta": {"count": 0}
            },
            "campaigns": {
