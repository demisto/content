 Before you can use AWS CloudTrail, you need to perform several configuration steps in your AWS environment.
...
[View Integration Documentation](https://xsoar.pan.dev/docs/reference/integrations/aws---cloud-trail)