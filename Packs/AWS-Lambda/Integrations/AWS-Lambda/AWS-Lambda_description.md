Before you can use the AWS Lambda integration in Cortex XSOAR, you need to perform several configuration steps in your AWS environment.
...
---
[View Integration Documentation](https://xsoar.pan.dev/docs/reference/integrations/aws---lambda)