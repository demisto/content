...
- Added support for **Feed Fetch Interval** parameter.
- Added support for **None** parameter.
...
- Added support for **None** parameter.
- Added support for **Indicator Verdict** parameter that indicators from this integration instance will be marked with this verdict.
