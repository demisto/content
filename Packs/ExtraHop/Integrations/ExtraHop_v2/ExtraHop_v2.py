...
def validate_device_tag_arguments(add: str, remove: str) -> None:
    """Validate arguments for devices-tag command.
    ...
    if not add and not remove:
        raise DemistoException("No device id provided to add or remove the tag.")
...
def devices_tag_command(client: ExtraHopClient, args: Dict[str, Any]) -> str:
    ...
    validate_device_tag_arguments(add, remove)
