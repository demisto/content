...
| author | The name of the user that created the alert. Possible values are: true, false. | Optional | 
| categories | The list of one or more detection categories. An alert is generated only if a detection is identified in the specified categories. Only applicable to detection alerts. | Optional | 
| cc | The list of email addresses, not included in an email group, to receive notifications. | Optional | 
| description | An optional description for the alert. | Optional | 
