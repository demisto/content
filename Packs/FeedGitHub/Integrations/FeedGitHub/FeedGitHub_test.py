...
def test_get_content_files_from_repo(mocker):
    ...
    return_data = {"content": "2023-02-08 (WEDNESDAY) - COBALT STRIKE FROM ICEDID (BOKBOT) INFECTION\n\nREFERENCE:\n\n"
