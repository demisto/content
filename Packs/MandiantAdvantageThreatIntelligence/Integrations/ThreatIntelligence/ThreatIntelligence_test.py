...
@pytest.mark.parametrize('value, command, type, response', [
    ('8.8.8.8', 'ip', Common.IP, {
        "id": "ipv4--ae71927b-78e2-5659-8576-af0dc232b3e9",
        "mscore": 0,
        "type": "ipv4",
        "value": "8.8.8.8",
    ...
    ('google.com', 'domain', Common.Domain, {
        "id": "fqdn--7baea406-cc1b-53f9-b1b2-ea4ad2f56dc1",
        "mscore": 0,
        "type": "fqdn",
        "value": "google.com",
    ...
    ("fe09cf6d3a358305f8c2f687b6f6da02", 'file', Common.File, {
        "id": "md5--e54a4f18-5d4d-56cd-8a41-a96938e9779f",
        "mscore": 100,
        "type": "md5",
        "value": "fe09cf6d3a358305f8c2f687b6f6da02",
    ...
    ("https://google.com", 'url', Common.URL, {
        "id": "url--431bfcd3-a8a5-5103-9ad7-ac7f05891875",
        "mscore": 0,
        "type": "url",
        "value": "https://google.com",
...
def test_fetch_malware_family(mocker):
    ...
    res = ThreatIntelligence.fetch_malware_family(client, {'malware_name': 'A310LOGGER'})
...
def test_fetch_threat_actor(mocker):
    ...
    raw_response = {
        ...
        "aliases": [
            ...
            {
                "name": "Cozy Bear (CrowdStrike)",
                "attribution_scope": "confirmed"
            },
            {
                "name": "Dark Halo (Volexity)",
                "attribution_scope": "confirmed"
            },
            {
                "name": "Dukes (ESET)",
            ...
            {
                "name": "Nobelium (Microsoft)",
                "attribution_scope": "confirmed"
            },
            {
                "name": "Nobelium (Recorded Future)",
                "attribution_scope": "confirmed"
            },
            {
            ...
            {
                "name": "The Dukes (F-Secure)",
                "attribution_scope": "confirmed"
            },
            {
                "name": "The Dukes (Volexity)",
                "attribution_scope": "confirmed"
            }
        ],
        "industries": [
