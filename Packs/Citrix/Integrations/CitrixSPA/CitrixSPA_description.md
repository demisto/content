...
2. If you have access to more than one tenant, their names and Citrix Cloud IDs will be presented to you in a list format for you to select which one you want to sign in to.
3. Once you sign in, the Tenant's Citrix Cloud ID is also presented in the top right corner of the screen.

### Citrix Secure Private Access (SPA) Events

This integration collects Citrix Secure Private Access events from the Citrix Cloud SystemLog API.
