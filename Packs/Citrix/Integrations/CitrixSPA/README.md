Collects Citrix Secure Private Access (SPA) audit and system log events from the Citrix Cloud SystemLog API.

## Configure Citrix SPA in Cortex
...
| Client Secret |  | True |
| Customer ID |  | True |
| Max events per fetch | Maximum number of Citrix SPA SystemLog events per fetch. | False |
...
### Citrix Secure Private Access (SPA) Events

This integration uses the Citrix Cloud SystemLog API to collect Secure Private Access events.
...
For a full list of SPA event types, see the [System Log Events for Secure Private Access](https://docs.citrix.com/en-us/citrix-cloud/citrix-cloud-management/system-log/secure-web-saas-apps-events.html) documentation.

For SPA audit log details, see the [Citrix Secure Private Access Audit Logs](https://docs.citrix.com/en-us/citrix-secure-private-access/service/citrix-secure-private-access-audit-logs) documentation.
...
### citrix-spa-get-events

***
Returns Citrix SPA system log events.
