...
- Added support to **pan-os-delete-rule** to delete additional types of policy rules.  In addition to security policy rules, this command can now also delete the following types:
