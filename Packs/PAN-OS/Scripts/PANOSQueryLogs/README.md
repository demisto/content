...
| polling | Whether to use polling. Default: false. |
| timeout | The timeout (in seconds) when polling. Default: 120. |
| interval_in_seconds | The interval (in seconds) when polling. Default: 10. |
