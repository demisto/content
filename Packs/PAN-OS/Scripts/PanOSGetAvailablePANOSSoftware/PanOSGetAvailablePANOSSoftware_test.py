...
def test_run_command(mocker):
    ...
    mock_execute_command = mocker.patch("PanOSGetAvailablePANOSSoftware.demisto.executeCommand", return_value=sample_command_result)
    ...
    args = {
        "target": "device1",
        "device_filter_string": "filter123",
        "panos_instance_name": "PAN-OS_instance"
    }
