...
def analyze_panorama_rules(rule_hitcount_data: list[dict],
                           ha_state_data: list[dict],
                           system_info: list[dict]) -> tuple[int, list[dict], list[dict]]:
    """
...
def main():
    try:
        ...
        missing_data = [data for data, value in [('RuleHitCount', rule_hitcount_data),
                                                 ('HAState', ha_state_data),
                                                 ('ShowSystemInfo', system_info)] if not value]
        if missing_data:
        ...
        total_panorama_rules, panorama_unused_rules, panorama_used_rules = analyze_panorama_rules(rule_hitcount_data,
                                                                                                  ha_state_data, system_info)
