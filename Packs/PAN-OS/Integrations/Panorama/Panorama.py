...
def main() -> None:
    try:
        ...
        elif command == 'panorama-get-anti-spyware-best-practice':
        ...
        elif command == 'panorama-get-antivirus-best-practice':
        ...
        elif command == 'panorama-show-user-id-interfaces-config':
            show_user_id_interface_config_command(args)

        elif command == 'panorama-show-zones-config':
            show_zone_config_command(args)

        elif command == 'panorama-list-configured-user-id-agents':
            list_configured_user_id_agents_command(args)

        elif command == 'panorama-upload-content-update-file':
            return_results(panorama_upload_content_update_file_command(args))

        elif command == 'panorama-install-file-content-update':
