...
def parse_incident_entries(incident_entries: List[Dict[str, Any]]) -> Tuple[Optional[datetime], Optional[str], List[Dict[str, Any]]]:
    ...
    Returns:
        Tuple[Optional[datetime], Optional[str], List[Dict[str, Any]]]: a tuple of the largest unique id, the largest time generated and the parsed incidents
    """
