...
## Known Limitations
---
The log forwarding profile needs to be configured manually and provided to this playbook as an input. See: [Getting Started Guide](https://docs.paloaltonetworks.com/cortex/cortex-data-lake/cortex-data-lake-getting-started/get-started-with-cortex-data-lake).
