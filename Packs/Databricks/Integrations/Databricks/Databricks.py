...
class DatabricksClient(ContentClient):
    ...
    def resize_cluster(self, cluster_id: str, **kwargs) -> dict:
        return self._http_request("POST", "/api/2.1/clusters/resize", json_data=assign_params(cluster_id=cluster_id, **kwargs))
    ...
    def change_cluster_owner(self, cluster_id: str, owner_username: str) -> dict:
        return self._http_request(
            "POST", "/api/2.1/clusters/change-owner", json_data={"cluster_id": cluster_id, "owner_username": owner_username}
        )
    ...
    def update_cluster(self, cluster_id: str, **kwargs) -> dict:
        return self._http_request("POST", "/api/2.1/clusters/update", json_data=assign_params(cluster_id=cluster_id, **kwargs))
    ...
    def create_cluster_policy(self, name: str, definition: str) -> dict:
        return self._http_request("POST", "/api/2.0/policies/clusters/create", json_data={"name": name, "definition": definition})
    ...
    def delete_cluster_policy(self, policy_id: str) -> dict:
        return self._http_request("POST", "/api/2.0/policies/clusters/delete", json_data={"policy_id": policy_id})

    # ---- Instance Pools (API 2.0) ----

    def get_instance_pool(self, instance_pool_id: str) -> dict:
        return self._http_request("GET", "/api/2.0/instance-pools/get", params={"instance_pool_id": instance_pool_id})
    ...
    def delete_instance_pool(self, instance_pool_id: str) -> dict:
        return self._http_request("POST", "/api/2.0/instance-pools/delete", json_data={"instance_pool_id": instance_pool_id})

    # ---- Libraries (API 2.0) ----

    def get_library_status(self, cluster_id: str) -> dict:
        return self._http_request("GET", "/api/2.0/libraries/cluster-status", params={"cluster_id": cluster_id})
    ...
    def install_libraries(self, cluster_id: str, libraries: list) -> dict:
        return self._http_request(
            "POST", "/api/2.0/libraries/install", json_data={"cluster_id": cluster_id, "libraries": libraries}
        )

    def uninstall_libraries(self, cluster_id: str, libraries: list) -> dict:
        return self._http_request(
            "POST", "/api/2.0/libraries/uninstall", json_data={"cluster_id": cluster_id, "libraries": libraries}
        )

    # ---- Command Execution (API 1.2) ----

    def create_context(self, cluster_id: str, language: str) -> dict:
        return self._http_request("POST", "/api/1.2/contexts/create", json_data={"clusterId": cluster_id, "language": language})

    def destroy_context(self, cluster_id: str, context_id: str) -> dict:
        return self._http_request(
            "POST", "/api/1.2/contexts/destroy", json_data={"clusterId": cluster_id, "contextId": context_id}
        )

    def get_context_status(self, cluster_id: str, context_id: str) -> dict:
        return self._http_request("GET", "/api/1.2/contexts/status", params={"clusterId": cluster_id, "contextId": context_id})

    def execute_command(self, cluster_id: str, context_id: str, language: str, command: str) -> dict:
        return self._http_request(
            "POST",
            "/api/1.2/commands/execute",
            json_data={"clusterId": cluster_id, "contextId": context_id, "language": language, "command": command},
        )

    def get_command_status(self, cluster_id: str, command_id: str, context_id: str) -> dict:
        return self._http_request(
            "GET", "/api/1.2/commands/status", params={"clusterId": cluster_id, "commandId": command_id, "contextId": context_id}
        )
    ...
    def cancel_command(self, cluster_id: str, command_id: str, context_id: str) -> dict:
        return self._http_request(
            ...
            json_data={"clusterId": cluster_id, "commandId": command_id, "contextId": context_id},
        )
    ...
    def reset_job(self, job_id: str, new_settings: dict) -> dict:
        return self._http_request("POST", "/api/2.2/jobs/reset", json_data={"job_id": int(job_id), "new_settings": new_settings})

    def update_job(self, job_id: str, fields_to_update: dict) -> dict:
        return self._http_request("POST", "/api/2.2/jobs/update", json_data={"job_id": int(job_id), **fields_to_update})
    ...
    def run_job_now(self, job_id: str, **kwargs) -> dict:
        return self._http_request("POST", "/api/2.2/jobs/run-now", json_data=assign_params(job_id=int(job_id), **kwargs))
    ...
    def update_pipeline(self, pipeline_id: str, **kwargs) -> dict:
        return self._http_request("PUT", f"/api/2.0/pipelines/{pipeline_id}", json_data=assign_params(**kwargs))
    ...
    def start_pipeline(self, pipeline_id: str, **kwargs) -> dict:
        return self._http_request("POST", f"/api/2.0/pipelines/{pipeline_id}/updates", json_data=assign_params(**kwargs))
    ...
    def get_pipeline_events(self, pipeline_id: str, **kwargs) -> dict:
        return self._http_request("GET", f"/api/2.0/pipelines/{pipeline_id}/events", params=assign_params(**kwargs))

    def list_pipeline_updates(self, pipeline_id: str, **kwargs) -> dict:
        return self._http_request("GET", f"/api/2.0/pipelines/{pipeline_id}/updates", params=assign_params(**kwargs))
    ...
    def dbfs_read(self, path: str, offset: int = None, length: int = None) -> dict:
        return self._http_request("GET", "/api/2.0/dbfs/read", params=assign_params(path=path, offset=offset, length=length))

    def dbfs_create(self, path: str, overwrite: bool = None) -> dict:
        return self._http_request("POST", "/api/2.0/dbfs/create", json_data=assign_params(path=path, overwrite=overwrite))

    def dbfs_add_block(self, handle: int, data: str) -> dict:
        return self._http_request("POST", "/api/2.0/dbfs/add-block", json_data={"handle": handle, "data": data})
    ...
    def dbfs_put(self, path: str, contents: str = None, overwrite: bool = None) -> dict:
        return self._http_request(
            "POST", "/api/2.0/dbfs/put", json_data=assign_params(path=path, contents=contents, overwrite=overwrite)
        )

    def dbfs_delete(self, path: str, recursive: bool = None) -> dict:
        return self._http_request("POST", "/api/2.0/dbfs/delete", json_data=assign_params(path=path, recursive=recursive))
    ...
    def dbfs_move(self, source_path: str, destination_path: str) -> dict:
        return self._http_request(
            "POST", "/api/2.0/dbfs/move", json_data={"source_path": source_path, "destination_path": destination_path}
        )
    ...
    def workspace_export(self, path: str, format_str: str = None) -> dict:
        return self._http_request("GET", "/api/2.0/workspace/export", params=assign_params(path=path, format=format_str))

    def workspace_import(self, path: str, content: str, **kwargs) -> dict:
        return self._http_request(
            "POST", "/api/2.0/workspace/import", json_data=assign_params(path=path, content=content, **kwargs)
        )

    def workspace_delete(self, path: str, recursive: bool = None) -> dict:
        return self._http_request("POST", "/api/2.0/workspace/delete", json_data=assign_params(path=path, recursive=recursive))
    ...
    def update_git_credential(self, credential_id: str, **kwargs) -> dict:
        return self._http_request("PATCH", f"/api/2.0/git-credentials/{credential_id}", json_data=assign_params(**kwargs))
    ...
    def edit_warehouse(self, warehouse_id: str, **kwargs) -> dict:
        return self._http_request("POST", f"/api/2.0/sql/warehouses/{warehouse_id}/edit", json_data=assign_params(**kwargs))
    ...
    def execute_sql_statement(self, warehouse_id: str, statement: str, **kwargs) -> dict:
        return self._http_request(
            "POST", "/api/2.0/sql/statements", json_data=assign_params(warehouse_id=warehouse_id, statement=statement, **kwargs)
        )
    ...
    def get_sql_result_chunk(self, statement_id: str, chunk_index: int) -> dict:
        return self._http_request("GET", f"/api/2.0/sql/statements/{statement_id}/result/chunks/{chunk_index}")
    ...
    def update_sql_query(self, query_id: str, **kwargs) -> dict:
        return self._http_request("PATCH", f"/api/2.0/sql/queries/{query_id}", json_data=assign_params(**kwargs))
    ...
    def update_sql_alert(self, alert_id: str, **kwargs) -> dict:
        return self._http_request("PATCH", f"/api/2.0/sql/alerts/{alert_id}", json_data=assign_params(**kwargs))
    ...
    def update_serving_endpoint_config(self, name: str, served_entities: list) -> dict:
        return self._http_request(
            "PUT", f"/api/2.0/serving-endpoints/{name}/config", json_data={"served_entities": served_entities}
        )
    ...
    def query_serving_endpoint(self, name: str, inputs: dict) -> dict:
        return self._http_request("POST", f"/api/2.0/serving-endpoints/{name}/invocations", json_data=inputs)

    def get_serving_endpoint_logs(self, name: str, served_model_name: str) -> dict:
        return self._http_request("GET", f"/api/2.0/serving-endpoints/{name}/served-models/{served_model_name}/logs")
    ...
    def create_vector_search_endpoint(self, name: str, endpoint_type: str) -> dict:
        return self._http_request(
            "POST", "/api/2.0/vector-search/endpoints", json_data={"name": name, "endpoint_type": endpoint_type}
        )
    ...
    def get_mlflow_metric_history(self, run_id: str, metric_key: str) -> dict:
        return self._http_request(
            "GET", "/api/2.0/mlflow/metrics/get-history", params=assign_params(run_id=run_id, metric_key=metric_key)
        )

    def list_mlflow_models(self, **kwargs) -> dict:
        return self._http_request("GET", "/api/2.0/mlflow/registered-models/list", params=assign_params(**kwargs))

    def get_mlflow_model(self, name: str) -> dict:
        return self._http_request("GET", "/api/2.0/mlflow/databricks/registered-models/get", params={"name": name})

    def create_mlflow_model_version(self, **kwargs) -> dict:
        return self._http_request("POST", "/api/2.0/mlflow/model-versions/create", json_data=assign_params(**kwargs))

    def get_mlflow_model_version(self, name: str, version: str) -> dict:
        return self._http_request("GET", "/api/2.0/mlflow/model-versions/get", params={"name": name, "version": version})

    def search_mlflow_model_versions(self, **kwargs) -> dict:
        return self._http_request("GET", "/api/2.0/mlflow/model-versions/search", params=assign_params(**kwargs))

    def delete_mlflow_model_version(self, name: str, version: str) -> dict:
        return self._http_request("DELETE", "/api/2.0/mlflow/model-versions/delete", params={"name": name, "version": version})
    ...
    def transition_mlflow_model_version_stage(self, name: str, version: str, stage: str) -> dict:
        return self._http_request(
            ...
            json_data={"name": name, "version": version, "stage": stage, "archive_existing_versions": True},
        )
    ...
    def create_catalog(self, **kwargs) -> dict:
        return self._http_request("POST", "/api/2.1/unity-catalog/catalogs", json_data=assign_params(**kwargs))

    def update_catalog(self, name: str, **kwargs) -> dict:
        return self._http_request("PATCH", f"/api/2.1/unity-catalog/catalogs/{name}", json_data=assign_params(**kwargs))

    def delete_catalog(self, name: str, force: bool = None) -> dict:
        return self._http_request("DELETE", f"/api/2.1/unity-catalog/catalogs/{name}", params=assign_params(force=force))
    ...
    def list_schemas(self, catalog_name: str) -> dict:
        return self._http_request("GET", "/api/2.1/unity-catalog/schemas", params={"catalog_name": catalog_name})

    def create_schema(self, **kwargs) -> dict:
        return self._http_request("POST", "/api/2.1/unity-catalog/schemas", json_data=assign_params(**kwargs))

    def update_schema(self, full_name: str, **kwargs) -> dict:
        return self._http_request("PATCH", f"/api/2.1/unity-catalog/schemas/{full_name}", json_data=assign_params(**kwargs))
    ...
    def list_tables(self, catalog_name: str, schema_name: str, **kwargs) -> dict:
        return self._http_request(
            ...
            params=assign_params(catalog_name=catalog_name, schema_name=schema_name, **kwargs),
        )
    ...
    def list_table_summaries(self, catalog_name: str, **kwargs) -> dict:
        return self._http_request(
            "GET", "/api/2.1/unity-catalog/table-summaries", params=assign_params(catalog_name=catalog_name, **kwargs)
        )
    ...
    def list_volumes(self, catalog_name: str, schema_name: str) -> dict:
        return self._http_request(
            "GET", "/api/2.1/unity-catalog/volumes", params=assign_params(catalog_name=catalog_name, schema_name=schema_name)
        )

    def create_volume(self, **kwargs) -> dict:
        return self._http_request("POST", "/api/2.1/unity-catalog/volumes", json_data=assign_params(**kwargs))

    def update_volume(self, full_name: str, **kwargs) -> dict:
        return self._http_request("PATCH", f"/api/2.1/unity-catalog/volumes/{full_name}", json_data=assign_params(**kwargs))
    ...
    def get_grants(self, securable_type: str, full_name: str) -> dict:
        return self._http_request("GET", f"/api/2.1/unity-catalog/permissions/{securable_type}/{full_name}")

    def update_grants(self, securable_type: str, full_name: str, changes: list) -> dict:
        return self._http_request(
            "PATCH", f"/api/2.1/unity-catalog/permissions/{securable_type}/{full_name}", json_data={"changes": changes}
        )
    ...
    def list_users(self, **kwargs) -> dict:
        return self._http_request("GET", "/api/2.0/preview/scim/v2/Users", params=assign_params(**kwargs))

    def create_user(self, **kwargs) -> dict:
        return self._http_request("POST", "/api/2.0/preview/scim/v2/Users", json_data=assign_params(**kwargs))

    def update_user(self, user_id: str, **kwargs) -> dict:
        return self._http_request("PATCH", f"/api/2.0/preview/scim/v2/Users/{user_id}", json_data=assign_params(**kwargs))
    ...
    def list_groups(self, **kwargs) -> dict:
        return self._http_request("GET", "/api/2.0/preview/scim/v2/Groups", params=assign_params(**kwargs))

    def create_group(self, **kwargs) -> dict:
        return self._http_request("POST", "/api/2.0/preview/scim/v2/Groups", json_data=assign_params(**kwargs))

    def update_group(self, group_id: str, **kwargs) -> dict:
        return self._http_request("PATCH", f"/api/2.0/preview/scim/v2/Groups/{group_id}", json_data=assign_params(**kwargs))
    ...
    def list_service_principals(self, **kwargs) -> dict:
        return self._http_request("GET", "/api/2.0/preview/scim/v2/ServicePrincipals", params=assign_params(**kwargs))

    def create_service_principal(self, **kwargs) -> dict:
        return self._http_request("POST", "/api/2.0/preview/scim/v2/ServicePrincipals", json_data=assign_params(**kwargs))

    def update_service_principal(self, sp_id: str, **kwargs) -> dict:
        return self._http_request(
            "PATCH", f"/api/2.0/preview/scim/v2/ServicePrincipals/{sp_id}", json_data=assign_params(**kwargs)
        )
    ...
    def set_permissions(self, object_type: str, object_id: str, access_control_list: list) -> dict:
        return self._http_request(
            "PUT", f"/api/2.0/permissions/{object_type}/{object_id}", json_data={"access_control_list": access_control_list}
        )

    def update_permissions(self, object_type: str, object_id: str, access_control_list: list) -> dict:
        return self._http_request(
            "PATCH", f"/api/2.0/permissions/{object_type}/{object_id}", json_data={"access_control_list": access_control_list}
        )
    ...
    def update_token(self, token_id: str, **kwargs) -> dict:
        return self._http_request("PATCH", f"/api/2.0/token/{token_id}", json_data=assign_params(**kwargs))
    ...
    def put_secret(self, scope: str, key: str, string_value: str = None) -> dict:
        return self._http_request(
            "POST", "/api/2.0/secrets/put", json_data=assign_params(scope=scope, key=key, string_value=string_value)
        )

    def delete_secret(self, scope: str, key: str) -> dict:
        return self._http_request("POST", "/api/2.0/secrets/delete", json_data={"scope": scope, "key": key})
    ...
    def create_secret_scope(self, scope: str, initial_manage_principal: str = None) -> dict:
        return self._http_request(
            ...
            json_data=assign_params(scope=scope, initial_manage_principal=initial_manage_principal),
        )
    ...
    def delete_secret_scope(self, scope: str) -> dict:
        return self._http_request("POST", "/api/2.0/secrets/scopes/delete", json_data={"scope": scope})

    def get_secret_acl(self, scope: str, principal: str) -> dict:
        return self._http_request("GET", "/api/2.0/secrets/acls/get", params={"scope": scope, "principal": principal})
    ...
    def put_secret_acl(self, scope: str, principal: str, permission: str) -> dict:
        return self._http_request(
            "POST", "/api/2.0/secrets/acls/put", json_data={"scope": scope, "principal": principal, "permission": permission}
        )

    def delete_secret_acl(self, scope: str, principal: str) -> dict:
        return self._http_request("POST", "/api/2.0/secrets/acls/delete", json_data={"scope": scope, "principal": principal})
    ...
    def list_dashboards(self, **kwargs) -> dict:
        return self._http_request("GET", "/api/2.0/lakeview/dashboards", params=assign_params(**kwargs))

    def create_dashboard(self, **kwargs) -> dict:
        return self._http_request("POST", "/api/2.0/lakeview/dashboards", json_data=assign_params(**kwargs))

    def update_dashboard(self, dashboard_id: str, **kwargs) -> dict:
        return self._http_request("PATCH", f"/api/2.0/lakeview/dashboards/{dashboard_id}", json_data=assign_params(**kwargs))
    ...
    def migrate_dashboard(self, source_dashboard_id: str) -> dict:
        return self._http_request(
            "POST", "/api/2.0/lakeview/dashboards/migrate", json_data={"source_dashboard_id": source_dashboard_id}
        )

    def publish_dashboard(self, dashboard_id: str, **kwargs) -> dict:
        return self._http_request(
            "POST", f"/api/2.0/lakeview/dashboards/{dashboard_id}/published", json_data=assign_params(**kwargs)
        )
    ...
    def create_global_init_script(self, **kwargs) -> dict:
        return self._http_request("POST", "/api/2.0/global-init-scripts", json_data=assign_params(**kwargs))

    def update_global_init_script(self, script_id: str, **kwargs) -> dict:
        return self._http_request("PATCH", f"/api/2.0/global-init-scripts/{script_id}", json_data=assign_params(**kwargs))
    ...
    def create_ip_access_list(self, **kwargs) -> dict:
        return self._http_request("POST", "/api/2.0/ip-access-lists", json_data=assign_params(**kwargs))

    def update_ip_access_list(self, ip_access_list_id: str, **kwargs) -> dict:
        return self._http_request("PATCH", f"/api/2.0/ip-access-lists/{ip_access_list_id}", json_data=assign_params(**kwargs))
...
def cluster_list_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "Clusters",
            clusters,
            headers=["cluster_id", "cluster_name", "state", "creator_user_name", "spark_version", "node_type_id"],
            removeNull=True,
        ),
        outputs_prefix="Databricks.Cluster",
        outputs_key_field="cluster_id",
...
def cluster_change_owner_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(readable_output=f"Cluster {args['cluster_id']} owner changed to {args['owner_username']}.")
...
def cluster_list_zones_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown("Available Zones", [{"zone": z} for z in zones], headers=["zone"]),
...
def cluster_policy_get_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "Cluster Policy", result, headers=["policy_id", "name", "creator_user_name", "created_at_timestamp"], removeNull=True
        ),
...
def cluster_policy_list_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "Cluster Policies", policies, headers=["policy_id", "name", "creator_user_name"], removeNull=True
        ),
        outputs_prefix="Databricks.ClusterPolicy",
        outputs_key_field="policy_id",
        outputs=policies,
...
def cluster_policy_edit_command(client: DatabricksClient, args: dict) -> CommandResults:
    client.edit_cluster_policy(args["policy_id"], name=args.get("name"), definition=args.get("definition"))
...
def instance_pool_get_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "Instance Pool",
            result,
            headers=["instance_pool_id", "instance_pool_name", "node_type_id", "min_idle_instances", "max_capacity", "state"],
            removeNull=True,
        ),
...
def instance_pool_list_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "Instance Pools", pools, headers=["instance_pool_id", "instance_pool_name", "node_type_id", "state"], removeNull=True
        ),
        outputs_prefix="Databricks.InstancePool",
        outputs_key_field="instance_pool_id",
        outputs=pools,
...
def library_cluster_status_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "Library Statuses", statuses, headers=["library", "status", "is_library_for_all_clusters"], removeNull=True
        ),
...
def library_all_cluster_statuses_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "All Cluster Library Statuses", statuses, headers=["cluster_id", "library_statuses"], removeNull=True
        ),
...
def context_status_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown("Context Status", result, headers=["id", "status"], removeNull=True),
        outputs_prefix="Databricks.Context",
        outputs_key_field="id",
        outputs=result,
    )
...
def command_execute_command(client: DatabricksClient, args: dict) -> CommandResults:
    result = client.execute_command(args["cluster_id"], args["context_id"], args["language"], args["command"])
    return CommandResults(
...
def command_status_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown("Command Status", result, headers=["id", "status", "results"], removeNull=True),
        outputs_prefix="Databricks.Command",
        outputs_key_field="id",
        outputs=result,
    )
...
def job_get_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    convert_epoch_fields(result)
    return CommandResults(
        readable_output=tableToMarkdown("Job", result, headers=["job_id", "creator_user_name", "created_time"], removeNull=True),
...
def job_list_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown("Jobs", jobs, headers=["job_id", "creator_user_name", "created_time"], removeNull=True),
        outputs_prefix="Databricks.Job",
        outputs_key_field="job_id",
        outputs=jobs,
    )
...
def pipeline_get_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "Pipeline", result, headers=["pipeline_id", "name", "state", "creator_user_name", "cluster_id"], removeNull=True
        ),
...
def pipeline_list_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "Pipelines", pipelines, headers=["pipeline_id", "name", "state", "creator_user_name"], removeNull=True
        ),
        outputs_prefix="Databricks.Pipeline",
        outputs_key_field="pipeline_id",
        outputs=pipelines,
...
def pipeline_events_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "Pipeline Events", events, headers=["id", "timestamp", "event_type", "message", "level"], removeNull=True
        ),
...
def pipeline_list_updates_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "Pipeline Updates", updates, headers=["update_id", "state", "creation_time"], removeNull=True
        ),
        outputs_prefix="Databricks.PipelineUpdate",
        outputs_key_field="update_id",
        outputs=updates,
...
def pipeline_get_update_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "Pipeline Update", update, headers=["update_id", "state", "creation_time"], removeNull=True
        ),
        outputs_prefix="Databricks.PipelineUpdate",
        outputs_key_field="update_id",
        outputs=update,
...
def pipeline_apply_environment_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(readable_output=f"Environment applied to pipeline {args['pipeline_id']}.")
...
def dbfs_get_status_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "DBFS Status", result, headers=["path", "is_dir", "file_size", "modification_time"], removeNull=True
        ),
...
def dbfs_list_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "DBFS Contents", files, headers=["path", "is_dir", "file_size", "modification_time"], removeNull=True
        ),
        outputs_prefix="Databricks.DBFS",
        outputs_key_field="path",
        outputs=files,
...
def dbfs_read_command(client: DatabricksClient, args: dict) -> CommandResults:
    result = client.dbfs_read(args["path"], offset=arg_to_number(args.get("offset")), length=arg_to_number(args.get("length")))
    return CommandResults(
        readable_output=tableToMarkdown("DBFS Read", result, headers=["bytes_read", "data"], removeNull=True),
...
def dbfs_add_block_command(client: DatabricksClient, args: dict) -> CommandResults:
    client.dbfs_add_block(int(arg_to_number(args["handle"]) or 0), args["data"])
...
def dbfs_close_command(client: DatabricksClient, args: dict) -> CommandResults:
    client.dbfs_close(int(arg_to_number(args["handle"]) or 0))
...
def dbfs_move_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(readable_output=f"Moved {args['source_path']} to {args['destination_path']}.")
...
def workspace_get_status_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "Workspace Object", result, headers=["object_type", "path", "object_id", "language"], removeNull=True
        ),
...
def workspace_list_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "Workspace Contents", objects, headers=["object_type", "path", "object_id", "language"], removeNull=True
        ),
        outputs_prefix="Databricks.WorkspaceObject",
        outputs_key_field="object_id",
        outputs=objects,
...
def git_credential_get_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "Git Credential", result, headers=["credential_id", "git_username", "git_provider"], removeNull=True
        ),
...
def git_credential_list_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "Git Credentials", creds, headers=["credential_id", "git_username", "git_provider"], removeNull=True
        ),
        outputs_prefix="Databricks.GitCredential",
        outputs_key_field="credential_id",
        outputs=creds,
...
def repo_get_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "Repo", result, headers=["id", "url", "provider", "path", "branch", "head_commit_id"], removeNull=True
        ),
...
def repo_list_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown("Repos", repos, headers=["id", "url", "provider", "path", "branch"], removeNull=True),
        outputs_prefix="Databricks.Repo",
        outputs_key_field="id",
        outputs=repos,
    )
...
def repo_create_command(client: DatabricksClient, args: dict) -> CommandResults:
    kwargs = assign_params(url=args.get("url"), provider=args.get("provider"), path=args.get("path"))
...
def warehouse_get_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "Warehouse",
            result,
            headers=["id", "name", "cluster_size", "state", "num_clusters", "creator_name", "num_active_sessions"],
            removeNull=True,
        ),
...
def warehouse_list_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "Warehouses", warehouses, headers=["id", "name", "cluster_size", "state", "num_clusters"], removeNull=True
        ),
        outputs_prefix="Databricks.Warehouse",
        outputs_key_field="id",
        outputs=warehouses,
...
def warehouse_create_command(client: DatabricksClient, args: dict) -> CommandResults:
    kwargs = assign_params(
        ...
        enable_serverless_compute=argToBoolean(args["enable_serverless_compute"])
        if args.get("enable_serverless_compute")
        else None,
    )
...
def sql_statement_execute_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown("SQL Statement", result, headers=["statement_id", "status"], removeNull=True),
...
def sql_statement_get_status_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown("SQL Statement Status", result, headers=["statement_id", "status"], removeNull=True),
        outputs_prefix="Databricks.SQLStatement",
        outputs_key_field="statement_id",
        outputs=result,
    )
...
def sql_statement_get_result_chunk_command(client: DatabricksClient, args: dict) -> CommandResults:
    result = client.get_sql_result_chunk(args["statement_id"], int(arg_to_number(args["chunk_index"]) or 0))
    return CommandResults(
        readable_output=tableToMarkdown(
            "SQL Result Chunk", result, headers=["chunk_index", "row_offset", "row_count"], removeNull=True
        ),
...
def sql_query_get_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "SQL Query", result, headers=["id", "name", "query", "description", "warehouse_id", "parent_path"], removeNull=True
        ),
...
def sql_query_list_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "SQL Queries", queries, headers=["id", "name", "description", "warehouse_id"], removeNull=True
        ),
        outputs_prefix="Databricks.SQLQuery",
        outputs_key_field="id",
        outputs=queries,
...
def sql_query_history_list_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "SQL Query History",
            queries,
            headers=["query_id", "query_text", "status", "user_name", "warehouse_id", "execution_end_time_ms", "duration"],
            removeNull=True,
        ),
...
def serving_endpoint_list_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "Serving Endpoints", endpoints, headers=["name", "creator", "creation_timestamp", "state"], removeNull=True
        ),
...
def serving_endpoint_get_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "Serving Endpoint", result, headers=["name", "creator", "creation_timestamp", "state"], removeNull=True
        ),
        outputs_prefix="Databricks.ServingEndpoint",
        outputs_key_field="name",
        outputs=result,
...
def vector_search_endpoint_list_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "Vector Search Endpoints", endpoints, headers=["name", "endpoint_type", "state"], removeNull=True
        ),
...
def vector_search_endpoint_get_metrics_command(client: DatabricksClient, args: dict) -> CommandResults:
...
def mlflow_metric_history_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "MLflow Metric History", metrics, headers=["key", "value", "timestamp", "step"], removeNull=True
        ),
...
def mlflow_model_list_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "MLflow Models",
            models,
            headers=["name", "creation_timestamp", "last_updated_timestamp", "user_id", "description"],
            removeNull=True,
        ),
...
def mlflow_model_version_get_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            ...
            version,
            headers=["name", "version", "creation_timestamp", "current_stage", "source", "run_id", "status"],
            removeNull=True,
        ),
        outputs_prefix="Databricks.MLflowModelVersion",
        outputs_key_field="version",
...
def mlflow_model_version_search_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "MLflow Model Versions", versions, headers=["name", "version", "current_stage", "status", "source"], removeNull=True
        ),
        outputs_prefix="Databricks.MLflowModelVersion",
        outputs_key_field="version",
        outputs=versions,
...
def mlflow_model_version_delete_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(readable_output=f"Model version {args['name']} v{args['version']} deleted.")


def mlflow_model_version_transition_stage_command(client: DatabricksClient, args: dict) -> CommandResults:
    result = client.transition_mlflow_model_version_stage(args["name"], args["version"], args["stage"])
    version = result.get("model_version", result)
    return CommandResults(
...
def catalog_get_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "Catalog", result, headers=["name", "owner", "comment", "metastore_id", "created_at", "created_by"], removeNull=True
        ),
...
def catalog_list_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "Catalogs", catalogs, headers=["name", "owner", "comment", "created_at"], removeNull=True
        ),
        outputs_prefix="Databricks.Catalog",
        outputs_key_field="name",
        outputs=catalogs,
...
def catalog_update_command(client: DatabricksClient, args: dict) -> CommandResults:
    kwargs = assign_params(new_name=args.get("new_name"), comment=args.get("comment"), owner=args.get("owner"))
...
def schema_get_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "Schema", result, headers=["name", "catalog_name", "owner", "comment", "full_name", "created_at"], removeNull=True
        ),
...
def schema_list_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "Schemas", schemas, headers=["name", "catalog_name", "owner", "comment", "full_name"], removeNull=True
        ),
        outputs_prefix="Databricks.Schema",
        outputs_key_field="full_name",
        outputs=schemas,
...
def schema_create_command(client: DatabricksClient, args: dict) -> CommandResults:
    kwargs = assign_params(name=args.get("name"), catalog_name=args.get("catalog_name"), comment=args.get("comment"))
...
def table_list_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "Tables", tables, headers=["name", "catalog_name", "schema_name", "table_type", "data_source_format"], removeNull=True
        ),
        outputs_prefix="Databricks.Table",
        outputs_key_field="full_name",
        outputs=tables,
...
def table_summaries_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown("Table Summaries", summaries, headers=["full_name", "table_type"], removeNull=True),
...
def volume_get_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "Volume",
            result,
            headers=["name", "catalog_name", "schema_name", "volume_type", "storage_location", "owner", "created_at"],
            removeNull=True,
        ),
...
def volume_list_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "Volumes", volumes, headers=["name", "catalog_name", "schema_name", "volume_type"], removeNull=True
        ),
        outputs_prefix="Databricks.Volume",
        outputs_key_field="full_name",
        outputs=volumes,
...
def grant_get_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown("Grants", grants, headers=["principal", "privileges"], removeNull=True),
...
def user_get_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown("User", result, headers=["id", "userName", "displayName", "active"], removeNull=True),
...
def user_list_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown("Users", users, headers=["id", "userName", "displayName", "active"], removeNull=True),
        outputs_prefix="Databricks.User",
        outputs_key_field="id",
        outputs=users,
    )
...
def user_update_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    if args.get("active"):
        operations.append({"op": "replace", "path": "active", "value": argToBoolean(args["active"])})
    kwargs = {
...
def group_get_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown("Group", result, headers=["id", "displayName", "members"], removeNull=True),
...
def group_list_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown("Groups", groups, headers=["id", "displayName"], removeNull=True),
        outputs_prefix="Databricks.Group",
        outputs_key_field="id",
        outputs=groups,
    )
...
def service_principal_get_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "Service Principal", result, headers=["id", "applicationId", "displayName", "active"], removeNull=True
        ),
...
def service_principal_list_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "Service Principals", sps, headers=["id", "applicationId", "displayName", "active"], removeNull=True
        ),
        outputs_prefix="Databricks.ServicePrincipal",
        outputs_key_field="id",
        outputs=sps,
...
def permissions_get_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "Permissions", result, headers=["object_id", "object_type", "access_control_list"], removeNull=True
        ),
...
def token_list_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "Tokens", tokens, headers=["token_id", "creation_time", "expiry_time", "comment"], removeNull=True
        ),
...
def secret_list_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown("Secrets", secrets, headers=["key", "last_updated_timestamp"], removeNull=True),
...
def secret_scope_create_command(client: DatabricksClient, args: dict) -> CommandResults:
    client.create_secret_scope(args["scope"], initial_manage_principal=args.get("initial_manage_principal"))
...
def secret_scope_list_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown("Secret Scopes", scopes, headers=["name", "backend_type"], removeNull=True),
...
def secret_acl_get_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown("Secret ACL", result, headers=["principal", "permission"], removeNull=True),
...
def secret_acl_list_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown("Secret ACLs", acls, headers=["principal", "permission"], removeNull=True),
        outputs_prefix="Databricks.SecretACL",
        outputs=acls,
    )
...
def secret_acl_delete_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(readable_output=f"ACL deleted for '{args['principal']}' on scope '{args['scope']}'.")
...
def dashboard_get_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "Dashboard",
            result,
            headers=["dashboard_id", "display_name", "warehouse_id", "path", "create_time", "update_time"],
            removeNull=True,
        ),
...
def dashboard_list_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "Dashboards", dashboards, headers=["dashboard_id", "display_name", "warehouse_id", "path"], removeNull=True
        ),
        outputs_prefix="Databricks.Dashboard",
        outputs_key_field="dashboard_id",
        outputs=dashboards,
...
def global_init_script_list_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "Global Init Scripts", scripts, headers=["script_id", "name", "position", "enabled", "created_at"], removeNull=True
        ),
        outputs_prefix="Databricks.GlobalInitScript",
        outputs_key_field="script_id",
        outputs=scripts,
...
def ip_access_list_get_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "IP Access List",
            ip_list,
            headers=["list_id", "label", "list_type", "ip_addresses", "address_count", "created_at", "created_by", "enabled"],
            removeNull=True,
        ),
...
def ip_access_list_list_command(client: DatabricksClient, args: dict) -> CommandResults:
    ...
    return CommandResults(
        readable_output=tableToMarkdown(
            "IP Access Lists", lists, headers=["list_id", "label", "list_type", "address_count", "enabled"], removeNull=True
        ),
        outputs_prefix="Databricks.IPAccessList",
        outputs_key_field="list_id",
        outputs=lists,
...
def fetch_incidents(client: DatabricksClient, params: dict, last_run: dict) -> tuple:
    ...
    demisto.debug(
        f"fetch_incidents started: last_fetch_time={last_fetch_time}, max_fetch={max_fetch}, " f"seen_ids_count={len(seen_ids)}"
    )
    ...
    demisto.info(f"fetch_incidents completed: fetched {len(incidents)} incidents, " f"new last_fetch_time={new_last_fetch}")
