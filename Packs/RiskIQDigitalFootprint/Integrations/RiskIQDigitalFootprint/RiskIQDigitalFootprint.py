...
def prepare_context_dict(
    response_dict: Dict[str, Any], keys_with_hierarchy: Union[tuple, str] = (), exclude_keys: Union[tuple, str] = ()
) -> Dict[str, str]:
    """
...
def get_standard_context_ip_for_get_asset(record: Dict[str, Any]) -> list:
    ...
    """
    standard_context_ip: List[Union[Common.IP, Common.CVE]] = [
        Common.IP(
            ip=record.get("name"),
...
def get_standard_context_url_for_get_asset(record: Dict[str, Any]) -> list:
    ...
    """
    standard_context_url: List[Union[Common.URL, Common.CVE]] = [
        Common.URL(
            url=record.get("name"),
            dbot_score=Common.DBotScore(
                indicator=record.get("name", ""),
...
def get_asset_custom_context_for_services_and_web_components(
    resp: Dict[str, Any], key: str, exclude_keys: Union[tuple, str]
) -> List[Dict[str, Any]]:
    """
