...
report_list_args = [
    ({"program_handle": " abc , xyz", "filter_by_keyword": "abc"},
     {"filter[program][]": ["abc", "xyz"], "filter[keyword]": "abc", 'page[size]': 50, 'page[number]': 0}),
    ({"program_handle": "abc", "sort_by": "swag_awarded_at"},
     {"filter[program][]": ["abc"], "sort": ["reports.swag_awarded_at"], 'page[size]': 50, 'page[number]': 0}),
    ({"program_handle": "abc", "sort_by": "-swag_awarded_at"},
     {"filter[program][]": ["abc"], "sort": ["-reports.swag_awarded_at"], 'page[size]': 50, 'page[number]': 0,}),
    ({"program_handle": "abc", "sort_by": "swag_awarded_at,-first_program_activity_at"},
     {"filter[program][]": ["abc"], "sort": ["reports.swag_awarded_at", "-reports.first_program_activity_at"],
      'page[size]': 50, 'page[number]': 0}),
    ({"program_handle": "ignored", "advanced_filter": '{"filter[reporter][]": "abc", "filter[program][]": "abc"}'},
     {"filter[program][]": ["abc"], "filter[reporter][]": ["abc"], 'page[size]': 50, 'page[number]': 0}),
    ({"program_handle": "abc", "advanced_filter": '{"filter[hacker_published]": "true"}'},
     {"filter[program][]": ["abc"], "filter[hacker_published]": "true", 'page[size]': 50, 'page[number]': 0}),
    ({"program_handle": "abc", "state": "new"},
     {"filter[program][]": ["abc"], "filter[state][]": ["new"], 'page[size]': 50, 'page[number]': 0}),
    ({"program_handle": "abc", "state": "new,resolved"},
     {"filter[program][]": ["abc"], "filter[state][]": ["new", "resolved"], 'page[size]': 50, 'page[number]': 0}),
    ({"program_handle": "abc", "severity": "low"},
     {"filter[program][]": ["abc"], "filter[severity][]": ["low"], 'page[size]': 50, 'page[number]': 0}),
    ({"program_handle": "abc", "severity": "low,medium"},
     {"filter[program][]": ["abc"], "filter[severity][]": ["low", "medium"], 'page[size]': 50, 'page[number]': 0}),
    ({"program_handle": "abc", "severity": "low,medium", "advanced_filter": '{"filter[severity][]": "high"}'},
     {"filter[program][]": ["abc"], "filter[severity][]": ["high"], 'page[size]': 50, 'page[number]': 0}),
    ({"program_handle": "abc", "state": "new", "advanced_filter": '{"filter[state][]": "triage"}'},
     {"filter[program][]": ["abc"], "filter[state][]": ["triage"], 'page[size]': 50, 'page[number]': 0}),
    ({"program_handle": "abc", "keyword": "new", "advanced_filter": '{"filter[keyword]": "abc"}'},
     {"filter[program][]": ["abc"], "filter[keyword]": "abc", 'page[size]': 50, 'page[number]': 0})
]
