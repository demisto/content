...
exception_handler_params = [
    ...
    (400, {"errors": [{"title": "Invalid Parameter"}]}, "Invalid Parameter"),
...
report_list_args = [
    ...
    ({"program_handle": "abc", "state": "new"}, {"filter[program][]": ["abc"], "filter[state][]": ["new"]}),
    ({"program_handle": "abc", "state": "new,resolved"}, {"filter[program][]": ["abc"], "filter[state][]": ["new", "resolved"]}),
    ({"program_handle": "abc", "severity": "low"}, {"filter[program][]": ["abc"], "filter[severity][]": ["low"]}),
    (
...
valid_params_for_fetch_incidents = [
    (
        "20",
        "2020-09-07T04:59:51Z",
        ["something_h1b", "checker_h1b"],
        "",
        "",
        "{}",
        "1",
        {
            "page[size]": "20",
            "filter[created_at__gt]": "2020-09-07T04:59:51",
            "filter[program][]": ["something_h1b", "checker_h1b"],
    ...
    (
        ...
        "",
        "",
        '{"filter[closed_at__gt]":"2020-10-26T10:48:16.834Z","filter[' 'reporter_agreed_on_going_public]":"false"}',
        "1",
        {
            "page[size]": "20",
            "filter[created_at__gt]": "2020-09-07T04:59:51",
            "filter[program][]": ["something_h1b"],
            "sort": "reports.created_at",
            "filter[closed_at__gt]": "2020-10-26T10:48:16.834Z",
