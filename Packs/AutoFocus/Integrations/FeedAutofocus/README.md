Use the Unit42 Intel Feed integration to fetch indicators from Unit42 Intel.
For more information click [here](https://docs.paloaltonetworks.com/autofocus/autofocus-admin/autofocus-feeds.html).
This Feed supports the AutoFocus Custom Feed and the Unit42 Intel Samples Feed.
To ingest the Daily Feed, use the [Unit42 Intel Daily Feed](https://xsoar.pan.dev/docs/reference/integrations/auto-focus-daily-feed). 
...
## Configure Unit42 Intel Feed on Cortex XSOAR

1. Navigate to **Settings** > **Integrations** > **Servers & Services**.
2. Search for Unit42 Intel Feed.
