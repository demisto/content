...
def penfield_assign(analyst_ids, category, created, id, name, severity):
    return demisto.executeCommand(
        ...
        {"analyst_ids": analyst_ids, "category": category, "created": created, "id": id, "name": name, "severity": severity},
    )
...
def main():
    try:
        ...
        # get assignee
        chosen_one = penfield_assign(analyst_ids, category, created, id, name, severity)[0]["Contents"]
