...
![image](/EclecticIQ/Integrations/EclecticIQ/Screenshots/1.png)
...
![image](/EclecticIQ/Integrations/EclecticIQ/Screenshots/2.png)
4. Select the file and it will be uploaded
5. Click on the Save icon (beside the Save Version button)
![image](/EclecticIQ/Integrations/EclecticIQ/Screenshots/3.png)
...
![image](/EclecticIQ/Integrations/EclecticIQ/Screenshots/4.png)
5. Click on "Add instance" (right-hand side)
6. Pass the valid API key
![image](/EclecticIQ/Integrations/EclecticIQ/Screenshots/5.png)
7. Click on the "Test" button and get a success message
8. Click on the "Save & exit" button
![image](/EclecticIQ/Integrations/EclecticIQ/Screenshots/6.png)
...
![image](/EclecticIQ/Integrations/EclecticIQ/Screenshots/7.png)
4. New Incident page will be displayed
5. Enter the Incident Name and required details
![image](/EclecticIQ/Integrations/EclecticIQ/Screenshots/8.png)
...
![image](/EclecticIQ/Integrations/EclecticIQ/Screenshots/9.png)
4. Click on War room
![image](/EclecticIQ/Integrations/EclecticIQ/Screenshots/10.png)
5. Pass the command in CLI and press enter button
![image](/EclecticIQ/Integrations/EclecticIQ/Screenshots/11.png)
...
![image](/EclecticIQ/Integrations/EclecticIQ/Screenshots/12.png)
...
4. Click on War room
5. Pass the command in CLI and press enter button
![image](/EclecticIQ/Integrations/EclecticIQ/Screenshots/13.png)
6. User gets the success message
7. Output Data will be stored in Context Data, to view the that click on a button(i.e, right shoulder button) that is beside the "Actions" button 
8. Click on "Context Data" to view the stored Output Data
![image](/EclecticIQ/Integrations/EclecticIQ/Screenshots/14.png)
...
4. Click on War room
5. Pass the command in CLI and press enter button
![image](/EclecticIQ/Integrations/EclecticIQ/Screenshots/15.png)
6. User gets the success message
7. Output Data will be stored in Context Data, to view the that click on a button(i.e, right shoulder button) that is beside the "Actions" button 
8. Click on "Context Data" to view the stored Output Data
![image](/EclecticIQ/Integrations/EclecticIQ/Screenshots/16.png)
...
![image](/EclecticIQ/Integrations/EclecticIQ/Screenshots/17.png)
4. Enter the Playbook Name and click on Save
![image](/EclecticIQ/Integrations/EclecticIQ/Screenshots/18.png)
5. Go to EclecticIQ and expand it (which is displayed under Task Library-Automation)
![image](/EclecticIQ/Integrations/EclecticIQ/Screenshots/19.png)
6. Click on the "Add" button to add the Lookup Observable command to Playbook
![image](/EclecticIQ/Integrations/EclecticIQ/Screenshots/20.png)
7. Pass the inputs: type and value
![image](/EclecticIQ/Integrations/EclecticIQ/Screenshots/21.png)
8. Click on Ok
9. Connect "Playbook Triggered" to the "lookup_observable" task
10. Click on "Save Playbook"
![image](/EclecticIQ/Integrations/EclecticIQ/Screenshots/22.png)
...
![image](/EclecticIQ/Integrations/EclecticIQ/Screenshots/23.png)
15. Click on the "Yes I know what I am doing" button
![image](/EclecticIQ/Integrations/EclecticIQ/Screenshots/24.png)
16. Playbook will Run and user gets a success message
![image](/EclecticIQ/Integrations/EclecticIQ/Screenshots/25.png)
17. Click on a button(i.e, right shoulder button) that is beside the "Actions" button 
![image](/EclecticIQ/Integrations/EclecticIQ/Screenshots/26.png)
18. Click on "Context Data" to view the output of the Playbook
![image](/EclecticIQ/Integrations/EclecticIQ/Screenshots/27.png)
...
![image](/EclecticIQ/Integrations/EclecticIQ/Screenshots/28.png)
17. Click on a button(i.e, right shoulder button) that is beside the "Actions" button 
![image](/EclecticIQ/Integrations/EclecticIQ/Screenshots/29.png)
18. Click on "Context Data" to view the output of the Playbook
![image](/EclecticIQ/Integrations/EclecticIQ/Screenshots/30.png)
...
![image](/EclecticIQ/Integrations/EclecticIQ/Screenshots/31.png)
8. Click on Ok
9. Connect "Playbook Triggered" to the "create_sighting" task
10. Click on "Save Playbook"
![image](/EclecticIQ/Integrations/EclecticIQ/Screenshots/32.png)
11. Go to "Incidents" (left-hand side) and click on it
12. Click on the created Incident from the Table
13. Click on Work Plan
14. Search the Playbook from the Default dropdown
15. Click on the "Yes I know what I am doing" button
16. Playbook will Run and get a success message
![image](/EclecticIQ/Integrations/EclecticIQ/Screenshots/33.png)
17. Click on a button(i.e, right shoulder button) that is beside the "Actions" button 
18. Click on "Context Data" to view the output of the Playbook
![image](/EclecticIQ/Integrations/EclecticIQ/Screenshots/34.png)
