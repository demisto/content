import pytest
<<<<<<< HEAD:Packs/EclecticIQ/Integrations/EclecticIQV2/EclecticIQ_test.py
...
def test_main_scenario_3(mocker):
    ...
    with pytest.raises(SystemExit):
        main()
>>>>>>> Added new integration EclecticIQV2 folder:Packs/EclecticIQ/Integrations/EclecticIQV2/EclecticIQV2_test.py
