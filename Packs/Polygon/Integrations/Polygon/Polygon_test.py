...
with open(os.path.dirname(__file__) + "test_data/args.json", "r") as f:
    data = json.load(f)
...
with open(os.path.dirname(__file__) + "test_data/get_report.json", "r") as f:
    MOCKED_REPORT = json.load(f)

with open(os.path.dirname(__file__) + "test_data/get_result.json", "r") as f:
    MOCKED_REPORT_RESULT = json.load(f)

with open(os.path.dirname(__file__) + "test_data/get_file_reputation.json", "r") as f:
    MOCKED_FILE_REPUTATION_DATA = json.load(f)

with open(os.path.dirname(__file__) + "test_data/upload.json", "r") as f:
    MOCKED_UPLOAD_DATA = json.load(f)

with open(os.path.dirname(__file__) + "test_data/get_analysis_info.json", "r") as f:
