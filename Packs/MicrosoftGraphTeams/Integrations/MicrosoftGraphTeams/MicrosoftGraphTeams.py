...
def update_teams_message_policy_violation_command(client: MsGraphClient, args: dict) -> None:
    """Apply a data loss prevention policy violation to a Microsoft Teams message.

    Targets a chat message, a channel message, or a channel reply.
    """
    chat_id = args.get("chat_id", "")
    ...
    return_results(
        CommandResults(
            outputs_prefix="MSGraphTeams.TeamsMessagePolicyViolation",
...
def main():
    ...
    commands = {
        ...
        "microsoft-teams-message-update-policy-violation": update_teams_message_policy_violation_command,
    }
