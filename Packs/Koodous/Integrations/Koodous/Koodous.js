var request = function(method, path, parameters){
    ...
    if (params.apikey_creds ? params.apikey_creds.password : params.APIKey){
        headers['Authorization'] = "Token " + params.apikey_creds ? params.apikey_creds.password : params.APIKey;
    }
