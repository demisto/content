...
The pack contains the **IBM Secrets Manager Event Collector** integration, which authenticates to IBM Cloud using an IAM API key and queries the IBM Cloud Logs query API to fetch Secrets Manager audit events.
