...
By default, issues created in Cortex XSOAR/XSIAM uses the risk level of the Microsoft Entra ID Protection alert as issue severity. This default behavior can be overridden by setting the following parameters:
