import MicrosoftGraphIdentityandAccessV2
import pytest
...
def test_ms_ip_string_to_list(ips, expected):
    ...
    assert MicrosoftGraphIdentityandAccessV2.ms_ip_string_to_list(ips) == expected
...
def test_get_last_fetch_time(last, expected):
    ...
    assert MicrosoftGraphIdentityandAccessV2.get_last_fetch_time(last, {}) == expected
...
def test_date_str_to_azure_format(date, expected):
    ...
    assert MicrosoftGraphIdentityandAccessV2.date_str_to_azure_format(date) == expected
...
def test_build_filter(last_fetch, parameters, expected):
    ...
    assert MicrosoftGraphIdentityandAccessV2.build_filter(last_fetch, parameters) == expected
...
def test_test_module_command_with_managed_identities(mocker, requests_mock, client_id):
    ...
    import MicrosoftGraphIdentityandAccessV2
    from MicrosoftGraphIdentityandAccessV2 import MANAGED_IDENTITIES_TOKEN_URL, Resources, main
    ...
    mocker.patch.object(MicrosoftGraphIdentityandAccessV2, "return_results", return_value=params)
    mocker.patch("MicrosoftApiModule.get_integration_context", return_value={})

    main()

    assert "ok" in MicrosoftGraphIdentityandAccessV2.return_results.call_args[0][0]
...
def test_missing_creds_error_thrown(expected_error):
    ...
    """
    from MicrosoftGraphIdentityandAccessV2 import Client
...
def test_list_role_members_command(mocker):
    ...
    """
    from MicrosoftGraphIdentityandAccessV2 import Client, list_role_members_command
...
def test_list_conditional_access_policies_command_scenarios(
    ...
    """
    from MicrosoftGraphIdentityandAccessV2 import Client, list_conditional_access_policies_command
...
def test_list_conditional_access_policies_command_invalid_args(mocker, args, expected_exception_message):
    ...
    """
    from MicrosoftGraphIdentityandAccessV2 import Client, list_conditional_access_policies_command, DemistoException
...
def test_create_conditional_access_policy_command_json_policy(mocker):
    ...
    """
    from MicrosoftGraphIdentityandAccessV2 import create_conditional_access_policy_command, Client
    ...
    mocker.patch("MicrosoftGraphIdentityandAccessV2.remove_empty_elements", return_value=expected_policy)
...
def test_create_conditional_access_policy_command_from_structured_args(mocker):
    ...
    mock_client.create_conditional_access_policy.return_value = mock_response
    mocker.patch("MicrosoftGraphIdentityandAccessV2.build_policy", return_value=expected_policy)
    mocker.patch("MicrosoftGraphIdentityandAccessV2.remove_empty_elements", return_value=expected_policy)
...
def test_create_conditional_access_policy_command_invalid_json(mocker):
    ...
    """
    from MicrosoftGraphIdentityandAccessV2 import create_conditional_access_policy_command, Client, DemistoException
...
def test_create_conditional_access_policy_command_missing_required_fields(mocker):
    ...
    mocker.patch("MicrosoftGraphIdentityandAccessV2.build_policy", side_effect=DemistoException(expected_output))
...
def test_resolve_merge_value_advanced_cases(field, existing_list, new_list, expected, expected_messages):
    ...
    """
    from MicrosoftGraphIdentityandAccessV2 import resolve_merge_value
...
def test_merge_policy_section(mocker, base_existing, new_dict, expected_messages, expected_new):
    ...
    """
    from MicrosoftGraphIdentityandAccessV2 import merge_policy_section
    ...
    mocker.patch("MicrosoftGraphIdentityandAccessV2.resolve_merge_value", side_effect=lambda field, existing, new, msgs: new)
...
def test_build_policy(args, expected_policy):
    ...
    """
    from MicrosoftGraphIdentityandAccessV2 import build_policy
...
def test_delete_conditional_access_policy_command_success(mocker, policy_id, response_mock, expected_output):
    ...
    """
    from MicrosoftGraphIdentityandAccessV2 import delete_conditional_access_policy_command, Client
...
def test_update_conditional_access_policy_command_append(
    ...
    """
    from MicrosoftGraphIdentityandAccessV2 import update_conditional_access_policy_command, Client
    ...
    mocker.patch("MicrosoftGraphIdentityandAccessV2.build_policy", return_value=new_policy_built)

    # Mock remove_empty_elements to return the same policy (no empty elements)
    mocker.patch("MicrosoftGraphIdentityandAccessV2.remove_empty_elements", return_value=new_policy_built)
    ...
    mocker.patch("MicrosoftGraphIdentityandAccessV2.merge_policy_section", side_effect=mock_merge)
...
def test_deep_get(root, path, expected):
    ...
    """
    from MicrosoftGraphIdentityandAccessV2 import deep_get
...
def test_deep_set(root, path, value, expected):
    ...
    MicrosoftGraphIdentityandAccessV2.deep_set(root_copy, path, value)
...
def test_deep_set_empty_path():
    ...
    with pytest.raises(IndexError):
        MicrosoftGraphIdentityandAccessV2.deep_set(root, path, "any_value")
