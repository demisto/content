...
LOGS_IMAGES_PER_PACK = "/Users/mmorag/dev/demisto/content/Packs/doc_files_script"
...
def extract_image_links_from_files_and_save_to_json():
    ...
    filtered_md_files = [
        ...
        'Playbooks' in path.parts and
        'Integrations' not in path.parts and
    ...
    try:
        with open(f'{LOGS_IMAGES_PER_PACK}/success.json', "a") as file_success:
            json.dump(images_information_success, file_success, indent=4)
        with open(f'{LOGS_IMAGES_PER_PACK}/errors.json', "a") as file_fails:
            json.dump(images_information_failed, file_fails, indent=4)
        with open(f'{LOGS_IMAGES_PER_PACK}/_errors.json', "a") as errors_files:
