...
import pytest
from AzureKubernetesServices import API_VERSION, AKSClient, clusters_addon_update, clusters_list
...
def test_clusters_addon_update(client, requests_mock):
    ...
    assert requests_mock.request_history[1].json() == {
        "location": location,
        "properties": {
            "addonProfiles": {"omsagent": {"enabled": True, "config": {"logAnalyticsWorkspaceResourceID": "workspace"}}}
        },
    }
...
def test_test_module_command_with_managed_identities(mocker, requests_mock, client_id):
    ...
    from AzureKubernetesServices import MANAGED_IDENTITIES_TOKEN_URL, Resources, main
