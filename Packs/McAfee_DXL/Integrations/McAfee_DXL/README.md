...
1. In ePO server go to **Menu > Server Settings**.
    ![go to menu](../../doc_files/go_to_menu.png/n)
    ![go to server settings](../../doc_files/go_to_serevr_settings.png/n)
2. Under DXL certificates (Third Party) click **Edit**.
    ![click edit](../../doc_files/click_edit.png/n)
3. download the brokers certificate.
    ![export Broker certificates](../../doc_files/export_Broker_certificates.png/n)
4. Download the brokers list.
    ![export Broker list](../../doc_files/export_Brocker_list.png/n)
5. Click **Import** and select the **client.crt** file.
    ![click import](../../doc_files/click_import.png/n)
    ![select client.crt file](../../doc_files/select_client.crt_file.png/n)
    ![click ok](../../doc_files/click_ok.png/n)
6. Click **Save**.
    ![click save](../../doc_files/click_save.png/n)
