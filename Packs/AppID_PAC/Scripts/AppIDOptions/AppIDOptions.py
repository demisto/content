...
options_dict = {
    'business-systems': ['auth-service', 'database', ' erp-crm', 'general-business', 'management', 'marketing',
                         'office-programs', 'software-development', 'software-update', 'storage-backup'],
    'collaboration': ['email', 'instant-messaging', 'internet-conferencing', 'social-business', 'social-networking',
