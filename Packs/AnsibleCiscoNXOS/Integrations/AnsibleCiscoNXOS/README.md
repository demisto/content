...
#### Command Example
```!nxos-acl host="192.168.1.19" name="ANSIBLE" seq="10" action="permit" proto="tcp" src="192.0.2.1/24" dest="any" state="present" ```
...
#### Command Example
```!nxos-bgp-neighbor host="192.168.1.19" asn="65535" neighbor="192.0.2.3" local_as="20" remote_as="30" bfd="enable" description="just a description" update_source="Ethernet1/3" state="present" ```
...
#### Command Example
```!nxos-bgp-neighbor-af host="192.168.1.19" asn="65535" neighbor="192.0.2.3" afi="ipv4" safi="unicast" route_reflector_client="True" state="present" ```
...
#### Command Example
```!nxos-snmp-host host="192.168.1.19" snmp_host="192.0.2.3" community="TESTING" state="present" ```
...
```json
{
    "CiscoNXOS": {
        "nxosSnmpHost": {
            "changed": true,
            "commands": [
                "snmp-server host 192.0.2.3 trap version 1 TESTING  udp-port 162"
            ],
            "host": "192.168.1.19",
            "status": "CHANGED"
        }
...
>  * changed: True
>  * ## Commands
>    * 0: snmp-server host 192.0.2.3 trap version 1 TESTING  udp-port 162
...
#### Command Example
```!nxos-static-route host="192.168.1.19" prefix="192.168.20.64/24" next_hop="192.0.2.3" route_name="testing" pref="100" ```
