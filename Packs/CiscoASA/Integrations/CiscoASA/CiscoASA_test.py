...
MOCK_RULES_GLOBAL = {
    ...
    "rangeInfo": {"offset": 0, "limit": 1, "total": 1},
    "items": [
        {
        ...
        },
        {
            ...
            "permit": True,
            "sourceAddress": {"kind": "IPv4Address", "value": "1.1.1.1"},
            "destinationAddress": {"kind": "AnyIPAddress", "value": "any"},
            "sourceService": {"kind": "NetworkProtocol", "value": "ip"},
            "destinationService": {"kind": "NetworkProtocol", "value": "ip"},
            "active": True,
...
def test_get_all_rules(requests_mock):
    ...
    empty_mock = {
        ...
        "rangeInfo": {"offset": 0, "limit": 0, "total": 0},
        "items": [],
    }
...
def test_rule_by_id(requests_mock):
    ...
    requests_mock.get(
        "https://example.com/api/access/global/rules/123456789", json=MOCK_RULES_GLOBAL.get("items")[1], status_code=200
    )

    client = Client("https://example.com", auth=("username", "password"), verify=False, proxy=False)

    args = {"interface_type": "Global", "interface_name": "name", "rule_id": "123456789"}
...
def test_create_rule(requests_mock):
    ...
    requests_mock.post("https://example.com/api/access/global/rules", json=MOCK_RULES_GLOBAL.get("items")[1], status_code=201)
            ...
            [
                {
                    "name": "TEST_GROUP",
                    "members": [
                        {"kind": "objectRef#NetworkObj", "object_id": "Test_Lior"},
            ...
            [
                {
                    "name": "TEST_GROUP",
                    "members": [
                        {"kind": "objectRef#UserObj", "object_id": "Pikachu_I_Choose_You!"},
                        {"kind": "objectRef#UserObj", "object_id": "Use_thunderbolt!"},
                    ],
                    "object_id": "TEST_GROUP",
                }
            ],
        ...
        (
            ...
            [
                ...
                },
                {
                    ...
                    "end": "never",
                    "periodic": [
                        {"frequency": "weekend", "start_hour": 3, "start_minute": 3, "end_hour": 4, "end_minute": 1},
                        {"frequency": "daily", "start_hour": 4, "start_minute": 0, "end_hour": 5, "end_minute": 1},
                        {
                        ...
                        {"frequency": "weekdays", "start_hour": 12, "start_minute": 0, "end_hour": 13, "end_minute": 1},
                    ],
                },
            ],
        ),
            ...
            [
                {
                    ...
                    "description": "test12",
                    "members": [{"kind": "SecurityName", "value": "beep"}, {"kind": "SecurityTag", "value": "bap"}],
                ...
                },
                {
                    ...
                    "description": "test21",
                    "members": [
                        {"kind": "objectRef#SecurityObjGroup", "object_id": "oneSecurityGroup"},
                        {"kind": "SecurityTag", "value": "52"},
                    ],
...
def test_list_command(
    ...
    requests_mock.get(url=f"{BASE_URL}/api/objects/{endpoint_suffix}", json=response)
    ...
    [
        ...
        (
            ...
            {"object_id": "oneSecurityGroup"},
            {
                "name": "oneSecurityGroup",
                "description": "test12",
                "members": [{"kind": "SecurityName", "value": "beep"}, {"kind": "SecurityTag", "value": "71"}],
                "object_id": "oneSecurityGroup",
            },
        ),
        (
...
def test_get_command(
    ...
    requests_mock.get(url=f'{BASE_URL}/api/objects/{endpoint_suffix}/{args["object_id"]}', json=response)
...
def test_write_memory_command(requests_mock, mock_client):
    ...
    - Ensure that the CommandResults outputs_prefix is correct.
    """
    expected_outputs = {"response": ["Bulko"]}
    mock_client._headers = {}
    response = load_mock_response("write_memory.json")

    requests_mock.post(url=f"{BASE_URL}/api/commands/writemem", json=response)
