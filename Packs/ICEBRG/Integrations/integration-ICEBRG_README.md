<!-- HTML_DOC -->
<p>ICEBRG is a network security product which is used in conjunction with Demisto to get events and reports produced in ICEBRG for queries.</p>
...
<h3>To set up ICEBRG to work with Demisto:</h3>
