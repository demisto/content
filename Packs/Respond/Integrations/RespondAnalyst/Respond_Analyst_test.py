...
def test_get_incident_command(requests_mock):
    ...
    expected_result = '''### Mandiant Automated Defense Alert, Tenant 1 : 6
|URL|accounts|assetCount|assetCriticality|assets|assignedUsers|attackStage|attackTactic|closeURL|dbotMirrorDirection|dbotMirrorInstance|description|domains|escalationreasons|eventCount|externalsystems|feedback|firstEventTime|hashes|incidentId|lastEventTime|malware|owner|probability|respondRemoteId|severity|signatures|status|tenantId|tenantIdRespond|timeGenerated|title|
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| https://localhost:6078/secure/incidents/6?tenantId=dev1 | {'domain': None, 'name': 'svc_adminscom3'},<br>{'domain': None, 'name': 'svc_adminscom'}''' \
''',<br>{'domain': 'test', 'name': 'svc_adminscom2'},<br>{'domain': None, 'name': 'svc_adminscom2'},<br>{'domain': 'test', 'name': 'svc_adminscom3'},''' \
'''<br>{'domain': 'test', 'name': 'svc_adminscom'},<br>{'name': 'Unknown', 'domain': None} | 1 | Critical | {'hostname': 'host1', 'ipaddress': '10.150.0.11', 'isinternal': True}'''\
''' | user1 | LateralMovement |  | https://localhost:6078/secure/incidents/feedback/6?tenantId=dev1 | Both | respond_test | description of the incident |  | ''' \
'''{'label': 'Multiple Network IPS Signatures Triggered by Same Internal Asset'} | 24 | {'hostname': 'host2', 'ipaddress': '10.150.0.22', 'isinternal': False} | timeUpdated: 1593469076049<br>'''\
'''userId: qa-user@respond-software.com<br>outcome: Non-Actionable<br>comments: blah blah blah | 2019-12-21T13:05:31Z | {'hash': '44d88612fea8a8f36de82e1278abb02f'} | 6 | 2020-06-05T08:20:17Z | ''' \
'''{'name': 'Ransom.Win32.CRYSIS.SM', 'type': 'Ransomware', 'vendor': 'McAfee'},<br>{'name': 'RAT.Win32.CRYSIS.SM', 'type': 'RAT', 'vendor': 'McAfee'} | user1 | VeryHigh | Tenant 1:6 | Critical |  '''\
'''| Closed | Tenant 1 | dev1 | 2020-06-05T16:20:21Z | Virus Infections, Suspicious Repeated Connections and Int - Int Network IPS Activity |
'''
    client = mock_rest_client()
    ...
    assert getattr(command_result, 'readable_output') == expected_result
