...
def test_main_failure(mock_return_error, capfd, mocker):
    ...
    mocker.patch.object(ChronicleAssetEventsForMACWidgetScript, "set_arguments_for_widget_view", side_effect=Exception)
    with capfd.disabled():
        ChronicleAssetEventsForMACWidgetScript.main()
...
def test_set_arguments_for_widget_view_when_mac_is_valid():
    ...
    indicator_data = {"CustomFields": {"chronicleassetmac": "01:XX:XX:XX:XX:XX"}}
    # set expected output
    expected_arguments = {
