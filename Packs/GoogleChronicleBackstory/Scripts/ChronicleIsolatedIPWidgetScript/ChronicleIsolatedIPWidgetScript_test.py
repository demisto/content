...
def test_get_html_representation_when_ip_is_not_isolated():
    ...
    assert (
        "<div style='color:green; text-align:center;'><h1>0.0.0.0<br/>IP Address Not Isolated</h1>"
...
def test_get_html_representation_when_ip_is_potentially_isolated():
    ...
    assert "<div style='color:red; text-align:center;'><h1>0.0.0.0<br/>IP Address Isolated</h1>" "</div>" == html_representation
