...
def test_main_success(mocker):
    ...
    mocker.patch.object(ChronicleDBotScoreWidgetScript, "get_html_representation", return_value="")
...
def test_get_html_representation_when_dbotscore_is_2(mocker):
    ...
    assert html_representation == "<div style='color:orange; text-align:center;'><h1>2<br/>Suspicious</h1></div>"
