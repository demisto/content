...
def test_get_html_representation_when_hostname_is_not_isolated():
    ...
    assert (
        "<div style='color:green; text-align:center;'><h1>dummyhost.com<br/>Hostname Not Isolated</h1>"
...
def test_get_html_representation_when_hostname_is_potentially_isolated():
    ...
    assert (
        "<div style='color:red; text-align:center;'><h1>dummyhost.com<br/>Hostname Isolated</h1>" "</div>" == html_representation
    )
