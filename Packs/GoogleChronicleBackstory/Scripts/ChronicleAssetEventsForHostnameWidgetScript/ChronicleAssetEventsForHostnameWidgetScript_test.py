...
def test_main_failure(mock_return_error, capfd, mocker):
    ...
    mocker.patch.object(ChronicleAssetEventsForHostnameWidgetScript, "set_arguments_for_widget_view", side_effect=Exception)
    with capfd.disabled():
        ChronicleAssetEventsForHostnameWidgetScript.main()
...
def test_set_arguments_for_widget_view_when_hostname_is_valid():
    ...
    indicator_data = {"CustomFields": {"chronicleassethostname": "dummyhost.com"}}
    # set expected output
    expected_arguments = {
