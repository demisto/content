...
ARGS = {
    "json_response": '{"Artifact": "e9428.b.akamaiedge.net", "IocIngestTime": "2020-07-17T20:00:00Z", '
...
def test_main_success(mocker):
    ...
    mocker.patch.object(ExtractDomainFromIOCDomainMatchRes, "get_entry_context", return_value={})
...
def test_main_failure(mock_return_error, capfd, mocker):
    ...
    mock_return_error.assert_called_once_with("Error occurred while extracting Domain from IOC Domain Matches response:\n")
