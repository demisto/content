...
def test_main_failure(mock_return_error, capfd, mocker):
    ...
    mocker.patch.object(ChronicleAssetEventsForIPWidgetScript, "set_arguments_for_widget_view", side_effect=Exception)
    with capfd.disabled():
        ChronicleAssetEventsForIPWidgetScript.main()
...
def test_set_arguments_for_widget_view_when_ip_is_valid():
    ...
    indicator_data = {"CustomFields": {"chronicleassetip": "0.0.0.0"}}
    # set expected output
    expected_arguments = {
