...
This MCP server provides the following tools for interacting with Horizon3.ai (H3) NodeZero (NZ) pentesting data.
...
- **Type**: Destructive (creates a pentest)
