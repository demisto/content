...
FETCHINCIDENTS_TICKET = {
    ...
    'is_deleted': 0,
    'itilcategories_id': 0,
    'links': [{'href': 'http://myglpi.mydomain.tld/apirest.php/Entity/0',
                'rel': 'Entity'},
            {'href': 'http://myglpi.mydomain.tld/apirest.php/User/2',
                'rel': 'User'},
            {'href': 'http://myglpi.mydomain.tld/apirest.php/User/2',
                'rel': 'User'},
            {'href': 'http://myglpi.mydomain.tld/apirest.php/RequestType/1',
                'rel': 'RequestType'},
            {'href': 'http://myglpi.mydomain.tld/apirest.php/Ticket/291/Document_Item/',
                'rel': 'Document_Item'},
            {'href': 'http://myglpi.mydomain.tld/apirest.php/Ticket/291/TicketTask/',
                'rel': 'TicketTask'},
            {'href': 'http://myglpi.mydomain.tld/apirest.php/Ticket/291/TicketValidation/',
                'rel': 'TicketValidation'},
            {'href': 'http://myglpi.mydomain.tld/apirest.php/Ticket/291/TicketCost/',
                'rel': 'TicketCost'},
            {'href': 'http://myglpi.mydomain.tld/apirest.php/Ticket/291/Problem_Ticket/',
                'rel': 'Problem_Ticket'},
            {'href': 'http://myglpi.mydomain.tld/apirest.php/Ticket/291/Change_Ticket/',
                'rel': 'Change_Ticket'},
            {'href': 'http://myglpi.mydomain.tld/apirest.php/Ticket/291/Item_Ticket/',
                'rel': 'Item_Ticket'},
            {'href': 'http://myglpi.mydomain.tld/apirest.php/Ticket/291/ITILSolution/',
                'rel': 'ITILSolution'},
            {'href': 'http://myglpi.mydomain.tld/apirest.php/Ticket/291/ITILFollowup/',
                'rel': 'ITILFollowup'}],
    'locations_id': 0,
...
FETCHINCIDENTS_TICKETUSER = [
    {
        'alternative_email': '',
        'id': 584,
        'links': [{'href': 'http://myglpi.mydomain.tld/apirest.php/Ticket/291',
                    'rel': 'Ticket'},
                    {'href': 'http://myglpi.mydomain.tld/apirest.php/User/2',
                    'rel': 'User'}],
...
FETCHINCIDENTS_TICKETDOC = [
    {
        ...
        'links': [
            {
                'rel': 'Document', 
                'href': 'http://myglpi.mydomain.tld/apirest.php/Document/33847'
            }, {
                'rel': 'Ticket', 
                'href': 'http://myglpi.mydomain.tld/apirest.php/Ticket/292'
            }, {
                'rel': 'Entity', 
                'href': 'http://myglpi.mydomain.tld/apirest.php/Entity/0'
            }, {
                'rel': 'User', 
                'href': 'http://myglpi.mydomain.tld/apirest.php/User/2'
            }
    ...
    'links': [
        {
            ...
            'rel': 'Document_Item', 
            'href': 'http://myglpi.mydomain.tld/apirest.php/Document/33847/Document_Item/'
        }
    ]
}
...
FETCHINCIDENTS_INCIDENTS = [
    {
        ...
        'attachment': [{
            'path': 'f07e9487-b0bc-4a05-b1c8-a707c7dd1328', 
