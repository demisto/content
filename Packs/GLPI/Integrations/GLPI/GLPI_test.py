...
def test_glpi_add_comment(requests_mock):
    ...
    requests_mock.post("mock://myglpi.mydomain.tld/apirest.php/ticketfollowup",
                       json=mock_response_ticketfollowup, status_code=201)
    client = Client(PARAMETERS)
...
def test_glpi_search(requests_mock):
    ...
    assert response[0].outputs == {'name': 'MyUser', 'realname': 'MyLastName', 'UserEmail.email': 'myuser@company.com',
                                   'phone': None, 'Location.completename': None, 'is_active': 1}
...
def test_glpi_get_modified_remote_data(requests_mock):
    ...
    assert response.modified_incident_ids == ['146', '193', '260', '279', '230', '289', '197', '278', '133', '250', '212', '144',
                                              '192', '186', '187', '156', '210', '259', '282', '135', '207', '184', '163', '169',
                                              '245', '258', '149', '136', '152', '221', '285', '191', '147', '132', '275', '142',
                                              '219', '244', '231', '200', '280', '178', '199', '246', '263', '261', '288', '220',
                                              '264', '176', '235']
