...
@pytest.mark.parametrize(
    ...
    [
        (
            [
                {"published": "2022-04-17T12:31:36.667", "uuid": "1d0844b6-3148-11ec-9027-a5b57ec5faaa"},
                {"published": "2022-04-17T12:32:36.667", "uuid": "1d0844b6-3148-11ec-9027-a5b57ec5fbbb"},
                {"published": "2022-04-17T12:33:36.667", "uuid": "1d0844b6-3148-11ec-9027-a5b57ec5fccc"},
            ],
        ...
        (
            [
                {"published": "2022-04-17T12:31:36.667", "uuid": "1d0844b6-3148-11ec-9027-a5b57ec5faaa"},
                {"published": "2022-04-17T12:32:36.667", "uuid": "1d0844b6-3148-11ec-9027-a5b57ec5fbbb"},
                {"published": "2022-04-17T12:32:36.667", "uuid": "1d0844b6-3148-11ec-9027-a5b57ec5fccc"},
            ],
            "2022-04-17T11:30:00.000",
            {
        ...
        ([], "2022-04-17T12:31:36.667", {"after": "2022-04-17T12:31:36.667000", "ids": [], "next_link": ""}),
    ],
)
...
def test_get_last_run_with_different_format():
    events = [
        {"published": "2022-04-17T12:31:36", "uuid": "1d0844b6-3148-11ec-9027-a5b57ec5faaa"},
        {"published": "2022-04-17T12:32:36", "uuid": "1d0844b6-3148-11ec-9027-a5b57ec5fbbb"},
        {"published": "2022-04-17T12:33:36", "uuid": "1d0844b6-3148-11ec-9027-a5b57ec5fccc"},
    ]
...
def test_get_last_run_invalid_date_format():
    events = [
        {"published": "2022-04-17T12:31:36", "uuid": "1d0844b6-3148-11ec-9027-a5b57ec5faaa"},
        {"published": "2022-04-17T12:32:36", "uuid": "1d0844b6-3148-11ec-9027-a5b57ec5fbbb"},
        {"published": "xxxyyyzzz", "uuid": "1d0844b6-3148-11ec-9027-a5b57ec5fccc"},
    ]
    last_run_after = "2022-04-17T11:30:00"
...
def test_get_events_success(dummy_client, mocker):
    ...
    mock_remove_duplicates.return_value = [{"id": 1, "published": "2022-04-17T12:32:36.667"}]
...
def test_get_events_with_next_link_success(dummy_client, mocker):
    ...
    mocker.patch("OktaEventCollector.remove_duplicates", mock_remove_duplicates)
    mocker.patch.object(
        dummy_client, "get_events", side_effect=[MockResponse(text=id1_pub, links={"next": {"url": "next_link"}})]
    )
...
def test_fetch_event(dummy_client, mocker):
    ...
    mocker.patch(
        "OktaEventCollector.get_events_command",
        side_effect=[
...
def test_429_too_many_requests(mocker):
    mock_events = [
        {"uuid": 1, "published": "2022-04-17T14:00:00.000Z"},
        {"uuid": 2, "published": "2022-04-17T14:00:01.000Z"},
        {"uuid": 3, "published": "2022-04-17T14:00:02.000Z"},
        {"uuid": 4, "published": "2022-04-17T14:00:03.000Z"},
    ]
    ...
    with requests_mock.Mocker() as m:
        ...
        m.get(
            "https://testurl.com/api/v1/logs?since=2022-04-17T14%3A00%3A03.000Z&sortOrder=ASCENDING&limit=5",
            status_code=429,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("https://testurl.com/api/v1/logs?sortOrder=ASCENDING&since=2022-04-17T11%3A32%3A36.667000&limit=1", "test-module"),
    ],
)
def test_okta_get_events(mocker, address, command):
    ...
    send_events_to_xsiam_mock = mocker.patch("OktaEventCollector.send_events_to_xsiam", return_value={})
    with requests_mock.Mocker() as m:
        m.get(address, json=mock_events)
        main()
