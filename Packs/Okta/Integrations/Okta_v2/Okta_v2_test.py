...
from Okta_v2 import (
    ...
    delete_limit_param,
    get_after_tag,
    get_group_members_command,
    get_groups_for_user_command,
    get_logs_command,
    get_user_command,
    get_user_factors_command,
    get_zone_command,
    list_users_command,
    list_zones_command,
...
factors_data = [
    {
        ...
        "profile": {"phoneNumber": "+12025550191"},
        "_links": {},
    },
    {
        ...
        "profile": {"credentialId": "woo@demisto.com"},
        "_links": {},
    },
    {
        ...
        "_links": {"self": {}, "poll": {}, "user": {}},
        "_embedded": {"activation": {"factorResult": "TIMEOUT", "_links": {}}},
    },
]
group_data = [
    {
...
polling_response_success = {"factorResult": "SUCCESS"}
polling_response_rejected = {
    "factorResult": "REJECTED",
    "_links": {
        "verify": {"href": "https://test.com/api/v1/users/TestID/factors/FactorID/verify", "hints": {"allow": ["POST"]}},
        "factor": {},
    },
}
create_user_response = {
    ...
    "_links": {
        "activate": {"href": "https://test.com/api/v1/users/TestID/lifecycle/activate"},
        "self": {"href": "https://test.com/api/v1/users/TestID"},
    },
}
create_group_response = {
    ...
    "objectClass": ["okta:user_group"],
    "type": "OKTA_GROUP",
    "profile": {"name": "TestGroup", "description": "Test Group Description"},
    "_links": {
        "logo": [
            {
                "name": "medium",
...
assign_group_to_app_response = {
    ...
    "profile": {},
    "_links": {
        "app": {"href": "https://test.com/api/v1/apps/0oa3ik9908vngPiMB1d7"},
        "self": {"href": "https://test.com/api/v1/apps/0oa3ik9908vngPiMB1d7/groups/00g3q8tjdyoOw6fJE1d7"},
        "group": {"href": "https://test.com/api/v1/groups/00g3q8tjdyoOw6fJE1d7"},
    },
}
group_members = [
    {
        ...
        "credentials": {
            "password": {},
            "recovery_question": {"question": "born city"},
...
logs = [
    {
        ...
        "client": {
            "userAgent": {"rawUserAgent": "python-requests/2.22.0", "os": "Windows", "browser": "Chrome"},
            "zone": "null",
            "device": "Computer",
            "id": "",
            "ipAddress": "8.8.8.8",
            "geographicalContext": {
                ...
                "country": "Israel",
                "postalCode": "",
                "geolocation": {"lat": 32.0678, "lon": 34.7647},
            },
        },
        ...
        "transaction": {"type": "WEB", "id": "XkvJGFsS6hsPnC7KoFliVAAABzI", "detail": {}},
    ...
    },
    {
        ...
        "client": {
            "userAgent": {"rawUserAgent": "python-requests/2.22.0", "os": "Unknown", "browser": "UNKNOWN"},
            "zone": "null",
            "device": "Unknown",
            "id": "",
            "ipAddress": "8.8.8.8",
...
okta_zone = {
    ...
    "gateways": [{"type": "CIDR", "value": "4.5.3.2/16"}, {"type": "CIDR", "value": "1.2.1.2/32"}],
...
LOGS = [{"mock_log1": "mock_value1"}, {"mock_log2": "mock_value2"}, {"mock_log3": "mock_value3"}]
...
@pytest.mark.parametrize(
    "url, expected_after_tag", [("https://dev-725178.oktapreview.com/api/v1/users?limit=10&after=qazwsx123", "qazwsx123")]
)
...
@pytest.mark.parametrize("args", [({"name": "TestGroup", "description": "Test Group Description"})])
...
@pytest.mark.parametrize("args", [({"groupName": "TestGroup", "appName": "TestApp"})])
...
@pytest.mark.parametrize("args", [({"zoneID": "nzoqsmcx1qWYJ6wYF7q0"})])
...
@pytest.mark.parametrize("args", [({"zoneID": "nzoqsmcx1qWYJ6wYF7q0", "zoneName": "NewZoneName"})])
...
@pytest.mark.parametrize("args", [({"gateway_ips": "8.8.8.8", "name": "NewZoneName"})])
...
def test_set_temp_password_command():
    ...
    expected_results = (
        "test password was last changed on 2023-03-22T10:15:26.000Z\n"
...
LOGS_WITH_LIMIT = [(None, 3), (1, 1), (3, 3), (1001, 3)]
...
def test_expire_password_with_revoke_session():
    ...
    client = MagicMock()
    args = {"username": "test_user", "hide_password": "False", "revoke_session": "True"}
...
def test_expire_password_without_revoke_session():
    ...
    client = MagicMock()
    args = {"username": "test_user", "hide_password": "False", "revoke_session": "False"}
...
def test_hide_password():
    ...
    client = MagicMock()
    args = {"username": "test_user", "hide_password": "True", "revoke_session": "False"}
...
def test_missing_username_and_user_id():
    ...
    client = MagicMock()
    args = {"hide_password": "False", "revoke_session": "False"}
...
def test_revoke_session(mock_http_request):
    ...
    mock_http_request.assert_called_once_with(method="POST", url_suffix=expected_uri, params=expected_params)
...
def test_apply_zone_update_override():
    ...
    """
    zoneObject = {}
    updated_zone = apply_zone_updates(
        zoneObject, "TestZone", ["192.168.1.1", "10.0.0.0-10.0.0.10"], ["10.0.0.1", "192.168.1.0-192.168.1.5"], "OVERRIDE"
    )
    assert updated_zone == {
        "name": "TestZone",
...
def test_apply_zone_update_append_with_range():
    ...
    updated_zone = apply_zone_updates(
        zoneObject, "NewZone", ["192.168.1.2-192.168.1.10"], ["10.0.0.1", "10.0.0.2-10.0.0.5"], "APPEND"
    )
    assert updated_zone == {
        "name": "NewZone",
