...
## Obtaining TrendAI Vision One™ API Credentials

Configuring the TrendAI Vision One™ integration requires API credentials generated in TrendAI Vision One™e. It is recommended that a new role be created with just the permissions required for this integration. You can create a new role for this integration by following these steps in TrendAI Vision One™.
...
| Incident Type            | Endsure the "TrendAI Vision One XDR Incident" type is selected          | True         |
| Mapper (Incoming)        | Endsure the "TrendAI Vision One XDR - Incoming Mapper" type is selected | True         |
