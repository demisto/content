...
| Log types to fetch                                                               | To maximize scalability, it is recommended to configure one type per instance. Default value is Workbench, Observed Attack Techniques, Search Detections, Audit.                                                  | True         |
| Fetch events                                                                     |                                                                                                                                                                                                                   | False        |
