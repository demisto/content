...
def test_set_email_reply():
    ...
    result = set_email_reply("test@gmail.com", '["test1@gmail.com"]', "test2@gmail.com", "test", [{"name": "image.png"}])
...
@pytest.mark.parametrize("email_html, expected", [(EMAIL_HTML, EXPECTED_RESULT_REMOVE_MESSAGE_HISTORY)])
...
def test_main(return_incident_path, expected_return, create_context_called, mocker):
    ...
    mocker.patch.object(PreprocessEmail, "get_incident_by_query", return_value=[util_load_json(return_incident_path)])
...
@pytest.mark.parametrize("email_code, scenario", [("87692312", "thread_found"), ("123", "thread_notfound")])
...
def test_get_email_related_incident_id_email_in_fields(mocker):
    ...
    mocker.patch.object(
        PreprocessEmail,
        "get_incident_by_query",
        return_value=[{"emailsubject": "subject 1", "id": "1"}, {"emailsubject": "subject 2", "id": "2"}],
    )
...
@pytest.mark.parametrize(
    ...
    [
        (
            [
                {"type": "Email/ID", "value": "foo@test.com"},
                {"type": "Instance", "value": "ews"},
                {"type": "Brand", "value": "EWSO365"},
            ],
            "test@test.com",
        ...
        (
            [
                {"type": "Email/ID", "value": "foo@test.com"},
                {"type": "Instance", "value": "gmail"},
                {"type": "Brand", "value": "Gmail"},
            ],
            "test@gmail.com",
            {
                "arguments": {"message-id": "foo@test.com", "user-id": "me", "using": "gmail"},
                "command": "gmail-get-attachments",
                "incidents": None,
            },
        ),
        (
            [
                {"type": "Email/ID", "value": "foo@outlook.com"},
                {"type": "Instance", "value": "MicrosoftGraphMail"},
                {"type": "Brand", "value": "MicrosoftGraphMail"},
            ],
            "test@outlook.com",
            {
                "command": "msgraph-mail-get-attachment",
                "incidents": None,
                "arguments": {"user_id": "test@outlook.com", "message_id": "foo@outlook.com", "using": "MicrosoftGraphMail"},
            },
        ),
    ],
)
