...
The bla1 script takes one or more domain names and checks whether they're in the XSOAR list defined in the InternalDomainsListName argument. by default, the InternalDomainsListName argument will use the XSOAR list called "InternalDomains".
