...
The scoring mechanism provides a comprehensive risk assessment, considering both the severity and frequency of malicious behaviors.<~XSIAM> (Available from Cortex XSIAM %%XSIAM_VERSION%%).</~XSIAM>
