...
The results of the script are tagged with the "Internal_Domain_Check_Results" tag, so they can be displayed in war-room entry sections in incident layouts. (Available from Cortex XSOAR 6.5.0).
