...
class TestParseCSV:
    ...
    def test_main_one_lined_csv(self, mocker):
        ...
        self.mock_demisto(mocker, file_obj=TestParseCSV.create_file_object("./test_data/one_lined_csv.csv"))
        main()
    ...
    def test_main_with_hash(self, mocker):
        ...
        with open("./test_data/one_is_hash_results.json") as f:
            expected = json.load(f)
        args = {"entryID": "entry_id", "parseAll": "no", "codec": "utf-8", "hashes": "1"}
    ...
    def test_parsecsv_with_iocs_same_column(self, mocker):
        ...
        with open("./test_data/IOCs_results.json") as f:
            expected = json.load(f)
        args = {"entryID": "entry_id", "parseAll": "no", "codec": "utf-8", "ips": "1", "domains": "1", "hashes": "1"}
