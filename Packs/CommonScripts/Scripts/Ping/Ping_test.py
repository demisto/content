...
def test_fail_ping(mocker):
    ...
    # failing because in debian string is a bit different - E  AssertionError: assert
    # 'Name does not resolve' in 'ping: nonExistingDomain45343.com: Name or service not known\n'
