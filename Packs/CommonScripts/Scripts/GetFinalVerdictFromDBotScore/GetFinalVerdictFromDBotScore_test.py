...
import GetFinalVerdictFromDBotScore
import pytest
...
@pytest.mark.parametrize(argnames='source_dbot_score, final_dbot_score, indicator_value',
                         argvalues=[
                             (
                                 [
                                     {
...
def test_having_reliabilites(mocker, source_dbot_score, final_dbot_score, indicator_value):
    ...
    """
    dbot_score = GetFinalVerdictFromDBotScore.get_final_verdict(source_dbot_score, indicator_value)
...
def test_main_final_dbot_score_found(mocker):
    ...
    return_results = mocker.patch('GetFinalVerdictFromDBotScore.return_results')

    GetFinalVerdictFromDBotScore.main()
