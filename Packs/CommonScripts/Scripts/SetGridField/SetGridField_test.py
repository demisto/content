...
def test_main_does_not_raises_error_in_xsiam_or_xsoar_sass(mocker):
    """
     Given
    - An output from executeCommand in XSIAM or XSOAR SASS.
     When
...
def test_main_raises_error_in_xsiam_or_xsoar_sass(mocker):
    """
     Given
    - An output from executeCommand in XSIAM or XSOAR SASS.
     When
