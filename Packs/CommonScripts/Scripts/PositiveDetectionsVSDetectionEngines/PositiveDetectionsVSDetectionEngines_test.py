...
detect_positive_not_zero_1 = {
    "CustomFields": {"detectionengines": 71, "positivedetections": 10},
...
detect_positive_not_zero_2 = {
    "CustomFields": {"detectionengines": 71, "positivedetections": 8},
    "ManuallyEditedFields": None,
    "account": "",
...
positive_zero = {
    "CustomFields": {"detectionengines": 71, "positivedetections": 0},
    "ManuallyEditedFields": None,
    "account": "",
...
@pytest.mark.parametrize(
    "indicator_data, expected_result",
    [(detect_positive_not_zero_1, (10, 61)), (detect_positive_not_zero_2, (8, 63)), (positive_zero, (0, 71))],
)
