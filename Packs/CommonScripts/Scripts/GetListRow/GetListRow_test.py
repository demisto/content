...
@pytest.mark.parametrize(
    ...
    [("True", "", "", 0), ("true", "", "test", 0), ("False", "", "test", 1), ("False", "", "", 1), ("False", "test", "test", 0)],
)
...
@pytest.mark.parametrize("list_result, expected", [("False", 0), ("id, name, status, title", 0), ("Item not found", 1), ("", 1)])
