...
EMAIL_FILE_TYPES = ("eml", "eml}", "message/rfc822")
...
def is_email(file_metadata: dict, file_name: str) -> bool:
    ...
    return any(
        (
            ...
            file_name.endswith(".msg")
            and ("composite document file v2 document" in file_info or "cdfv2 microsoft outlook message" in file_info),
        )
    )
