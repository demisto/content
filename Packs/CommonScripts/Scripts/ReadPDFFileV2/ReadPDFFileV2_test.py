...
UNESCAPE_CASES = [
    (
        False,
        {
            "http://example.com/abc&#34;&#160;xmlns:xsi=&#34;http://example.com/abc&#34;&#160;",
...
def test_incorrect_authentication():
    ...
    with pytest.raises(PdfInvalidCredentialsException) as e:
        handling_pdf_credentials(cpy_file_path=file_path, dec_file_path=dec_file_path, encrypted="yes", user_password="12")
    assert "Incorrect password" in str(e)
...
ENC_PDF_META_DATA_CASES = [
    (
        ...
        ),
        {
            ...
            "CreationDate": "Wed May 15 08:18:48 2019",
            "ModDate": "Wed May 15 08:18:48 2019",
            "Tagged": "no",
            "Form": "none",
            "Pages": "2",
            "Encrypted": "AES 128-bit",
            "Permissions": "print:yes copy:yes change:yes addNotes:yes",
            "PageSize": "595 x 842 pts (A4) (rotated 0 degrees)",
...
PDF_META_DATA_CASES = [
    (
        ...
        ),
        {
            ...
            "Producer": "macOS Version 10.14.4 (Build 18E226) Quartz PDFContext",
            "CreationDate": "Wed May 15 11:47:28 2019",
            "ModDate": "Wed May 15 11:47:28 2019",
            "Tagged": "no",
            "Form": "none",
            "Pages": "1",
            "Encrypted": "no",
...
def test_get_pdf_text_with_encrypted(tmp_path):
    ...
    file_path = f"{CWD}/encrypted.pdf"
    dec_file_path = f"{CWD}/decrypted.pdf"
    dec_file_path = handling_pdf_credentials(
        cpy_file_path=file_path, user_password="1234", dec_file_path=dec_file_path, encrypted="yes"
    )
...
def test_get_pdf_htmls_content_with_encrypted(mocker, tmp_path):
    ...
    expected = (
        "If you are end user who wishes to use XSL Formatter yourself, you may purchase "
...
def test_get_urls_and_emails_from_pdf_annots_with_encrypt(file_path):
    ...
    expected_urls = {
        ...
        "https://test2.com",
        "http://www.test3.net",
        "https://test5.com.co/ed/trn/update?email=user@test6.net",
        "http://www.test7.com",
        "https://test8.com",
    }
    ...
    dec_file_path = handling_pdf_credentials(
        cpy_file_path=file_path, user_password="123456", dec_file_path=dec_file_path, encrypted=""
    )
...
@pytest.mark.parametrize(
    "file_path",
    ["URLs_Extraction_Test_PDF_Encoding_Google_Docs_Renderer.pdf", "URLs_Extraction_Test_PDF_Encoding_Quartz_PDFContext.pdf"],
)
...
def test_get_urls_and_emails_from_pdf_file_with_encrypt(tmp_path):
    ...
    expected_emails = {
        "Userthatdoesnotexist3@demis",
        "userthatdoesnotexist@demisto.com",
        "userthatdoesnotexist4@demis",
...
def test_handle_error_read_only(mocker):
    ...
    handle_error_read_only(
        fun, f"{CWD}/test_for_read_only_file.txt", "The error is not due to a problem with write permissions to the file"
    )
