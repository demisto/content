        ...
        "Contents": [
            {
                ...
                "manualScore": True,
                "moduleToFeedMap": {
                    "VirusTotal": {"score": 1, "type": "IP", "value": "8.8.8.8"},
                    "ipinfo": {"score": 0, "type": "IP", "value": "8.8.8.8"},
                },
                "score": 2,
                "value": "8.8.8.8",
            }
...
class TestIterateIndicatorEntry:
    ...
    def set_input(score=2, indicator="8.8.8.8", indicator_type="IP", vendors="ipinfo", set_by=None):
        ...
        res = {"indicator_type": indicator_type, "moduleToFeedMap": module_to_feed_map, "score": score, "value": indicator}
        if set_by:
