    ...
    "iocs": [
        {
            "id": "4467",
            "version": 4,
            "modified": "2020-08-09T16:38:12.862662+03:00",
            "sortValues": [" \x01\x16\x14g#Wjx\x1d\x00", "4467"],
            "comments": [
                {
                    "id": "b96b5331-1afb-46ed-8de7-645d74243d83",
                    "version": 0,
                    "modified": "0001-01-01T00:00:00Z",
                    "sortValues": None,
                    "content": "Created",
                    "user": "@DBot",
                    "created": "2020-08-09T13:53:55.851918+03:00",
            ...
            "account": "",
            "timestamp": "2020-08-09T13:53:55.907799+03:00",
            "indicator_type": "MITRE ATT&CK",
            "value": "T1345",
            "source": "DBot",
            "sourceInstances": ["MITRE ATT&CK"],
            "sourceBrands": ["MITRE ATT&CK"],
            "investigationIDs": ["11", "a2fcc0c4-c7a9-4fdb-89d9-3613aec57280"],
            "relatedIncCount": 1,
            "lastSeen": "2020-08-09T16:38:12.86248+03:00",
            "firstSeen": "2020-08-09T13:53:55.907473+03:00",
            "lastSeenEntryID": "610@a2fcc0c4-c7a9-4fdb-89d9-3613aec57280",
            "firstSeenEntryID": "2@11",
            "score": 0,
            "manualScore": False,
            ...
            "insightCache": {
                "id": "t1345",
                "version": 1,
                "modified": "2020-08-09T16:33:44.495265+03:00",
                "sortValues": None,
                "scores": {
                    "MITRE ATT&CK": {
                        "score": 0,
                        "content": "## ['T1345'](https://ABCDEFG:8443/#/indicator/4467):\n ",
                        "contentFormat": "markdown",
                        "timestamp": "2020-08-09T16:33:44.49526+03:00",
                        "scoreChangeTimestamp": "2020-08-09T16:33:44.49526+03:00",
            ...
            "moduleToFeedMap": {
                "MITRE ATT&CK": {
                    ...
                    "fetchTime": "2020-08-09T16:33:44.49526+03:00",
                    "sourceBrand": "MITRE ATT&CK",
                    "sourceInstance": "MITRE ATT&CK",
                    "moduleId": "MITRE ATT&CK",
                    ...
                    "ExpirationSource": {
                        "setTime": "2020-08-09T16:38:12.845863+03:00",
                        "source": "indicatorType",
                        "user": "",
                        "brand": "MITRE ATT&CK",
                        "instance": "MITRE ATT&CK",
                        "moduleId": "MITRE ATT&CK",
                        "expirationPolicy": "indicatorType",
            ...
            "isShared": False,
            "expiration": "2020-08-23T16:38:12.845863+03:00",
            ...
            "calculatedTime": "2020-08-09T16:38:12.86248+03:00",
            "lastReputationRun": "2020-08-09T16:33:44.506101+03:00",
            "comment": "",
            "manuallyEditedFields": None,
            "modifiedTime": "2020-08-09T16:33:44.49526+03:00",
            "aggregatedReliability": "",
        }
    ],
    "searchAfter": [" \x01\x16\x14g#Wjx\x1d\x00", "4467"],
}
...
def test_feed_related_indicator(mocker):
    ...
    assert (
        result.readable_output == "|Type|Value|Description|\n|---|---|---|\n| MITRE ATT&CK |  | "
...
RELATED_INDICATOR_OBJECTS_PACK = [
    ...
    (
        "value1",
        "type1",
        "desc1, https://blog.cloudsploit.com/the-danger-of-unused-aws-regions-af0bf1b878fc",
        {
            "Value": "value1",
            "Type": "type1",
