...
@pytest.mark.parametrize(
    "headers, request_content_type_header, response_content_type_header, expected_headers",
    [
        ({}, "json", "json", {"Content-Type": "application/json", "Accept": "application/json"}),
        ({"Content-Type": "application/json"}, "", "json", {"Content-Type": "application/json", "Accept": "application/json"}),
        ({}, "", "", {}),
    ],
)
