...
| headers | Specify a hash of headers to send with the request.<br/>Headers can be of string type but need to be formatted in the following ways:<br/>\`\{"key": "value"\}\` or \`"key": "value"\` |
