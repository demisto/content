...
class TestLongurlInService:
    @pytest.mark.parametrize(
        "args, mock_files_prefix, mock_files_count, expected_output",
        [
            (  # Generic test
    ...
    def test_nested_shortened_url(self, mocker, args: dict, mock_files_prefix: str, mock_files_count: int, expected_output: dict):
        """
    ...
    @pytest.mark.parametrize(
        "args, response_mock, expected_output",
        [
            (  # Test a case where the URL is invalid
