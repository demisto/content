...
expected_calls = [call(['aquatone-discover', '--domain', 'test.com'], stdout=-1, stderr=-1, encoding='utf-8'),
                  call().communicate(),
                  call(['cat', '/root/aquatone/test.com/hosts.json'], stdout=-1, stderr=-1, encoding='utf-8'),
                  call().communicate()]
