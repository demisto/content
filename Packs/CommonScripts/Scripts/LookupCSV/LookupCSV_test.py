...
class TestLookupCSV:
    ...
    def mock_context(mocker, args_value=None):
        if not args_value:
            args_value = {"entryID": "entry_id", "header_row": "true"}
    ...
    def test_add_header_row(self, mocker):
        ...
        args_value = {"entryID": "entry_id", "add_header_row": "sourceIP,count"}
        self.mock_demisto(mocker, file_obj=self.create_file_object("./TestData/simple_no_header.csv"), args_value=args_value)
        main()
        result = self.get_demisto_results()
        assert expected == result
    ...
    def test_main_csv_search(self, mocker):
        ...
        args_value = {"entryID": "entry_id", "header_row": "true", "column": "sourceIP", "value": "1.1.1.1"}
        self.mock_demisto(mocker, file_obj=self.create_file_object("./TestData/column_search.csv"), args_value=args_value)
        main()
        result = self.get_demisto_results()
        assert expected == result
    ...
    def test_main_csv_missing(self, mocker):
        ...
        args_value = {"entryID": "entry_id", "header_row": "true", "column": "sourceIP", "value": "4.4.4.4"}
        self.mock_demisto(mocker, file_obj=self.create_file_object("./TestData/column_search.csv"), args_value=args_value)
        main()
        result = self.get_demisto_results()
        assert expected == result
    ...
    def test_main_csv_search_multi(self, mocker):
        ...
        args_value = {"entryID": "entry_id", "header_row": "true", "column": "sourceIP", "value": "4.4.4.4"}
        self.mock_demisto(
            mocker, file_obj=self.create_file_object("./TestData/simple_duplicated_cols.csv"), args_value=args_value
        )
    ...
    def test_main_csv_broken_search(self, mocker):
        ...
        args_value = {"entryID": "entry_id", "header_row": "true", "column": "sourceIP", "value": "1.1.1.1"}
        self.mock_demisto(mocker, file_obj=self.create_file_object("./TestData/column_search.txt"), args_value=args_value)
