...
def test_eml_contains_html_and_text(mocker):
    ...
    expected_output = """<html xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:w="urn:schemas-microsoft-com:office:word" xmlns:m="http://schemas.microsoft.com/office/2004/12/omml" xmlns="http://www.w3.org/TR/REC-html40"><head><meta name="Generator" content="Microsoft Word 15 (filtered medium)"><style><!--
         ...
         - </o:shapelayout></xml><![endif]--></head><body lang="PL" link="#0563C1" vlink="#954F72"><div id="BodyTopText"><p style="font-family:PKO Bank Polski;font-size:15px;color:#0098d4">Wewnętrzne</p></div><div class="WordSection1"><p class="MsoNormal"><span style='font-size:10.0pt;font-family:"PKO Bank Polski",sans-serif;color:black'>żółć<o:p></o:p></span></p></div></body></html>"""
