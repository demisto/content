...
@pytest.mark.parametrize('input,fqdn,domain', [  # noqa: E501 disable-secrets-detection
    ...
    ('https://urldefense.com/v3/__http://survey.lavulcamktg.cl/index.php/783758', 'survey.lavulcamktg.cl',
     'lavulcamktg.cl'),
    ('this.is.test.com', 'this.is.test.com', 'test.com'),
    ('caseapi.phishlabs.com', 'caseapi.phishlabs.com', 'phishlabs.com'),
    ...
    ('content-test-236508.iam.gserviceaccount.com',
     'content-test-236508.iam.gserviceaccount.com', 'gserviceaccount.com'),  # noqa: E501
    ('www.testö.com', 'www.testö.com', 'testö.com'),
    ('1Ab.Vt', '', ''),
])  # noqa: E124
...
def test_extract_fqdn_or_domain_empty_indicators(mocker):
    ...
    mocker.patch.object(demisto, 'args', return_value={'input': 'Ab.Vt'})
