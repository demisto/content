...
def test_extract_indicators(mocker):
    ...
    assert results == {
        "Type": 1,
        "ContentsFormat": "text",
        "Contents": {"FileData": "abcabcabc"},
        "HumanReadable": "Read 9 bytes from file:\nabcabcabc",
        "EntryContext": {"FileData": "abcabcabc"},
    }
...
def test_read_binary_to_base64(mocker):
    ...
    Then:
        Validate the right output returns.
    """
    args = {"input_encoding": "binary", "output_data_type": "base64"}
    expected = {
        "Type": 1,
        "ContentsFormat": "text",
        "Contents": {"FileData": "ASNFZ4k="},
        "HumanReadable": "Read 5 bytes from file:\nASNFZ4k=",
        "EntryContext": {"FileData": "ASNFZ4k="},
    }
...
def test_read_binary_to_json_decode_error(mocker):
    ...
    Then:
        Cause an exception.
    """
    args = {"input_encoding": "binary", "output_data_type": "json"}
    mocker.patch("ReadFile.execute_command", return_value={"path": "./test_data/test_binary.bin"})
...
def test_read_utf8_to_json(mocker):
    ...
    Then:
        Validate the right output returns.
    """
    args = {"input_encoding": "utf-8", "output_data_type": "json"}
    expected = {
        "Type": 1,
        "ContentsFormat": "text",
...
def test_read_utf16be_to_json(mocker):
    ...
    Then:
        Validate the right output returns.
    """
    args = {"input_encoding": "utf-16", "output_data_type": "json"}
    expected = {
        "Type": 1,
        "ContentsFormat": "text",
        "Contents": {"FileData": {"a": "b"}},
...
def test_read_file_default_with_meta(mocker):
    ...
    file_info = {"Data": "abcabcabc", "EntryID": "1", "FileSize": 9, "EOF": True}
...
def test_read_file_incomplete_with_meta(mocker):
    ...
    file_info = {"Data": "abc", "EntryID": "1", "FileSize": 9, "EOF": False}
...
def test_read_empty_file_with_meta(mocker):
    ...
    file_info = {"Data": "", "EntryID": "1", "FileSize": 0, "EOF": True}
...
def test_read_binary_to_base64_with_meta(mocker):
    ...
    file_info = {"Data": "ASNFZ4k=", "EntryID": "1", "FileSize": 5, "EOF": True}
...
def test_read_utf8_to_json_with_meta(mocker):
    ...
    file_info = {"Data": {"a": "b"}, "EntryID": "1", "FileSize": 9, "EOF": True}
...
def test_read_utf16be_to_json_with_meta(mocker):
    ...
    file_info = {"Data": {"a": "b"}, "EntryID": "1", "FileSize": 22, "EOF": True}
