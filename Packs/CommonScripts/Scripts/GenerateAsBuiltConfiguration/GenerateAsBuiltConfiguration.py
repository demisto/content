...
def get_classifier_mapper():
    ...
    Returns:
        dict: Filtered data for the custom classifers, incoming mapper and outgoing mapper having the data only for the fields mentioned.
    """
...
def get_playbook_dependencies(playbook):
    """
    This function accepts the playbook and provides the subplaybook, integrations and automations related to that particular playbook.
...
def get_instance_classifier_incident_type(integration_instance, incident_types, classifiers):
    """
    This function accepts the integration instance data, incident types data and classifers data and then establishes the mapping for the
...
def get_playbook_integration(playbook, filter_int):
    ...
    Returns:
    pb_integration : dictionary having complete integration data for a specific playbook, containing classifiers, incident types, field types
    layout, incident fields, incoming mapper and outgoing mapper.
    """
    pb_integration = None
    # d = []
    section_data = []
...
def sub_data(playbook):
    """
    This function accepts the playbook data and fetches the subplaybooks, automations and integrations for that particular playbook.
...
def create_config_file(pb_name, ignore_playbook):
    """
    This function accepts the playbook names and the name of the playbooks to be ignored to avoid the data repetition, as they are already covered
    in the subplaybooks, and then create complete configuration data for those playbooks and subplaybooks
    ...
    Returns:
    playbook : dictionary containing the complete data for playbooks, that is automtion, subplaybook and all the configuration data of integration for
...
def create_as_built(playbook_names, ignore_playbook):
    """
    This function accepts the playbook names and the names of the playbook to be ignored and then append all the data for those palybook
    that are not to be ignored, in a list.
