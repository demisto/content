...
def test_strings(mocker):
    mocker.patch.object(
        demisto, "executeCommand", return_value=[{"path": "./test_data/text_file.txt", "name": "text_file.txt", "Type": ""}]
    )
...
def test_strings_no_string(mocker):
    mocker.patch.object(
        demisto, "executeCommand", return_value=[{"path": "./test_data/no_text_file.txt", "name": "text_file.txt", "Type": ""}]
    )
...
def test_pdf_file(mocker):
    mocker.patch.object(
        demisto, "executeCommand", return_value=[{"path": "./test_data/pdf_file.pdf", "name": "pdf_file.pdf", "Type": ""}]
    )
