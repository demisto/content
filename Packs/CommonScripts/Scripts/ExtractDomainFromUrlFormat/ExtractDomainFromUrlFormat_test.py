...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "https://urldefense.proofpoint.com/v2/url?u=http-3A__go.getpostman.com_y4wULsdG0h0DDMY0Dv00100&d=DwMFaQ&c=ywDJJevdGcjv4rm9P3FcNg&r=s5kA2oIAQRXsacJiBKmTORIWyRN39ZKhobje2GyRgNs&m=vN1dVSiZvEoM9oExtQqEptm9Dbvq9tnjACDZzrBLaWI&s=zroN7KQdBCPBOfhOmv5SP1DDzZKZ1y9I3x4STS5PbHA&e=",
            "getpostman.com",
        ),  # noqa: E501
...
@pytest.mark.parametrize(
    "input,url", [("http:example.com", "http://example.com"), ("http:\\\\example.com", "http://example.com")]
)  # noqa: E124
