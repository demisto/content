...
def mocked_gdetect_get():
    return {
        ...
        "size": 219648,
        "filenames": ["sha256"],
        "malwares": ["Win.Ransomware.Buhtrap-9865977-0", "TR/Redcap.ltkcp", "Mal/Behav-010"],
        "files": [
            {
                "sha256": "005b00d41749f7b0336d4d5fe0402dcfc95ae0df44a2231a89a59919eeb30b31",
                "sha1": "2159b8d8b985f32641314220bb24126747b71d13",
                ...
                "av_results": [
                    {"av": "SignatureOyster", "result": "Win.Ransomware.Buhtrap-9865977-0", "score": 1000},
                    {"av": "SignatureUmbrella", "result": "TR/Redcap.ltkcp", "score": 1000},
                    {"av": "SignatureSophos", "result": "Mal/Behav-010", "score": 1000},
                ],
                "size": 219648,
                "is_malware": True,
            },
        ...
        "duration": 8268,
        "token": (
            "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ6.eyJ1c2VybmFtZSI6ImFwaS10YW8ndWl0ZXN0IiwiZ7JvdXBzIjpbInRhbmd1aXRlc3QiXSwi"
        ...
        "threats": {
            "005b00d41749f7b0336d4d5fe0402dcfc95ae0df44a2231a89a59919eeb30b31": {
                "filenames": ["23465d22-3464-39ce-b8b3-bc2ee7d6eecf"],
                "tags": [
                    {"name": "av.virus_name", "value": "Mal/Behav-010"},
                    {"name": "attribution.family", "value": "win_vegalocker_auto"},
                    {"name": "av.virus_name", "value": "win_vegalocker_auto"},
                    {"name": "av.virus_name", "value": "Win.Ransomware.Buhtrap-9865977-0"},
                    {"name": "av.virus_name", "value": "TR/Redcap.ltkcp"},
                ],
                "score": 4000,
                "magic": "PE32 executable (GUI) Intel 80386, for MS Windows",
                "sha256": "005b00d41749f7b0336d4d5fe0402dcfc95ae0df44a2231a89a59919eeb30b31",
...
def mock_add_token(mock):
    ...
    mock["token"] = (
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ6.eyJ1c2VybmFtZSI6ImFwaS10YW8ndWl0ZXN0IiwiZ7JvdXBzIjpbInRhbmd1aXRlc3QiX"
...
def mocked_gdetect_get_errors():
    base = mocked_gdetect_get_base()
    base["errors"] = {"Extract": "The number of retries has passed the limit."}
