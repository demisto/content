...
| share | Yes/No to indicate if the job should be shared with read only permissions. Sharing will also expand the expiry time of the results to 7 days. Possible values are: Yes, No. Default is No. | Optional | 
