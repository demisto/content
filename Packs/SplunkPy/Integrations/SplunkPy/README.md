...
***
Change job settings to share its results to all Splunk users, and increase its TTL to 7 days.
...
| **Path** | **Type** | **Description** |
| --- | --- | --- |
| Splunk.JobUpdates.SID | unknown | ID of the job. | 
| Splunk.JobUpdates.TTL updated | unknown | True/False on whether the TTL change was successful | 
| Splunk.JobUpdates.Sharing updated | unknown | True/False on whether the sharing options change was successful | 
