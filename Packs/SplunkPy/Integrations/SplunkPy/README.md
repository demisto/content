...
3. Click **Add instance** to create and configure a new integration instance.
    ...
    | Timezone of the Splunk server, in minutes. For example, if GMT is gmt +3, set timezone to +180. For UTC, set the timezone to 0. Relevant only for fetching and mirroring notable events. Most be specified when mirroring is enabled. |  | False |
