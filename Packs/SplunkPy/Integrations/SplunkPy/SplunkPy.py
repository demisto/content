...
DAYLIGHT_SAVING_TIME_HOURS_DELTA = timedelta(hours=1)
...
def remove_irrelevant_incident_ids(
    ...
    for incident_id, incident_occurred_time in last_run_fetched_ids.items():
        ...
        if isinstance(incident_occurred_time, dict):
            ...
            if incident_window_end_datetime >= window_start_datetime - DAYLIGHT_SAVING_TIME_HOURS_DELTA:
...
def fetch_findings(
    ...
    # Todo Israel: resume this late_indexed_pagination
