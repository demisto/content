...
response_test_users_to_entry = [
    {
        ...
        "ipWhitelisted": False,
        "emails": [{"address": "johndoe@test.com", "primary": True}],
...
expected_result_test_users_to_entry = {
    "expected_human_readable": expected_human_readable,
...
expected_raw_response_test_autoreply_to_entry = [
    {
        "EnableAutoReply": True,
...
expected_outputs_test_autoreply_to_entry = {
...
expected_result_test_autoreply_to_entry = {
    "expected_human_readable": expected_human_readable_test_autoreply_to_entry,
...
role_test_role_to_entry = {
    ...
    "rolePrivileges": [
        {"privilegeName": "ADMIN", "serviceId": "00upglbi0qz687j"},
...
expected_outputstest_role_to_entry = {
    "ETag": "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX",
    "IsSuperAdminRole": True,
    "IsSystemRole": True,
    "Kind": "admin#directory#role",
    ...
    "Name": "ADMIN",
    "Privilege": [{"ServiceID": "00upglbi0qz687j", "Name": "ADMIN"}, {"ServiceID": "03j2qqm31d4j55e", "Name": "ADMIN"}],
}
...
expected_result_test_role_to_entry = {
    "expected_human_readable": expected_human_readable_test_role_to_entry,
...
expected_human_readable_test_user_roles_to_entry = (
...
expected_raw_response_user_roles_to_entry = [
    {
...
expected_result_user_roles_to_entry = {
    "expected_human_readable": expected_human_readable_test_user_roles_to_entry,
...
expected_raw_response_test_tokens_to_entry = [
    {
        "DisplayText": "iOS Account Manager",
        "ClientId": "000000000000.apps.googleusercontent.com",
        "Kind": "admin#directory#token",
...
expected_result_test_tokens_to_entry = {
    "expected_human_readable": expected_human_readable_test_tokens_to_entry,
...
expected_outputs_test_sent_mail_to_entry = [
    {
        "Type": "Gmail",
        "ID": "11111",
        "Labels": ["SENT"],
...
expected_result_test_sent_mail_to_entry = {
    "expected_human_readable": expected_human_readable_test_sent_mail_to_entry,
...
list_filters_mock_result = [
    {"id": "AAAA", "criteria": {"from": "test1@gmail.com"}, "action": {"addLabelIds": ["TRASH"]}},
    {"id": "BBBB", "criteria": {"from": "test2@gmail.com"}, "action": {"addLabelIds": ["TRASH"]}},
]
except_contents = [
    {"ID": "AAAA", "Mailbox": "1111111", "Criteria": {"from": "test1@gmail.com"}, "Action": {"addLabelIds": ["TRASH"]}},
    {"ID": "BBBB", "Mailbox": "1111111", "Criteria": {"from": "test2@gmail.com"}, "Action": {"addLabelIds": ["TRASH"]}},
]
...
expected_result_test_filters_to_entry = {
    "expected_human_readable": expected_human_readable_test_filters_to_entry,
...
expected_result_test_mailboxes_to_entry = {
    "expected_human_readable": expected_human_readable_test_mailboxes_to_entry,
...
except_contents_test_emails_to_entry = [
    {
        "id": "183c702bfdbb3fc2",
        "threadId": "183c702bfdbb3fc2",
        "labelIds": ["UNREAD", "IMPORTANT", "CATEGORY_PERSONAL", "INBOX"],
...
expected_result_test_emails_to_entry = {
    "expected_human_readable": expected_human_readable_test_emails_to_entry,
...
email_without_date = {
    ...
    "payload": {
        ...
        "filename": "",
        "headers": [
            {"name": "Delivered-To", "value": "XXX@gmail.com"},
            {
                "name": "Received",
            ...
            {"name": "Return-Path", "value": "\u003cwa0kv7nos5@z5hho8nuu3.ejmlk9qy6k.vps.ovh.ca\u003e"},
            {
                "name": "Received",
            ...
            {"name": "Return-Path", "value": "\u003cinfo@yyaetfxo.tel.impactsbuilding.com\u003e"},
            {"name": "Date", "value": "afnhz"},
            {"name": "From", "value": "Very Urgent \u003cRLVFRJB@wood8742.us\u003e"},
            {"name": "To", "value": "XXX@gmail.com"},
            {"name": "Message-ID", "value": "\u003caugvk-XXX-aplbz@pdr8-services-05v.prod.WOOD8742.org\u003e"},
            {"name": "Subject", "value": "Re: thank you (XXX@gmail.com) for you message confirmation is required.."},
...
email_no_header = {
    ...
    "payload": {
        ...
        "headers": [
            {"name": "Delivered-To", "value": "XXX@gmail.com"},
            {"name": "Received", "value": "by 2002:a17:90a:77cb:0:0:0:0 with SMTP id e11csp4670216pjs;"},
            {
                "name": "X-Google-Smtp-Source",
                "value": "ABdhPJxamjNl6uZsgLyKjEqaDARxIQdMr8xEKXgXeJkJInviprq4VA8RETMs1rxm01fZSW+FUlvo",
            },
            {"name": "X-Received", "value": "by 2002:a9d:4b03:: with SMTP id q3mr13206164otf.88.1608581517297;"},
            {
                "name": "ARC-Seal",
                "value": "i=1; a=rsa-sha256; t=1608581517; cv=none;        d=google.com; s=arc-20160816;        b=NWZvGIF2nTuHIYBhWBly0w+/YcSwPjGWb+Yf5dTnyic+24LOxREHxMzYWras3dchDf         eadMwZUTPRwTc/OhKUGZnEGhlIj80vfKbmAghvBhXVvS2nro+YFeUblwB7x57C5WhPNJ         aLNs+DgOZCKaBe+DLpvsxMVEFuqtmkdX0xPkqeetgFK5iW+FNbPaw1Ni0qYfqEEvTl56         wzPe9YoUUw/QRGQuCmGSdG3kSrCOfgMO3/OwjJofxIjWObNOzRZmyL39eY+ejhhqbkBI         jNTCsg8WSwVEPupHaeZKXhsxW/3rZOKk+aC5KEb35mCnJGnd2tR+ayXbdybMYyJ5QmIt         vpmw==",
            },
...
service_result_with_pageToken = {
    "messages": [{"id": "1845fa4c3a5618cb", "threadId": "1845fa4c3a5618cb"}],
    "nextPageToken": "02582292467408105606",
    "resultSizeEstimate": 1,
}

service_result_without_pageToken = {
    "messages": [{"id": "1845fa4c2d5dfbb0", "threadId": "1845fa4c2d5dfbb0"}],
    "nextPageToken": None,
    "resultSizeEstimate": 1,
}
...
third_message = {
    ...
    "payload": {
        ...
        "headers": [
            {
                "name": "Received",
                "value": "from 111111111111 named unknown by gmailapi.google.com with HTTPREST; Wed, 9 Nov 2022 22:45:43 -0500",
            },
            {"name": "Content-Type", "value": 'text/plain; charset="utf-8"'},
            {"name": "MIME-Version", "value": "1.0"},
            {"name": "Content-Transfer-Encoding", "value": "base64"},
...
first_incident_result = [
    {
        "type": "Gmail",
        "name": "HelloWorld2",
        "details": "helloworld\r\n",
        "labels": [
            {"type": "Email/ID", "value": "1845fa4c2d5dfbb0"},
...
second_incident_result = [
    {
        "type": "Gmail",
        "name": "HelloWorld1",
        "details": "helloworld\r\n",
        "labels": [
            {"type": "Email/ID", "value": "1845fa4c3a5618cb"},
            {"type": "Email/subject", "value": "HelloWorld1"},
            {"type": "Email/text", "value": "helloworld\r\n"},
            {"type": "Email/from", "value": "admin@demistodev.com"},
            {"type": "Email/html", "value": None},
            {"type": "Email/to", "value": ""},
            {"type": "Email/cc", "value": ""},
            {"type": "Email/bcc", "value": ""},
...
expected_result_forwarding_address_get_command_2 = {
    "raw_response": {"forwardingEmail": "test@gmail.com", "verificationStatus": "accepted", "userId": "111"},
    "outputs": {"forwardingEmail": "test@gmail.com", "verificationStatus": "accepted", "userId": "111"},
    "readable_output": '### Get forwarding address for: "111"\n|forwardingEmail|verificationStatus|\n|---|---|\n| test@gmail.com | accepted |\n',
}
