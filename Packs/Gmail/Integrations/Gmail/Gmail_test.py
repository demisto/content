...
EXPECTED_OCCURRED_NO_INTERNALDATE = datetime.datetime(2020, 12, 21, 20, 11, 57, tzinfo=datetime.timezone.utc)  # noqa: UP017
EMAIL_INTERNALDATE_EARLY = input_data.email_with_early_internalDate
EXPECTED_OCCURRED_INTERNALDATE_EARLY = datetime.datetime(2020, 12, 21, 20, 11, 40, tzinfo=datetime.timezone.utc)  # noqa: UP017
EMAIL_HEADER_EARLY = input_data.email_with_internalDate_header_early
EXPECTED_OCCURRED_HEADER_EARLY = datetime.datetime(2020, 12, 21, 20, 11, 57, tzinfo=datetime.timezone.utc)  # noqa: UP017
EMAIL_NO_HEADER = input_data.email_no_header
EXPECTED_OCCURRED_NO_HEADER = datetime.datetime(2020, 12, 21, 20, 11, 58, tzinfo=datetime.timezone.utc)  # noqa: UP017
EMAIL_NO_DATE = input_data.email_no_date
EXPECTED_OCCURRED_NO_DATE = datetime.datetime(2020, 12, 22, 14, 13, 20, tzinfo=datetime.timezone.utc)  # noqa: UP017
...
def test_parse_date_isoformat_server():
    ...
    assert date == datetime.datetime(2017, 10, 24, 14, 13, 20, tzinfo=datetime.timezone.utc)  # noqa: UP017
