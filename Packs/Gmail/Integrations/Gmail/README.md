...
2. Enter a client name (the Unique ID) and paste the following into the One or more API Scopes textboxes. 
...
11.  Select **Add new**:  
    - Complete the configuration using the Client ID from the service account created earlier.  
