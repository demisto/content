...
To determine what value should be used, take a look at the logs after a failed execution of the command. The command prints to the logs *info* messages detailing the status of the search every 100 accounts it successfully searched.
