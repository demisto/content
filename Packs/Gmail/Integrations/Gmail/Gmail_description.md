...
If a non-admin user is user for the integration's parameter, the test button will fail on a 403 error.
This may also fail the ***gmail-search-all-mailboxes*** command.
