...
## Playbook Image
---
![Search in mailboxes Gmail (Loop) with polling](https://raw.githubusercontent.com/demisto/content/master/Packs/Gmail/doc_files/Search_in_mailboxes_Gmail_(Loop)_with_polling.png)
