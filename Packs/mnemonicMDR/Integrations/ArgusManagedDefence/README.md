...
| Fetch incidents exclude tag | Excludes fetching incidents with the optional tag. May be used to exclude fetching Argus Cases created by XSOAR. Tags in Argus are of key: value pairs. You may exclude with either \(1\) tag key, or \(2\) key: value pairs by a comma-separated string. | False |
...
| context_output | Set to true to output to context data. By default, only print to war room. Possible values are: true, false. Default is false. | Optional | 
...
| context_output | Set to true to output to context data. Otherwise, only print to war room. Possible values are: true, false. Default is true. | Optional | 
...
| **Argument Name** | **Description** | **Required** |
| --- | --- | --- |
| sha256 | file id of XSOAR file to upload. | Required | 
| safe | Download as a zipped file with password 'infected'. Set to false to download raw. Possible values are: true, false. Default is true. | Optional | 
...
| **Argument Name** | **Description** | **Required** |
| --- | --- | --- |
| id_shortname | ID or shortname of asset to get. | Required | 
| context_output | Set to true to output to context data. By default, only print to war room. Possible values are: true, false. Default is false. | Optional | 
...
| asset | Asset ids or short names. | Optional | 
| parent | Asset parent group ids or short names. | Optional | 
| keywords | Limit search by asset field \(short name\, name\, and description\) keywords. | Optional | 
| time_field_strategy | Which time field\(s\) to filter by timestamp start\/end. | Optional | 
| sort_by | Field\(s\) to sort by \- refer to the search POST endpoint to see which fields are permitted. | Optional | 
...
| **Argument Name** | **Description** | **Required** |
| --- | --- | --- |
| sha256 | sha256 hash of sample. | Required | 
| context_output | Set to true to output to context data. By default, only print to war room. Possible values are: true, false. Default is false. | Optional | 
...
***
Get vulnerability definition metadata.
...
| **Argument Name** | **Description** | **Required** |
| --- | --- | --- |
| vulnerability_definition_uuid | Vulnerability definition ID or identifier of vulnerability. | Required | 
| context_output | Set to true to output to context data. By default, only print to war room. Possible values are: true, false. Default is false. | Optional | 
...
| **Path** | **Type** | **Description** |
| --- | --- | --- |
| Argus.Vulnerability.Definition.data.id | String | Vulnerability definition id. | 
| Argus.Vulnerability.Definition.data.description | String | Description of vulnerability. | 
| Argus.Vulnerability.Definition.data.solution | String | How to fix the vulnerability. | 
...
| Argus.Vulnerability.Definition.data.name | String | Name of vulnerability. | 
...
| --- | --- | --- |
| id_shortname | ID or shortname of asset to get. | Required | 
| customer | Customer ID or short name \(default is user's customer\)\, only used when asset short name was provided. | Optional | 
| short_name | Update short name of asset. | Optional | 
| name | Update name of asset. | Optional | 
| description | Update description of asset. Support HTML\, which will be sanitized. | Optional | 
| owner | Update owner of asset\, specified by user ID or username. When username is specified\, it should exist within current user's domain. | Optional | 
| criticality | Dict. Request to update a Group or Asset's criticality triad. | Optional | 
| add_components | List. Specify components to be added with the asset. | Optional | 
| delete_components | List. Specify IDs of the components to be deleted from the asset. | Optional | 
| ttl | Time to live duration of this asset since last seen\, 0 means won't expire. | Optional | 
| context_output | Set to true to output to context data. By default, only print to war room. Possible values are: true, false. Default is false. | Optional | 
...
| **Path** | **Type** | **Description** |
| --- | --- | --- |
| Argus.Vulnerability.data.vulnerabilityID | String | Vulnerability ID. | 
| Argus.Vulnerability.data.severity | String | Vulnerability severity. | 
| Argus.Vulnerability.data.resolution | String | Vulnerability resolution status. | 
| Argus.Vulnerability.data.asset.name | String | Asset shortname. | 
| Argus.Vulnerability.data.lastUpdatedTimestamp | Number | Timestamp when the vulnerability was last updated. | 
| Argus.Vulnerability.data.id | String | Vulnerability UUID. | 
| Argus.Vulnerability.data.vulnerabilityDefinition.id | String | Vulnerability description ID. | 
| Argus.Vulnerability.data.cvss | Number | Vulnerability CVSS. | 
| Argus.Vulnerability.data.observationDescription | String | Vulnerability observation description. | 
| Argus.Vulnerability.data.observationReferences | String | Vulnerability observation description references. | 
| Argus.Vulnerability.data.vulnerabilityDefinition.flags | String | Flags of the vulnerability definition.  | 
...
| **Argument Name** | **Description** | **Required** |
| --- | --- | --- |
| customer | ID or short name of customer\, if not specified then current user's customer will be assigned. | Optional | 
| short_name | Short name of asset*. | Optional | 
| name | Name of asset*. | Optional | 
| description | Description of asset. May use HTML\, which will be sanitized. | Optional | 
| owner | ID or username of user who owns the asset. When username is specified\, it should exist within current user's domain. | Optional | 
| criticality | Dict. Request to set a Group or Asset's criticality triad. | Optional | 
| asset_definition | ID or short name of asset definition\, it should exist within current user's domain. | Optional | 
| components | List. Specify components to be added with the asset. | Optional | 
| ttl | Time to live duration of this asset since last seen\, 0 means won't expire. | Optional | 
| context_output | Set to true to output to context data. By default, only print to war room. Possible values are: true, false. Default is false. | Optional | 
...
***
Get Vulnerabilities belonging to the Asset.
...
| **Argument Name** | **Description** | **Required** |
| --- | --- | --- |
| id_shortname | Asset ID or shortname. | Required | 
| customer | Customer ID or short name \(default is user's customer\)\, only used when asset short name was provided. | Optional | 
| include_deleted | Whether to include deleted vulnerabilities, not included by default. Possible values are: true, false. Default is false. | Optional | 
...
| Argus.Vulnerability.data.lastUpdatedTimestamp | Number | Timestamp when the vulnerability was last updated. | 
| Argus.Vulnerability.data.id | String | Vulnerability UUID. | 
| Argus.Vulnerability.data.vulnerabilityDefinition.id | String | Vulnerability definition ID. | 
| Argus.Vulnerability.data.cvss | Number | Vulnerability CVSS. | 
| Argus.Vulnerability.data.observationDescription | String | Vulnerability observation description. | 
| Argus.Vulnerability.data.observationReferences | String | Vulnerability observation description references. | 
| Argus.Vulnerability.data.vulnerabilityDefinition.flags | String | Flags of the vulnerability definition.  | 
...
| **Argument Name** | **Description** | **Required** |
| --- | --- | --- |
| file-id | file id of XSOAR file to upload. | Required | 
| context_output | Set to true to output to context data. By default, only print to war room. Possible values are: true, false. Default is false. | Optional | 
...
| end_timestamp | Upper bound timestamp filter value. | Optional | 
| time_field_strategy | Which time field(s) to filter by timestamp start/end. | Optional | 
| sort_by | Field(s) to sort by. | Optional | 
| context_output | Set to true to output context data. By default, only print to war room. Possible values are: true, false. Default is false. | Optional | 
...
***
Basic vulnerability search. Will not return vulnerabilities seen more than 31 days ago. Please use advanced search to return older vulnerabilities. If start/end timestamps are present, the range must be valid for at least one of the time stamps fields. Check the documentation for the TimestampFieldStrategy field for more details.
...
| asset | Asset ids or short names. | Optional | 
| vulnerability_id | Vulnerability external ID. | Optional | 
| severity | Vulnerability severity. Possible values are: info, low, medium, high, critical. | Optional | 
| resolution | Vulnerability resolution. Possible values are: unresolved, accepted, temporarilyAccepted, falsePositive, serviceNotAvailable, noLongerVulnerable. | Optional | 
| time_field_strategy | which time field(s) to filter by timestamp start/end. | Optional | 
| sort_by | Fields to sort by - refer to the search POST endpoint to see which fields are permitted. | Optional | 
| limit | Limit results. The sum of limit and offset must be &lt;= 10'000. Default vale: 25. | Optional | 
| start_timestamp | Lower bound timestamp filter frame. | Optional | 
| end_timestamp | Upper bound timestamp filter value. | Optional | 
| offset | Offset results. The sum of limit and offset must be &lt;= 10'000. | Optional | 
| include_deleted | include deleted. | Optional | 
| context_output | Set to true to output to context data. By default, only print to war room. Possible values are: true, false. Default is false. | Optional | 
