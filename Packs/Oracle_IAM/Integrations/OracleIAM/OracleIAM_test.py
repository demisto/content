...
from OracleIAM import Client, create_group_command, delete_group_command, get_group_command, main, update_group_command
...
class TestGetUserCommand:
    def test_existing_user(self):
        ...
        with requests_mock.Mocker() as m:
            ...
            m.get('https://test.com/admin/v1/Users?filter=userName eq "mock_user_name"', json={"Resources": [{"id": "123456"}]})
    ...
    def test_get_bad_response(self, mocker):
        ...
        with requests_mock.Mocker() as m:
            m.post("https://test.com/oauth2/v1/token", json={})
            m.get(
                'https://test.com/admin/v1/Users?filter=userName eq "mock_user_name"',
                status_code=500,
...
class TestCreateGroupCommand:
    ...
    def test_group_already_exist(self):
        ...
        with requests_mock.Mocker() as m:
            m.post("https://test.com/oauth2/v1/token", json={})
            m.post("https://test.com/admin/v1/Groups", status_code=400, json={"detail": "Group already exist", "status": 400})
