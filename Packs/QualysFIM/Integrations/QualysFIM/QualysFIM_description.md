Before you start, make sure that you have Qualys login credentials. The username and password you need for the integration instance are the Qualys FIM username and password you use in the Qualys FIM UI. This should be provided when you first register to Qualys FIM services.
