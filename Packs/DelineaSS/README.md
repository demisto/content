...
5. Click to select the Enable Syslog/CEF Logging check box. A syslog/CEF section will appear.

6. Type IP address or name for the XSIAM broker VM in the Syslog/CEF Server text box.
...
#### More information on SIEM integration can be found [here](https://docs.thycotic.com/ss/11.1.0/events-and-alerts/secure-syslog-cef) and [here](https://docs.delinea.com/int/current/splunk/splunk-on-prem/config/event-log-analysis.md)
