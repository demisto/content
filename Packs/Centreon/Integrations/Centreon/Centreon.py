...
def transform_host_vals(key, value):
    ...
    host_service_status = {"0": "Up", "4": "Pending"}
...
def get_host_status_command():
    ...
    entry = {
        ...
        "EntryContext": {"Centreon.Host(val.Id==obj.Id)": camel_case_response},
    }
...
def get_service_status_command():
    ...
    entry = {
        ...
        "EntryContext": {"Centreon.Service(val.ServiceId==obj.ServiceId)": camel_case_response},
    }
