...
Contains functions to run searches and return data based on incoming incidents. Returned data 
can be used inside playbooks to make user-defined decisions or enrich incident metadata. 
"""
