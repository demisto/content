from CompareIndicators import collect_unique_indicators_from_lists, demisto, extract_list_from_args
...
def test_extract_list_from_args__file_exists(mocker):
    ...
    """
    mocker.patch.object(demisto, "getFilePath", return_value={"path": "test_files/ips.txt"})
