        ...
        [
            {
                ...
                "labels": [
                    {"type": "Email/subject", "value": "Potential phishing I received"},
        ...
        [
            {
                ...
                "occurred": "0001-01-01T00:00:00Z",
                "attachment": [
                    {"path": "example_id", "name": "example_path.eml"},
...
PARSED_INCIDENT = [
    (
        context_list.get("CONTEXT_WITH_ATTACHMENT_AS_ENTRY_ID"),
        [
            {
                "name": "Potential phishing I received",
                "occurred": "0001-01-01T00:00:00Z",
...
CASES = [
    ...
    (incident_list.get("WITHOUT_LABEL"), None, [{"name": "Potential phishing I received", "occurred": "0001-01-01T00:00:00Z"}]),
    (
        incident_list.get("WITH_LABEL"),
        ["example_path.eml"],
        [
    ...
    (
        incident_list.get("WITHOUT_LABEL"),
        ["example_path.eml", "example_path2.eml"],
        [
            {
                "name": "Potential phishing I received",
                "occurred": "0001-01-01T00:00:00Z",
    ...
    (
        incident_list.get("MULTIPLE_INCIDENTS"),
        ["example_path.eml"],
        [
            {"name": "Potential phishing I received", "occurred": "0001-01-01T00:00:00Z", "attachment": ["example_path.eml"]},
            {"name": "Potential phishing I received 2", "occurred": "0001-01-01T00:00:00Z", "attachment": ["example_path.eml"]},
        ],
    ),
...
def test_create_test_incident_command_bad(incident_path):
    ...
    with pytest.raises(ValueError) as e:
        CreateIncidents.create_test_incident_from_file_command(
            CreateIncidents.Client("example_base_url.com", False, False), {"incidents_path": incident_path}
        )
...
def test_create_test_incident_command_happy(mocker, incidents, attachment, expected):
    ...
    mocker.patch.object(CreateIncidents.Client, "http_request", side_effect=http_mock)
    CreateIncidents.create_test_incident_from_file_command(
        CLIENT_MOCK, {"incidents_path": "example.json", "attachment_paths": attachment}
    )
...
ARGS = [
    {"incident_entry_id": "entry_id", "incident_raw_json": '{"name": "incident"}'},
