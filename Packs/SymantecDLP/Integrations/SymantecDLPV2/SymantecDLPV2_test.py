...
FIRST_INCIDENT_DETAILS = json.dumps(
    {
        "ID": 3620,
        "severity": "High",
        "customAttributeGroup": [
            {
                ...
                "customAttribute": [
                    {"name": "Custom Attribute1", "index": 1},
                    {"name": "cust2", "index": 2},
                    {"name": "bla", "index": 3},
                ],
            },
        ...
        "messageId": 2104,
        "messageOriginatorID": 828,
        "matchCount": 3,
        "creationDate": "2022-03-06T15:23:53.245",
        "isBlockedStatusSuperseded": False,
        "detectionServerName": "Detection - Network monitor",
        "networkSenderPort": 59637,
        "messageType": "HTTP",
        "policyId": 2,
        "detectionDate": "2022-03-06T15:23:39.197",
        "messageTypeId": 3,
        "detectionServerId": 1,
        "messageDate": "2022-03-06T15:23:39.197",
        "senderIPAddress": "1.1.1.1",
        "endpointMachineIpAddress": "1.1.1.1",
        "recipientInfo": [
            {
                "recipientType": 1,
                "recipientPort": 80,
                "recipientDomain": "2.2.2.254",
                "recipientIdentifier": "http://2.2.2.254/latest/api/token",
                "recipientIPAddress": "2.2.2.254",
                "recipientUrl": "http://2.2.2.254/latest/api/token",
            }
        ],
        "networkSenderIdentifier": "1.1.1.1",
...
SECOND_INCIDENT_DETAILS = json.dumps(
    {
        ...
        "attachmentInfo": [
            {
                "componentType": 3,
                "messageComponentName": "423.txt",
                "messageComponentId": 4638,
                "wasCracked": False,
                "documentFormat": "ascii",
                "originalSize": 3928,
            }
        ],
        "fileCreateDate": "2022-01-05T14:10:04.798",
        "discoverServer": "c:",
        "fileAccessDate": "2022-01-05T14:10:04.798",
        "discoverTargetName": "Discovery server - File system",
        "messageType": "RAW",
        "discoverRepositoryLocation": "c:/das/423.txt",
        "discoverScanId": 216,
        "discoverContentRootPath": "c:/das",
        "policyName": "Illegal Drugs",
        "policyGroupName": "Test Policy group for Endpoint Discover",
        "policyGroupId": 21,
        "messageSource": "DISCOVER",
        "messageId": 2110,
        "matchCount": 100,
        "creationDate": "2022-03-06T15:23:53.246",
        "discoverMillisSinceFirstSeen": 5244552861,
        "isBlockedStatusSuperseded": False,
        "detectionServerName": "Detection - Discovery",
        "messageAclEntries": [
            ...
            {"principal": "BUILTIN\\Users", "aclType": "FILE", "permission": "READ", "grantDeny": "GRANT"},
        ],
        "policyId": 43,
        "detectionDate": "2022-03-06T15:23:39.197",
        "messageTypeId": 9,
        "discoverTargetId": 2,
        "discoverScanStartDate": "2022-03-06T07:00:00",
        "discoverName": "423.txt",
        "detectionServerId": 21,
        "messageDate": "2022-01-05T14:10:16.548",
        "fileOwner": "BUILTIN\\Administrators",
        "discoverUrl": "c:/das/423.txt",
        "isHidingNotAllowed": False,
        "incidentStatusName": "incident.status.New",
...
def test_parse_custom_attribute():
    ...
    custom_attribute_group_list = [
        {
            "customAttributes": [{"name": "cn", "index": 1, "displayOrder": 1, "value": None, "email": False}],
            "name": "Default Attribute Group",
        },
        {
            "customAttributes": [
                {"name": "Resolution", "index": 2, "displayOrder": 2, "value": None, "email": False},
                {"name": "First Name", "value": "Admin", "index": 3, "displayOrder": 3, "email": False},
            ],
            "name": "Predefined",
        },
    ]
    ...
    custom_attribute_all_list_output = [
        {"customAttribute": [{"index": 1, "name": "cn"}], "name": "Default Attribute Group"},
        {
            "customAttribute": [{"index": 2, "name": "Resolution"}, {"index": 3, "name": "First Name", "value": "Admin"}],
            "name": "Predefined",
        },
    ]
    ...
    with raises(
        DemistoException,
        match="When choosing the custom value for custom_attributes argument -"
    ...
    custom_attribute_custom_list_output = [
        {"customAttribute": {"index": 1, "name": "cn"}, "name": "Default Attribute Group"},
        {"customAttribute": {"index": 3, "name": "First Name", "value": "Admin"}, "name": "Predefined"},
    ]
    ...
    with raises(
        DemistoException,
        match="When choosing the group value for custom_attributes argument -"
...
@pytest.mark.parametrize(
    "custom_attribute,expected_result",
    [
...
@pytest.mark.parametrize("severity,expected_result", [(1, "High"), (4, "Info")])
...
@pytest.mark.parametrize(
    "creation_date,expected_result", [("2 days", "2022-03-02T13:34:14Z"), ("2022-03-02T13:34:14Z", "2022-03-02T13:34:14Z")]
)
...
def test_create_update_body():
    ...
    update_body = create_update_body(
        incident_ids=[3620], data_owner_email="testing@gmail.com", note="test note", custom_attributes=["1:test"]
    )
    assert update_body == {
        "incidentIds": [3620],
...
def test_get_incident_details_command(mocker):
    ...
    mocker.patch.object(client, "get_incident_editable_attributes_request", return_value=incident_editable_attributes_res)
...
def test_fetch_incidents_single(requests_mock):
    ...
    requests_mock.post("https://SymantecDLPV2.com/ProtectManager/webservices/v2/incidents", json=SINGLE_INCIDENTS_MOCK_RESPONSE)
    requests_mock.get(
...
def test_fetch_incidents_multiple(requests_mock):
    ...
    requests_mock.post("https://SymantecDLPV2.com/ProtectManager/webservices/v2/incidents", json=MULTIPLE_INCIDENTS_MOCK_RESPONSE)
    requests_mock.get(
        "https://SymantecDLPV2.com/ProtectManager/webservices/v2/incidents/3620/staticAttributes",
...
def test_get_incident_original_message_command(requests_mock):
    ...
    requests_mock.get("https://SymantecDLPV2.com/ProtectManager/webservices/v2/incidents/1234/originalMessage", content=b"123")
...
def test_get_report_filters_command(requests_mock):
    ...
    requests_mock.get("https://SymantecDLPV2.com/ProtectManager/webservices/v2/savedReport/1234", json={"test": "test"})
...
def test_list_users_command(requests_mock):
    ...
    mocked_response = [
        {"userId": 241, "userName": "User1", "emailAddress": "test@gmail.com", "accountDisabled": "no", "roles": ["API Web"]}
    ]

    requests_mock.get("https://SymantecDLPV2.com/ProtectManager/webservices/v2/users", json=mocked_response)
...
def test_get_sender_recipient_pattern_command(requests_mock):
    ...
    mocked_response = {
        ...
        "modifiedBy": {"id": 343, "name": "AdminUsername "},
        "userPatterns": ["domain-jsmith", "domain-jdoe"],
        "ipAddresses": ["1.1.1.1", "2.2.2.2"],
    }

    requests_mock.get("https://SymantecDLPV2.com/ProtectManager/webservices/v2/senderRecipientPattern/1234", json=mocked_response)
...
def test_list_sender_recipient_patterns_command(requests_mock):
    ...
    requests_mock.get("https://SymantecDLPV2.com/ProtectManager/webservices/v2/senderRecipientPattern/list", json=mocked_response)
...
def test_update_sender_pattern_command(requests_mock):
    ...
    requests_mock.put("https://SymantecDLPV2.com/ProtectManager/webservices/v2/senderRecipientPattern/1234", json=mocked_response)
...
def test_get_message_body_command(requests_mock):
    ...
    requests_mock.get("https://SymantecDLPV2.com/ProtectManager/webservices/v2/incidents/1234/messageBody", json={"test": "test"})
