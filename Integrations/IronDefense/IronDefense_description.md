...
## Fetching Incidents
This integration can fetch Alert Notifications, Event Notifications, and Dome Notifications as incidents. Fetching any of these Notifications is done without support for refresh.  The default configuration is to fetch just Alert Notifications as incidents. 
## Test Playbook
A test playbook containing all commands defined by this integration is provided for reference. Search for the 
