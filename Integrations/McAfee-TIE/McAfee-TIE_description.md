...
To connect the McAfee TIE using the DXL TIE client, you need to create certificates and configure DXL. For more information, see the [OpenDXL documentation](https://opendxl.github.io/opendxl-client-python/pydoc/index.html). After you complete this configuration, you will have the following files.
