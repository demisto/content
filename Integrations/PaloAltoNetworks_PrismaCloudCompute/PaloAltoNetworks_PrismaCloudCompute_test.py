...
def test_fetch_incidents(requests_mock):
    json_incidents_mock_response = [
        ...
        },
        {
            ...
            "command": "",
            "container": "",
            "forensicLink": "/api/v1/profiles/host/devbox/forensic/download?hostname=devbox&incidentID=id",
            "fqdn": "devbox",
            "function": "",
            "host": "devbox",
            "image": "",
    ...
    expected_incidents = [
        ...
        {'name': 'Prisma Cloud Compute Alert - Incident', 'occurred': '2020-01-09T10:49:24.675Z', 'severity': 0,
         'rawJSON': '{"_id": "5e170535776710d48a0812ff", "activityType": "", "appID": "", "category": "customRule", '
                    ...
                    '"/api/v1/profiles/host/devbox/forensic/download?hostname=devbox&incidentID=id", '
        ...
        {'name': 'Prisma Cloud Compute Alert - Cloud Discovery', 'occurred': '2020-01-09T10:50:08.115Z', 'severity': 0,
         'rawJSON': '{"_id": "5e170560776710d48a081321", "accountID": "123456789", "credentialId": "koko", '
                    ...
                    '"createdAt": "2019-03-05T10:53:07Z", "name": "test4", "protected": false}], '
                    ...
                    '"time": "2020-01-09T10:50:08.115Z", "total": 4, "entitiesMarkdownTable": "### Entities '
        ...
        {'name': 'Prisma Cloud Compute Alert - Container Compliance', 'occurred': '2020-01-09T10:52:31.185Z',
         ...
         'rawJSON': '{"_id": "5e1705ef776710d48a0813b4", "compliance": [{"description": "(CIS_Docker_CE_v1.1.0 - '
                    ...
                    '"time": "2020-01-09T10:52:31.185Z", "type": "container", "complianceMarkdownTable": "### '
        ...
        {'name': 'Prisma Cloud Compute Alert - Image Compliance', 'occurred': '2020-01-09T10:52:31.185Z', 'severity': 0,
         'rawJSON': '{"_id": "5e1705ef776710d48a0813b5", "compliance": [{"description": "(CIS_Docker_CE_v1.1.0 - 4.1) '
                    ...
                    '"kind": "compliance", "time": "2020-01-09T10:52:31.185Z", "type": "image", '
                    '"complianceMarkdownTable": "### Compliance Table\\n|Description|Id|Type|\\n|---|---|---|\\n| ('
        ...
        {'name': 'Prisma Cloud Compute Alert - Vulnerability in library/alpine:2.6',
         ...
         'rawJSON': '{"_id": "5e170623776710d48a081440", "distroName": "BusyBox 1.21.1", "imageName": '
                    ...
                    '"vulnerabilities": [{"cve": "CVE-2019-5747", "link": '
                    '"https://test.com", "packageVersion": "1.21.1", '
                    '"packages": "busybox", "severity": "high", "sourcePackage": "", "status": ""}, '
                    '{"cve": "CVE-2017-16544", "link": '
                    '"https://test.com", "packageVersion": "1.21.1", '
                    '"packages": "busybox", "severity": "high", "sourcePackage": "", "status": ""}, '
                    '{"cve": "CVE-2016-2147", "link": '
                    '"https://test.com", "packageVersion": "1.21.1", '
                    '"packages": "busybox", "severity": "high", "sourcePackage": "", "status": "fixed in 1.25.0"}, '
                    '{"cve": "ALAS-2018-1065", "link": "", "packageVersion": "1.0.1m-r0", "packages": "libcrypto1.0", '
                    '"severity": "medium", "sourcePackage": "openssl", "status": "fixed in 1.0.2k-12.110.amzn1"}, '
                    '{"cve": "ALAS-2019-1188", "link": "", "packageVersion": "1.0.1m-r0", "packages": "libcrypto1.0", '
                    '"severity": "medium", "sourcePackage": "openssl", "status": "fixed in 1.0.2k-16.150.amzn1"}], '
                    '"vulnerabilitiesMarkdownTable": "### Vulnerabilities Table\\n|Cve|Link|Package '
                    'Version|Packages|Severity|Source Package|Status|\\n|---|---|---|---|---|---|---|\\n| '
                    'CVE-2019-5747 | https://test.com | 1.21.1 | '
                    'busybox | high |  |  |\\n| CVE-2017-16544 | '
                    'https://test.com | 1.21.1 | busybox | high |  |  '
                    '|\\n| CVE-2016-2147 | https://test.com | 1.21.1 | '
                    'busybox | high |  | fixed in 1.25.0 |\\n| ALAS-2018-1065 |  | 1.0.1m-r0 | libcrypto1.0 | medium '
                    '| openssl | fixed in 1.0.2k-12.110.amzn1 |\\n| ALAS-2019-1188 |  | 1.0.1m-r0 | libcrypto1.0 | '
                    'medium | openssl | fixed in 1.0.2k-16.150.amzn1 |\\n"}'}]
