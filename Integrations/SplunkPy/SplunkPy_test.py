...
RAW_WITH_MESSAGE = '{"@timestamp":"2019-10-15T13:30:08.578-04:00","message":"{"TimeStamp":"2019-10-15 13:30:08",' \
                   ...
                   '"73.110.240.176","PRODUCT_CODE":"WFNPortal","X-FORWARDED-PROTO":"http","ERROR_ID":"4008",' \
                   '"SCOPE[23]":"\/security\/notification-communication-response-value.accept","REQ_URL":' \
                   '"http:\/\/step-up-authentication-api.gslb.es.oneadp.com\/smsstepup\/events\/core\/v1\/step-up-' \
                   ...
                   '\/payroll\/v1\/earning-configuration.add","ORGOID":"G2SY6MR3ATKA121T","SCOPE[8]":"\/' \
                   ...
                   '\/OrganizationSoftPurge","X-FORWARDED-HOST":"step-up-authentication-api.gslb.es.oneadp.com",' \
                   '"ADP-MESSAGEID":"a1d57ed2-1fe6-4800-be7a-26cd89bf686d","CNAME":"JRJG INC","CONTENT-LENGTH":' \
                   '"584","SCOPE[31]":"autopay\/events\/payroll\/v1\/earning-configuration.remove","CID":"BSTAR00044"' \
                   ',"ACTOR_UID":"KWinters@BSTAR00044","SECURE_API_MODE":"HTTPS_SECURE","X-REQUEST-ID":' \
                   '"2473a981bef27bc8444e510adc80844a","SCOPE[1]":"AVSSCP\/Docstash\/Download","SCOPE[18]":' \
                   '"\/api\/events\/core\/v1\/product-role.assign","BLOCK_SESSION":"Y","CONSUMER_ID":' \
                   '"ab2e715e-41c4-43d6-bff7-fc2d713eb73b","SCOPE[34]":"autopay\/payroll\/v1\/cafeteria-plan-' \
                   ...
                   '"SUBJECT_ORGOID":"G2SY6MR3ATKA121T","SCOPE[5]":"\/Associate","SCOPE[14]":"\/Organization",' \
                   '"SCOPE[26]":"WFNSvcsProvider\/payrollPi","EVENT_ID":"9ea87118-5679-4d0e-a67f-0abd9cc0f8cd",' \
                   ...
                   '"867b6d06-47cf-40ab-8dd7-bd0d57b157fd","X-DOMAIN":"netsecure.api.ws.adp.com","SOR_CODE":' \
                   ...
                   '"73.110.240.176, 11.2.244.195, 11.3.78.5, 11.1.76.5","SCOPE[17]":"\/api\/core\/v1\/organization",' \
                   ...
                   '"http","ADP-CONVERSATIONID":"stY46PpweFToT5JX04CZGMeHbX8=","SCOPE[12]":' \
                   ...
                   '-configurations","SESSION_ID":"f50be909-9e4f-408d-bf77-68499012bc24","SCOPE[20]":' \
                   '"\/api\/events\/core\/v1\/user.provision","SUBJECT_AOID":"G370XX6XYCBZDDWN",' \
                   '"X-ORIGINAL-FORWARDED-FOR":"73.110.240.176, 11.2.244.195, 11.3.78.5","SCOPE[40]":' \
                   '"autopay\/payroll\/v1\/employer-details"}","TXID":"3AF-D30-7CTTCQ","ADP-MessageID":' \
                   '"a1d57ed2-1fe6-4800-be7a-26cd89bf686d","SESSIONID":"stY46PpweFToT5JX04CZGMeHbX8=","ORGOID":' \
                   '"G2SY6MR3ATKA121T","AOID":"G2N2TJETBRAAX68V","MSGID":"a1d57ed2-1fe6-4800-be7a-26cd89bf686d"}'
