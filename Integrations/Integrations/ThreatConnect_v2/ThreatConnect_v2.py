        ...
        try:
            for indicator in raw_indicators:
                for associated_indicator in indicator.indicator_associations:
                    associatedIndicators.append({"id": associated_indicator.id, "indicator": associated_indicator.indicator, "type": associated_indicator.type, "description": associated_indicator.description, "owner_name": associated_indicator.owner_name,
                                                 "rating": associated_indicator.rating, "confidence": associated_indicator.confidence, "date_added": associated_indicator.date_added, "last_modified": associated_indicator.last_modified, "weblink": associated_indicator.weblink})
...
def tc_get_indicator_command():
    ...
    ec, indicators, raw_indicators, indicators_associations, indicator_groups, indicator_observations, indicator_tags = tc_get_indicator(
        indicator, owners, rating_threshold, confidence_threshold, associated_groups, associated_indicators, include_observations, include_tags, indicator_type)
