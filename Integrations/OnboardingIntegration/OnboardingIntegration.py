...
<table border="0" cellpadding="0" cellspacing="0" align="center" width="inherit" style="-ms-text-size-adjust:100%; -webkit-font-smoothing:antialiased; -webkit-text-size-adjust:100%; line-height:100%; text-size-adjust:100%; border-spacing:0; mso-table-lspace:0; mso-table-rspace:0; border-collapse:collapse; max-width:560px; padding:0; width:inherit" class="wrapper">
    ...
    <tr>
        <td align="center" valign="top" style="-ms-text-size-adjust:100%; -webkit-font-smoothing:antialiased; -webkit-text-size-adjust:100%; line-height:100%; text-size-adjust:100%; border-spacing:0; mso-table-lspace:0; mso-table-rspace:0; border-collapse:collapse; margin:0; padding:0; padding-bottom:20px; padding-left:6.25%; padding-right:6.25%; padding-top:20px; width:87.5%" width="87.5%">
            ...
            <div style="-ms-text-size-adjust:100%; -webkit-font-smoothing:antialiased; -webkit-text-size-adjust:100%; line-height:1px; text-size-adjust:100%; color:#F0F0F0; display:none; font-size:1px; height:0; max-height:0; max-width:0; opacity:0; overflow:hidden; visibility:hidden" class="preheader" height="0">
            ...
            <a target="_blank" style="-ms-text-size-adjust:100%; -webkit-font-smoothing:antialiased; -webkit-text-size-adjust:100%; line-height:100%; text-size-adjust:100%; color:#127DB3; text-decoration:none" href="https://github.com/konsav/email-templates/"><img border="0" vspace="0" hspace="0" src="https://raw.githubusercontent.com/konsav/email-templates/master/images/logo-black.png" width="100" height="30" alt="Logo" title="Logo" style="-ms-interpolation-mode:bicubic; border:none; line-height:100%; outline:none; text-decoration:none; color:#000; display:block; font-size:10px; margin:0; padding:0"></a>
...
<table border="0" cellpadding="0" cellspacing="0" align="center" bgcolor="#FFFFFF" width="inherit" style="-ms-text-size-adjust:100%; -webkit-font-smoothing:antialiased; -webkit-text-size-adjust:100%; line-height:100%; text-size-adjust:100%; border-spacing:0; mso-table-lspace:0; mso-table-rspace:0; border-collapse:collapse; max-width:560px; padding:0; width:inherit" class="container">

    <!-- HEADER -->
    <!-- Set text color and font family ("sans-serif" or "Georgia, serif") -->
    <tr>
        <td align="center" valign="top" style="-ms-text-size-adjust:100%; -webkit-font-smoothing:antialiased; -webkit-text-size-adjust:100%; line-height:130%; text-size-adjust:100%; border-spacing:0; mso-table-lspace:0; mso-table-rspace:0; border-collapse:collapse; color:#000; font-family:sans-serif; font-size:24px; font-weight:bold; margin:0; padding:0; padding-left:6.25%; padding-right:6.25%; padding-top:25px; width:87.5%" class="header" width="87.5%">
    ...
    <!-- Set text color and font family ("sans-serif" or "Georgia, serif") -->
    <tr>
        <td align="center" valign="top" style="-ms-text-size-adjust:100%; -webkit-font-smoothing:antialiased; -webkit-text-size-adjust:100%; line-height:150%; text-size-adjust:100%; border-spacing:0; mso-table-lspace:0; mso-table-rspace:0; border-collapse:collapse; color:#000; font-family:sans-serif; font-size:18px; font-weight:300; margin:0; padding:0; padding-bottom:3px; padding-left:6.25%; padding-right:6.25%; padding-top:5px; width:87.5%" class="subheader" width="87.5%">
    ...
    <tr>
        <td align="center" valign="top" style="-ms-text-size-adjust:100%; -webkit-font-smoothing:antialiased; -webkit-text-size-adjust:100%; line-height:100%; text-size-adjust:100%; border-spacing:0; mso-table-lspace:0; mso-table-rspace:0; border-collapse:collapse; margin:0; padding:0; padding-top:20px" class="hero"><a target="_blank" style="-ms-text-size-adjust:100%; -webkit-font-smoothing:antialiased; -webkit-text-size-adjust:100%; line-height:100%; text-size-adjust:100%; color:#127DB3; text-decoration:none" href="https://github.com/konsav/email-templates/"><img border="0" vspace="0" hspace="0" src="https://raw.githubusercontent.com/konsav/email-templates/master/images/hero-wide.png" alt="Please enable images to view this content" title="Hero Image" width="100%" style="-ms-interpolation-mode:bicubic; border:none; line-height:100%; outline:none; text-decoration:none; color:#000; display:block; font-size:13px; margin:0; max-width:560px; padding:0; width:100%"></a></td>
    </tr>

    <!-- PARAGRAPH -->
    <!-- Set text color and font family ("sans-serif" or "Georgia, serif"). Duplicate all text styles in links, including line-height -->
    <tr>
        <td align="center" valign="top" style="-ms-text-size-adjust:100%; -webkit-font-smoothing:antialiased; -webkit-text-size-adjust:100%; line-height:160%; text-size-adjust:100%; border-spacing:0; mso-table-lspace:0; mso-table-rspace:0; border-collapse:collapse; color:#000; font-family:sans-serif; font-size:17px; font-weight:400; margin:0; padding:0; padding-left:6.25%; padding-right:6.25%; padding-top:25px; width:87.5%" class="paragraph" width="87.5%">
        ''',
              '                {}',
              '''
        </td>
    ...
    <!-- Set line color -->
    <tr>	
        <td align="center" valign="top" style="-ms-text-size-adjust:100%; -webkit-font-smoothing:antialiased; -webkit-text-size-adjust:100%; line-height:100%; text-size-adjust:100%; border-spacing:0; mso-table-lspace:0; mso-table-rspace:0; border-collapse:collapse; margin:0; padding:0; padding-left:6.25%; padding-right:6.25%; padding-top:25px; width:87.5%" class="line" width="87.5%"><hr color="#E0E0E0" align="center" width="100%" size="1" noshade style="margin: 0; padding: 0;">
        </td>
    </tr>

    <!-- LIST -->
    <tr>
        <td align="center" valign="top" style="-ms-text-size-adjust:100%; -webkit-font-smoothing:antialiased; -webkit-text-size-adjust:100%; line-height:100%; text-size-adjust:100%; border-spacing:0; mso-table-lspace:0; mso-table-rspace:0; border-collapse:collapse; margin:0; padding:0; padding-left:6.25%; padding-right:6.25%" class="list-item"><table align="center" border="0" cellspacing="0" cellpadding="0" style="-ms-text-size-adjust:100%; -webkit-font-smoothing:antialiased; -webkit-text-size-adjust:100%; line-height:100%; text-size-adjust:100%; border-spacing:0; mso-table-lspace:0; mso-table-rspace:0; border-collapse:collapse; margin:0; padding:0; width:inherit" width="inherit">
            ...
            <tr>
                ...
                <td align="left" valign="top" style="-ms-text-size-adjust:100%; -webkit-font-smoothing:antialiased; -webkit-text-size-adjust:100%; line-height:100%; text-size-adjust:100%; border-spacing:0; mso-table-lspace:0; mso-table-rspace:0; border-collapse:collapse; padding-right:20px; padding-top:30px"><img border="0" vspace="0" hspace="0" style="-ms-interpolation-mode:bicubic; border:none; line-height:100%; outline:none; text-decoration:none; color:#000; display:block; margin:0; padding:0" src="https://raw.githubusercontent.com/konsav/email-templates/master/images/list-item.png" alt="H" title="Highly compatible" width="50" height="50"></td>

                <!-- LIST ITEM TEXT -->
                <!-- Set text color and font family ("sans-serif" or "Georgia, serif"). Duplicate all text styles in links, including line-height -->
                <td align="left" valign="top" style="-ms-text-size-adjust:100%; -webkit-font-smoothing:antialiased; -webkit-text-size-adjust:100%; line-height:160%; text-size-adjust:100%; border-spacing:0; mso-table-lspace:0; mso-table-rspace:0; border-collapse:collapse; color:#000; font-family:sans-serif; font-size:17px; font-weight:400; margin:0; padding:0; padding-top:25px" class="paragraph">
            ...
            <tr>
                ...
                <!-- LIST ITEM IMAGE -->
                <!-- Image text color should be opposite to background color. Set your url, image src, alt and title. Alt text should fit the image size. Real image size should be x2 -->
                <td align="left" valign="top" style="-ms-text-size-adjust:100%; -webkit-font-smoothing:antialiased; -webkit-text-size-adjust:100%; line-height:100%; text-size-adjust:100%; border-spacing:0; mso-table-lspace:0; mso-table-rspace:0; border-collapse:collapse; padding-right:20px; padding-top:30px"><img border="0" vspace="0" hspace="0" style="-ms-interpolation-mode:bicubic; border:none; line-height:100%; outline:none; text-decoration:none; color:#000; display:block; margin:0; padding:0" src="https://raw.githubusercontent.com/konsav/email-templates/master/images/list-item.png" alt="D" title="Designer friendly" width="50" height="50"></td>
    ...
    <!-- Set text color and font family ("sans-serif" or "Georgia, serif"). Duplicate all text styles in links, including line-height -->
    <tr>
        <td align="center" valign="top" style="-ms-text-size-adjust:100%; -webkit-font-smoothing:antialiased; -webkit-text-size-adjust:100%; line-height:160%; text-size-adjust:100%; border-spacing:0; mso-table-lspace:0; mso-table-rspace:0; border-collapse:collapse; color:#000; font-family:sans-serif; font-size:17px; font-weight:400; margin:0; padding:0; padding-bottom:25px; padding-left:6.25%; padding-right:6.25%; padding-top:20px; width:87.5%" class="paragraph" width="87.5%">
                {}
        </td>
    </tr>
...
<table border="0" cellpadding="0" cellspacing="0" align="center" width="inherit" style="-ms-text-size-adjust:100%; -webkit-font-smoothing:antialiased; -webkit-text-size-adjust:100%; line-height:100%; text-size-adjust:100%; border-spacing:0; mso-table-lspace:0; mso-table-rspace:0; border-collapse:collapse; max-width:560px; padding:0; width:inherit" class="wrapper">
    ...
    <!-- Image text color should be opposite to background color. Set your url, image src, alt and title. Alt text should fit the image size. Real image size should be x2 -->
    <tr>
        <td align="center" valign="top" style="-ms-text-size-adjust:100%; -webkit-font-smoothing:antialiased; -webkit-text-size-adjust:100%; line-height:100%; text-size-adjust:100%; border-spacing:0; mso-table-lspace:0; mso-table-rspace:0; border-collapse:collapse; margin:0; padding:0; padding-left:6.25%; padding-right:6.25%; padding-top:25px; width:87.5%" class="social-icons" width="87.5%"><table width="256" border="0" cellpadding="0" cellspacing="0" align="center" style="-ms-text-size-adjust:100%; -webkit-font-smoothing:antialiased; -webkit-text-size-adjust:100%; line-height:100%; text-size-adjust:100%; border-spacing:0; mso-table-lspace:0; mso-table-rspace:0; border-collapse:collapse; padding:0">
            <tr>

                <!-- ICON 1 -->
                <td align="center" valign="middle" style="-ms-text-size-adjust:100%; -webkit-font-smoothing:antialiased; -webkit-text-size-adjust:100%; line-height:100%; text-size-adjust:100%; border-spacing:0; mso-table-lspace:0; mso-table-rspace:0; border-collapse:collapse; margin:0; padding:0; padding-left:10px; padding-right:10px"><a target="_blank" href="https://raw.githubusercontent.com/konsav/email-templates/" style="-ms-text-size-adjust:100%; -webkit-font-smoothing:antialiased; -webkit-text-size-adjust:100%; line-height:100%; text-size-adjust:100%; color:#127DB3; text-decoration:none"><img border="0" vspace="0" hspace="0" style="-ms-interpolation-mode:bicubic; border:none; line-height:100%; outline:none; text-decoration:none; color:#000; display:inline-block; margin:0; padding:0" alt="F" title="Facebook" width="44" height="44" src="https://raw.githubusercontent.com/konsav/email-templates/master/images/social-icons/facebook.png"></a></td>

                <!-- ICON 2 -->
                <td align="center" valign="middle" style="-ms-text-size-adjust:100%; -webkit-font-smoothing:antialiased; -webkit-text-size-adjust:100%; line-height:100%; text-size-adjust:100%; border-spacing:0; mso-table-lspace:0; mso-table-rspace:0; border-collapse:collapse; margin:0; padding:0; padding-left:10px; padding-right:10px"><a target="_blank" href="https://raw.githubusercontent.com/konsav/email-templates/" style="-ms-text-size-adjust:100%; -webkit-font-smoothing:antialiased; -webkit-text-size-adjust:100%; line-height:100%; text-size-adjust:100%; color:#127DB3; text-decoration:none"><img border="0" vspace="0" hspace="0" style="-ms-interpolation-mode:bicubic; border:none; line-height:100%; outline:none; text-decoration:none; color:#000; display:inline-block; margin:0; padding:0" alt="T" title="Twitter" width="44" height="44" src="https://raw.githubusercontent.com/konsav/email-templates/master/images/social-icons/twitter.png"></a></td>				

                <!-- ICON 3 -->
                <td align="center" valign="middle" style="-ms-text-size-adjust:100%; -webkit-font-smoothing:antialiased; -webkit-text-size-adjust:100%; line-height:100%; text-size-adjust:100%; border-spacing:0; mso-table-lspace:0; mso-table-rspace:0; border-collapse:collapse; margin:0; padding:0; padding-left:10px; padding-right:10px"><a target="_blank" href="https://raw.githubusercontent.com/konsav/email-templates/" style="-ms-text-size-adjust:100%; -webkit-font-smoothing:antialiased; -webkit-text-size-adjust:100%; line-height:100%; text-size-adjust:100%; color:#127DB3; text-decoration:none"><img border="0" vspace="0" hspace="0" style="-ms-interpolation-mode:bicubic; border:none; line-height:100%; outline:none; text-decoration:none; color:#000; display:inline-block; margin:0; padding:0" alt="G" title="Google Plus" width="44" height="44" src="https://raw.githubusercontent.com/konsav/email-templates/master/images/social-icons/googleplus.png"></a></td>		

                <!-- ICON 4 -->
                <td align="center" valign="middle" style="-ms-text-size-adjust:100%; -webkit-font-smoothing:antialiased; -webkit-text-size-adjust:100%; line-height:100%; text-size-adjust:100%; border-spacing:0; mso-table-lspace:0; mso-table-rspace:0; border-collapse:collapse; margin:0; padding:0; padding-left:10px; padding-right:10px"><a target="_blank" href="https://raw.githubusercontent.com/konsav/email-templates/" style="-ms-text-size-adjust:100%; -webkit-font-smoothing:antialiased; -webkit-text-size-adjust:100%; line-height:100%; text-size-adjust:100%; color:#127DB3; text-decoration:none"><img border="0" vspace="0" hspace="0" style="-ms-interpolation-mode:bicubic; border:none; line-height:100%; outline:none; text-decoration:none; color:#000; display:inline-block; margin:0; padding:0" alt="I" title="Instagram" width="44" height="44" src="https://raw.githubusercontent.com/konsav/email-templates/master/images/social-icons/instagram.png"></a></td>
    ...
    <!-- Set text color and font family ("sans-serif" or "Georgia, serif"). Duplicate all text styles in links, including line-height -->
    <tr>
        <td align="center" valign="top" style="-ms-text-size-adjust:100%; -webkit-font-smoothing:antialiased; -webkit-text-size-adjust:100%; line-height:150%; text-size-adjust:100%; border-spacing:0; mso-table-lspace:0; mso-table-rspace:0; border-collapse:collapse; color:#999; font-family:sans-serif; font-size:13px; font-weight:400; margin:0; padding:0; padding-bottom:20px; padding-left:6.25%; padding-right:6.25%; padding-top:20px; width:87.5%" class="footer" width="87.5%">

                This email template was sent to you becouse we want to make the world a better place. You could change your <a href="https://github.com/konsav/email-templates/" target="_blank" style="-ms-text-size-adjust:100%; -webkit-font-smoothing:antialiased; -webkit-text-size-adjust:100%; line-height:150%; text-size-adjust:100%; color:#999; font-family:sans-serif; font-size:13px; font-weight:400; text-decoration:underline">subscription settings</a> anytime.
...
TEMPLATE_3 = ['''<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <meta http-equiv="content-type" content="text/html; charset=utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0;">
    <meta name="format-detection" content="telephone=no">
