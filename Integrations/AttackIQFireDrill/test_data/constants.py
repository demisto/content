...
GET_TEST_RESULT = {'Type': 1,
        ...
        {'id': '9aed2cef-8c64-4e29-83b4-709de5963b66', 'name': 'Most Used Threat Actor Techniques', 'description': None,
         'project': '8978fe24-607a-4815-a36a-89fb6191b318', 'scenarios': [
            {'id': 'fdef9f60-d933-4158-bfde-81c2d791b2a2', 'name': 'Persistence Through Startup Folder',
             'model_json': {}},
            {'id': '04ed47b9-145c-46f6-9434-f9f5af27a2d2', 'name': 'Execute Encoded Powershell Command',
             'model_json': {'run_as_logged_in_user': False, 'timeout': 10000}},
            {'id': 'a3098773-f2c1-4b32-8cba-2ed6d7ec0ba1', 'name': 'Standard Application Layer Protocol',
             'model_json': {'ports_no_standard_protocols': ['443'], 'payload_type': ['safe', 'malicious'],
                            'timeout': 30, 'ports_standard_protocols': ['21', '25', '53', '80']}},
            {'id': '59699d35-b268-41b5-bc00-ed8acc222b64', 'name': 'Scheduled Task Execution', 'model_json': {}},
            {'id': 'cfbbd145-28a2-4ac3-a1e0-79abddfc9881', 'name': 'Dump Windows Passwords with Original Mimikatz',
             'model_json': {'mimikatz_cred_types': [], 'show_all_cred_types': False, 'wce_cred_types': 'lm_ntlm',
                            'use_custom_parameters': False, 'mimikatz_module': 'sekurlsa', 'user_type': 'all',
                            'gsecdump_cred_types': 'sam_ad', 'pwdump7_cred_types': [], 'cred_types': ['all'],
                            'undetectable_mimikatz_cred_types': [], 'print_output': False,
                            'lazagne_cred_types': 'browsers', 'pwd_dumping_tool': 'mimikatz'}},
            {'id': 'f73dd965-dc8c-4230-9745-a530b21c5333', 'name': 'Remote File Copy Script', 'model_json': {
                'scripts': [
                    {'script_hash': '1ed3ee9d6aa12e67241be44f5e284de65c8ca297025cde2ee79bc4dc7f1f425a', 'exit_code': 0,
                     'platform': 'windows', 'success_type': 'with_exit_code', 'interpreter': 'powershell.exe',
                     'script_files': '67211eac-1745-43c3-9fc9-9b99049b088c/remote_file_copy.ps1'}]}},
            {'id': '8ca3ca07-b52b-4ede-af05-ce1eb8834454', 'name': 'Command-Line Interface Script', 'model_json': {
                'scripts': [
                    {'script_hash': '4851bb8fdee02a8935a3ded79e39b6a0c2c9ab6bd5a94534a2524e50009c50e2', 'exit_code': 0,
                     'platform': 'windows', 'success_type': 'with_exit_code', 'interpreter': 'cmd.exe',
                     'script_files': '8a354ed9-fc5e-4c5c-8b8b-47e5e66a3c4b/command_line_interface.bat'}]}},
            {'id': '8e39c23c-aca4-4940-96bf-247723026e46', 'name': 'File Deletion Script', 'model_json': {'scripts': [
                {'script_hash': '6c670f90fba2fc5d6449c1948a5497ea7d0f53f1a3d4f1d26590d211b860adf6', 'exit_code': 0,
                 'platform': 'windows', 'success_type': 'with_exit_code', 'interpreter': 'cmd.exe',
                 'script_files': '029d27bb-dc6d-4510-922b-9e564df1eca4/file_deletion.bat'}]}},
            {'id': '5fbb5e71-6e35-4e2c-8dc6-7ee55be563dd', 'name': 'System Information Discovery Script',
             'model_json': {'scripts': [
                 {'script_hash': 'd51e34a47a79465a0ef3916fe01fe667e8e4281ef3b676569e6a1a33419e51ea', 'exit_code': 0,
                  'platform': 'windows', 'success_type': 'with_exit_code', 'interpreter': 'cmd.exe',
                  'script_files': '4be17c81-a0de-4a7e-acd2-b9bd9f9aeb1c/system_information_discovery.bat'},
                 {'script_hash': 'b4e7c8a463c04cd1e45e1455af358185c09d144ef3c276ebd4a0fa4c628f153e', 'exit_code': 0,
                  'execute_as_user': False, 'platform': 'linux', 'success_type': 'with_exit_code',
                  'interpreter': '/bin/bash',
                  'script_files': '3b33ee2d-04a6-4a33-b0d5-15d0c91e5857/system_information_discovery.sh'}]}},
            {'id': '1e46e621-2453-4aaa-85b7-ab67d0b37b8c', 'name': 'Persistence Through Windows Registry',
             'model_json': {'registry': [{'data': '%SystemRoot%/attackiq_data.exe', 'value': 'attackiq_value',
                                          'key': 'HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Run'},
            ...
            {'id': '03e17460-849e-4b86-b6c6-ef0db72823ff', 'ipv4_address': '172.31.39.254',
             'hostname': 'ec2amaz-g4iu5no', 'product_name': 'Windows Server 2016 Datacenter',
             'modified': '2019-09-05T13:33:34.062040Z', 'status': 'Active'}], 'asset_groups': [],
         'total_asset_count': 1, 'cron_expression': None, 'runnable': True, 'last_result': 'Failed',
         'scheduled_count': 10, 'user': 'akrupnik@paloaltonetworks.com', 'created': '2019-09-05T08:47:38.273306Z',
         'modified': '2019-09-05T08:56:42.496002Z', 'latest_instance_id': '0de2caab-1ec0-4907-948b-dca3dc65fe2c',
         'using_default_assets': True, 'using_default_schedule': True}]}, 'EntryContext': {
        'AttackIQ.Test(val.Id === obj.Id)': [
            {'Id': '9aed2cef-8c64-4e29-83b4-709de5963b66', 'Name': 'Most Used Threat Actor Techniques',
             'Description': None, 'Assessment': '8978fe24-607a-4815-a36a-89fb6191b318', 'TotalAssetCount': 1,
             'CronExpression': None, 'Runnable': True, 'LastResult': 'Failed', 'User': 'akrupnik@paloaltonetworks.com',
             'Created': '2019-09-05T08:47:38.273306Z', 'Modified': '2019-09-05T08:56:42.496002Z',
             'UsingDefaultSchedule': True, 'UsingDefaultAssets': True,
             'LatestInstanceId': '0de2caab-1ec0-4907-948b-dca3dc65fe2c',
             'Scenarios': [{'Name': 'Persistence Through Startup Folder', 'Id': 'fdef9f60-d933-4158-bfde-81c2d791b2a2'},
                           ...
                           {'Name': 'System Information Discovery Script',
                            'Id': '5fbb5e71-6e35-4e2c-8dc6-7ee55be563dd'},
                           {'Name': 'Persistence Through Windows Registry',
                            'Id': '1e46e621-2453-4aaa-85b7-ab67d0b37b8c'}], 'Assets': [
                {'Id': '03e17460-849e-4b86-b6c6-ef0db72823ff', 'Ipv4Address': '172.31.39.254',
...
GET_TEST_STATUS_RESULT = {
    ...
    'EntryContext': {
        'AttackIQ.Test(val.Id === obj.Id)': {
            'Detected': 0, 'Failed': 9, 'Finished': True, 'Passed': 1, 'Errored': 0,
            'Total': 10, 'Id': 1
        }
    }
}
GET_TEST_RESULT_RESULT = {
    ...
    "Contents": {
        "count": 1, "next": None, "previous": None, "results": [
            {
                "id": "5f044657-d0bc-48ab-afaf-98c6ae5a9e7f", "modified": "2019-09-03T14:22:46.747664Z",
                "project": {"id": "c4e352ae-1506-4c74-bd90-853f02dd765a", "name": "Arseny's ransomware project"},
                "project_run_id": "74fc59ba-ec33-41c2-a63f-9a0188e3b4bb",
                "master_job": {"id": "1c350a5a-84f2-4938-93d8-cc31f0a99482", "name": "Ransomware Download", "assets": [
                    {
                        "id": "03e17460-849e-4b86-b6c6-ef0db72823ff", "ipv4_address": "172.31.39.254",
                        "hostname": "ec2amaz-g4iu5no", "product_name": "Windows Server 2016 Datacenter",
                ...
                "instance_job": "24178034-cb69-442d-afd8-a7d87ae78eda", "instance_job_on_demand": True,
                "instance_job_run_all": True, "scenario_job_ref": 3874153,
                "scenario_scheduled_job_uuid": "6c757c3d-6e80-426e-94cb-625113845d8e",
                "scenario": {
                ...
                "asset": {"id": "03e17460-849e-4b86-b6c6-ef0db72823ff", "ipv4_address": "172.31.39.254",
                          "hostname": "ec2amaz-g4iu5no", "product_name": "Windows Server 2016 Datacenter",
                          "modified": "2019-09-05T12:10:01.590138Z"}, "asset_hostname": "ec2amaz-g4iu5no",
                "asset_ipv4_address": "172.31.39.254", "asset_group": None, "asset_group_name": None,
                "scheduled_time": "2019-09-03T14:16:00Z", "sent_to_agent": True, "done": True, "canceled": False,
                "job_state_id": 7, "job_state_name": "Finished",
                "scenario_result_value": {"ai_scenario_outcome": 1, "ai_log_time": 1567520565441,
                                          "ai_python_process_id": 100,
                                          "ai_total_time_taken": 2.687, "ai_critical_phases_successful": 0,
                                          "ai_tracker_id": "125"}, "outcome_id": 1, "outcome_name": "Passed",
                "sent_to_siem_connector": False, "result_id": "5f044657-d0bc-48ab-afaf-98c6ae5a9e7f",
                "company": "55b4e4cf-9cf9-4bef-8c21-6eb17f5bfc7d", "user": "efcc433f-c954-4855-b9f0-3c3beeefdbf6",
                "created": "2019-09-03T14:16:24.560022Z", "run_count": "",
                "scenario_scheduled_job": {"id": "5f044657-d0bc-48ab-afaf-98c6ae5a9e7f",
                                           "scenario_scheduled_job_uuid": "6c757c3d-6e80-426e-94cb-625113845d8e",
                                           "scenario_job": {"id": "5f044657-d0bc-48ab-afaf-98c6ae5a9e7f",
                                                            "master_job": "1c350a5a-84f2-4938-93d8-cc31f0a99482",
                                                            "master_job_name": "Ransomware Download",
                                                            "project": {"id": "c4e352ae-1506-4c74-bd90-853f02dd765a",
                                                                        "name": "Arseny's ransomware project"},
                                                            "scenario": {"id": "fc057ae4-c56d-4e9a-8c0f-9f22ec1e5576",
                                                                         ...
                                                                         "supported_platforms": {"osx": ">=0.0",
                                                                                                 ...
                                                                                                 "debian": ">=0.0",
                                                                                                 "fedora": ">=0.0"}},
                                                            "asset": {"id": "03e17460-849e-4b86-b6c6-ef0db72823ff",
                                                                      "ipv4_address": "172.31.39.254",
                                                                      "hostname": "ec2amaz-g4iu5no",
                                                                      "product_name": "Windows Server 2016 Datacenter",
                                                                      "modified": "2019-09-05T12:10:01.590138Z"},
                                                            "modified": "2019-09-03T14:22:46.747664Z"},
                                           "job_state": "Finished", "modified": "2019-09-03T14:22:46.747664Z"},
                "config_map_values": {}, "cancellable": True}]},
    "EntryContext": {"AttackIQ.TestResult(val.Id === obj.Id)": [
        {"Id": "5f044657-d0bc-48ab-afaf-98c6ae5a9e7f", "Modified": "2019-09-03T14:22:46.747664Z",
         "Assessment": {"Id": "c4e352ae-1506-4c74-bd90-853f02dd765a", "Name": "Arseny's ransomware project"},
         "MasterJob": {"Id": "1c350a5a-84f2-4938-93d8-cc31f0a99482", "Assets": [
             {"Ipv4Address": "172.31.39.254", "Hostname": "ec2amaz-g4iu5no",
