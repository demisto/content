...
IS_V2_API = VERSION in ['10.2', '10.3']
...
class NitroESM(object):
    ...
    def wait_for_results(self, resultID, max_wait):
        ...
        return_error('Waited more {} min for query results : {}'.format(max_wait, resultID))
...
try:
    ...
    if demisto.command() == 'fetch-incidents':
        ...
        if mode in ('cases', 'both'):
            ...
            cases.sort(key=lambda case: case['id']['value'])
        ...
        if VERSION not in ['10.0', '10.1', '10.2', '10.3']:
