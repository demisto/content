...
are available to you, you can leave it empty and press the Test button. In the error message you will receive the list of available collections for the specified discovery path.
