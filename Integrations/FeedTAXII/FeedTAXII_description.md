...
are available to you, you can leave it empty -> press the Test button and you will receive the list of available collections for the specified discovery path.
