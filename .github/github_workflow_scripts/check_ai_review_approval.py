...
MARKETPLACE_AI_REVIEWER_BOT = "marketplace-ai-reviewer"
BOT_USERNAMES = {MARKETPLACE_AI_REVIEWER_BOT, BOT_USERNAME}
...
def find_reaction_on_review(reviews: list[PullRequestReview], github_token: str, pr_number: str):
    ...
    print(f"Found {len(reviews)} AI review(s) from '{MARKETPLACE_AI_REVIEWER_BOT}'. Checking for approvals...")
...
def main():
    ...
    relevant_reviews: list[PullRequestReview] = [
        ...
        if (
            review.user
            and review.user.login in BOT_USERNAMES  # BC
