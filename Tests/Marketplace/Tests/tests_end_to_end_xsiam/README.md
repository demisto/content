...
### How to execute
```bash
python -m pytest Tests/Marketplace/Tests/tests_end_to_end_xsiam -v --disable-warnings --cloud_machine machine1 --cloud_servers_path Tests/Marketplace/Tests/tests_end_to_end_xsiam/test_cloud_server_path.json --cloud_servers_api_keys Tests/Marketplace/Tests/tests_end_to_end_xsiam/test_cloud_api_keys.json
```