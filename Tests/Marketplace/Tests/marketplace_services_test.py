...
from Tests.Marketplace.marketplace_constants import XSOAR_ON_PREM_MP, Changelog, PackStatus, PackFolders, Metadata, GCPConfig, BucketUploadFlow, \
    PackTags, XSOAR_START_TAG, XSOAR_END_TAG, XSOAR_SAAS_START_TAG, XSOAR_SAAS_END_TAG, XSOAR_ON_PREM_TAG, XSOAR_ON_PREM_END_TAG, \
    XSOAR_MP, XSIAM_MP, XSOAR_SAAS_MP, XSOAR_ON_PREM_MP
