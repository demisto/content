...
def main():
    ...
    pc_successful_packs_dict, pc_successful_uploaded_dependencies_zip_packs_dict, pc_failed_packs_dict, pc_uploaded_images = get_upload_data(packs_results_file_path, BucketUploadFlow.PREPARE_CONTENT_FOR_TESTING)
