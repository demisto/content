...
from Tests.Marketplace.marketplace_constants import XSOAR_ON_PREM_MP, XSOAR_SAAS_MP, PackFolders, Metadata, GCPConfig, BucketUploadFlow, PACKS_FOLDER, \
    ...
    def filter_release_notes_by_tags(self, release_notes, upload_marketplace):
        ...
        def remove_tags_section_from_rn(release_notes, marketplace, upload_marketplace):
            ...
            if ((start_tag in release_notes and end_tag in release_notes) and (
                ((upload_marketplace in [XSIAM_MP, XPANSE_MP]) and marketplace != upload_marketplace) or
                (upload_marketplace == XSOAR_SAAS_MP and marketplace not in [XSOAR_SAAS_MP, XSOAR_MP]) or
                (upload_marketplace == XSOAR_MP and marketplace not in [XSOAR_MP, XSOAR_ON_PREM_MP])
                )): 
