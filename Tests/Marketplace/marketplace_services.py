...
class Pack(object):
    ...
    def encrypt_pack(zip_pack_path, pack_name, encryption_key, extract_destination_path,
                     private_artifacts_dir, new_encryption_key):
        ...
        Args:
            ...
            new_encryption_key (str) : A second key which we can decrypt the pack with.
        """
        try:
            ...
            shutil.copy(new_encryption_key_output_file, os.path.join(new_artefacts, f'{pack_name}.enc2.zip'))
    ...
    def zip_pack(self, extract_destination_path="", pack_name="", encryption_key="",
                 private_artifacts_dir='private_artifacts', new_encryption_key=""):
        """ Zips pack folder.
    ...
    def upload_to_storage(self, zip_pack_path, latest_version, storage_bucket, override_pack,
        ...
        try:
            ...
            if private_content:
                ...
                new_encryption_key_path = os.path.join(new_encryption_key_pack_name, f"{self._pack_name}.zip")
