...
COPY_CONTENT_COMMAND="sudo rm /usr/local/demisto/res/script-CommonServer_4_1.yml /usr/local/demisto/res/script-CommonServerPython_4_1.yml \
    && sudo unzip -qq -o ~/content/content_new.zip -d /usr/local/demisto/res \
