...
INTEGRATION_PNG_REGEX = r"{}.*\.png$".format(INTEGRATIONS_DIR)
INTEGRATION_MD_REGEX = r"{}.*\.md$".format(INTEGRATIONS_DIR)
...
CHECKED_TYPES_REGEXES = [PLAYBOOK_REGEX, INTEGRATION_YML_REGEX,
                         ...
                         INTEGRATION_PNG_REGEX, INTEGRATION_MD_REGEX]
...
PACKAGE_FILES_REGEX = CODE_FILES_REGEX + [INTEGRATION_MD_REGEX, INTEGRATION_PNG_REGEX]
