...
CHECKED_TYPES_REGEXES = [PLAYBOOK_REGEX, INTEGRATION_YML_REGEX, BETA_INTEGRATION_YML_REGEX, INTEGRATION_REGEX,
                         WIDGETS_REGEX, DASHBOARD_REGEX, CONNECTIONS_REGEX, CLASSIFIER_REGEX, SCRIPT_YML_REGEX,
                         SCRIPT_REGEX, LAYOUT_REGEX, INCIDENT_FIELD_REGEX, MISC_REGEX, REPORT_REGEX,
                         REPUTATION_REGEX]
