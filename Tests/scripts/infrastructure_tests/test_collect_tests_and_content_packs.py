...
from demisto_sdk.commands.common.constants import PACKS_DIR, PACKS_PACK_IGNORE_FILE_NAME, TEST_PLAYBOOKS_DIR
from TestSuite.pack import Pack
from TestSuite.repo import Repo
from TestSuite.playbook import Playbook
from ruamel.yaml import YAML

import Tests.scripts.collect_tests_and_content_packs as collect_tests_and_content_packs
from Tests.scripts.collect_tests_and_content_packs import (
    ...
    get_from_version_and_to_version_bounderies, get_ignore_pack_skipped_tests)
...
def test_get_ignore_pack_tests__ignore_test(tmpdir, mocker):
    ...
    # prepare mocks
    mocker.patch.object(collect_tests_and_content_packs, "get_pack_ignore_file_path", return_value=pack_ignore_path)
