...
def main():
        ...
        with SSHClient() as ssh:
            try:
                ...
                if time_to_live:
                    ...
                    logging.warning(f'Tests for some integration failed on {readable_role}, keeping instance alive until ...'). #FIXME
            except SSHException:
    ...
    if not success:
        logging.eror(f'Exiting with error, see reasons above.')
