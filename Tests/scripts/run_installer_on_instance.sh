...
# install mitmproxy
ssh ${USER}@${PUBLIC_IP} 'wget https://snapshots.mitmproxy.org/4.0.4/mitmproxy-4.0.4-linux.tar.gz' >/dev/null
ssh ${USER}@${PUBLIC_IP} 'tar -xzvf mitmproxy-4.0.4-linux.tar.gz' >/dev/null
