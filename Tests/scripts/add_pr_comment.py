...
COVERAGE_REPORT_COMMENT_TO_SKIP = 'Link to the unit tests coverage report'

if __name__ == "__main__":
    logging_manager = ParallelLoggingManager('UT_coverage_report.log')
    _add_pr_comment(COVERAGE_REPORT_COMMENT, logging_manager, COVERAGE_REPORT_COMMENT_TO_SKIP)
