...
class BranchTestCollector(TestCollector):
    ...
    def _get_git_diff(self) -> FilesToCollect:
        ...
        if os.getenv('IFRA_ENV_TYPE') in ['Bucket-Upload', 'XDR-Test-Content-Env-Bucket-Upload']:
...
if __name__ == '__main__':
    ...
    elif os.environ.get("IFRA_ENV_TYPE") in ['Bucket-Upload', 'XDR-Test-Content-Env-Bucket-Upload']:
