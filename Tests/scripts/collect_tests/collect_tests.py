...
class TestCollector(ABC):
    ...
    def _sanity_test_names(self) -> tuple[str, ...]:
        match self.marketplace:
            ...
            case _:
                # todo: no sanity tests for xpanse (tuple)
    ...
    def __validate_marketplace_compatibility(self,
        ...
        match self.marketplace:
            case MarketplaceVersions.MarketplaceV2:
                # todo: will be packs that has mpv2 and xpanse -> want run on xsiam them
                if content_item_marketplaces != (self.marketplace,):  # not in xsoar instead this
            ...
            case MarketplaceVersions.XSOAR | MarketplaceVersions.XPANSE:  # todo: case: XPANSE
...
if __name__ == '__main__':
    ...
    if args.changed_pack_path:
        ...
        match (nightly, marketplace):
            ...
            case _:
                # todo: no nightly for xpanse (add class)
