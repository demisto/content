...
class TestCredentialsOperations:
    def test_fetch_credentials_positive(self, mocker, requests_mock):
        ...
        # list
        requests_mock.get(f"{BASE_URL}credential", json=GET_CREDENTIALS)
        results = fetch_credentials(client)
        assert results == [
            {"user": "User1", "name": "DBot Demisto", "password": "mj54bk32gb"},
    ...
    def test_fetch_credentials_negative(self, mocker, requests_mock):
        ...
        mocker.patch.object(demisto, "credentials")
        # list
        requests_mock.get(f"{BASE_URL}credential", json={})
...
class TestAccountOperations:
    def test_lock_account_positive(self, requests_mock):
        ...
        requests_mock.post(BASE_URL + "account/lock?account=111", json={"account": [{"username": "111", "isLocked": True}]})
    ...
    def test_unlock_account_positive(self, requests_mock):
        ...
        requests_mock.post(BASE_URL + "account/unlock?account=111", json={"account": [{"username": "111", "isLocked": False}]})
    ...
    def test_reset_account_positive(self, requests_mock):
        ...
        requests_mock.post(BASE_URL + "account/reset?account=111", json={"account": [{"username": "111", "isLocked": False}]})
...
class TestVaultOperations:
    def test_lock_vault_positive(self, requests_mock):
        ...
        requests_mock.post(BASE_URL + "vault/lock?vaultId=111", json={"vault": [{"vaultId": "111", "isLocked": True}]})
    ...
    def test_lock_vault_negative(self, requests_mock):
        ...
        requests_mock.post(BASE_URL + "vault/lock?vaultId=111", json={"vault": [{"vaultId": "111", "isLocked": False}]})
    ...
    def test_unlock_vault_positive(self, requests_mock):
        ...
        requests_mock.post(BASE_URL + "vault/unlock?vaultId=111", json={"vault": [{"vaultId": "111", "isLocked": False}]})
    ...
    def test_unlock_vault_negative(self, requests_mock):
        ...
        requests_mock.post(BASE_URL + "vault/unlock?vaultId=111", json={"vault": [{"vaultId": "111", "isLocked": True}]})
