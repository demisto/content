...
IP_RESULTS = {"result": [{"id": 101, "severity": 0, "IP": "8.8.8.8", "description": "Google's DNS"}]}

URL_RESULTS = {"result": [{"id": 101, "severity": 31, "URL": "suspicious.example.com", "description": "Scary URL"}]}

DOMAIN_RESULTS = {"result": [{"id": 101, "severity": 50, "Domain": "example.com", "description": "Scary domain"}]}
...
class TestDeTi:
    ...
    def test_file_positive(self, requests_mock):
        ...
        human_readable, context, raw_response = search_file_command(CLIENT, {"file": "d1e09edea866f35738ab48893603a025"})
