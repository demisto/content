...
63 tests covering: `is_checked`, `get_current_step`, `get_step_index`, `reset_from_step`, `markpass_step` (including non-checkpoint rejection, prerequisite enforcement, sequential enforcement, auth parity cases, full workflow), `find_row`, `format_status`, `format_dashboard_row`, round-trip scenarios, and edge cases.
