...
4. Run the setter:
   ```bash
   python3 content/connectus/workflow_state.py set-release-notes "<Integration ID>"
   ```
...
```bash
python3 content/connectus/workflow_state.py markpass "<Integration ID>" "precommit/validate/unit tests passed"
```
