...
def create_deployment(client: Client):
    ...
    if created_deployment.get("data", {}):
        human_readable = tableToMarkdown(
...
def update_deployment(client: Client):
    ...
    if updated_deployment.get("data", {}):
        human_readable = tableToMarkdown(
...
def delete_deployment(client: Client):
    ...
    if deleted_deployment.get("data", {}):
        human_readable = tableToMarkdown(
...
@metadata_collector.command(
    ...
    outputs_list=[
        ...
        OutputArgument(
            name="contact_email", description="Email of the contact person.", prefix="SafeBreach.AccountDetails", output_type=str
        ),
        OutputArgument(
            name="user_quota",
            prefix="SafeBreach.AccountDetails",
        ...
        OutputArgument(
            name="expiration_date", description="Account expiration date.", prefix="SafeBreach.AccountDetails", output_type=str
        ),
    ],
...
@metadata_collector.command(
    ...
    outputs_list=[
        ...
        OutputArgument(
            name="attack_id", description="the attack ID of the simulation.", prefix="SafeBreach.ActiveTest", output_type=str
        ),
    ],
...
def get_all_running_simulations_summary(client: Client):
    ...
    Returns:
        CommandResults,Dict: This returns all simulations related summary as a table and gives a dictionary as outputs for the same
    """
...
@metadata_collector.command(
    ...
    outputs_list=[
        ...
        OutputArgument(
            name="is_enabled", description="if simulation is enabled.", prefix="SafeBreach.Schedules", output_type=bool
        ),
        OutputArgument(
            name="user_schedule",
...
@metadata_collector.command(
    ...
    outputs_list=[
        ...
        OutputArgument(
            name="actions_list", description="actions list of the scenario.", prefix="SafeBreach.CustomScenario", output_type=str
        ),
        OutputArgument(
            name="edges_count", description="edges_count for the scenario.", prefix="SafeBreach.CustomScenario", output_type=str
        ),
        OutputArgument(
            name="steps_order",
