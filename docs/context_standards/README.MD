...
"Domain": {
    ...
    "Admin": {
        "Country": "STRING, The domain administrator's country.",
        "Email": "STRING, The domain administrator's email address.",
        "Name": "STRING, The domain administrator's name.",
        "Phone": "STRING, The domain administrator's phone number."
    },
    "Registrant": {
