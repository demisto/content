...
| [GenericPolling Playbook](https://github.com/demisto/content/blob/master/docs/tests/genericpolling/README.md) | How to use GenericPolling playbook and for what purpose |
