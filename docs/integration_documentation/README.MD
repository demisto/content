...
Once the command has been executed, you will see the documentation markdown in the War Room as a new entry and a copy of it as a file entry. Review the generated document.
