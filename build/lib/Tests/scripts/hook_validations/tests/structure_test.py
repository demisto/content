...
def test_scheme_validation_playbook():
    ...
    assert validator._is_valid_scheme('playbook'), \
...
def test_scheme_validation_invalid_playbook():
    ...
    try:
        validator._is_valid_scheme(matching_regex=PLAYBOOK_REGEX)
...
def test_invalid_file_examination():
    ...
    validator = IntegrationValidator(file_path="Integrations/integration-test.yml")
