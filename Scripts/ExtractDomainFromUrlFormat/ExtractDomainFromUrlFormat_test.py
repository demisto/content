...
@pytest.mark.parametrize('input,domain,fqdn', [
                        ('http://this.is.test.com', 'test.com', 'this.is.test.com'),
                        ('http:example.com', 'example.com', ''),
                        ('http:\\\\example.com', 'example.com', ''),
                        ('https://caseapi.phishlabs.com', 'phishlabs.com', 'caseapi.phishlabs.com'),
                         # output needs to be bytes string utf-8 encoded (otherwise python loop demisto.results fails)
                        (u'www.bücher.de', u'bücher.de'.encode('utf-8'), u'www.bücher.de'.encode('utf-8')),
                        ('https://urldefense.proofpoint.com/v2/url?u=http-3A__go.getpostman.com_y4wULsdG0h0DDMY0Dv00100&d=DwMFaQ&c=ywDJJevdGcjv4rm9P3FcNg&r=s5kA2oIAQRXsacJiBKmTORIWyRN39ZKhobje2GyRgNs&m=vN1dVSiZvEoM9oExtQqEptm9Dbvq9tnjACDZzrBLaWI&s=zroN7KQdBCPBOfhOmv5SP1DDzZKZ1y9I3x4STS5PbHA&e=', 'getpostman.com', 'go.getpostman.com'),  # noqa: E501
                        ('hxxps://www[.]demisto[.]com', 'demisto.com', 'www.demisto.com'),
...
def test_extract_domain(input, domain, fqdn):
    extracted_domain = extract_domain(input, False)  # extract domain
    extracted_fqdn = extract_domain(input, True)  # exstract fqdn
